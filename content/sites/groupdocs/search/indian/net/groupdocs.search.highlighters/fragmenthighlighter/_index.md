...
description: एक खज परणम हइलइटर क प्रतनधत्व करत है ज पठ के टुकड़ं में खज परणमं क हइलइट करत है
type: docs
weight: 640
url: /hi/net/groupdocs.search.highlighters/fragmenthighlighter/
---
...
| नाम | विवरण |
| --- | --- |
| [FragmentHighlighter](fragmenthighlighter)(OutputFormat) | का एक नया उदाहरण प्रारंभ करता है[`FragmentHighlighter`](../fragmenthighlighter) वर्ग. |
...
| नाम | विवरण |
| --- | --- |
| [GetResult](../../groupdocs.search.highlighters/fragmenthighlighter/getresult)() | परिणामी खंड कंटेनरों की एक सरणी प्राप्त करता है। |
