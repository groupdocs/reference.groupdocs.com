...
هذه الطريقة ترجع`حقيقي` إذا تم العثور على الاسم المستعار وإزالته بنجاح. هذه الطريقة ترجع`خطأ شنيع` إذا لم يتم العثور على الاسم المستعار في ملف[`AliasDictionary`](../../aliasdictionary) الكائن .
