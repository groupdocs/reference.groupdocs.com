...
| --- | --- |
| [OcrContext(InputStream imageStream, ImageLocation imageLocation, String imageFileExtension)](#OcrContext-java.io.InputStream-com.groupdocs.search.options.ImageLocation-java.lang.String-) | Initializes a new instance of the 
OcrContext
 class.
 |
## Methods
...
This value can be used to determine the type of the image.
