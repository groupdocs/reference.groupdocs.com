...
| [TXT](#TXT) | A file with .TXT extension represents a text document that contains plain text in the form of lines.
 |
| [LOG](#LOG) | A file with .LOG extension is typically a text document containing plain text in the form of lines.
 |
...
Text File format.
 |
| [OTT](#OTT) | Files with OTT extension represent template documents generated by applications in compliance with
...
| [POT](#POT) | Files with .POT extension represent Microsoft PowerPoint template files in binary format created by PowerPoint 97-2003 versions.
 |
| [PST](#PST) | Files with .PST extension represent Outlook Personal Storage Files (also called Personal Storage Table)
that store variety of user information.
 |
| [OST](#OST) | OST or Offline Storage Files represent user's mailbox data in offline mode on local machine upon
...
| [PDF](#PDF) | Portable Document Format (PDF) is a type of document created by Adobe back in 1990s.
 |
| [RTF](#RTF) | Introduced and documented by Microsoft, the Rich Text Format (RTF) represents a method of encoding
...
| [VSS](#VSS) | VSS are stencil files created with Microsoft Visio 2007 and earlier.
 |
| [DCM](#DCM) | Files with .DCM extension represent digital image which stores medical information of patients
...
can hold content such as text, images, objects and styles.
Learn more about this file format
...
the OASIS' OpenDocument standard format. These are created with word processor applications such as
free OpenOffice Writer and can hold settings that can be used to generate new documents from these template files.
Learn more about this file format
...
as well as other similar spreadsheet programs such as OpenOffice Calc or Apple Numbers.
Learn more about this file format
...
Learn more about spreadsheet file formats
...
PPS file reading and creation is supported by Microsoft PowerPoint 97-2003.
Learn more about this file format
...
a format that is independent of application software, hardware as well as Operating System.
Learn more about this file format
...
exchange with other Microsoft Products, thus serving the purpose of interoperability.
Learn more about this file format
...
file format for exporting the emails.
Learn more about this file format
...
objects that can be included in a .VSD Visio drawing.
Learn more about this file format
