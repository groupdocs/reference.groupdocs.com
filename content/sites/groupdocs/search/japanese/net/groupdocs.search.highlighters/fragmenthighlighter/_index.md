...
description: 検索結果をテキスト フラグメントで強調表示する検索結果ハイライターを表します
type: docs
weight: 640
url: /ja/net/groupdocs.search.highlighters/fragmenthighlighter/
---
## FragmentHighlighter class

検索結果をテキスト フラグメントで強調表示する検索結果ハイライターを表します。
...
| 名前 | 説明 |
| --- | --- |
| [FragmentHighlighter](fragmenthighlighter)(OutputFormat) | の新しいインスタンスを初期化します[`FragmentHighlighter`](../fragmenthighlighter)class. |
...
| 名前 | 説明 |
| --- | --- |
| [GetResult](../../groupdocs.search.highlighters/fragmenthighlighter/getresult)() | 結果のフラグメント コンテナーの配列を取得します。 |
