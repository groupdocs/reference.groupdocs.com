...
description: の新しいインスタンスを初期化しますOleDiagramOptionsgroupdocs.merger.domain.options/olediagramoptionsclass.
type: docs
weight: 10
url: /ja/net/groupdocs.merger.domain.options/olediagramoptions/olediagramoptions/
---
## OleDiagramOptions(byte[], byte[], string, int) {#constructor}

の新しいインスタンスを初期化します[`OleDiagramOptions`](../../olediagramoptions)class.
