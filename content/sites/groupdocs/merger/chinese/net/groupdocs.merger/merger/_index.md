...
| 姓名 | 描述 |
| --- | --- |
| [Merger](merger#constructor)(Func&lt;Stream&gt;) | 初始化的新实例[`Merger`](../merger)类. |
| [Merger](merger#constructor_4)(Stream) | 初始化的新实例[`Merger`](../merger)类. |
| [Merger](merger#constructor_8)(string) | 初始化的新实例[`Merger`](../merger)类. |
| [Merger](merger#constructor_1)(Func&lt;Stream&gt;, ILoadOptions) | 初始化的新实例[`Merger`](../merger)类. |
| [Merger](merger#constructor_3)(Func&lt;Stream&gt;, MergerSettings) | 初始化的新实例[`Merger`](../merger)类. |
| [Merger](merger#constructor_5)(Stream, ILoadOptions) | 初始化的新实例[`Merger`](../merger)类. |
| [Merger](merger#constructor_7)(Stream, MergerSettings) | 初始化的新实例[`Merger`](../merger)类. |
| [Merger](merger#constructor_9)(string, ILoadOptions) | 初始化的新实例[`Merger`](../merger)类. |
| [Merger](merger#constructor_11)(string, MergerSettings) | 初始化的新实例[`Merger`](../merger)类. |
| [Merger](merger#constructor_2)(Func&lt;Stream&gt;, ILoadOptions, MergerSettings) | 初始化的新实例[`Merger`](../merger)类. |
| [Merger](merger#constructor_6)(Stream, ILoadOptions, MergerSettings) | 初始化的新实例[`Merger`](../merger)类. |
| [Merger](merger#constructor_10)(string, ILoadOptions, MergerSettings) | 初始化的新实例[`Merger`](../merger)类. |
...
| [Dispose](../../groupdocs.merger/merger/dispose)() | 处理资源。 |
...
| [GetDocumentInfo](../../groupdocs.merger/merger/getdocumentinfo)() | 获取有关文档页面的信息：它们的大小、最大页面高度、最大高度页面的宽度。 |
