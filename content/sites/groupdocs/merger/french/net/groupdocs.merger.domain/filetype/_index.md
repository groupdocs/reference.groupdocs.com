...
| static [IsArchive](../../groupdocs.merger.domain/filetype/isarchive)(FileType) | Détermine si l'entrée[`FileType`](../filetype) est un format d'archive. |
| static [IsImage](../../groupdocs.merger.domain/filetype/isimage)(FileType) | Détermine si l'entrée[`FileType`](../filetype) est le format d'image. |
...
| Nom | La description |
| --- | --- |
| static [BMP](../../groupdocs.merger.domain/filetype/bmp) | Bitmap Image File (.bmp) représente les fichiers utilisés pour stocker des images numériques bitmap. En savoir plus sur ce format de fichier[ici](https://docs.fileformat.com/image/bmp) . |
| static [BZ2](../../groupdocs.merger.domain/filetype/bz2) | Fichier compressé Bzip2 (.bz2) |
...
| static [GIF](../../groupdocs.merger.domain/filetype/gif) | Fichier de format d'échange graphique (.gif) |
| static [GZ](../../groupdocs.merger.domain/filetype/gz) | Fichier compressé G-Zip (.gz) |
...
| static [JPEG](../../groupdocs.merger.domain/filetype/jpeg) | Image JPEG (.jpeg) est un type de format d'image enregistré à l'aide de la méthode de compression avec perte. L'image de sortie, résultant de la compression, est un compromis entre la taille de stockage et la qualité de l'image. En savoir plus sur ce format de fichier[ici](https://docs.fileformat.com/image/jpeg) . |
| static [JPG](../../groupdocs.merger.domain/filetype/jpg) | Image JPEG (.jpg) |
...
| static [PNG](../../groupdocs.merger.domain/filetype/png) | Portable Network Graphic (.png) est un type de format de fichier d'image raster qui utilise une compression sans perte. En savoir plus sur ce format de fichier[ici](https://docs.fileformat.com/image/png) . |
...
| static [RAR](../../groupdocs.merger.domain/filetype/rar) | Fichier compressé Roshal ARchive (.rar) |
...
| static [SevenZ](../../groupdocs.merger.domain/filetype/sevenz) | Fichier compressé 7-Zip (.7z) |
| static [TAR](../../groupdocs.merger.domain/filetype/tar) | Archive de fichiers Unix consolidée (.tar) |
...
| static [TIF](../../groupdocs.merger.domain/filetype/tif) | Fichier image balisé (.tif) |
| static [TIFF](../../groupdocs.merger.domain/filetype/tiff) | Format de fichier image tagué (.tiff) |
...
| static [ZIP](../../groupdocs.merger.domain/filetype/zip) | Fichier compressé (.zip) |
