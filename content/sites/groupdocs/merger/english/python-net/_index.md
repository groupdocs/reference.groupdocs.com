...
| [`groupdocs.merger.domain.result`](/merger/python-net/groupdocs.merger.domain.result) | The namespace provides classes which represent document results. |
| [`groupdocs.merger.exceptions`](/merger/python-net/groupdocs.merger.exceptions) | The namespace provides different classes for exceptions. |
| [`groupdocs.merger.logging`](/merger/python-net/groupdocs.merger.logging) | The namespace provides classes for customizing logging behaviour. |
