...
description: Проверяет защищен ли документ паролем.
type: docs
weight: 90
url: /ru/net/groupdocs.merger/merger/ispasswordset/
---
...
Возвращает значение, указывающее, защищен документ или нет.
