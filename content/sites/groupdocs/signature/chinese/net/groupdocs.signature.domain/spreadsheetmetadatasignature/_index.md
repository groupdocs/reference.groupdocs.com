...
| 姓名 | 描述 |
| --- | --- |
| [SpreadsheetMetadataSignature](spreadsheetmetadatasignature#constructor)(string) | 使用预定义的名称和空值创建电子表格元数据签名。 |
| [SpreadsheetMetadataSignature](spreadsheetmetadatasignature#constructor_1)(string, object) | 使用预定义的值创建电子表格元数据签名。 |
...
| override [ToString](../../groupdocs.signature.domain/spreadsheetmetadatasignature/tostring#tostring_2)(string, IFormatProvider) | 转换为指定格式的字符串 |
