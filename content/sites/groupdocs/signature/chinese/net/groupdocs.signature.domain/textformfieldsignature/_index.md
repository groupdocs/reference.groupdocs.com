...
description: 包含 Pdf 文档 的文本输入表单字段签名属性
type: docs
weight: 960
...
| 姓名 | 描述 |
| --- | --- |
| [TextFormFieldSignature](textformfieldsignature#constructor)(string) | 创建具有预定义名称的 PdfTextFormFieldSignature. |
| [TextFormFieldSignature](textformfieldsignature#constructor_1)(string, string) | 创建具有预定义名称的 PdfTextFormFieldSignature. |
