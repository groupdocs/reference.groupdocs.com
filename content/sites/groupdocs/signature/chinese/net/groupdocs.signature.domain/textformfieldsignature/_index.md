...
description: 包含 Pdf Document 的文本输入表单字段签名属性
type: docs
weight: 930
url: /zh/net/groupdocs.signature.domain/textformfieldsignature/
---
## TextFormFieldSignature class

包含 Pdf Document 的文本输入表单字段签名属性
...
| 姓名 | 描述 |
| --- | --- |
| [TextFormFieldSignature](textformfieldsignature#constructor)(string) | 使用预定义的名称创建 PdfTextFormFieldSignature。 |
| [TextFormFieldSignature](textformfieldsignature#constructor_1)(string, string) | 使用预定义的名称创建 PdfTextFormFieldSignature。 |
...
| [Text](../../groupdocs.signature.domain/textformfieldsignature/text) { get; set; } | 获取或设置表单域文本输入的文本。 |
...
| 姓名 | 描述 |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/textformfieldsignature/clone)() | 克隆 FormField 签名实例。 |
| override [Equals](../../groupdocs.signature.domain/textformfieldsignature/equals)(object) | 覆盖 Equals 方法以比较签名属性 |
| override [GetHashCode](../../groupdocs.signature.domain/textformfieldsignature/gethashcode)() | 覆盖 GetHashCode 方法 |
