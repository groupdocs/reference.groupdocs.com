...
description: 包含表单字段签名属性
type: docs
weight: 460
url: /zh/net/groupdocs.signature.domain/formfieldsignature/
---
...
| 姓名 | 描述 |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/formfieldsignature/clone)() | 克隆 FormField 签名实例。 |
| override [Equals](../../groupdocs.signature.domain/formfieldsignature/equals)(object) | 覆盖 Equals 方法以比较签名属性 |
| override [GetHashCode](../../groupdocs.signature.domain/formfieldsignature/gethashcode)() | 覆盖 GetHashCode 方法 |
