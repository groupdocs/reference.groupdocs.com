...
| 姓名 | 描述 |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/pdfmetadatasignature/clone#clone_1)() | 克隆元数据签名实例。 |
| override [Clone](../../groupdocs.signature.domain/pdfmetadatasignature/clone#clone)(object) | 克隆具有给定值的 Pdf 元数据签名实例。 |
| override [Equals](../../groupdocs.signature.domain/pdfmetadatasignature/equals)(object) | 覆盖 Equals 方法以比较签名属性 |
