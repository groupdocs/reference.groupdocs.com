...
| 姓名 | 描述 |
| --- | --- |
| [ImageSignature](imagesignature)(string) | 使用搜索过程后获得的签名标识符初始化 ImageSignature 对象。 此唯一标识符用于从文档签名信息层中查找此签名的其他属性。 |
...
| [Format](../../groupdocs.signature.domain/imagesignature/format) { get; } | 指定签名图片的格式。 |
...
| [Size](../../groupdocs.signature.domain/imagesignature/size) { get; } | 指定签名图像的字节大小。 |
