...
| 姓名 | 描述 |
| --- | --- |
| [PresentationMetadataSignature](presentationmetadatasignature#constructor)(string) | 使用预定义名称和空值 创建表示元数据签名 |
| [PresentationMetadataSignature](presentationmetadatasignature#constructor_1)(string, object) | 创建具有预定义值的演示文稿元数据签名 |
...
| override [ToString](../../groupdocs.signature.domain/presentationmetadatasignature/tostring#tostring_2)(string, IFormatProvider) | 转换为具有指定格式的字符串 |
