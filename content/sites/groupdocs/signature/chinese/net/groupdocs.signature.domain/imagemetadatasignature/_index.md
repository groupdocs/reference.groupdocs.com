...
| [Description](../../groupdocs.signature.domain/imagemetadatasignature/description) { get; } | 用于获取标准图像元数据签名描述的只读值 |
| [Height](../../groupdocs.signature.domain/basesignature/height) { get; set; } | 指定签名的高度。 |
| [Id](../../groupdocs.signature.domain/imagemetadatasignature/id) { get; set; } | 图像元数据签名的标识符。 见ImageMetadataSignatures包含具有预定义 Id 值的标准签名的类。 |
...
| [Size](../../groupdocs.signature.domain/imagemetadatasignature/size) { get; } | 获取元数据值大小的只读值 |
...
| override [ToDateTime](../../groupdocs.signature.domain/imagemetadatasignature/todatetime#todatetime)() | 转换为日期时间。 |
| override [ToDateTime](../../groupdocs.signature.domain/imagemetadatasignature/todatetime#todatetime_1)(IFormatProvider) | 转换为日期时间。 |
...
| override [ToDouble](../../groupdocs.signature.domain/imagemetadatasignature/todouble#todouble)() | 转换为双精度。 |
| override [ToDouble](../../groupdocs.signature.domain/imagemetadatasignature/todouble#todouble_1)(IFormatProvider) | 转换为双精度。 |
...
| override [ToSingle](../../groupdocs.signature.domain/imagemetadatasignature/tosingle#tosingle)() | 转换为浮点数。 |
| override [ToSingle](../../groupdocs.signature.domain/imagemetadatasignature/tosingle#tosingle_1)(IFormatProvider) | 转换为浮点数。 |
| override [ToString](../../groupdocs.signature.domain/imagemetadatasignature/tostring#tostring)() | 使用覆盖 ToString() 方法转换为字符串 |
| override [ToString](../../groupdocs.signature.domain/imagemetadatasignature/tostring#tostring_1)(string) | 转换为指定格式的字符串 |
| override [ToString](../../groupdocs.signature.domain/imagemetadatasignature/tostring#tostring_2)(string, IFormatProvider) | 转换为指定格式的字符串 |
