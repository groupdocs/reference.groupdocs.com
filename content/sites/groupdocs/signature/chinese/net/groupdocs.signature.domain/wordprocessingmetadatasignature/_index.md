...
| 姓名 | 描述 |
| --- | --- |
| [WordProcessingMetadataSignature](wordprocessingmetadatasignature#constructor)(string) | 使用预定义的名称和空值创建字处理元数据签名。 |
| [WordProcessingMetadataSignature](wordprocessingmetadatasignature#constructor_1)(string, object) | 使用预定义的值创建字处理元数据签名。 |
...
| override [Clone](../../groupdocs.signature.domain/wordprocessingmetadatasignature/clone#clone)(object) | 使用给定值克隆词元数据签名实例。 |
...
| override [ToString](../../groupdocs.signature.domain/wordprocessingmetadatasignature/tostring#tostring_2)(string, IFormatProvider) | 转换为指定格式的字符串 |
