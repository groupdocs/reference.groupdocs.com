...
description: 包含文字处理元数据签名属性
type: docs
weight: 1070
url: /zh/net/groupdocs.signature.domain/wordprocessingmetadatasignature/
---
...
| 姓名 | 描述 |
| --- | --- |
| [WordProcessingMetadataSignature](wordprocessingmetadatasignature#constructor)(string) | 创建具有预定义名称和空值的 WordProcessing 元数据签名。 |
| [WordProcessingMetadataSignature](wordprocessingmetadatasignature#constructor_1)(string, object) | 使用预定义值创建字处理元数据签名。 |
...
| 姓名 | 描述 |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/wordprocessingmetadatasignature/clone#clone_1)() | 克隆元数据签名实例。 |
| override [Clone](../../groupdocs.signature.domain/wordprocessingmetadatasignature/clone#clone)(object) | 克隆具有给定值的单词元数据签名实例。 |
...
| override [ToString](../../groupdocs.signature.domain/wordprocessingmetadatasignature/tostring#tostring)() | 使用覆盖 ToString() 方法转换为字符串 |
| virtual [ToString](../../groupdocs.signature.domain/metadatasignature/tostring)(string) | 转换为具有指定格式的字符串 |
| override [ToString](../../groupdocs.signature.domain/wordprocessingmetadatasignature/tostring#tostring_2)(string, IFormatProvider) | 转换为具有指定格式的字符串 |
