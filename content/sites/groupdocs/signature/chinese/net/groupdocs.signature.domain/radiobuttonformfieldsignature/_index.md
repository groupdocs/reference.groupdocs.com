...
description: 包含单选按钮输入表单字段签名属性
type: docs
weight: 790
url: /zh/net/groupdocs.signature.domain/radiobuttonformfieldsignature/
---
...
| 姓名 | 描述 |
| --- | --- |
| [RadioButtonFormFieldSignature](radiobuttonformfieldsignature#constructor)(string) | 使用预定义的名称创建 RadioButtonFieldSignature。 |
| [RadioButtonFormFieldSignature](radiobuttonformfieldsignature#constructor_1)(string, List&lt;string&gt;) | 使用预定义的名称和项目列表创建 RadioButtonFieldSignature。 |
| [RadioButtonFormFieldSignature](radiobuttonformfieldsignature#constructor_2)(string, List&lt;string&gt;, object) | 使用预定义的名称、项目列表和选定值创建 RadioButtonFieldSignature。 |
...
| [Items](../../groupdocs.signature.domain/radiobuttonformfieldsignature/items) { get; set; } | 获取或设置单选按钮选项列表。 |
...
| [Selected](../../groupdocs.signature.domain/radiobuttonformfieldsignature/selected) { get; set; } | 包含选定的值。 |
...
| 姓名 | 描述 |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/radiobuttonformfieldsignature/clone)() | 克隆 FormField 签名实例。 |
| override [Equals](../../groupdocs.signature.domain/radiobuttonformfieldsignature/equals)(object) | 覆盖 Equals 方法以比较签名属性 |
| override [GetHashCode](../../groupdocs.signature.domain/radiobuttonformfieldsignature/gethashcode)() | 覆盖 GetHashCode 方法 |
