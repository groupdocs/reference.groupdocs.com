...
| 姓名 | 描述 |
| --- | --- |
| [CheckboxFormFieldSignature](checkboxformfieldsignature#constructor)(string) | 使用预定义的名称创建 CheckboxFormFieldSignature。 |
| [CheckboxFormFieldSignature](checkboxformfieldsignature#constructor_1)(string, bool) | 使用预定义的名称和值创建 CheckboxFormFieldSignature |
