...
description: 表示 Pdf 文档的 FormField 签名选项的类
type: docs
weight: 1300
url: /zh/net/groupdocs.signature.options/formfieldsignoptions/
---
## FormFieldSignOptions class

表示 Pdf 文档的 FormField 签名选项的类。
...
| 姓名 | 描述 |
| --- | --- |
| [FormFieldSignOptions](formfieldsignoptions#constructor)() | 使用默认值初始化 PdfFormFieldSignOptions 类的新实例。 |
| [FormFieldSignOptions](formfieldsignoptions#constructor_1)(FormFieldSignature) | 使用 FormField 签名初始化 PdfFormFieldSignOptions 类的新实例。 |
...
| [Signature](../../groupdocs.signature.options/formfieldsignoptions/signature) { get; set; } | 获取或设置签名的FormField。 |
...
* GroupDocs.Signature创建FormField电子签名的基本用法： [如何使用 FormField 签名对文档进行电子签名](https://docs.groupdocs.com/display/signaturenet/eSign+document+with+Form+Field+signature)
* 使用 GroupDocs.Signature 设置 FormField 电子签名的高级用法： [具有 FormField 签名和其他设置的电子签名文档的高级用法](https://docs.groupdocs.com/display/signaturenet/Sign+document+with+Form+Field+signature+-+advanced)
