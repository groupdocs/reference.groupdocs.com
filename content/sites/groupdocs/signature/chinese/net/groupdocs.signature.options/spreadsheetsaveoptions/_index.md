...
description: 电子表格文档的保存选项
type: docs
weight: 1700
url: /zh/net/groupdocs.signature.options/spreadsheetsaveoptions/
---
...
| 姓名 | 描述 |
| --- | --- |
| [SpreadsheetSaveOptions](spreadsheetsaveoptions#constructor)() | 使用默认值初始化 SpreadsheetSaveOptions 类的新实例。 |
| [SpreadsheetSaveOptions](spreadsheetsaveoptions#constructor_1)(SpreadsheetSaveFileFormat) | 使用预定义的输出文件格式初始化 SpreadsheetSaveOptions 类的新实例。 |
| [SpreadsheetSaveOptions](spreadsheetsaveoptions#constructor_2)(SpreadsheetSaveFileFormat, bool) | 使用指定的输出类型和覆盖标志初始化 SpreadsheetSaveOptions 类的新实例。 |
...
| [FileFormat](../../groupdocs.signature.options/spreadsheetsaveoptions/fileformat) { get; set; } | 获取或设置签名文档的文件格式。 |
