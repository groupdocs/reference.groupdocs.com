...
| [BitsPerChannel](../../groupdocs.signature.options/jpegsaveoptions/bitsperchannel) { get; set; } | 获取或设置无损 jpeg 图像的每个通道的位。 现在我们支持每通道 2 到 8 位。 |
| [ColorType](../../groupdocs.signature.options/jpegsaveoptions/colortype) { get; set; } | 获取或设置 jpeg 图像的颜色类型。 |
| [Comment](../../groupdocs.signature.options/jpegsaveoptions/comment) { get; set; } | 获取或设置jpeg文件注释。 |
...
| [SampleRoundingMode](../../groupdocs.signature.options/jpegsaveoptions/sampleroundingmode) { get; set; } | 获取或设置样本舍入模式以将 8 位值适合 n 位值 JpegOptions.BitsPerChannel. |
