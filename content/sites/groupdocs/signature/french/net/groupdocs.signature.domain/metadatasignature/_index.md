...
description: Contient les propriétés de signature des métadonnées.
type: docs
weight: 590
url: /fr/net/groupdocs.signature.domain/metadatasignature/
---
## MetadataSignature class

Contient les propriétés de signature des métadonnées.
...
| Nom | La description |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/metadatasignature/clone#clone_1)() | Cloner l'instance de signature de métadonnées. |
| virtual [Clone](../../groupdocs.signature.domain/metadatasignature/clone#clone)(object) | Cloner l'instance de signature de métadonnées avec la valeur donnée. |
...
| [GetData&lt;T&gt;](../../groupdocs.signature.domain/metadatasignature/getdata#getdata)() | Obtenir l'objet à partir de la valeur de signature des métadonnées via la désérialisation. |
| [GetData&lt;T&gt;](../../groupdocs.signature.domain/metadatasignature/getdata#getdata_1)(IDataEncryption) | Obtenir un objet à partir du texte de signature des métadonnées via la désérialisation. |
...
| virtual [ToDateTime](../../groupdocs.signature.domain/metadatasignature/todatetime#todatetime)() | Convertit en DateHeure. |
| virtual [ToDateTime](../../groupdocs.signature.domain/metadatasignature/todatetime#todatetime_1)(IFormatProvider) | Convertit en DateHeure. |
| virtual [ToDecimal](../../groupdocs.signature.domain/metadatasignature/todecimal#todecimal)() | convertit en décimal. |
| virtual [ToDecimal](../../groupdocs.signature.domain/metadatasignature/todecimal#todecimal_1)(IFormatProvider) | convertit en décimal. |
| virtual [ToDouble](../../groupdocs.signature.domain/metadatasignature/todouble#todouble)() | Convertit en Double. |
| virtual [ToDouble](../../groupdocs.signature.domain/metadatasignature/todouble#todouble_1)(IFormatProvider) | Convertit en Double. |
| virtual [ToInteger](../../groupdocs.signature.domain/metadatasignature/tointeger)() | Convertit en entier. |
| virtual [ToSingle](../../groupdocs.signature.domain/metadatasignature/tosingle#tosingle)() | Convertit en float. |
| virtual [ToSingle](../../groupdocs.signature.domain/metadatasignature/tosingle#tosingle_1)(IFormatProvider) | Convertit en float. |
| override [ToString](../../groupdocs.signature.domain/metadatasignature/tostring#tostring)() | Convertit en chaîne avec la méthode override ToString() |
| virtual [ToString](../../groupdocs.signature.domain/metadatasignature/tostring#tostring_1)(string) | convertit en chaîne avec le format spécifié |
| virtual [ToString](../../groupdocs.signature.domain/metadatasignature/tostring#tostring_2)(string, IFormatProvider) | convertit en chaîne avec le format spécifié |
