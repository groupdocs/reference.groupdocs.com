...
description: Contient les propriétés de signature du champ de saisie de texte pour le document PDF
type: docs
weight: 960
url: /fr/net/groupdocs.signature.domain/textformfieldsignature/
---
## TextFormFieldSignature class

Contient les propriétés de signature du champ de saisie de texte pour le document PDF
...
| Nom | La description |
| --- | --- |
| [TextFormFieldSignature](textformfieldsignature#constructor)(string) | Crée PdfTextFormFieldSignature avec un nom prédéfini. |
| [TextFormFieldSignature](textformfieldsignature#constructor_1)(string, string) | Crée PdfTextFormFieldSignature avec un nom prédéfini. |
...
| [Text](../../groupdocs.signature.domain/textformfieldsignature/text) { get; set; } | Obtient ou définit le texte de la saisie de texte du champ de formulaire. |
...
| Nom | La description |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/textformfieldsignature/clone)() | Cloner l'instance FormField Signature. |
| override [Equals](../../groupdocs.signature.domain/textformfieldsignature/equals)(object) | Écrase la méthode Equals pour comparer les propriétés de la signature |
| override [GetHashCode](../../groupdocs.signature.domain/textformfieldsignature/gethashcode)() | Remplace la méthode GetHashCode |
