...
description: Contient les propriétés de signature de codebarres.
type: docs
weight: 20
url: /fr/net/groupdocs.signature.domain/barcodesignature/
---
## BarcodeSignature class

Contient les propriétés de signature de code-barres.
...
| Nom | La description |
| --- | --- |
| [BarcodeSignature](barcodesignature)(string) | Initialiser l'objet BarcodeSignature avec l'identifiant de signature qui a été obtenu après le processus de recherche. Cet identifiant unique est utilisé pour trouver des propriétés supplémentaires pour cette signature à partir de la couche d'informations de signature de document. |

## Propriétés

| Nom | La description |
| --- | --- |
| [Content](../../groupdocs.signature.domain/barcodesignature/content) { get; } | Spécifie le contenu de l'image de données binaires de code-barres de type[`Format`](./format) . Par défaut, cette propriété ne sera pas définie. Utiliser la propriété[`ReturnContent`](../../groupdocs.signature.options/barcodesearchoptions/returncontent) pour activer cette fonctionnalité. |
...
| [EncodeType](../../groupdocs.signature.domain/barcodesignature/encodetype) { get; } | Spécifie le type de code-barres. |
| [Format](../../groupdocs.signature.domain/barcodesignature/format) { get; } | Spécifie le format de l'image de la signature du code-barres. |
...
| [Text](../../groupdocs.signature.domain/barcodesignature/text) { get; } | Spécifie le texte du code-barres. |
...
| Nom | La description |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/barcodesignature/clone)() | Cloner une instance de signature de code-barres. |
| override [Equals](../../groupdocs.signature.domain/barcodesignature/equals)(object) | Écrase la méthode Equals pour comparer les propriétés de la signature |
| override [GetHashCode](../../groupdocs.signature.domain/barcodesignature/gethashcode)() | Remplace la méthode GetHashCode |
