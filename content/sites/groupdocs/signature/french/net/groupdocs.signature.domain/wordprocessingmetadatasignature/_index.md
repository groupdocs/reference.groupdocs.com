...
Contient des propriétés de signature de métadonnées de traitement de texte.
...
| Nom | La description |
| --- | --- |
| [WordProcessingMetadataSignature](wordprocessingmetadatasignature#constructor)(string) | Crée une signature de métadonnées de traitement de texte avec un nom prédéfini et une valeur vide. |
| [WordProcessingMetadataSignature](wordprocessingmetadatasignature#constructor_1)(string, object) | Crée une signature de métadonnées de traitement de texte avec des valeurs prédéfinies. |
...
| Nom | La description |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/wordprocessingmetadatasignature/clone#clone_1)() | Cloner l'instance de signature de métadonnées. |
| override [Clone](../../groupdocs.signature.domain/wordprocessingmetadatasignature/clone#clone)(object) | Clone Words Metadata Signature instance avec la valeur donnée. |
...
| override [ToString](../../groupdocs.signature.domain/wordprocessingmetadatasignature/tostring#tostring)() | Convertit en chaîne avec la méthode override ToString() |
...
| override [ToString](../../groupdocs.signature.domain/wordprocessingmetadatasignature/tostring#tostring_2)(string, IFormatProvider) | convertit en chaîne avec le format spécifié |
