...
description: Contient les propriétés de signature du champ de formulaire.
type: docs
weight: 460
url: /fr/net/groupdocs.signature.domain/formfieldsignature/
---
## FormFieldSignature class

Contient les propriétés de signature du champ de formulaire.
...
| Nom | La description |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/formfieldsignature/clone)() | Cloner l'instance FormField Signature. |
| override [Equals](../../groupdocs.signature.domain/formfieldsignature/equals)(object) | Écrase la méthode Equals pour comparer les propriétés de la signature |
| override [GetHashCode](../../groupdocs.signature.domain/formfieldsignature/gethashcode)() | Remplace la méthode GetHashCode |
