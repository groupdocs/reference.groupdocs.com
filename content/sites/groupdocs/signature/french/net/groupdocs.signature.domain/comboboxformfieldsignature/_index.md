...
Contient les propriétés de signature de champ de formulaire de saisie de zone de liste déroulante.
...
| Nom | La description |
| --- | --- |
| [ComboboxFormFieldSignature](comboboxformfieldsignature#constructor)(string) | Crée ComboboxFormFieldSignature avec un nom prédéfini. |
| [ComboboxFormFieldSignature](comboboxformfieldsignature#constructor_1)(string, List&lt;string&gt;) | Crée ComboboxFormFieldSignature avec un nom prédéfini et une liste d'options. |
| [ComboboxFormFieldSignature](comboboxformfieldsignature#constructor_2)(string, List&lt;string&gt;, object) | Crée ComboboxFormFieldSignature avec un nom prédéfini, une liste d'options et une valeur sélectionnée. |
...
| [Items](../../groupdocs.signature.domain/comboboxformfieldsignature/items) { get; set; } | Obtenir ou définir la liste des options de liste déroulante. |
...
| [Selected](../../groupdocs.signature.domain/comboboxformfieldsignature/selected) { get; set; } | Obtenir ou définir la valeur sélectionnée. |
...
| Nom | La description |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/comboboxformfieldsignature/clone)() | Cloner l'instance FormField Signature. |
| override [Equals](../../groupdocs.signature.domain/comboboxformfieldsignature/equals)(object) | Écrase la méthode Equals pour comparer les propriétés de la signature |
| override [GetHashCode](../../groupdocs.signature.domain/comboboxformfieldsignature/gethashcode)() | Remplace la méthode GetHashCode |
