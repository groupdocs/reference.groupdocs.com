...
Contient les propriétés de signature d'image.
...
| Nom | La description |
| --- | --- |
| [ImageSignature](imagesignature)(string) | Initialise l'objet ImageSignature avec l'identifiant de signature obtenu après le processus de recherche. Cet identifiant unique est utilisé pour trouver des propriétés supplémentaires pour cette signature à partir de la couche d'informations de signature de document. |

## Propriétés

| Nom | La description |
| --- | --- |
| [Content](../../groupdocs.signature.domain/imagesignature/content) { get; } | Spécifie le contenu des données binaires de l'image de type[`Format`](./format) . Par défaut, cette propriété ne sera pas définie. Utiliser la propriété[`ReturnContent`](../../groupdocs.signature.options/imagesearchoptions/returncontent) pour activer cette fonctionnalité. |
...
| [Format](../../groupdocs.signature.domain/imagesignature/format) { get; } | Spécifie le format de l'image de la signature. |
...
| [Size](../../groupdocs.signature.domain/imagesignature/size) { get; } | Spécifie la taille en octets de l'image de la signature. |
...
| Nom | La description |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/imagesignature/clone)() | Cloner une instance de signature de code-barres. |
| override [Equals](../../groupdocs.signature.domain/imagesignature/equals)(object) | Écrase la méthode Equals pour comparer les propriétés de la signature |
| override [GetHashCode](../../groupdocs.signature.domain/imagesignature/gethashcode)() | Remplace la méthode GetHashCode |
