...
description: Contient les propriétés de signature de métadonnées de certificat.
type: docs
weight: 70
url: /fr/net/groupdocs.signature.domain/certificatemetadatasignature/
---
## CertificateMetadataSignature class

Contient les propriétés de signature de métadonnées de certificat.
...
| Nom | La description |
| --- | --- |
| [CertificateMetadataSignature](certificatemetadatasignature#constructor)(string) | Crée une signature de métadonnées de certificat avec un nom prédéfini et une valeur vide. |
| [CertificateMetadataSignature](certificatemetadatasignature#constructor_1)(string, object) | Crée une signature de métadonnées de certificat avec des valeurs prédéfinies. |
...
| Nom | La description |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/certificatemetadatasignature/clone#clone_1)() | Cloner l'instance de signature de métadonnées. |
| override [Clone](../../groupdocs.signature.domain/certificatemetadatasignature/clone#clone)(object) | Cloner l'instance de signature de métadonnées de certificat avec la valeur donnée. |
...
| override [ToString](../../groupdocs.signature.domain/certificatemetadatasignature/tostring#tostring)() | Convertit en chaîne avec la méthode override ToString() |
...
| override [ToString](../../groupdocs.signature.domain/certificatemetadatasignature/tostring#tostring_2)(string, IFormatProvider) | convertit en chaîne avec le format spécifié |
