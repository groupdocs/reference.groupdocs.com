...
Représente les options de signature de texte.
...
| Nom | La description |
| --- | --- |
| [TextSignOptions](textsignoptions#constructor)() | Initialise une nouvelle instance de la classe TextSignOptions avec les valeurs par défaut. |
| [TextSignOptions](textsignoptions#constructor_1)(string) | Initialise une nouvelle instance de la classe TextSignOptions avec text. |
...
* Utilisation de base de la création de signature électronique textuelle par GroupDocs.Signature : [Comment signer un document électronique avec une signature textuelle](https://docs.groupdocs.com/display/signaturenet/eSign+document+with+Text+signature)
* Utilisation avancée des paramètres de signature électronique Texte avec GroupDocs.Signature : [Utilisation avancée du document eSign avec signature textuelle et paramètres supplémentaires](https://docs.groupdocs.com/display/signaturenet/Sign+document+with+Text+signature+-+advanced)
