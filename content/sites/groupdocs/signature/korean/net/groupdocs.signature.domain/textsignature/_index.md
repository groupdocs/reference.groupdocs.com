...
description: 텍스트 서명 속성을 포함합니다.
type: docs
weight: 1000
url: /ko/net/groupdocs.signature.domain/textsignature/
---
## TextSignature class
...
| 이름 | 설명 |
| --- | --- |
| [TextSignature](textsignature)(string) | 검색 과정 후에 얻은 서명 식별자로 TextSignature 개체를 초기화합니다. 이 고유 식별자는 문서 서명 정보 레이어에서 이 서명에 대한 추가 속성을 찾는 데 사용됩니다. |
...
| [Native](../../groupdocs.signature.domain/textsignature/native) { get; set; } | 기본 특성을 지정합니다. 서명이 문서에 특정한 경우 true입니다. |
...
| [SignatureImplementation](../../groupdocs.signature.domain/textsignature/signatureimplementation) { get; } | 텍스트 서명 구현을 지정합니다. |
| [SignatureType](../../groupdocs.signature.domain/basesignature/signaturetype) { get; } | 서명 유형을 지정합니다. |
| [Text](../../groupdocs.signature.domain/textsignature/text) { get; set; } | 서명의 텍스트를 지정합니다. |
...
| 이름 | 설명 |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/textsignature/clone)() | 복제 텍스트 서명 인스턴스. |
| override [Equals](../../groupdocs.signature.domain/textsignature/equals)(object) | 서명 속성을 비교하기 위해 Equals 메서드를 덮어씁니다 |
| override [GetHashCode](../../groupdocs.signature.domain/textsignature/gethashcode)() | GetHashCode method 재정의 |
