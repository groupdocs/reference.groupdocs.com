...
description: 워드프로세싱 메타데이터 서명 속성을 포함합니다.
type: docs
weight: 1070
url: /ko/net/groupdocs.signature.domain/wordprocessingmetadatasignature/
---
## WordProcessingMetadataSignature class

워드프로세싱 메타데이터 서명 속성을 포함합니다.
...
| 이름 | 설명 |
| --- | --- |
| [WordProcessingMetadataSignature](wordprocessingmetadatasignature#constructor)(string) | 미리 정의된 이름과 빈 값으로 WordProcessing 메타데이터 서명을 생성합니다. |
| [WordProcessingMetadataSignature](wordprocessingmetadatasignature#constructor_1)(string, object) | 미리 정의된 값으로 WordProcessing 메타데이터 서명을 생성합니다. |
...
| 이름 | 설명 |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/wordprocessingmetadatasignature/clone#clone_1)() | 복제 메타데이터 서명 인스턴스. |
| override [Clone](../../groupdocs.signature.domain/wordprocessingmetadatasignature/clone#clone)(object) | 주어진 값을 가진 복제 단어 메타데이터 서명 인스턴스. |
...
| override [ToString](../../groupdocs.signature.domain/wordprocessingmetadatasignature/tostring#tostring)() | 재정의를 통해 문자열로 변환 ToString() method |
| virtual [ToString](../../groupdocs.signature.domain/metadatasignature/tostring)(string) | 지정된 format 의 문자열로 변환합니다. |
| override [ToString](../../groupdocs.signature.domain/wordprocessingmetadatasignature/tostring#tostring_2)(string, IFormatProvider) | 지정된 format 의 문자열로 변환합니다. |
