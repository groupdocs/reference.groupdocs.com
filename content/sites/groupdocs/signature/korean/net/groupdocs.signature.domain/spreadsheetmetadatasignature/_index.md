...
description: 스프레드시트 메타데이터 서명 속성을 포함합니다.
type: docs
weight: 870
url: /ko/net/groupdocs.signature.domain/spreadsheetmetadatasignature/
---
## SpreadsheetMetadataSignature class

스프레드시트 메타데이터 서명 속성을 포함합니다.
...
| 이름 | 설명 |
| --- | --- |
| [SpreadsheetMetadataSignature](spreadsheetmetadatasignature#constructor)(string) | 미리 정의된 이름과 빈 값으로 스프레드시트 메타데이터 서명을 생성합니다. |
| [SpreadsheetMetadataSignature](spreadsheetmetadatasignature#constructor_1)(string, object) | 미리 정의된 값으로 스프레드시트 메타데이터 서명을 생성합니다. |
...
| 이름 | 설명 |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/spreadsheetmetadatasignature/clone#clone_1)() | 복제 메타데이터 서명 인스턴스. |
| override [Clone](../../groupdocs.signature.domain/spreadsheetmetadatasignature/clone#clone)(object) | 지정된 값으로 스프레드시트 메타데이터 서명 인스턴스를 복제합니다. |
...
| override [ToString](../../groupdocs.signature.domain/spreadsheetmetadatasignature/tostring#tostring)() | 재정의를 통해 문자열로 변환 ToString() method |
| virtual [ToString](../../groupdocs.signature.domain/metadatasignature/tostring)(string) | 지정된 format 의 문자열로 변환합니다. |
| override [ToString](../../groupdocs.signature.domain/spreadsheetmetadatasignature/tostring#tostring_2)(string, IFormatProvider) | 지정된 format 의 문자열로 변환합니다. |
