...
description: 프레젠테이션 메타데이터 서명 속성을 포함합니다.
type: docs
weight: 740
url: /ko/net/groupdocs.signature.domain/presentationmetadatasignature/
---
## PresentationMetadataSignature class

프레젠테이션 메타데이터 서명 속성을 포함합니다.
...
| 이름 | 설명 |
| --- | --- |
| [PresentationMetadataSignature](presentationmetadatasignature#constructor)(string) | 미리 정의된 이름과 빈 값으로 프레젠테이션 메타데이터 서명을 생성합니다 |
| [PresentationMetadataSignature](presentationmetadatasignature#constructor_1)(string, object) | 미리 정의된 values 로 프레젠테이션 메타데이터 서명을 생성합니다. |
...
| 이름 | 설명 |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/presentationmetadatasignature/clone#clone_1)() | 복제 메타데이터 서명 인스턴스. |
| override [Clone](../../groupdocs.signature.domain/presentationmetadatasignature/clone#clone)(object) | 주어진 값으로 슬라이드 메타데이터 서명 인스턴스 복제. |
...
| override [ToString](../../groupdocs.signature.domain/presentationmetadatasignature/tostring#tostring)() | 재정의를 통해 문자열로 변환 ToString() method |
| virtual [ToString](../../groupdocs.signature.domain/metadatasignature/tostring)(string) | 지정된 format 의 문자열로 변환합니다. |
| override [ToString](../../groupdocs.signature.domain/presentationmetadatasignature/tostring#tostring_2)(string, IFormatProvider) | 지정된 format 의 문자열로 변환합니다. |
