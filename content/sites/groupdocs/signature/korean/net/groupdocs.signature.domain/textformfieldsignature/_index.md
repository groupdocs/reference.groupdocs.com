...
description: PDF 문서 에 대한 텍스트 입력 양식 필드 서명 속성을 포함합니다.
type: docs
weight: 960
url: /ko/net/groupdocs.signature.domain/textformfieldsignature/
---
## TextFormFieldSignature class

PDF 문서 에 대한 텍스트 입력 양식 필드 서명 속성을 포함합니다.
...
| 이름 | 설명 |
| --- | --- |
| [TextFormFieldSignature](textformfieldsignature#constructor)(string) | 사전 정의된 이름으로 PdfTextFormFieldSignature를 생성합니다. |
| [TextFormFieldSignature](textformfieldsignature#constructor_1)(string, string) | 사전 정의된 이름으로 PdfTextFormFieldSignature를 생성합니다. |
...
| [Text](../../groupdocs.signature.domain/textformfieldsignature/text) { get; set; } | 양식 필드 텍스트 입력의 텍스트를 가져오거나 설정합니다. |
...
| 이름 | 설명 |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/textformfieldsignature/clone)() | 복제 FormField 서명 인스턴스. |
| override [Equals](../../groupdocs.signature.domain/textformfieldsignature/equals)(object) | 서명 속성을 비교하기 위해 Equals 메서드를 덮어씁니다 |
| override [GetHashCode](../../groupdocs.signature.domain/textformfieldsignature/gethashcode)() | GetHashCode method 재정의 |
