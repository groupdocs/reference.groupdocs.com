...
description: 이미지 서명 속성을 포함합니다.
type: docs
weight: 590
url: /ko/net/groupdocs.signature.domain/imagesignature/
---
...
| 이름 | 설명 |
| --- | --- |
| [ImageSignature](imagesignature)(string) | 검색 과정을 거쳐 얻은 서명 식별자로 ImageSignature 객체를 초기화합니다. 이 고유 식별자는 문서 서명 정보 레이어에서 이 서명에 대한 추가 속성을 찾는 데 사용됩니다. |

## 속성

| 이름 | 설명 |
| --- | --- |
| [Content](../../groupdocs.signature.domain/imagesignature/content) { get; } | 유형의 이미지 이진 데이터 콘텐츠를 지정합니다.[`Format`](./format) . 기본적으로 이 속성은 설정되지 않습니다. 속성 사용[`ReturnContent`](../../groupdocs.signature.options/imagesearchoptions/returncontent) 이 기능을 활성화하려면. |
...
| [Format](../../groupdocs.signature.domain/imagesignature/format) { get; } | 서명 이미지의 형식을 지정합니다. |
...
| [Size](../../groupdocs.signature.domain/imagesignature/size) { get; } | 서명 이미지의 크기를 바이트 단위로 지정합니다. |
...
| 이름 | 설명 |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/imagesignature/clone)() | 복제 바코드 서명 인스턴스. |
| override [Equals](../../groupdocs.signature.domain/imagesignature/equals)(object) | 서명 속성을 비교하기 위해 Equals 메서드를 덮어씁니다 |
| override [GetHashCode](../../groupdocs.signature.domain/imagesignature/gethashcode)() | GetHashCode method 재정의 |
