...
description: 라디오 버튼 입력 양식 필드 서명 속성을 포함합니다.
type: docs
weight: 820
url: /ko/net/groupdocs.signature.domain/radiobuttonformfieldsignature/
---
## RadioButtonFormFieldSignature class

라디오 버튼 입력 양식 필드 서명 속성을 포함합니다.
...
| 이름 | 설명 |
| --- | --- |
| [RadioButtonFormFieldSignature](radiobuttonformfieldsignature#constructor)(string) | 미리 정의된 이름으로 RadioButtonFieldSignature를 만듭니다. |
| [RadioButtonFormFieldSignature](radiobuttonformfieldsignature#constructor_1)(string, List&lt;string&gt;) | 미리 정의된 이름과 항목 목록으로 RadioButtonFieldSignature를 만듭니다. |
| [RadioButtonFormFieldSignature](radiobuttonformfieldsignature#constructor_2)(string, List&lt;string&gt;, object) | 미리 정의된 이름, 항목 목록 및 선택한 값으로 RadioButtonFieldSignature를 만듭니다. |
...
| [Items](../../groupdocs.signature.domain/radiobuttonformfieldsignature/items) { get; set; } | 라디오 버튼 옵션 목록을 가져오거나 설정합니다. |
...
| [Selected](../../groupdocs.signature.domain/radiobuttonformfieldsignature/selected) { get; set; } | 선택한 값을 포함합니다. |
...
| 이름 | 설명 |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/radiobuttonformfieldsignature/clone)() | 복제 FormField 서명 인스턴스. |
| override [Equals](../../groupdocs.signature.domain/radiobuttonformfieldsignature/equals)(object) | 서명 속성을 비교하기 위해 Equals 메서드를 덮어씁니다 |
| override [GetHashCode](../../groupdocs.signature.domain/radiobuttonformfieldsignature/gethashcode)() | GetHashCode method 재정의 |
