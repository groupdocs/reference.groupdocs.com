...
description: 인증서 메타데이터 서명 속성을 포함합니다.
type: docs
weight: 70
url: /ko/net/groupdocs.signature.domain/certificatemetadatasignature/
---
## CertificateMetadataSignature class

인증서 메타데이터 서명 속성을 포함합니다.
...
| 이름 | 설명 |
| --- | --- |
| [CertificateMetadataSignature](certificatemetadatasignature#constructor)(string) | 미리 정의된 이름과 빈 값으로 인증서 메타데이터 서명을 생성합니다. |
| [CertificateMetadataSignature](certificatemetadatasignature#constructor_1)(string, object) | 미리 정의된 값으로 인증서 메타데이터 서명을 생성합니다. |
...
| 이름 | 설명 |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/certificatemetadatasignature/clone#clone_1)() | 복제 메타데이터 서명 인스턴스. |
| override [Clone](../../groupdocs.signature.domain/certificatemetadatasignature/clone#clone)(object) | 주어진 값으로 인증서 메타데이터 서명 인스턴스를 복제합니다. |
...
| override [ToString](../../groupdocs.signature.domain/certificatemetadatasignature/tostring#tostring)() | 재정의를 통해 문자열로 변환 ToString() method |
| virtual [ToString](../../groupdocs.signature.domain/metadatasignature/tostring)(string) | 지정된 format 의 문자열로 변환합니다. |
| override [ToString](../../groupdocs.signature.domain/certificatemetadatasignature/tostring#tostring_2)(string, IFormatProvider) | 지정된 format 의 문자열로 변환합니다. |
