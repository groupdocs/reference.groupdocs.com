...
description: 확인란 입력 양식 필드 서명 속성을 포함합니다.
type: docs
weight: 80
url: /ko/net/groupdocs.signature.domain/checkboxformfieldsignature/
---
## CheckboxFormFieldSignature class

확인란 입력 양식 필드 서명 속성을 포함합니다.
...
| 이름 | 설명 |
| --- | --- |
| [CheckboxFormFieldSignature](checkboxformfieldsignature#constructor)(string) | 미리 정의된 이름으로 CheckboxFormFieldSignature를 생성합니다. |
| [CheckboxFormFieldSignature](checkboxformfieldsignature#constructor_1)(string, bool) | 미리 정의된 이름과 value 로 CheckboxFormFieldSignature를 생성합니다. |

## 속성

| 이름 | 설명 |
| --- | --- |
| [Checked](../../groupdocs.signature.domain/checkboxformfieldsignature/checked) { get; set; } | 양식 필드 확인란 입력의 체크된 값을 가져오거나 설정합니다. |
...
| 이름 | 설명 |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/checkboxformfieldsignature/clone)() | 복제 FormField 서명 인스턴스. |
| override [Equals](../../groupdocs.signature.domain/checkboxformfieldsignature/equals)(object) | 서명 속성을 비교하기 위해 Equals 메서드를 덮어씁니다 |
| override [GetHashCode](../../groupdocs.signature.domain/checkboxformfieldsignature/gethashcode)() | GetHashCode method 재정의 |
