...
description: 이미지 문서에 대한 옵션을 저장합니다.
type: docs
weight: 1400
url: /ko/net/groupdocs.signature.options/imagesaveoptions/
---
## ImageSaveOptions class

이미지 문서에 대한 옵션을 저장합니다.
...
| 이름 | 설명 |
| --- | --- |
| [ImageSaveOptions](imagesaveoptions#constructor)() | 기본값으로 ImagesSaveOptions 클래스의 새 인스턴스를 초기화합니다. |
| [ImageSaveOptions](imagesaveoptions#constructor_1)(bool) | 덮어쓰기 플래그를 사용하여 ImagesSaveOptions 클래스의 새 인스턴스를 초기화합니다. |
| [ImageSaveOptions](imagesaveoptions#constructor_2)(ImageSaveFileFormat, bool) | 지정된 출력 유형 및 덮어쓰기 플래그를 사용하여 ImagesSaveOptions 클래스의 새 인스턴스를 초기화합니다. |
