...
description: WordProcessing 문서에 대한 옵션을 저장합니다.
type: docs
weight: 1790
url: /ko/net/groupdocs.signature.options/wordprocessingsaveoptions/
---
## WordProcessingSaveOptions class

WordProcessing 문서에 대한 옵션을 저장합니다.
...
| 이름 | 설명 |
| --- | --- |
| [WordProcessingSaveOptions](wordprocessingsaveoptions#constructor)() | 기본값으로 WordProcessingSaveOptions 클래스의 새 인스턴스를 초기화합니다. |
| [WordProcessingSaveOptions](wordprocessingsaveoptions#constructor_1)(bool) | 지정된 출력 유형 및 덮어쓰기 플래그를 사용하여 WordProcessingSaveOptions 클래스의 새 인스턴스를 초기화합니다. |
| [WordProcessingSaveOptions](wordprocessingsaveoptions#constructor_2)(WordProcessingSaveFileFormat) | 지정된 출력 파일 형식으로 WordProcessingSaveOptions 클래스의 새 인스턴스를 초기화합니다. |
| [WordProcessingSaveOptions](wordprocessingsaveoptions#constructor_3)(WordProcessingSaveFileFormat, bool) | 지정된 출력 파일 형식 및 덮어쓰기 플래그를 사용하여 WordProcessingSaveOptions 클래스의 새 인스턴스를 초기화합니다. |
...
| [FileFormat](../../groupdocs.signature.options/wordprocessingsaveoptions/fileformat) { get; set; } | 서명된 문서의 파일 형식을 가져오거나 설정합니다. |
