...
description: 스프레드시트 문서 옵션 저장.
type: docs
weight: 1700
url: /ko/net/groupdocs.signature.options/spreadsheetsaveoptions/
---
...
| 이름 | 설명 |
| --- | --- |
| [SpreadsheetSaveOptions](spreadsheetsaveoptions#constructor)() | 기본값으로 SpreadsheetSaveOptions 클래스의 새 인스턴스를 초기화합니다. |
| [SpreadsheetSaveOptions](spreadsheetsaveoptions#constructor_1)(SpreadsheetSaveFileFormat) | 미리 정의된 출력 파일 형식으로 SpreadsheetSaveOptions 클래스의 새 인스턴스를 초기화합니다. |
| [SpreadsheetSaveOptions](spreadsheetsaveoptions#constructor_2)(SpreadsheetSaveFileFormat, bool) | 지정된 출력 유형 및 덮어쓰기 플래그를 사용하여 SpreadsheetSaveOptions 클래스의 새 인스턴스를 초기화합니다. |
...
| [FileFormat](../../groupdocs.signature.options/spreadsheetsaveoptions/fileformat) { get; set; } | 서명된 문서의 파일 형식을 가져오거나 설정합니다. |
