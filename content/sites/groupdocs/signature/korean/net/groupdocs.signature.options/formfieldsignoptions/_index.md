...
description: PDF 문서에 대한 FormField 서명 옵션의 클래스를 나타냅니다.
type: docs
weight: 1380
url: /ko/net/groupdocs.signature.options/formfieldsignoptions/
---
## FormFieldSignOptions class

PDF 문서에 대한 FormField 서명 옵션의 클래스를 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [FormFieldSignOptions](formfieldsignoptions#constructor)() | 기본값을 사용하여 PdfFormFieldSignOptions 클래스의 새 인스턴스를 초기화합니다. |
| [FormFieldSignOptions](formfieldsignoptions#constructor_1)(FormFieldSignature) | FormField 서명을 사용하여 PdfFormFieldSignOptions 클래스의 새 인스턴스를 초기화합니다. |
...
| [Signature](../../groupdocs.signature.options/formfieldsignoptions/signature) { get; set; } | 서명의 FormField를 가져오거나 설정합니다. |
...
* GroupDocs.Signature에 의한 FormField 전자 서명 생성의 기본 사용법: [FormField 서명으로 문서에 전자 서명하는 방법](https://docs.groupdocs.com/display/signaturenet/eSign+document+with+Form+Field+signature)
* GroupDocs.Signature를 사용한 FormField 전자 서명 설정의 고급 사용: [FormField 서명 및 추가 설정으로 전자 서명 문서에 대한 고급 사용](https://docs.groupdocs.com/display/signaturenet/Sign+document+with+Form+Field+signature+-+advanced)
