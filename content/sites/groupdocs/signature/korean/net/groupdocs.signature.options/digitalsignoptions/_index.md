...
description: 디지털 서명 옵션을 나타냅니다.
type: docs
weight: 1340
url: /ko/net/groupdocs.signature.options/digitalsignoptions/
---
...
| 이름 | 설명 |
| --- | --- |
| [DigitalSignOptions](digitalsignoptions#constructor)() | 기본값을 사용하여 DigitalSignOptions 클래스의 새 인스턴스를 초기화합니다. |
| [DigitalSignOptions](digitalsignoptions#constructor_1)(Stream) | 인증서 스트림을 사용하여 DigitalSignOptions 클래스의 새 인스턴스를 초기화합니다. |
| [DigitalSignOptions](digitalsignoptions#constructor_4)(string) | 인증서 파일을 사용하여 DigitalSignOptions 클래스의 새 인스턴스를 초기화합니다. |
| [DigitalSignOptions](digitalsignoptions#constructor_2)(Stream, Stream) | 인증서 스트림 및 이미지 스트림을 사용하여 DigitalSignOptions 클래스의 새 인스턴스를 초기화합니다. |
| [DigitalSignOptions](digitalsignoptions#constructor_3)(Stream, string) | 인증서 스트림 및 이미지 파일을 사용하여 DigitalSignOptions 클래스의 새 인스턴스를 초기화합니다. |
| [DigitalSignOptions](digitalsignoptions#constructor_5)(string, Stream) | 인증서 파일 및 이미지 스트림을 사용하여 DigitalSignOptions 클래스의 새 인스턴스를 초기화합니다. |
| [DigitalSignOptions](digitalsignoptions#constructor_6)(string, string) | 인증서 파일 및 이미지 파일을 사용하여 DigitalSignOptions 클래스의 새 인스턴스를 초기화합니다. |
...
| [CertificateFilePath](../../groupdocs.signature.options/digitalsignoptions/certificatefilepath) { get; set; } | 디지털 인증서 파일 경로를 가져오거나 설정합니다. 이 속성은 CertificateStream이 지정되지 않은 경우에만 사용됩니다. |
| [CertificateStream](../../groupdocs.signature.options/digitalsignoptions/certificatestream) { get; set; } | 디지털 인증서 스트림을 가져오거나 설정합니다. 이 속성이 지정되면 항상 CertificateFilePath 대신 사용됩니다. |
| [Contact](../../groupdocs.signature.options/digitalsignoptions/contact) { get; set; } | 서명 연락처를 가져오거나 설정합니다. |
...
| [Location](../../groupdocs.signature.options/digitalsignoptions/location) { get; set; } | 서명 위치를 가져오거나 설정합니다. |
...
| [Password](../../groupdocs.signature.options/digitalsignoptions/password) { get; set; } | 디지털 인증서의 암호를 가져오거나 설정합니다. |
| [Reason](../../groupdocs.signature.options/digitalsignoptions/reason) { get; set; } | 서명 이유를 가져오거나 설정합니다. |
...
| [Signature](../../groupdocs.signature.options/digitalsignoptions/signature) { get; set; } | 문서 디지털 서명의 속성을 가져오거나 설정합니다. PDF 문서에 서명하기 위해 인스턴스를 사용하여 고급 속성을 설정할 수 있습니다.[`PdfDigitalSignature`](../../groupdocs.signature.domain/pdfdigitalsignature) |
...
| [Visible](../../groupdocs.signature.options/digitalsignoptions/visible) { get; set; } | 서명의 가시성을 가져오거나 설정합니다. |
...
| [XAdESType](../../groupdocs.signature.options/digitalsignoptions/xadestype) { get; set; } | XAdES 유형[`XAdESType`](./xadestype) . 기본값은 없음(XAdES가 꺼져 있음)입니다. 현재 XAdES 서명 유형은 스프레드시트 문서에 대해서만 지원됩니다. |
...
* GroupDocs.Signature에 의한 디지털 전자 서명 생성의 기본 사용법: [디지털 서명으로 문서에 전자 서명하는 방법](https://docs.groupdocs.com/display/signaturenet/eSign+document+with+Digital+signature)
* GroupDocs.Signature를 사용한 디지털 전자 서명 설정의 고급 사용: [디지털 서명 및 추가 설정으로 전자 서명 문서에 대한 고급 사용](https://docs.groupdocs.com/display/signaturenet/Sign+document+with+Digital+signature+-+advanced)
