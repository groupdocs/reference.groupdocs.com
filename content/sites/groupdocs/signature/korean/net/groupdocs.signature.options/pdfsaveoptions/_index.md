...
description: PDF 문서에 대한 옵션을 저장합니다.
type: docs
weight: 1510
url: /ko/net/groupdocs.signature.options/pdfsaveoptions/
---
## PdfSaveOptions class

PDF 문서에 대한 옵션을 저장합니다.
...
| 이름 | 설명 |
| --- | --- |
| [PdfSaveOptions](pdfsaveoptions#constructor)() | 기본값으로 PdfSaveOptions 클래스의 새 인스턴스를 초기화합니다. |
| [PdfSaveOptions](pdfsaveoptions#constructor_1)(bool) | 덮어쓰기 플래그를 사용하여 PdfSaveOptions 클래스의 새 인스턴스를 초기화합니다. |
| [PdfSaveOptions](pdfsaveoptions#constructor_2)(PdfSaveFileFormat) | 지정된 출력 파일 형식으로 PdfSaveOptions 클래스의 새 인스턴스를 초기화합니다. |
| [PdfSaveOptions](pdfsaveoptions#constructor_3)(PdfSaveFileFormat, bool) | 지정된 출력 파일 형식 및 덮어쓰기 플래그를 사용하여 PdfSaveOptions 클래스의 새 인스턴스를 초기화합니다. |
...
| [FileFormat](../../groupdocs.signature.options/pdfsaveoptions/fileformat) { get; set; } | 서명된 문서의 파일 형식을 가져오거나 설정합니다. |
