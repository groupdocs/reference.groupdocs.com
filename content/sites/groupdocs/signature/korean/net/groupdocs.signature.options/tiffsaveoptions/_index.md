...
description: Tiff 이미지 문서에 대한 옵션 저장.
type: docs
weight: 1760
url: /ko/net/groupdocs.signature.options/tiffsaveoptions/
---
## TiffSaveOptions class

Tiff 이미지 문서에 대한 옵션 저장.
...
| 이름 | 설명 |
| --- | --- |
| [TiffSaveOptions](tiffsaveoptions)() | 기본값으로 TiffSaveOptions를 생성합니다. |
...
| [ExpectedTiffFormat](../../groupdocs.signature.options/tiffsaveoptions/expectedtiffformat) { get; set; } | 서명된 문서의 TIFF 형식을 가져오거나 설정합니다. |
