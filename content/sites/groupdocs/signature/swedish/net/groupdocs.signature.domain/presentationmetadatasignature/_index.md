...
description: Innehåller egenskaper för presentationsmetadatasignatur.
type: docs
weight: 740
url: /sv/net/groupdocs.signature.domain/presentationmetadatasignature/
---
## PresentationMetadataSignature class

Innehåller egenskaper för presentationsmetadatasignatur.
...
| namn | Beskrivning |
| --- | --- |
| [PresentationMetadataSignature](presentationmetadatasignature#constructor)(string) | Skapar presentationsmetadatasignatur med fördefinierat namn och tomt värde |
| [PresentationMetadataSignature](presentationmetadatasignature#constructor_1)(string, object) | Skapar presentationsmetadatasignatur med fördefinierade värden |
...
| namn | Beskrivning |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/presentationmetadatasignature/clone#clone_1)() | Clone Metadata Signatur-instans. |
| override [Clone](../../groupdocs.signature.domain/presentationmetadatasignature/clone#clone)(object) | Clone Slides Metadata Signaturinstans med givet värde. |
...
| override [ToString](../../groupdocs.signature.domain/presentationmetadatasignature/tostring#tostring)() | Konverterar till String med åsidosätt ToString() method |
...
| override [ToString](../../groupdocs.signature.domain/presentationmetadatasignature/tostring#tostring_2)(string, IFormatProvider) | Konverterar till sträng med specificerat format |
