...
Innehåller egenskaper för formulärfältsignatur i kombinationsrutan.
...
| namn | Beskrivning |
| --- | --- |
| [ComboboxFormFieldSignature](comboboxformfieldsignature#constructor)(string) | Skapar ComboboxFormFieldSignature med fördefinierat namn. |
| [ComboboxFormFieldSignature](comboboxformfieldsignature#constructor_1)(string, List&lt;string&gt;) | Skapar ComboboxFormFieldSignature med fördefinierat namn och alternativlista. |
| [ComboboxFormFieldSignature](comboboxformfieldsignature#constructor_2)(string, List&lt;string&gt;, object) | Skapar ComboboxFormFieldSignature med fördefinierat namn, alternativlista och valt värde. |
...
| [Items](../../groupdocs.signature.domain/comboboxformfieldsignature/items) { get; set; } | Hämta eller ställ in alternativlista med kombinationsruta. |
...
| [Selected](../../groupdocs.signature.domain/comboboxformfieldsignature/selected) { get; set; } | Hämta eller ange valt värde. |
...
| namn | Beskrivning |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/comboboxformfieldsignature/clone)() | Clone FormField Signature-instans. |
| override [Equals](../../groupdocs.signature.domain/comboboxformfieldsignature/equals)(object) | Skriver över Equals-metoden för att jämföra signaturegenskaper |
| override [GetHashCode](../../groupdocs.signature.domain/comboboxformfieldsignature/gethashcode)() | Åsidosätter GetHashCode method |
