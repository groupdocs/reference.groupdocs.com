...
Representerar QR-kodsignaturalternativen.
...
| namn | Beskrivning |
| --- | --- |
| [QrCodeSignOptions](qrcodesignoptions#constructor)() | Initierar en ny instans av QRCodeSignOptions-klassen med standardvärden. |
| [QrCodeSignOptions](qrcodesignoptions#constructor_1)(string) | Initierar en ny instans av QRCodeSignOptions-klassen med text. |
| [QrCodeSignOptions](qrcodesignoptions#constructor_2)(string, QrCodeType) | Initierar en ny instans av klassen BarcodeSignOptions med text. |
...
| [CodeTextAlignment](../../groupdocs.signature.options/qrcodesignoptions/codetextalignment) { get; set; } | Hämtar eller ställer in justeringen av text i resultatet QR-kodbild. Standardvärdet är None. |
| [Data](../../groupdocs.signature.options/qrcodesignoptions/data) { get; set; } | Hämtar eller ställer in anpassat objekt för att serialiseras till QR-kodinnehåll. |
| [DataEncryption](../../groupdocs.signature.options/qrcodesignoptions/dataencryption) { get; set; } | Får eller ställer in implementering av[`IDataEncryption`](../../groupdocs.signature.domain.extensions/idataencryption) gränssnitt för att koda och avkoda QR-kodsignaturtext- eller dataegenskaper. |
...
| [EncodeType](../../groupdocs.signature.options/qrcodesignoptions/encodetype) { get; set; } | Hämtar eller ställer in QR-kodtyp. |
...
| [LogoFilePath](../../groupdocs.signature.options/qrcodesignoptions/logofilepath) { get; set; } | Hämtar eller ställer in QR-kodens logotypbilds filnamn. Den här egenskapen används endast om LogoStream inte är specificerad. Användning av den här egenskapen kan orsaka problem med verifieringen. Använd den försiktigt. |
| [LogoStream](../../groupdocs.signature.options/qrcodesignoptions/logostream) { get; set; } | Hämtar eller ställer in QR-kodens logotypbildström. Om den här egenskapen anges används den alltid istället LogoFilePath. Användning av den här egenskapen kan orsaka problem med verifieringen. Använd den försiktigt. |
...
* Grundläggande användning av att skapa QR-kod elektronisk signatur av GroupDocs.Signatur: [Hur man e-signerar dokument med QR-kodsignatur](https://docs.groupdocs.com/display/signaturenet/eSign+document+with+QR-code+signature)
* Avancerad användning av inställningar för QR-kod elektronisk signatur med GroupDocs.Signatur: [Avancerad användning för eSign-dokument med QR-kodsignatur och ytterligare inställningar](https://docs.groupdocs.com/display/signaturenet/Sign+document+with+QR-code+signature+-+advanced)
