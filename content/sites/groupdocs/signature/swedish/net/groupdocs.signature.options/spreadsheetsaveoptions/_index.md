...
Spara alternativ för kalkylarksdokument.
...
| namn | Beskrivning |
| --- | --- |
| [SpreadsheetSaveOptions](spreadsheetsaveoptions#constructor)() | Initierar en ny instans av SpreadsheetSaveOptions-klassen med standardvärden. |
| [SpreadsheetSaveOptions](spreadsheetsaveoptions#constructor_1)(SpreadsheetSaveFileFormat) | Initierar en ny instans av SpreadsheetSaveOptions-klassen med fördefinierat utdatafilformat. |
| [SpreadsheetSaveOptions](spreadsheetsaveoptions#constructor_2)(SpreadsheetSaveFileFormat, bool) | Initierar en ny instans av SpreadsheetSaveOptions-klassen med specificerad utdatatyp och överskrivningsflagga. |
...
| [FileFormat](../../groupdocs.signature.options/spreadsheetsaveoptions/fileformat) { get; set; } | Hämtar eller ställer in filformat för signerat dokument. |
