...
description: Representerar klass av FormFields signaturalternativ för PDFdokument.
type: docs
weight: 1380
url: /sv/net/groupdocs.signature.options/formfieldsignoptions/
---
## FormFieldSignOptions class

Representerar klass av FormFields signaturalternativ för PDF-dokument.
...
| namn | Beskrivning |
| --- | --- |
| [FormFieldSignOptions](formfieldsignoptions#constructor)() | Initierar en ny instans av klassen PdfFormFieldSignOptions med standardvärden. |
| [FormFieldSignOptions](formfieldsignoptions#constructor_1)(FormFieldSignature) | Initierar en ny instans av klassen PdfFormFieldSignOptions med FormField-signatur. |
...
| [Signature](../../groupdocs.signature.options/formfieldsignoptions/signature) { get; set; } | Hämtar eller ställer in formfältet för signatur. |
...
* Grundläggande användning för att skapa FormField elektronisk signatur av GroupDocs.Signatur: [Hur man e-signerar dokument med FormField-signatur](https://docs.groupdocs.com/display/signaturenet/eSign+document+with+Form+Field+signature)
* Avancerad användning av inställningar för FormField elektronisk signatur med GroupDocs.Signatur: [Avancerad användning för eSign-dokument med FormField-signatur och ytterligare inställningar](https://docs.groupdocs.com/display/signaturenet/Sign+document+with+Form+Field+signature+-+advanced)
