...
| Name | Description |
| --- | --- |
| [CheckboxFormFieldSignature](checkboxformfieldsignature#constructor)(string) | Creates CheckboxFormFieldSignature with predefined name. |
| [CheckboxFormFieldSignature](checkboxformfieldsignature#constructor_1)(string, bool) | Creates CheckboxFormFieldSignature with predefined name and value |

## Properties

| Name | Description |
| --- | --- |
| [Checked](../../groupdocs.signature.domain/checkboxformfieldsignature/checked) { get; set; } | Gets or sets checked value of form field check-box input. |
