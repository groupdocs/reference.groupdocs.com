...
| Name | Description |
| --- | --- |
| [TextFormFieldSignature](textformfieldsignature#constructor)(string) | Creates PdfTextFormFieldSignature with predefined name. |
| [TextFormFieldSignature](textformfieldsignature#constructor_1)(string, string) | Creates PdfTextFormFieldSignature with predefined name. |
...
| [Text](../../groupdocs.signature.domain/textformfieldsignature/text) { get; set; } | Gets or sets text of form field text input. |
