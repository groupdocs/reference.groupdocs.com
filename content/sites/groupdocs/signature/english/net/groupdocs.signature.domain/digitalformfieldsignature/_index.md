...
| Name | Description |
| --- | --- |
| [DigitalFormFieldSignature](digitalformfieldsignature)(string) | Creates PdfDigitalFormFieldSignature with predefined name. |
...
| [Signed](../../groupdocs.signature.domain/digitalformfieldsignature/signed) { get; } | Read-only property that shows if Form-field Signature was signed with digital certificate. |
