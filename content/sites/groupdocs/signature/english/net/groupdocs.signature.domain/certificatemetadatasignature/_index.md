...
type: docs
weight: 70
url: /net/groupdocs.signature.domain/certificatemetadatasignature/
---
...
| Name | Description |
| --- | --- |
| [CertificateMetadataSignature](certificatemetadatasignature#constructor)(string) | Creates Certificate Metadata Signature with predefined name and empty value. |
| [CertificateMetadataSignature](certificatemetadatasignature#constructor_1)(string, object) | Creates Certificate Metadata Signature with predefined values. |
...
| Name | Description |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/certificatemetadatasignature/clone#clone_1)() | Clone Metadata Signature instance. |
| override [Clone](../../groupdocs.signature.domain/certificatemetadatasignature/clone#clone)(object) | Clone Certificate Metadata Signature instance with given value. |
...
| override [ToString](../../groupdocs.signature.domain/certificatemetadatasignature/tostring#tostring)() | Converts to String with override ToString() method |
| virtual [ToString](../../groupdocs.signature.domain/metadatasignature/tostring)(string) | Converts to String with specified format |
| override [ToString](../../groupdocs.signature.domain/certificatemetadatasignature/tostring#tostring_2)(string, IFormatProvider) | Converts to String with specified format |
