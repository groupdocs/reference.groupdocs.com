...
type: docs
weight: 11
url: /java/com.groupdocs.signature.domain.documentpreview/filetype/
---
**Inheritance:**
java.lang.Object
```
...
parameter is [FileType](../../com.groupdocs.signature.domain.documentpreview/filetype) and is the same as current [FileType](../../com.groupdocs.signature.domain.documentpreview/filetype) object; otherwise,
...
if both [FileType](../../com.groupdocs.signature.domain.documentpreview/filetype) objects are not the same; otherwise,
