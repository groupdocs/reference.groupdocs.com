...
| [setHideSignatures(boolean value)](#setHideSignatures-boolean-) | Gets or sets flag to hide signatures from page preview image.
 |
| [getResolution()](#getResolution--) | Gets the resolution of the preview images in DPI (dots per inch).
 |
| [setResolution(int value)](#setResolution-int-) | Sets the resolution of the preview images in DPI (dots per inch).
 |
...
Gets the resolution of the preview images in DPI (dots per inch).
...
Sets the resolution of the preview images in DPI (dots per inch).
