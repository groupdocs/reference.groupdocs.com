...
| Method | Description |
| --- | --- |
| [getName()](#getName--) | Gets or sets the name, either the first and last name of a natural person or
the company name of a legal person.
 |
| [setName(String value)](#setName-java.lang.String-) | Gets or sets the name, either the first and last name of a natural person or
the company name of a legal person.
 |
