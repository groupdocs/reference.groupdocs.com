...
Each Signature [BaseSignature](../../com.groupdocs.signature.domain.signatures/basesignature) has Deleted flag 
BaseSignature.Deleted
([BaseSignature.getDeleted](../../com.groupdocs.signature.domain.signatures/basesignature#getDeleted)/[BaseSignature.setDeleted(boolean)](../../com.groupdocs.signature.domain.signatures/basesignature#setDeleted-boolean-)) to detect if it was deleted.
...
The level of the logging to limit the messages (All, Traces, Warnings, Errors). 
LogLevel
.
