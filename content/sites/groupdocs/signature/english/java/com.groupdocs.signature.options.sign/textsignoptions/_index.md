...
(pixels, percents or millimeters see [MeasureType](../../com.groupdocs.signature.domain.enums/measuretype) LocationMeasureType property).
 |
...
(pixels, percents or millimeters see [MeasureType](../../com.groupdocs.signature.domain.enums/measuretype) SizeMeasureType property).
 |
...
(see [TextSignatureImplementation](../../com.groupdocs.signature.domain.enums/textsignatureimplementation) SignatureImplementation property).
