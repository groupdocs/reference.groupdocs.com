...
description: 
type: docs
url: /python-net/groupdocs.signature.domain/documentresultsignature/succeeded/
is_root: false
weight: 190
---
...
List of successfully processed signatures [`BaseSignature`](/signature/python-net/groupdocs.signature.domain/basesignature).
### Definition:
```python
@property
def succeeded(self):
