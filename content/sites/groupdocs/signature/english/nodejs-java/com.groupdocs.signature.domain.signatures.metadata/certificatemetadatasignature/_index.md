...
type: docs
weight: 10
url: /nodejs-java/com.groupdocs.signature.domain.signatures.metadata/certificatemetadatasignature/
---
**Inheritance:**
...
```
public final class CertificateMetadataSignature extends MetadataSignature
```
...
| --- | --- |
| [CertificateMetadataSignature(String name)](#CertificateMetadataSignature-java.lang.String-) | Creates Certificate Metadata Signature with predefined name and empty value. |
| [CertificateMetadataSignature(String name, Object value)](#CertificateMetadataSignature-java.lang.String-java.lang.Object-) | Creates Certificate Metadata Signature with predefined values. |
## Methods

| Method | Description |
| --- | --- |
| [deepClone()](#deepClone--) | Clone Metadata Signature instance. |
| [deepClone(Object value)](#deepClone-java.lang.Object-) | Clone Certificate Metadata Signature instance with given value. |
...
### CertificateMetadataSignature(String name) {#CertificateMetadataSignature-java.lang.String-}
```
...
| --- | --- | --- |
| name | java.lang.String | Certificate Metadata Signature name. |

### CertificateMetadataSignature(String name, Object value) {#CertificateMetadataSignature-java.lang.String-java.lang.Object-}
```
