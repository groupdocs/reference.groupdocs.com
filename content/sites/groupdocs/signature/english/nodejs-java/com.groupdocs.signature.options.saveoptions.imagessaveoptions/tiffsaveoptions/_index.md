...
type: docs
weight: 24
url: /nodejs-java/com.groupdocs.signature.options.saveoptions.imagessaveoptions/tiffsaveoptions/
---
**Inheritance:**
...
**Returns:**
int
### setExpectedTiffFormat(int value) {#setExpectedTiffFormat-int-}
```
