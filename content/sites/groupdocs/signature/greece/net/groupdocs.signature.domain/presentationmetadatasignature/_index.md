...
description: Περιέχει ιδιότητες υπογραφής μεταδεδομένων παρουσίασης.
type: docs
weight: 740
url: /el/net/groupdocs.signature.domain/presentationmetadatasignature/
---
## PresentationMetadataSignature class

Περιέχει ιδιότητες υπογραφής μεταδεδομένων παρουσίασης.
...
| Ονομα | Περιγραφή |
| --- | --- |
| [PresentationMetadataSignature](presentationmetadatasignature#constructor)(string) | Δημιουργεί υπογραφή μεταδεδομένων παρουσίασης με προκαθορισμένο όνομα και κενή τιμή |
| [PresentationMetadataSignature](presentationmetadatasignature#constructor_1)(string, object) | Δημιουργεί υπογραφή μεταδεδομένων παρουσίασης με προκαθορισμένες τιμές |
...
| Ονομα | Περιγραφή |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/presentationmetadatasignature/clone#clone_1)() | Περίπτωση υπογραφής μεταδεδομένων κλωνοποίησης. |
| override [Clone](../../groupdocs.signature.domain/presentationmetadatasignature/clone#clone)(object) | Στιγμιότυπο υπογραφής μεταδεδομένων κλώνων διαφανειών με δεδομένη τιμή. |
...
| override [ToString](../../groupdocs.signature.domain/presentationmetadatasignature/tostring#tostring)() | Μετατρέπεται σε συμβολοσειρά με μέθοδο παράκαμψης ToString() |
...
| override [ToString](../../groupdocs.signature.domain/presentationmetadatasignature/tostring#tostring_2)(string, IFormatProvider) | Μετατρέπεται σε συμβολοσειρά με καθορισμένη μορφή |
