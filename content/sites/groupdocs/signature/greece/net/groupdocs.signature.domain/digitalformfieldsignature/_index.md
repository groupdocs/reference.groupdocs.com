...
description: Περιέχει ιδιότητες πεδίου φόρμας εισαγωγής ψηφιακής υπογραφής για έγγραφα Pdf.
type: docs
weight: 140
url: /el/net/groupdocs.signature.domain/digitalformfieldsignature/
---
## DigitalFormFieldSignature class

Περιέχει ιδιότητες πεδίου φόρμας εισαγωγής ψηφιακής υπογραφής για έγγραφα Pdf.
...
| Ονομα | Περιγραφή |
| --- | --- |
| [DigitalFormFieldSignature](digitalformfieldsignature)(string) | Δημιουργεί PdfDigitalFormFieldSignature με προκαθορισμένο όνομα. |
...
| [Signed](../../groupdocs.signature.domain/digitalformfieldsignature/signed) { get; } | Ιδιότητα μόνο για ανάγνωση που δείχνει εάν η Υπογραφή πεδίου φόρμας υπογράφηκε με ψηφιακό πιστοποιητικό. |
...
| Ονομα | Περιγραφή |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/digitalformfieldsignature/clone)() | Clone FormField Instance Signature. |
| override [Equals](../../groupdocs.signature.domain/digitalformfieldsignature/equals)(object) | Αντικαθιστά τη μέθοδο Equals για σύγκριση ιδιοτήτων υπογραφής |
| override [GetHashCode](../../groupdocs.signature.domain/digitalformfieldsignature/gethashcode)() | Αντικαθιστά τη μέθοδο GetHashCode |
