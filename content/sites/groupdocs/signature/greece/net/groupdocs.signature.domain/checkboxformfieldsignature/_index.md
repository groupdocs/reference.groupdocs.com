...
description: Περιέχει ιδιότητες υπογραφής πεδίου φόρμας εισαγωγής πλαισίου ελέγχου.
type: docs
weight: 80
url: /el/net/groupdocs.signature.domain/checkboxformfieldsignature/
---
## CheckboxFormFieldSignature class

Περιέχει ιδιότητες υπογραφής πεδίου φόρμας εισαγωγής πλαισίου ελέγχου.
...
| Ονομα | Περιγραφή |
| --- | --- |
| [CheckboxFormFieldSignature](checkboxformfieldsignature#constructor)(string) | Δημιουργεί CheckboxFormFieldSignature με προκαθορισμένο όνομα. |
| [CheckboxFormFieldSignature](checkboxformfieldsignature#constructor_1)(string, bool) | Δημιουργεί CheckboxFormFieldSignature με προκαθορισμένο όνομα και τιμή |

## Ιδιότητες

| Ονομα | Περιγραφή |
| --- | --- |
| [Checked](../../groupdocs.signature.domain/checkboxformfieldsignature/checked) { get; set; } | Λαμβάνει ή ορίζει την επιλεγμένη τιμή του πεδίου φόρμας εισαγωγή πλαισίου ελέγχου. |
...
| Ονομα | Περιγραφή |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/checkboxformfieldsignature/clone)() | Clone FormField Instance Signature. |
| override [Equals](../../groupdocs.signature.domain/checkboxformfieldsignature/equals)(object) | Αντικαθιστά τη μέθοδο Equals για σύγκριση ιδιοτήτων υπογραφής |
| override [GetHashCode](../../groupdocs.signature.domain/checkboxformfieldsignature/gethashcode)() | Αντικαθιστά τη μέθοδο GetHashCode |
