...
description: Περιέχει ιδιότητες υπογραφής μεταδεδομένων Pdf.
type: docs
weight: 680
url: /el/net/groupdocs.signature.domain/pdfmetadatasignature/
---
## PdfMetadataSignature class

Περιέχει ιδιότητες υπογραφής μεταδεδομένων Pdf.
...
| Ονομα | Περιγραφή |
| --- | --- |
| [PdfMetadataSignature](pdfmetadatasignature#constructor)(string) | Δημιουργεί υπογραφή μεταδεδομένων Pdf με προκαθορισμένο όνομα και κενή τιμή |
| [PdfMetadataSignature](pdfmetadatasignature#constructor_1)(string, object) | Δημιουργεί υπογραφή μεταδεδομένων Pdf με προκαθορισμένες τιμές |
| [PdfMetadataSignature](pdfmetadatasignature#constructor_2)(string, object, string) | Δημιουργεί υπογραφή μεταδεδομένων Pdf με προκαθορισμένες τιμές |
...
| [TagPrefix](../../groupdocs.signature.domain/pdfmetadatasignature/tagprefix) { get; set; } | Η ετικέτα προθέματος του ονόματος της υπογραφής μεταδεδομένων Pdf. Από προεπιλογή αυτή η ιδιότητα έχει οριστεί σε "xmp". Οι πιθανές τιμές είναι |
...
| Ονομα | Περιγραφή |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/pdfmetadatasignature/clone#clone_1)() | Περίπτωση υπογραφής μεταδεδομένων κλωνοποίησης. |
| override [Clone](../../groupdocs.signature.domain/pdfmetadatasignature/clone#clone)(object) | Κλωνοποίηση στιγμιότυπο υπογραφής μεταδεδομένων Pdf με δεδομένη τιμή. |
| override [Equals](../../groupdocs.signature.domain/pdfmetadatasignature/equals)(object) | Αντικαθιστά τη μέθοδο Equals για σύγκριση ιδιοτήτων υπογραφής |
...
| override [GetHashCode](../../groupdocs.signature.domain/pdfmetadatasignature/gethashcode)() | Αντικαθιστά τη μέθοδο GetHashCode |
...
| override [ToString](../../groupdocs.signature.domain/metadatasignature/tostring)() | Μετατρέπεται σε συμβολοσειρά με μέθοδο παράκαμψης ToString() |
...
| virtual [ToString](../../groupdocs.signature.domain/metadatasignature/tostring)(string, IFormatProvider) | Μετατρέπεται σε συμβολοσειρά με καθορισμένη μορφή |
