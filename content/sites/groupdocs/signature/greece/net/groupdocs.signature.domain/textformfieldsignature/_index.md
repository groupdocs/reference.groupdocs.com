...
description: Περιέχει ιδιότητες υπογραφής πεδίου φόρμας εισαγωγής κειμένου για έγγραφο Pdf
type: docs
weight: 960
url: /el/net/groupdocs.signature.domain/textformfieldsignature/
---
## TextFormFieldSignature class

Περιέχει ιδιότητες υπογραφής πεδίου φόρμας εισαγωγής κειμένου για έγγραφο Pdf
...
| Ονομα | Περιγραφή |
| --- | --- |
| [TextFormFieldSignature](textformfieldsignature#constructor)(string) | Δημιουργεί PdfTextFormFieldSignature με προκαθορισμένο όνομα. |
| [TextFormFieldSignature](textformfieldsignature#constructor_1)(string, string) | Δημιουργεί PdfTextFormFieldSignature με προκαθορισμένο όνομα. |
...
| [Text](../../groupdocs.signature.domain/textformfieldsignature/text) { get; set; } | Λαμβάνει ή ορίζει κείμενο εισαγωγής κειμένου πεδίου φόρμας. |
...
| Ονομα | Περιγραφή |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/textformfieldsignature/clone)() | Clone FormField Instance Signature. |
| override [Equals](../../groupdocs.signature.domain/textformfieldsignature/equals)(object) | Αντικαθιστά τη μέθοδο Equals για σύγκριση ιδιοτήτων υπογραφής |
| override [GetHashCode](../../groupdocs.signature.domain/textformfieldsignature/gethashcode)() | Αντικαθιστά τη μέθοδο GetHashCode |
