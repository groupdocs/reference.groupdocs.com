...
description: Περιέχει ιδιότητες υπογραφής μεταδεδομένων πιστοποιητικού.
type: docs
weight: 70
url: /el/net/groupdocs.signature.domain/certificatemetadatasignature/
---
## CertificateMetadataSignature class

Περιέχει ιδιότητες υπογραφής μεταδεδομένων πιστοποιητικού.
...
| Ονομα | Περιγραφή |
| --- | --- |
| [CertificateMetadataSignature](certificatemetadatasignature#constructor)(string) | Δημιουργεί υπογραφή μεταδεδομένων πιστοποιητικού με προκαθορισμένο όνομα και κενή τιμή. |
| [CertificateMetadataSignature](certificatemetadatasignature#constructor_1)(string, object) | Δημιουργεί υπογραφή μεταδεδομένων πιστοποιητικού με προκαθορισμένες τιμές. |
...
| Ονομα | Περιγραφή |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/certificatemetadatasignature/clone#clone_1)() | Περίπτωση υπογραφής μεταδεδομένων κλωνοποίησης. |
| override [Clone](../../groupdocs.signature.domain/certificatemetadatasignature/clone#clone)(object) | Στιγμιότυπο υπογραφής μεταδεδομένων πιστοποιητικού κλωνοποίησης με δεδομένη τιμή. |
...
| override [ToString](../../groupdocs.signature.domain/certificatemetadatasignature/tostring#tostring)() | Μετατρέπεται σε συμβολοσειρά με μέθοδο παράκαμψης ToString() |
...
| override [ToString](../../groupdocs.signature.domain/certificatemetadatasignature/tostring#tostring_2)(string, IFormatProvider) | Μετατρέπεται σε συμβολοσειρά με καθορισμένη μορφή |
