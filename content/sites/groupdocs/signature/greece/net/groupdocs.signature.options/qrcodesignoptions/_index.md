...
description: Αντιπροσωπεύει τις επιλογές υπογραφής QRCode.
type: docs
weight: 1630
url: /el/net/groupdocs.signature.options/qrcodesignoptions/
---
## QrCodeSignOptions class

Αντιπροσωπεύει τις επιλογές υπογραφής QR-Code.
...
| Ονομα | Περιγραφή |
| --- | --- |
| [QrCodeSignOptions](qrcodesignoptions#constructor)() | Αρχικοποιεί μια νέα παρουσία της κλάσης QRCodeSignOptions με προεπιλεγμένες τιμές. |
| [QrCodeSignOptions](qrcodesignoptions#constructor_1)(string) | Αρχικοποιεί μια νέα παρουσία της κλάσης QRCodeSignOptions με κείμενο. |
| [QrCodeSignOptions](qrcodesignoptions#constructor_2)(string, QrCodeType) | Αρχικοποιεί μια νέα παρουσία της κλάσης BarcodeSignOptions με κείμενο. |
...
| [CodeTextAlignment](../../groupdocs.signature.options/qrcodesignoptions/codetextalignment) { get; set; } | Λαμβάνει ή ορίζει τη στοίχιση του κειμένου στην εικόνα του κωδικού QR του αποτελέσματος. Η προεπιλεγμένη τιμή είναι Καμία. |
| [Data](../../groupdocs.signature.options/qrcodesignoptions/data) { get; set; } | Λαμβάνει ή ορίζει προσαρμοσμένο αντικείμενο για σειριοποίηση σε περιεχόμενο QR-Code. |
| [DataEncryption](../../groupdocs.signature.options/qrcodesignoptions/dataencryption) { get; set; } | Λαμβάνει ή ορίζει την υλοποίηση του[`IDataEncryption`](../../groupdocs.signature.domain.extensions/idataencryption) διεπαφή για κωδικοποίηση και αποκωδικοποίηση ιδιοτήτων κειμένου ή δεδομένων υπογραφής κώδικα QR. |
...
| [EncodeType](../../groupdocs.signature.options/qrcodesignoptions/encodetype) { get; set; } | Λήψη ή ορισμό τύπου QR-Code. |
...
| override [ForeColor](../../groupdocs.signature.options/qrcodesignoptions/forecolor) { get; set; } | Λαμβάνει ή ορίζει το χρώμα εμπρός των γραμμών QR-Code Η χρήση αυτής της ιδιότητας μπορεί να προκαλέσει προβλήματα με την επαλήθευση. Χρησιμοποιήστε το προσεκτικά. |
...
| [InnerMargins](../../groupdocs.signature.options/qrcodesignoptions/innermargins) { get; set; } | Λαμβάνει ή ορίζει το διάστημα μεταξύ των στοιχείων QR-Code και των περιγραμμάτων εικόνας του αποτελέσματος. |
...
| [LogoFilePath](../../groupdocs.signature.options/qrcodesignoptions/logofilepath) { get; set; } | Λαμβάνει ή ορίζει το όνομα αρχείου εικόνας λογότυπου με κωδικό QR. Αυτή η ιδιότητα χρησιμοποιείται μόνο εάν δεν έχει καθοριστεί το LogoStream. Η χρήση αυτής της ιδιότητας μπορεί να προκαλέσει προβλήματα με την επαλήθευση. Χρησιμοποιήστε το προσεκτικά. |
| [LogoStream](../../groupdocs.signature.options/qrcodesignoptions/logostream) { get; set; } | Λαμβάνει ή ορίζει τη ροή εικόνας με λογότυπο με κωδικό QR. Εάν αυτή η ιδιότητα έχει καθοριστεί, χρησιμοποιείται πάντα αντί για LogoFilePath. Η χρήση αυτής της ιδιότητας μπορεί να προκαλέσει προβλήματα με την επαλήθευση. Χρησιμοποιήστε το προσεκτικά. |
...
| [ReturnContent](../../groupdocs.signature.options/qrcodesignoptions/returncontent) { get; set; } | Λαμβάνει ή ορίζει τη σημαία για τη λήψη περιεχομένου εικόνας με κωδικό QR μιας υπογραφής που τοποθετήθηκε στη σελίδα εγγράφου. Εάν αυτή η σημαία οριστεί true, το περιεχόμενο εικόνας υπογραφής QR-Code θα διατηρήσει τα ακατέργαστα δεδομένα εικόνας σύμφωνα με την απαιτούμενη μορφή[`ReturnContentType`](./returncontenttype) . Από προεπιλογή αυτή η επιλογή είναι απενεργοποιημένη. |
| [ReturnContentType](../../groupdocs.signature.options/qrcodesignoptions/returncontenttype) { get; set; } | Καθορίζει τον τύπο αρχείου του επιστρεφόμενου περιεχομένου εικόνας της υπογραφής QR-Code όταν είναι ενεργοποιημένη η ιδιότητα ReturnContent. Από προεπιλογή ορίζεται σε Null. Αυτό σημαίνει να επιστρέψετε το περιεχόμενο εικόνας με κωδικό QR στην αρχική μορφή. Αυτή η μορφή εικόνας καθορίζεται στο[`Format`](../../groupdocs.signature.domain/qrcodesignature/format) Οι πιθανές υποστηριζόμενες τιμές είναι: FileType.JPEG, FileType.PNG, FileType.BMP. Εάν δεν υποστηρίζεται η παρεχόμενη μορφή, θα επιστραφεί περιεχόμενο εικόνας με κωδικό QR σε μορφή .png. |
...
* Βασική χρήση της δημιουργίας ηλεκτρονικής υπογραφής QR-Code από το GroupDocs.Υπογραφή: [Πώς να υπογράψετε έγγραφο με υπογραφή QR-Code](https://docs.groupdocs.com/display/signaturenet/eSign+document+with+QR-code+signature)
* Προηγμένη χρήση των ρυθμίσεων της ηλεκτρονικής υπογραφής QR-Code με GroupDocs.Υπογραφή: [Προηγμένη χρήση στο έγγραφο eSign με υπογραφή QR-Code και πρόσθετες ρυθμίσεις](https://docs.groupdocs.com/display/signaturenet/Sign+document+with+QR-code+signature+-+advanced)
