...
description: Αντιπροσωπεύει τις επιλογές υπογραφής εικόνας.
type: docs
weight: 1420
url: /el/net/groupdocs.signature.options/imagesignoptions/
---
## ImageSignOptions class

Αντιπροσωπεύει τις επιλογές υπογραφής εικόνας.
...
| Ονομα | Περιγραφή |
| --- | --- |
| [ImageSignOptions](imagesignoptions#constructor)() | Αρχικοποιεί μια νέα παρουσία της κλάσης ImageSignOptions με προεπιλεγμένες τιμές. |
| [ImageSignOptions](imagesignoptions#constructor_1)(Stream) | Αρχικοποιεί μια νέα παρουσία της κλάσης ImageSignOptions με ροή εικόνας. |
| [ImageSignOptions](imagesignoptions#constructor_2)(string) | Αρχικοποιεί μια νέα παρουσία της κλάσης ImageSignOptions με αρχείο εικόνας. |
...
| Ονομα | Περιγραφή |
| --- | --- |
| static [FromBase64](../../groupdocs.signature.options/imagesignoptions/frombase64)(string) | Δημιουργεί μια νέα παρουσία της κλάσης ImageSignOptions με προκαθορισμένη εικόνα από το Base64. |
...
* Βασική χρήση της δημιουργίας ηλεκτρονικής υπογραφής εικόνας από το GroupDocs. Υπογραφή: [Πώς να υπογράψετε έγγραφο με υπογραφή εικόνας](https://docs.groupdocs.com/display/signaturenet/eSign+document+with+Image+signature)
* Προηγμένη χρήση των ρυθμίσεων της ηλεκτρονικής υπογραφής εικόνας με το GroupDocs.Υπογραφή: [Προηγμένη χρήση στο έγγραφο eSign με υπογραφή εικόνας και πρόσθετες ρυθμίσεις](https://docs.groupdocs.com/display/signaturenet/Sign+document+with+Image+signature+-+advanced)
