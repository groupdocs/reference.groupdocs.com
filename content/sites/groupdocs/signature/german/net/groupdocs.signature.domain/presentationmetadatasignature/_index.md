...
description: Enthält PräsentationsmetadatenSignatureigenschaften.
type: docs
weight: 710
url: /de/net/groupdocs.signature.domain/presentationmetadatasignature/
---
## PresentationMetadataSignature class

Enthält Präsentationsmetadaten-Signatureigenschaften.
...
| Name | Beschreibung |
| --- | --- |
| [PresentationMetadataSignature](presentationmetadatasignature#constructor)(string) | Erstellt Präsentationsmetadaten-Signatur mit vordefiniertem Namen und leerem Wert |
| [PresentationMetadataSignature](presentationmetadatasignature#constructor_1)(string, object) | Erstellt eine Präsentationsmetadaten-Signatur mit vordefinierten Werten |
...
| Name | Beschreibung |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/presentationmetadatasignature/clone#clone_1)() | Instanz der Metadaten-Signatur klonen. |
| override [Clone](../../groupdocs.signature.domain/presentationmetadatasignature/clone#clone)(object) | Instanz der Folienmetadaten-Signatur mit dem angegebenen Wert klonen. |
...
| override [ToString](../../groupdocs.signature.domain/presentationmetadatasignature/tostring#tostring)() | Konvertiert in String mit override ToString() method |
...
| override [ToString](../../groupdocs.signature.domain/presentationmetadatasignature/tostring#tostring_2)(string, IFormatProvider) | Konvertiert in eine Zeichenfolge mit dem angegebenen Format |
