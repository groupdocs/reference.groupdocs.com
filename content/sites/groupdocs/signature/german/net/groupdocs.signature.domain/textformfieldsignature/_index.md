...
description: Enthält Signatureigenschaften des Texteingabeformularfelds für das PDFDokument
type: docs
weight: 930
url: /de/net/groupdocs.signature.domain/textformfieldsignature/
---
## TextFormFieldSignature class

Enthält Signatureigenschaften des Texteingabeformularfelds für das PDF-Dokument
...
| Name | Beschreibung |
| --- | --- |
| [TextFormFieldSignature](textformfieldsignature#constructor)(string) | Erstellt PdfTextFormFieldSignature mit vordefiniertem Namen. |
| [TextFormFieldSignature](textformfieldsignature#constructor_1)(string, string) | Erstellt PdfTextFormFieldSignature mit vordefiniertem Namen. |
...
| [Text](../../groupdocs.signature.domain/textformfieldsignature/text) { get; set; } | Liest oder setzt Text der Formularfeld-Texteingabe. |
...
| Name | Beschreibung |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/textformfieldsignature/clone)() | FormField-Signaturinstanz klonen. |
| override [Equals](../../groupdocs.signature.domain/textformfieldsignature/equals)(object) | Überschreibt die Equals-Methode, um Signatureigenschaften zu vergleichen |
| override [GetHashCode](../../groupdocs.signature.domain/textformfieldsignature/gethashcode)() | überschreibt die GetHashCode-Methode |
