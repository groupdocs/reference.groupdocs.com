...
description: Enthält ZertifikatMetadatenSignatureigenschaften.
type: docs
weight: 70
url: /de/net/groupdocs.signature.domain/certificatemetadatasignature/
---
## CertificateMetadataSignature class

Enthält Zertifikat-Metadaten-Signatureigenschaften.
...
| Name | Beschreibung |
| --- | --- |
| [CertificateMetadataSignature](certificatemetadatasignature#constructor)(string) | Erstellt eine Zertifikat-Metadaten-Signatur mit vordefiniertem Namen und leerem Wert. |
| [CertificateMetadataSignature](certificatemetadatasignature#constructor_1)(string, object) | Erstellt eine Zertifikat-Metadaten-Signatur mit vordefinierten Werten. |
...
| Name | Beschreibung |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/certificatemetadatasignature/clone#clone_1)() | Instanz der Metadaten-Signatur klonen. |
| override [Clone](../../groupdocs.signature.domain/certificatemetadatasignature/clone#clone)(object) | Clone Certificate Metadata Signature-Instanz mit dem angegebenen Wert. |
...
| override [ToString](../../groupdocs.signature.domain/certificatemetadatasignature/tostring#tostring)() | Konvertiert in String mit override ToString() method |
...
| override [ToString](../../groupdocs.signature.domain/certificatemetadatasignature/tostring#tostring_2)(string, IFormatProvider) | Konvertiert in eine Zeichenfolge mit dem angegebenen Format |
