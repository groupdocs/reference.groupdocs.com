...
description: يصف الفئة الأساسية للتوقيعات.
type: docs
weight: 50
url: /ar/net/groupdocs.signature.domain/basesignature/
---
## BaseSignature class

يصف الفئة الأساسية للتوقيعات.
...
| اسم | وصف |
| --- | --- |
| virtual [Clone](../../groupdocs.signature.domain/basesignature/clone)() | مثيل توقيع استنساخ . |
| override [Equals](../../groupdocs.signature.domain/basesignature/equals)(object) | طريقة الكتابة فوق يساوي لمقارنة خصائص التوقيع |
| override [GetHashCode](../../groupdocs.signature.domain/basesignature/gethashcode)() | يلغي طريقة GetHashCode |
