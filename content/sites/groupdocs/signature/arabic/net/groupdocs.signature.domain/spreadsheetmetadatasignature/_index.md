...
يحتوي على خصائص توقيع بيانات تعريف جدول البيانات .
...
| اسم | وصف |
| --- | --- |
| [SpreadsheetMetadataSignature](spreadsheetmetadatasignature#constructor)(string) | إنشاء توقيع البيانات الوصفية لجدول البيانات باسم محدد مسبقًا وقيمة فارغة. |
| [SpreadsheetMetadataSignature](spreadsheetmetadatasignature#constructor_1)(string, object) | إنشاء توقيع البيانات الوصفية لجدول البيانات بقيم محددة مسبقًا. |
...
| اسم | وصف |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/spreadsheetmetadatasignature/clone#clone_1)() | مثيل توقيع بيانات تعريف النسخ . |
| override [Clone](../../groupdocs.signature.domain/spreadsheetmetadatasignature/clone#clone)(object) | نسخة توقيع بيانات وصفية لجدول البيانات بقيمة معينة. |
...
| override [ToString](../../groupdocs.signature.domain/spreadsheetmetadatasignature/tostring#tostring)() | التحويل إلى سلسلة مع تجاوز ToString () method |
| virtual [ToString](../../groupdocs.signature.domain/metadatasignature/tostring)(string) | تحويل إلى سلسلة بالتنسيق المحدد |
| override [ToString](../../groupdocs.signature.domain/spreadsheetmetadatasignature/tostring#tostring_2)(string, IFormatProvider) | تحويل إلى سلسلة بالتنسيق المحدد |
