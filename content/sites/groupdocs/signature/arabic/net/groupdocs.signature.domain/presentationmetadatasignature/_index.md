...
description: يحتوي على خصائص توقيع بيانات تعريف العرض التقديمي .
type: docs
weight: 710
url: /ar/net/groupdocs.signature.domain/presentationmetadatasignature/
---
## PresentationMetadataSignature class

يحتوي على خصائص توقيع بيانات تعريف العرض التقديمي .
...
| اسم | وصف |
| --- | --- |
| [PresentationMetadataSignature](presentationmetadatasignature#constructor)(string) | إنشاء توقيع بيانات تعريف العرض التقديمي باسم معرف مسبقًا وقيمة فارغة |
| [PresentationMetadataSignature](presentationmetadatasignature#constructor_1)(string, object) | إنشاء توقيع بيانات تعريف العرض التقديمي بقيم محددة مسبقًا |
...
| اسم | وصف |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/presentationmetadatasignature/clone#clone_1)() | مثيل توقيع بيانات تعريف النسخ . |
| override [Clone](../../groupdocs.signature.domain/presentationmetadatasignature/clone#clone)(object) | مثيل توقيع البيانات الوصفية Clone Slides بقيمة معينة. |
...
| override [ToString](../../groupdocs.signature.domain/presentationmetadatasignature/tostring#tostring)() | التحويل إلى سلسلة مع تجاوز ToString () method |
| virtual [ToString](../../groupdocs.signature.domain/metadatasignature/tostring)(string) | تحويل إلى سلسلة بالتنسيق المحدد |
| override [ToString](../../groupdocs.signature.domain/presentationmetadatasignature/tostring#tostring_2)(string, IFormatProvider) | تحويل إلى سلسلة بالتنسيق المحدد |
