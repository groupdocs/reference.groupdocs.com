...
description: يحتوي على خصائص توقيع بيانات تعريف معالجة الكلمات.
type: docs
weight: 1070
url: /ar/net/groupdocs.signature.domain/wordprocessingmetadatasignature/
---
## WordProcessingMetadataSignature class

يحتوي على خصائص توقيع بيانات تعريف معالجة الكلمات.
...
| اسم | وصف |
| --- | --- |
| [WordProcessingMetadataSignature](wordprocessingmetadatasignature#constructor)(string) | إنشاء توقيع بيانات تعريف معالجة الكلمات باسم محدد مسبقًا وقيمة فارغة. |
| [WordProcessingMetadataSignature](wordprocessingmetadatasignature#constructor_1)(string, object) | إنشاء توقيع بيانات تعريف معالجة الكلمات بقيم محددة مسبقًا. |
...
| اسم | وصف |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/wordprocessingmetadatasignature/clone#clone_1)() | مثيل توقيع بيانات تعريف النسخ . |
| override [Clone](../../groupdocs.signature.domain/wordprocessingmetadatasignature/clone#clone)(object) | مثيل توقيع البيانات الوصفية للكلمات المستنسخة بقيمة معينة. |
...
| override [ToString](../../groupdocs.signature.domain/wordprocessingmetadatasignature/tostring#tostring)() | التحويل إلى سلسلة مع تجاوز ToString () method |
| virtual [ToString](../../groupdocs.signature.domain/metadatasignature/tostring)(string) | تحويل إلى سلسلة بالتنسيق المحدد |
| override [ToString](../../groupdocs.signature.domain/wordprocessingmetadatasignature/tostring#tostring_2)(string, IFormatProvider) | تحويل إلى سلسلة بالتنسيق المحدد |
