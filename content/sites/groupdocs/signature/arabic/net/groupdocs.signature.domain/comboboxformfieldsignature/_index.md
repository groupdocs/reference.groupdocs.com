...
يحتوي على خصائص توقيع حقل نموذج الإدخال في مربع التحرير والسرد.
...
| اسم | وصف |
| --- | --- |
| [ComboboxFormFieldSignature](comboboxformfieldsignature#constructor)(string) | إنشاء ComboboxFormFieldSignature باسم محدد مسبقًا. |
| [ComboboxFormFieldSignature](comboboxformfieldsignature#constructor_1)(string, List&lt;string&gt;) | إنشاء ComboboxFormFieldSignature باسم وقائمة خيارات محددة مسبقًا. |
| [ComboboxFormFieldSignature](comboboxformfieldsignature#constructor_2)(string, List&lt;string&gt;, object) | إنشاء ComboboxFormFieldSignature بالاسم المحدد مسبقًا وقائمة الخيارات والقيمة المحددة. |
...
| [Items](../../groupdocs.signature.domain/comboboxformfieldsignature/items) { get; set; } | احصل على قائمة خيارات مربع التحرير والسرد أو اضبطها. |
...
| [Selected](../../groupdocs.signature.domain/comboboxformfieldsignature/selected) { get; set; } | الحصول على القيمة المحددة أو تعيينها. |
...
| اسم | وصف |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/comboboxformfieldsignature/clone)() | مثيل توقيع الحقل Clone Form |
| override [Equals](../../groupdocs.signature.domain/comboboxformfieldsignature/equals)(object) | طريقة الكتابة فوق يساوي لمقارنة خصائص التوقيع |
| override [GetHashCode](../../groupdocs.signature.domain/comboboxformfieldsignature/gethashcode)() | يلغي طريقة GetHashCode |
