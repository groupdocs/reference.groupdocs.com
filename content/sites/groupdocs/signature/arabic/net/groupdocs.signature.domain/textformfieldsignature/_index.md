...
description: يحتوي على خصائص توقيع حقل نموذج إدخال النص لـ Pdf Document
type: docs
weight: 930
url: /ar/net/groupdocs.signature.domain/textformfieldsignature/
---
## TextFormFieldSignature class

يحتوي على خصائص توقيع حقل نموذج إدخال النص لـ Pdf Document
...
| اسم | وصف |
| --- | --- |
| [TextFormFieldSignature](textformfieldsignature#constructor)(string) | إنشاء PdfTextFormFieldSignature باسم محدد مسبقًا. |
| [TextFormFieldSignature](textformfieldsignature#constructor_1)(string, string) | إنشاء PdfTextFormFieldSignature باسم محدد مسبقًا. |
...
| [Text](../../groupdocs.signature.domain/textformfieldsignature/text) { get; set; } | الحصول على أو تعيين نص إدخال نص حقل النموذج. |
...
| اسم | وصف |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/textformfieldsignature/clone)() | مثيل توقيع الحقل Clone Form |
| override [Equals](../../groupdocs.signature.domain/textformfieldsignature/equals)(object) | طريقة الكتابة فوق يساوي لمقارنة خصائص التوقيع |
| override [GetHashCode](../../groupdocs.signature.domain/textformfieldsignature/gethashcode)() | يلغي طريقة GetHashCode |
