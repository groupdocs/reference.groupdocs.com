...
description: يمثل خيارات توقيع النص.
type: docs
weight: 1650
url: /ar/net/groupdocs.signature.options/textsignoptions/
---
## TextSignOptions class

يمثل خيارات توقيع النص.
...
| اسم | وصف |
| --- | --- |
| [TextSignOptions](textsignoptions#constructor)() | تهيئة مثيل جديد لفئة TextSignOptions بالقيم الافتراضية. |
| [TextSignOptions](textsignoptions#constructor_1)(string) | تهيئة مثيل جديد لفئة TextSignOptions مع النص. |
...
* الاستخدام الأساسي لإنشاء توقيع إلكتروني نصي بواسطة GroupDocs. التوقيع: [كيفية التوقيع الإلكتروني للمستند مع التوقيع النصي](https://docs.groupdocs.com/display/signaturenet/eSign+document+with+Text+signature)
* الاستخدام المتقدم لإعدادات التوقيع الإلكتروني النصي باستخدام GroupDocs. التوقيع: [الاستخدام المتقدم لـ eSign Document مع توقيع النص والإعدادات الإضافية](https://docs.groupdocs.com/display/signaturenet/Sign+document+with+Text+signature+-+advanced)
