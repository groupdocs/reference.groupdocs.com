...
Параметры сохранения для электронных таблиц.
...
| Имя | Описание |
| --- | --- |
| [SpreadsheetSaveOptions](spreadsheetsaveoptions#constructor)() | Инициализирует новый экземпляр класса SpreadsheetSaveOptions со значениями по умолчанию. |
| [SpreadsheetSaveOptions](spreadsheetsaveoptions#constructor_1)(SpreadsheetSaveFileFormat) | Инициализирует новый экземпляр класса SpreadsheetSaveOptions с предопределенным форматом выходного файла. |
| [SpreadsheetSaveOptions](spreadsheetsaveoptions#constructor_2)(SpreadsheetSaveFileFormat, bool) | Инициализирует новый экземпляр класса SpreadsheetSaveOptions с указанным типом вывода и флагом перезаписи. |
...
| [FileFormat](../../groupdocs.signature.options/spreadsheetsaveoptions/fileformat) { get; set; } | Получает или задает формат файла подписанного документа. |
