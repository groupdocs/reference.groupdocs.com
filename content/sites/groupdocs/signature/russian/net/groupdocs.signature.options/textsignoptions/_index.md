...
Представляет параметры текстовой подписи.
...
| Имя | Описание |
| --- | --- |
| [TextSignOptions](textsignoptions#constructor)() | Инициализирует новый экземпляр класса TextSignOptions со значениями по умолчанию. |
| [TextSignOptions](textsignoptions#constructor_1)(string) | Инициализирует новый экземпляр класса TextSignOptions текстом. |
