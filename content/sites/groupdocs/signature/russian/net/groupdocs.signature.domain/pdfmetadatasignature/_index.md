...
Содержит свойства подписи метаданных Pdf.
...
| Имя | Описание |
| --- | --- |
| [PdfMetadataSignature](pdfmetadatasignature#constructor)(string) | Создает подпись метаданных Pdf с предопределенным именем и пустым значением |
| [PdfMetadataSignature](pdfmetadatasignature#constructor_1)(string, object) | Создает подпись метаданных Pdf с предопределенными значениями |
| [PdfMetadataSignature](pdfmetadatasignature#constructor_2)(string, object, string) | Создает подпись метаданных Pdf с предопределенными значениями |
...
| Имя | Описание |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/pdfmetadatasignature/clone#clone_1)() | Экземпляр подписи метаданных клонирования. |
| override [Clone](../../groupdocs.signature.domain/pdfmetadatasignature/clone#clone)(object) | Клонировать экземпляр подписи метаданных Pdf с заданным значением. |
| override [Equals](../../groupdocs.signature.domain/pdfmetadatasignature/equals)(object) | Перезаписывает метод Equals для сравнения свойств подписи |
...
| override [GetHashCode](../../groupdocs.signature.domain/pdfmetadatasignature/gethashcode)() | Переопределяет метод GetHashCode |
...
| override [ToString](../../groupdocs.signature.domain/metadatasignature/tostring)() | Преобразует в строку с переопределением метода ToString() |
| virtual [ToString](../../groupdocs.signature.domain/metadatasignature/tostring)(string) | Преобразует в строку с указанным форматом |
| virtual [ToString](../../groupdocs.signature.domain/metadatasignature/tostring)(string, IFormatProvider) | Преобразует в строку с указанным форматом |
