...
description: Содержит свойства подписи метаданных WordProcessing.
type: docs
weight: 1040
url: /ru/net/groupdocs.signature.domain/wordprocessingmetadatasignature/
---
## WordProcessingMetadataSignature class

Содержит свойства подписи метаданных WordProcessing.
...
| Имя | Описание |
| --- | --- |
| [WordProcessingMetadataSignature](wordprocessingmetadatasignature#constructor)(string) | Создает подпись метаданных WordProcessing с предопределенным именем и пустым значением. |
| [WordProcessingMetadataSignature](wordprocessingmetadatasignature#constructor_1)(string, object) | Создает подпись метаданных WordProcessing с предопределенными значениями. |
...
| Имя | Описание |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/wordprocessingmetadatasignature/clone#clone_1)() | Экземпляр подписи метаданных клонирования. |
| override [Clone](../../groupdocs.signature.domain/wordprocessingmetadatasignature/clone#clone)(object) | Копировать экземпляр подписи метаданных слов с заданным значением. |
...
| override [ToString](../../groupdocs.signature.domain/wordprocessingmetadatasignature/tostring#tostring)() | Преобразует в строку с переопределением метода ToString() |
| virtual [ToString](../../groupdocs.signature.domain/metadatasignature/tostring)(string) | Преобразует в строку с указанным форматом |
| override [ToString](../../groupdocs.signature.domain/wordprocessingmetadatasignature/tostring#tostring_2)(string, IFormatProvider) | Преобразует в строку с указанным форматом |
