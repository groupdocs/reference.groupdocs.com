...
description: Содержит свойства подписи метаданных сертификата.
type: docs
weight: 70
url: /ru/net/groupdocs.signature.domain/certificatemetadatasignature/
---
## CertificateMetadataSignature class

Содержит свойства подписи метаданных сертификата.
...
| Имя | Описание |
| --- | --- |
| [CertificateMetadataSignature](certificatemetadatasignature#constructor)(string) | Создает подпись метаданных сертификата с предопределенным именем и пустым значением. |
| [CertificateMetadataSignature](certificatemetadatasignature#constructor_1)(string, object) | Создает подпись метаданных сертификата с предопределенными значениями. |
...
| Имя | Описание |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/certificatemetadatasignature/clone#clone_1)() | Экземпляр подписи метаданных клонирования. |
| override [Clone](../../groupdocs.signature.domain/certificatemetadatasignature/clone#clone)(object) | Копировать экземпляр подписи метаданных сертификата с заданным значением. |
...
| override [ToString](../../groupdocs.signature.domain/certificatemetadatasignature/tostring#tostring)() | Преобразует в строку с переопределением метода ToString() |
| virtual [ToString](../../groupdocs.signature.domain/metadatasignature/tostring)(string) | Преобразует в строку с указанным форматом |
| override [ToString](../../groupdocs.signature.domain/certificatemetadatasignature/tostring#tostring_2)(string, IFormatProvider) | Преобразует в строку с указанным форматом |
