...
Содержит свойства подписи поля формы ввода текста для Pdf Document
...
| Имя | Описание |
| --- | --- |
| [TextFormFieldSignature](textformfieldsignature#constructor)(string) | Создает PdfTextFormFieldSignature с предопределенным именем. |
| [TextFormFieldSignature](textformfieldsignature#constructor_1)(string, string) | Создает PdfTextFormFieldSignature с предопределенным именем. |
...
| [Text](../../groupdocs.signature.domain/textformfieldsignature/text) { get; set; } | Получает или задает текст ввода текста поля формы. |
...
| Имя | Описание |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/textformfieldsignature/clone)() | Клонировать экземпляр подписи FormField. |
| override [Equals](../../groupdocs.signature.domain/textformfieldsignature/equals)(object) | Перезаписывает метод Equals для сравнения свойств подписи |
| override [GetHashCode](../../groupdocs.signature.domain/textformfieldsignature/gethashcode)() | Переопределяет метод GetHashCode |
