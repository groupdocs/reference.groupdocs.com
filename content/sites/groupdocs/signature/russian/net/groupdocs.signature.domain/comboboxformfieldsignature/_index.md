...
Содержит свойства подписи поля формы ввода со списком.
...
| Имя | Описание |
| --- | --- |
| [ComboboxFormFieldSignature](comboboxformfieldsignature#constructor)(string) | Создает ComboboxFormFieldSignature с предопределенным именем. |
| [ComboboxFormFieldSignature](comboboxformfieldsignature#constructor_1)(string, List&lt;string&gt;) | Создает ComboboxFormFieldSignature с предопределенным именем и списком опций. |
| [ComboboxFormFieldSignature](comboboxformfieldsignature#constructor_2)(string, List&lt;string&gt;, object) | Создает ComboboxFormFieldSignature с предопределенным именем, списком опций и выбранным значением. |
...
| [Items](../../groupdocs.signature.domain/comboboxformfieldsignature/items) { get; set; } | Получить или установить список опций поля со списком. |
...
| [Selected](../../groupdocs.signature.domain/comboboxformfieldsignature/selected) { get; set; } | Получить или установить выбранное значение. |
...
| Имя | Описание |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/comboboxformfieldsignature/clone)() | Клонировать экземпляр подписи FormField. |
| override [Equals](../../groupdocs.signature.domain/comboboxformfieldsignature/equals)(object) | Перезаписывает метод Equals для сравнения свойств подписи |
| override [GetHashCode](../../groupdocs.signature.domain/comboboxformfieldsignature/gethashcode)() | Переопределяет метод GetHashCode |
