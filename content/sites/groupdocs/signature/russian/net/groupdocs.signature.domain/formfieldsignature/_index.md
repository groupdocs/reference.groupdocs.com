...
description: Содержит свойства подписи поля формы.
type: docs
weight: 460
url: /ru/net/groupdocs.signature.domain/formfieldsignature/
---
## FormFieldSignature class

Содержит свойства подписи поля формы.
...
| Имя | Описание |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/formfieldsignature/clone)() | Клонировать экземпляр подписи FormField. |
| override [Equals](../../groupdocs.signature.domain/formfieldsignature/equals)(object) | Перезаписывает метод Equals для сравнения свойств подписи |
| override [GetHashCode](../../groupdocs.signature.domain/formfieldsignature/gethashcode)() | Переопределяет метод GetHashCode |
