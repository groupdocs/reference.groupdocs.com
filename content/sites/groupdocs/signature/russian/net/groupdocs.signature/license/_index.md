...
| Имя | Описание |
| --- | --- |
| [License](license)() | Создайте экземпляр лицензии |

## Методы

| Имя | Описание |
| --- | --- |
| [SetLicense](../../groupdocs.signature/license/setlicense#setlicense)(Stream) | Лицензирует компонент. |
| [SetLicense](../../groupdocs.signature/license/setlicense#setlicense_1)(string) | Лицензирует компонент. |
