...
description: Contiene propiedades de firma de metadatos de hoja de cálculo.
type: docs
weight: 840
url: /es/net/groupdocs.signature.domain/spreadsheetmetadatasignature/
---
## SpreadsheetMetadataSignature class

Contiene propiedades de firma de metadatos de hoja de cálculo.
...
| Nombre | Descripción |
| --- | --- |
| [SpreadsheetMetadataSignature](spreadsheetmetadatasignature#constructor)(string) | Crea una firma de metadatos de hoja de cálculo con un nombre predefinido y un valor vacío. |
| [SpreadsheetMetadataSignature](spreadsheetmetadatasignature#constructor_1)(string, object) | Crea una firma de metadatos de hoja de cálculo con valores predefinidos. |
...
| Nombre | Descripción |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/spreadsheetmetadatasignature/clone#clone_1)() | Clonar instancia de firma de metadatos. |
| override [Clone](../../groupdocs.signature.domain/spreadsheetmetadatasignature/clone#clone)(object) | Clonar instancia de firma de metadatos de hoja de cálculo con valor dado. |
...
| override [ToString](../../groupdocs.signature.domain/spreadsheetmetadatasignature/tostring#tostring)() | Convierte a cadena con anular el método ToString() |
...
| override [ToString](../../groupdocs.signature.domain/spreadsheetmetadatasignature/tostring#tostring_2)(string, IFormatProvider) | Convierte a cadena con formato especificado |
