...
description: Contiene propiedades de firma de metadatos de certificado.
type: docs
weight: 70
url: /es/net/groupdocs.signature.domain/certificatemetadatasignature/
---
## CertificateMetadataSignature class

Contiene propiedades de firma de metadatos de certificado.
...
| Nombre | Descripción |
| --- | --- |
| [CertificateMetadataSignature](certificatemetadatasignature#constructor)(string) | Crea una firma de metadatos de certificado con un nombre predefinido y un valor vacío. |
| [CertificateMetadataSignature](certificatemetadatasignature#constructor_1)(string, object) | Crea firma de metadatos de certificado con valores predefinidos. |
...
| Nombre | Descripción |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/certificatemetadatasignature/clone#clone_1)() | Clonar instancia de firma de metadatos. |
| override [Clone](../../groupdocs.signature.domain/certificatemetadatasignature/clone#clone)(object) | Instancia de firma de metadatos de certificado de clonación con valor dado. |
...
| override [ToString](../../groupdocs.signature.domain/certificatemetadatasignature/tostring#tostring)() | Convierte a cadena con anular el método ToString() |
...
| override [ToString](../../groupdocs.signature.domain/certificatemetadatasignature/tostring#tostring_2)(string, IFormatProvider) | Convierte a cadena con formato especificado |
