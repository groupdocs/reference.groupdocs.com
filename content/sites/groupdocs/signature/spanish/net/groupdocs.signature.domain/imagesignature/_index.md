...
description: Contiene propiedades de firma de imagen.
type: docs
weight: 590
url: /es/net/groupdocs.signature.domain/imagesignature/
---
## ImageSignature class

Contiene propiedades de firma de imagen.
...
| Nombre | Descripción |
| --- | --- |
| [ImageSignature](imagesignature)(string) | Inicialice el objeto ImageSignature con el identificador de firma que se obtuvo después del proceso de búsqueda. Este identificador único se usa para encontrar propiedades adicionales para esta firma en la capa de información de firma del documento. |

## Propiedades

| Nombre | Descripción |
| --- | --- |
| [Content](../../groupdocs.signature.domain/imagesignature/content) { get; } | Especifica el contenido de datos binarios de imagen de tipo[`Format`](./format) . Por defecto esta propiedad no estará configurada. Usar propiedad[`ReturnContent`](../../groupdocs.signature.options/imagesearchoptions/returncontent) para habilitar esta característica. |
...
| [Format](../../groupdocs.signature.domain/imagesignature/format) { get; } | Especifica el formato de la imagen de la firma. |
...
| [Size](../../groupdocs.signature.domain/imagesignature/size) { get; } | Especifica el tamaño en bytes de la imagen de la firma. |
...
| Nombre | Descripción |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/imagesignature/clone)() | Clonar instancia de firma de código de barras. |
| override [Equals](../../groupdocs.signature.domain/imagesignature/equals)(object) | Sobrescribe el método Equals para comparar las propiedades de la firma |
| override [GetHashCode](../../groupdocs.signature.domain/imagesignature/gethashcode)() | Anula el método GetHashCode |
