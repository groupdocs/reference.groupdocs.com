...
Contiene propiedades de firma de metadatos de PDF.
...
| Nombre | Descripción |
| --- | --- |
| [PdfMetadataSignature](pdfmetadatasignature#constructor)(string) | Crea una firma de metadatos en PDF con un nombre predefinido y un valor vacío |
| [PdfMetadataSignature](pdfmetadatasignature#constructor_1)(string, object) | Crea firma de metadatos PDF con valores predefinidos |
| [PdfMetadataSignature](pdfmetadatasignature#constructor_2)(string, object, string) | Crea firma de metadatos PDF con valores predefinidos |
...
| Nombre | Descripción |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/pdfmetadatasignature/clone#clone_1)() | Clonar instancia de firma de metadatos. |
| override [Clone](../../groupdocs.signature.domain/pdfmetadatasignature/clone#clone)(object) | Clonar instancia de firma de metadatos de PDF con valor dado. |
| override [Equals](../../groupdocs.signature.domain/pdfmetadatasignature/equals)(object) | Sobrescribe el método Equals para comparar las propiedades de la firma |
...
| override [GetHashCode](../../groupdocs.signature.domain/pdfmetadatasignature/gethashcode)() | Anula el método GetHashCode |
...
| override [ToString](../../groupdocs.signature.domain/metadatasignature/tostring)() | Convierte a cadena con anular el método ToString() |
...
| virtual [ToString](../../groupdocs.signature.domain/metadatasignature/tostring)(string, IFormatProvider) | Convierte a cadena con formato especificado |
