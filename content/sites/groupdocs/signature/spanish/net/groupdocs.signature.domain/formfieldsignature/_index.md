...
description: Contiene propiedades de firma de campo de formulario.
type: docs
weight: 440
url: /es/net/groupdocs.signature.domain/formfieldsignature/
---
## FormFieldSignature class

Contiene propiedades de firma de campo de formulario.
...
| Nombre | Descripción |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/formfieldsignature/clone)() | Clonar instancia de Firma de FormField. |
| override [Equals](../../groupdocs.signature.domain/formfieldsignature/equals)(object) | Sobrescribe el método Equals para comparar las propiedades de la firma |
| override [GetHashCode](../../groupdocs.signature.domain/formfieldsignature/gethashcode)() | Anula el método GetHashCode |
