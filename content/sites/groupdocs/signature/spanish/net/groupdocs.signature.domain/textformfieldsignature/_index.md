...
description: Contiene propiedades de firma de campo de formulario de entrada de texto para Documento PDF
type: docs
weight: 930
url: /es/net/groupdocs.signature.domain/textformfieldsignature/
---
## TextFormFieldSignature class

Contiene propiedades de firma de campo de formulario de entrada de texto para Documento PDF
...
| Nombre | Descripción |
| --- | --- |
| [TextFormFieldSignature](textformfieldsignature#constructor)(string) | Crea PdfTextFormFieldSignature con nombre predefinido. |
| [TextFormFieldSignature](textformfieldsignature#constructor_1)(string, string) | Crea PdfTextFormFieldSignature con nombre predefinido. |
...
| [Text](../../groupdocs.signature.domain/textformfieldsignature/text) { get; set; } | Obtiene o establece el texto de la entrada de texto del campo de formulario. |
...
| Nombre | Descripción |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/textformfieldsignature/clone)() | Clonar instancia de Firma de FormField. |
| override [Equals](../../groupdocs.signature.domain/textformfieldsignature/equals)(object) | Sobrescribe el método Equals para comparar las propiedades de la firma |
| override [GetHashCode](../../groupdocs.signature.domain/textformfieldsignature/gethashcode)() | Anula el método GetHashCode |
