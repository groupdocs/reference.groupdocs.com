...
description: Contiene propiedades de firma de metadatos de procesamiento de textos.
type: docs
weight: 1040
url: /es/net/groupdocs.signature.domain/wordprocessingmetadatasignature/
---
## WordProcessingMetadataSignature class

Contiene propiedades de firma de metadatos de procesamiento de textos.
...
| Nombre | Descripción |
| --- | --- |
| [WordProcessingMetadataSignature](wordprocessingmetadatasignature#constructor)(string) | Crea una firma de metadatos de procesamiento de texto con un nombre predefinido y un valor vacío. |
| [WordProcessingMetadataSignature](wordprocessingmetadatasignature#constructor_1)(string, object) | Crea una firma de metadatos de procesamiento de textos con valores predefinidos. |
...
| Nombre | Descripción |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/wordprocessingmetadatasignature/clone#clone_1)() | Clonar instancia de firma de metadatos. |
| override [Clone](../../groupdocs.signature.domain/wordprocessingmetadatasignature/clone#clone)(object) | Instancia de firma de metadatos de palabras clonadas con valor dado. |
...
| override [ToString](../../groupdocs.signature.domain/wordprocessingmetadatasignature/tostring#tostring)() | Convierte a cadena con anular el método ToString() |
...
| override [ToString](../../groupdocs.signature.domain/wordprocessingmetadatasignature/tostring#tostring_2)(string, IFormatProvider) | Convierte a cadena con formato especificado |
