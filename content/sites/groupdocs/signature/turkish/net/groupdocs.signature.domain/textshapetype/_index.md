...
Metin şekli türlerini belirtir.
...
| RoundRectangle | `2` | YuvarlakDikdörtgen. |
| Ellipse | `3` | Elips. |
| Diamond | `4` | Elmas. |
| Triangle | `5` | Üçgen. |
| RightTriangle | `6` | SağÜçgen. |
...
| Callout1 | `41` | Açıklama1. |
| Callout2 | `42` | Açıklama2. |
| Callout3 | `43` | Açıklama3. |
...
| LeftBrace | `87` | SolBrace. |
| RightBrace | `88` | SağBrace. |
