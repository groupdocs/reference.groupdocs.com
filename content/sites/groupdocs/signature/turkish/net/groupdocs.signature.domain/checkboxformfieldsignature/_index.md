...
Onay kutusu giriş formu alanı imza özelliklerini içerir.
...
| İsim | Tanım |
| --- | --- |
| [Checked](../../groupdocs.signature.domain/checkboxformfieldsignature/checked) { get; set; } | Form alanı onay kutusu girişinin kontrol edilen değerini alır veya ayarlar. |
