...
description: WordProcessing Metadata Signature özelliklerini içerir.
type: docs
weight: 1070
url: /tr/net/groupdocs.signature.domain/wordprocessingmetadatasignature/
---
## WordProcessingMetadataSignature class

WordProcessing Metadata Signature özelliklerini içerir.
...
| İsim | Tanım |
| --- | --- |
| [WordProcessingMetadataSignature](wordprocessingmetadatasignature#constructor)(string) | Önceden tanımlanmış ad ve boş değerle WordProcessing Metadata İmzası oluşturur. |
| [WordProcessingMetadataSignature](wordprocessingmetadatasignature#constructor_1)(string, object) | Önceden tanımlanmış değerlerle WordProcessing Metadata İmzası oluşturur. |
...
| İsim | Tanım |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/wordprocessingmetadatasignature/clone#clone_1)() | Klon Meta Veri İmza örneği. |
| override [Clone](../../groupdocs.signature.domain/wordprocessingmetadatasignature/clone#clone)(object) | Verilen değerle Word Metadata Signature örneğini Klonlayın. |
...
| override [ToString](../../groupdocs.signature.domain/wordprocessingmetadatasignature/tostring#tostring)() | ToString() yöntemini geçersiz kılarak Dizeye dönüştürür |
| virtual [ToString](../../groupdocs.signature.domain/metadatasignature/tostring)(string) | Belirtilen format ile Dizeye dönüştürür |
| override [ToString](../../groupdocs.signature.domain/wordprocessingmetadatasignature/tostring#tostring_2)(string, IFormatProvider) | Belirtilen format ile Dizeye dönüştürür |
