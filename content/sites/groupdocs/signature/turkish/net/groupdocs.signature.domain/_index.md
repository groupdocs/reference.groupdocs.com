...
description: Ad alanı belge temsiliyle çalışmak için sınıflar sağlar.
type: docs
weight: 20
url: /tr/net/groupdocs.signature.domain/
---
...
| [DeleteResult](./deleteresult) | Belgeden imza(lar)ın silinmesinin sonucu. |
| [DigitalFormFieldSignature](./digitalformfieldsignature) | Pdf Belgeleri için dijital imza giriş formu alanı özelliklerini içerir. |
| [DigitalSignature](./digitalsignature) | Dijital imza özelliklerini içerir. |
| [DocumentInfo](./documentinfo) | Belge açıklama özelliklerini tanımlar. |
| [FileType](./filetype) | Dosya türünü temsil eder. |
| [FormFieldSignature](./formfieldsignature) | Form alanı imza özelliklerini içerir. |
| [ImageMetadataSignature](./imagemetadatasignature) | Görüntü Meta Verileri imza özelliklerini içerir. |
| [ImageSignature](./imagesignature) | Görüntü imza özelliklerini içerir. |
| [MetadataSignature](./metadatasignature) | Meta veri imza özelliklerini içerir. |
| [MetadataSignatureCollection](./metadatasignaturecollection) | Meta veri imza nesnelerinin toplanması. |
| [Padding](./padding) | Element. ile ilişkili dolgu veya kenar boşluğu bilgilerini temsil eder. |
| [PageInfo](./pageinfo) | Belge sayfası açıklaması class |
...
| [QrCodeTypes](./qrcodetypes) | QRCode Türleri kabı. |
| [RadioButtonFormFieldSignature](./radiobuttonformfieldsignature) | Radyo düğmesi giriş formu alanı imza özelliklerini içerir. |
| [SearchResult](./searchresult) | Belirtilen belgede imza aramanın sonucu. |
...
| Yapı | Tanım |
| --- | --- |
| [TimeStamp](./timestamp) | Üçüncü taraf siteden zaman damgası almak için verileri temsil eder. |
## Arayüzler
...
| [ITransparency](./itransparency) | Farklı nesneler için Saydamlık özelliğini tanımlayın views |
## numaralandırma

| numaralandırma | Tanım |
| --- | --- |
| [CodeTextAlignment](./codetextalignment) | Barkodlar ve QR kodları için kod metninin hizalanması. |
| [DashStyle](./dashstyle) | Belgelerde kısa çizgi çizme stilini temsil eder. |
| [DocumentType](./documenttype) | Belge türünü tanımlar. |
...
| [StampTextRepeatType](./stamptextrepeattype) | Damga satırları için metin yineleme türünü belirtir. |
| [StretchMode](./stretchmode) | Bir belge sayfasında imza alanının genişletilmiş modunu temsil eder. |
| [TextHorizontalAlignment](./texthorizontalalignment) | İmza içindeki metnin yatay hizalamasını belirtir. |
| [TextMatchType](./textmatchtype) | string. içindeki metin eşleme türünü belirtir |
| [TextShapeType](./textshapetype) | Metin şekli türlerini belirtir. |
| [TextSignatureImplementation](./textsignatureimplementation) | PDF metin imzası için uygulama türünü belirtir. |
| [TextVerticalAlignment](./textverticalalignment) | Bir imza içindeki metnin dikey hizalamasını belirtir. |
| [VerticalAlignment](./verticalalignment) | Belge sayfasındaki öğenin dikey hizalamasını belirtir. |
| [WordProcessingSaveFileFormat](./wordprocessingsavefileformat) | WordProcessing belgeleri için farklı dosya kaydetme biçimleri tanımlar. |
| [WordProcessingTextSignatureImplementation](./wordprocessingtextsignatureimplementation) | WordProcessing belgeleri için metin imza uygulamasının türünü belirtir. |
