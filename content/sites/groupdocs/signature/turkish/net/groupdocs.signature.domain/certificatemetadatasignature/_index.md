...
description: Sertifika Meta Veri İmza özelliklerini içerir.
type: docs
weight: 70
url: /tr/net/groupdocs.signature.domain/certificatemetadatasignature/
---
## CertificateMetadataSignature class

Sertifika Meta Veri İmza özelliklerini içerir.
...
| İsim | Tanım |
| --- | --- |
| [CertificateMetadataSignature](certificatemetadatasignature#constructor)(string) | Önceden tanımlanmış ad ve boş değerle Sertifika Meta Veri İmzası oluşturur. |
| [CertificateMetadataSignature](certificatemetadatasignature#constructor_1)(string, object) | Önceden tanımlanmış değerlerle Sertifika Meta Veri İmzası oluşturur. |
...
| İsim | Tanım |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/certificatemetadatasignature/clone#clone_1)() | Klon Meta Veri İmza örneği. |
| override [Clone](../../groupdocs.signature.domain/certificatemetadatasignature/clone#clone)(object) | Sertifika Meta Veri İmza örneğini verilen değerle Klonla. |
...
| override [ToString](../../groupdocs.signature.domain/certificatemetadatasignature/tostring#tostring)() | ToString() yöntemini geçersiz kılarak Dizeye dönüştürür |
| virtual [ToString](../../groupdocs.signature.domain/metadatasignature/tostring)(string) | Belirtilen format ile Dizeye dönüştürür |
| override [ToString](../../groupdocs.signature.domain/certificatemetadatasignature/tostring#tostring_2)(string, IFormatProvider) | Belirtilen format ile Dizeye dönüştürür |
