...
description: Şunun uygulanmasını alır veya ayarlarIDataEncryptiongroupdocs.signature.domain.extensions/idataencryptionbu seçenek koleksiyonuyla tüm Meta veri imzalarını şifrelemek için arayüz. Bu değer ayarlanırsa eklenen tüm imzalar varsayılan olarak bu şifrelemeyi veya atanmışsa kendi DataEncryptionını kullanır.
type: docs
weight: 20
