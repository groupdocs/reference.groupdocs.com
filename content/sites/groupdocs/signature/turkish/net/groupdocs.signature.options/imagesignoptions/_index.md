...
description: Görüntü imza seçeneklerini temsil eder.
type: docs
weight: 1420
...
Görüntü imza seçeneklerini temsil eder.
...
* GroupDocs.Signature tarafından Görüntü elektronik imzası oluşturmanın temel kullanımı: [Belgeyi Görüntü imzasıyla e-Sign nasıl yapılır?](https://docs.groupdocs.com/display/signaturenet/eSign+document+with+Image+signature)
* GroupDocs.Signature ile Görüntü elektronik imza ayarlarının gelişmiş kullanımı: [Görüntü imzası ve ek ayarlarla belgeyi eSign için gelişmiş kullanım](https://docs.groupdocs.com/display/signaturenet/Sign+document+with+Image+signature+-+advanced)
