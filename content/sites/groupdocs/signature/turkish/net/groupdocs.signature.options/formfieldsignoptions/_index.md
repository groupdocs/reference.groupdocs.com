...
Pdf belgeleri için FormField imza seçeneklerinin sınıfını temsil eder.
...
| İsim | Tanım |
| --- | --- |
| [FormFieldSignOptions](formfieldsignoptions#constructor)() | Varsayılan değerlerle PdfFormFieldSignOptions sınıfının yeni bir örneğini başlatır. |
| [FormFieldSignOptions](formfieldsignoptions#constructor_1)(FormFieldSignature) | FormField imzasıyla PdfFormFieldSignOptions sınıfının yeni bir örneğini başlatır. |
