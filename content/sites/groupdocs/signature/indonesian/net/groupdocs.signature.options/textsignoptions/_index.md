...
description: Mewakili opsi Tanda tangan teks.
type: docs
weight: 1730
url: /id/net/groupdocs.signature.options/textsignoptions/
---
## TextSignOptions class

Mewakili opsi Tanda tangan teks.
...
| Nama | Keterangan |
| --- | --- |
| [TextSignOptions](textsignoptions#constructor)() | Menginisialisasi instance baru dari kelas TextSignOptions dengan nilai default. |
| [TextSignOptions](textsignoptions#constructor_1)(string) | Menginisialisasi instance baru dari kelas TextSignOptions dengan text. |
...
* Penggunaan dasar pembuatan tanda tangan elektronik Teks oleh GroupDocs.Signature: [Bagaimana cara menandatangani dokumen dengan Tanda tangan teks](https://docs.groupdocs.com/display/signaturenet/eSign+document+with+Text+signature)
* Penggunaan lanjutan pengaturan tanda tangan elektronik Teks dengan GroupDocs.Signature: [Penggunaan tingkat lanjut untuk menandatangani dokumen dengan Tanda tangan teks dan pengaturan tambahan](https://docs.groupdocs.com/display/signaturenet/Sign+document+with+Text+signature+-+advanced)
