...
description: Berisi properti tanda tangan kolom formulir input tombol radio.
type: docs
weight: 820
url: /id/net/groupdocs.signature.domain/radiobuttonformfieldsignature/
---
## RadioButtonFormFieldSignature class

Berisi properti tanda tangan kolom formulir input tombol radio.
...
| Nama | Keterangan |
| --- | --- |
| [RadioButtonFormFieldSignature](radiobuttonformfieldsignature#constructor)(string) | Membuat RadioButtonFieldSignature dengan nama yang telah ditentukan. |
| [RadioButtonFormFieldSignature](radiobuttonformfieldsignature#constructor_1)(string, List&lt;string&gt;) | Membuat RadioButtonFieldSignature dengan nama dan daftar item yang telah ditentukan. |
| [RadioButtonFormFieldSignature](radiobuttonformfieldsignature#constructor_2)(string, List&lt;string&gt;, object) | Membuat RadioButtonFieldSignature dengan nama yang telah ditentukan, daftar item, dan nilai yang dipilih. |
...
| [Items](../../groupdocs.signature.domain/radiobuttonformfieldsignature/items) { get; set; } | Dapatkan atau setel daftar opsi tombol Radio. |
...
| [Selected](../../groupdocs.signature.domain/radiobuttonformfieldsignature/selected) { get; set; } | Berisi nilai yang dipilih. |
...
| Nama | Keterangan |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/radiobuttonformfieldsignature/clone)() | Contoh Tanda Tangan FormField Kloning. |
| override [Equals](../../groupdocs.signature.domain/radiobuttonformfieldsignature/equals)(object) | Menimpa metode Sama dengan untuk membandingkan properti tanda tangan |
| override [GetHashCode](../../groupdocs.signature.domain/radiobuttonformfieldsignature/gethashcode)() | Menimpa metode GetHashCode |
