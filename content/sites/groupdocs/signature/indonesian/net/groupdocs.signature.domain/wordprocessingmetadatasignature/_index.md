...
description: Berisi properti Tanda Tangan Metadata Pemrosesan Kata.
type: docs
weight: 1070
url: /id/net/groupdocs.signature.domain/wordprocessingmetadatasignature/
---
## WordProcessingMetadataSignature class

Berisi properti Tanda Tangan Metadata Pemrosesan Kata.
...
| Nama | Keterangan |
| --- | --- |
| [WordProcessingMetadataSignature](wordprocessingmetadatasignature#constructor)(string) | Membuat Tanda Tangan Metadata Pemrosesan Kata dengan nama yang telah ditentukan dan nilai kosong. |
| [WordProcessingMetadataSignature](wordprocessingmetadatasignature#constructor_1)(string, object) | Membuat Tanda Tangan Metadata Pemrosesan Kata dengan nilai standar. |
...
| Nama | Keterangan |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/wordprocessingmetadatasignature/clone#clone_1)() | Contoh Tanda Tangan Metadata Kloning. |
| override [Clone](../../groupdocs.signature.domain/wordprocessingmetadatasignature/clone#clone)(object) | Contoh Tanda Tangan Metadata Kata Kloning dengan nilai yang diberikan. |
...
| override [ToString](../../groupdocs.signature.domain/wordprocessingmetadatasignature/tostring#tostring)() | Mengonversi ke String dengan mengganti metode ToString() |
...
| override [ToString](../../groupdocs.signature.domain/wordprocessingmetadatasignature/tostring#tostring_2)(string, IFormatProvider) | Konversi ke String dengan format yang ditentukan |
