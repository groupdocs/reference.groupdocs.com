...
description: Berisi properti Tanda Tangan Metadata Sertifikat.
type: docs
weight: 70
url: /id/net/groupdocs.signature.domain/certificatemetadatasignature/
---
## CertificateMetadataSignature class

Berisi properti Tanda Tangan Metadata Sertifikat.
...
| Nama | Keterangan |
| --- | --- |
| [CertificateMetadataSignature](certificatemetadatasignature#constructor)(string) | Membuat Tanda Tangan Metadata Sertifikat dengan nama yang telah ditentukan dan nilai kosong. |
| [CertificateMetadataSignature](certificatemetadatasignature#constructor_1)(string, object) | Membuat Tanda Tangan Metadata Sertifikat dengan nilai standar. |
...
| Nama | Keterangan |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/certificatemetadatasignature/clone#clone_1)() | Contoh Tanda Tangan Metadata Kloning. |
| override [Clone](../../groupdocs.signature.domain/certificatemetadatasignature/clone#clone)(object) | Contoh Tanda Tangan Metadata Sertifikat Kloning dengan nilai yang diberikan. |
...
| override [ToString](../../groupdocs.signature.domain/certificatemetadatasignature/tostring#tostring)() | Mengonversi ke String dengan mengganti metode ToString() |
...
| override [ToString](../../groupdocs.signature.domain/certificatemetadatasignature/tostring#tostring_2)(string, IFormatProvider) | Konversi ke String dengan format yang ditentukan |
