...
description: Berisi properti tanda tangan bidang formulir input teks untuk Dokumen Pdf
type: docs
weight: 960
url: /id/net/groupdocs.signature.domain/textformfieldsignature/
---
## TextFormFieldSignature class

Berisi properti tanda tangan bidang formulir input teks untuk Dokumen Pdf
...
| Nama | Keterangan |
| --- | --- |
| [TextFormFieldSignature](textformfieldsignature#constructor)(string) | Membuat PdfTextFormFieldSignature dengan nama yang telah ditentukan. |
| [TextFormFieldSignature](textformfieldsignature#constructor_1)(string, string) | Membuat PdfTextFormFieldSignature dengan nama yang telah ditentukan. |
...
| [Text](../../groupdocs.signature.domain/textformfieldsignature/text) { get; set; } | Mendapat atau menyetel teks input teks bidang formulir. |
...
| Nama | Keterangan |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/textformfieldsignature/clone)() | Contoh Tanda Tangan FormField Kloning. |
| override [Equals](../../groupdocs.signature.domain/textformfieldsignature/equals)(object) | Menimpa metode Sama dengan untuk membandingkan properti tanda tangan |
| override [GetHashCode](../../groupdocs.signature.domain/textformfieldsignature/gethashcode)() | Menimpa metode GetHashCode |
