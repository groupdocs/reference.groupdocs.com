...
Rappresenta la classe delle opzioni di firma FormField per i documenti Pdf.
...
| Nome | Descrizione |
| --- | --- |
| [FormFieldSignOptions](formfieldsignoptions#constructor)() | Inizializza una nuova istanza della classe PdfFormFieldSignOptions con valori predefiniti. |
| [FormFieldSignOptions](formfieldsignoptions#constructor_1)(FormFieldSignature) | Inizializza una nuova istanza della classe PdfFormFieldSignOptions con firma FormField. |
