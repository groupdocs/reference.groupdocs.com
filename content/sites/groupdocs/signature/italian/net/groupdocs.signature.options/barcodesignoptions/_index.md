...
description: Rappresenta le opzioni di firma del codice a barre.
type: docs
weight: 1190
...
Rappresenta le opzioni di firma del codice a barre.
...
* Utilizzo di base della creazione di firme elettroniche con codici a barre da GroupDocs. Firma: [Come firmare un documento con la firma del codice a barre](https://docs.groupdocs.com/display/signaturenet/eSign+document+with+Barcode+signature)
