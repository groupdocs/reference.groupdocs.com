...
description: Contiene le proprietà della firma del codice a barre.
type: docs
weight: 20
url: /it/net/groupdocs.signature.domain/barcodesignature/
---
## BarcodeSignature class

Contiene le proprietà della firma del codice a barre.
...
| Nome | Descrizione |
| --- | --- |
| [BarcodeSignature](barcodesignature)(string) | Inizializza l'oggetto BarcodeSignature con l'identificatore della firma ottenuto dopo il processo di ricerca. Questo identificatore univoco viene utilizzato per trovare proprietà aggiuntive per questa firma dal livello delle informazioni sulla firma del documento. |

## Proprietà

| Nome | Descrizione |
| --- | --- |
| [Content](../../groupdocs.signature.domain/barcodesignature/content) { get; } | Specifica il contenuto dell'immagine di dati binari del codice a barre di tipo[`Format`](./format) . Per impostazione predefinita, questa proprietà non verrà impostata. Usa proprietà[`ReturnContent`](../../groupdocs.signature.options/barcodesearchoptions/returncontent) per abilitare questa funzione. |
...
| [EncodeType](../../groupdocs.signature.domain/barcodesignature/encodetype) { get; } | Specifica il tipo di codifica del codice a barre. |
| [Format](../../groupdocs.signature.domain/barcodesignature/format) { get; } | Specifica il formato dell'immagine della firma del codice a barre. |
...
| [Text](../../groupdocs.signature.domain/barcodesignature/text) { get; } | Specifica il testo del codice a barre. |
...
| Nome | Descrizione |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/barcodesignature/clone)() | Clona istanza firma codice a barre. |
| override [Equals](../../groupdocs.signature.domain/barcodesignature/equals)(object) | Sovrascrive il metodo Equals per confrontare le proprietà della firma |
| override [GetHashCode](../../groupdocs.signature.domain/barcodesignature/gethashcode)() | Sostituisce il metodo GetHashCode |
