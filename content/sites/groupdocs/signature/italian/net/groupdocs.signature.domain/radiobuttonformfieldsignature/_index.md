...
Contiene le proprietà della firma del campo del modulo di input del pulsante di opzione.
...
| Nome | Descrizione |
| --- | --- |
| [RadioButtonFormFieldSignature](radiobuttonformfieldsignature#constructor)(string) | Crea RadioButtonFieldSignature con un nome predefinito. |
| [RadioButtonFormFieldSignature](radiobuttonformfieldsignature#constructor_1)(string, List&lt;string&gt;) | Crea RadioButtonFieldSignature con un nome predefinito e un elenco di elementi. |
| [RadioButtonFormFieldSignature](radiobuttonformfieldsignature#constructor_2)(string, List&lt;string&gt;, object) | Crea RadioButtonFieldSignature con nome predefinito, elenco di elementi e valore selezionato. |
...
| [Items](../../groupdocs.signature.domain/radiobuttonformfieldsignature/items) { get; set; } | Ottieni o imposta l'elenco delle opzioni dei pulsanti di opzione. |
...
| [Selected](../../groupdocs.signature.domain/radiobuttonformfieldsignature/selected) { get; set; } | Contiene il valore selezionato. |
