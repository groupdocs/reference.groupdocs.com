...
description: Descrive la classe base per le firme.
type: docs
weight: 50
url: /it/net/groupdocs.signature.domain/basesignature/
---
## BaseSignature class

Descrive la classe base per le firme.
...
| Nome | Descrizione |
| --- | --- |
| virtual [Clone](../../groupdocs.signature.domain/basesignature/clone)() | Clona istanza firma. |
| override [Equals](../../groupdocs.signature.domain/basesignature/equals)(object) | Sovrascrive il metodo Equals per confrontare le proprietà della firma |
| override [GetHashCode](../../groupdocs.signature.domain/basesignature/gethashcode)() | Sostituisce il metodo GetHashCode |
