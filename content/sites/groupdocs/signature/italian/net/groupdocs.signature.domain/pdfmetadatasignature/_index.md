...
Contiene le proprietà della firma dei metadati Pdf.
...
| Nome | Descrizione |
| --- | --- |
| [PdfMetadataSignature](pdfmetadatasignature#constructor)(string) | Crea la firma dei metadati Pdf con nome predefinito e valore vuoto |
| [PdfMetadataSignature](pdfmetadatasignature#constructor_1)(string, object) | Crea la firma dei metadati Pdf con valori predefiniti |
| [PdfMetadataSignature](pdfmetadatasignature#constructor_2)(string, object, string) | Crea la firma dei metadati Pdf con valori predefiniti |
...
| Nome | Descrizione |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/pdfmetadatasignature/clone#clone_1)() | Clona istanza firma metadati. |
| override [Clone](../../groupdocs.signature.domain/pdfmetadatasignature/clone#clone)(object) | Clona l'istanza della firma dei metadati Pdf con un determinato valore. |
| override [Equals](../../groupdocs.signature.domain/pdfmetadatasignature/equals)(object) | Sovrascrive il metodo Equals per confrontare le proprietà della firma |
...
| override [GetHashCode](../../groupdocs.signature.domain/pdfmetadatasignature/gethashcode)() | Sostituisce il metodo GetHashCode |
...
| override [ToString](../../groupdocs.signature.domain/metadatasignature/tostring)() | Converte in String con override ToString() method |
...
| virtual [ToString](../../groupdocs.signature.domain/metadatasignature/tostring)(string, IFormatProvider) | Converte in stringa con il formato specificato |
