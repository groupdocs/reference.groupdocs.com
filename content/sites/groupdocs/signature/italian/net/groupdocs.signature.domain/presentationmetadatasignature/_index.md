...
Contiene le proprietà della firma dei metadati di presentazione.
...
| override [ToString](../../groupdocs.signature.domain/presentationmetadatasignature/tostring#tostring)() | Converte in String con override ToString() method |
...
| override [ToString](../../groupdocs.signature.domain/presentationmetadatasignature/tostring#tostring_2)(string, IFormatProvider) | Converte in stringa con il formato specificato |
