...
description: Contiene le proprietà della firma dei metadati del certificato.
type: docs
weight: 70
url: /it/net/groupdocs.signature.domain/certificatemetadatasignature/
---
## CertificateMetadataSignature class

Contiene le proprietà della firma dei metadati del certificato.
...
| Nome | Descrizione |
| --- | --- |
| [CertificateMetadataSignature](certificatemetadatasignature#constructor)(string) | Crea la firma dei metadati del certificato con un nome predefinito e un valore vuoto. |
| [CertificateMetadataSignature](certificatemetadatasignature#constructor_1)(string, object) | Crea la firma dei metadati del certificato con valori predefiniti. |
...
| Nome | Descrizione |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/certificatemetadatasignature/clone#clone_1)() | Clona istanza firma metadati. |
| override [Clone](../../groupdocs.signature.domain/certificatemetadatasignature/clone#clone)(object) | Clona l'istanza della firma dei metadati del certificato con un determinato valore. |
...
| override [ToString](../../groupdocs.signature.domain/certificatemetadatasignature/tostring#tostring)() | Converte in String con override ToString() method |
...
| override [ToString](../../groupdocs.signature.domain/certificatemetadatasignature/tostring#tostring_2)(string, IFormatProvider) | Converte in stringa con il formato specificato |
