...
description: Bevat teksthandtekeningeigenschappen.
type: docs
weight: 1000
url: /nl/net/groupdocs.signature.domain/textsignature/
---
## TextSignature class

Bevat teksthandtekeningeigenschappen.
...
| Naam | Beschrijving |
| --- | --- |
| [TextSignature](textsignature)(string) | Initialiseer het TextSignature-object met de handtekening-ID die is verkregen na het zoekproces. Deze unieke ID wordt gebruikt om aanvullende eigenschappen voor deze handtekening te vinden uit de informatielaag voor de documenthandtekening. |
...
| [Native](../../groupdocs.signature.domain/textsignature/native) { get; set; } | Specificeert het native attribuut. Het is waar als de handtekening documentspecifiek is. |
...
| [SignatureImplementation](../../groupdocs.signature.domain/textsignature/signatureimplementation) { get; } | Specificeert de implementatie van teksthandtekeningen. |
| [SignatureType](../../groupdocs.signature.domain/basesignature/signaturetype) { get; } | Specificeert het type handtekening. |
| [Text](../../groupdocs.signature.domain/textsignature/text) { get; set; } | Specificeert tekst in handtekening. |
...
| Naam | Beschrijving |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/textsignature/clone)() | Instantie voor teksthandtekening klonen. |
| override [Equals](../../groupdocs.signature.domain/textsignature/equals)(object) | Overschrijft de Equals-methode om handtekeningeigenschappen te vergelijken |
| override [GetHashCode](../../groupdocs.signature.domain/textsignature/gethashcode)() | Overschrijft GetHashCode-methode |
