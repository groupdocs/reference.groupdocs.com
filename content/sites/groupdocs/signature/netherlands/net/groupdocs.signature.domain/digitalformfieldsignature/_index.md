...
description: Bevat eigenschappen van invoerformulier voor digitale handtekening voor pdfdocumenten.
type: docs
weight: 140
url: /nl/net/groupdocs.signature.domain/digitalformfieldsignature/
---
## DigitalFormFieldSignature class

Bevat eigenschappen van invoerformulier voor digitale handtekening voor pdf-documenten.
...
| Naam | Beschrijving |
| --- | --- |
| [DigitalFormFieldSignature](digitalformfieldsignature)(string) | Creëert PdfDigitalFormFieldSignature met vooraf gedefinieerde naam. |
...
| [Signed](../../groupdocs.signature.domain/digitalformfieldsignature/signed) { get; } | Alleen-lezen eigenschap die aangeeft of formulierveldhandtekening is ondertekend met een digitaal certificaat. |
...
| Naam | Beschrijving |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/digitalformfieldsignature/clone)() | Clone FormField Signature-instantie. |
| override [Equals](../../groupdocs.signature.domain/digitalformfieldsignature/equals)(object) | Overschrijft de Equals-methode om handtekeningeigenschappen te vergelijken |
| override [GetHashCode](../../groupdocs.signature.domain/digitalformfieldsignature/gethashcode)() | Overschrijft GetHashCode-methode |
