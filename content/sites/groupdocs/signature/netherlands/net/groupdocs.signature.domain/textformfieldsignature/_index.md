...
description: Bevat tekstinvoerformulierveldhandtekeningeigenschappen voor pdfdocument
type: docs
weight: 960
url: /nl/net/groupdocs.signature.domain/textformfieldsignature/
---
## TextFormFieldSignature class

Bevat tekstinvoerformulierveldhandtekeningeigenschappen voor pdf-document
...
| Naam | Beschrijving |
| --- | --- |
| [TextFormFieldSignature](textformfieldsignature#constructor)(string) | Creëert PdfTextFormFieldSignature met vooraf gedefinieerde naam. |
| [TextFormFieldSignature](textformfieldsignature#constructor_1)(string, string) | Creëert PdfTextFormFieldSignature met vooraf gedefinieerde naam. |
...
| [Text](../../groupdocs.signature.domain/textformfieldsignature/text) { get; set; } | Krijgt of stelt tekst van formulierveldtekstinvoer in. |
...
| Naam | Beschrijving |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/textformfieldsignature/clone)() | Clone FormField Signature-instantie. |
| override [Equals](../../groupdocs.signature.domain/textformfieldsignature/equals)(object) | Overschrijft de Equals-methode om handtekeningeigenschappen te vergelijken |
| override [GetHashCode](../../groupdocs.signature.domain/textformfieldsignature/gethashcode)() | Overschrijft GetHashCode-methode |
