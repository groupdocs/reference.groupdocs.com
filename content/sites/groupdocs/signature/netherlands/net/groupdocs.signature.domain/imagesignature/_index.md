...
description: Bevat afbeeldingshandtekeningeigenschappen.
type: docs
weight: 590
url: /nl/net/groupdocs.signature.domain/imagesignature/
---
## ImageSignature class

Bevat afbeeldingshandtekeningeigenschappen.
...
| Naam | Beschrijving |
| --- | --- |
| [ImageSignature](imagesignature)(string) | Initialiseer het ImageSignature-object met de handtekening-ID die is verkregen na het zoekproces. Deze unieke ID wordt gebruikt om aanvullende eigenschappen voor deze handtekening te vinden uit de documenthandtekening-informatielaag. |

## Eigenschappen

| Naam | Beschrijving |
| --- | --- |
| [Content](../../groupdocs.signature.domain/imagesignature/content) { get; } | Specificeert de binaire gegevensinhoud van het type afbeelding[`Format`](./format) . Standaard is deze eigenschap niet ingesteld. Gebruik eigenschap[`ReturnContent`](../../groupdocs.signature.options/imagesearchoptions/returncontent) om deze functie in te schakelen. |
...
| [Format](../../groupdocs.signature.domain/imagesignature/format) { get; } | Specificeert het formaat van handtekening afbeelding. |
...
| [Size](../../groupdocs.signature.domain/imagesignature/size) { get; } | Specificeert de grootte in bytes van handtekeningafbeelding. |
...
| Naam | Beschrijving |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/imagesignature/clone)() | Clone Barcode Signature-exemplaar. |
| override [Equals](../../groupdocs.signature.domain/imagesignature/equals)(object) | Overschrijft de Equals-methode om handtekeningeigenschappen te vergelijken |
| override [GetHashCode](../../groupdocs.signature.domain/imagesignature/gethashcode)() | Overschrijft GetHashCode-methode |
