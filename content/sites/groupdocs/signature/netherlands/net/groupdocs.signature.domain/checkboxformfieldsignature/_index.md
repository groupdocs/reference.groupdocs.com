...
description: Bevat checkbox invoerformulier veld handtekening eigenschappen.
type: docs
weight: 80
url: /nl/net/groupdocs.signature.domain/checkboxformfieldsignature/
---
## CheckboxFormFieldSignature class

Bevat check-box invoerformulier veld handtekening eigenschappen.
...
| Naam | Beschrijving |
| --- | --- |
| [CheckboxFormFieldSignature](checkboxformfieldsignature#constructor)(string) | Creëert CheckboxFormFieldSignature met vooraf gedefinieerde naam. |
| [CheckboxFormFieldSignature](checkboxformfieldsignature#constructor_1)(string, bool) | Creëert CheckboxFormFieldSignature met vooraf gedefinieerde naam en waarde |

## Eigenschappen

| Naam | Beschrijving |
| --- | --- |
| [Checked](../../groupdocs.signature.domain/checkboxformfieldsignature/checked) { get; set; } | Haalt of stelt de aangevinkte waarde van de invoer van het selectievakje in het formulierveld in. |
...
| Naam | Beschrijving |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/checkboxformfieldsignature/clone)() | Clone FormField Signature-instantie. |
| override [Equals](../../groupdocs.signature.domain/checkboxformfieldsignature/equals)(object) | Overschrijft de Equals-methode om handtekeningeigenschappen te vergelijken |
| override [GetHashCode](../../groupdocs.signature.domain/checkboxformfieldsignature/gethashcode)() | Overschrijft GetHashCode-methode |
