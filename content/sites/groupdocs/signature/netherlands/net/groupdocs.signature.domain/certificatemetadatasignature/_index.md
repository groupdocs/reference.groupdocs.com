...
description: Bevat certificaatmetagegevens Handtekeningeigenschappen.
type: docs
weight: 70
url: /nl/net/groupdocs.signature.domain/certificatemetadatasignature/
---
## CertificateMetadataSignature class

Bevat certificaatmetagegevens Handtekeningeigenschappen.
...
| Naam | Beschrijving |
| --- | --- |
| [CertificateMetadataSignature](certificatemetadatasignature#constructor)(string) | Creëert handtekening metagegevens certificaat met vooraf gedefinieerde naam en lege waarde. |
| [CertificateMetadataSignature](certificatemetadatasignature#constructor_1)(string, object) | Creëert handtekening metagegevens certificaat met vooraf gedefinieerde waarden. |
...
| Naam | Beschrijving |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/certificatemetadatasignature/clone#clone_1)() | Clone Metadata Signature-instantie. |
| override [Clone](../../groupdocs.signature.domain/certificatemetadatasignature/clone#clone)(object) | Clone Certificate Metadata Signature-instantie met gegeven waarde. |
...
| override [ToString](../../groupdocs.signature.domain/certificatemetadatasignature/tostring#tostring)() | Converteert naar String met override ToString() methode |
...
| override [ToString](../../groupdocs.signature.domain/certificatemetadatasignature/tostring#tostring_2)(string, IFormatProvider) | Converteert naar String met opgegeven formaat |
