...
description: Bevat eigenschappen van de veldhandtekening van het keuzerondje voor invoerformulieren.
type: docs
weight: 820
url: /nl/net/groupdocs.signature.domain/radiobuttonformfieldsignature/
---
## RadioButtonFormFieldSignature class

Bevat eigenschappen van de veldhandtekening van het keuzerondje voor invoerformulieren.
...
| Naam | Beschrijving |
| --- | --- |
| [RadioButtonFormFieldSignature](radiobuttonformfieldsignature#constructor)(string) | Creëert RadioButtonFieldSignature met vooraf gedefinieerde naam. |
| [RadioButtonFormFieldSignature](radiobuttonformfieldsignature#constructor_1)(string, List&lt;string&gt;) | Creëert RadioButtonFieldSignature met vooraf gedefinieerde naam en itemslijst. |
| [RadioButtonFormFieldSignature](radiobuttonformfieldsignature#constructor_2)(string, List&lt;string&gt;, object) | Creëert RadioButtonFieldSignature met vooraf gedefinieerde naam, itemslijst en geselecteerde waarde. |
...
| [Items](../../groupdocs.signature.domain/radiobuttonformfieldsignature/items) { get; set; } | Optielijst keuzerondjes ophalen of instellen. |
...
| [Selected](../../groupdocs.signature.domain/radiobuttonformfieldsignature/selected) { get; set; } | Bevat geselecteerde waarde. |
...
| Naam | Beschrijving |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/radiobuttonformfieldsignature/clone)() | Clone FormField Signature-instantie. |
| override [Equals](../../groupdocs.signature.domain/radiobuttonformfieldsignature/equals)(object) | Overschrijft de Equals-methode om handtekeningeigenschappen te vergelijken |
| override [GetHashCode](../../groupdocs.signature.domain/radiobuttonformfieldsignature/gethashcode)() | Overschrijft GetHashCode-methode |
