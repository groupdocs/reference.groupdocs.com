...
description: Vertegenwoordigt de barcodehandtekeningopties.
type: docs
weight: 1260
url: /nl/net/groupdocs.signature.options/barcodesignoptions/
---
## BarcodeSignOptions class

Vertegenwoordigt de barcodehandtekeningopties.
...
| Naam | Beschrijving |
| --- | --- |
| [BarcodeSignOptions](barcodesignoptions#constructor)() | Initialiseert een nieuwe instantie van de klasse BarcodeSignOptions met standaardwaarden. |
| [BarcodeSignOptions](barcodesignoptions#constructor_1)(string) | Initialiseert een nieuwe instantie van de klasse BarcodeSignOptions met tekst. |
| [BarcodeSignOptions](barcodesignoptions#constructor_2)(string, BarcodeType) | Initialiseert een nieuwe instantie van de klasse BarcodeSignOptions met tekst. |
...
| [CodeTextAlignment](../../groupdocs.signature.options/barcodesignoptions/codetextalignment) { get; set; } | Hiermee wordt de uitlijning van tekst in de resulterende streepjescodeafbeelding opgehaald of ingesteld. Standaardwaarde is Geen. |
...
| [EncodeType](../../groupdocs.signature.options/barcodesignoptions/encodetype) { get; set; } | Ontvangt of stelt streepjescodetype in. |
...
| override [ForeColor](../../groupdocs.signature.options/barcodesignoptions/forecolor) { get; set; } | Hiermee wordt de voorgrondkleur van streepjescodebalken opgehaald of ingesteld. Het gebruik van deze eigenschap kan problemen met de verificatie veroorzaken. Gebruik het voorzichtig. |
...
| [InnerMargins](../../groupdocs.signature.options/barcodesignoptions/innermargins) { get; set; } | Hiermee wordt de ruimte tussen streepjescode-elementen en resultaatafbeeldingsranden opgehaald of ingesteld. |
...
* Basisgebruik van het maken van een elektronische handtekening met streepjescode door GroupDocs.Signature: [Document e-ondertekenen met streepjescodehandtekening](https://docs.groupdocs.com/display/signaturenet/eSign+document+with+Barcode+signature)
* Geavanceerd gebruik van instellingen van elektronische handtekening met streepjescode met GroupDocs.Signature: [Geavanceerd gebruik voor eSign-documenten met barcodehandtekening en aanvullende instellingen](https://docs.groupdocs.com/display/signaturenet/Sign+document+with+Barcode+signature+and+additional+settings)
