...
description: Vertegenwoordigt de klasse van de FormFieldhandtekeningopties voor pdfdocumenten.
type: docs
weight: 1380
url: /nl/net/groupdocs.signature.options/formfieldsignoptions/
---
## FormFieldSignOptions class

Vertegenwoordigt de klasse van de FormField-handtekeningopties voor pdf-documenten.
...
| Naam | Beschrijving |
| --- | --- |
| [FormFieldSignOptions](formfieldsignoptions#constructor)() | Initialiseert een nieuwe instantie van de klasse PdfFormFieldSignOptions met standaardwaarden. |
| [FormFieldSignOptions](formfieldsignoptions#constructor_1)(FormFieldSignature) | Initialiseert een nieuwe instantie van de klasse PdfFormFieldSignOptions met FormField-handtekening. |
...
| [Signature](../../groupdocs.signature.options/formfieldsignoptions/signature) { get; set; } | Haalt of stelt het FormField van handtekening in. |
...
* Basisgebruik van het maken van FormField elektronische handtekening door GroupDocs.Signature: [Document e-ondertekenen met FormField-handtekening](https://docs.groupdocs.com/display/signaturenet/eSign+document+with+Form+Field+signature)
* Geavanceerd gebruik van instellingen van FormField elektronische handtekening met GroupDocs.Signature: [Geavanceerd gebruik voor eSign-documenten met FormField-handtekening en aanvullende instellingen](https://docs.groupdocs.com/display/signaturenet/Sign+document+with+Form+Field+signature+-+advanced)
