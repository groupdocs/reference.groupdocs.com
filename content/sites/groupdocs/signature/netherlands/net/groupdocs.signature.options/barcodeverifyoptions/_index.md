...
description: Vertegenwoordigt de streepjescodeverificatieopties.
type: docs
weight: 1270
url: /nl/net/groupdocs.signature.options/barcodeverifyoptions/
---
## BarcodeVerifyOptions class

Vertegenwoordigt de streepjescodeverificatieopties.
...
| Naam | Beschrijving |
| --- | --- |
| [BarcodeVerifyOptions](barcodeverifyoptions#constructor)() | Creëert standaard verificatieoptie voor barcodehandtekening. |
| [BarcodeVerifyOptions](barcodeverifyoptions#constructor_1)(BarcodeType) | Creëert standaard verificatieoptie met streepjescodetype verificatie |
| [BarcodeVerifyOptions](barcodeverifyoptions#constructor_2)(string) | Creëert standaard verificatieoptie met verificatietekst |
| [BarcodeVerifyOptions](barcodeverifyoptions#constructor_3)(string, BarcodeType) | Creëert standaard Verificatie Optie met Barcode Type verificatie en tekst |
...
| [EncodeType](../../groupdocs.signature.options/barcodeverifyoptions/encodetype) { get; set; } | Verkrijgt of stelt barcodetypeverificatie in. |
...
* Basisgebruik van verificatie voor elektronische handtekening met streepjescode door GroupDocs.Signature: [ Hoe eVerification Barcode handtekeningen in een document](https://docs.groupdocs.com/display/signaturenet/Verify+Barcode+signatures+in+the+document)
* Geavanceerd gebruik van verificatie-instellingen voor elektronische handtekening met streepjescode met GroupDocs.Signature: [Geavanceerd gebruik van eVerification-streepjescodehandtekeningen in een document en aanvullende instellingen]()
