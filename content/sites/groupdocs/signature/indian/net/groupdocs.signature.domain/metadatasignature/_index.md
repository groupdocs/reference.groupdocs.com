...
description: में मेटडेट हस्तक्षर गुण शमल हैं
type: docs
weight: 610
url: /hi/net/groupdocs.signature.domain/metadatasignature/
---
## MetadataSignature class

में मेटाडेटा हस्ताक्षर गुण शामिल हैं।
...
| नाम | विवरण |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/metadatasignature/clone#clone_1)() | क्लोन मेटाडेटा हस्ताक्षर उदाहरण। |
| virtual [Clone](../../groupdocs.signature.domain/metadatasignature/clone#clone)(object) | दिए गए मान के साथ क्लोन मेटाडेटा हस्ताक्षर उदाहरण। |
...
| [GetData&lt;T&gt;](../../groupdocs.signature.domain/metadatasignature/getdata#getdata)() | अक्रमांकन पर मेटाडेटा हस्ताक्षर मूल्य से वस्तु प्राप्त करें। |
| [GetData&lt;T&gt;](../../groupdocs.signature.domain/metadatasignature/getdata#getdata_1)(IDataEncryption) | अक्रमांकन पर मेटाडेटा सिग्नेचर टेक्स्ट से ऑब्जेक्ट प्राप्त करें। |
...
| virtual [ToDateTime](../../groupdocs.signature.domain/metadatasignature/todatetime#todatetime)() | दिनांक समय में परिवर्तित होता है. |
| virtual [ToDateTime](../../groupdocs.signature.domain/metadatasignature/todatetime#todatetime_1)(IFormatProvider) | दिनांक समय में परिवर्तित होता है. |
| virtual [ToDecimal](../../groupdocs.signature.domain/metadatasignature/todecimal#todecimal)() | दशमलव में परिवर्तित होता है। |
| virtual [ToDecimal](../../groupdocs.signature.domain/metadatasignature/todecimal#todecimal_1)(IFormatProvider) | दशमलव में परिवर्तित होता है। |
| virtual [ToDouble](../../groupdocs.signature.domain/metadatasignature/todouble#todouble)() | डबल में परिवर्तित होता है। |
| virtual [ToDouble](../../groupdocs.signature.domain/metadatasignature/todouble#todouble_1)(IFormatProvider) | डबल में परिवर्तित होता है। |
| virtual [ToInteger](../../groupdocs.signature.domain/metadatasignature/tointeger)() | पूर्णांक में परिवर्तित होता है। |
| virtual [ToSingle](../../groupdocs.signature.domain/metadatasignature/tosingle#tosingle)() | फ्लोट में परिवर्तित होता है। |
| virtual [ToSingle](../../groupdocs.signature.domain/metadatasignature/tosingle#tosingle_1)(IFormatProvider) | फ्लोट में परिवर्तित होता है। |
| override [ToString](../../groupdocs.signature.domain/metadatasignature/tostring#tostring)() | ओवरराइड ToString () method के साथ स्ट्रिंग में कनवर्ट करता है |
| virtual [ToString](../../groupdocs.signature.domain/metadatasignature/tostring#tostring_1)(string) | निर्दिष्ट स्वरूप के साथ स्ट्रिंग में कनवर्ट करता है |
| virtual [ToString](../../groupdocs.signature.domain/metadatasignature/tostring#tostring_2)(string, IFormatProvider) | निर्दिष्ट स्वरूप के साथ स्ट्रिंग में कनवर्ट करता है |
