...
description: हस्तक्षर के लए आधर वर्ग क वर्णन करत है
type: docs
weight: 50
url: /hi/net/groupdocs.signature.domain/basesignature/
---
## BaseSignature class

हस्ताक्षर के लिए आधार वर्ग का वर्णन करता है।
...
| नाम | विवरण |
| --- | --- |
| virtual [Clone](../../groupdocs.signature.domain/basesignature/clone)() | क्लोन सिग्नेचर इंस्टेंस. |
| override [Equals](../../groupdocs.signature.domain/basesignature/equals)(object) | हस्ताक्षर गुणों की तुलना करने के लिए बराबर विधि को ओवरराइट करता है |
| override [GetHashCode](../../groupdocs.signature.domain/basesignature/gethashcode)() | GetHashCode method को ओवरराइड करता है |
