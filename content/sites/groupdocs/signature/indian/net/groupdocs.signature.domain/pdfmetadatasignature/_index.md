...
description: में पडएफ मेटडेट हस्तक्षर गुण शमल हैं
type: docs
weight: 680
url: /hi/net/groupdocs.signature.domain/pdfmetadatasignature/
---
## PdfMetadataSignature class

में पीडीएफ मेटाडेटा हस्ताक्षर गुण शामिल हैं।
...
| नाम | विवरण |
| --- | --- |
| [PdfMetadataSignature](pdfmetadatasignature#constructor)(string) | पूर्वनिर्धारित नाम और खाली मान के साथ पीडीएफ मेटाडेटा हस्ताक्षर बनाता है |
| [PdfMetadataSignature](pdfmetadatasignature#constructor_1)(string, object) | पूर्वनिर्धारित मानों के साथ पीडीएफ मेटाडेटा हस्ताक्षर बनाता है |
| [PdfMetadataSignature](pdfmetadatasignature#constructor_2)(string, object, string) | पूर्वनिर्धारित मानों के साथ पीडीएफ मेटाडेटा हस्ताक्षर बनाता है |
...
| [TagPrefix](../../groupdocs.signature.domain/pdfmetadatasignature/tagprefix) { get; set; } | पीडीएफ मेटाडेटा हस्ताक्षर नाम का उपसर्ग टैग। डिफ़ॉल्ट रूप से यह संपत्ति "xmp" पर सेट है। संभावित मान हैं |
...
| नाम | विवरण |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/pdfmetadatasignature/clone#clone_1)() | क्लोन मेटाडेटा हस्ताक्षर उदाहरण। |
| override [Clone](../../groupdocs.signature.domain/pdfmetadatasignature/clone#clone)(object) | दिए गए मान के साथ क्लोन पीडीएफ मेटाडेटा हस्ताक्षर उदाहरण। |
| override [Equals](../../groupdocs.signature.domain/pdfmetadatasignature/equals)(object) | हस्ताक्षर गुणों की तुलना करने के लिए बराबर विधि को ओवरराइट करता है |
...
| override [GetHashCode](../../groupdocs.signature.domain/pdfmetadatasignature/gethashcode)() | GetHashCode method को ओवरराइड करता है |
...
| override [ToString](../../groupdocs.signature.domain/metadatasignature/tostring)() | ओवरराइड ToString () method के साथ स्ट्रिंग में कनवर्ट करता है |
...
| virtual [ToString](../../groupdocs.signature.domain/metadatasignature/tostring)(string, IFormatProvider) | निर्दिष्ट स्वरूप के साथ स्ट्रिंग में कनवर्ट करता है |
