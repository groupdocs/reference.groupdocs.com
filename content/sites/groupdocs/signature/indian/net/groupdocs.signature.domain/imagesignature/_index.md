...
description: में छव हस्तक्षर गुण शमल हैं
type: docs
weight: 590
url: /hi/net/groupdocs.signature.domain/imagesignature/
---
## ImageSignature class

में छवि हस्ताक्षर गुण शामिल हैं।
...
| नाम | विवरण |
| --- | --- |
| [ImageSignature](imagesignature)(string) | सिग्नेचर आइडेंटिफायर के साथ इमेज सिग्नेचर ऑब्जेक्ट को इनिशियलाइज़ करें जो खोज प्रक्रिया के बाद प्राप्त किया गया था। इस यूनिक आइडेंटिफायर का उपयोग इस सिग्नेचर के लिए डॉक्यूमेंट सिग्नेचर इंफॉर्मेशन लेयर से अतिरिक्त प्रॉपर्टी खोजने के लिए किया जाता है। |

## गुण

| नाम | विवरण |
| --- | --- |
| [Content](../../groupdocs.signature.domain/imagesignature/content) { get; } | प्रकार की छवि बाइनरी डेटा सामग्री निर्दिष्ट करता है[`Format`](./format) . डिफ़ॉल्ट रूप से यह संपत्ति सेट नहीं की जाएगी। संपत्ति का प्रयोग करें[`ReturnContent`](../../groupdocs.signature.options/imagesearchoptions/returncontent) इस सुविधा को सक्षम करने के लिए. |
...
| [Format](../../groupdocs.signature.domain/imagesignature/format) { get; } | हस्ताक्षर छवि के प्रारूप को निर्दिष्ट करता है। |
...
| [Size](../../groupdocs.signature.domain/imagesignature/size) { get; } | हस्ताक्षर छवि के बाइट्स में आकार निर्दिष्ट करता है। |
...
| नाम | विवरण |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/imagesignature/clone)() | क्लोन बारकोड सिग्नेचर इंस्टेंस. |
| override [Equals](../../groupdocs.signature.domain/imagesignature/equals)(object) | हस्ताक्षर गुणों की तुलना करने के लिए बराबर विधि को ओवरराइट करता है |
| override [GetHashCode](../../groupdocs.signature.domain/imagesignature/gethashcode)() | GetHashCode method को ओवरराइड करता है |
