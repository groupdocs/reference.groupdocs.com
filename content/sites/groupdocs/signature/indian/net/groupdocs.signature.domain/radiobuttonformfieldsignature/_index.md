...
description: में रेडयबटन इनपुट फर्म फ़ल्ड हस्तक्षर गुण शमल हैं
type: docs
weight: 820
url: /hi/net/groupdocs.signature.domain/radiobuttonformfieldsignature/
---
## RadioButtonFormFieldSignature class

में रेडियो-बटन इनपुट फॉर्म फ़ील्ड हस्ताक्षर गुण शामिल हैं।
...
| नाम | विवरण |
| --- | --- |
| [RadioButtonFormFieldSignature](radiobuttonformfieldsignature#constructor)(string) | पूर्वनिर्धारित नाम के साथ RadioButtonFieldSignature बनाता है। |
| [RadioButtonFormFieldSignature](radiobuttonformfieldsignature#constructor_1)(string, List&lt;string&gt;) | पूर्वनिर्धारित नाम और आइटम सूची के साथ RadioButtonFieldSignature बनाता है। |
| [RadioButtonFormFieldSignature](radiobuttonformfieldsignature#constructor_2)(string, List&lt;string&gt;, object) | पूर्वनिर्धारित नाम, आइटम सूची और चयनित मान के साथ RadioButtonFieldSignature बनाता है। |
...
| [Items](../../groupdocs.signature.domain/radiobuttonformfieldsignature/items) { get; set; } | रेडियो बटन विकल्प सूची प्राप्त करें या सेट करें। |
...
| [Selected](../../groupdocs.signature.domain/radiobuttonformfieldsignature/selected) { get; set; } | में चयनित मान शामिल है। |
...
| नाम | विवरण |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/radiobuttonformfieldsignature/clone)() | क्लोन फॉर्मफिल्ड सिग्नेचर इंस्टेंस। |
| override [Equals](../../groupdocs.signature.domain/radiobuttonformfieldsignature/equals)(object) | हस्ताक्षर गुणों की तुलना करने के लिए बराबर विधि को ओवरराइट करता है |
| override [GetHashCode](../../groupdocs.signature.domain/radiobuttonformfieldsignature/gethashcode)() | GetHashCode method को ओवरराइड करता है |
