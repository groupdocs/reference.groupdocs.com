...
description: में वर्ड प्रसेसंग मेटडेट हस्तक्षर गुण शमल हैं
type: docs
weight: 1070
url: /hi/net/groupdocs.signature.domain/wordprocessingmetadatasignature/
---
## WordProcessingMetadataSignature class

में वर्ड प्रोसेसिंग मेटाडेटा हस्ताक्षर गुण शामिल हैं।
...
| नाम | विवरण |
| --- | --- |
| [WordProcessingMetadataSignature](wordprocessingmetadatasignature#constructor)(string) | पूर्वनिर्धारित नाम और खाली मान के साथ वर्ड प्रोसेसिंग मेटाडेटा सिग्नेचर बनाता है। |
| [WordProcessingMetadataSignature](wordprocessingmetadatasignature#constructor_1)(string, object) | पूर्वनिर्धारित मानों के साथ वर्ड प्रोसेसिंग मेटाडेटा सिग्नेचर बनाता है। |
...
| नाम | विवरण |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/wordprocessingmetadatasignature/clone#clone_1)() | क्लोन मेटाडेटा हस्ताक्षर उदाहरण। |
| override [Clone](../../groupdocs.signature.domain/wordprocessingmetadatasignature/clone#clone)(object) | क्लोन शब्द मेटाडेटा हस्ताक्षर उदाहरण दिए गए मान के साथ। |
...
| override [ToString](../../groupdocs.signature.domain/wordprocessingmetadatasignature/tostring#tostring)() | ओवरराइड ToString () method के साथ स्ट्रिंग में कनवर्ट करता है |
...
| override [ToString](../../groupdocs.signature.domain/wordprocessingmetadatasignature/tostring#tostring_2)(string, IFormatProvider) | निर्दिष्ट स्वरूप के साथ स्ट्रिंग में कनवर्ट करता है |
