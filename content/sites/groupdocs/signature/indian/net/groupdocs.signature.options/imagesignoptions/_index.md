...
description: छव हस्तक्षर वकल्पं क प्रतनधत्व करत है
type: docs
weight: 1420
url: /hi/net/groupdocs.signature.options/imagesignoptions/
---
## ImageSignOptions class

छवि हस्ताक्षर विकल्पों का प्रतिनिधित्व करता है।
...
| नाम | विवरण |
| --- | --- |
| [ImageSignOptions](imagesignoptions#constructor)() | डिफ़ॉल्ट मानों के साथ ImageSignOptions वर्ग का एक नया उदाहरण आरंभ करता है। |
| [ImageSignOptions](imagesignoptions#constructor_1)(Stream) | छवि स्ट्रीम के साथ ImageSignOptions वर्ग का एक नया उदाहरण शुरू करता है। |
| [ImageSignOptions](imagesignoptions#constructor_2)(string) | छवि फ़ाइल के साथ ImageSignOptions वर्ग का एक नया उदाहरण शुरू करता है। |
...
| नाम | विवरण |
| --- | --- |
| static [FromBase64](../../groupdocs.signature.options/imagesignoptions/frombase64)(string) | Base64. से पूर्वनिर्धारित छवि के साथ ImageSignOptions वर्ग का एक नया उदाहरण बनाता है |
...
* GroupDocs द्वारा छवि इलेक्ट्रॉनिक हस्ताक्षर बनाने का मूल उपयोग। हस्ताक्षर: [इमेज सिग्नेचर के साथ डॉक्यूमेंट पर ई-साइन कैसे करें](https://docs.groupdocs.com/display/signaturenet/eSign+document+with+Image+signature)
* GroupDocs के साथ छवि इलेक्ट्रॉनिक हस्ताक्षर की सेटिंग का उन्नत उपयोग। हस्ताक्षर: [छवि हस्ताक्षर और अतिरिक्त सेटिंग्स के साथ ई-हस्ताक्षर दस्तावेज़ का उन्नत उपयोग](https://docs.groupdocs.com/display/signaturenet/Sign+document+with+Image+signature+-+advanced)
