...
description: बरकड सत्यपन वकल्पं क प्रतनधत्व करत है
type: docs
weight: 1270
url: /hi/net/groupdocs.signature.options/barcodeverifyoptions/
---
## BarcodeVerifyOptions class

बारकोड सत्यापन विकल्पों का प्रतिनिधित्व करता है।
...
| नाम | विवरण |
| --- | --- |
| [BarcodeVerifyOptions](barcodeverifyoptions#constructor)() | बारकोड हस्ताक्षर के लिए डिफ़ॉल्ट सत्यापन विकल्प बनाता है। |
| [BarcodeVerifyOptions](barcodeverifyoptions#constructor_1)(BarcodeType) | बारकोड प्रकार के सत्यापन के साथ डिफ़ॉल्ट सत्यापन विकल्प बनाता है |
| [BarcodeVerifyOptions](barcodeverifyoptions#constructor_2)(string) | सत्यापन पाठ के साथ डिफ़ॉल्ट सत्यापन विकल्प बनाता है |
| [BarcodeVerifyOptions](barcodeverifyoptions#constructor_3)(string, BarcodeType) | बारकोड प्रकार सत्यापन और text के साथ डिफ़ॉल्ट सत्यापन विकल्प बनाता है |
...
| [EncodeType](../../groupdocs.signature.options/barcodeverifyoptions/encodetype) { get; set; } | बारकोड प्रकार सत्यापन प्राप्त या सेट करता है। |
...
* GroupDocs द्वारा बारकोड इलेक्ट्रॉनिक हस्ताक्षर के सत्यापन का मूल उपयोग। हस्ताक्षर: [ किसी दस्तावेज़ में बारकोड हस्ताक्षर का ई-सत्यापन कैसे करें](https://docs.groupdocs.com/display/signaturenet/Verify+Barcode+signatures+in+the+document)
* GroupDocs के साथ बारकोड इलेक्ट्रॉनिक हस्ताक्षर के सत्यापन की सेटिंग का उन्नत उपयोग। हस्ताक्षर: [एक दस्तावेज़ और अतिरिक्त सेटिंग्स में ई-सत्यापन बारकोड हस्ताक्षरों का उन्नत उपयोग]()
