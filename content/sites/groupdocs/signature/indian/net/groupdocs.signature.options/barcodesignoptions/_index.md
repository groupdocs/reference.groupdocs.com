...
description: बरकड हस्तक्षर वकल्पं क प्रतनधत्व करत है
type: docs
weight: 1260
url: /hi/net/groupdocs.signature.options/barcodesignoptions/
---
## BarcodeSignOptions class

बारकोड हस्ताक्षर विकल्पों का प्रतिनिधित्व करता है।
...
| नाम | विवरण |
| --- | --- |
| [BarcodeSignOptions](barcodesignoptions#constructor)() | डिफ़ॉल्ट मानों के साथ BarcodeSignOptions वर्ग का एक नया उदाहरण शुरू करता है। |
| [BarcodeSignOptions](barcodesignoptions#constructor_1)(string) | पाठ के साथ BarcodeSignOptions वर्ग का एक नया उदाहरण प्रारंभ करता है। |
| [BarcodeSignOptions](barcodesignoptions#constructor_2)(string, BarcodeType) | पाठ के साथ BarcodeSignOptions वर्ग का एक नया उदाहरण प्रारंभ करता है। |
...
| [CodeTextAlignment](../../groupdocs.signature.options/barcodesignoptions/codetextalignment) { get; set; } | परिणाम बारकोड छवि में पाठ के संरेखण को प्राप्त या सेट करता है। डिफ़ॉल्ट मान कोई नहीं है। |
...
| [EncodeType](../../groupdocs.signature.options/barcodesignoptions/encodetype) { get; set; } | बारकोड प्रकार प्राप्त या सेट करता है। |
...
| override [ForeColor](../../groupdocs.signature.options/barcodesignoptions/forecolor) { get; set; } | बारकोड बार के अग्र रंग को प्राप्त या सेट करता है इस गुण के उपयोग से सत्यापन में समस्या हो सकती है। इसे सावधानी से प्रयोग करें. |
...
| [InnerMargins](../../groupdocs.signature.options/barcodesignoptions/innermargins) { get; set; } | बारकोड तत्वों और परिणाम छवि सीमाओं के बीच स्थान प्राप्त या सेट करता है। |
...
* GroupDocs द्वारा बारकोड इलेक्ट्रॉनिक हस्ताक्षर बनाने का मूल उपयोग। हस्ताक्षर: [बारकोड सिग्नेचर के साथ डॉक्यूमेंट पर ई-साइन कैसे करें](https://docs.groupdocs.com/display/signaturenet/eSign+document+with+Barcode+signature)
* GroupDocs के साथ बारकोड इलेक्ट्रॉनिक हस्ताक्षर की सेटिंग का उन्नत उपयोग। हस्ताक्षर: [बारकोड सिग्नेचर और अतिरिक्त सेटिंग्स के साथ ई-साइन दस्तावेज़ का उन्नत उपयोग](https://docs.groupdocs.com/display/signaturenet/Sign+document+with+Barcode+signature+and+additional+settings)
