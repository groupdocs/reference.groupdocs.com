...
description: इमेज दस्तवेज़ं के लए टफ़ सेव वकल्प.
type: docs
weight: 1760
url: /hi/net/groupdocs.signature.options/tiffsaveoptions/
---
## TiffSaveOptions class

इमेज दस्तावेज़ों के लिए टिफ़ सेव विकल्प.
...
| नाम | विवरण |
| --- | --- |
| [TiffSaveOptions](tiffsaveoptions)() | डिफ़ॉल्ट मानों के साथ TiffSaveOptions बनाता है। |
...
| [ExpectedTiffFormat](../../groupdocs.signature.options/tiffsaveoptions/expectedtiffformat) { get; set; } | हस्ताक्षरित दस्तावेज़ का TIFF प्रारूप प्राप्त या सेट करता है। |
