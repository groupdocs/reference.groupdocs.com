...
description: छव दस्तवेज़ं के लए जेपईज सहेजें वकल्प
type: docs
weight: 1460
url: /hi/net/groupdocs.signature.options/jpegsaveoptions/
---
## JpegSaveOptions class

छवि दस्तावेज़ों के लिए जेपीईजी सहेजें विकल्प।
...
| नाम | विवरण |
| --- | --- |
| [JpegSaveOptions](jpegsaveoptions)() | डिफ़ॉल्ट मानों के साथ JpegSaveOptions बनाता है। |
...
| [BitsPerChannel](../../groupdocs.signature.options/jpegsaveoptions/bitsperchannel) { get; set; } | दोषरहित जेपीईजी छवि के लिए प्रति चैनल बिट प्राप्त या सेट करता है। अब हम प्रति चैनल 2 से 8 बिट्स का समर्थन करते हैं। |
| [ColorType](../../groupdocs.signature.options/jpegsaveoptions/colortype) { get; set; } | जेपीईजी छवि के लिए रंग प्रकार प्राप्त या सेट करता है। |
| [Comment](../../groupdocs.signature.options/jpegsaveoptions/comment) { get; set; } | जेपीईजी फ़ाइल टिप्पणी प्राप्त या सेट करता है। |
| [CompressionType](../../groupdocs.signature.options/jpegsaveoptions/compressiontype) { get; set; } | संपीड़न प्रकार प्राप्त या सेट करता है। |
...
| [Quality](../../groupdocs.signature.options/jpegsaveoptions/quality) { get; set; } | छवि गुणवत्ता प्राप्त या सेट करता है। |
| [SampleRoundingMode](../../groupdocs.signature.options/jpegsaveoptions/sampleroundingmode) { get; set; } | एक 8-बिट मान को n-बिट मान JpegOptions.BitsPerChannel. में फ़िट करने के लिए सैंपल राउंडिंग मोड प्राप्त या सेट करता है |
