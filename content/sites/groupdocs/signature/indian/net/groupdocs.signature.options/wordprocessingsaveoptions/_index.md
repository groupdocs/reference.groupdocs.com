...
description: वर्डप्रसेसंग दस्तवेज़ं के लए वकल्प सहेजें
type: docs
weight: 1790
url: /hi/net/groupdocs.signature.options/wordprocessingsaveoptions/
---
## WordProcessingSaveOptions class

वर्डप्रोसेसिंग दस्तावेज़ों के लिए विकल्प सहेजें।
...
| नाम | विवरण |
| --- | --- |
| [WordProcessingSaveOptions](wordprocessingsaveoptions#constructor)() | डिफ़ॉल्ट मानों के साथ WordProcessingSaveOptions वर्ग का एक नया उदाहरण आरंभ करता है। |
| [WordProcessingSaveOptions](wordprocessingsaveoptions#constructor_1)(bool) | निर्दिष्ट आउटपुट प्रकार के साथ WordProcessingSaveOptions वर्ग का एक नया उदाहरण प्रारंभ करता है और ध्वज को अधिलेखित करता है। |
| [WordProcessingSaveOptions](wordprocessingsaveoptions#constructor_2)(WordProcessingSaveFileFormat) | निर्दिष्ट आउटपुट फ़ाइल स्वरूप के साथ WordProcessingSaveOptions वर्ग का एक नया उदाहरण आरंभ करता है। |
| [WordProcessingSaveOptions](wordprocessingsaveoptions#constructor_3)(WordProcessingSaveFileFormat, bool) | निर्दिष्ट आउटपुट फ़ाइल स्वरूप के साथ WordProcessingSaveOptions वर्ग का एक नया उदाहरण प्रारंभ करता है और ध्वज को अधिलेखित करता है। |
...
| [FileFormat](../../groupdocs.signature.options/wordprocessingsaveoptions/fileformat) { get; set; } | हस्ताक्षरित दस्तावेज़ का फ़ाइल प्रारूप प्राप्त या सेट करता है। |
