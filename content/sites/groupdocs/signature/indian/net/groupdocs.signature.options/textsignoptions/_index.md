...
description: पठ हस्तक्षर वकल्पं क प्रतनधत्व करत है
type: docs
weight: 1730
url: /hi/net/groupdocs.signature.options/textsignoptions/
---
## TextSignOptions class

पाठ हस्ताक्षर विकल्पों का प्रतिनिधित्व करता है।
...
| नाम | विवरण |
| --- | --- |
| [TextSignOptions](textsignoptions#constructor)() | डिफ़ॉल्ट मानों के साथ TextSignOptions वर्ग का एक नया उदाहरण प्रारंभ करता है। |
| [TextSignOptions](textsignoptions#constructor_1)(string) | टेक्स्ट के साथ टेक्स्टसाइनऑप्शन क्लास का एक नया उदाहरण प्रारंभ करता है। |
...
* GroupDocs द्वारा टेक्स्ट इलेक्ट्रॉनिक हस्ताक्षर बनाने का मूल उपयोग। हस्ताक्षर: [टेक्स्ट सिग्नेचर के साथ डॉक्यूमेंट पर ई-साइन कैसे करें](https://docs.groupdocs.com/display/signaturenet/eSign+document+with+Text+signature)
* GroupDocs के साथ टेक्स्ट इलेक्ट्रॉनिक हस्ताक्षर की सेटिंग का उन्नत उपयोग। हस्ताक्षर: [टेक्स्ट सिग्नेचर और अतिरिक्त सेटिंग्स के साथ ई-साइन दस्तावेज़ का उन्नत उपयोग](https://docs.groupdocs.com/display/signaturenet/Sign+document+with+Text+signature+-+advanced)
