...
description: PDF दस्तवेज़ं के लए सहेजें वकल्प.
type: docs
weight: 1510
url: /hi/net/groupdocs.signature.options/pdfsaveoptions/
---
## PdfSaveOptions class

PDF दस्तावेज़ों के लिए सहेजें विकल्प.
...
| नाम | विवरण |
| --- | --- |
| [PdfSaveOptions](pdfsaveoptions#constructor)() | डिफ़ॉल्ट मानों के साथ PdfSaveOptions वर्ग का एक नया उदाहरण प्रारंभ करता है। |
| [PdfSaveOptions](pdfsaveoptions#constructor_1)(bool) | ओवरराइट फ्लैग के साथ PdfSaveOptions वर्ग का एक नया उदाहरण प्रारंभ करता है। |
| [PdfSaveOptions](pdfsaveoptions#constructor_2)(PdfSaveFileFormat) | निर्दिष्ट आउटपुट फ़ाइल स्वरूप के साथ PdfSaveOptions वर्ग का एक नया उदाहरण आरंभ करता है। |
| [PdfSaveOptions](pdfsaveoptions#constructor_3)(PdfSaveFileFormat, bool) | निर्दिष्ट आउटपुट फ़ाइल प्रारूप के साथ PdfSaveOptions वर्ग का एक नया उदाहरण प्रारंभ करता है और ध्वज को अधिलेखित करता है। |
...
| [FileFormat](../../groupdocs.signature.options/pdfsaveoptions/fileformat) { get; set; } | हस्ताक्षरित दस्तावेज़ का फ़ाइल प्रारूप प्राप्त या सेट करता है। |
