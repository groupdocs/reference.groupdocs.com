...
description: Pdf ドキュメントの FormField 署名オプションのクラスを表します
type: docs
weight: 1380
url: /ja/net/groupdocs.signature.options/formfieldsignoptions/
---
## FormFieldSignOptions class

Pdf ドキュメントの FormField 署名オプションのクラスを表します。
...
| 名前 | 説明 |
| --- | --- |
| [FormFieldSignOptions](formfieldsignoptions#constructor)() | PdfFormFieldSignOptions クラスの新しいインスタンスをデフォルト値で初期化します。 |
| [FormFieldSignOptions](formfieldsignoptions#constructor_1)(FormFieldSignature) | FormField シグネチャを持つ PdfFormFieldSignOptions クラスの新しいインスタンスを初期化します。 |
...
| [Signature](../../groupdocs.signature.options/formfieldsignoptions/signature) { get; set; } | 署名の FormField を取得または設定します。 |
...
* GroupDocs.SignatureによるFormField電子署名作成の基本的な使い方: [FormField署名付きのドキュメントに電子署名する方法](https://docs.groupdocs.com/display/signaturenet/eSign+document+with+Form+Field+signature)
* GroupDocs.Signature: による FormField 電子署名の設定の高度な使用法[FormField署名と追加設定を使用してドキュメントを電子署名する高度な使用法](https://docs.groupdocs.com/display/signaturenet/Sign+document+with+Form+Field+signature+-+advanced)
