...
description: スプレッドシート ドキュメントのオプションを保存します
type: docs
weight: 1700
url: /ja/net/groupdocs.signature.options/spreadsheetsaveoptions/
---
## SpreadsheetSaveOptions class

スプレッドシート ドキュメントのオプションを保存します。
...
| 名前 | 説明 |
| --- | --- |
| [SpreadsheetSaveOptions](spreadsheetsaveoptions#constructor)() | SpreadsheetSaveOptions クラスの新しいインスタンスをデフォルト値で初期化します。 |
| [SpreadsheetSaveOptions](spreadsheetsaveoptions#constructor_1)(SpreadsheetSaveFileFormat) | SpreadsheetSaveOptions クラスの新しいインスタンスを定義済みの出力ファイル形式で初期化します。 |
| [SpreadsheetSaveOptions](spreadsheetsaveoptions#constructor_2)(SpreadsheetSaveFileFormat, bool) | 指定した出力タイプと上書きフラグを使用して、SpreadsheetSaveOptions クラスの新しいインスタンスを初期化します。 |
...
| [FileFormat](../../groupdocs.signature.options/spreadsheetsaveoptions/fileformat) { get; set; } | 署名済みドキュメントのファイル形式を取得または設定します。 |
