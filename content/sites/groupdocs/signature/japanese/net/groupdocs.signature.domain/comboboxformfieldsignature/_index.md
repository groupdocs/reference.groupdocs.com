...
description: コンボボックスの入力フォーム フィールド署名プロパティが含まれます
type: docs
weight: 100
url: /ja/net/groupdocs.signature.domain/comboboxformfieldsignature/
---
## ComboboxFormFieldSignature class

コンボボックスの入力フォーム フィールド署名プロパティが含まれます。
...
| 名前 | 説明 |
| --- | --- |
| [ComboboxFormFieldSignature](comboboxformfieldsignature#constructor)(string) | 定義済みの名前で ComboboxFormFieldSignature を作成します。 |
| [ComboboxFormFieldSignature](comboboxformfieldsignature#constructor_1)(string, List&lt;string&gt;) | 定義済みの名前とオプション リストで ComboboxFormFieldSignature を作成します。 |
| [ComboboxFormFieldSignature](comboboxformfieldsignature#constructor_2)(string, List&lt;string&gt;, object) | 定義済みの名前、オプション リスト、および選択した値で ComboboxFormFieldSignature を作成します。 |
...
| [Items](../../groupdocs.signature.domain/comboboxformfieldsignature/items) { get; set; } | コンボ ボックス オプション リストを取得または設定します。 |
...
| [Selected](../../groupdocs.signature.domain/comboboxformfieldsignature/selected) { get; set; } | 選択した値を取得または設定します。 |
...
| 名前 | 説明 |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/comboboxformfieldsignature/clone)() | FormField 署名インスタンスを複製します。 |
| override [Equals](../../groupdocs.signature.domain/comboboxformfieldsignature/equals)(object) | Equals メソッドを上書きして署名プロパティを比較します |
| override [GetHashCode](../../groupdocs.signature.domain/comboboxformfieldsignature/gethashcode)() | GetHashCode method をオーバーライドします |
