...
description: Pdf Document のテキスト入力フォーム フィールド署名プロパティが含まれます
type: docs
weight: 960
url: /ja/net/groupdocs.signature.domain/textformfieldsignature/
---
## TextFormFieldSignature class

Pdf Document のテキスト入力フォーム フィールド署名プロパティが含まれます
...
| 名前 | 説明 |
| --- | --- |
| [TextFormFieldSignature](textformfieldsignature#constructor)(string) | 定義済みの名前で PdfTextFormFieldSignature を作成します。 |
| [TextFormFieldSignature](textformfieldsignature#constructor_1)(string, string) | 定義済みの名前で PdfTextFormFieldSignature を作成します。 |
...
| [Text](../../groupdocs.signature.domain/textformfieldsignature/text) { get; set; } | フォーム フィールド テキスト入力のテキストを取得または設定します。 |
...
| 名前 | 説明 |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/textformfieldsignature/clone)() | FormField 署名インスタンスを複製します。 |
| override [Equals](../../groupdocs.signature.domain/textformfieldsignature/equals)(object) | Equals メソッドを上書きして署名プロパティを比較します |
| override [GetHashCode](../../groupdocs.signature.domain/textformfieldsignature/gethashcode)() | GetHashCode method をオーバーライドします |
