...
description: ラジオボタン入力フォーム フィールドの署名プロパティが含まれています
type: docs
weight: 820
url: /ja/net/groupdocs.signature.domain/radiobuttonformfieldsignature/
---
## RadioButtonFormFieldSignature class

ラジオボタン入力フォーム フィールドの署名プロパティが含まれています。
...
| 名前 | 説明 |
| --- | --- |
| [RadioButtonFormFieldSignature](radiobuttonformfieldsignature#constructor)(string) | 定義済みの名前で RadioButtonFieldSignature を作成します. |
| [RadioButtonFormFieldSignature](radiobuttonformfieldsignature#constructor_1)(string, List&lt;string&gt;) | 定義済みの名前と項目リストで RadioButtonFieldSignature を作成します。 |
| [RadioButtonFormFieldSignature](radiobuttonformfieldsignature#constructor_2)(string, List&lt;string&gt;, object) | 定義済みの名前、項目リスト、および選択された値で RadioButtonFieldSignature を作成します。 |
...
| [Items](../../groupdocs.signature.domain/radiobuttonformfieldsignature/items) { get; set; } | ラジオ ボタン オプション リストを取得または設定します。 |
...
| [Selected](../../groupdocs.signature.domain/radiobuttonformfieldsignature/selected) { get; set; } | 選択した値が含まれます。 |
...
| 名前 | 説明 |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/radiobuttonformfieldsignature/clone)() | FormField 署名インスタンスを複製します。 |
| override [Equals](../../groupdocs.signature.domain/radiobuttonformfieldsignature/equals)(object) | Equals メソッドを上書きして署名プロパティを比較します |
| override [GetHashCode](../../groupdocs.signature.domain/radiobuttonformfieldsignature/gethashcode)() | GetHashCode method をオーバーライドします |
