...
description: スプレッドシート メタデータ署名プロパティが含まれます
type: docs
weight: 870
url: /ja/net/groupdocs.signature.domain/spreadsheetmetadatasignature/
---
## SpreadsheetMetadataSignature class

スプレッドシート メタデータ署名プロパティが含まれます。
...
| 名前 | 説明 |
| --- | --- |
| [SpreadsheetMetadataSignature](spreadsheetmetadatasignature#constructor)(string) | 定義済みの名前と空の値を持つスプレッドシート メタデータ署名を作成します。 |
| [SpreadsheetMetadataSignature](spreadsheetmetadatasignature#constructor_1)(string, object) | 定義済みの値でスプレッドシート メタデータ署名を作成します。 |
...
| 名前 | 説明 |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/spreadsheetmetadatasignature/clone#clone_1)() | メタデータ署名インスタンスの複製. |
| override [Clone](../../groupdocs.signature.domain/spreadsheetmetadatasignature/clone#clone)(object) | 指定された値でスプレッドシート メタデータ署名インスタンスを複製します。 |
...
| override [ToString](../../groupdocs.signature.domain/spreadsheetmetadatasignature/tostring#tostring)() | オーバーライド ToString() method で文字列に変換します |
| virtual [ToString](../../groupdocs.signature.domain/metadatasignature/tostring)(string) | 指定されたフォーマットの文字列に変換します |
| override [ToString](../../groupdocs.signature.domain/spreadsheetmetadatasignature/tostring#tostring_2)(string, IFormatProvider) | 指定されたフォーマットの文字列に変換します |
