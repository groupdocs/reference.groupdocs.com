...
description: WordProcessing メタデータ署名プロパティが含まれています
type: docs
weight: 1070
url: /ja/net/groupdocs.signature.domain/wordprocessingmetadatasignature/
---
## WordProcessingMetadataSignature class

WordProcessing メタデータ署名プロパティが含まれています。
...
| 名前 | 説明 |
| --- | --- |
| [WordProcessingMetadataSignature](wordprocessingmetadatasignature#constructor)(string) | 定義済みの名前と空の値を使用して WordProcessing メタデータ署名を作成します。 |
| [WordProcessingMetadataSignature](wordprocessingmetadatasignature#constructor_1)(string, object) | 定義済みの値で WordProcessing メタデータ署名を作成します。 |
...
| 名前 | 説明 |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/wordprocessingmetadatasignature/clone#clone_1)() | メタデータ署名インスタンスの複製. |
| override [Clone](../../groupdocs.signature.domain/wordprocessingmetadatasignature/clone#clone)(object) | 指定された値を持つクローン ワード メタデータ署名インスタンス。 |
| override [Equals](../../groupdocs.signature.domain/metadatasignature/equals)(object) | Equals メソッドを上書きして署名プロパティを比較します |
...
| override [GetHashCode](../../groupdocs.signature.domain/metadatasignature/gethashcode)() | GetHashCode method をオーバーライドします |
...
| override [ToString](../../groupdocs.signature.domain/wordprocessingmetadatasignature/tostring#tostring)() | オーバーライド ToString() method で文字列に変換します |
| virtual [ToString](../../groupdocs.signature.domain/metadatasignature/tostring)(string) | 指定されたフォーマットの文字列に変換します |
| override [ToString](../../groupdocs.signature.domain/wordprocessingmetadatasignature/tostring#tostring_2)(string, IFormatProvider) | 指定されたフォーマットの文字列に変換します |
