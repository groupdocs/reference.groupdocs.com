...
description: フォーム フィールド署名プロパティが含まれます
type: docs
weight: 460
url: /ja/net/groupdocs.signature.domain/formfieldsignature/
---
## FormFieldSignature class

フォーム フィールド署名プロパティが含まれます。
...
| 名前 | 説明 |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/formfieldsignature/clone)() | FormField 署名インスタンスを複製します。 |
| override [Equals](../../groupdocs.signature.domain/formfieldsignature/equals)(object) | Equals メソッドを上書きして署名プロパティを比較します |
| override [GetHashCode](../../groupdocs.signature.domain/formfieldsignature/gethashcode)() | GetHashCode method をオーバーライドします |
