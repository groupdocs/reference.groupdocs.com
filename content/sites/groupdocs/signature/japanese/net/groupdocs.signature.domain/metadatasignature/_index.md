...
description: メタデータ署名プロパティが含まれています.
type: docs
weight: 610
url: /ja/net/groupdocs.signature.domain/metadatasignature/
---
## MetadataSignature class

メタデータ署名プロパティが含まれています.
...
| 名前 | 説明 |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/metadatasignature/clone#clone_1)() | メタデータ署名インスタンスの複製. |
| virtual [Clone](../../groupdocs.signature.domain/metadatasignature/clone#clone)(object) | 指定された値でメタデータ署名インスタンスを複製します。 |
| override [Equals](../../groupdocs.signature.domain/metadatasignature/equals)(object) | Equals メソッドを上書きして署名プロパティを比較します |
| [GetData&lt;T&gt;](../../groupdocs.signature.domain/metadatasignature/getdata#getdata)() | 逆シリアル化でメタデータ署名値からオブジェクトを取得します。 |
| [GetData&lt;T&gt;](../../groupdocs.signature.domain/metadatasignature/getdata#getdata_1)(IDataEncryption) | デシリアライゼーションでメタデータ署名テキストからオブジェクトを取得します。 |
...
| virtual [ToDateTime](../../groupdocs.signature.domain/metadatasignature/todatetime#todatetime)() | DateTime に変換します。 |
| virtual [ToDateTime](../../groupdocs.signature.domain/metadatasignature/todatetime#todatetime_1)(IFormatProvider) | DateTime に変換します。 |
| virtual [ToDecimal](../../groupdocs.signature.domain/metadatasignature/todecimal#todecimal)() | 10 進数に変換します。 |
| virtual [ToDecimal](../../groupdocs.signature.domain/metadatasignature/todecimal#todecimal_1)(IFormatProvider) | 10 進数に変換します。 |
| virtual [ToDouble](../../groupdocs.signature.domain/metadatasignature/todouble#todouble)() | Double に変換します。 |
| virtual [ToDouble](../../groupdocs.signature.domain/metadatasignature/todouble#todouble_1)(IFormatProvider) | Double に変換します。 |
| virtual [ToInteger](../../groupdocs.signature.domain/metadatasignature/tointeger)() | 整数に変換します。 |
| virtual [ToSingle](../../groupdocs.signature.domain/metadatasignature/tosingle#tosingle)() | float に変換します。 |
| virtual [ToSingle](../../groupdocs.signature.domain/metadatasignature/tosingle#tosingle_1)(IFormatProvider) | float に変換します。 |
| override [ToString](../../groupdocs.signature.domain/metadatasignature/tostring#tostring)() | オーバーライド ToString() method で文字列に変換します |
| virtual [ToString](../../groupdocs.signature.domain/metadatasignature/tostring#tostring_1)(string) | 指定されたフォーマットの文字列に変換します |
| virtual [ToString](../../groupdocs.signature.domain/metadatasignature/tostring#tostring_2)(string, IFormatProvider) | 指定されたフォーマットの文字列に変換します |
