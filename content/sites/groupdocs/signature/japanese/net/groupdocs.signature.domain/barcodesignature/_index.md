...
description: バーコード署名のプロパティが含まれています.
type: docs
weight: 20
url: /ja/net/groupdocs.signature.domain/barcodesignature/
---
## BarcodeSignature class

バーコード署名のプロパティが含まれています.
...
| 名前 | 説明 |
| --- | --- |
| [BarcodeSignature](barcodesignature)(string) | 検索プロセス後に取得した署名識別子で BarcodeSignature オブジェクトを初期化します。 この一意の識別子は、ドキュメント署名情報レイヤーからこの署名の追加プロパティを見つけるために使用されます。 |

## プロパティ

| 名前 | 説明 |
| --- | --- |
| [Content](../../groupdocs.signature.domain/barcodesignature/content) { get; } | タイプのバーコード バイナリ データ イメージ コンテンツを指定します[`Format`](./format). デフォルトでは、このプロパティは設定されません. プロパティを使用します[`ReturnContent`](../../groupdocs.signature.options/barcodesearchoptions/returncontent)この機能を有効にするには. |
...
| [EncodeType](../../groupdocs.signature.domain/barcodesignature/encodetype) { get; } | バーコードのエンコード タイプを指定します。 |
| [Format](../../groupdocs.signature.domain/barcodesignature/format) { get; } | バーコード署名画像の形式を指定します。 |
...
| [Text](../../groupdocs.signature.domain/barcodesignature/text) { get; } | バーコードのテキストを指定します。 |
...
| 名前 | 説明 |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/barcodesignature/clone)() | バーコード署名インスタンスの複製. |
| override [Equals](../../groupdocs.signature.domain/barcodesignature/equals)(object) | Equals メソッドを上書きして署名プロパティを比較します |
| override [GetHashCode](../../groupdocs.signature.domain/barcodesignature/gethashcode)() | GetHashCode method をオーバーライドします |
