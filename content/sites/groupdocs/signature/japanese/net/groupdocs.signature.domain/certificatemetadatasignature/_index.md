...
description: 証明書メタデータ署名のプロパティが含まれています.
type: docs
weight: 70
url: /ja/net/groupdocs.signature.domain/certificatemetadatasignature/
---
## CertificateMetadataSignature class

証明書メタデータ署名のプロパティが含まれています.
...
| 名前 | 説明 |
| --- | --- |
| [CertificateMetadataSignature](certificatemetadatasignature#constructor)(string) | 定義済みの名前と空の値で証明書メタデータ署名を作成します。 |
| [CertificateMetadataSignature](certificatemetadatasignature#constructor_1)(string, object) | 定義済みの値で証明書メタデータ署名を作成します。 |
...
| 名前 | 説明 |
| --- | --- |
| override [Clone](../../groupdocs.signature.domain/certificatemetadatasignature/clone#clone_1)() | メタデータ署名インスタンスの複製. |
| override [Clone](../../groupdocs.signature.domain/certificatemetadatasignature/clone#clone)(object) | 指定された値で証明書メタデータ署名インスタンスを複製します。 |
...
| override [ToString](../../groupdocs.signature.domain/certificatemetadatasignature/tostring#tostring)() | オーバーライド ToString() method で文字列に変換します |
| virtual [ToString](../../groupdocs.signature.domain/metadatasignature/tostring)(string) | 指定されたフォーマットの文字列に変換します |
| override [ToString](../../groupdocs.signature.domain/certificatemetadatasignature/tostring#tostring_2)(string, IFormatProvider) | 指定されたフォーマットの文字列に変換します |
