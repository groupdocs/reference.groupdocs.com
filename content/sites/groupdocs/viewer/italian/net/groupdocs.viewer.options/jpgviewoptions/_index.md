...
description: Fornisce opzioni per il rendering dei documenti in formato JPG.
type: docs
weight: 360
url: /it/net/groupdocs.viewer.options/jpgviewoptions/
---
## JpgViewOptions class

Fornisce opzioni per il rendering dei documenti in formato JPG.
...
| [ExtractText](../../groupdocs.viewer.options/jpgviewoptions/extracttext) { get; set; } | Abilita l'estrazione del testo. |
| [Height](../../groupdocs.viewer.options/jpgviewoptions/height) { get; set; } | L'altezza di un'immagine di output in pixel. |
...
| [MaxHeight](../../groupdocs.viewer.options/jpgviewoptions/maxheight) { get; set; } | Altezza massima di un'immagine di output in pixel. |
| [MaxWidth](../../groupdocs.viewer.options/jpgviewoptions/maxwidth) { get; set; } | Larghezza massima di un'immagine di output in pixel. |
...
| [Width](../../groupdocs.viewer.options/jpgviewoptions/width) { get; set; } | La larghezza dell'immagine di output in pixel. |
