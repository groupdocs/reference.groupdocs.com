...
| [ExtractText](../../groupdocs.viewer.options/pngviewoptions/extracttext) { get; set; } | Abilita l'estrazione del testo. |
| [Height](../../groupdocs.viewer.options/pngviewoptions/height) { get; set; } | L'altezza di un'immagine di output in pixel. |
...
| [MaxHeight](../../groupdocs.viewer.options/pngviewoptions/maxheight) { get; set; } | Altezza massima di un'immagine di output in pixel. |
| [MaxWidth](../../groupdocs.viewer.options/pngviewoptions/maxwidth) { get; set; } | Larghezza massima di un'immagine di output in pixel. |
...
| [Width](../../groupdocs.viewer.options/pngviewoptions/width) { get; set; } | La larghezza dell'immagine di output in pixel. |
