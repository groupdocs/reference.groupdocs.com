...
description: Biedt opties voor het weergeven van documenten in JPGindeling.
type: docs
weight: 360
url: /nl/net/groupdocs.viewer.options/jpgviewoptions/
---
## JpgViewOptions class

Biedt opties voor het weergeven van documenten in JPG-indeling.
...
| Naam | Beschrijving |
| --- | --- |
| [JpgViewOptions](jpgviewoptions#constructor)() | Initialiseert nieuw exemplaar van[`JpgViewOptions`](../jpgviewoptions) klasse. |
| [JpgViewOptions](jpgviewoptions#constructor_1)(CreatePageStream) | Initialiseert nieuw exemplaar van[`JpgViewOptions`](../jpgviewoptions) klasse. |
| [JpgViewOptions](jpgviewoptions#constructor_3)(IPageStreamFactory) | Initialiseert nieuw exemplaar van[`JpgViewOptions`](../jpgviewoptions) klasse. |
| [JpgViewOptions](jpgviewoptions#constructor_4)(string) | Initialiseert nieuw exemplaar van[`JpgViewOptions`](../jpgviewoptions) klasse. |
| [JpgViewOptions](jpgviewoptions#constructor_2)(CreatePageStream, ReleasePageStream) | Initialiseert nieuw exemplaar van[`JpgViewOptions`](../jpgviewoptions) klasse. |
...
| [ExtractText](../../groupdocs.viewer.options/jpgviewoptions/extracttext) { get; set; } | Schakelt tekstextractie in. |
| [Height](../../groupdocs.viewer.options/jpgviewoptions/height) { get; set; } | De hoogte van een uitvoerbeeld in pixels. |
...
| [MaxHeight](../../groupdocs.viewer.options/jpgviewoptions/maxheight) { get; set; } | Max. hoogte van een uitvoerbeeld in pixels. |
| [MaxWidth](../../groupdocs.viewer.options/jpgviewoptions/maxwidth) { get; set; } | Maximale breedte van een uitvoerbeeld in pixels. |
...
| [Quality](../../groupdocs.viewer.options/jpgviewoptions/quality) { get; set; } | Kwaliteit van het uitvoerbeeld; Geldige waarden liggen tussen 1 en 100; Standaardwaarde is 90. |
...
| [Width](../../groupdocs.viewer.options/jpgviewoptions/width) { get; set; } | De breedte van het uitvoerbeeld in pixels. |
