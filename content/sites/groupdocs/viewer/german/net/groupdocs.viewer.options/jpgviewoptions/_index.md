...
description: Bietet Optionen zum Rendern von Dokumenten im JPGFormat.
type: docs
weight: 360
url: /de/net/groupdocs.viewer.options/jpgviewoptions/
---
## JpgViewOptions class

Bietet Optionen zum Rendern von Dokumenten im JPG-Format.
...
| Name | Beschreibung |
| --- | --- |
| [JpgViewOptions](jpgviewoptions#constructor)() | Initialisiert eine neue Instanz von[`JpgViewOptions`](../jpgviewoptions) Klasse. |
| [JpgViewOptions](jpgviewoptions#constructor_1)(CreatePageStream) | Initialisiert eine neue Instanz von[`JpgViewOptions`](../jpgviewoptions) Klasse. |
| [JpgViewOptions](jpgviewoptions#constructor_3)(IPageStreamFactory) | Initialisiert eine neue Instanz von[`JpgViewOptions`](../jpgviewoptions) Klasse. |
| [JpgViewOptions](jpgviewoptions#constructor_4)(string) | Initialisiert eine neue Instanz von[`JpgViewOptions`](../jpgviewoptions) Klasse. |
| [JpgViewOptions](jpgviewoptions#constructor_2)(CreatePageStream, ReleasePageStream) | Initialisiert eine neue Instanz von[`JpgViewOptions`](../jpgviewoptions) Klasse. |
...
| [ExtractText](../../groupdocs.viewer.options/jpgviewoptions/extracttext) { get; set; } | Aktiviert die Textextraktion. |
| [Height](../../groupdocs.viewer.options/jpgviewoptions/height) { get; set; } | Die Höhe eines Ausgabebildes in Pixel. |
...
| [MaxHeight](../../groupdocs.viewer.options/jpgviewoptions/maxheight) { get; set; } | Maximale Höhe eines Ausgabebildes in Pixel. |
| [MaxWidth](../../groupdocs.viewer.options/jpgviewoptions/maxwidth) { get; set; } | Maximale Breite eines Ausgabebildes in Pixel. |
...
| [Quality](../../groupdocs.viewer.options/jpgviewoptions/quality) { get; set; } | Qualität des Ausgabebildes; Gültige Werte liegen zwischen 1 und 100; Standardwert ist 90. |
...
| [Width](../../groupdocs.viewer.options/jpgviewoptions/width) { get; set; } | Die Breite des Ausgabebildes in Pixel. |
