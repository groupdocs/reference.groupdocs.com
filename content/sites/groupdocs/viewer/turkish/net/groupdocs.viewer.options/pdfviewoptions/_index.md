...
| [ImageHeight](../../groupdocs.viewer.options/pdfviewoptions/imageheight) { get; set; } | Çıktı görüntüsünün piksel cinsinden yüksekliği. (Tek görüntüyü yalnızca HTML'ye dönüştürürken) |
...
| [ImageWidth](../../groupdocs.viewer.options/pdfviewoptions/imagewidth) { get; set; } | Çıktı görüntüsünün piksel cinsinden genişliği. (Tek görüntüyü yalnızca HTML'ye dönüştürürken) |
