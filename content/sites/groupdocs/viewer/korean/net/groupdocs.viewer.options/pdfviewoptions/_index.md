...
description: 문서를 PDF 형식으로 렌더링하기 위한 옵션을 제공합니다.
type: docs
weight: 420
url: /ko/net/groupdocs.viewer.options/pdfviewoptions/
---
## PdfViewOptions class

문서를 PDF 형식으로 렌더링하기 위한 옵션을 제공합니다.
...
| 이름 | 설명 |
| --- | --- |
| [PdfViewOptions](pdfviewoptions#constructor)() | 의 새 인스턴스를 초기화합니다.[`PdfViewOptions`](../pdfviewoptions) 클래스. |
| [PdfViewOptions](pdfviewoptions#constructor_1)(CreateFileStream) | 의 새 인스턴스를 초기화합니다.[`PdfViewOptions`](../pdfviewoptions) 클래스. |
| [PdfViewOptions](pdfviewoptions#constructor_3)(IFileStreamFactory) | 의 새 인스턴스를 초기화합니다.[`PdfViewOptions`](../pdfviewoptions) 클래스. |
| [PdfViewOptions](pdfviewoptions#constructor_4)(string) | 의 새 인스턴스를 초기화합니다.[`PdfViewOptions`](../pdfviewoptions) 클래스. |
| [PdfViewOptions](pdfviewoptions#constructor_2)(CreateFileStream, ReleaseFileStream) | 의 새 인스턴스를 초기화합니다.[`PdfViewOptions`](../pdfviewoptions) 클래스. |
...
| [ImageHeight](../../groupdocs.viewer.options/pdfviewoptions/imageheight) { get; set; } | 출력 이미지의 높이(픽셀)입니다. (단일 이미지를 HTML로만 변환하는 경우) |
| [ImageMaxHeight](../../groupdocs.viewer.options/pdfviewoptions/imagemaxheight) { get; set; } | 출력 이미지의 최대 높이(픽셀 단위). (단일 이미지를 HTML로만 변환하는 경우) |
| [ImageMaxWidth](../../groupdocs.viewer.options/pdfviewoptions/imagemaxwidth) { get; set; } | 출력 이미지의 최대 너비(픽셀 단위). (단일 이미지를 HTML로만 변환하는 경우) |
| [ImageWidth](../../groupdocs.viewer.options/pdfviewoptions/imagewidth) { get; set; } | 출력 이미지의 너비(픽셀)입니다. (단일 이미지를 HTML로만 변환하는 경우) |
| [JpgQuality](../../groupdocs.viewer.options/pdfviewoptions/jpgquality) { get; set; } | 출력 PDF 문서에 포함된 JPG 이미지의 품질; 유효한 값은 1에서 100 사이입니다. 기본값은 90입니다. |
| [MailStorageOptions](../../groupdocs.viewer.options/baseviewoptions/mailstorageoptions) { get; set; } | 메일 저장소 데이터 파일 보기 옵션. |
| [Optimize](../../groupdocs.viewer.options/pdfviewoptions/optimize) { get; set; } | Times New Roman 및 Arial과 같은 일반적인 글꼴을 제외하고 다른 최적화 기술을 적용하여 출력 파일 크기를 줄입니다. |
...
| [Security](../../groupdocs.viewer.options/pdfviewoptions/security) { get; set; } | 출력 PDF 문서 보안 옵션입니다. |
