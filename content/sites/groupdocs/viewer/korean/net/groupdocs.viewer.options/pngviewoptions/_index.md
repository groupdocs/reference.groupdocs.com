...
description: 문서를 PNG 형식으로 렌더링하기 위한 옵션을 제공합니다.
type: docs
weight: 440
url: /ko/net/groupdocs.viewer.options/pngviewoptions/
---
## PngViewOptions class

문서를 PNG 형식으로 렌더링하기 위한 옵션을 제공합니다.
...
| 이름 | 설명 |
| --- | --- |
| [PngViewOptions](pngviewoptions#constructor)() | 의 새 인스턴스를 초기화합니다.[`PngViewOptions`](../pngviewoptions) 클래스. |
| [PngViewOptions](pngviewoptions#constructor_1)(CreatePageStream) | 의 새 인스턴스를 초기화합니다.[`PngViewOptions`](../pngviewoptions) 클래스. |
| [PngViewOptions](pngviewoptions#constructor_3)(IPageStreamFactory) | 의 새 인스턴스를 초기화합니다.[`PngViewOptions`](../pngviewoptions) 클래스. |
| [PngViewOptions](pngviewoptions#constructor_4)(string) | 의 새 인스턴스를 초기화합니다.[`PngViewOptions`](../pngviewoptions) 클래스. |
| [PngViewOptions](pngviewoptions#constructor_2)(CreatePageStream, ReleasePageStream) | 의 새 인스턴스를 초기화합니다.[`PngViewOptions`](../pngviewoptions) 클래스. |
...
| [ExtractText](../../groupdocs.viewer.options/pngviewoptions/extracttext) { get; set; } | 텍스트 추출을 활성화합니다. |
| [Height](../../groupdocs.viewer.options/pngviewoptions/height) { get; set; } | 출력 이미지의 높이(픽셀 단위). |
| [MailStorageOptions](../../groupdocs.viewer.options/baseviewoptions/mailstorageoptions) { get; set; } | 메일 저장소 데이터 파일 보기 옵션. |
| [MaxHeight](../../groupdocs.viewer.options/pngviewoptions/maxheight) { get; set; } | 출력 이미지의 최대 높이(픽셀 단위). |
| [MaxWidth](../../groupdocs.viewer.options/pngviewoptions/maxwidth) { get; set; } | 출력 이미지의 최대 너비(픽셀 단위). |
...
| [Width](../../groupdocs.viewer.options/pngviewoptions/width) { get; set; } | 출력 이미지의 너비(픽셀 단위). |
