...
description: 의 새 인스턴스를 초기화합니다.ArchiveViewInfogroupdocs.viewer.results/archiveviewinfo 클래스.
type: docs
weight: 10
url: /ko/net/groupdocs.viewer.results/archiveviewinfo/archiveviewinfo/
---
## ArchiveViewInfo() {#constructor}

의 새 인스턴스를 초기화합니다.[`ArchiveViewInfo`](../../archiveviewinfo) 클래스.
...
| folders | List`1 | 아카이브 파일에 포함된 폴더 목록입니다. |
