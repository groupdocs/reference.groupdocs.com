...
description: दस्तवेज़ं क पडएफ प्ररूप में प्रस्तुत करने के लए वकल्प प्रदन करत है
type: docs
weight: 420
url: /hi/net/groupdocs.viewer.options/pdfviewoptions/
---
## PdfViewOptions class

दस्तावेज़ों को पीडीएफ प्रारूप में प्रस्तुत करने के लिए विकल्प प्रदान करता है।
...
| नाम | विवरण |
| --- | --- |
| [PdfViewOptions](pdfviewoptions#constructor)() | का नया उदाहरण शुरू करता है[`PdfViewOptions`](../pdfviewoptions) वर्ग. |
| [PdfViewOptions](pdfviewoptions#constructor_1)(CreateFileStream) | का नया उदाहरण शुरू करता है[`PdfViewOptions`](../pdfviewoptions) वर्ग. |
| [PdfViewOptions](pdfviewoptions#constructor_3)(IFileStreamFactory) | का नया उदाहरण शुरू करता है[`PdfViewOptions`](../pdfviewoptions) वर्ग. |
| [PdfViewOptions](pdfviewoptions#constructor_4)(string) | का नया उदाहरण शुरू करता है[`PdfViewOptions`](../pdfviewoptions) वर्ग. |
| [PdfViewOptions](pdfviewoptions#constructor_2)(CreateFileStream, ReleaseFileStream) | का नया उदाहरण शुरू करता है[`PdfViewOptions`](../pdfviewoptions) वर्ग. |
...
| [ImageHeight](../../groupdocs.viewer.options/pdfviewoptions/imageheight) { get; set; } | पिक्सेल में आउटपुट इमेज की ऊंचाई। (एक छवि को केवल HTML में कनवर्ट करते समय) |
| [ImageMaxHeight](../../groupdocs.viewer.options/pdfviewoptions/imagemaxheight) { get; set; } | पिक्सल में आउटपुट छवि की अधिकतम ऊंचाई। (एक छवि को केवल HTML में कनवर्ट करते समय) |
| [ImageMaxWidth](../../groupdocs.viewer.options/pdfviewoptions/imagemaxwidth) { get; set; } | पिक्सल में आउटपुट छवि की अधिकतम चौड़ाई। (एक छवि को केवल HTML में कनवर्ट करते समय) |
| [ImageWidth](../../groupdocs.viewer.options/pdfviewoptions/imagewidth) { get; set; } | पिक्सल में आउटपुट छवि की चौड़ाई। (एक छवि को केवल HTML में कनवर्ट करते समय) |
| [JpgQuality](../../groupdocs.viewer.options/pdfviewoptions/jpgquality) { get; set; } | आउटपुट PDF दस्तावेज़ में निहित JPG छवियों की गुणवत्ता; मान्य मान 1 और 100 के बीच हैं; डिफ़ॉल्ट मान 90. है |
...
| [Optimize](../../groupdocs.viewer.options/pdfviewoptions/optimize) { get; set; } | टाइम्स न्यू रोमन और एरियल जैसे सामान्य फोंट को हटाकर और अन्य अनुकूलन तकनीकों को लागू करके आउटपुट फ़ाइल आकार को कम करें। |
...
| [Security](../../groupdocs.viewer.options/pdfviewoptions/security) { get; set; } | आउटपुट PDF दस्तावेज़ सुरक्षा विकल्प. |
