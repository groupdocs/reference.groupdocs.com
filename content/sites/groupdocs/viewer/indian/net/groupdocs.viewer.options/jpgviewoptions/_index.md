...
description: जेपज प्ररूप में दस्तवेजं क प्रस्तुत करने के लए वकल्प प्रदन करत है
type: docs
weight: 360
url: /hi/net/groupdocs.viewer.options/jpgviewoptions/
---
## JpgViewOptions class

जेपीजी प्रारूप में दस्तावेजों को प्रस्तुत करने के लिए विकल्प प्रदान करता है।
...
| नाम | विवरण |
| --- | --- |
| [JpgViewOptions](jpgviewoptions#constructor)() | का नया उदाहरण शुरू करता है[`JpgViewOptions`](../jpgviewoptions) वर्ग. |
| [JpgViewOptions](jpgviewoptions#constructor_1)(CreatePageStream) | का नया उदाहरण शुरू करता है[`JpgViewOptions`](../jpgviewoptions) वर्ग. |
| [JpgViewOptions](jpgviewoptions#constructor_3)(IPageStreamFactory) | का नया उदाहरण शुरू करता है[`JpgViewOptions`](../jpgviewoptions) वर्ग. |
| [JpgViewOptions](jpgviewoptions#constructor_4)(string) | का नया उदाहरण शुरू करता है[`JpgViewOptions`](../jpgviewoptions) वर्ग. |
| [JpgViewOptions](jpgviewoptions#constructor_2)(CreatePageStream, ReleasePageStream) | का नया उदाहरण शुरू करता है[`JpgViewOptions`](../jpgviewoptions) वर्ग. |
...
| [ExtractText](../../groupdocs.viewer.options/jpgviewoptions/extracttext) { get; set; } | पाठ निष्कर्षण सक्षम करता है। |
| [Height](../../groupdocs.viewer.options/jpgviewoptions/height) { get; set; } | पिक्सल में आउटपुट छवि की ऊंचाई। |
...
| [MaxHeight](../../groupdocs.viewer.options/jpgviewoptions/maxheight) { get; set; } | पिक्सल में आउटपुट इमेज की अधिकतम ऊंचाई. |
| [MaxWidth](../../groupdocs.viewer.options/jpgviewoptions/maxwidth) { get; set; } | पिक्सल में आउटपुट छवि की अधिकतम चौड़ाई। |
...
| [Quality](../../groupdocs.viewer.options/jpgviewoptions/quality) { get; set; } | आउटपुट छवि की गुणवत्ता; मान्य मान 1 और 100 के बीच हैं; डिफ़ॉल्ट मान 90. है |
...
| [Width](../../groupdocs.viewer.options/jpgviewoptions/width) { get; set; } | पिक्सल में आउटपुट छवि की चौड़ाई। |
