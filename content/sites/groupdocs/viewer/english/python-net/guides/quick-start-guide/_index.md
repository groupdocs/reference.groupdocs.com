...
description: "Set up a virtual environment, install groupdocs-viewer-net, and run three minimal examples — DOCX → HTML, DOCX → PDF, and DOCX → per-page PNG — in under five minutes."
type: docs
...
To quickly test the library, let's render a DOCX file to HTML. You can also download the app that we're going to build [here](https://docs.groupdocs.com/viewer/python-net/_sample_files/getting-started/quick-start-guide/render_docx_to_html.zip).
...
`sample.docx` is the sample file used in this example. Click [here](https://docs.groupdocs.com/viewer/python-net/_sample_files/getting-started/quick-start-guide/sample.docx) to download it.

{{< /tab >}}
{{< tab "render-docx-to-html-outputs.zip" >}}  
```text
render_docx_to_html/page_1.html (317 KB)
render_docx_to_html/page_2.html (149 KB)
render_docx_to_html/page_3.html (113 KB)
```
[Download full output](https://docs.groupdocs.com/viewer/python-net/_output_files/getting-started/quick-start-guide/render_docx_to_html/render-docx-to-html-outputs.zip)
{{< /tab >}}
{{< /tabs >}}
...
In this example we'll render a DOCX file to PDF. You can download the app that we're going to build [here](https://docs.groupdocs.com/viewer/python-net/_sample_files/getting-started/quick-start-guide/render_docx_to_pdf.zip).
...
```
[Download full output](https://docs.groupdocs.com/viewer/python-net/_output_files/getting-started/quick-start-guide/render_docx_to_pdf/output.pdf)
{{< /tab >}}
{{< /tabs >}}
...
In this example we'll render a DOCX file to PNG images. You can download the app that we're going to build [here](https://docs.groupdocs.com/viewer/python-net/_sample_files/getting-started/quick-start-guide/render_docx_to_png.zip).
...
{{< /tab >}}
{{< tab "render-docx-to-png-outputs.zip" >}}  
```text
render_docx_to_png/output_1.png (89 KB)
render_docx_to_png/output_2.png (77 KB)
render_docx_to_png/output_3.png (50 KB)
```
[Download full output](https://docs.groupdocs.com/viewer/python-net/_output_files/getting-started/quick-start-guide/render_docx_to_png/render-docx-to-png-outputs.zip)
{{< /tab >}}
{{< /tabs >}}
