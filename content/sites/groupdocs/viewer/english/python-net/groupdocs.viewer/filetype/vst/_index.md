...
description: "Visio Drawing Template (.vst) are vector image files created with Microsoft Visio and act as template for creating further files."
type: docs
url: /python-net/groupdocs.viewer/filetype/vst/
is_root: false
weight: 3400
---
