...
The EmailOptions class encapsulates various settings and parameters that can be used
to control the rendering of email messages in the GroupDocs.Viewer component.


For details, see the [documentation](../https://docs.groupdocs.com/viewer/java/render-email-messages/).
...
| --- | --- |
| [EmailOptions()](#EmailOptions--) | Initializes a new instance of the 
EmailOptions
 class.
 |
## Methods
...
***Note:** The time format is specified using a pattern, such as 'MM d yyyy HH:mm tt'.
If the time format is not set, the current system format will be used.
For details, see the [documentation](../https://docs.groupdocs.com/viewer/java/render-email-messages/#specify-the-date-and-time-format-and-change-the-time-zone).*
