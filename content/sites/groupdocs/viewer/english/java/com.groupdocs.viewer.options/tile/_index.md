...
| --- | --- |
| [Tile(int startPointX, int startPointY, int width, int height)](#Tile-int-int-int-int-) | Initializes a new instance of the [Tile](../../com.groupdocs.viewer.options/tile) class. |
## Methods
...
Initializes a new instance of the [Tile](../../com.groupdocs.viewer.options/tile) class.
