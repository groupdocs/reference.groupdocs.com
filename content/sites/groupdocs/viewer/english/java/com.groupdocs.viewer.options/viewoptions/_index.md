...
The ViewOptions class extends the BaseViewOptions class and serves as a base class for rendering options
in the GroupDocs.Viewer component. It encapsulates common settings and parameters that can be used
for rendering various types of documents into different formats.
...
In case both #setWatermark(Watermark).setWatermark(Watermark) and #getPageRotations().getPageRotations() are specified,
the watermark will be applied to the rotated pages.
For details, see the [documentation](../https://docs.groupdocs.com/viewer/java/add-text-watermark/).
...
ViewOptions.Watermark
 and #getPageRotations().getPageRotations() are specified,
the watermark will be applied to the rotated pages.
For details, see the [documentation](../https://docs.groupdocs.com/viewer/java/add-text-watermark/).
...
For details, see the [documentation](../https://docs.groupdocs.com/viewer/java/flip-or-rotate-pages/).
...
If both [setWatermark(Watermark)](../../com.groupdocs.viewer.options/viewoptions#setWatermark-Watermark-) and 
getPageRotations()
 are specified,
the watermark will be applied to the rotated pages.
For details, see the [documentation](../https://docs.groupdocs.com/viewer/java/flip-or-rotate-pages/).
