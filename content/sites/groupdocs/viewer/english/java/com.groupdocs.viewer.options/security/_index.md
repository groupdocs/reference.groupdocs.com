...
The Security class encapsulates various settings and options that can be used to apply security measures
to a PDF document in the GroupDocs.Viewer component. These options include password protection,
...
| --- | --- |
| [Security()](#Security--) | Initializes a new instance of the 
Security
 class.
 |
## Methods
