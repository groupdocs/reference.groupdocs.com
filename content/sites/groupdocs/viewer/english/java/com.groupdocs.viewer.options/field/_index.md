...
The Field enum represents common email message fields in the GroupDocs.Viewer component.
It provides a set of predefined fields that can be used to identify and access specific
information in email messages, such as the sender, recipient, subject, and more.


For details, see the [documentation](../https://docs.groupdocs.com/viewer/java/render-email-messages/#rename-fields-in-the-message-header).
