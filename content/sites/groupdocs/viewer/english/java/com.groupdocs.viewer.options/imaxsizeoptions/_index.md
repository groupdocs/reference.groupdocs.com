...
The IMaxSizeOptions interface defines the limits of image size options in the GroupDocs.Viewer component.
It serves as a contract for classes that provide maximum size constraints for rendering images.
