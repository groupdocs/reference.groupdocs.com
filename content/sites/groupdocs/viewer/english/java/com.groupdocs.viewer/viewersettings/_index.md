...
The ViewerSettings class provides options and properties to customize the behavior of the GroupDocs.Viewer component during the document rendering process.
You can use this class to specify various settings, such as logger, custom cache implementation, and more.
...
| --- | --- |
| [ViewerSettings(Cache cache, ILogger logger)](#ViewerSettings-com.groupdocs.viewer.caching.Cache-com.groupdocs.foundation.logging.ILogger-) | Initializes a new instance of the 
ViewerSettings
 class.
 |
| [ViewerSettings(ILogger logger)](#ViewerSettings-com.groupdocs.foundation.logging.ILogger-) | Initializes a new instance of the 
ViewerSettings
 class.
 |
| [ViewerSettings(Cache cache)](#ViewerSettings-com.groupdocs.viewer.caching.Cache-) | Initializes a new instance of the 
ViewerSettings
 class.
 |
| [ViewerSettings()](#ViewerSettings--) | Initializes a new instance of the 
ViewerSettings
 class.
 |
## Methods
