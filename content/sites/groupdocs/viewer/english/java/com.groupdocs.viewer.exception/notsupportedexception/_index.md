...
It indicates that the current operation is not supported by the underlying system or implementation.

## Constructors

| Constructor | Description |
| --- | --- |
| [NotSupportedException(String message)](#NotSupportedException-java.lang.String-) | Initializes a new instance of the 
NotSupportedException
 class with a specified error message.
 |
| [NotSupportedException(String message, Throwable throwable)](#NotSupportedException-java.lang.String-java.lang.Throwable-) | Initializes a new instance of the 
NotSupportedException
 class with a specified error message and the cause of the exception.
 |
