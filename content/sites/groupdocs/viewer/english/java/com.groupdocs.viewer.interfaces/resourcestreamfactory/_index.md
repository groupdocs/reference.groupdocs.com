...
ResourceStreamFactory
 interface provides the necessary methods for creating a resource URL, as well as
...
Releases the stream created by the [createResourceStream(int, Resource)](../../com.groupdocs.viewer.interfaces/resourcestreamfactory#createResourceStream-int--Resource-) method
for the specified page number and HTML resource.
