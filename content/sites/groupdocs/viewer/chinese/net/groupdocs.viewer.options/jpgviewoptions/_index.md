...
| 姓名 | 描述 |
| --- | --- |
| [JpgViewOptions](jpgviewoptions#constructor)() | 初始化新实例[`JpgViewOptions`](../jpgviewoptions)类. |
| [JpgViewOptions](jpgviewoptions#constructor_1)(CreatePageStream) | 初始化新实例[`JpgViewOptions`](../jpgviewoptions)类. |
| [JpgViewOptions](jpgviewoptions#constructor_3)(IPageStreamFactory) | 初始化新实例[`JpgViewOptions`](../jpgviewoptions)类. |
| [JpgViewOptions](jpgviewoptions#constructor_4)(string) | 初始化新实例[`JpgViewOptions`](../jpgviewoptions)类. |
| [JpgViewOptions](jpgviewoptions#constructor_2)(CreatePageStream, ReleasePageStream) | 初始化新实例[`JpgViewOptions`](../jpgviewoptions)类. |
...
| [Quality](../../groupdocs.viewer.options/jpgviewoptions/quality) { get; set; } | 输出图像的质量； 有效值介于 1 和 100 之间； 默认值为 90. |
