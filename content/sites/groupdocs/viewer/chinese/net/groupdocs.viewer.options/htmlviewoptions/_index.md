...
| [ExcludeFonts](../../groupdocs.viewer.options/htmlviewoptions/excludefonts) { get; set; } | 启用后会阻止将任何字体添加到 HTML 文档中。 |
| [FontsToExclude](../../groupdocs.viewer.options/htmlviewoptions/fontstoexclude) { get; set; } | 要从 HTML 文档中排除的字体名称列表。 |
| [ForPrinting](../../groupdocs.viewer.options/htmlviewoptions/forprinting) { get; set; } | 指示是否优化输出 HTML 以进行打印。 |
...
| [RenderResponsive](../../groupdocs.viewer.options/htmlviewoptions/renderresponsive) { get; set; } | 启用响应式渲染； 响应式网页可以在具有不同屏幕尺寸的设备上很好地渲染。 |
| [RenderToSinglePage](../../groupdocs.viewer.options/htmlviewoptions/rendertosinglepage) { get; set; } | 启用 HTML 内容将呈现到单个页面 |
...
| 姓名 | 描述 |
| --- | --- |
| static [ForEmbeddedResources](../../groupdocs.viewer.options/htmlviewoptions/forembeddedresources#forembeddedresources)() | 初始化的新实例[`HtmlViewOptions`](../htmlviewoptions)类. |
| static [ForEmbeddedResources](../../groupdocs.viewer.options/htmlviewoptions/forembeddedresources#forembeddedresources_1)(CreatePageStream) | 初始化的新实例[`HtmlViewOptions`](../htmlviewoptions)用于渲染成带有嵌入资源的 HTML 的类。 |
| static [ForEmbeddedResources](../../groupdocs.viewer.options/htmlviewoptions/forembeddedresources#forembeddedresources_3)(IPageStreamFactory) | 初始化的新实例[`HtmlViewOptions`](../htmlviewoptions)用于渲染成带有嵌入资源的 HTML 的类。 |
| static [ForEmbeddedResources](../../groupdocs.viewer.options/htmlviewoptions/forembeddedresources#forembeddedresources_4)(string) | 初始化的新实例[`HtmlViewOptions`](../htmlviewoptions)类. |
| static [ForEmbeddedResources](../../groupdocs.viewer.options/htmlviewoptions/forembeddedresources#forembeddedresources_2)(CreatePageStream, ReleasePageStream) | 初始化的新实例[`HtmlViewOptions`](../htmlviewoptions)用于渲染成带有嵌入资源的 HTML 的类。 |
| static [ForExternalResources](../../groupdocs.viewer.options/htmlviewoptions/forexternalresources#forexternalresources)() | 初始化的新实例[`HtmlViewOptions`](../htmlviewoptions)类. |
| static [ForExternalResources](../../groupdocs.viewer.options/htmlviewoptions/forexternalresources#forexternalresources_3)(IPageStreamFactory, IResourceStreamFactory) | 初始化的新实例[`HtmlViewOptions`](../htmlviewoptions)使用外部资源渲染成 HTML 的类。 |
| static [ForExternalResources](../../groupdocs.viewer.options/htmlviewoptions/forexternalresources#forexternalresources_1)(CreatePageStream, CreateResourceStream, CreateResourceUrl) | 初始化的新实例[`HtmlViewOptions`](../htmlviewoptions)使用外部资源渲染成 HTML 的类。 |
| static [ForExternalResources](../../groupdocs.viewer.options/htmlviewoptions/forexternalresources#forexternalresources_4)(string, string, string) | 初始化的新实例[`HtmlViewOptions`](../htmlviewoptions)类. |
| static [ForExternalResources](../../groupdocs.viewer.options/htmlviewoptions/forexternalresources#forexternalresources_2)(CreatePageStream, CreateResourceStream, CreateResourceUrl, ReleasePageStream, ReleaseResourceStream) | 初始化的新实例[`HtmlViewOptions`](../htmlviewoptions)使用外部资源渲染成 HTML 的类。 |
