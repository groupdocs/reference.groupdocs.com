...
description: Предоставляет параметры для преобразования документов в формат PNG.
type: docs
weight: 440
url: /ru/net/groupdocs.viewer.options/pngviewoptions/
---
## PngViewOptions class

Предоставляет параметры для преобразования документов в формат PNG.
...
| Имя | Описание |
| --- | --- |
| [PngViewOptions](pngviewoptions#constructor)() | Инициализирует новый экземпляр[`PngViewOptions`](../pngviewoptions) класс. |
| [PngViewOptions](pngviewoptions#constructor_1)(CreatePageStream) | Инициализирует новый экземпляр[`PngViewOptions`](../pngviewoptions) класс. |
| [PngViewOptions](pngviewoptions#constructor_3)(IPageStreamFactory) | Инициализирует новый экземпляр[`PngViewOptions`](../pngviewoptions) класс. |
| [PngViewOptions](pngviewoptions#constructor_4)(string) | Инициализирует новый экземпляр[`PngViewOptions`](../pngviewoptions) класс. |
| [PngViewOptions](pngviewoptions#constructor_2)(CreatePageStream, ReleasePageStream) | Инициализирует новый экземпляр[`PngViewOptions`](../pngviewoptions) класс. |
...
| [ExtractText](../../groupdocs.viewer.options/pngviewoptions/extracttext) { get; set; } | Включает извлечение текста. |
| [Height](../../groupdocs.viewer.options/pngviewoptions/height) { get; set; } | Высота выходного изображения в пикселях. |
...
| [MaxHeight](../../groupdocs.viewer.options/pngviewoptions/maxheight) { get; set; } | Максимальная высота выходного изображения в пикселях. |
| [MaxWidth](../../groupdocs.viewer.options/pngviewoptions/maxwidth) { get; set; } | Максимальная ширина выходного изображения в пикселях. |
...
| [Width](../../groupdocs.viewer.options/pngviewoptions/width) { get; set; } | Ширина выходного изображения в пикселях. |
