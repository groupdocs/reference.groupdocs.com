...
description: Memberikan opsi untuk merender dokumen ke dalam format PNG.
type: docs
weight: 440
url: /id/net/groupdocs.viewer.options/pngviewoptions/
---
## PngViewOptions class

Memberikan opsi untuk merender dokumen ke dalam format PNG.
...
| Nama | Keterangan |
| --- | --- |
| [PngViewOptions](pngviewoptions#constructor)() | Menginisialisasi instance baru[`PngViewOptions`](../pngviewoptions) kelas. |
| [PngViewOptions](pngviewoptions#constructor_1)(CreatePageStream) | Menginisialisasi instance baru[`PngViewOptions`](../pngviewoptions) kelas. |
| [PngViewOptions](pngviewoptions#constructor_3)(IPageStreamFactory) | Menginisialisasi instance baru[`PngViewOptions`](../pngviewoptions) kelas. |
| [PngViewOptions](pngviewoptions#constructor_4)(string) | Menginisialisasi instance baru[`PngViewOptions`](../pngviewoptions) kelas. |
| [PngViewOptions](pngviewoptions#constructor_2)(CreatePageStream, ReleasePageStream) | Menginisialisasi instance baru[`PngViewOptions`](../pngviewoptions) kelas. |
...
| [ExtractText](../../groupdocs.viewer.options/pngviewoptions/extracttext) { get; set; } | Mengaktifkan ekstraksi teks. |
| [Height](../../groupdocs.viewer.options/pngviewoptions/height) { get; set; } | Tinggi gambar keluaran dalam piksel. |
...
| [MaxHeight](../../groupdocs.viewer.options/pngviewoptions/maxheight) { get; set; } | Tinggi maksimum gambar keluaran dalam piksel. |
| [MaxWidth](../../groupdocs.viewer.options/pngviewoptions/maxwidth) { get; set; } | Lebar maksimum gambar keluaran dalam piksel. |
...
| [Width](../../groupdocs.viewer.options/pngviewoptions/width) { get; set; } | Lebar gambar keluaran dalam piksel. |
