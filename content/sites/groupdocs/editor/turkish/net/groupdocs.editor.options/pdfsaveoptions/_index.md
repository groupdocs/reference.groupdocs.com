...
| İsim | Tanım |
| --- | --- |
| [Compliance](../../groupdocs.editor.options/pdfsaveoptions/compliance) { get; set; } | Çıktı belgeleri için PDF standartlarına uygunluk düzeyini belirtir. Varsayılan, PdfCompliance.Pdf17. 'dir. |
...
| [Password](../../groupdocs.editor.options/pdfsaveoptions/password) { get; set; } | Parola, oluşturulan PDF belgesine kullanıcı parolası olarak uygulanacak, açmak için gereklidir. NULL veya boşsa, belgeye parola uygulanmaz. Aksi takdirde, belge RC4 (anahtar uzunluğu 128 bit) ile şifrelenecektir. Varsayılan olarak NULL'dur — parola uygulanmaz. |
