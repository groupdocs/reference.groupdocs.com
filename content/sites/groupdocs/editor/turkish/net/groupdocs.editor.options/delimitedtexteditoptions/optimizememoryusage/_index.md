...
description: Girdi belgesinin işlenmesi sırasında bazı özel durumlarda performansı düşürebilen ancak diğer yandan bellek kullanımını azaltan bellek optimizasyon mekanizmalarını etkinleştirir. Büyük belgeleri işlerken ve OutOfMemoryException ile karşılaşıldığında kullanışlıdır. VarsayılanYANLIŞ daha iyi performans için bellek optimizasyonu devre dışı bırakıldı.
type: docs
weight: 40
