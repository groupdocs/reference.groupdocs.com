...
Metin içeriği ve kodlaması olan desteklenen herhangi bir metin kaynağı için temel sınıf
...
| abstract [Type](../../groupdocs.editor.htmlcss.resources.textual/textresourcebase/type) { get; } | türü uygularken, kaynak metninin türü hakkında bilgi döndürmelidir |
...
| [Equals](../../groupdocs.editor.htmlcss.resources.textual/textresourcebase/equals#equals)(IHtmlResource) | Bu örneği eşitlikte belirtilen şekilde kontrol eder. |
