...
Meta verileri ve ek yöntemleriyle GIF (Grafik Değişim Biçimi) biçimindeki bir görüntüyü temsil eder
...
| İsim | Tanım |
| --- | --- |
| [GifImage](gifimage#constructor)(string, Stream) | İçerikten, bayt akışı olarak temsil edilen ve belirtilen ad ile yeni GifImage örneği oluşturur |
| [GifImage](gifimage#constructor_1)(string, string) | İçerikten base64 kodlu dize olarak temsil edilen ve belirtilen name ile yeni GifImage örneği oluşturur |
...
| override [Type](../../groupdocs.editor.htmlcss.resources.images.raster/gifimage/type) { get; } | ImageType.Gif döndürür |
| [Version](../../groupdocs.editor.htmlcss.resources.images.raster/gifimage/version) { get; } | Bu GIF görüntüsünün dahili sürümünü döndürür (sürüm başlıktan çıkarılır) |
...
| [ReduceToNewHeight](../../groupdocs.editor.htmlcss.resources.images.raster/gifimage/reducetonewheight#reducetonewheight)(ushort) | Belirtilen yeni azaltılmış yükseklik ve orantılı olarak azaltılmış genişliğe sahip yeni bir küçültülmüş GIF görüntüsü oluşturur ve döndürür. (2 methods) |
...
| static [IsValid](../../groupdocs.editor.htmlcss.resources.images.raster/gifimage/isvalid#isvalid)(Stream) | Belirtilen akışın geçerli bir GIF image olup olmadığını kontrol eder |
| static [IsValid](../../groupdocs.editor.htmlcss.resources.images.raster/gifimage/isvalid#isvalid_1)(string) | Belirtilen base64 kodlu dizenin geçerli bir GIF olup olmadığını kontrol eder image |
