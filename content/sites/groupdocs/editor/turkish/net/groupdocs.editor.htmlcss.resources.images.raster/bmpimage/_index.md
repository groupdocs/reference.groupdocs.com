...
Meta verileri ve ek yöntemleriyle BMP (BitMap Resmi) biçimindeki bir görüntüyü temsil eder
...
| İsim | Tanım |
| --- | --- |
| [BmpImage](bmpimage#constructor)(string, Stream) | İçerikten, bayt akışı olarak temsil edilen ve belirtilen ad ile yeni BmpImage örneği oluşturur |
| [BmpImage](bmpimage#constructor_1)(string, string) | İçerikten, base64 kodlu dize olarak temsil edilen ve belirtilen name ile yeni BmpImage örneği oluşturur |
...
| override [Type](../../groupdocs.editor.htmlcss.resources.images.raster/bmpimage/type) { get; } | ImageType.Bmp döndürür |
...
| [ReduceToNewHeight](../../groupdocs.editor.htmlcss.resources.images.raster/bmpimage/reducetonewheight#reducetonewheight)(ushort) | Yeni bir azaltılmış BMP görüntüsü oluşturur ve döndürür, ancak belirtilen yeni azaltılmış yükseklik ve orantılı olarak azaltılmış genişliğe sahiptir. (2 methods) |
...
| static [IsValid](../../groupdocs.editor.htmlcss.resources.images.raster/bmpimage/isvalid#isvalid)(Stream) | Belirtilen akışın geçerli bir BMP olup olmadığını kontrol eder image |
| static [IsValid](../../groupdocs.editor.htmlcss.resources.images.raster/bmpimage/isvalid#isvalid_1)(string) | Belirtilen base64 kodlu dizenin geçerli bir BMP olup olmadığını kontrol eder image |
