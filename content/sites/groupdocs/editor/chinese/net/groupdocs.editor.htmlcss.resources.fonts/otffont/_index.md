...
description: 表示OTFOpen Type Format格式中的一种字体
type: docs
weight: 390
url: /zh/net/groupdocs.editor.htmlcss.resources.fonts/otffont/
---
## OtfFont class

表示OTF（Open Type Format）格式中的一种字体
...
| 姓名 | 描述 |
| --- | --- |
| [OtfFont](otffont#constructor)(string, Stream) | 从内容创建新的 OtfFont 类，表示为字节流，并具有指定的名称 |
| [OtfFont](otffont#constructor_1)(string, string) | 从内容创建新的 OtfFont 类，表示为 base64 编码的字符串，并具有指定的名称 |
...
| override [Type](../../groupdocs.editor.htmlcss.resources.fonts/otffont/type) { get; } | 返回[`Otf`](../fonttype/otf) |
...
| static [IsValid](../../groupdocs.editor.htmlcss.resources.fonts/otffont/isvalid#isvalid)(Stream) | 检查指定的流是否是有效的 OTF font |
| static [IsValid](../../groupdocs.editor.htmlcss.resources.fonts/otffont/isvalid#isvalid_1)(string) | 检查指定的 base64 编码字符串是否是有效的 OTF font |

## 字段

| 姓名 | 描述 |
| --- | --- |
| const [RequiredHeaderSize](../../groupdocs.editor.htmlcss.resources.fonts/otffont/requiredheadersize) | OTF 标头大小（以字节为单位），这是其验证所必需的 |
