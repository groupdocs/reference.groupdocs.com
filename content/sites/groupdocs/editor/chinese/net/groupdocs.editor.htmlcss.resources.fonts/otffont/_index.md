...
description: 表示 OTFOpen Type Format格式中的一种字体
type: docs
weight: 290
...
表示 OTF（Open Type Format）格式中的一种字体
...
| static [IsValid](../../groupdocs.editor.htmlcss.resources.fonts/otffont/isvalid#isvalid)(Stream) | 检查指定流是否是有效的 OTF 字体 |
| static [IsValid](../../groupdocs.editor.htmlcss.resources.fonts/otffont/isvalid#isvalid_1)(string) | 检查指定的 base64 编码字符串是否是有效的 OTF 字体 |
