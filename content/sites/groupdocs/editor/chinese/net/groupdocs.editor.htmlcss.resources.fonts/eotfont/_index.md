...
| 姓名 | 描述 |
| --- | --- |
| [EotFont](eotfont#constructor)(string, Stream) | 从内容创建新的 EotFont 类，表示为字节流，并具有指定的名称 |
| [EotFont](eotfont#constructor_1)(string, string) | 从内容创建新的 EotFont 类，表示为 base64 编码的字符串，并具有指定的名称 |
...
| 姓名 | 描述 |
| --- | --- |
| const [RequiredHeaderSize](../../groupdocs.editor.htmlcss.resources.fonts/eotfont/requiredheadersize) | EOT 标头大小（以字节为单位），这是其验证所必需的 |
