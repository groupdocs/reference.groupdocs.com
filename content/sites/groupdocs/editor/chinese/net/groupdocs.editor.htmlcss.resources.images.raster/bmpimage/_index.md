...
description: 表示一张 BMP位图图片格式的图像及其元数据和附加方法
type: docs
weight: 400
url: /zh/net/groupdocs.editor.htmlcss.resources.images.raster/bmpimage/
---
## BmpImage class

表示一张 BMP（位图图片）格式的图像及其元数据和附加方法
...
| 姓名 | 描述 |
| --- | --- |
| [BmpImage](bmpimage#constructor)(string, Stream) | 从内容创建新的 BmpImage 实例，表示为字节流，并具有指定的名称 |
| [BmpImage](bmpimage#constructor_1)(string, string) | 从内容创建新的 BmpImage 实例，表示为 base64 编码的字符串，并具有指定的名称 |
...
| override [Type](../../groupdocs.editor.htmlcss.resources.images.raster/bmpimage/type) { get; } | 返回 ImageType.Bmp |
...
| [ReduceToNewHeight](../../groupdocs.editor.htmlcss.resources.images.raster/bmpimage/reducetonewheight#reducetonewheight)(ushort) | 创建并返回一个新的缩小 BMP 图像，但具有指定的新缩小高度和按比例缩小的宽度。 (2 methods) |
| [Save](../../groupdocs.editor.htmlcss.resources.images.raster/rasterimageresourcebase/save)(string) | 将此光栅图像保存到指定文件 |
| static [IsValid](../../groupdocs.editor.htmlcss.resources.images.raster/bmpimage/isvalid#isvalid)(Stream) | 检查指定流是否是有效的 BMP 图像 |
| static [IsValid](../../groupdocs.editor.htmlcss.resources.images.raster/bmpimage/isvalid#isvalid_1)(string) | 检查指定的 base64 编码字符串是否为有效的 BMP 图像 |
