...
description: 表示 BMP位图图片格式的一张图像及其元数据和其他方法
type: docs
weight: 500
...
| static [IsValid](../../groupdocs.editor.htmlcss.resources.images.raster/bmpimage/isvalid#isvalid)(Stream) | 检查指定的流是否是有效的 BMP 图像 |
