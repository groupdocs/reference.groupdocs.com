...
description: 检查指定流是否是有效的 BMP 图像
type: docs
weight: 40
url: /zh/net/groupdocs.editor.htmlcss.resources.images.raster/bmpimage/isvalid/
---
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| binaryContent | Stream | 字节流，可能包含 BMP 图像 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| contentInBase64 | String | base64 编码字符串形式的大概 BMP 图像的内容 |
