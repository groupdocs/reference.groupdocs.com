...
| 姓名 | 描述 |
| --- | --- |
| [GifImage](gifimage#constructor)(string, Stream) | 从内容创建新的 GifImage 实例，表示为字节流，并具有指定的名称 |
| [GifImage](gifimage#constructor_1)(string, string) | 从内容创建新的 GifImage 实例，表示为 base64 编码的字符串，并具有指定的名称 |
