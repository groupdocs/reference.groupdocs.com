...
description: 表示 JPEG联合图像专家组格式的一张图像及其元数据和其他方法
type: docs
weight: 430
...
表示 JPEG（联合图像专家组）格式的一张图像及其元数据和其他方法
...
| static [IsValid](../../groupdocs.editor.htmlcss.resources.images.raster/jpegimage/isvalid#isvalid)(Stream) | 检查指定流是否是有效的 JPEG 图像 |
