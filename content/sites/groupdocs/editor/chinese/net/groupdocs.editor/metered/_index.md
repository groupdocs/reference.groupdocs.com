...
type: docs
weight: 800
url: /zh/net/groupdocs.editor/metered/
---
## Metered class
...
| 姓名 | 描述 |
| --- | --- |
| [SetMeteredKey](../../groupdocs.editor/metered/setmeteredkey)(string, string) | 使用计量密钥激活产品。 |
| static [GetConsumptionCredit](../../groupdocs.editor/metered/getconsumptioncredit)() | 检索消耗的积分数。 |
| static [GetConsumptionQuantity](../../groupdocs.editor/metered/getconsumptionquantity)() | 检索已处理的 MB 数量。 |
