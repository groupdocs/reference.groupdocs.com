...
description: Создает новый класс TtfFont из содержимого представленного в виде строки в кодировке base64 и с указанным именем
type: docs
weight: 10
...
| --- | --- | --- |
| name | String | Название шрифта TTF. Не может быть нулевым, пустым или пробельным. |
| contentInBase64 | String | Содержимое в виде строки в кодировке base64. Не может быть нулевым, пустым или пробельным. Если это не содержимое TTF, будет выдано исключение. |
...
| --- | --- |
| ArgumentException |  |
| [InvalidFontFormatException](../../../groupdocs.editor.htmlcss.exceptions/invalidfontformatexception) | Возникает, когда указанное двоичное содержимое не может быть правильно интерпретировано как допустимый шрифт TTF. |
