...
description: Указывает следует ли разбивать содержимое электронной книги AZW3 на пакеты и если да то максимальный уровень заголовков на котором следует разбивать содержимое AZW3. Значение по умолчанию2 Установка на0 отключит разделение поэтому все содержимое электронной книги будет объединено в единый пакет внутри AZW3.
type: docs
weight: 20
...
По умолчанию (значение`2` ), Только**Заголовок 1** а также**Заголовок 2** абзацы приводят к разделению документа. Установка этого свойства в ноль приведет к тому, что документ вообще не будет разбиваться на абзацы заголовков.
