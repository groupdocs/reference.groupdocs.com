...
| Nome | Descrizione |
| --- | --- |
| [JpegImage](jpegimage#constructor)(string, Stream) | Crea una nuova istanza JpegImage dal contenuto, rappresentato come flusso di byte e con il nome specificato |
| [JpegImage](jpegimage#constructor_1)(string, string) | Crea una nuova istanza JpegImage dal contenuto, rappresentato come stringa con codifica base64 e con il nome specificato |
...
| override [Type](../../groupdocs.editor.htmlcss.resources.images.raster/jpegimage/type) { get; } | Restituisce ImageType.Jpeg |
...
| [ReduceToNewHeight](../../groupdocs.editor.htmlcss.resources.images.raster/jpegimage/reducetonewheight#reducetonewheight)(ushort) | Crea e restituisce una nuova immagine JPEG ridotta, ma con una nuova altezza ridotta specificata e una larghezza proporzionalmente ridotta. (2 methods) |
...
| static [IsValid](../../groupdocs.editor.htmlcss.resources.images.raster/jpegimage/isvalid#isvalid)(Stream) | Controlla se il flusso specificato è un'immagine JPEG valida |
| static [IsValid](../../groupdocs.editor.htmlcss.resources.images.raster/jpegimage/isvalid#isvalid_1)(string) | Verifica se la stringa con codifica Base64 specificata è un'immagine JPEG valida |
