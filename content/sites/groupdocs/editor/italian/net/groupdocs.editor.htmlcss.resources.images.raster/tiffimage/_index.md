...
description: Rappresenta unimmagine in formato TIFF Tagged Image File Format con i relativi metadati e metodi aggiuntivi
type: docs
weight: 460
url: /it/net/groupdocs.editor.htmlcss.resources.images.raster/tiffimage/
---
## TiffImage class

Rappresenta un'immagine in formato TIFF (Tagged Image File Format) con i relativi metadati e metodi aggiuntivi
...
| Nome | Descrizione |
| --- | --- |
| [TiffImage](tiffimage#constructor)(string, Stream) | Crea una nuova istanza GifImage dal contenuto, rappresentato come flusso di byte e con il nome specificato |
| [TiffImage](tiffimage#constructor_1)(string, string) | Crea una nuova istanza TiffImage dal contenuto, rappresentata come stringa con codifica base64 e con il nome specificato |
...
| [FramesCount](../../groupdocs.editor.htmlcss.resources.images.raster/tiffimage/framescount) { get; } | Restituisce un numero di fotogrammi (immagini) all'interno di questa immagine TIFF. Non può essere inferiore a 1. |
...
| override [Type](../../groupdocs.editor.htmlcss.resources.images.raster/tiffimage/type) { get; } | Restituisce ImageType.Tiff |
...
| static [IsValid](../../groupdocs.editor.htmlcss.resources.images.raster/tiffimage/isvalid#isvalid)(Stream) | Controlla se il flusso specificato è un'immagine TIFF valida |
| static [IsValid](../../groupdocs.editor.htmlcss.resources.images.raster/tiffimage/isvalid#isvalid_1)(string) | Controlla se la stringa con codifica Base64 specificata è un'immagine TIFF valida |
...
Vedere https://en.wikipedia.org/wiki/TIFF per i dettagli. In casi molto rari TIFF è presente all'interno dei documenti WordProcessing.
