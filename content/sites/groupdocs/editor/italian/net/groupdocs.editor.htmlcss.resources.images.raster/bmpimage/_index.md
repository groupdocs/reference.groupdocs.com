...
description: Rappresenta unimmagine in formato BMP BitMap Picture con i relativi metadati e metodi aggiuntivi
type: docs
weight: 500
url: /it/net/groupdocs.editor.htmlcss.resources.images.raster/bmpimage/
---
## BmpImage class

Rappresenta un'immagine in formato BMP (BitMap Picture) con i relativi metadati e metodi aggiuntivi
...
| Nome | Descrizione |
| --- | --- |
| [BmpImage](bmpimage#constructor)(string, Stream) | Crea una nuova istanza BmpImage dal contenuto, rappresentato come flusso di byte e con il nome specificato |
| [BmpImage](bmpimage#constructor_1)(string, string) | Crea una nuova istanza BmpImage dal contenuto, rappresentato come stringa con codifica base64 e con il nome specificato |
...
| override [Type](../../groupdocs.editor.htmlcss.resources.images.raster/bmpimage/type) { get; } | Restituisce ImageType.Bmp |
...
| [ReduceToNewHeight](../../groupdocs.editor.htmlcss.resources.images.raster/bmpimage/reducetonewheight#reducetonewheight)(ushort) | Crea e restituisce una nuova immagine BMP ridotta, ma con una nuova altezza ridotta specificata e una larghezza proporzionalmente ridotta. (2 methods) |
...
| static [IsValid](../../groupdocs.editor.htmlcss.resources.images.raster/bmpimage/isvalid#isvalid)(Stream) | Controlla se il flusso specificato è un'immagine BMP valida |
| static [IsValid](../../groupdocs.editor.htmlcss.resources.images.raster/bmpimage/isvalid#isvalid_1)(string) | Verifica se la stringa con codifica Base64 specificata è un'immagine BMP valida |
