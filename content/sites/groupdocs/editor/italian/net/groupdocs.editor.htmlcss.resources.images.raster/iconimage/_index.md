...
description: Rappresenta unimmagine in formato ICON con i relativi metadati e metodi aggiuntivi
type: docs
weight: 520
url: /it/net/groupdocs.editor.htmlcss.resources.images.raster/iconimage/
---
## IconImage class

Rappresenta un'immagine in formato ICON con i relativi metadati e metodi aggiuntivi
...
| Nome | Descrizione |
| --- | --- |
| [IconImage](iconimage#constructor)(string, Stream) | Crea una nuova istanza IconImage dal contenuto, rappresentato come flusso di byte e con il nome specificato |
| [IconImage](iconimage#constructor_1)(string, string) | Crea una nuova istanza IconImage dal contenuto, rappresentata come stringa con codifica base64 e con il nome specificato |
...
| [NumberOfImages](../../groupdocs.editor.htmlcss.resources.images.raster/iconimage/numberofimages) { get; } | Restituisce il numero di immagini presenti in questo file ICON |
...
| override [Type](../../groupdocs.editor.htmlcss.resources.images.raster/iconimage/type) { get; } | Restituisce ImageType.Icon |
...
| [ReduceToNewHeight](../../groupdocs.editor.htmlcss.resources.images.raster/iconimage/reducetonewheight#reducetonewheight)(ushort) | Crea e restituisce una nuova immagine icona ridotta, ma con una nuova altezza ridotta specificata e una larghezza proporzionalmente ridotta. (2 methods) |
...
| static [IsValid](../../groupdocs.editor.htmlcss.resources.images.raster/iconimage/isvalid#isvalid)(Stream) | Controlla se il flusso specificato è un'immagine ICON valida |
| static [IsValid](../../groupdocs.editor.htmlcss.resources.images.raster/iconimage/isvalid#isvalid_1)(string) | Controlla se la stringa con codifica Base64 specificata è un'immagine ICON valida |
