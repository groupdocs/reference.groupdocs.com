...
Rappresenta i metadati di un documento testuale come XML, HTML o testo semplice (TXT)
...
| [IsEncrypted](../../groupdocs.editor.metadata/textualdocumentinfo/isencrypted) { get; } | Restituisce sempre 'false', poiché i documenti testuali non possono essere crittografati. |
