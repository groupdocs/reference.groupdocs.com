...
| --- | --- | --- |
| extension | String | Estensione del nome file di qualsiasi formato EBook supportato, con o senza carattere punto iniziale, indipendente da maiuscole e minuscole. Non può essere NULL o vuoto, deve essere valido. |
