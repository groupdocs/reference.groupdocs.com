...
description: Stellt eine Schriftart im OTFFormat Open Type Format dar
type: docs
weight: 390
url: /de/net/groupdocs.editor.htmlcss.resources.fonts/otffont/
---
## OtfFont class
...
| Name | Beschreibung |
| --- | --- |
| [OtfFont](otffont#constructor)(string, Stream) | Erstellt eine neue OtfFont-Klasse aus Inhalt, dargestellt als Bytestream, und mit dem angegebenen Namen |
| [OtfFont](otffont#constructor_1)(string, string) | Erstellt eine neue OtfFont-Klasse aus Inhalt, dargestellt als base64-codierte Zeichenfolge und mit dem angegebenen Namen |
...
| override [Type](../../groupdocs.editor.htmlcss.resources.fonts/otffont/type) { get; } | gibt zurück[`Otf`](../fonttype/otf) |
...
| static [IsValid](../../groupdocs.editor.htmlcss.resources.fonts/otffont/isvalid#isvalid)(Stream) | Überprüft, ob der angegebene Stream eine gültige OTF-Schriftart ist |
| static [IsValid](../../groupdocs.editor.htmlcss.resources.fonts/otffont/isvalid#isvalid_1)(string) | Überprüft, ob die angegebene base64-codierte Zeichenfolge eine gültige OTF-Schriftart ist |

## Felder

| Name | Beschreibung |
| --- | --- |
| const [RequiredHeaderSize](../../groupdocs.editor.htmlcss.resources.fonts/otffont/requiredheadersize) | Größe des OTF-Headers (in Bytes), die für seine Validierung erforderlich ist |
