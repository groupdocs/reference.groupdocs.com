...
description: Stellt eine Schriftart im TTFFormat TrueType Font dar
type: docs
weight: 300
url: /de/net/groupdocs.editor.htmlcss.resources.fonts/ttffont/
---
## TtfFont class
...
| Name | Beschreibung |
| --- | --- |
| [TtfFont](ttffont#constructor)(string, Stream) | Erstellt eine neue TtfFont-Klasse aus Inhalt, dargestellt als Byte-Stream, und mit dem angegebenen Namen |
| [TtfFont](ttffont#constructor_1)(string, string) | Erstellt eine neue TtfFont-Klasse aus Inhalt, dargestellt als base64-codierte Zeichenfolge und mit dem angegebenen Namen |
...
| override [Type](../../groupdocs.editor.htmlcss.resources.fonts/ttffont/type) { get; } | Gibt FontType.Ttf zurück |
...
| static [IsValid](../../groupdocs.editor.htmlcss.resources.fonts/ttffont/isvalid#isvalid)(Stream) | Überprüft, ob der angegebene Stream eine gültige TTF-Schriftart ist |
| static [IsValid](../../groupdocs.editor.htmlcss.resources.fonts/ttffont/isvalid#isvalid_1)(string) | Überprüft, ob die angegebene base64-codierte Zeichenfolge eine gültige TTF-Schriftart ist |

## Felder

| Name | Beschreibung |
| --- | --- |
| const [RequiredHeaderSize](../../groupdocs.editor.htmlcss.resources.fonts/ttffont/requiredheadersize) | Größe des TTF-Headers (in Bytes), die für seine Validierung erforderlich ist |
