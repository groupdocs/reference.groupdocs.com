...
description: Repräsentiert ein Bild im BMPFormat BitMap Picture mit seinen Metadaten und zusätzlichen Methoden
type: docs
weight: 400
url: /de/net/groupdocs.editor.htmlcss.resources.images.raster/bmpimage/
---
## BmpImage class

Repräsentiert ein Bild im BMP-Format (BitMap Picture) mit seinen Metadaten und zusätzlichen Methoden
...
| Name | Beschreibung |
| --- | --- |
| [BmpImage](bmpimage#constructor)(string, Stream) | Erstellt eine neue BmpImage-Instanz aus Inhalt, dargestellt als Byte-Stream, und mit dem angegebenen Namen |
| [BmpImage](bmpimage#constructor_1)(string, string) | Erstellt eine neue BmpImage-Instanz aus Inhalt, dargestellt als base64-codierte Zeichenfolge und mit dem angegebenen Namen |
...
| override [Type](../../groupdocs.editor.htmlcss.resources.images.raster/bmpimage/type) { get; } | Gibt ImageType.Bmp zurück |
...
| [ReduceToNewHeight](../../groupdocs.editor.htmlcss.resources.images.raster/bmpimage/reducetonewheight#reducetonewheight)(ushort) | Erstellt ein neues reduziertes BMP-Bild und gibt es zurück, jedoch mit der angegebenen neuen reduzierten Höhe und proportional reduzierter Breite. (2 methods) |
...
| static [IsValid](../../groupdocs.editor.htmlcss.resources.images.raster/bmpimage/isvalid#isvalid)(Stream) | Überprüft, ob der angegebene Stream ein gültiges BMP-Bild ist |
| static [IsValid](../../groupdocs.editor.htmlcss.resources.images.raster/bmpimage/isvalid#isvalid_1)(string) | Überprüft, ob die angegebene base64-codierte Zeichenfolge ein gültiges BMP-Bild ist |
