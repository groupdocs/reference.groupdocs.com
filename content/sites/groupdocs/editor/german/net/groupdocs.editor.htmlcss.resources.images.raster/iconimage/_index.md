...
description: Repräsentiert ein Bild im ICONFormat mit seinen Metadaten und zusätzlichen Methoden
type: docs
weight: 420
url: /de/net/groupdocs.editor.htmlcss.resources.images.raster/iconimage/
---
## IconImage class

Repräsentiert ein Bild im ICON-Format mit seinen Metadaten und zusätzlichen Methoden
...
| Name | Beschreibung |
| --- | --- |
| [IconImage](iconimage#constructor)(string, Stream) | Erstellt eine neue IconImage-Instanz aus Inhalt, dargestellt als Byte-Stream, und mit dem angegebenen Namen |
| [IconImage](iconimage#constructor_1)(string, string) | Erstellt eine neue IconImage-Instanz aus Inhalt, dargestellt als base64-codierte Zeichenfolge und mit dem angegebenen Namen |
...
| [NumberOfImages](../../groupdocs.editor.htmlcss.resources.images.raster/iconimage/numberofimages) { get; } | Gibt die Anzahl der Bilder zurück, die in dieser ICON-Datei vorhanden sind |
...
| override [Type](../../groupdocs.editor.htmlcss.resources.images.raster/iconimage/type) { get; } | Gibt ImageType.Icon zurück |
...
| [ReduceToNewHeight](../../groupdocs.editor.htmlcss.resources.images.raster/iconimage/reducetonewheight#reducetonewheight)(ushort) | Erstellt ein neues reduziertes Symbolbild und gibt es zurück, jedoch mit der angegebenen neuen reduzierten Höhe und proportional reduzierter Breite. (2 methods) |
...
| static [IsValid](../../groupdocs.editor.htmlcss.resources.images.raster/iconimage/isvalid#isvalid)(Stream) | Überprüft, ob der angegebene Stream ein gültiges ICON-Bild ist |
| static [IsValid](../../groupdocs.editor.htmlcss.resources.images.raster/iconimage/isvalid#isvalid_1)(string) | Überprüft, ob die angegebene base64-codierte Zeichenfolge ein gültiges ICON-Bild ist |
