...
description: OTF Open Type Format 形式の 1 つのフォントを表します
type: docs
weight: 390
url: /ja/net/groupdocs.editor.htmlcss.resources.fonts/otffont/
---
## OtfFont class

OTF (Open Type Format) 形式の 1 つのフォントを表します
...
| 名前 | 説明 |
| --- | --- |
| [OtfFont](otffont#constructor)(string, Stream) | コンテンツから新しい OtfFont クラスを作成し、バイト ストリームとして表され、指定された name を使用します |
| [OtfFont](otffont#constructor_1)(string, string) | base64 でエンコードされた文字列として表され、指定された name を持つコンテンツから新しい OtfFont クラスを作成します |
...
| override [Type](../../groupdocs.editor.htmlcss.resources.fonts/otffont/type) { get; } | 戻り値[`Otf`](../fonttype/otf) |
...
| static [IsValid](../../groupdocs.editor.htmlcss.resources.fonts/otffont/isvalid#isvalid)(Stream) | 指定されたストリームが有効な OTF かどうかをチェックします font |
| static [IsValid](../../groupdocs.editor.htmlcss.resources.fonts/otffont/isvalid#isvalid_1)(string) | 指定された base64 でエンコードされた文字列が有効な OTF かどうかを確認します font |

## 田畑

| 名前 | 説明 |
| --- | --- |
| const [RequiredHeaderSize](../../groupdocs.editor.htmlcss.resources.fonts/otffont/requiredheadersize) | 検証に必要な OTF ヘッダー サイズ (バイト単位) |
