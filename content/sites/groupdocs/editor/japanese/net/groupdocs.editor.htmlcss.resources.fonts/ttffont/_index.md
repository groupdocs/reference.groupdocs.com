...
description: TTF TrueType Font 形式の 1 つのフォントを表します
type: docs
weight: 400
url: /ja/net/groupdocs.editor.htmlcss.resources.fonts/ttffont/
---
## TtfFont class

TTF (TrueType Font) 形式の 1 つのフォントを表します
...
| 名前 | 説明 |
| --- | --- |
| [TtfFont](ttffont#constructor)(string, Stream) | コンテンツから新しい TtfFont クラスを作成し、バイト ストリームとして表され、指定された name を使用します |
| [TtfFont](ttffont#constructor_1)(string, string) | base64 でエンコードされた文字列として表され、指定された name を持つコンテンツから新しい TtfFont クラスを作成します |
...
| override [Type](../../groupdocs.editor.htmlcss.resources.fonts/ttffont/type) { get; } | FontType.Ttf を返します |
...
| static [IsValid](../../groupdocs.editor.htmlcss.resources.fonts/ttffont/isvalid#isvalid)(Stream) | 指定されたストリームが有効な TTF かどうかをチェックします font |
| static [IsValid](../../groupdocs.editor.htmlcss.resources.fonts/ttffont/isvalid#isvalid_1)(string) | 指定された base64 でエンコードされた文字列が有効な TTF かどうかを確認します font |

## 田畑

| 名前 | 説明 |
| --- | --- |
| const [RequiredHeaderSize](../../groupdocs.editor.htmlcss.resources.fonts/ttffont/requiredheadersize) | 検証に必要な TTF ヘッダー サイズ (バイト単位) |
