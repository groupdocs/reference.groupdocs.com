...
description: base64 でエンコードされた文字列として表され指定された name を持つコンテンツから新しい EmfImage インスタンスを作成します
type: docs
weight: 10
...
base64 でエンコードされた文字列として表され、指定された name を持つコンテンツから新しい EmfImage インスタンスを作成します
...
| パラメータ | タイプ | 説明 |
| --- | --- | --- |
| name | String | EMF イメージの名前。 null、空、または空白にすることはできません。 |
| contentInBase64 | String | base64 でエンコードされた文字列としてのコンテンツ。 null、空、または空白にすることはできません。 EMF コンテンツでない場合、例外がスローされます。 |
...
コンテンツから新しい EmfImage インスタンスを作成し、バイト ストリームとして表され、指定された name を使用します
