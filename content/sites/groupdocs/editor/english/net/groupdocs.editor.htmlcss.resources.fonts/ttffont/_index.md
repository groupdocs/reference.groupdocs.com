...
type: docs
weight: 410
url: /net/groupdocs.editor.htmlcss.resources.fonts/ttffont/
---
## TtfFont class
...
| Name | Description |
| --- | --- |
| [TtfFont](ttffont#constructor)(string, Stream) | Creates new TtfFont class from content, represented as byte stream, and with specified name |
| [TtfFont](ttffont#constructor_1)(string, string) | Creates new TtfFont class from content, represented as base64-encoded string, and with specified name |
...
| override [Type](../../groupdocs.editor.htmlcss.resources.fonts/ttffont/type) { get; } | Returns FontType.Ttf |
...
| static [IsValid](../../groupdocs.editor.htmlcss.resources.fonts/ttffont/isvalid#isvalid)(Stream) | Checks whether specified stream is a valid TTF font |
| static [IsValid](../../groupdocs.editor.htmlcss.resources.fonts/ttffont/isvalid#isvalid_1)(string) | Checks whether specified base64-encoded string is a valid TTF font |

## Fields

| Name | Description |
| --- | --- |
| const [RequiredHeaderSize](../../groupdocs.editor.htmlcss.resources.fonts/ttffont/requiredheadersize) | TTF header size (in bytes), which is required for its validation |
