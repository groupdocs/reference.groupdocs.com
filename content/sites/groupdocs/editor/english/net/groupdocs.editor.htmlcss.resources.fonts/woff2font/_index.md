...
type: docs
weight: 980
url: /net/groupdocs.editor.htmlcss.resources.fonts/woff2font/
---
## Woff2Font class
...
| Name | Description |
| --- | --- |
| [Woff2Font](woff2font#constructor)(string, Stream) | Creates new Woff2Font class from content, represented as byte stream, and with specified name |
| [Woff2Font](woff2font#constructor_1)(string, string) | Creates new Woff2Font class from content, represented as base64-encoded string, and with specified name |
...
| static [IsValid](../../groupdocs.editor.htmlcss.resources.fonts/woff2font/isvalid#isvalid)(Stream) | Checks whether specified stream is a valid WOFF2 font |
| static [IsValid](../../groupdocs.editor.htmlcss.resources.fonts/woff2font/isvalid#isvalid_1)(string) | Checks whether specified base64-encoded string is a valid WOFF2 font |

## Fields

| Name | Description |
| --- | --- |
| const [RequiredHeaderSize](../../groupdocs.editor.htmlcss.resources.fonts/woff2font/requiredheadersize) | WOFF2 header size (in bytes), which is required for its validation |
