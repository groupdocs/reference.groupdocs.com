...
| Name | Description |
| --- | --- |
| [BmpImage](bmpimage#constructor)(string, Stream) | Creates new BmpImage instance from content, represented as byte stream, and with specified name |
| [BmpImage](bmpimage#constructor_1)(string, string) | Creates new BmpImage instance from content, represented as base64-encoded string, and with specified name |
...
| override [Type](../../groupdocs.editor.htmlcss.resources.images.raster/bmpimage/type) { get; } | Returns ImageType.Bmp |
...
| [ReduceToNewHeight](../../groupdocs.editor.htmlcss.resources.images.raster/bmpimage/reducetonewheight#reducetonewheight)(ushort) | Creates and returns a new reduced BMP image, but with specified new reduced height and proportionally reduced width. (2 methods) |
