...
type: docs
weight: 510
url: /net/groupdocs.editor.htmlcss.resources.images.raster/gifimage/
---
## GifImage class
...
| Name | Description |
| --- | --- |
| [GifImage](gifimage#constructor)(string, Stream) | Creates new GifImage instance from content, represented as byte stream, and with specified name |
| [GifImage](gifimage#constructor_1)(string, string) | Creates new GifImage instance from content, represented as base64-encoded string, and with specified name |
...
| override [Type](../../groupdocs.editor.htmlcss.resources.images.raster/gifimage/type) { get; } | Returns ImageType.Gif |
| [Version](../../groupdocs.editor.htmlcss.resources.images.raster/gifimage/version) { get; } | Returns internal version of this GIF image (version is extracted from header) |
