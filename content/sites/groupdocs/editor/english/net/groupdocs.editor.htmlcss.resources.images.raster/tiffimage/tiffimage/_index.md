...
description: Creates new TiffImage instance from content represented as base64encoded string and with specified name
type: docs
weight: 10
url: /net/groupdocs.editor.htmlcss.resources.images.raster/tiffimage/tiffimage/
---
...
| --- | --- | --- |
| name | String | Name of the TIFF image. Cannot be null, empty or whitespaces. |
| contentInBase64 | String | Content as base64-encoded string. Cannot be null, empty or whitespaces. If it is not a TIFF content, exception will be thrown. |
...
| Parameter | Type | Description |
| --- | --- | --- |
| name | String | Name of the GIF image. Cannot be null, empty or whitespaces. |
