...
description: Creates new IconImage instance from content represented as base64encoded string and with specified name
type: docs
weight: 10
url: /net/groupdocs.editor.htmlcss.resources.images.raster/iconimage/iconimage/
---
...
| --- | --- | --- |
| name | String | Name of the ICON image. Cannot be null, empty or whitespaces. |
| contentInBase64 | String | Content as base64-encoded string. Cannot be null, empty or whitespaces. If it is not a ICON content, exception will be thrown. |
