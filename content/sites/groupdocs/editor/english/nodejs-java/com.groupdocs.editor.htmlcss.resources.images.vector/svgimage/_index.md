...
type: docs
weight: 12
url: /nodejs-java/com.groupdocs.editor.htmlcss.resources.images.vector/svgimage/
---
**Inheritance:**
...
| --- | --- |
| [SvgImage(String name, String content)](#SvgImage-java.lang.String-java.lang.String-) | Creates new SvgImage instance from content, represented as usual string,
and with specified name
 |
| [SvgImage(String name, InputStream binaryContent)](#SvgImage-java.lang.String-java.io.InputStream-) | Creates new SvgImage instance from content, represented as byte stream,
and with specified name
 |
## Methods
...
| Method | Description |
| --- | --- |
| [isValid(String content)](#isValid-java.lang.String-) | Performs a surface check whether specified textual XML-compliant content
...
| [getTextContent()](#getTextContent--) | Returns a content of this SVG image as a plain text (in XML format)
 |
| [getXmlContent()](#getXmlContent--) | Returns a content of this SVG image int its original XML-compliant
textual form
 |
