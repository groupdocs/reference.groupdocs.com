...
type: docs
weight: 14
url: /nodejs-java/com.groupdocs.editor.htmlcss.resources.images.vector/wmfimage/
---
**Inheritance:**
...
| --- | --- |
| [WmfImage(String name, String contentInBase64)](#WmfImage-java.lang.String-java.lang.String-) | Creates new WmfImage instance from content, represented as base64-encoded
string, and with specified name
 |
| [WmfImage(String name, InputStream binaryContent)](#WmfImage-java.lang.String-java.io.InputStream-) | Creates new WmfImage instance from content, represented as byte stream,
...
| [saveToSvg(OutputStream outputSvgContent)](#saveToSvg-java.io.OutputStream-) | Saves this vector WMF image into vector SVG image
 |
| [dispose()](#dispose--) | Disposes this WMF image by disposing its content and making most its
