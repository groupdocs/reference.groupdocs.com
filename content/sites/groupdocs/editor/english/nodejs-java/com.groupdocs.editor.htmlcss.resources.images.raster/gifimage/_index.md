...
type: docs
weight: 11
url: /nodejs-java/com.groupdocs.editor.htmlcss.resources.images.raster/gifimage/
---
**Inheritance:**
...
| --- | --- |
| [GifImage(String name, String contentInBase64)](#GifImage-java.lang.String-java.lang.String-) | Creates new GifImage instance from content, represented as base64-encoded
string, and with specified name
 |
| [GifImage(String name, InputStream binaryContent)](#GifImage-java.lang.String-java.io.InputStream-) | Creates new GifImage instance from content, represented as byte stream,
...
| [getType()](#getType--) | Returns ImageType.Gif
 |
| [getVersion()](#getVersion--) | Returns internal version of this GIF image (version is extracted from
header)
 |
