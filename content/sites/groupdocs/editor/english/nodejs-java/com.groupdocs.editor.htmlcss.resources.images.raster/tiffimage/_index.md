...
type: docs
weight: 16
url: /nodejs-java/com.groupdocs.editor.htmlcss.resources.images.raster/tiffimage/
---
**Inheritance:**
...
| --- | --- |
| [TiffImage(String name, String contentInBase64)](#TiffImage-java.lang.String-java.lang.String-) | Creates new TiffImage instance from content, represented as
base64-encoded string, and with specified name
 |
| [TiffImage(String name, InputStream binaryContent)](#TiffImage-java.lang.String-java.io.InputStream-) | Creates new GifImage instance from content, represented as byte stream,
...
Returns a number of frames (images) inside this TIFF image. Cannot be
lesser then 1.
