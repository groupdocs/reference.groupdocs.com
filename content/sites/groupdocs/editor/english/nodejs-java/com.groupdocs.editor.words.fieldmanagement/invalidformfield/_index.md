...
Represents the update of invalid form field names during the 
...
| Method | Description |
| --- | --- |
| [getName()](#getName--) | Gets the original name of the form field that cannot be modified outside 
FormFieldManager
.
 |
...
Gets the original name of the form field that cannot be modified outside 
FormFieldManager
.
...
This name removes duplicate unique identifiers with other form fields and sets a unique bookmark name.
