...
type: docs
weight: 12
url: /nodejs-java/com.groupdocs.editor.words.fieldmanagement/currenttimeformfield/
---
**Inheritance:**
java.lang.Object
...
| --- | --- |
| [CurrentTimeFormField(String stylesheet, String name)](#CurrentTimeFormField-java.lang.String-java.lang.String-) | Initializes a new instance of the [CurrentTimeFormField](../../com.groupdocs.editor.words.fieldmanagement/currenttimeformfield) class with the specified stylesheet and name. |
## Methods
...
| [getType()](#getType--) | Gets the type of the form field, which is always FormFieldType.CurrentTime for this class. |
...
| [getValue()](#getValue--) | Gets or sets the value of the form field, which represents the current time. |
| [setValue(Date value)](#setValue-java.util.Date-) | Gets or sets the value of the form field, which represents the current time. |
...
Initializes a new instance of the [CurrentTimeFormField](../../com.groupdocs.editor.words.fieldmanagement/currenttimeformfield) class with the specified stylesheet and name.
