...
type: docs
weight: 42
url: /nodejs-java/com.groupdocs.editor.options/texttrailingspacesoptions/
---
**Inheritance:**
java.lang.Object
```
...
Contains available options for trailing space handling during opening plain
text document (TXT)
...
| [Trim](#Trim) | Trim (truncate) all trailing spaces completely.
 |
| [Preserve](#Preserve) | Pass all trailing spaces to the output HTML "as is", without touching
them
 |
### Trim {#Trim}
```
