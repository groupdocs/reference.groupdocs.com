...
type: docs
weight: 21
url: /nodejs-java/com.groupdocs.editor.options/markdowneditoptions/
---
**Inheritance:**
java.lang.Object
...
| --- | --- |
| [MarkdownEditOptions()](#MarkdownEditOptions--) | Creates and returns a new instance of the MarkdownEditOptions class,
...
| Method | Description |
| --- | --- |
| [getImageLoadCallback()](#getImageLoadCallback--) | Allows to control how images are saved when converting Markdown document
to Html.
 |
| [setImageLoadCallback(IMarkdownImageLoadCallback value)](#setImageLoadCallback-com.groupdocs.editor.options.IMarkdownImageLoadCallback-) | Allows to control how images are saved when converting Markdown document
to Html.
 |
...
Creates and returns a new instance of the MarkdownEditOptions class,
where all options are set to their default values
