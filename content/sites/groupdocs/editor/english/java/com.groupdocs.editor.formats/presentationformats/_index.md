...
Encapsulates all Presentation formats. Includes the following formats: [PresentationFormats\#Odp](../../com.groupdocs.editor.formats/presentationformats\#Odp), [PresentationFormats\#Otp](../../com.groupdocs.editor.formats/presentationformats\#Otp), [PresentationFormats\#Pot](../../com.groupdocs.editor.formats/presentationformats\#Pot), [PresentationFormats\#Potm](../../com.groupdocs.editor.formats/presentationformats\#Potm), [PresentationFormats\#Potx](../../com.groupdocs.editor.formats/presentationformats\#Potx), [PresentationFormats\#Pps](../../com.groupdocs.editor.formats/presentationformats\#Pps), [PresentationFormats\#Ppsm](../../com.groupdocs.editor.formats/presentationformats\#Ppsm), [PresentationFormats\#Ppsx](../../com.groupdocs.editor.formats/presentationformats\#Ppsx), [PresentationFormats\#Ppt](../../com.groupdocs.editor.formats/presentationformats\#Ppt), [PresentationFormats\#Ppt95](../../com.groupdocs.editor.formats/presentationformats\#Ppt95), [PresentationFormats\#Pptm](../../com.groupdocs.editor.formats/presentationformats\#Pptm), [PresentationFormats\#Pptx](../../com.groupdocs.editor.formats/presentationformats\#Pptx). Learn more about Presentation formats [here][].
...
| [CloneTo(PresentationFormats that)](#CloneTo-com.groupdocs.editor.formats.PresentationFormats-) |  |
| [Clone()](#Clone--) |  |
| [clone()](#clone--) |  |
| [equals(PresentationFormats obj1, PresentationFormats obj2)](#equals-com.groupdocs.editor.formats.PresentationFormats-com.groupdocs.editor.formats.PresentationFormats-) |  |
### PresentationFormats() {#PresentationFormats--}
```
...
| Parameter | Type | Description |
| --- | --- | --- |
| that | [PresentationFormats](../../com.groupdocs.editor.formats/presentationformats) |  |
...
### equals(PresentationFormats obj1, PresentationFormats obj2) {#equals-com.groupdocs.editor.formats.PresentationFormats-com.groupdocs.editor.formats.PresentationFormats-}
```
public static boolean equals(PresentationFormats obj1, PresentationFormats obj2)
```
...
| Parameter | Type | Description |
| --- | --- | --- |
| obj1 | [PresentationFormats](../../com.groupdocs.editor.formats/presentationformats) |  |
| obj2 | [PresentationFormats](../../com.groupdocs.editor.formats/presentationformats) |  |
