...
Encapsulates all eBook formats. Includes the following file types: [EBookFormats\#Mobi](../../com.groupdocs.editor.formats/ebookformats\#Mobi), [EBookFormats\#Epub](../../com.groupdocs.editor.formats/ebookformats\#Epub) Learn more about Mobi format [here][], and about ePub format [here][here 1].
...
| [CloneTo(EBookFormats that)](#CloneTo-com.groupdocs.editor.formats.EBookFormats-) |  |
| [Clone()](#Clone--) |  |
| [clone()](#clone--) |  |
| [equals(EBookFormats obj1, EBookFormats obj2)](#equals-com.groupdocs.editor.formats.EBookFormats-com.groupdocs.editor.formats.EBookFormats-) |  |
### EBookFormats() {#EBookFormats--}
```
public EBookFormats()
```
...
### CloneTo(EBookFormats that) {#CloneTo-com.groupdocs.editor.formats.EBookFormats-}
```
public void CloneTo(EBookFormats that)
```
...
| Parameter | Type | Description |
| --- | --- | --- |
| that | [EBookFormats](../../com.groupdocs.editor.formats/ebookformats) |  |

### Clone() {#Clone--}
```
public EBookFormats Clone()
```
...
### equals(EBookFormats obj1, EBookFormats obj2) {#equals-com.groupdocs.editor.formats.EBookFormats-com.groupdocs.editor.formats.EBookFormats-}
```
public static boolean equals(EBookFormats obj1, EBookFormats obj2)
```
...
| Parameter | Type | Description |
| --- | --- | --- |
| obj1 | [EBookFormats](../../com.groupdocs.editor.formats/ebookformats) |  |
| obj2 | [EBookFormats](../../com.groupdocs.editor.formats/ebookformats) |  |
