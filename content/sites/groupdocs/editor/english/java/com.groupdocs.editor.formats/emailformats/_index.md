...
Encapsulates all emails formats. Includes the following file types: [EmailFormats\#Tnef](../../com.groupdocs.editor.formats/emailformats\#Tnef), [EmailFormats\#Eml](../../com.groupdocs.editor.formats/emailformats\#Eml), [EmailFormats\#Emlx](../../com.groupdocs.editor.formats/emailformats\#Emlx), [EmailFormats\#Msg](../../com.groupdocs.editor.formats/emailformats\#Msg), [EmailFormats\#Html](../../com.groupdocs.editor.formats/emailformats\#Html), [EmailFormats\#Mhtml](../../com.groupdocs.editor.formats/emailformats\#Mhtml).
...
| [CloneTo(EmailFormats that)](#CloneTo-com.groupdocs.editor.formats.EmailFormats-) |  |
| [Clone()](#Clone--) |  |
| [clone()](#clone--) |  |
| [equals(EmailFormats obj1, EmailFormats obj2)](#equals-com.groupdocs.editor.formats.EmailFormats-com.groupdocs.editor.formats.EmailFormats-) |  |
### EmailFormats() {#EmailFormats--}
```
public EmailFormats()
```
...
### CloneTo(EmailFormats that) {#CloneTo-com.groupdocs.editor.formats.EmailFormats-}
```
public void CloneTo(EmailFormats that)
```
...
| Parameter | Type | Description |
| --- | --- | --- |
| that | [EmailFormats](../../com.groupdocs.editor.formats/emailformats) |  |

### Clone() {#Clone--}
```
public EmailFormats Clone()
```
...
### equals(EmailFormats obj1, EmailFormats obj2) {#equals-com.groupdocs.editor.formats.EmailFormats-com.groupdocs.editor.formats.EmailFormats-}
```
public static boolean equals(EmailFormats obj1, EmailFormats obj2)
```
...
| Parameter | Type | Description |
| --- | --- | --- |
| obj1 | [EmailFormats](../../com.groupdocs.editor.formats/emailformats) |  |
| obj2 | [EmailFormats](../../com.groupdocs.editor.formats/emailformats) |  |
