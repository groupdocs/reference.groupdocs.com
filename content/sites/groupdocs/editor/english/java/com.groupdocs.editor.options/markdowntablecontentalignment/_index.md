...
Allows to specify the alignment of the content of the table to be used when
...
| Field | Description |
| --- | --- |
| [Auto](#Auto) | The alignment will be taken from the first paragraph in corresponding
table column.
 |
