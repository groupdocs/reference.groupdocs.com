...
By default is false (disabled) \\u2014 all attribute-value pairs are placed in a single line.
...
By default is false (disabled) \\u2014 leaf text nodes are placed on the same line as their parents, without new indent.
