...
| [fromValueWithUnit(CssNumber value, byte unit)](#fromValueWithUnit-com.groupdocs.editor.htmlcss.css.datatypes.CssNumber-byte-) |  |
...
| [CloneTo(Length that)](#CloneTo-com.groupdocs.editor.htmlcss.css.datatypes.Length-) |  |
| [Clone()](#Clone--) |  |
| [clone()](#clone--) |  |
| [equals(Length obj1, Length obj2)](#equals-com.groupdocs.editor.htmlcss.css.datatypes.Length-com.groupdocs.editor.htmlcss.css.datatypes.Length-) |  |
### Length() {#Length--}
```
public Length()
```
...
### fromValueWithUnit(CssNumber value, byte unit) {#fromValueWithUnit-com.groupdocs.editor.htmlcss.css.datatypes.CssNumber-byte-}
```
public static Length fromValueWithUnit(CssNumber value, byte unit)
```
...
### changeNegative() {#changeNegative--}
```
public final void changeNegative()
```
...
| result | com.groupdocs.editor.htmlcss.css.datatypes.Length[] | Output parameter, that contains a result of parsing. If parsing is unsuccessful, contains a default Length value \\u2014 a unitless zero. |
...
### CloneTo(Length that) {#CloneTo-com.groupdocs.editor.htmlcss.css.datatypes.Length-}
```
public void CloneTo(Length that)
```
...
| Parameter | Type | Description |
| --- | --- | --- |
| that | [Length](../../com.groupdocs.editor.htmlcss.css.datatypes/length) |  |
...
### equals(Length obj1, Length obj2) {#equals-com.groupdocs.editor.htmlcss.css.datatypes.Length-com.groupdocs.editor.htmlcss.css.datatypes.Length-}
```
public static boolean equals(Length obj1, Length obj2)
```
...
| Parameter | Type | Description |
| --- | --- | --- |
| obj1 | [Length](../../com.groupdocs.editor.htmlcss.css.datatypes/length) |  |
| obj2 | [Length](../../com.groupdocs.editor.htmlcss.css.datatypes/length) |  |
