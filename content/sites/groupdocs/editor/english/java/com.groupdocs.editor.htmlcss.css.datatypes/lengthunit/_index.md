...
| [Vmax](#Vmax) | Vmax.
 |
| [Percent](#Percent) | The value is relative to a fixed (external) value, that is context
dependent.
 |
## Methods
...
Pixel. Relative to the viewing device. For screen display, typically
...
font. On fonts with the 'x' letter, this is generally the height of
lowercase letters in the font; 1ex \\u2248 0.5em in many fonts.
...
Ch. This unit represents the width, or more precisely the advance
...
Rem. This unit represents the font-size of the root element (e.g. the
font-size of the \<html\> element). When used on the font-size on
this root element, it represents its initial value.
...
Vmin. 1/100th of the minimum value between the height and the width
of the viewport.
...
Vmax. 1/100th of the maximum value between the height and the width
of the viewport.
