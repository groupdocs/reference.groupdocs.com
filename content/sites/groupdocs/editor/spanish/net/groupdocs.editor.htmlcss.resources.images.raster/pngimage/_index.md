...
Representa una imagen en formato PNG (Portable Network Graphics) con sus metadatos y métodos adicionales
...
| Nombre | Descripción |
| --- | --- |
| [PngImage](pngimage#constructor)(string, Stream) | Crea una nueva instancia de PngImage a partir del contenido, representada como flujo de bytes y con el nombre especificado |
| [PngImage](pngimage#constructor_1)(string, string) | Crea una nueva instancia de PngImage a partir del contenido, representada como una cadena codificada en base64 y con el nombre especificado |
...
| override [Type](../../groupdocs.editor.htmlcss.resources.images.raster/pngimage/type) { get; } | Devuelve TipoImagen.Png |
...
| [ReduceToNewHeight](../../groupdocs.editor.htmlcss.resources.images.raster/pngimage/reducetonewheight#reducetonewheight)(ushort) | Crea y devuelve una nueva imagen PNG reducida, pero con una nueva altura reducida especificada y un ancho proporcionalmente reducido. (2 methods) |
...
| static [IsValid](../../groupdocs.editor.htmlcss.resources.images.raster/pngimage/isvalid#isvalid)(Stream) | Comprueba si el flujo especificado es una imagen PNG válida |
| static [IsValid](../../groupdocs.editor.htmlcss.resources.images.raster/pngimage/isvalid#isvalid_1)(string) | Comprueba si la cadena codificada en base64 especificada es una imagen PNG válida |
