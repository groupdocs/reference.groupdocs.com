...
type: docs
weight: 400
url: /es/net/groupdocs.editor.htmlcss.resources.images.raster/bmpimage/
---
## BmpImage class

Representa una imagen en formato BMP (BitMap Picture) con sus metadatos y métodos adicionales
...
| Nombre | Descripción |
| --- | --- |
| [BmpImage](bmpimage#constructor)(string, Stream) | Crea una nueva instancia de BmpImage a partir del contenido, representada como flujo de bytes y con el nombre especificado |
| [BmpImage](bmpimage#constructor_1)(string, string) | Crea una nueva instancia de BmpImage a partir del contenido, representada como una cadena codificada en base64 y con el nombre especificado |
...
| override [Type](../../groupdocs.editor.htmlcss.resources.images.raster/bmpimage/type) { get; } | Devuelve TipoImagen.Bmp |
...
| [ReduceToNewHeight](../../groupdocs.editor.htmlcss.resources.images.raster/bmpimage/reducetonewheight#reducetonewheight)(ushort) | Crea y devuelve una nueva imagen BMP reducida, pero con una nueva altura reducida especificada y un ancho proporcionalmente reducido. (2 methods) |
...
| static [IsValid](../../groupdocs.editor.htmlcss.resources.images.raster/bmpimage/isvalid#isvalid)(Stream) | Comprueba si el flujo especificado es una imagen BMP válida |
| static [IsValid](../../groupdocs.editor.htmlcss.resources.images.raster/bmpimage/isvalid#isvalid_1)(string) | Comprueba si la cadena codificada en base64 especificada es una imagen BMP válida |
