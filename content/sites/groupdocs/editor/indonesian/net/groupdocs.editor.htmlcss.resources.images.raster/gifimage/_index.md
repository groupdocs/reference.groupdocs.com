...
description: Mewakili satu gambar dalam format GIF Graphics Interchange Format dengan metadata dan metode tambahannya
type: docs
weight: 510
...
Mewakili satu gambar dalam format GIF (Graphics Interchange Format) dengan metadata dan metode tambahannya
...
| Nama | Keterangan |
| --- | --- |
| [GifImage](gifimage#constructor)(string, Stream) | Membuat instance GifImage baru dari konten, direpresentasikan sebagai aliran byte, dan dengan nama tertentu |
| [GifImage](gifimage#constructor_1)(string, string) | Membuat instance GifImage baru dari konten, direpresentasikan sebagai string berenkode base64, dan dengan nama tertentu |
...
| [Version](../../groupdocs.editor.htmlcss.resources.images.raster/gifimage/version) { get; } | Mengembalikan versi internal gambar GIF ini (versi diekstrak dari header) |
...
| [ReduceToNewHeight](../../groupdocs.editor.htmlcss.resources.images.raster/gifimage/reducetonewheight#reducetonewheight)(ushort) | Membuat dan mengembalikan gambar GIF baru yang diperkecil, tetapi dengan tinggi baru yang diperkecil dan lebar yang diperkecil secara proporsional. (2 methods) |
...
| static [IsValid](../../groupdocs.editor.htmlcss.resources.images.raster/gifimage/isvalid#isvalid)(Stream) | Memeriksa apakah aliran yang ditentukan adalah gambar GIF yang valid |
| static [IsValid](../../groupdocs.editor.htmlcss.resources.images.raster/gifimage/isvalid#isvalid_1)(string) | Memeriksa apakah string berenkode base64 yang ditentukan adalah gambar GIF yang valid |
