...
description: Merupakan satu gambar dalam format PNG Portable Network Graphics dengan metadata dan metode tambahannya
type: docs
weight: 540
url: /id/net/groupdocs.editor.htmlcss.resources.images.raster/pngimage/
---
## PngImage class

Merupakan satu gambar dalam format PNG (Portable Network Graphics) dengan metadata dan metode tambahannya
...
| Nama | Keterangan |
| --- | --- |
| [PngImage](pngimage#constructor)(string, Stream) | Membuat instance PngImage baru dari konten, direpresentasikan sebagai aliran byte, dan dengan nama tertentu |
| [PngImage](pngimage#constructor_1)(string, string) | Membuat instance PngImage baru dari konten, direpresentasikan sebagai string berenkode base64, dan dengan nama tertentu |
...
| override [Type](../../groupdocs.editor.htmlcss.resources.images.raster/pngimage/type) { get; } | Mengembalikan ImageType.Png |
...
| [ReduceToNewHeight](../../groupdocs.editor.htmlcss.resources.images.raster/pngimage/reducetonewheight#reducetonewheight)(ushort) | Membuat dan mengembalikan gambar PNG baru yang diperkecil, tetapi dengan tinggi baru yang diperkecil dan lebar yang diperkecil secara proporsional. (2 methods) |
...
| static [IsValid](../../groupdocs.editor.htmlcss.resources.images.raster/pngimage/isvalid#isvalid)(Stream) | Memeriksa apakah aliran yang ditentukan adalah gambar PNG yang valid |
| static [IsValid](../../groupdocs.editor.htmlcss.resources.images.raster/pngimage/isvalid#isvalid_1)(string) | Memeriksa apakah string berenkode base64 yang ditentukan adalah gambar PNG yang valid |
