...
description: Vertegenwoordigt één afbeelding in BMPindeling BitMap Picture met zijn metagegevens en aanvullende methoden
type: docs
weight: 500
url: /nl/net/groupdocs.editor.htmlcss.resources.images.raster/bmpimage/
---
## BmpImage class

Vertegenwoordigt één afbeelding in BMP-indeling (BitMap Picture) met zijn metagegevens en aanvullende methoden
...
| Naam | Beschrijving |
| --- | --- |
| [BmpImage](bmpimage#constructor)(string, Stream) | Creëert nieuwe BmpImage-instantie van inhoud, weergegeven als bytestroom, en met opgegeven naam |
| [BmpImage](bmpimage#constructor_1)(string, string) | Creëert nieuwe BmpImage-instantie van inhoud, weergegeven als base64-gecodeerde tekenreeks, en met gespecificeerde naam |
...
| override [Type](../../groupdocs.editor.htmlcss.resources.images.raster/bmpimage/type) { get; } | Retourneert ImageType.Bmp |
...
| [ReduceToNewHeight](../../groupdocs.editor.htmlcss.resources.images.raster/bmpimage/reducetonewheight#reducetonewheight)(ushort) | Creëert en retourneert een nieuwe verkleinde BMP-afbeelding, maar met gespecificeerde nieuwe verkleinde hoogte en proportioneel verkleinde breedte. (2 methods) |
...
| static [IsValid](../../groupdocs.editor.htmlcss.resources.images.raster/bmpimage/isvalid#isvalid)(Stream) | Controleert of opgegeven stream een geldige BMP-afbeelding is |
| static [IsValid](../../groupdocs.editor.htmlcss.resources.images.raster/bmpimage/isvalid#isvalid_1)(string) | Controleert of opgegeven base64-gecodeerde tekenreeks een geldige BMP-afbeelding is |
