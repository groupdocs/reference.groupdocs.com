...
description: Vertegenwoordigt één afbeelding in JPEGindeling Joint Photographic Experts Group met zijn metadata en aanvullende methoden
type: docs
weight: 530
url: /nl/net/groupdocs.editor.htmlcss.resources.images.raster/jpegimage/
---
## JpegImage class

Vertegenwoordigt één afbeelding in JPEG-indeling (Joint Photographic Experts Group) met zijn metadata en aanvullende methoden
...
| Naam | Beschrijving |
| --- | --- |
| [JpegImage](jpegimage#constructor)(string, Stream) | Maakt een nieuwe JpegImage-instantie van inhoud, weergegeven als bytestream, en met opgegeven naam |
| [JpegImage](jpegimage#constructor_1)(string, string) | Maakt een nieuwe JpegImage-instantie op basis van inhoud, weergegeven als base64-gecodeerde tekenreeks, en met de opgegeven naam |
...
| override [Type](../../groupdocs.editor.htmlcss.resources.images.raster/jpegimage/type) { get; } | Retourneert ImageType.Jpeg |
...
| [ReduceToNewHeight](../../groupdocs.editor.htmlcss.resources.images.raster/jpegimage/reducetonewheight#reducetonewheight)(ushort) | Creëert en retourneert een nieuwe verkleinde JPEG-afbeelding, maar met gespecificeerde nieuwe verkleinde hoogte en proportioneel verkleinde breedte. (2 methods) |
...
| static [IsValid](../../groupdocs.editor.htmlcss.resources.images.raster/jpegimage/isvalid#isvalid)(Stream) | Controleert of opgegeven stream een geldige JPEG-afbeelding is |
| static [IsValid](../../groupdocs.editor.htmlcss.resources.images.raster/jpegimage/isvalid#isvalid_1)(string) | Controleert of opgegeven base64-gecodeerde tekenreeks een geldige JPEG-afbeelding is |
