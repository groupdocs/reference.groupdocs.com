...
description: Vertegenwoordigt één lettertype in het WOFFformaat Web Open Font Format
type: docs
weight: 420
url: /nl/net/groupdocs.editor.htmlcss.resources.fonts/wofffont/
---
## WoffFont class

Vertegenwoordigt één lettertype in het WOFF-formaat (Web Open Font Format)
...
| Naam | Beschrijving |
| --- | --- |
| [WoffFont](wofffont#constructor)(string, Stream) | Creëert nieuwe WoffFont-klasse van inhoud, weergegeven als bytestroom, en met gespecificeerde naam |
| [WoffFont](wofffont#constructor_1)(string, string) | Maakt nieuwe WoffFont-klasse van inhoud, weergegeven als base64-gecodeerde tekenreeks, en met gespecificeerde naam |
...
| override [Type](../../groupdocs.editor.htmlcss.resources.fonts/wofffont/type) { get; } | Retourneert FontType.Woff |
...
| static [IsValid](../../groupdocs.editor.htmlcss.resources.fonts/wofffont/isvalid#isvalid)(Stream) | Controleert of opgegeven stream een geldig WOFF-lettertype is |
| static [IsValid](../../groupdocs.editor.htmlcss.resources.fonts/wofffont/isvalid#isvalid_1)(string) | Controleert of opgegeven base64-gecodeerde tekenreeks een geldig WOFF-lettertype is |

## Velden

| Naam | Beschrijving |
| --- | --- |
| const [RequiredHeaderSize](../../groupdocs.editor.htmlcss.resources.fonts/wofffont/requiredheadersize) | WOFF-headergrootte (in bytes), die vereist is voor de validatie |
