...
description: Αντιπροσωπεύει μία εικόνα σε μορφή BMP BitMap Picture με τα μεταδεδομένα και τις πρόσθετες μεθόδους
type: docs
weight: 500
url: /el/net/groupdocs.editor.htmlcss.resources.images.raster/bmpimage/
---
## BmpImage class

Αντιπροσωπεύει μία εικόνα σε μορφή BMP (BitMap Picture) με τα μεταδεδομένα και τις πρόσθετες μεθόδους
...
| Ονομα | Περιγραφή |
| --- | --- |
| [BmpImage](bmpimage#constructor)(string, Stream) | Δημιουργεί νέα παρουσία BmpImage από περιεχόμενο, που αναπαρίσταται ως ροή byte και με καθορισμένο όνομα |
| [BmpImage](bmpimage#constructor_1)(string, string) | Δημιουργεί νέα παρουσία BmpImage από περιεχόμενο, που αναπαρίσταται ως συμβολοσειρά με κωδικοποίηση base64 και με καθορισμένο όνομα |
...
| override [Type](../../groupdocs.editor.htmlcss.resources.images.raster/bmpimage/type) { get; } | Επιστρέφει ImageType.Bmp |
...
| [ReduceToNewHeight](../../groupdocs.editor.htmlcss.resources.images.raster/bmpimage/reducetonewheight#reducetonewheight)(ushort) | Δημιουργεί και επιστρέφει μια νέα μειωμένη εικόνα BMP, αλλά με καθορισμένο νέο μειωμένο ύψος και αναλογικά μειωμένο πλάτος. (2 methods) |
...
| static [IsValid](../../groupdocs.editor.htmlcss.resources.images.raster/bmpimage/isvalid#isvalid)(Stream) | Ελέγχει εάν η καθορισμένη ροή είναι έγκυρη εικόνα BMP |
| static [IsValid](../../groupdocs.editor.htmlcss.resources.images.raster/bmpimage/isvalid#isvalid_1)(string) | Ελέγχει εάν η καθορισμένη συμβολοσειρά με κωδικοποίηση base64 είναι έγκυρη εικόνα BMP |
