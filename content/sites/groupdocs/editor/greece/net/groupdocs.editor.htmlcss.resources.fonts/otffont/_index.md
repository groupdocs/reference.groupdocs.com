...
description: Αντιπροσωπεύει μία γραμματοσειρά σε μορφή OTF Μορφή ανοιχτού τύπου
type: docs
weight: 390
url: /el/net/groupdocs.editor.htmlcss.resources.fonts/otffont/
---
## OtfFont class

Αντιπροσωπεύει μία γραμματοσειρά σε μορφή OTF (Μορφή ανοιχτού τύπου)
...
| Ονομα | Περιγραφή |
| --- | --- |
| [OtfFont](otffont#constructor)(string, Stream) | Δημιουργεί νέα κλάση OtfFont από περιεχόμενο, που αναπαρίσταται ως ροή byte και με καθορισμένο όνομα |
| [OtfFont](otffont#constructor_1)(string, string) | Δημιουργεί νέα κλάση OtfFont από περιεχόμενο, που αναπαρίσταται ως συμβολοσειρά με κωδικοποίηση base64 και με καθορισμένο όνομα |
...
| override [Type](../../groupdocs.editor.htmlcss.resources.fonts/otffont/type) { get; } | Επιστρέφει[`Otf`](../fonttype/otf) |
...
| static [IsValid](../../groupdocs.editor.htmlcss.resources.fonts/otffont/isvalid#isvalid)(Stream) | Ελέγχει εάν η καθορισμένη ροή είναι έγκυρη γραμματοσειρά OTF |
| static [IsValid](../../groupdocs.editor.htmlcss.resources.fonts/otffont/isvalid#isvalid_1)(string) | Ελέγχει εάν η καθορισμένη συμβολοσειρά με κωδικοποίηση base64 είναι έγκυρη γραμματοσειρά OTF |

## Πεδία

| Ονομα | Περιγραφή |
| --- | --- |
| const [RequiredHeaderSize](../../groupdocs.editor.htmlcss.resources.fonts/otffont/requiredheadersize) | Μέγεθος κεφαλίδας OTF (σε byte), το οποίο απαιτείται για την επικύρωσή της |
