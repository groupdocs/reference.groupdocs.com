...
type: docs
weight: 410
url: /el/net/groupdocs.editor.htmlcss.resources.fonts/woff2font/
---
## Woff2Font class

Αντιπροσωπεύει μία γραμματοσειρά στη μορφή WOFF2 (Web Open Font Format)
...
| Ονομα | Περιγραφή |
| --- | --- |
| [Woff2Font](woff2font#constructor)(string, Stream) | Δημιουργεί νέα κλάση Woff2Font από περιεχόμενο, που αναπαρίσταται ως ροή byte και με καθορισμένο όνομα |
| [Woff2Font](woff2font#constructor_1)(string, string) | Δημιουργεί νέα κλάση Woff2Font από περιεχόμενο, που αναπαρίσταται ως συμβολοσειρά με κωδικοποίηση base64 και με καθορισμένο όνομα |
...
| override [Type](../../groupdocs.editor.htmlcss.resources.fonts/woff2font/type) { get; } | Επιστρέφει FontType.Woff2 |
...
| static [IsValid](../../groupdocs.editor.htmlcss.resources.fonts/woff2font/isvalid#isvalid)(Stream) | Ελέγχει εάν η καθορισμένη ροή είναι έγκυρη γραμματοσειρά WOFF2 |
| static [IsValid](../../groupdocs.editor.htmlcss.resources.fonts/woff2font/isvalid#isvalid_1)(string) | Ελέγχει εάν η καθορισμένη συμβολοσειρά με κωδικοποίηση base64 είναι έγκυρη γραμματοσειρά WOFF2 |

## Πεδία

| Ονομα | Περιγραφή |
| --- | --- |
| const [RequiredHeaderSize](../../groupdocs.editor.htmlcss.resources.fonts/woff2font/requiredheadersize) | Μέγεθος κεφαλίδας WOFF2 (σε byte), το οποίο απαιτείται για την επικύρωσή της |
