...
description: Αντιπροσωπεύει μία γραμματοσειρά σε μορφή TTF TrueType Font
type: docs
weight: 400
url: /el/net/groupdocs.editor.htmlcss.resources.fonts/ttffont/
---
## TtfFont class

Αντιπροσωπεύει μία γραμματοσειρά σε μορφή TTF (TrueType Font)
...
| Ονομα | Περιγραφή |
| --- | --- |
| [TtfFont](ttffont#constructor)(string, Stream) | Δημιουργεί νέα κλάση TtfFont από περιεχόμενο, που αναπαρίσταται ως ροή byte και με καθορισμένο όνομα |
| [TtfFont](ttffont#constructor_1)(string, string) | Δημιουργεί νέα κλάση TtfFont από περιεχόμενο, που αναπαρίσταται ως συμβολοσειρά με κωδικοποίηση base64 και με καθορισμένο όνομα |
...
| override [Type](../../groupdocs.editor.htmlcss.resources.fonts/ttffont/type) { get; } | Επιστρέφει FontType.Ttf |
...
| static [IsValid](../../groupdocs.editor.htmlcss.resources.fonts/ttffont/isvalid#isvalid)(Stream) | Ελέγχει εάν η καθορισμένη ροή είναι έγκυρη γραμματοσειρά TTF |
| static [IsValid](../../groupdocs.editor.htmlcss.resources.fonts/ttffont/isvalid#isvalid_1)(string) | Ελέγχει εάν η καθορισμένη συμβολοσειρά με κωδικοποίηση base64 είναι έγκυρη γραμματοσειρά TTF |

## Πεδία

| Ονομα | Περιγραφή |
| --- | --- |
| const [RequiredHeaderSize](../../groupdocs.editor.htmlcss.resources.fonts/ttffont/requiredheadersize) | Μέγεθος κεφαλίδας TTF (σε byte), που απαιτείται για την επικύρωσή της |
