...
type: docs
weight: 360
url: /el/net/groupdocs.editor.htmlcss.resources.fonts/eotfont/
---
## EotFont class

Αντιπροσωπεύει μία γραμματοσειρά στη μορφή EOT (Embedded OpenType)
...
| Ονομα | Περιγραφή |
| --- | --- |
| [EotFont](eotfont#constructor)(string, Stream) | Δημιουργεί νέα κλάση EotFont από περιεχόμενο, που αναπαρίσταται ως ροή byte και με καθορισμένο όνομα |
| [EotFont](eotfont#constructor_1)(string, string) | Δημιουργεί νέα κλάση EotFont από περιεχόμενο, που αναπαρίσταται ως συμβολοσειρά με κωδικοποίηση base64 και με καθορισμένο όνομα |
...
| override [Type](../../groupdocs.editor.htmlcss.resources.fonts/eotfont/type) { get; } | Επιστρέφει FontType.Eot |
...
| static [IsValid](../../groupdocs.editor.htmlcss.resources.fonts/eotfont/isvalid#isvalid)(Stream) | Ελέγχει εάν η καθορισμένη ροή είναι έγκυρη γραμματοσειρά EOT |
| static [IsValid](../../groupdocs.editor.htmlcss.resources.fonts/eotfont/isvalid#isvalid_1)(string) | Ελέγχει εάν η καθορισμένη συμβολοσειρά με κωδικοποίηση base64 είναι έγκυρη γραμματοσειρά EOT |

## Πεδία

| Ονομα | Περιγραφή |
| --- | --- |
| const [RequiredHeaderSize](../../groupdocs.editor.htmlcss.resources.fonts/eotfont/requiredheadersize) | Μέγεθος κεφαλίδας EOT (σε byte), που απαιτείται για την επικύρωσή της |
