...
description: 이름과 확장자로 구성된 이 벡터 이미지의 올바른 파일 이름을 반환합니다. 이론적으로 이름과 다를 수 있습니다.
type: docs
weight: 30
url: /ko/net/groupdocs.editor.htmlcss.resources.images.vector/vectorimageresourcebase/filenamewithextension/
---
