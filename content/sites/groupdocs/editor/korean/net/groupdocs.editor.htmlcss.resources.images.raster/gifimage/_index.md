...
description: 메타데이터 및 추가 메서드가 있는 GIFGraphics Interchange Format 형식의 하나의 이미지를 나타냅니다
type: docs
weight: 510
url: /ko/net/groupdocs.editor.htmlcss.resources.images.raster/gifimage/
---
## GifImage class

메타데이터 및 추가 메서드가 있는 GIF(Graphics Interchange Format) 형식의 하나의 이미지를 나타냅니다
...
| 이름 | 설명 |
| --- | --- |
| [GifImage](gifimage#constructor)(string, Stream) | 바이트 스트림으로 표시되고 지정된 name 를 사용하여 콘텐츠에서 새 GifImage 인스턴스를 만듭니다. |
| [GifImage](gifimage#constructor_1)(string, string) | base64로 인코딩된 문자열로 표시되고 지정된 name 를 사용하여 콘텐츠에서 새 GifImage 인스턴스를 만듭니다. |
...
| override [Type](../../groupdocs.editor.htmlcss.resources.images.raster/gifimage/type) { get; } | ImageType.Gif 를 반환합니다. |
| [Version](../../groupdocs.editor.htmlcss.resources.images.raster/gifimage/version) { get; } | 이 GIF 이미지의 내부 버전을 반환합니다(버전은 헤더에서 추출됨) |
...
| [ReduceToNewHeight](../../groupdocs.editor.htmlcss.resources.images.raster/gifimage/reducetonewheight#reducetonewheight)(ushort) | 새로 축소된 GIF 이미지를 생성하고 반환하지만 새로 축소된 높이와 비례적으로 축소된 너비를 지정합니다. (2 methods) |
| [Save](../../groupdocs.editor.htmlcss.resources.images.raster/rasterimageresourcebase/save)(string) | 이 래스터 이미지를 지정된 file 에 저장합니다. |
| static [IsValid](../../groupdocs.editor.htmlcss.resources.images.raster/gifimage/isvalid#isvalid)(Stream) | 지정된 스트림이 유효한 GIF인지 확인합니다. image |
| static [IsValid](../../groupdocs.editor.htmlcss.resources.images.raster/gifimage/isvalid#isvalid_1)(string) | 지정된 base64 인코딩 문자열이 유효한 GIF인지 확인합니다. |
