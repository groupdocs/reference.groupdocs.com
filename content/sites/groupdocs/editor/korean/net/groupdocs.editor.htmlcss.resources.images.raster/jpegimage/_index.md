...
description: 메타데이터 및 추가 방법이 있는 JPEGJoint Photographic Experts Group 형식의 이미지 하나를 나타냅니다
type: docs
weight: 530
url: /ko/net/groupdocs.editor.htmlcss.resources.images.raster/jpegimage/
---
## JpegImage class

메타데이터 및 추가 방법이 있는 JPEG(Joint Photographic Experts Group) 형식의 이미지 하나를 나타냅니다
...
| 이름 | 설명 |
| --- | --- |
| [JpegImage](jpegimage#constructor)(string, Stream) | 콘텐츠에서 바이트 스트림으로 표시되고 지정된 name 를 사용하여 새 JpegImage 인스턴스를 만듭니다. |
| [JpegImage](jpegimage#constructor_1)(string, string) | base64로 인코딩된 문자열로 표시되고 지정된 name 를 사용하여 콘텐츠에서 새 JpegImage 인스턴스를 만듭니다. |
...
| override [Type](../../groupdocs.editor.htmlcss.resources.images.raster/jpegimage/type) { get; } | ImageType.Jpeg 를 반환합니다. |
...
| [ReduceToNewHeight](../../groupdocs.editor.htmlcss.resources.images.raster/jpegimage/reducetonewheight#reducetonewheight)(ushort) | 새로 축소된 JPEG 이미지를 생성하고 반환하지만 새로 축소된 높이와 비례적으로 축소된 너비를 지정합니다. (2 methods) |
| [Save](../../groupdocs.editor.htmlcss.resources.images.raster/rasterimageresourcebase/save)(string) | 이 래스터 이미지를 지정된 file 에 저장합니다. |
| static [IsValid](../../groupdocs.editor.htmlcss.resources.images.raster/jpegimage/isvalid#isvalid)(Stream) | 지정된 스트림이 유효한 JPEG 이미지인지 확인합니다 |
| static [IsValid](../../groupdocs.editor.htmlcss.resources.images.raster/jpegimage/isvalid#isvalid_1)(string) | 지정된 base64 인코딩 문자열이 유효한 JPEG 이미지인지 확인합니다 |
