...
description: 메타데이터 및 추가 메서드가 있는 BMPBitMap Picture 형식의 하나의 이미지를 나타냅니다
type: docs
weight: 500
url: /ko/net/groupdocs.editor.htmlcss.resources.images.raster/bmpimage/
---
## BmpImage class

메타데이터 및 추가 메서드가 있는 BMP(BitMap Picture) 형식의 하나의 이미지를 나타냅니다
...
| 이름 | 설명 |
| --- | --- |
| [BmpImage](bmpimage#constructor)(string, Stream) | 바이트 스트림으로 표시되고 지정된 name 를 사용하여 콘텐츠에서 새 BmpImage 인스턴스를 만듭니다. |
| [BmpImage](bmpimage#constructor_1)(string, string) | 콘텐츠에서 base64로 인코딩된 문자열로 표시되고 지정된 name 를 사용하여 새 BmpImage 인스턴스를 만듭니다. |
...
| override [Type](../../groupdocs.editor.htmlcss.resources.images.raster/bmpimage/type) { get; } | ImageType.Bmp 를 반환합니다. |
...
| [ReduceToNewHeight](../../groupdocs.editor.htmlcss.resources.images.raster/bmpimage/reducetonewheight#reducetonewheight)(ushort) | 새로 축소된 BMP 이미지를 생성하고 반환하지만 새로 축소된 높이와 비례적으로 축소된 너비를 지정합니다. (2 methods) |
| [Save](../../groupdocs.editor.htmlcss.resources.images.raster/rasterimageresourcebase/save)(string) | 이 래스터 이미지를 지정된 file 에 저장합니다. |
| static [IsValid](../../groupdocs.editor.htmlcss.resources.images.raster/bmpimage/isvalid#isvalid)(Stream) | 지정된 스트림이 유효한 BMP인지 확인합니다. image |
| static [IsValid](../../groupdocs.editor.htmlcss.resources.images.raster/bmpimage/isvalid#isvalid_1)(string) | 지정된 base64 인코딩 문자열이 유효한 BMP인지 확인합니다. |
