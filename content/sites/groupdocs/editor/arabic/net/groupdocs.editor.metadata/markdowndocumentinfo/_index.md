...
| [IsEncrypted](../../groupdocs.editor.metadata/markdowndocumentinfo/isencrypted) { get; } | نظرًا لأنه لا يمكن تشفير مستندات Markdown بكلمة مرور ، فإن هذه الخاصية تُرجع دائمًا ``خطأ شنيع` |
