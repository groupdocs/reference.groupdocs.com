...
description: يمثل صورة واحدة بتنسيق JPEG مجموعة خبراء التصوير المشتركة مع البيانات الوصفية والأساليب الإضافية
type: docs
weight: 430
url: /ar/net/groupdocs.editor.htmlcss.resources.images.raster/jpegimage/
---
## JpegImage class
...
| اسم | وصف |
| --- | --- |
| [JpegImage](jpegimage#constructor)(string, Stream) | إنشاء نسخة JpegImage جديدة من المحتوى ، يتم تمثيلها على شكل دفق بايت ، وباسم محدد |
| [JpegImage](jpegimage#constructor_1)(string, string) | إنشاء مثيل JpegImage جديد من المحتوى ، يتم تمثيله كسلسلة مشفرة باستخدام base64 ، وباسم محدد |
...
| override [Type](../../groupdocs.editor.htmlcss.resources.images.raster/jpegimage/type) { get; } | إرجاع ImageType.Jpeg |
...
| [ReduceToNewHeight](../../groupdocs.editor.htmlcss.resources.images.raster/jpegimage/reducetonewheight#reducetonewheight)(ushort) | لإنشاء وإرجاع صورة JPEG جديدة مخفضة ، ولكن بارتفاع مخفض جديد محدد وعرض مخفض نسبيًا . (2 methods) |
...
| static [IsValid](../../groupdocs.editor.htmlcss.resources.images.raster/jpegimage/isvalid#isvalid)(Stream) | للتحقق مما إذا كان الدفق المحدد صورة JPEG صالحة |
| static [IsValid](../../groupdocs.editor.htmlcss.resources.images.raster/jpegimage/isvalid#isvalid_1)(string) | للتحقق مما إذا كانت السلسلة المحددة بترميز base64 هي صورة JPEG صالحة |
