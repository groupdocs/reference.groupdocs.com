...
| فصل | وصف |
| --- | --- |
| [Azw3SaveOptions](./azw3saveoptions) | يسمح بتحديد خيارات مخصصة لإنشاء وحفظ الكتب الإلكترونية AZW3 ، والمعروفة أيضًا باسم Kindle Format 8 (KF8) |
| [DelimitedTextEditOptions](./delimitedtexteditoptions) | خيارات لتحميل مستندات جداول البيانات المستندة إلى النص (CSV ، المستندة إلى علامة التبويب وما إلى ذلك) ، التي تستخدم فاصلًا (محددًا) |
| [DelimitedTextSaveOptions](./delimitedtextsaveoptions) | يحتوي على خيارات لإنشاء مستندات جداول بيانات نصية وحفظها (CSV أو مستند إلى علامة تبويب وما إلى ذلك) ، والتي تستخدم فاصلًا (محددًا) |
| [EbookEditOptions](./ebookeditoptions) | يسمح بتحديد الخيارات المخصصة وتعديلها لتحرير مستندات الكتاب الإلكتروني بجميع التنسيقات المدعومة: ePub و MOBI و AZW3. |
| [EmailEditOptions](./emaileditoptions) | يسمح بتحديد خيارات مخصصة لتحرير المستندات بتنسيقات البريد الإلكتروني (البريد الإلكتروني) المختلفة |
...
| [PdfSaveOptions](./pdfsaveoptions) | يسمح بتحديد خيارات مخصصة لإنشاء مستندات PDF (تنسيق المستند المحمول) وحفظها |
| [PresentationEditOptions](./presentationeditoptions) | يسمح بتحديد خيارات مخصصة لتحرير المستندات لجميع تنسيقات العروض التقديمية (المتوافقة مع PowerPoint ) |
| [PresentationLoadOptions](./presentationloadoptions) | يسمح بتحديد خيارات مخصصة لتحميل المستندات لجميع تنسيقات العروض التقديمية التي يمكن دعمها مثل PPT (X) و PPTM و PPS (X) وما إلى ذلك. |
| [PresentationSaveOptions](./presentationsaveoptions) | يسمح بتحديد خيارات مخصصة لإنشاء وحفظ مستندات العرض التقديمي (متوافق مع PowerPoint) |
| [SpreadsheetEditOptions](./spreadsheeteditoptions) | يسمح بتحديد خيارات مخصصة لتحرير المستندات لجميع تنسيقات جداول البيانات (المتوافقة مع Excel) التي يمكن دعمها |
| [SpreadsheetLoadOptions](./spreadsheetloadoptions) | يحتوي على خيارات لتحميل مستندات جداول بيانات ثنائية (خلايا ومتوافقة مع Excel) مثل XLS (X) و ODS وما إلى ذلك في محرر class |
...
| بنية | وصف |
| --- | --- |
| [PageRange](./pagerange) | يغلف نطاق صفحة واحد ، والذي يمكن أن يكون له حدود مفتوحة أو مغلقة. بشكل افتراضي ، يكون "مفتوحًا بالكامل" - يتضمن جميع الصفحات الموجودة. يبدأ ترقيم الصفحات من 1 وليس من 0. |
## واجهات
...
| [WordProcessingProtectionType](./wordprocessingprotectiontype) | يمثل جميع أنواع الحماية المتوفرة لمستند معالجة الكلمات |
| [WorksheetProtectionType](./worksheetprotectiontype) | يمثل ورقة عمل جدول البيانات (علامة التبويب) أنواع الحماية |
