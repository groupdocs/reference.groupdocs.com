...
description: Représente une image au format ICON avec ses métadonnées et des méthodes supplémentaires
type: docs
weight: 520
url: /fr/net/groupdocs.editor.htmlcss.resources.images.raster/iconimage/
---
## IconImage class

Représente une image au format ICON avec ses métadonnées et des méthodes supplémentaires
...
| Nom | La description |
| --- | --- |
| [IconImage](iconimage#constructor)(string, Stream) | Crée une nouvelle instance IconImage à partir du contenu, représenté sous forme de flux d'octets et avec le nom spécifié |
| [IconImage](iconimage#constructor_1)(string, string) | Crée une nouvelle instance IconImage à partir du contenu, représentée sous forme de chaîne encodée en base64 et avec le nom spécifié |
...
| [NumberOfImages](../../groupdocs.editor.htmlcss.resources.images.raster/iconimage/numberofimages) { get; } | Renvoie le nombre d'images présentes dans ce fichier ICON |
...
| override [Type](../../groupdocs.editor.htmlcss.resources.images.raster/iconimage/type) { get; } | Renvoie ImageType.Icon |
...
| [ReduceToNewHeight](../../groupdocs.editor.htmlcss.resources.images.raster/iconimage/reducetonewheight#reducetonewheight)(ushort) | Crée et renvoie une nouvelle image d'icône réduite, mais avec une nouvelle hauteur réduite spécifiée et une largeur proportionnellement réduite. (2 methods) |
...
| static [IsValid](../../groupdocs.editor.htmlcss.resources.images.raster/iconimage/isvalid#isvalid)(Stream) | Vérifie si le flux spécifié est une image ICON valide |
| static [IsValid](../../groupdocs.editor.htmlcss.resources.images.raster/iconimage/isvalid#isvalid_1)(string) | Vérifie si la chaîne encodée en base64 spécifiée est une image ICON valide |
