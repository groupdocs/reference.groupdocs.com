...
type: docs
weight: 510
url: /fr/net/groupdocs.editor.htmlcss.resources.images.raster/gifimage/
---
## GifImage class

Représente une image au format GIF (Graphics Interchange Format) avec ses métadonnées et méthodes supplémentaires
...
| Nom | La description |
| --- | --- |
| [GifImage](gifimage#constructor)(string, Stream) | Crée une nouvelle instance GifImage à partir du contenu, représenté sous forme de flux d'octets et avec le nom spécifié |
| [GifImage](gifimage#constructor_1)(string, string) | Crée une nouvelle instance GifImage à partir du contenu, représentée sous forme de chaîne encodée en base64 et avec le nom spécifié |
...
| override [Type](../../groupdocs.editor.htmlcss.resources.images.raster/gifimage/type) { get; } | Renvoie ImageType.Gif |
| [Version](../../groupdocs.editor.htmlcss.resources.images.raster/gifimage/version) { get; } | Renvoie la version interne de cette image GIF (la version est extraite de l'en-tête) |
...
| [ReduceToNewHeight](../../groupdocs.editor.htmlcss.resources.images.raster/gifimage/reducetonewheight#reducetonewheight)(ushort) | Crée et renvoie une nouvelle image GIF réduite, mais avec une nouvelle hauteur réduite spécifiée et une largeur proportionnellement réduite. (2 methods) |
...
| static [IsValid](../../groupdocs.editor.htmlcss.resources.images.raster/gifimage/isvalid#isvalid)(Stream) | Vérifie si le flux spécifié est une image GIF valide |
| static [IsValid](../../groupdocs.editor.htmlcss.resources.images.raster/gifimage/isvalid#isvalid_1)(string) | Vérifie si la chaîne encodée en base64 spécifiée est une image GIF valide |
