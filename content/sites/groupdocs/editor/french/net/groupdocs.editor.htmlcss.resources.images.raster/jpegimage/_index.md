...
description: Représente une image au format JPEG Joint Photographic Experts Group avec ses métadonnées et des méthodes supplémentaires
type: docs
weight: 430
url: /fr/net/groupdocs.editor.htmlcss.resources.images.raster/jpegimage/
---
## JpegImage class

Représente une image au format JPEG (Joint Photographic Experts Group) avec ses métadonnées et des méthodes supplémentaires
...
| Nom | La description |
| --- | --- |
| [JpegImage](jpegimage#constructor)(string, Stream) | Crée une nouvelle instance JpegImage à partir du contenu, représenté sous forme de flux d'octets et avec le nom spécifié |
| [JpegImage](jpegimage#constructor_1)(string, string) | Crée une nouvelle instance JpegImage à partir du contenu, représentée sous forme de chaîne encodée en base64 et avec le nom spécifié |
...
| override [Type](../../groupdocs.editor.htmlcss.resources.images.raster/jpegimage/type) { get; } | Renvoie ImageType.Jpeg |
...
| [ReduceToNewHeight](../../groupdocs.editor.htmlcss.resources.images.raster/jpegimage/reducetonewheight#reducetonewheight)(ushort) | Crée et renvoie une nouvelle image JPEG réduite, mais avec une nouvelle hauteur réduite spécifiée et une largeur proportionnellement réduite. (2 methods) |
...
| static [IsValid](../../groupdocs.editor.htmlcss.resources.images.raster/jpegimage/isvalid#isvalid)(Stream) | Vérifie si le flux spécifié est une image JPEG valide |
| static [IsValid](../../groupdocs.editor.htmlcss.resources.images.raster/jpegimage/isvalid#isvalid_1)(string) | Vérifie si la chaîne encodée en base64 spécifiée est une image JPEG valide |
