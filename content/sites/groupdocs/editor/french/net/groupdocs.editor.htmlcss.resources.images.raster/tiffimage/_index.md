...
description: Représente une image au format TIFF Tagged Image File Format avec ses métadonnées et des méthodes supplémentaires
type: docs
weight: 560
...
Représente une image au format TIFF (Tagged Image File Format) avec ses métadonnées et des méthodes supplémentaires
...
| [TiffImage](tiffimage#constructor_1)(string, string) | Crée une nouvelle instance TiffImage à partir du contenu, représentée sous forme de chaîne encodée en base64 et avec le nom spécifié |
...
| [FramesCount](../../groupdocs.editor.htmlcss.resources.images.raster/tiffimage/framescount) { get; } | Renvoie un nombre de trames (images) à l'intérieur de cette image TIFF. Ne peut pas être inférieur à 1. |
...
| override [Type](../../groupdocs.editor.htmlcss.resources.images.raster/tiffimage/type) { get; } | Renvoie ImageType.Tiff |
...
Voir https://en.wikipedia.org/wiki/TIFF pour plus de détails. Dans de très rares cas, TIFF est présent dans les documents WordProcessing.
