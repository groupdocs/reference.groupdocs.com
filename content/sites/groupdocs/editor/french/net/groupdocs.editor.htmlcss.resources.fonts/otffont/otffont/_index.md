...
description: Crée une nouvelle classe OtfFont à partir du contenu représentée sous forme de chaîne encodée en base64 et avec le nom spécifié
type: docs
weight: 10
...
Crée une nouvelle classe OtfFont à partir du contenu, représentée sous forme de chaîne encodée en base64 et avec le nom spécifié
...
| --- | --- | --- |
| name | String | Nom de la police OTF. Ne peut pas être nul, vide ou des espaces blancs. |
| contentInBase64 | String | Contenu sous forme de chaîne encodée en base64. Ne peut pas être nul, vide ou des espaces blancs. S'il ne s'agit pas d'un contenu OTF, une exception sera levée. |
