...
description: Инициализирует новый экземплярPreviewOptionsgroupdocs.parser.options/previewoptions класс вызывающий закрытие выходного потока.
type: docs
weight: 10
url: /ru/net/groupdocs.parser.options/previewoptions/previewoptions/
---
...
Инициализирует новый экземпляр[`PreviewOptions`](../../previewoptions) класс, заставляющий выходной поток возвращаться клиенту для дальнейшего использования.
