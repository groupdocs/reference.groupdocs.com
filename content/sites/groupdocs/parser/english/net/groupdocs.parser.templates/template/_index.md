...
Provides the document page template. It consists of [`TemplateItem`](../templateitem) objects which represent the items of the template such as text field and table definitions.
