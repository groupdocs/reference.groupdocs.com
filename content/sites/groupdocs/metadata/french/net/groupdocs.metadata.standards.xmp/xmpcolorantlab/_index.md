...
type: docs
weight: 3330
url: /fr/net/groupdocs.metadata.standards.xmp/xmpcolorantlab/
---
...
| Nom | La description |
| --- | --- |
| [XmpColorantLab](xmpcolorantlab#constructor)() | Initialise une nouvelle instance du[`XmpColorantLab`](../xmpcolorantlab) classe. |
| [XmpColorantLab](xmpcolorantlab#constructor_1)(sbyte, sbyte, double) | Initialise une nouvelle instance du[`XmpColorantLab`](../xmpcolorantlab) classe. |

## Propriétés

| Nom | La description |
| --- | --- |
| [A](../../groupdocs.metadata.standards.xmp/xmpcolorantlab/a) { get; set; } | Obtient ou définit le composant A. |
| [B](../../groupdocs.metadata.standards.xmp/xmpcolorantlab/b) { get; set; } | Obtient ou définit le composant B. |
...
| [L](../../groupdocs.metadata.standards.xmp/xmpcolorantlab/l) { get; set; } | Obtient ou définit le composant L. |
...
| Nom | La description |
| --- | --- |
| const [MaxL](../../groupdocs.metadata.standards.xmp/xmpcolorantlab/maxl) | Valeur maximale du composant L. |
| const [MinL](../../groupdocs.metadata.standards.xmp/xmpcolorantlab/minl) | Valeur min du composant L. |
