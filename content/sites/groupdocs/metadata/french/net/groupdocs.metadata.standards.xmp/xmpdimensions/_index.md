...
type: docs
weight: 3380
url: /fr/net/groupdocs.metadata.standards.xmp/xmpdimensions/
---
## XmpDimensions class
...
| Nom | La description |
| --- | --- |
| [XmpDimensions](xmpdimensions#constructor)() | Initialise une nouvelle instance du[`XmpDimensions`](../xmpdimensions) classe. |
| [XmpDimensions](xmpdimensions#constructor_1)(double, double) | Initialise une nouvelle instance du[`XmpDimensions`](../xmpdimensions) classe. |
...
| [Height](../../groupdocs.metadata.standards.xmp/xmpdimensions/height) { get; set; } | Obtient ou définit la hauteur. |
...
| [Units](../../groupdocs.metadata.standards.xmp/xmpdimensions/units) { get; set; } | Obtient ou définit les unités. |
| [Width](../../groupdocs.metadata.standards.xmp/xmpdimensions/width) { get; set; } | Obtient ou définit la largeur. |
