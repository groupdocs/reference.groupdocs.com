...
description: Fournit une classe de base abstraite pour les packages de métadonnées MakerNote.
type: docs
weight: 2830
url: /fr/net/groupdocs.metadata.standards.exif.makernote/makernotepackage/
---
## MakerNotePackage class

Fournit une classe de base abstraite pour les packages de métadonnées MakerNote.
