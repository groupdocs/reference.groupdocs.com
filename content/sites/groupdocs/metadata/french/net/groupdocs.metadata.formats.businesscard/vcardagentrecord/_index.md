...
description: Représente la classe de métadonnées denregistrement de lagent vCard.
type: docs
weight: 610
url: /fr/net/groupdocs.metadata.formats.businesscard/vcardagentrecord/
---
## VCardAgentRecord class

Représente la classe de métadonnées d'enregistrement de l'agent vCard.
...
| override [ContentType](../../groupdocs.metadata.formats.businesscard/vcardagentrecord/contenttype) { get; } | Obtient le type de contenu de l'enregistrement. |
...
| [Value](../../groupdocs.metadata.formats.businesscard/vcardagentrecord/value) { get; } | Obtient la valeur d'enregistrement. |
