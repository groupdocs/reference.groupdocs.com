...
description: Représente la classe de métadonnées VCard de base.
type: docs
weight: 620
url: /fr/net/groupdocs.metadata.formats.businesscard/vcardbasepackage/
---
## VCardBasePackage class

Représente la classe de métadonnées VCard de base.
