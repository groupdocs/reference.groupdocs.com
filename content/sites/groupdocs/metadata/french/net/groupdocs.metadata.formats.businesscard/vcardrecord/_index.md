...
description: Représente la classe abstraite de métadonnées denregistrement vCard.
type: docs
weight: 770
url: /fr/net/groupdocs.metadata.formats.businesscard/vcardrecord/
---
## VCardRecord class

Représente la classe abstraite de métadonnées d'enregistrement vCard.
...
| abstract [ContentType](../../groupdocs.metadata.formats.businesscard/vcardrecord/contenttype) { get; } | Obtient le type de contenu de l'enregistrement. |
