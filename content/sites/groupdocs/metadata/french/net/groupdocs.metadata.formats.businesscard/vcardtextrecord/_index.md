...
description: Représente la classe de métadonnées denregistrement de texte vCard.
type: docs
weight: 810
url: /fr/net/groupdocs.metadata.formats.businesscard/vcardtextrecord/
---
## VCardTextRecord class

Représente la classe de métadonnées d'enregistrement de texte vCard.
...
| [CharsetParameter](../../groupdocs.metadata.formats.businesscard/vcardtextrecord/charsetparameter) { get; } | Obtient le paramètre de jeu de caractères. |
| override [ContentType](../../groupdocs.metadata.formats.businesscard/vcardtextrecord/contenttype) { get; } | Obtient le type de contenu de l'enregistrement. |
...
| [IsQuotedPrintable](../../groupdocs.metadata.formats.businesscard/vcardtextrecord/isquotedprintable) { get; } | Obtient une valeur indiquant si cette instance est une chaîne imprimable entre guillemets. |
...
| [MediaTypeParameter](../../groupdocs.metadata.formats.businesscard/vcardtextrecord/mediatypeparameter) { get; } | Obtient la valeur du paramètre de type de média. |
...
| [Value](../../groupdocs.metadata.formats.businesscard/vcardtextrecord/value) { get; } | Obtient la valeur d'enregistrement. |
...
| [GetReadabilityValue](../../groupdocs.metadata.formats.businesscard/vcardtextrecord/getreadabilityvalue)(string) | Obtient la valeur de lisibilité. |
