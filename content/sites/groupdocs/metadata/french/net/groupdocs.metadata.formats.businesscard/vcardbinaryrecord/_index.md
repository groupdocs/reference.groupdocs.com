...
description: Représente la classe de métadonnées denregistrement binaire vCard.
type: docs
weight: 630
url: /fr/net/groupdocs.metadata.formats.businesscard/vcardbinaryrecord/
---
## VCardBinaryRecord class

Représente la classe de métadonnées d'enregistrement binaire vCard.
...
| override [ContentType](../../groupdocs.metadata.formats.businesscard/vcardbinaryrecord/contenttype) { get; } | Obtient le type de contenu de l'enregistrement. |
...
| [Value](../../groupdocs.metadata.formats.businesscard/vcardbinaryrecord/value) { get; } | Obtient la valeur d'enregistrement. |
