...
description: Représente la classe de métadonnées denregistrement de date et dheure vCard.
type: docs
weight: 690
url: /fr/net/groupdocs.metadata.formats.businesscard/vcarddatetimerecord/
---
## VCardDateTimeRecord class

Représente la classe de métadonnées d'enregistrement de date et d'heure vCard.
...
| override [ContentType](../../groupdocs.metadata.formats.businesscard/vcarddatetimerecord/contenttype) { get; } | Obtient le type de contenu de l'enregistrement. |
...
| [Value](../../groupdocs.metadata.formats.businesscard/vcarddatetimerecord/value) { get; } | Obtient la valeur d'enregistrement. |
