...
description: Représente le package racine permettant de travailler avec des métadonnées dans un dessin DWG.
type: docs
weight: 860
url: /fr/net/groupdocs.metadata.formats.cad/dwgrootpackage/
---
## DwgRootPackage class

Représente le package racine permettant de travailler avec des métadonnées dans un dessin DWG.
