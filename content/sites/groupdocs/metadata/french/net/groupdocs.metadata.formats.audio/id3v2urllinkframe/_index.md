...
description: Représente un cadre de lien URL dans unID3V2Tag./id3v2tag Le nom du cadre commence toujours par le caractère W.
type: docs
weight: 530
url: /fr/net/groupdocs.metadata.formats.audio/id3v2urllinkframe/
---
## ID3V2UrlLinkFrame class

Représente un cadre de lien URL dans un[`ID3V2Tag`](../id3v2tag) Le nom du cadre commence toujours par le caractère W.
...
| Nom | La description |
| --- | --- |
| [ID3V2UrlLinkFrame](id3v2urllinkframe)(string, string) | Initialise une nouvelle instance du[`ID3V2UrlLinkFrame`](../id3v2urllinkframe) classe. |
...
| [Url](../../groupdocs.metadata.formats.audio/id3v2urllinkframe/url) { get; } | Obtient la valeur de l'URL. |
