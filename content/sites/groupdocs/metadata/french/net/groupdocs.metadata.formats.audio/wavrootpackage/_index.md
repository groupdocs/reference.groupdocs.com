...
description: Représente le package racine permettant de travailler avec des métadonnées dans un fichier audio WAV.
type: docs
weight: 600
url: /fr/net/groupdocs.metadata.formats.audio/wavrootpackage/
---
## WavRootPackage class

Représente le package racine permettant de travailler avec des métadonnées dans un fichier audio WAV.
...
| [RiffInfoPackage](../../groupdocs.metadata.formats.audio/wavrootpackage/riffinfopackage) { get; } | Obtient le package contenant les balises RIFF Info. |
| [WavPackage](../../groupdocs.metadata.formats.audio/wavrootpackage/wavpackage) { get; } | Obtient le package de métadonnées natives WAV. |
| [XmpPackage](../../groupdocs.metadata.formats.audio/wavrootpackage/xmppackage) { get; set; } | Obtient ou définit le package de métadonnées XMP. |
