...
description: Représente une trame PCNT dans unID3V2Tag./id3v2tag . Il sagit simplement dun compteur du nombre de fois quun fichier a été lu.
type: docs
weight: 470
url: /fr/net/groupdocs.metadata.formats.audio/id3v2playcounterframe/
---
## ID3V2PlayCounterFrame class

Représente une trame PCNT dans un[`ID3V2Tag`](../id3v2tag) . Il s'agit simplement d'un compteur du nombre de fois qu'un fichier a été lu.
...
| [Value](../../groupdocs.metadata.formats.audio/id3v2playcounterframe/value) { get; } | Obtient le nombre de fois que le fichier a été lu. |
