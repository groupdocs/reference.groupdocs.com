...
description: Représente le package racine permettant de travailler avec des métadonnées dans un message électronique EML.
type: docs
weight: 1390
url: /fr/net/groupdocs.metadata.formats.email/emlrootpackage/
---
## EmlRootPackage class

Représente le package racine permettant de travailler avec des métadonnées dans un message électronique EML.
...
| [EmailPackage](../../groupdocs.metadata.formats.email/emlrootpackage/emailpackage) { get; } | Obtient le package de métadonnées EML. (2 properties) |
...
Cet exemple de code montre comment extraire les métadonnées d'un message EML.
