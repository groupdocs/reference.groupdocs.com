...
description: Représente le package racine permettant de travailler avec des métadonnées dans un message électronique.
type: docs
weight: 1370
url: /fr/net/groupdocs.metadata.formats.email/emailrootpackage/
---
## EmailRootPackage class

Représente le package racine permettant de travailler avec des métadonnées dans un message électronique.
...
| [EmailPackage](../../groupdocs.metadata.formats.email/emailrootpackage/emailpackage) { get; } | Obtient le package de métadonnées d'e-mail. |
