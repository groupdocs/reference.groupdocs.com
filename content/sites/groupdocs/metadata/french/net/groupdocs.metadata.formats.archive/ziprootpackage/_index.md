...
description: Représente le package racine permettant de travailler avec des métadonnées dans une archive ZIP.
type: docs
weight: 370
url: /fr/net/groupdocs.metadata.formats.archive/ziprootpackage/
---
## ZipRootPackage class

Représente le package racine permettant de travailler avec des métadonnées dans une archive ZIP.
...
| [ZipPackage](../../groupdocs.metadata.formats.archive/ziprootpackage/zippackage) { get; } | Obtient le package de métadonnées ZIP. |
