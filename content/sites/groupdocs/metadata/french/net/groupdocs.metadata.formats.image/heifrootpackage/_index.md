...
description: Représente le package racine destiné à fonctionner avec les métadonnées dans une image HEIF.
type: docs
weight: 1730
url: /fr/net/groupdocs.metadata.formats.image/heifrootpackage/
---
## HeifRootPackage class

Représente le package racine destiné à fonctionner avec les métadonnées dans une image HEIF.
...
| [ExifPackage](../../groupdocs.metadata.formats.image/heifrootpackage/exifpackage) { get; set; } | Obtient ou définit le package de métadonnées EXIF. |
...
| [XmpPackage](../../groupdocs.metadata.formats.image/heifrootpackage/xmppackage) { get; set; } | Obtient ou définit le package de métadonnées XMP. |
