...
description: Représente des données textuelles compressées extraites dune image PNG.
type: docs
weight: 1820
url: /fr/net/groupdocs.metadata.formats.image/pngcompressedtextchunk/
---
## PngCompressedTextChunk class

Représente des données textuelles compressées extraites d'une image PNG.
