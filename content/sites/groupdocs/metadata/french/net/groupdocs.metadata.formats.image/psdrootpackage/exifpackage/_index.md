...
type: docs
weight: 10
url: /fr/net/groupdocs.metadata.formats.image/psdrootpackage/exifpackage/
---
...
Cet exemple de code montre comment extraire les propriétés de métadonnées EXIF de base d'une image PSD.
