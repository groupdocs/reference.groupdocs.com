...
description: Représente le package racine destiné à fonctionner avec les métadonnées dans une image EMF.
type: docs
weight: 1700
url: /fr/net/groupdocs.metadata.formats.image/emfrootpackage/
---
## EmfRootPackage class

Représente le package racine destiné à fonctionner avec les métadonnées dans une image EMF.
