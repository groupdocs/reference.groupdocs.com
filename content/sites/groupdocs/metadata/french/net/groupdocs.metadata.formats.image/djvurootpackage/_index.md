...
description: Représente le package racine destiné à fonctionner avec les métadonnées dans une image DjVu.
type: docs
weight: 1690
url: /fr/net/groupdocs.metadata.formats.image/djvurootpackage/
---
## DjVuRootPackage class

Représente le package racine destiné à fonctionner avec les métadonnées dans une image DjVu.
