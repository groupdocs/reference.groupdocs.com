...
description: Fournit une classe abstraite de base pour tous les packages racine dimage.
type: docs
weight: 1770
url: /fr/net/groupdocs.metadata.formats.image/imagerootpackage/
---
## ImageRootPackage class

Fournit une classe abstraite de base pour tous les packages racine d'image.
