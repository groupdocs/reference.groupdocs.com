...
description: Représente le package racine permettant de travailler avec des métadonnées dans une image WEBP.
type: docs
weight: 2130
url: /fr/net/groupdocs.metadata.formats.image/webprootpackage/
---
## WebPRootPackage class

Représente le package racine permettant de travailler avec des métadonnées dans une image WEBP.
...
| [ExifPackage](../../groupdocs.metadata.formats.image/webprootpackage/exifpackage) { get; set; } | Obtient ou définit le package de métadonnées EXIF. |
...
| [XmpPackage](../../groupdocs.metadata.formats.image/webprootpackage/xmppackage) { get; set; } | Obtient ou définit le package de métadonnées XMP. |
