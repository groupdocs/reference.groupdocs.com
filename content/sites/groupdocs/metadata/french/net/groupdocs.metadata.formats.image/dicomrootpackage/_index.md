...
description: Représente le package racine destiné à fonctionner avec les métadonnées dans une image DICOM.
type: docs
weight: 1680
url: /fr/net/groupdocs.metadata.formats.image/dicomrootpackage/
---
## DicomRootPackage class

Représente le package racine destiné à fonctionner avec les métadonnées dans une image DICOM.
...
| [DicomPackage](../../groupdocs.metadata.formats.image/dicomrootpackage/dicompackage) { get; } | Obtient le package de métadonnées natives DICOM. |
...
Cet exemple montre comment lire les propriétés de métadonnées spécifiques au format DICOM.
