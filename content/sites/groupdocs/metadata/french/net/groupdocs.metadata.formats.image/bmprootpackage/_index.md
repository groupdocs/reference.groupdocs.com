...
description: Représente le package racine destiné à fonctionner avec les métadonnées dans une image BMP.
type: docs
weight: 1660
url: /fr/net/groupdocs.metadata.formats.image/bmprootpackage/
---
## BmpRootPackage class

Représente le package racine destiné à fonctionner avec les métadonnées dans une image BMP.
...
| Nom | La description |
| --- | --- |
| [BmpHeader](../../groupdocs.metadata.formats.image/bmprootpackage/bmpheader) { get; } | Obtient le package de métadonnées d'en-tête BMP. |
...
Cet exemple de code montre comment lire l'en-tête d'un fichier BMP.
