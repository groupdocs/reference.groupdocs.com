...
description: Représente un package de métadonnées contenant des informations de format de fichier spécifiques à limage.
type: docs
weight: 1780
url: /fr/net/groupdocs.metadata.formats.image/imagetypepackage/
---
## ImageTypePackage class

Représente un package de métadonnées contenant des informations de format de fichier spécifiques à l'image.
