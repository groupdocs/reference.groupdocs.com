...
description: Représente le package racine destiné à fonctionner avec les métadonnées dans une image WMF.
type: docs
weight: 2140
url: /fr/net/groupdocs.metadata.formats.image/wmfrootpackage/
---
## WmfRootPackage class

Représente le package racine destiné à fonctionner avec les métadonnées dans une image WMF.
