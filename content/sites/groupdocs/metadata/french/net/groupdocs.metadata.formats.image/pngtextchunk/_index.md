...
description: Représente des données textuelles extraites dune image PNG.
type: docs
weight: 1870
url: /fr/net/groupdocs.metadata.formats.image/pngtextchunk/
---
## PngTextChunk class

Représente des données textuelles extraites d'une image PNG.
