...
description: Représente les métadonnées audio dans une vidéo Matroska.
type: docs
weight: 2430
url: /fr/net/groupdocs.metadata.formats.video/matroskaaudiotrack/
---
## MatroskaAudioTrack class

Représente les métadonnées audio dans une vidéo Matroska.
...
| Nom | La description |
| --- | --- |
| [BitDepth](../../groupdocs.metadata.formats.video/matroskaaudiotrack/bitdepth) { get; } | Obtient les bits par échantillon, principalement utilisés pour PCM. |
| [Channels](../../groupdocs.metadata.formats.video/matroskaaudiotrack/channels) { get; } | Obtient le nombre de canaux dans la piste. |
...
| [OutputSamplingFrequency](../../groupdocs.metadata.formats.video/matroskaaudiotrack/outputsamplingfrequency) { get; } | Obtient la fréquence d'échantillonnage de sortie réelle en Hz (utilisée pour les techniques SBR). |
| [PropertyDescriptors](../../groupdocs.metadata.common/metadatapackage/propertydescriptors) { get; } | Obtient une collection de descripteurs contenant des informations sur les propriétés accessibles via le moteur de recherche GroupDocs.Metadata. |
| [SamplingFrequency](../../groupdocs.metadata.formats.video/matroskaaudiotrack/samplingfrequency) { get; } | Obtient la fréquence d'échantillonnage en Hz. |
