...
description: Représente les métadonnées QuickTime.
type: docs
weight: 2630
url: /fr/net/groupdocs.metadata.formats.video/movpackage/
---
## MovPackage class

Représente les métadonnées QuickTime.
...
| Nom | La description |
| --- | --- |
| [Atoms](../../groupdocs.metadata.formats.video/movpackage/atoms) { get; } | Obtient un tableau de[`MovAtom`](../movatom) atomes. |
