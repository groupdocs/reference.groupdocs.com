...
description: Représente les métadonnées de propriété de flux vidéo dans le conteneur multimédia ASF.
type: docs
weight: 2370
url: /fr/net/groupdocs.metadata.formats.video/asfvideostreamproperty/
---
## AsfVideoStreamProperty class

Représente les métadonnées de propriété de flux vidéo dans le conteneur multimédia ASF.
...
| [BitsPerPixels](../../groupdocs.metadata.formats.video/asfvideostreamproperty/bitsperpixels) { get; } | Obtient les bits par pixels. |
| [Compression](../../groupdocs.metadata.formats.video/asfvideostreamproperty/compression) { get; } | Obtient l'ID de compression vidéo. |
...
| [ImageHeight](../../groupdocs.metadata.formats.video/asfvideostreamproperty/imageheight) { get; } | Obtient la hauteur de l'image encodée en pixels. |
| [ImageWidth](../../groupdocs.metadata.formats.video/asfvideostreamproperty/imagewidth) { get; } | Obtient la largeur de l'image encodée en pixels. |
