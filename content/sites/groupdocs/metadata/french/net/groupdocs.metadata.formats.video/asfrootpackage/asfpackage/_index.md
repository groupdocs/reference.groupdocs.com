...
description: Obtient le package de métadonnées ASF.
type: docs
weight: 10
url: /fr/net/groupdocs.metadata.formats.video/asfrootpackage/asfpackage/
---
## AsfRootPackage.AsfPackage property

Obtient le package de métadonnées ASF.
...
Cet exemple de code montre comment lire les métadonnées ASF natives.
...
using (Metadata metadata = new Metadata(Constants.InputAsf))
{
    ...
    // Affiche les propriétés de base
    ...
    // Afficher les informations du codec Asf
    ...
    // Affiche les descripteurs de métadonnées
    ...
    //Affiche les propriétés du flux de base
    foreach (AsfBaseStreamProperty property in package.StreamProperties)
    {
        ...
        //Affiche les propriétés du flux audio
        ...
        //Affiche les propriétés du flux vidéo
