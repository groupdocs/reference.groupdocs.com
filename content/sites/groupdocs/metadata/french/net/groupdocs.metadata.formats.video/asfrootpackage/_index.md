...
description: Représente le package racine permettant de travailler avec des métadonnées dans une vidéo ASF.
type: docs
weight: 2350
url: /fr/net/groupdocs.metadata.formats.video/asfrootpackage/
---
## AsfRootPackage class

Représente le package racine permettant de travailler avec des métadonnées dans une vidéo ASF.
...
| Nom | La description |
| --- | --- |
| [AsfPackage](../../groupdocs.metadata.formats.video/asfrootpackage/asfpackage) { get; } | Obtient le package de métadonnées ASF. |
...
| [XmpPackage](../../groupdocs.metadata.formats.video/asfrootpackage/xmppackage) { get; set; } | Obtient ou définit le package de métadonnées XMP. |
