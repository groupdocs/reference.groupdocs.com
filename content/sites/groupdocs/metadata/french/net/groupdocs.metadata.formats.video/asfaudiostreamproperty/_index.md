...
description: Représente les métadonnées de propriété de flux audio dans le conteneur multimédia ASF.
type: docs
weight: 2230
url: /fr/net/groupdocs.metadata.formats.video/asfaudiostreamproperty/
---
## AsfAudioStreamProperty class

Représente les métadonnées de propriété de flux audio dans le conteneur multimédia ASF.
...
| [BitsPerSample](../../groupdocs.metadata.formats.video/asfaudiostreamproperty/bitspersample) { get; } | Obtient le nombre de bits par échantillon de données monaurales. |
| [Channels](../../groupdocs.metadata.formats.video/asfaudiostreamproperty/channels) { get; } | Obtient le nombre de canaux audio. |
...
| [FormatTag](../../groupdocs.metadata.formats.video/asfaudiostreamproperty/formattag) { get; } | Obtient l'identifiant unique du codec utilisé pour encoder les données audio. |
...
| [SamplesPerSecond](../../groupdocs.metadata.formats.video/asfaudiostreamproperty/samplespersecond) { get; } | Obtient une valeur en Hertz (cycles par seconde) qui représente le taux d'échantillonnage du flux audio. |
