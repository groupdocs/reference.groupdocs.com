...
description: Représente un point dentrée vers tous les packages de métadonnées présentés dans un fichier particulier.
type: docs
weight: 240
url: /fr/net/groupdocs.metadata.common/rootmetadatapackage/
---
## RootMetadataPackage class

Représente un point d'entrée vers tous les packages de métadonnées présentés dans un fichier particulier.
