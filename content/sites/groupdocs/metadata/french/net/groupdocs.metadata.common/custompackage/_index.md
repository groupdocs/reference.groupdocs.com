...
description: Fournit un conteneur pour les propriétés de métadonnées.
type: docs
weight: 20
url: /fr/net/groupdocs.metadata.common/custompackage/
---
## CustomPackage class

Fournit un conteneur pour les propriétés de métadonnées.
