...
description: Représente le package racine destiné à fonctionner avec des métadonnées dans un format de gestion de projet.
type: docs
weight: 1140
url: /fr/net/groupdocs.metadata.formats.document/projectmanagementrootpackage/
---
## ProjectManagementRootPackage class

Représente le package racine destiné à fonctionner avec des métadonnées dans un format de gestion de projet.
...
Cet exemple de code montre comment extraire les propriétés intégrées d'un document ProjectManagement.
