...
description: Représente les métadonnées natives dans un document bureautique.
type: docs
weight: 920
url: /fr/net/groupdocs.metadata.formats.document/documentpackage/
---
## DocumentPackage class

Représente les métadonnées natives dans un document bureautique.
