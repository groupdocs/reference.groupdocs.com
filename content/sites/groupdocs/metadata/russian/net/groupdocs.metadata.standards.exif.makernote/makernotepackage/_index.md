...
description: Предоставляет абстрактный базовый класс для пакетов метаданных MakerNote.
type: docs
weight: 2830
url: /ru/net/groupdocs.metadata.standards.exif.makernote/makernotepackage/
---
## MakerNotePackage class

Предоставляет абстрактный базовый класс для пакетов метаданных MakerNote.
