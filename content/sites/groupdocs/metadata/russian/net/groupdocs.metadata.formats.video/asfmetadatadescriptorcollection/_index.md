...
description: Представляет набор дескрипторов метаданных.
type: docs
weight: 2330
url: /ru/net/groupdocs.metadata.formats.video/asfmetadatadescriptorcollection/
---
## AsfMetadataDescriptorCollection class

Представляет набор дескрипторов метаданных.
