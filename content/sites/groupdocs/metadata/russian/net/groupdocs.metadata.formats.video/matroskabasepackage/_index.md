...
description: Предоставляет базовый класс метаданных для всех пакетов извлеченных из видео Matroska.
type: docs
weight: 2440
url: /ru/net/groupdocs.metadata.formats.video/matroskabasepackage/
---
## MatroskaBasePackage class

Предоставляет базовый класс метаданных для всех пакетов, извлеченных из видео Matroska.
