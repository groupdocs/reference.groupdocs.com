...
description: Представляет метаданные свойств базового потока в медиаконтейнере ASF.
type: docs
weight: 2250
url: /ru/net/groupdocs.metadata.formats.video/asfbasestreamproperty/
---
## AsfBaseStreamProperty class

Представляет метаданные свойств базового потока в медиаконтейнере ASF.
