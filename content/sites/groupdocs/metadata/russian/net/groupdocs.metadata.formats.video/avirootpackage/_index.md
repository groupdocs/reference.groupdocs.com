...
description: Представляет корневой пакет позволяющий работать с метаданными в видео AVI.
type: docs
weight: 2400
url: /ru/net/groupdocs.metadata.formats.video/avirootpackage/
---
## AviRootPackage class

Представляет корневой пакет, позволяющий работать с метаданными в видео AVI.
...
| [Header](../../groupdocs.metadata.formats.video/avirootpackage/header) { get; } | Получает пакет заголовков AVI. |
| [Item](../../groupdocs.metadata.common/metadatapackage/item) { get; } | Получает[`MetadataProperty`](../../groupdocs.metadata.common/metadataproperty) с указанным именем. |
| [Keys](../../groupdocs.metadata.common/metadatapackage/keys) { get; } | Получает коллекцию имен свойств метаданных. |
| [MetadataType](../../groupdocs.metadata.common/metadatapackage/metadatatype) { get; } | Получает тип метаданных. |
| [PropertyDescriptors](../../groupdocs.metadata.common/metadatapackage/propertydescriptors) { get; } | Получает набор дескрипторов, содержащих информацию о свойствах, доступных через поисковую систему GroupDocs.Metadata. |
| [RiffInfoPackage](../../groupdocs.metadata.formats.video/avirootpackage/riffinfopackage) { get; } | Получает пакет, содержащий теги RIFF Info. |
| [XmpPackage](../../groupdocs.metadata.formats.video/avirootpackage/xmppackage) { get; set; } | Получает или задает пакет метаданных XMP. |
