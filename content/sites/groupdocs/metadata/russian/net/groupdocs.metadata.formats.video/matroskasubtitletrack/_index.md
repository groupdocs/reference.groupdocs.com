...
description: Представляет метаданные субтитров в видео Matroska.
type: docs
weight: 2520
url: /ru/net/groupdocs.metadata.formats.video/matroskasubtitletrack/
---
## MatroskaSubtitleTrack class

Представляет метаданные субтитров в видео Matroska.
...
| [Subtitles](../../groupdocs.metadata.formats.video/matroskasubtitletrack/subtitles) { get; } | Получает субтитры. |
