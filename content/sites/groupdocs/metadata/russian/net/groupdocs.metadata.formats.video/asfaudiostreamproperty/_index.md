...
description: Представляет метаданные свойства аудиопотока в медиаконтейнере ASF.
type: docs
weight: 2230
url: /ru/net/groupdocs.metadata.formats.video/asfaudiostreamproperty/
---
## AsfAudioStreamProperty class

Представляет метаданные свойства аудиопотока в медиаконтейнере ASF.
...
| [BitsPerSample](../../groupdocs.metadata.formats.video/asfaudiostreamproperty/bitspersample) { get; } | Получает количество битов на выборку монофонических данных. |
| [Channels](../../groupdocs.metadata.formats.video/asfaudiostreamproperty/channels) { get; } | Получает количество аудиоканалов. |
...
| [FormatTag](../../groupdocs.metadata.formats.video/asfaudiostreamproperty/formattag) { get; } | Получает уникальный идентификатор кодека, используемого для кодирования аудиоданных. |
...
| [SamplesPerSecond](../../groupdocs.metadata.formats.video/asfaudiostreamproperty/samplespersecond) { get; } | Получает значение в герцах (количество циклов в секунду), представляющее частоту дискретизации аудиопотока. |
