...
description: Представляет общую информацию о цели в видео Matroska.
type: docs
weight: 2500
url: /ru/net/groupdocs.metadata.formats.video/matroskasimpletag/
---
## MatroskaSimpleTag class

Представляет общую информацию о цели в видео Matroska.
