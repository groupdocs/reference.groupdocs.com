...
description: Представляет набор пользовательских свойств метаданных САПР.
type: docs
weight: 830
url: /ru/net/groupdocs.metadata.formats.cad/cadcustompropertypackage/
---
## CadCustomPropertyPackage class

Представляет набор пользовательских свойств метаданных САПР.
