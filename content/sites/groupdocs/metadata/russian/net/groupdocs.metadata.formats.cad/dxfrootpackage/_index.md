...
description: Представляет корневой пакет позволяющий работать с метаданными в чертеже DXF.
type: docs
weight: 870
url: /ru/net/groupdocs.metadata.formats.cad/dxfrootpackage/
---
## DxfRootPackage class

Представляет корневой пакет, позволяющий работать с метаданными в чертеже DXF.
