...
description: Представляет базовую абстракцию для пакета метаданных.
type: docs
weight: 120
url: /ru/net/groupdocs.metadata.common/metadatapackage/
---
## MetadataPackage class

Представляет базовую абстракцию для пакета метаданных.
