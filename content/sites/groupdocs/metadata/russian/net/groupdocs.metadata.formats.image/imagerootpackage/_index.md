...
description: Предоставляет базовый абстрактный класс для всех корневых пакетов образов.
type: docs
weight: 1770
url: /ru/net/groupdocs.metadata.formats.image/imagerootpackage/
---
## ImageRootPackage class

Предоставляет базовый абстрактный класс для всех корневых пакетов образов.
