...
description: Представляет корневой пакет предназначенный для работы с метаданными в изображении BMP.
type: docs
weight: 1660
url: /ru/net/groupdocs.metadata.formats.image/bmprootpackage/
---
## BmpRootPackage class

Представляет корневой пакет, предназначенный для работы с метаданными в изображении BMP.
...
| Имя | Описание |
| --- | --- |
| [BmpHeader](../../groupdocs.metadata.formats.image/bmprootpackage/bmpheader) { get; } | Получает пакет метаданных заголовка BMP. |
...
В этом примере кода показано, как прочитать заголовок файла BMP.
