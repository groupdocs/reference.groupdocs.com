...
description: Представляет корневой пакет предназначенный для работы с метаданными в образе EMF.
type: docs
weight: 1700
url: /ru/net/groupdocs.metadata.formats.image/emfrootpackage/
---
## EmfRootPackage class

Представляет корневой пакет, предназначенный для работы с метаданными в образе EMF.
