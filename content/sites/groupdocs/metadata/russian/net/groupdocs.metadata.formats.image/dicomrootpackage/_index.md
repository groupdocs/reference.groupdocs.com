...
description: Представляет корневой пакет предназначенный для работы с метаданными в изображении DICOM.
type: docs
weight: 1680
url: /ru/net/groupdocs.metadata.formats.image/dicomrootpackage/
---
## DicomRootPackage class

Представляет корневой пакет, предназначенный для работы с метаданными в изображении DICOM.
...
| [DicomPackage](../../groupdocs.metadata.formats.image/dicomrootpackage/dicompackage) { get; } | Получает собственный пакет метаданных DICOM. |
...
В этом примере показано, как считывать свойства метаданных формата DICOM.
