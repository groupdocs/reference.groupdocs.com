...
description: Представляет текстовые данные извлеченные из изображения PNG.
type: docs
weight: 1870
url: /ru/net/groupdocs.metadata.formats.image/pngtextchunk/
---
## PngTextChunk class

Представляет текстовые данные, извлеченные из изображения PNG.
