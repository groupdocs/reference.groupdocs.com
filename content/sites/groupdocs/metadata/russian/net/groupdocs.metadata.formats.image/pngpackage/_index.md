...
description: Представляет исходные метаданные PNG.
type: docs
weight: 1850
url: /ru/net/groupdocs.metadata.formats.image/pngpackage/
---
## PngPackage class

Представляет исходные метаданные PNG.
...
| [TextChunks](../../groupdocs.metadata.formats.image/pngpackage/textchunks) { get; } | Получает коллекцию фрагментов текста, извлеченных из изображения. |
