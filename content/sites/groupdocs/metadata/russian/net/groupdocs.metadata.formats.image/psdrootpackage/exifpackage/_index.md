...
type: docs
weight: 10
url: /ru/net/groupdocs.metadata.formats.image/psdrootpackage/exifpackage/
---
...
В этом примере кода показано, как извлечь основные свойства метаданных EXIF из изображения PSD.
