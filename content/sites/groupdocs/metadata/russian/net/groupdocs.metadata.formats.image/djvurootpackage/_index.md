...
description: Представляет корневой пакет предназначенный для работы с метаданными в образе DjVu.
type: docs
weight: 1690
url: /ru/net/groupdocs.metadata.formats.image/djvurootpackage/
---
## DjVuRootPackage class

Представляет корневой пакет, предназначенный для работы с метаданными в образе DjVu.
