...
description: Представляет сжатые текстовые данные извлеченные из изображения PNG.
type: docs
weight: 1820
url: /ru/net/groupdocs.metadata.formats.image/pngcompressedtextchunk/
---
## PngCompressedTextChunk class

Представляет сжатые текстовые данные, извлеченные из изображения PNG.
