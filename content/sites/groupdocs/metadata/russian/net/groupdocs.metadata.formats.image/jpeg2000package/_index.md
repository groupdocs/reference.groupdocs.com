...
description: Представляет исходные метаданные JPEG2000.
type: docs
weight: 1790
url: /ru/net/groupdocs.metadata.formats.image/jpeg2000package/
---
## Jpeg2000Package class

Представляет исходные метаданные JPEG2000.
...
| Имя | Описание |
| --- | --- |
| [Comments](../../groupdocs.metadata.formats.image/jpeg2000package/comments) { get; } | Получает комментарии JPEG2000. |
