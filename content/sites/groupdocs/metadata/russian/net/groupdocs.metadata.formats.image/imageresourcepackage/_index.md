...
description: Представляет пакет метаданных содержащий ресурсы изображений Photoshop.
type: docs
weight: 1760
url: /ru/net/groupdocs.metadata.formats.image/imageresourcepackage/
---
## ImageResourcePackage class

Представляет пакет метаданных, содержащий ресурсы изображений Photoshop.
...
| [ToList](../../groupdocs.metadata.formats.image/imageresourcepackage/tolist)() | Создает список из пакета. |
