...
description: Представляет корневой пакет позволяющий работать с метаданными в изображении WEBP.
type: docs
weight: 2130
url: /ru/net/groupdocs.metadata.formats.image/webprootpackage/
---
## WebPRootPackage class

Представляет корневой пакет, позволяющий работать с метаданными в изображении WEBP.
...
| [ExifPackage](../../groupdocs.metadata.formats.image/webprootpackage/exifpackage) { get; set; } | Получает или задает пакет метаданных EXIF. |
...
| [XmpPackage](../../groupdocs.metadata.formats.image/webprootpackage/xmppackage) { get; set; } | Получает или задает пакет метаданных XMP. |
