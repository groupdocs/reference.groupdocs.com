...
type: docs
weight: 3380
url: /ru/net/groupdocs.metadata.standards.xmp/xmpdimensions/
---
## XmpDimensions class
...
| Имя | Описание |
| --- | --- |
| [XmpDimensions](xmpdimensions#constructor)() | Инициализирует новый экземпляр[`XmpDimensions`](../xmpdimensions) класс. |
| [XmpDimensions](xmpdimensions#constructor_1)(double, double) | Инициализирует новый экземпляр[`XmpDimensions`](../xmpdimensions) класс. |
...
| [Height](../../groupdocs.metadata.standards.xmp/xmpdimensions/height) { get; set; } | Получает или задает высоту. |
...
| [Units](../../groupdocs.metadata.standards.xmp/xmpdimensions/units) { get; set; } | Получает или задает единицы измерения. |
| [Width](../../groupdocs.metadata.standards.xmp/xmpdimensions/width) { get; set; } | Получает или задает ширину. |
