...
type: docs
weight: 3520
url: /ru/net/groupdocs.metadata.standards.xmp/xmpreal/
---
## XmpReal class
...
| Имя | Описание |
| --- | --- |
| [XmpReal](xmpreal#constructor)(double) | Инициализирует новый экземпляр[`XmpReal`](../xmpreal) класс. |
...
| [Value](../../groupdocs.metadata.standards.xmp/xmpreal/value) { get; } | Получает значение. |
...
| override [GetXmpRepresentation](../../groupdocs.metadata.standards.xmp/xmpreal/getxmprepresentation)() | Возвращает строковое значение в формате XMP. |
