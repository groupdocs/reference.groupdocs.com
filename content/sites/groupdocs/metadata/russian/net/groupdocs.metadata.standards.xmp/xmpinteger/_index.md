...
type: docs
weight: 3430
url: /ru/net/groupdocs.metadata.standards.xmp/xmpinteger/
---
## XmpInteger class
...
| [Value](../../groupdocs.metadata.standards.xmp/xmpinteger/value) { get; } | Получает значение. |
...
| override [GetXmpRepresentation](../../groupdocs.metadata.standards.xmp/xmpinteger/getxmprepresentation)() | Возвращает строковое значение в формате XMP. |
