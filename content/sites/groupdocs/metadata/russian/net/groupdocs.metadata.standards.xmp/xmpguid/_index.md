...
type: docs
weight: 3410
url: /ru/net/groupdocs.metadata.standards.xmp/xmpguid/
---
## XmpGuid class
...
| [Value](../../groupdocs.metadata.standards.xmp/xmpguid/value) { get; } | Получает значение. |
...
| override [GetXmpRepresentation](../../groupdocs.metadata.standards.xmp/xmpguid/getxmprepresentation)() | Возвращает строковое значение в формате XMP. |
