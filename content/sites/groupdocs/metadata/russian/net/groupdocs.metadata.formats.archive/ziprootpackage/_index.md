...
description: Представляет корневой пакет позволяющий работать с метаданными в ZIPархиве.
type: docs
weight: 370
url: /ru/net/groupdocs.metadata.formats.archive/ziprootpackage/
---
...
| [ZipPackage](../../groupdocs.metadata.formats.archive/ziprootpackage/zippackage) { get; } | Получает пакет метаданных ZIP. |
