...
description: Представляет кадр PCNT вID3V2Tag./id3v2tag . Это просто счетчик количества воспроизведений файла.
type: docs
weight: 470
url: /ru/net/groupdocs.metadata.formats.audio/id3v2playcounterframe/
---
## ID3V2PlayCounterFrame class

Представляет кадр PCNT в[`ID3V2Tag`](../id3v2tag) . Это просто счетчик количества воспроизведений файла.
...
| [Value](../../groupdocs.metadata.formats.audio/id3v2playcounterframe/value) { get; } | Получает количество воспроизведений файла. |
