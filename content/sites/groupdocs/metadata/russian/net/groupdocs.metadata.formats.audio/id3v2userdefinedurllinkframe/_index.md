...
description: Представляет кадр WXXX вID3V2Tag./id3v2tag .
type: docs
weight: 550
url: /ru/net/groupdocs.metadata.formats.audio/id3v2userdefinedurllinkframe/
---
## ID3V2UserDefinedUrlLinkFrame class

Представляет кадр WXXX в[`ID3V2Tag`](../id3v2tag) .
...
| Имя | Описание |
| --- | --- |
| [ID3V2UserDefinedUrlLinkFrame](id3v2userdefinedurllinkframe#constructor_1)(string, string) | Инициализирует новый экземпляр[`ID3V2UserDefinedUrlLinkFrame`](../id3v2userdefinedurllinkframe) класс. |
| [ID3V2UserDefinedUrlLinkFrame](id3v2userdefinedurllinkframe#constructor)(ID3V2EncodingType, string, string) | Инициализирует новый экземпляр[`ID3V2UserDefinedUrlLinkFrame`](../id3v2userdefinedurllinkframe) класс. |
...
| [Description](../../groupdocs.metadata.formats.audio/id3v2userdefinedurllinkframe/description) { get; } | Получает описание. |
| [Encoding](../../groupdocs.metadata.formats.audio/id3v2userdefinedurllinkframe/encoding) { get; } | Получает кодировку кадра. |
...
| [Url](../../groupdocs.metadata.formats.audio/id3v2userdefinedurllinkframe/url) { get; } | Получает URL. |
