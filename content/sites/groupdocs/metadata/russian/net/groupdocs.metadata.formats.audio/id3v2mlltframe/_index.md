...
description: Представляет кадр MLLT вID3V2Tag./id3v2tag .
type: docs
weight: 460
url: /ru/net/groupdocs.metadata.formats.audio/id3v2mlltframe/
---
## ID3V2MlltFrame class

Представляет кадр MLLT в[`ID3V2Tag`](../id3v2tag) .
