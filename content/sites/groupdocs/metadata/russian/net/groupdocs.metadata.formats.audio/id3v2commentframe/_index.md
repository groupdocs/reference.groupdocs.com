...
description: Представляет кадр COMM вID3V2Tag./id3v2tag .
type: docs
weight: 440
url: /ru/net/groupdocs.metadata.formats.audio/id3v2commentframe/
---
## ID3V2CommentFrame class

Представляет кадр COMM в[`ID3V2Tag`](../id3v2tag) .
...
| Имя | Описание |
| --- | --- |
| [ID3V2CommentFrame](id3v2commentframe)(ID3V2EncodingType, string, string, string) | Инициализирует новый экземпляр[`ID3V2CommentFrame`](../id3v2commentframe) класс. |

## Характеристики

| Имя | Описание |
| --- | --- |
| [CommentEncoding](../../groupdocs.metadata.formats.audio/id3v2commentframe/commentencoding) { get; } | Получает кодировку комментария. |
...
| [Language](../../groupdocs.metadata.formats.audio/id3v2commentframe/language) { get; } | Получает язык комментария (3 символа). |
| [MetadataType](../../groupdocs.metadata.common/metadatapackage/metadatatype) { get; } | Получает тип метаданных. |
| [PropertyDescriptors](../../groupdocs.metadata.common/metadatapackage/propertydescriptors) { get; } | Получает набор дескрипторов, содержащих информацию о свойствах, доступных через поисковую систему GroupDocs.Metadata. |
| [ShortContentDescription](../../groupdocs.metadata.formats.audio/id3v2commentframe/shortcontentdescription) { get; } | Получает краткое описание содержимого. |
| [Text](../../groupdocs.metadata.formats.audio/id3v2commentframe/text) { get; } | Получает текст комментария. |
...
Этот фрейм предназначен для любой полнотекстовой информации, которая не помещается ни в какой другой фрейм.
