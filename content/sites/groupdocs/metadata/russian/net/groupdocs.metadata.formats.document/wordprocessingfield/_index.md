...
description: Представляет поле в текстовом документе.
type: docs
weight: 1250
url: /ru/net/groupdocs.metadata.formats.document/wordprocessingfield/
---
## WordProcessingField class

Представляет поле в текстовом документе.
...
| Имя | Описание |
| --- | --- |
| [Code](../../groupdocs.metadata.formats.document/wordprocessingfield/code) { get; } | Получает код поля. |
...
| [Result](../../groupdocs.metadata.formats.document/wordprocessingfield/result) { get; } | Получает результат поля. |
