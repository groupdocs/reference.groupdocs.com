...
description: Представляет собственные метаданные в документе Office.
type: docs
weight: 920
url: /ru/net/groupdocs.metadata.formats.document/documentpackage/
---
## DocumentPackage class

Представляет собственные метаданные в документе Office.
