...
description: Представляет поле формы в документе PDF.
type: docs
weight: 1010
url: /ru/net/groupdocs.metadata.formats.document/pdfformfield/
---
## PdfFormField class

Представляет поле формы в документе PDF.
...
| [Name](../../groupdocs.metadata.formats.document/pdfformfield/name) { get; } | Получает имя поля. |
| [PropertyDescriptors](../../groupdocs.metadata.common/metadatapackage/propertydescriptors) { get; } | Получает набор дескрипторов, содержащих информацию о свойствах, доступных через поисковую систему GroupDocs.Metadata. |
| [Value](../../groupdocs.metadata.formats.document/pdfformfield/value) { get; } | Получает значение поля. |
