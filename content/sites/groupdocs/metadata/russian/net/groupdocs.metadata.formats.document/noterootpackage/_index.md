...
description: Представляет корневой пакет предназначенный для работы с метаданными в файле электронных заметок.
type: docs
weight: 970
url: /ru/net/groupdocs.metadata.formats.document/noterootpackage/
---
## NoteRootPackage class

Представляет корневой пакет, предназначенный для работы с метаданными в файле электронных заметок.
...
| [DocumentStatistics](../../groupdocs.metadata.formats.document/noterootpackage/documentstatistics) { get; } | Получает пакет статистики документа. |
| [FileType](../../groupdocs.metadata.common/rootmetadatapackage/filetype) { get; } | Получает пакет метаданных типа файла. |
| [InspectionPackage](../../groupdocs.metadata.formats.document/noterootpackage/inspectionpackage) { get; } | Получает пакет метаданных, содержащий результаты проверки документа. Пакет содержит информацию о частях документа, которые в некоторых случаях могут рассматриваться как метаданные. |
...
В этом примере кода показано, как проверить документ заметки.
