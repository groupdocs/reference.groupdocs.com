...
description: Представляет закладку в документе PDF.
type: docs
weight: 1000
url: /ru/net/groupdocs.metadata.formats.document/pdfbookmark/
---
## PdfBookmark class

Представляет закладку в документе PDF.
...
| [Title](../../groupdocs.metadata.formats.document/pdfbookmark/title) { get; } | Получает название закладки. |
