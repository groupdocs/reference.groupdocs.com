...
type: docs
weight: 980
url: /ru/net/groupdocs.metadata.formats.document/pdfannotation/
---
## PdfAnnotation class
...
| [Name](../../groupdocs.metadata.formats.document/pdfannotation/name) { get; } | Получает имя аннотации. |
| [PageNumber](../../groupdocs.metadata.formats.document/pdfannotation/pagenumber) { get; } | Получает номер страницы, содержащей аннотацию. |
| [PropertyDescriptors](../../groupdocs.metadata.common/metadatapackage/propertydescriptors) { get; } | Получает набор дескрипторов, содержащих информацию о свойствах, доступных через поисковую систему GroupDocs.Metadata. |
| [Text](../../groupdocs.metadata.formats.document/pdfannotation/text) { get; } | Получает текст аннотации. |
