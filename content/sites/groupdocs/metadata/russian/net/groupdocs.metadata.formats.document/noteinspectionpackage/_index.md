...
description: Представляет пакет метаданных раскрывающий внутреннюю структуру раздела заметок.
type: docs
weight: 950
url: /ru/net/groupdocs.metadata.formats.document/noteinspectionpackage/
---
## NoteInspectionPackage class

Представляет пакет метаданных, раскрывающий внутреннюю структуру раздела заметок.
...
| [Pages](../../groupdocs.metadata.formats.document/noteinspectionpackage/pages) { get; } | Получает массив страниц раздела. |
