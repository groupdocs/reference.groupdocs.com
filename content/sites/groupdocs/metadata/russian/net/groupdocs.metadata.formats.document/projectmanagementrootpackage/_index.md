...
description: Представляет корневой пакет предназначенный для работы с метаданными в формате управления проектами.
type: docs
weight: 1140
url: /ru/net/groupdocs.metadata.formats.document/projectmanagementrootpackage/
---
## ProjectManagementRootPackage class

Представляет корневой пакет, предназначенный для работы с метаданными в формате управления проектами.
...
В этом примере кода показано, как извлечь встроенные свойства документа ProjectManagement.
