...
description: Представляет базовый класс метаданных VCard.
type: docs
weight: 620
url: /ru/net/groupdocs.metadata.formats.businesscard/vcardbasepackage/
---
## VCardBasePackage class

Представляет базовый класс метаданных VCard.
