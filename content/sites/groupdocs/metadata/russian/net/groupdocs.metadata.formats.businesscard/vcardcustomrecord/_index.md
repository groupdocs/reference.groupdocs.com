...
description: Представляет класс метаданных пользовательской записи vCard.
type: docs
weight: 680
url: /ru/net/groupdocs.metadata.formats.businesscard/vcardcustomrecord/
---
## VCardCustomRecord class

Представляет класс метаданных пользовательской записи vCard.
...
| override [ContentType](../../groupdocs.metadata.formats.businesscard/vcardcustomrecord/contenttype) { get; } | Получает тип содержимого записи. |
...
| [Value](../../groupdocs.metadata.formats.businesscard/vcardcustomrecord/value) { get; } | Получает значение записи. |
