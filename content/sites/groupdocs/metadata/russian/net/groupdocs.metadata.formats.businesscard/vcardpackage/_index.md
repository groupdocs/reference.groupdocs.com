...
description: Представляет метаданные формата электронной визитной карточки VCF Virtual Contact File.
type: docs
weight: 760
url: /ru/net/groupdocs.metadata.formats.businesscard/vcardpackage/
---
## VCardPackage class

Представляет метаданные формата электронной визитной карточки VCF (Virtual Contact File).
...
| Имя | Описание |
| --- | --- |
| [Cards](../../groupdocs.metadata.formats.businesscard/vcardpackage/cards) { get; } | Получает массив карточек, извлеченных из файла. |
