...
description: Предоставляет базовый класс объединения записей vCard.
type: docs
weight: 780
url: /ru/net/groupdocs.metadata.formats.businesscard/vcardrecordset/
---
## VCardRecordset class

Предоставляет базовый класс объединения записей vCard.
