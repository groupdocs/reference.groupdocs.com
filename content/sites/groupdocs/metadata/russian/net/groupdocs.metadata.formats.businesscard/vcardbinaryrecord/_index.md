...
description: Представляет класс метаданных двоичной записи vCard.
type: docs
weight: 630
url: /ru/net/groupdocs.metadata.formats.businesscard/vcardbinaryrecord/
---
## VCardBinaryRecord class

Представляет класс метаданных двоичной записи vCard.
...
| override [ContentType](../../groupdocs.metadata.formats.businesscard/vcardbinaryrecord/contenttype) { get; } | Получает тип содержимого записи. |
...
| [Value](../../groupdocs.metadata.formats.businesscard/vcardbinaryrecord/value) { get; } | Получает значение записи. |
