...
description: Представляет абстрактный класс метаданных записи vCard.
type: docs
weight: 770
url: /ru/net/groupdocs.metadata.formats.businesscard/vcardrecord/
---
## VCardRecord class

Представляет абстрактный класс метаданных записи vCard.
...
| abstract [ContentType](../../groupdocs.metadata.formats.businesscard/vcardrecord/contenttype) { get; } | Получает тип содержимого записи. |
