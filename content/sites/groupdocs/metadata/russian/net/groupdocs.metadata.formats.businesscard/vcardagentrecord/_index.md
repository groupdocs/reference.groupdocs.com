...
description: Представляет класс метаданных записи vCard Agent.
type: docs
weight: 610
url: /ru/net/groupdocs.metadata.formats.businesscard/vcardagentrecord/
---
## VCardAgentRecord class

Представляет класс метаданных записи vCard Agent.
...
| override [ContentType](../../groupdocs.metadata.formats.businesscard/vcardagentrecord/contenttype) { get; } | Получает тип содержимого записи. |
...
| [Value](../../groupdocs.metadata.formats.businesscard/vcardagentrecord/value) { get; } | Получает значение записи. |
