...
description: Представляет корневой пакет позволяющий работать с метаданными в электронной книге EPUB.
type: docs
weight: 1340
url: /ru/net/groupdocs.metadata.formats.ebook/epubrootpackage/
---
## EpubRootPackage class

Представляет корневой пакет, позволяющий работать с метаданными в электронной книге EPUB.
...
| [DublinCorePackage](../../groupdocs.metadata.formats.ebook/epubrootpackage/dublincorepackage) { get; } | Получает пакет метаданных Dublin Core, извлеченный из электронной книги. |
| [EpubPackage](../../groupdocs.metadata.formats.ebook/epubrootpackage/epubpackage) { get; } | Получает пакет метаданных EPUB. |
