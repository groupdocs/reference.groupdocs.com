...
description: Представляет пакет выгружаемого текста XMP.
type: docs
weight: 3180
url: /ru/net/groupdocs.metadata.standards.xmp.schemes/xmppagedtextpackage/
---
## XmpPagedTextPackage class

Представляет пакет выгружаемого текста XMP.
...
| Имя | Описание |
| --- | --- |
| [XmpPagedTextPackage](xmppagedtextpackage)() | Инициализирует новый экземпляр[`XmpPagedTextPackage`](../xmppagedtextpackage) класс. |

## Характеристики

| Имя | Описание |
| --- | --- |
| [Colorants](../../groupdocs.metadata.standards.xmp.schemes/xmppagedtextpackage/colorants) { get; set; } | Получает или задает упорядоченный массив красителей (образцов), которые используются в документе (включая любые содержащиеся в нем документы). |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | Получает количество свойств метаданных. |
| [Fonts](../../groupdocs.metadata.standards.xmp.schemes/xmppagedtextpackage/fonts) { get; set; } | Получает или задает неупорядоченный массив шрифтов, используемых в документе (включая любые содержащиеся в нем документы). |
| [Item](../../groupdocs.metadata.common/metadatapackage/item) { get; } | Получает[`MetadataProperty`](../../groupdocs.metadata.common/metadataproperty) с указанным именем. |
| [Keys](../../groupdocs.metadata.common/metadatapackage/keys) { get; } | Получает коллекцию имен свойств метаданных. |
| [MaxPageSize](../../groupdocs.metadata.standards.xmp.schemes/xmppagedtextpackage/maxpagesize) { get; set; } | Получает или задает размер самой большой страницы в документе (включая все содержащиеся документы). |
...
| [NumberOfPages](../../groupdocs.metadata.standards.xmp.schemes/xmppagedtextpackage/numberofpages) { get; set; } | Получает или задает количество страниц в документе. |
| [PlateNames](../../groupdocs.metadata.standards.xmp.schemes/xmppagedtextpackage/platenames) { get; set; } | Получает или задает упорядоченный массив имен пластин, необходимых для печати документа (включая любые содержащиеся в нем документы). |
...
| override [Set](../../groupdocs.metadata.standards.xmp.schemes/xmppagedtextpackage/set#set_7)(string, string) | Устанавливает строковое свойство. |
| override [Set](../../groupdocs.metadata.standards.xmp.schemes/xmppagedtextpackage/set#set_2)(string, XmpArray) | Устанавливает значение, унаследованное от[`XmpArray`](../../groupdocs.metadata.standards.xmp/xmparray) . |
