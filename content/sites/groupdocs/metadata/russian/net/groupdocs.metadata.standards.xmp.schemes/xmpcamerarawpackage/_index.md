...
| [CropUnits](../../groupdocs.metadata.standards.xmp.schemes/xmpcamerarawpackage/cropunits) { get; set; } | Получает или устанавливает единицы для[`CropWidth`](./cropwidth) и[`CropHeight`](./cropheight) . |
