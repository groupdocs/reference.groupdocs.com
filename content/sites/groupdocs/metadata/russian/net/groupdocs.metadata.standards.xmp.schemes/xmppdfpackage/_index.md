...
description: Указывает свойства используемые с документами Adobe PDF.
type: docs
weight: 3190
url: /ru/net/groupdocs.metadata.standards.xmp.schemes/xmppdfpackage/
---
## XmpPdfPackage class

Указывает свойства, используемые с документами Adobe PDF.
...
| Имя | Описание |
| --- | --- |
| [XmpPdfPackage](xmppdfpackage)() | Инициализирует новый экземпляр[`XmpPdfPackage`](../xmppdfpackage) класс. |
...
| [IsTrapped](../../groupdocs.metadata.standards.xmp.schemes/xmppdfpackage/istrapped) { get; set; } | Получает или задает значение, указывающее, был ли документ перехвачен. |
| [Item](../../groupdocs.metadata.common/metadatapackage/item) { get; } | Получает[`MetadataProperty`](../../groupdocs.metadata.common/metadataproperty) с указанным именем. |
| [Keys](../../groupdocs.metadata.common/metadatapackage/keys) { get; } | Получает коллекцию имен свойств метаданных. |
| [Keywords](../../groupdocs.metadata.standards.xmp.schemes/xmppdfpackage/keywords) { get; set; } | Получает или задает ключевые слова. |
...
| [PdfVersion](../../groupdocs.metadata.standards.xmp.schemes/xmppdfpackage/pdfversion) { get; set; } | Получает или задает версию файла PDF. Например 1.0, 1.3 и так далее. |
| [Prefix](../../groupdocs.metadata.standards.xmp/xmppackage/prefix) { get; } | Получает префикс xmlns. |
| [Producer](../../groupdocs.metadata.standards.xmp.schemes/xmppdfpackage/producer) { get; set; } | Получает или задает имя инструмента, создавшего документ PDF. |
...
| override [Set](../../groupdocs.metadata.standards.xmp.schemes/xmppdfpackage/set#set_7)(string, string) | Устанавливает строковое свойство. |
