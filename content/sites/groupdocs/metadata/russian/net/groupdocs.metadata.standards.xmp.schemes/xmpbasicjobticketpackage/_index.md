...
description: Представляет пространство имен Basic JobTicket.
type: docs
weight: 3080
url: /ru/net/groupdocs.metadata.standards.xmp.schemes/xmpbasicjobticketpackage/
---
## XmpBasicJobTicketPackage class

Представляет пространство имен Basic Job-Ticket.
...
| Имя | Описание |
| --- | --- |
| [XmpBasicJobTicketPackage](xmpbasicjobticketpackage)() | Инициализирует новый экземпляр[`XmpBasicJobTicketPackage`](../xmpbasicjobticketpackage) класс. |
...
| [Jobs](../../groupdocs.metadata.standards.xmp.schemes/xmpbasicjobticketpackage/jobs) { get; set; } | Получает или задает задания. |
