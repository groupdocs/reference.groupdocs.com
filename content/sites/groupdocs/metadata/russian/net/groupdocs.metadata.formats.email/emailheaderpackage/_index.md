...
description: Представляет пакет метаданных содержащий заголовки сообщений электронной почты.
type: docs
weight: 1350
url: /ru/net/groupdocs.metadata.formats.email/emailheaderpackage/
---
## EmailHeaderPackage class

Представляет пакет метаданных, содержащий заголовки сообщений электронной почты.
...
| [Get](../../groupdocs.metadata.formats.email/emailheaderpackage/get)(string) | Получает значение указанного заголовка. |
