...
description: Представляет корневой пакет позволяющий работать с метаданными в сообщении электронной почты.
type: docs
weight: 1370
url: /ru/net/groupdocs.metadata.formats.email/emailrootpackage/
---
## EmailRootPackage class

Представляет корневой пакет, позволяющий работать с метаданными в сообщении электронной почты.
...
| [EmailPackage](../../groupdocs.metadata.formats.email/emailrootpackage/emailpackage) { get; } | Получает пакет метаданных электронной почты. |
