...
description: Представляет значение таблицы записей имен дляUnicode платформа.
type: docs
weight: 1580
url: /ru/net/groupdocs.metadata.formats.font/opentypeunicodenamerecord/
---
## OpenTypeUnicodeNameRecord class

Представляет значение таблицы записей имен дляUnicode платформа.
...
| [Encoding](../../groupdocs.metadata.formats.font/opentypeunicodenamerecord/encoding) { get; } | Получает идентификатор кодировки. |
