...
description: Представляет корневой пакет позволяющий работать с метаданными в файле шрифта OpenType.
type: docs
weight: 1550
url: /ru/net/groupdocs.metadata.formats.font/opentyperootpackage/
---
## OpenTypeRootPackage class

Представляет корневой пакет, позволяющий работать с метаданными в файле шрифта OpenType.
...
| [DigitalSignaturePackage](../../groupdocs.metadata.formats.font/opentyperootpackage/digitalsignaturepackage) { get; } | Получает пакет метаданных цифровой подписи. |
...
| [OpenTypePackage](../../groupdocs.metadata.formats.font/opentyperootpackage/opentypepackage) { get; } | Получает пакет метаданных OpenType. |
