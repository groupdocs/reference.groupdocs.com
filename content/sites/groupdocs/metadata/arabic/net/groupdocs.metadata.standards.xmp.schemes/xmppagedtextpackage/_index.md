...
description: يمثل حزمة XMP PagedText .
type: docs
weight: 3180
url: /ar/net/groupdocs.metadata.standards.xmp.schemes/xmppagedtextpackage/
---
## XmpPagedTextPackage class

يمثل حزمة XMP Paged-Text .
...
| اسم | وصف |
| --- | --- |
| [XmpPagedTextPackage](xmppagedtextpackage)() | يقوم بتهيئة مثيل جديد لملف[`XmpPagedTextPackage`](../xmppagedtextpackage) فئة . |

## الخصائص

| اسم | وصف |
| --- | --- |
| [Colorants](../../groupdocs.metadata.standards.xmp.schemes/xmppagedtextpackage/colorants) { get; set; } | الحصول على أو تعيين مصفوفة مرتبة من الملونات (الحوامل) المستخدمة في المستند (بما في ذلك أي مستندات مضمنة). |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | الحصول على عدد خصائص البيانات الوصفية. |
| [Fonts](../../groupdocs.metadata.standards.xmp.schemes/xmppagedtextpackage/fonts) { get; set; } | الحصول على أو تحديد مصفوفة غير مرتبة من الخطوط المستخدمة في الوثيقة (بما في ذلك أي وثائق مضمنة). |
...
| [MaxPageSize](../../groupdocs.metadata.standards.xmp.schemes/xmppagedtextpackage/maxpagesize) { get; set; } | الحصول على أو تحديد حجم أكبر صفحة في المستند (بما في ذلك أي مستندات مضمنة). |
...
| [NumberOfPages](../../groupdocs.metadata.standards.xmp.schemes/xmppagedtextpackage/numberofpages) { get; set; } | الحصول على أو تحديد عدد الصفحات في المستند. |
| [PlateNames](../../groupdocs.metadata.standards.xmp.schemes/xmppagedtextpackage/platenames) { get; set; } | الحصول على أو تعيين مصفوفة مرتبة من أسماء اللوحات المطلوبة لطباعة المستند (بما في ذلك أي مستندات مضمنة). |
...
| override [Set](../../groupdocs.metadata.standards.xmp.schemes/xmppagedtextpackage/set#set_7)(string, string) | تعيين خاصية السلسلة . |
| override [Set](../../groupdocs.metadata.standards.xmp.schemes/xmppagedtextpackage/set#set_2)(string, XmpArray) | يعيّن القيمة الموروثة من[`XmpArray`](../../groupdocs.metadata.standards.xmp/xmparray) . |
