...
description: يمثل مساحة الاسم الأساسية لتذكرة العمل.
type: docs
weight: 3080
url: /ar/net/groupdocs.metadata.standards.xmp.schemes/xmpbasicjobticketpackage/
---
## XmpBasicJobTicketPackage class

يمثل مساحة الاسم الأساسية لتذكرة العمل.
...
| اسم | وصف |
| --- | --- |
| [XmpBasicJobTicketPackage](xmpbasicjobticketpackage)() | يقوم بتهيئة مثيل جديد لملف[`XmpBasicJobTicketPackage`](../xmpbasicjobticketpackage) فئة . |
...
| [Jobs](../../groupdocs.metadata.standards.xmp.schemes/xmpbasicjobticketpackage/jobs) { get; set; } | الحصول على الوظائف أو تعيينها. |
