...
description: يمثل البيانات الوصفية لخاصية دفق الفيديو في حاوية وسائط ASF.
type: docs
weight: 2370
url: /ar/net/groupdocs.metadata.formats.video/asfvideostreamproperty/
---
## AsfVideoStreamProperty class

يمثل البيانات الوصفية لخاصية دفق الفيديو في حاوية وسائط ASF.
...
| [BitsPerPixels](../../groupdocs.metadata.formats.video/asfvideostreamproperty/bitsperpixels) { get; } | الحصول على وحدات البت لكل بكسل . |
| [Compression](../../groupdocs.metadata.formats.video/asfvideostreamproperty/compression) { get; } | يحصل على معرف ضغط الفيديو . |
...
| [ImageHeight](../../groupdocs.metadata.formats.video/asfvideostreamproperty/imageheight) { get; } | الحصول على ارتفاع الصورة المشفرة بالبكسل. |
| [ImageWidth](../../groupdocs.metadata.formats.video/asfvideostreamproperty/imagewidth) { get; } | الحصول على عرض الصورة المشفرة بالبكسل. |
