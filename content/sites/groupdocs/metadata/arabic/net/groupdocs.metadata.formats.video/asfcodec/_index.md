...
description: يمثل البيانات الوصفية لبرنامج ترميز ASF .
type: docs
weight: 2260
url: /ar/net/groupdocs.metadata.formats.video/asfcodec/
---
## AsfCodec class

يمثل البيانات الوصفية لبرنامج ترميز ASF .
...
| اسم | وصف |
| --- | --- |
| [CodecType](../../groupdocs.metadata.formats.video/asfcodec/codectype) { get; } | يحصل على نوع برنامج الترميز . |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | الحصول على عدد خصائص البيانات الوصفية. |
| [Description](../../groupdocs.metadata.formats.video/asfcodec/description) { get; } | يحصل على الوصف . |
| [Information](../../groupdocs.metadata.formats.video/asfcodec/information) { get; } | يحصل على سلسلة المعلومات . |
...
| [Name](../../groupdocs.metadata.formats.video/asfcodec/name) { get; } | الحصول على اسم الخاصية . |
