...
description: يمثل بيانات تعريف QuickTime .
type: docs
weight: 2630
url: /ar/net/groupdocs.metadata.formats.video/movpackage/
---
## MovPackage class

يمثل بيانات تعريف QuickTime .
...
| اسم | وصف |
| --- | --- |
| [Atoms](../../groupdocs.metadata.formats.video/movpackage/atoms) { get; } | يحصل على مجموعة من[`MovAtom`](../movatom) ذرات. |
