...
description: يحصل على حزمة البيانات الوصفية Matroska .
type: docs
weight: 10
url: /ar/net/groupdocs.metadata.formats.video/matroskarootpackage/matroskapackage/
---
## MatroskaRootPackage.MatroskaPackage property

يحصل على حزمة البيانات الوصفية Matroska .
...
يوضح هذا المثال كيفية قراءة خصائص بيانات التعريف الخاصة بتنسيق Matroska.
...
using (Metadata metadata = new Metadata(Constants.InputMkv))
{
    ...
    // قراءة البيانات الوصفية لعلامة Matroska
    ...
    // قراءة ماتروسكا تتبع البيانات الوصفية
...
* مساحة الاسم [GroupDocs.Metadata.Formats.Video](../../matroskarootpackage)
