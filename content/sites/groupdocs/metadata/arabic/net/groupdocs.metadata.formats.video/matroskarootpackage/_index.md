...
description: يمثل الحزمة الجذرية التي تسمح بالعمل مع البيانات الوصفية في فيديو Matroska.
type: docs
weight: 2480
url: /ar/net/groupdocs.metadata.formats.video/matroskarootpackage/
---
## MatroskaRootPackage class

يمثل الحزمة الجذرية التي تسمح بالعمل مع البيانات الوصفية في فيديو Matroska.
...
| [MatroskaPackage](../../groupdocs.metadata.formats.video/matroskarootpackage/matroskapackage) { get; } | يحصل على حزمة البيانات الوصفية Matroska . |
...
يوضح هذا المثال كيفية استخراج ترجمات من فيديو MKV.
