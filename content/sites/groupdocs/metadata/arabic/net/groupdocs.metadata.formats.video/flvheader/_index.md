...
description: يمثل رأس فيديو بتنسيق FLV .
type: docs
weight: 2410
url: /ar/net/groupdocs.metadata.formats.video/flvheader/
---
## FlvHeader class

يمثل رأس فيديو بتنسيق FLV .
...
| [HasAudioTags](../../groupdocs.metadata.formats.video/flvheader/hasaudiotags) { get; } | يحصل على قيمة تشير إلى ما إذا كانت العلامات الصوتية موجودة في الملف. |
| [HasVideoTags](../../groupdocs.metadata.formats.video/flvheader/hasvideotags) { get; } | يحصل على قيمة تشير إلى ما إذا كانت علامات الفيديو موجودة في الملف. |
...
| [TypeFlags](../../groupdocs.metadata.formats.video/flvheader/typeflags) { get; } | يحصل على أعلام نوع FLV . |
| [Version](../../groupdocs.metadata.formats.video/flvheader/version) { get; } | يحصل على نسخة الملف . |
