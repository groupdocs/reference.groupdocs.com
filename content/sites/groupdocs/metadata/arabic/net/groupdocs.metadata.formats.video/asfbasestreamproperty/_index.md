...
description: يمثل البيانات الوصفية لخاصية التدفق الأساسي في حاوية وسائط ASF.
type: docs
weight: 2250
url: /ar/net/groupdocs.metadata.formats.video/asfbasestreamproperty/
---
## AsfBaseStreamProperty class

يمثل البيانات الوصفية لخاصية التدفق الأساسي في حاوية وسائط ASF.
