...
description: يمثل الحزمة الجذر التي تسمح بالعمل مع البيانات الوصفية في فيديو QuickTime .
type: docs
weight: 2640
url: /ar/net/groupdocs.metadata.formats.video/movrootpackage/
---
## MovRootPackage class

يمثل الحزمة الجذر التي تسمح بالعمل مع البيانات الوصفية في فيديو QuickTime .
...
| [MovPackage](../../groupdocs.metadata.formats.video/movrootpackage/movpackage) { get; } | الحصول على حزمة بيانات تعريف QuickTime . |
...
| [XmpPackage](../../groupdocs.metadata.formats.video/movrootpackage/xmppackage) { get; set; } | الحصول على حزمة بيانات تعريف XMP أو تعيينها. |
...
يوضح هذا المثال كيفية قراءة ذرات QuickTime في فيديو MOV.
