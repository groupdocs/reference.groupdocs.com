...
description: يحصل على حزمة البيانات الوصفية لـ ASF .
type: docs
weight: 10
url: /ar/net/groupdocs.metadata.formats.video/asfrootpackage/asfpackage/
---
## AsfRootPackage.AsfPackage property

يحصل على حزمة البيانات الوصفية لـ ASF .
...
يوضح نموذج التعليمات البرمجية هذا كيفية قراءة بيانات تعريف ASF الأصلية.
