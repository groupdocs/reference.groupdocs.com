...
description: يمثل عنصر SEGMENTINFO يحتوي على معلومات عامة حول المقطع في فيديو Matroska.
type: docs
weight: 2490
url: /ar/net/groupdocs.metadata.formats.video/matroskasegment/
---
...
| [DateUtc](../../groupdocs.metadata.formats.video/matroskasegment/dateutc) { get; } | الحصول على تاريخ ووقت إنشاء المقطع بواسطة تطبيق أو مكتبة muxing. |
| [Duration](../../groupdocs.metadata.formats.video/matroskasegment/duration) { get; } | يحصل على مدة SEGMENT. يرجى الاطلاع[`TimecodeScale`](./timecodescale) لمزيد من المعلومات. |
...
| [MuxingApp](../../groupdocs.metadata.formats.video/matroskasegment/muxingapp) { get; } | الحصول على الاسم الكامل للتطبيق أو المكتبة متبوعًا برقم الإصدار. |
...
| [ScaledDuration](../../groupdocs.metadata.formats.video/matroskasegment/scaledduration) { get; } | الحصول على المدة المقاسة للقطاع. |
| [SegmentFilename](../../groupdocs.metadata.formats.video/matroskasegment/segmentfilename) { get; } | الحصول على اسم الملف المقابل لهذا المقطع. |
| [SegmentUid](../../groupdocs.metadata.formats.video/matroskasegment/segmentuid) { get; } | الحصول على رقم فريد 128 بت يحدد SEGMENT. من الواضح أنه لا يمكن الإشارة إلى ملف إلا بواسطة ملف آخر في حالة وجود SEGMENTUID ، ومع ذلك ، يمكن التشغيل بدون هذا المعرف الفريد . |
| [TimecodeScale](../../groupdocs.metadata.formats.video/matroskasegment/timecodescale) { get; } | يحصل على قيمة مقياس الكود الزمني. يتم ضرب كل رمز زمني تم قياسه في ملف MATROSKA بـ TIMECODESCALE للحصول على رمز الوقت بالنانو ثانية. لاحظ أنه لا يتم تحجيم كل الرموز الزمنية! |
| [Title](../../groupdocs.metadata.formats.video/matroskasegment/title) { get; } | الحصول على الاسم العام للقطاع . |
| [WritingApp](../../groupdocs.metadata.formats.video/matroskasegment/writingapp) { get; } | الحصول على الاسم الكامل للتطبيق متبوعًا برقم الإصدار. |
