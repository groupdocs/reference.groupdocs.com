...
description: يمثل البيانات الوصفية لرأس EBML في فيديو ماتروسكا.
type: docs
weight: 2460
url: /ar/net/groupdocs.metadata.formats.video/matroskaebmlheader/
---
## MatroskaEbmlHeader class

يمثل البيانات الوصفية لرأس EBML في فيديو ماتروسكا.
...
| [DocType](../../groupdocs.metadata.formats.video/matroskaebmlheader/doctype) { get; } | يحصل على محتويات الملف. في حالة ملف MATROSKA ، تكون قيمته "matroska" . |
| [DocTypeReadVersion](../../groupdocs.metadata.formats.video/matroskaebmlheader/doctypereadversion) { get; } | يحصل على الحد الأدنى من رقم الإصدار أ[`DocType`](./doctype) يجب أن يكون المحلل اللغوي متوافقًا مع لقراءة الملف. |
| [DocTypeVersion](../../groupdocs.metadata.formats.video/matroskaebmlheader/doctypeversion) { get; } | يحصل على إصدار[`DocType`](./doctype) الكاتب المستخدم في إنشاء الملف. |
...
| [ReadVersion](../../groupdocs.metadata.formats.video/matroskaebmlheader/readversion) { get; } | الحصول على الإصدار الأدنى الذي يحتاجه المحلل اللغوي لـ EBML ليكون متوافقًا معه حتى يتمكن من قراءة الملف. |
| [Version](../../groupdocs.metadata.formats.video/matroskaebmlheader/version) { get; } | الحصول على نسخة كاتب EBML التي تم استخدامها لإنشاء الملف. |
