...
description: يمثل ذرة QuickTime .
type: docs
weight: 2620
url: /ar/net/groupdocs.metadata.formats.video/movatom/
---
## MovAtom class
...
| [DataOffset](../../groupdocs.metadata.formats.video/movatom/dataoffset) { get; } | يحصل على إزاحة البيانات . |
| [DataSize](../../groupdocs.metadata.formats.video/movatom/datasize) { get; } | الحصول على حجم البيانات بالبايت . |
| [HasExtendedSize](../../groupdocs.metadata.formats.video/movatom/hasextendedsize) { get; } | الحصول على قيمة تشير إلى ما إذا كان حقل الحجم الموسع قد تم استخدامه لتخزين بيانات الذرة. |
...
| [LongSize](../../groupdocs.metadata.formats.video/movatom/longsize) { get; } | الحصول على حجم الذرة بالبايت. |
| [MetadataType](../../groupdocs.metadata.common/metadatapackage/metadatatype) { get; } | الحصول على نوع البيانات الوصفية . |
| [Offset](../../groupdocs.metadata.formats.video/movatom/offset) { get; } | يحصل على إزاحة الذرة . |
...
| [Size](../../groupdocs.metadata.formats.video/movatom/size) { get; } | الحصول على حجم الذرة بالبايت. |
| [Type](../../groupdocs.metadata.formats.video/movatom/type) { get; } | يحصل على النوع المكون من 4 أحرف . |
