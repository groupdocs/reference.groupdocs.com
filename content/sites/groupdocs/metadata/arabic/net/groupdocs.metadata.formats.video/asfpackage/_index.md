...
description: يمثل البيانات الوصفية الأصلية لحاوية وسائط ASF.
type: docs
weight: 2340
url: /ar/net/groupdocs.metadata.formats.video/asfpackage/
---
## AsfPackage class

يمثل البيانات الوصفية الأصلية لحاوية وسائط ASF.
...
| اسم | وصف |
| --- | --- |
| [CodecInformation](../../groupdocs.metadata.formats.video/asfpackage/codecinformation) { get; } | يحصل على إدخالات معلومات برنامج الترميز. |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | الحصول على عدد خصائص البيانات الوصفية. |
| [CreationDate](../../groupdocs.metadata.formats.video/asfpackage/creationdate) { get; } | يحصل على تاريخ ووقت الإنشاء الأولي للملف. |
| [FileID](../../groupdocs.metadata.formats.video/asfpackage/fileid) { get; } | الحصول على المعرف الفريد لهذا الملف. |
| [Flags](../../groupdocs.metadata.formats.video/asfpackage/flags) { get; } | يحصل على أعلام الرأس . |
...
| [MetadataDescriptors](../../groupdocs.metadata.formats.video/asfpackage/metadatadescriptors) { get; } | يحصل على واصفات البيانات الوصفية . |
...
| [StreamProperties](../../groupdocs.metadata.formats.video/asfpackage/streamproperties) { get; } | يحصل على خصائص دفق الوسائط الرقمية. |
