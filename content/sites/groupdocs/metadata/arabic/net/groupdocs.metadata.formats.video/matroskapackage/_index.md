...
description: يمثل حاوية بيانات وصفية في فيديو Matroska .
type: docs
weight: 2470
url: /ar/net/groupdocs.metadata.formats.video/matroskapackage/
---
## MatroskaPackage class

يمثل حاوية بيانات وصفية في فيديو Matroska .
...
| اسم | وصف |
| --- | --- |
| [ContentType](../../groupdocs.metadata.formats.video/matroskapackage/contenttype) { get; } | يحصل على نوع محتوى Matroska . |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | الحصول على عدد خصائص البيانات الوصفية. |
| [EbmlHeader](../../groupdocs.metadata.formats.video/matroskapackage/ebmlheader) { get; } | الحصول على البيانات الوصفية لرأس EBML. |
...
| [Segments](../../groupdocs.metadata.formats.video/matroskapackage/segments) { get; } | يحصل على البيانات الوصفية لمعلومات المقطع . |
| [SubtitleTracks](../../groupdocs.metadata.formats.video/matroskapackage/subtitletracks) { get; } | يحصل على إدخالات بيانات تعريف الترجمة. |
| [Tags](../../groupdocs.metadata.formats.video/matroskapackage/tags) { get; } | يحصل على البيانات الوصفية الخاصة بالعلامات . |
| [Tracks](../../groupdocs.metadata.formats.video/matroskapackage/tracks) { get; } | يحصل على إدخالات البيانات الوصفية للمسار. |
