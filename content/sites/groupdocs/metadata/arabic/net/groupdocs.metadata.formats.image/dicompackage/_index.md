...
description: يمثل بيانات وصفية أصلية لـ DICOM .
type: docs
weight: 1670
url: /ar/net/groupdocs.metadata.formats.image/dicompackage/
---
## DicomPackage class

يمثل بيانات وصفية أصلية لـ DICOM .
...
| اسم | وصف |
| --- | --- |
| [DicomPackage](dicompackage)() | يقوم بتهيئة مثيل جديد لملف[`Metadata`](../../groupdocs.metadata/metadata) فئة . |

## الخصائص

| اسم | وصف |
| --- | --- |
| [BitsAllocated](../../groupdocs.metadata.formats.image/dicompackage/bitsallocated) { get; } | يحصل على القيمة المخصصة للبت. |
| [Blues](../../groupdocs.metadata.formats.image/dicompackage/blues) { get; } | يحصل على ألوان المصفوفة من اللون الأزرق . |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | الحصول على عدد خصائص البيانات الوصفية. |
| [DicomInfo](../../groupdocs.metadata.formats.image/dicompackage/dicominfo) { get; } | يحصل على معلومات رأس ملف DICOM. |
| [Greens](../../groupdocs.metadata.formats.image/dicompackage/greens) { get; } | يحصل على ألوان المصفوفة الخضراء . |
| [HeaderBytes](../../groupdocs.metadata.formats.image/dicompackage/headerbytes) { get; } | يحصل على معلومات الرأس بالبايت. |
| [HeaderOffset](../../groupdocs.metadata.formats.image/dicompackage/headeroffset) { get; } | يحصل على إزاحة الرأس . |
...
| [NumberOfFrames](../../groupdocs.metadata.formats.image/dicompackage/numberofframes) { get; } | يحصل على عدد الإطارات . |
...
| [Reds](../../groupdocs.metadata.formats.image/dicompackage/reds) { get; } | يحصل على ألوان المصفوفة الحمراء . |
