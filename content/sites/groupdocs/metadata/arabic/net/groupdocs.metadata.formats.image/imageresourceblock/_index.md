...
description: يمثل كتلة موارد صورة Photoshop .  كتل موارد الصور هي وحدة البناء الأساسية للعديد من تنسيقات الملفات  بما في ذلك تنسيق الملفات الأصلي في Photoshop و JPEG و TIFF. تُستخدم موارد الصور لتخزين البيانات غير البكسل المرتبطة بالصور  مثل مسارات أداة القلم.
type: docs
weight: 1740
url: /ar/net/groupdocs.metadata.formats.image/imageresourceblock/
---
## ImageResourceBlock class

يمثل كتلة موارد صورة Photoshop .  كتل موارد الصور هي وحدة البناء الأساسية للعديد من تنسيقات الملفات ، بما في ذلك تنسيق الملفات الأصلي في Photoshop و JPEG و TIFF. تُستخدم موارد الصور لتخزين البيانات غير البكسل المرتبطة بالصور ، مثل مسارات أداة القلم.
...
| [Data](../../groupdocs.metadata.formats.image/imageresourceblock/data) { get; } | يحصل على بيانات المورد . |
| [ID](../../groupdocs.metadata.formats.image/imageresourceblock/id) { get; } | الحصول على المعرف الفريد للمورد. |
...
| [Name](../../groupdocs.metadata.formats.image/imageresourceblock/name) { get; } | الحصول على اسم كتلة مورد الصورة. |
...
| [Signature](../../groupdocs.metadata.formats.image/imageresourceblock/signature) { get; } | الحصول على توقيع كتلة مورد الصورة. |
