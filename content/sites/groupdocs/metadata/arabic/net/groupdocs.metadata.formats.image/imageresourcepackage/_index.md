...
description: يمثل حزمة بيانات أولية تحتوي على Photoshop Image Resources .
type: docs
weight: 1760
url: /ar/net/groupdocs.metadata.formats.image/imageresourcepackage/
---
## ImageResourcePackage class

يمثل حزمة بيانات أولية تحتوي على Photoshop Image Resources .
...
| [ToList](../../groupdocs.metadata.formats.image/imageresourcepackage/tolist)() | إنشاء قائمة من الحزمة . |
