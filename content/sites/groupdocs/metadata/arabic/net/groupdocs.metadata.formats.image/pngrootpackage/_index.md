...
description: يمثل الحزمة الجذرية المخصصة للعمل مع البيانات الوصفية في صورة PNG.
type: docs
weight: 1860
url: /ar/net/groupdocs.metadata.formats.image/pngrootpackage/
---
## PngRootPackage class

يمثل الحزمة الجذرية المخصصة للعمل مع البيانات الوصفية في صورة PNG.
...
| [ExifPackage](../../groupdocs.metadata.formats.image/pngrootpackage/exifpackage) { get; set; } | الحصول على حزمة بيانات تعريف EXIF أو تعيينها. |
...
| [PngPackage](../../groupdocs.metadata.formats.image/pngrootpackage/pngpackage) { get; } | الحصول على حزمة البيانات الوصفية الأصلية لـ PNG. |
...
| [XmpPackage](../../groupdocs.metadata.formats.image/pngrootpackage/xmppackage) { get; set; } | الحصول على حزمة بيانات تعريف XMP أو تعيينها. |
...
* [العمل مع البيانات الوصفية في صور PNG](https://docs.groupdocs.com/display/metadatanet/Working+with+metadata+in+PNG+images)
