...
description: يمثل الحزمة الجذرية التي تسمح بالعمل مع البيانات الأولية في مستند Photoshop.
type: docs
weight: 1930
url: /ar/net/groupdocs.metadata.formats.image/psdrootpackage/
---
## PsdRootPackage class

يمثل الحزمة الجذرية التي تسمح بالعمل مع البيانات الأولية في مستند Photoshop.
...
| [ExifPackage](../../groupdocs.metadata.formats.image/psdrootpackage/exifpackage) { get; set; } | الحصول على حزمة بيانات تعريف EXIF أو تعيينها. |
...
| [ImageResourcePackage](../../groupdocs.metadata.formats.image/psdrootpackage/imageresourcepackage) { get; } | الحصول على حزمة البيانات الأولية لمورد صورة Photoshop . كتل موارد الصورة هي وحدة البناء الأساسية لتنسيق ملف Photoshop الأصلي. |
| [IptcPackage](../../groupdocs.metadata.formats.image/psdrootpackage/iptcpackage) { get; set; } | الحصول على حزمة بيانات تعريف IPTC أو تعيينها. |
...
| [PsdPackage](../../groupdocs.metadata.formats.image/psdrootpackage/psdpackage) { get; } | يحصل على حزمة البيانات الأولية التي تحتوي على معلومات حول ملف PSD. |
| [XmpPackage](../../groupdocs.metadata.formats.image/psdrootpackage/xmppackage) { get; set; } | الحصول على حزمة بيانات تعريف XMP أو تعيينها. |
