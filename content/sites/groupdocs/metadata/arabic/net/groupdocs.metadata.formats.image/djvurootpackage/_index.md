...
description: يمثل الحزمة الجذر المخصصة للعمل مع البيانات الوصفية في صورة DjVu.
type: docs
weight: 1690
url: /ar/net/groupdocs.metadata.formats.image/djvurootpackage/
---
## DjVuRootPackage class

يمثل الحزمة الجذر المخصصة للعمل مع البيانات الوصفية في صورة DjVu.
