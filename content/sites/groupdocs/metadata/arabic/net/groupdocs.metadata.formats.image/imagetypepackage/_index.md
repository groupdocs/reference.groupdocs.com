...
description: يمثل حزمة بيانات وصفية تحتوي على معلومات تنسيق ملف خاص بالصورة.
type: docs
weight: 1780
url: /ar/net/groupdocs.metadata.formats.image/imagetypepackage/
---
## ImageTypePackage class

يمثل حزمة بيانات وصفية تحتوي على معلومات تنسيق ملف خاص بالصورة.
