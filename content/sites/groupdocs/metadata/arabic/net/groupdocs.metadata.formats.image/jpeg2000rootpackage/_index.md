...
description: يمثل الحزمة الجذر المخصصة للعمل مع البيانات الوصفية في صورة JPEG2000 .
type: docs
weight: 1800
url: /ar/net/groupdocs.metadata.formats.image/jpeg2000rootpackage/
---
## Jpeg2000RootPackage class

يمثل الحزمة الجذر المخصصة للعمل مع البيانات الوصفية في صورة JPEG2000 .
...
| [ExifPackage](../../groupdocs.metadata.formats.image/jpeg2000rootpackage/exifpackage) { get; set; } | الحصول على حزمة بيانات تعريف EXIF أو تعيينها. |
...
| [Jpeg2000Package](../../groupdocs.metadata.formats.image/jpeg2000rootpackage/jpeg2000package) { get; } | الحصول على حزمة البيانات الوصفية الأصلية بتنسيق JPEG2000 . |
...
| [XmpPackage](../../groupdocs.metadata.formats.image/jpeg2000rootpackage/xmppackage) { get; set; } | الحصول على حزمة بيانات تعريف XMP أو تعيينها. |
