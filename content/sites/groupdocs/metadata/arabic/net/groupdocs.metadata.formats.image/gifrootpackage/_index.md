...
description: يمثل الحزمة الجذرية المخصصة للعمل مع البيانات الوصفية في صورة GIF.
type: docs
weight: 1720
url: /ar/net/groupdocs.metadata.formats.image/gifrootpackage/
---
## GifRootPackage class

يمثل الحزمة الجذرية المخصصة للعمل مع البيانات الوصفية في صورة GIF.
...
| [FileType](../../groupdocs.metadata.formats.image/gifrootpackage/filetype) { get; } | يحصل على حزمة البيانات الوصفية لنوع الملف. (3 properties) |
| [IsXmpSupported](../../groupdocs.metadata.formats.image/gifrootpackage/isxmpsupported) { get; } | يحصل على قيمة تشير إلى ما إذا كانت بيانات XMP الأولية مدعومة لهذه الصورة. |
...
| [XmpPackage](../../groupdocs.metadata.formats.image/gifrootpackage/xmppackage) { get; set; } | الحصول على حزمة بيانات تعريف XMP أو تعيينها. |
...
* [العمل مع البيانات الوصفية في صور GIF](https://docs.groupdocs.com/display/metadatanet/Working+with+metadata+in+GIF+images)
