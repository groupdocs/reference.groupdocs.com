...
description: يمثل بيانات تعريف PNG الأصلية.
type: docs
weight: 1850
url: /ar/net/groupdocs.metadata.formats.image/pngpackage/
---
## PngPackage class

يمثل بيانات تعريف PNG الأصلية.
...
| [TextChunks](../../groupdocs.metadata.formats.image/pngpackage/textchunks) { get; } | الحصول على مجموعة أجزاء النص المستخرجة من الصورة. |
