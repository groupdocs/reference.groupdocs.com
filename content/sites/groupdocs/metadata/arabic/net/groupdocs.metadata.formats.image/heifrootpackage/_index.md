...
description: يمثل الحزمة الجذرية التي تهدف إلى العمل مع البيانات الوصفية في صورة HEIF.
type: docs
weight: 1730
url: /ar/net/groupdocs.metadata.formats.image/heifrootpackage/
---
## HeifRootPackage class

يمثل الحزمة الجذرية التي تهدف إلى العمل مع البيانات الوصفية في صورة HEIF.
...
| [ExifPackage](../../groupdocs.metadata.formats.image/heifrootpackage/exifpackage) { get; set; } | الحصول على حزمة بيانات تعريف EXIF أو تعيينها. |
...
| [XmpPackage](../../groupdocs.metadata.formats.image/heifrootpackage/xmppackage) { get; set; } | الحصول على حزمة بيانات تعريف XMP أو تعيينها. |
