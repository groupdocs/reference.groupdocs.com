...
description: يمثل الحزمة الجذرية المخصصة للعمل مع البيانات الوصفية في صورة DICOM .
type: docs
weight: 1680
url: /ar/net/groupdocs.metadata.formats.image/dicomrootpackage/
---
## DicomRootPackage class

يمثل الحزمة الجذرية المخصصة للعمل مع البيانات الوصفية في صورة DICOM .
...
| [DicomPackage](../../groupdocs.metadata.formats.image/dicomrootpackage/dicompackage) { get; } | يحصل على حزمة البيانات الوصفية الأصلية لـ DICOM. |
...
يوضح هذا المثال كيفية قراءة خصائص بيانات التعريف الخاصة بتنسيق DICOM.
