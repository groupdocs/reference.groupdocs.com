...
description: يمثل البيانات الوصفية الأصلية بتنسيق JPEG2000 .
type: docs
weight: 1790
url: /ar/net/groupdocs.metadata.formats.image/jpeg2000package/
---
## Jpeg2000Package class

يمثل البيانات الوصفية الأصلية بتنسيق JPEG2000 .
...
| اسم | وصف |
| --- | --- |
| [Comments](../../groupdocs.metadata.formats.image/jpeg2000package/comments) { get; } | الحصول على تعليقات JPEG2000 . |
