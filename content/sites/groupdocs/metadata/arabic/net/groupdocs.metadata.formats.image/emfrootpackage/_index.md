...
description: يمثل الحزمة الجذرية المخصصة للعمل مع البيانات الوصفية في صورة EMF.
type: docs
weight: 1700
url: /ar/net/groupdocs.metadata.formats.image/emfrootpackage/
---
## EmfRootPackage class

يمثل الحزمة الجذرية المخصصة للعمل مع البيانات الوصفية في صورة EMF.
