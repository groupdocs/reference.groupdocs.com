...
description: يمثل مجموعة من خصائص بيانات تعريف CAD المخصصة.
type: docs
weight: 830
url: /ar/net/groupdocs.metadata.formats.cad/cadcustompropertypackage/
---
## CadCustomPropertyPackage class

يمثل مجموعة من خصائص بيانات تعريف CAD المخصصة.
