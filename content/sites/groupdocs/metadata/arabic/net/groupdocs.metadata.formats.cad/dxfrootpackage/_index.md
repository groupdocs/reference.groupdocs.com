...
description: يمثل الحزمة الجذرية التي تسمح بالعمل مع البيانات الوصفية في رسم DXF.
type: docs
weight: 870
url: /ar/net/groupdocs.metadata.formats.cad/dxfrootpackage/
---
## DxfRootPackage class

يمثل الحزمة الجذرية التي تسمح بالعمل مع البيانات الوصفية في رسم DXF.
...
| اسم | وصف |
| --- | --- |
| [CadPackage](../../groupdocs.metadata.formats.cad/cadrootpackage/cadpackage) { get; } | يحصل على حزمة بيانات تعريف CAD. |
