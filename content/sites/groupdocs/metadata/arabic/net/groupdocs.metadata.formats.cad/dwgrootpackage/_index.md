...
description: يمثل الحزمة الجذرية التي تسمح بالعمل مع البيانات الوصفية في رسم DWG.
type: docs
weight: 860
url: /ar/net/groupdocs.metadata.formats.cad/dwgrootpackage/
---
## DwgRootPackage class

يمثل الحزمة الجذرية التي تسمح بالعمل مع البيانات الوصفية في رسم DWG.
