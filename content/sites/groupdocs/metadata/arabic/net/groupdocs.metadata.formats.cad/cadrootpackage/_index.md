...
description: يمثل الحزمة الجذرية التي تسمح بالعمل مع البيانات الوصفية في رسم CAD.
type: docs
weight: 850
url: /ar/net/groupdocs.metadata.formats.cad/cadrootpackage/
---
## CadRootPackage class

يمثل الحزمة الجذرية التي تسمح بالعمل مع البيانات الوصفية في رسم CAD.
...
يوضح نموذج التعليمات البرمجية هذا كيفية قراءة البيانات الوصفية لرسم CAD.
