...
description: بنية تحتوي على خصائص المُلون حامل المستخدم في المستند.
type: docs
weight: 3300
url: /ar/net/groupdocs.metadata.standards.xmp/xmpcolorantbase/
---
## XmpColorantBase class

بنية تحتوي على خصائص المُلون (حامل) المستخدم في المستند.
