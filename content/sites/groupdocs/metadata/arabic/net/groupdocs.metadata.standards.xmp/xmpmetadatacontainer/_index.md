...
description: يمثل حاوية لخصائص بيانات تعريف XMP.
type: docs
weight: 3470
url: /ar/net/groupdocs.metadata.standards.xmp/xmpmetadatacontainer/
---
## XmpMetadataContainer class

يمثل حاوية لخصائص بيانات تعريف XMP.
...
| abstract [GetXmpRepresentation](../../groupdocs.metadata.standards.xmp/xmpmetadatacontainer/getxmprepresentation)() | تحويل قيمة XMP إلى تمثيل XML. |
