...
type: docs
weight: 3340
url: /ar/net/groupdocs.metadata.standards.xmp/xmpcolorantrgb/
---
...
| اسم | وصف |
| --- | --- |
| [XmpColorantRgb](xmpcolorantrgb#constructor)() | يقوم بتهيئة مثيل جديد لملف[`XmpColorantRgb`](../xmpcolorantrgb) فئة . |
| [XmpColorantRgb](xmpcolorantrgb#constructor_1)(byte, byte, byte) | يقوم بتهيئة مثيل جديد لملف[`XmpColorantRgb`](../xmpcolorantrgb) فئة . |

## الخصائص

| اسم | وصف |
| --- | --- |
| [Blue](../../groupdocs.metadata.standards.xmp/xmpcolorantrgb/blue) { get; set; } | الحصول على المكون الأزرق أو تعيينه. |
...
| [Green](../../groupdocs.metadata.standards.xmp/xmpcolorantrgb/green) { get; set; } | الحصول على القيمة الخضراء أو تعيينها. |
...
| [Red](../../groupdocs.metadata.standards.xmp/xmpcolorantrgb/red) { get; set; } | الحصول على المكون الأحمر أو تعيينه. |
