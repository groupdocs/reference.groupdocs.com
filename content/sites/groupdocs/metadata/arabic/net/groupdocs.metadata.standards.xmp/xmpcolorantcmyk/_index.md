...
type: docs
weight: 3310
url: /ar/net/groupdocs.metadata.standards.xmp/xmpcolorantcmyk/
---
...
| اسم | وصف |
| --- | --- |
| [XmpColorantCmyk](xmpcolorantcmyk#constructor)() | يقوم بتهيئة مثيل جديد لملف[`XmpColorantCmyk`](../xmpcolorantcmyk) فئة . |
| [XmpColorantCmyk](xmpcolorantcmyk#constructor_1)(double, double, double, double) | يقوم بتهيئة مثيل جديد لملف[`XmpColorantCmyk`](../xmpcolorantcmyk) فئة . |

## الخصائص

| اسم | وصف |
| --- | --- |
| [Black](../../groupdocs.metadata.standards.xmp/xmpcolorantcmyk/black) { get; set; } | الحصول على أو تعيين المكون الأسود. |
...
| [Cyan](../../groupdocs.metadata.standards.xmp/xmpcolorantcmyk/cyan) { get; set; } | الحصول على أو تعيين المكون السماوي. |
...
| [Magenta](../../groupdocs.metadata.standards.xmp/xmpcolorantcmyk/magenta) { get; set; } | الحصول على أو تعيين المكون الأرجواني. |
...
| [Yellow](../../groupdocs.metadata.standards.xmp/xmpcolorantcmyk/yellow) { get; set; } | الحصول على أو تعيين المكون الأصفر. |
...
| اسم | وصف |
| --- | --- |
| const [ColorValueMax](../../groupdocs.metadata.standards.xmp/xmpcolorantcmyk/colorvaluemax) | الحد الأقصى لقيمة اللون في تلوين CMYK . |
| const [ColorValueMin](../../groupdocs.metadata.standards.xmp/xmpcolorantcmyk/colorvaluemin) | قيمة الحد الأدنى للون في تلوين CMYK. |
