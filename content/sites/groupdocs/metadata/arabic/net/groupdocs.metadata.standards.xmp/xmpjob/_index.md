...
description: يمثل الوظيفة.
type: docs
weight: 3440
url: /ar/net/groupdocs.metadata.standards.xmp/xmpjob/
---
## XmpJob class
...
| اسم | وصف |
| --- | --- |
| [XmpJob](xmpjob)() | يقوم بتهيئة مثيل جديد لملف[`XmpJob`](../xmpjob) فئة . |
...
| [ID](../../groupdocs.metadata.standards.xmp/xmpjob/id) { get; set; } | الحصول على معرّف فريد للوظيفة أو تعيينه. هذا الحقل هو مرجع في بعض أنظمة إدارة الوظائف الخارجية. |
...
| [Name](../../groupdocs.metadata.standards.xmp/xmpjob/name) { get; set; } | الحصول على أو تعيين الاسم غير الرسمي للوظيفة. هذا الاسم لعرض المستخدم والأنظمة غير الرسمية. |
...
| [Url](../../groupdocs.metadata.standards.xmp/xmpjob/url) { get; set; } | الحصول على أو تعيين عنوان URL لملف يشير إلى ملف إدارة وظيفة خارجي. |
