...
description: يوفر فئة أساسية مجردة لحزم بيانات تعريف MakerNote.
type: docs
weight: 2830
url: /ar/net/groupdocs.metadata.standards.exif.makernote/makernotepackage/
---
## MakerNotePackage class

يوفر فئة أساسية مجردة لحزم بيانات تعريف MakerNote.
