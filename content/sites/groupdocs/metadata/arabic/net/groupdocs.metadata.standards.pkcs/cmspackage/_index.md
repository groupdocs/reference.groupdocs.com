...
description: يمثل حزمة بيانات وصفية للتوقيع الرقمي لـ CMS.
type: docs
weight: 3000
url: /ar/net/groupdocs.metadata.standards.pkcs/cmspackage/
---
## CmsPackage class

يمثل حزمة بيانات وصفية للتوقيع الرقمي لـ CMS.
...
| [Flags](../../groupdocs.metadata.standards.pkcs/cmspackage/flags) { get; } | يحصل على أعلام التوقيع الرقمي . |
...
| [Signatures](../../groupdocs.metadata.standards.pkcs/cmspackage/signatures) { get; } | يحصل على مجموعة من التواقيع المستخرجة من الملف. |
