...
description: يمثل حاوية محتوى موقعة تتكون من معرف نوع المحتوى والمحتوى نفسه.
type: docs
weight: 2990
url: /ar/net/groupdocs.metadata.standards.pkcs/cmsencapsulatedcontent/
---
## CmsEncapsulatedContent class

يمثل حاوية محتوى موقعة تتكون من معرف نوع المحتوى والمحتوى نفسه.
...
| اسم | وصف |
| --- | --- |
| [ContentRawData](../../groupdocs.metadata.standards.pkcs/cmsencapsulatedcontent/contentrawdata) { get; } | يحصل على البيانات الأولية لمعلومات المحتوى. |
| [ContentType](../../groupdocs.metadata.standards.pkcs/cmsencapsulatedcontent/contenttype) { get; } | الحصول على معرف الكائن يحدد نوع المحتوى بشكل فريد. |
