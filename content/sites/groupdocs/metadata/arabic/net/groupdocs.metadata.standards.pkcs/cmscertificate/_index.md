...
description: يمثل شهادة CMS .
type: docs
weight: 2980
url: /ar/net/groupdocs.metadata.standards.pkcs/cmscertificate/
---
...
| [NotAfter](../../groupdocs.metadata.standards.pkcs/cmscertificate/notafter) { get; } | الحصول على التاريخ بالتوقيت المحلي الذي تصبح الشهادة بعده غير صالحة. |
| [NotBefore](../../groupdocs.metadata.standards.pkcs/cmscertificate/notbefore) { get; } | الحصول على التاريخ بالتوقيت المحلي الذي تصبح فيه الشهادة صالحة. |
...
| [RawData](../../groupdocs.metadata.standards.pkcs/cmscertificate/rawdata) { get; } | الحصول على البيانات الأولية لهذه الشهادة. |
