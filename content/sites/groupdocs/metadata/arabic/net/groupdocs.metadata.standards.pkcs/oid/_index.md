...
| [FriendlyName](../../groupdocs.metadata.standards.pkcs/oid/friendlyname) { get; } | الحصول على الاسم المألوف . |
...
| [Value](../../groupdocs.metadata.standards.pkcs/oid/value) { get; } | يحصل على قيمة معرف الكائن (OID). |
