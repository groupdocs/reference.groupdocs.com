...
description: يمثل الحزمة الجذرية التي تسمح بالعمل مع البيانات الوصفية في رسالة بريد إلكتروني.
type: docs
weight: 1370
url: /ar/net/groupdocs.metadata.formats.email/emailrootpackage/
---
## EmailRootPackage class

يمثل الحزمة الجذرية التي تسمح بالعمل مع البيانات الوصفية في رسالة بريد إلكتروني.
...
| [EmailPackage](../../groupdocs.metadata.formats.email/emailrootpackage/emailpackage) { get; } | يحصل على حزمة البيانات الوصفية للبريد الإلكتروني. |
