...
description: يمثل الحزمة الجذرية التي تسمح بالعمل مع البيانات الوصفية في رسالة بريد إلكتروني MSG .
type: docs
weight: 1410
url: /ar/net/groupdocs.metadata.formats.email/msgrootpackage/
---
## MsgRootPackage class

يمثل الحزمة الجذرية التي تسمح بالعمل مع البيانات الوصفية في رسالة بريد إلكتروني MSG .
...
| [EmailPackage](../../groupdocs.metadata.formats.email/msgrootpackage/emailpackage) { get; } | يحصل على حزمة البيانات الوصفية لـ MSG . (2 properties) |
...
يوضح نموذج التعليمات البرمجية هذا كيفية استخراج البيانات الوصفية من رسالة MSG.
