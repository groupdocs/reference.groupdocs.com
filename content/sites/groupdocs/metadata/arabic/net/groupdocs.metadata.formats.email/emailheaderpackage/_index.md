...
description: يمثل حزمة بيانات وصفية تحتوي على رؤوس رسائل البريد الإلكتروني.
type: docs
weight: 1350
url: /ar/net/groupdocs.metadata.formats.email/emailheaderpackage/
---
## EmailHeaderPackage class

يمثل حزمة بيانات وصفية تحتوي على رؤوس رسائل البريد الإلكتروني.
...
| [Get](../../groupdocs.metadata.formats.email/emailheaderpackage/get)(string) | يحصل على قيمة الرأس المحدد. |
