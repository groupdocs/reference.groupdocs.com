...
description: يمثل البيانات الوصفية الأصلية في مستند مكتب.
type: docs
weight: 920
url: /ar/net/groupdocs.metadata.formats.document/documentpackage/
---
## DocumentPackage class

يمثل البيانات الوصفية الأصلية في مستند مكتب.
