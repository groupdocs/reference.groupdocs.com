...
description: يمثل تعليق مستخدم في عرض تقديمي.
type: docs
weight: 1060
url: /ar/net/groupdocs.metadata.formats.document/presentationcomment/
---
## PresentationComment class

يمثل تعليق مستخدم في عرض تقديمي.
...
| اسم | وصف |
| --- | --- |
| [Author](../../groupdocs.metadata.formats.document/presentationcomment/author) { get; } | الحصول على كاتب التعليق. |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | الحصول على عدد خصائص البيانات الوصفية. |
| [CreatedTime](../../groupdocs.metadata.formats.document/presentationcomment/createdtime) { get; } | الحصول على وقت إنشاء التعليق. |
...
| [SlideNumber](../../groupdocs.metadata.formats.document/presentationcomment/slidenumber) { get; } | الحصول على رقم الشريحة التي ينتمي إليها التعليق . |
| [Text](../../groupdocs.metadata.formats.document/presentationcomment/text) { get; } | يحصل على نص التعليق. |
