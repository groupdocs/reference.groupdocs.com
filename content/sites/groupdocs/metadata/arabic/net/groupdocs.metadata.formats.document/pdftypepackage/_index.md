...
description: يمثل حزمة بيانات وصفية تحتوي على معلومات تنسيق ملف خاص بـ PDF.
type: docs
weight: 1050
url: /ar/net/groupdocs.metadata.formats.document/pdftypepackage/
---
## PdfTypePackage class

يمثل حزمة بيانات وصفية تحتوي على معلومات تنسيق ملف خاص بـ PDF.
...
| [Version](../../groupdocs.metadata.formats.document/pdftypepackage/version) { get; } | الحصول على نسخة التنسيق . |
