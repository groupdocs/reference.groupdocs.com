...
description: يمثل حقلاً في مستند معالجة الكلمات.
type: docs
weight: 1250
url: /ar/net/groupdocs.metadata.formats.document/wordprocessingfield/
---
## WordProcessingField class

يمثل حقلاً في مستند معالجة الكلمات.
...
| اسم | وصف |
| --- | --- |
| [Code](../../groupdocs.metadata.formats.document/wordprocessingfield/code) { get; } | يحصل على رمز الحقل . |
...
| [Result](../../groupdocs.metadata.formats.document/wordprocessingfield/result) { get; } | يحصل على نتيجة الحقل . |
