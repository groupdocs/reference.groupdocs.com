...
description: يمثل صفحة في قسم OneNote .
type: docs
weight: 960
url: /ar/net/groupdocs.metadata.formats.document/notepage/
---
## NotePage class

يمثل صفحة في قسم OneNote .
...
| اسم | وصف |
| --- | --- |
| [Author](../../groupdocs.metadata.formats.document/notepage/author) { get; } | الحصول على مؤلف الصفحة. |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | الحصول على عدد خصائص البيانات الوصفية. |
| [CreationTime](../../groupdocs.metadata.formats.document/notepage/creationtime) { get; } | يحصل على وقت الإنشاء . |
...
| [LastModificationTime](../../groupdocs.metadata.formats.document/notepage/lastmodificationtime) { get; } | الحصول على وقت التعديل الأخير. |
...
| [Title](../../groupdocs.metadata.formats.document/notepage/title) { get; } | الحصول على عنوان الصفحة. |
