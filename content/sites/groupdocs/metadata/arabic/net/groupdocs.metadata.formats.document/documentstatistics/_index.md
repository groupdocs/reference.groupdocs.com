...
description: يمثل مجموعة من إحصائيات المستند.
type: docs
weight: 940
url: /ar/net/groupdocs.metadata.formats.document/documentstatistics/
---
## DocumentStatistics class

يمثل مجموعة من إحصائيات المستند.
...
| اسم | وصف |
| --- | --- |
| [DocumentStatistics](documentstatistics)() | يقوم بتهيئة مثيل جديد لملف[`DocumentStatistics`](../documentstatistics) فئة . |

## الخصائص

| اسم | وصف |
| --- | --- |
| [CharacterCount](../../groupdocs.metadata.formats.document/documentstatistics/charactercount) { get; } | الحصول على العدد التقديري للأحرف في المستند. |
...
| [PageCount](../../groupdocs.metadata.formats.document/documentstatistics/pagecount) { get; } | الحصول على العدد التقديري للصفحات في المستند. |
...
| [WordCount](../../groupdocs.metadata.formats.document/documentstatistics/wordcount) { get; } | الحصول على العدد التقديري للكلمات في المستند. |
