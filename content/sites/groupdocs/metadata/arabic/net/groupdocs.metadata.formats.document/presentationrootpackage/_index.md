...
description: يمثل الحزمة الجذرية المخصصة للعمل مع البيانات الوصفية في عرض تقديمي.
type: docs
weight: 1100
url: /ar/net/groupdocs.metadata.formats.document/presentationrootpackage/
---
## PresentationRootPackage class

يمثل الحزمة الجذرية المخصصة للعمل مع البيانات الوصفية في عرض تقديمي.
...
| [DocumentStatistics](../../groupdocs.metadata.formats.document/presentationrootpackage/documentstatistics) { get; } | الحصول على حزمة إحصائيات المستند . |
| [FileType](../../groupdocs.metadata.formats.document/presentationrootpackage/filetype) { get; } | يحصل على حزمة البيانات الوصفية لنوع الملف. (2 properties) |
| [InspectionPackage](../../groupdocs.metadata.formats.document/presentationrootpackage/inspectionpackage) { get; } | يحصل على حزمة بيانات وصفية تحتوي على نتائج استقصاء للمستند . تحتوي الحزمة على معلومات حول أجزاء المستند التي يمكن اعتبارها بيانات وصفية في بعض الحالات. |
...
يوضح هذا المثال كيفية استخراج خصائص البيانات الوصفية المضمنة من عرض تقديمي.
