...
description: يمثل حقل نموذج في مستند PDF .
type: docs
weight: 1010
url: /ar/net/groupdocs.metadata.formats.document/pdfformfield/
---
## PdfFormField class

يمثل حقل نموذج في مستند PDF .
...
| [Name](../../groupdocs.metadata.formats.document/pdfformfield/name) { get; } | يحصل على اسم الحقل . |
...
| [Value](../../groupdocs.metadata.formats.document/pdfformfield/value) { get; } | يحصل على قيمة الحقل . |
