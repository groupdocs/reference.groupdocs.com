...
description: يمثل حزمة بيانات وصفية تحتوي على معلومات تنسيق ملف خاص بالعرض التقديمي.
type: docs
weight: 1120
url: /ar/net/groupdocs.metadata.formats.document/presentationtypepackage/
---
## PresentationTypePackage class

يمثل حزمة بيانات وصفية تحتوي على معلومات تنسيق ملف خاص بالعرض التقديمي.
...
| [PresentationFormat](../../groupdocs.metadata.formats.document/presentationtypepackage/presentationformat) { get; } | الحصول على تنسيق العرض التقديمي الدقيق . |
