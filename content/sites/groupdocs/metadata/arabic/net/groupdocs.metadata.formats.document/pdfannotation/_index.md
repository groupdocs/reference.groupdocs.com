...
type: docs
weight: 980
url: /ar/net/groupdocs.metadata.formats.document/pdfannotation/
---
## PdfAnnotation class
...
| [Name](../../groupdocs.metadata.formats.document/pdfannotation/name) { get; } | الحصول على اسم التعليق التوضيحي. |
| [PageNumber](../../groupdocs.metadata.formats.document/pdfannotation/pagenumber) { get; } | الحصول على رقم الصفحة التي تحتوي على التعليق التوضيحي. |
...
| [Text](../../groupdocs.metadata.formats.document/pdfannotation/text) { get; } | الحصول على نص التعليق التوضيحي . |
