...
description: يمثل حزمة بيانات وصفية تحتوي على معلومات تنسيق ملف خاص بجداول البيانات.
type: docs
weight: 1230
url: /ar/net/groupdocs.metadata.formats.document/spreadsheettypepackage/
---
## SpreadsheetTypePackage class

يمثل حزمة بيانات وصفية تحتوي على معلومات تنسيق ملف خاص بجداول البيانات.
...
| [SpreadsheetFormat](../../groupdocs.metadata.formats.document/spreadsheettypepackage/spreadsheetformat) { get; } | الحصول على تنسيق جدول البيانات الدقيق . |
