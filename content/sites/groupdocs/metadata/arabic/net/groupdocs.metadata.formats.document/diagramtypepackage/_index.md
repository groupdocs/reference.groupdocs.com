...
description: يمثل حزمة بيانات وصفية تحتوي على معلومات تنسيق ملف خاص بالرسم التخطيطي.
type: docs
weight: 910
url: /ar/net/groupdocs.metadata.formats.document/diagramtypepackage/
---
## DiagramTypePackage class

يمثل حزمة بيانات وصفية تحتوي على معلومات تنسيق ملف خاص بالرسم التخطيطي.
...
| [DiagramFormat](../../groupdocs.metadata.formats.document/diagramtypepackage/diagramformat) { get; } | الحصول على تنسيق الرسم التخطيطي الدقيق. |
