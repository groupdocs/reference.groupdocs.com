...
description: يحتوي على معلومات حول أجزاء مستند PDF التي يمكن اعتبارها بيانات وصفية في بعض الحالات.
type: docs
weight: 1020
url: /ar/net/groupdocs.metadata.formats.document/pdfinspectionpackage/
---
## PdfInspectionPackage class

يحتوي على معلومات حول أجزاء مستند PDF التي يمكن اعتبارها بيانات وصفية في بعض الحالات.
...
| اسم | وصف |
| --- | --- |
| [Annotations](../../groupdocs.metadata.formats.document/pdfinspectionpackage/annotations) { get; } | الحصول على مجموعة من التعليقات التوضيحية . |
| [Attachments](../../groupdocs.metadata.formats.document/pdfinspectionpackage/attachments) { get; } | يحصل على مجموعة من المرفقات. |
| [Bookmarks](../../groupdocs.metadata.formats.document/pdfinspectionpackage/bookmarks) { get; } | يحصل على مجموعة من الإشارات المرجعية . |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | الحصول على عدد خصائص البيانات الوصفية. |
| [DigitalSignatures](../../groupdocs.metadata.formats.document/pdfinspectionpackage/digitalsignatures) { get; } | الحصول على مجموعة من التوقيعات الرقمية. |
| [Fields](../../groupdocs.metadata.formats.document/pdfinspectionpackage/fields) { get; } | يحصل على مصفوفة من حقول النموذج . |
...
| [ClearAnnotations](../../groupdocs.metadata.formats.document/pdfinspectionpackage/clearannotations)() | يزيل كافة التعليقات التوضيحية التي تم اكتشافها من المستند. |
| [ClearAttachments](../../groupdocs.metadata.formats.document/pdfinspectionpackage/clearattachments)() | يزيل كافة المرفقات المكتشفة من المستند. |
| [ClearBookmarks](../../groupdocs.metadata.formats.document/pdfinspectionpackage/clearbookmarks)() | يزيل كافة الإشارات المرجعية المكتشفة من المستند. |
| [ClearDigitalSignatures](../../groupdocs.metadata.formats.document/pdfinspectionpackage/cleardigitalsignatures)() | يزيل كل التوقيعات الرقمية المكتشفة من المستند. |
| [ClearFields](../../groupdocs.metadata.formats.document/pdfinspectionpackage/clearfields)() | يزيل جميع حقول النموذج المكتشفة من المستند. |
...
| override [RemoveProperties](../../groupdocs.metadata.formats.document/pdfinspectionpackage/removeproperties)(Func&lt;MetadataProperty, bool&gt;) | يزيل خصائص البيانات الوصفية التي تفي بالتقييم المحدد. |
| override [Sanitize](../../groupdocs.metadata.formats.document/pdfinspectionpackage/sanitize)() | إزالة خصائص البيانات الوصفية القابلة للكتابة من الحزمة. العملية متكررة لذا فهي تؤثر على جميع الحزم المتداخلة أيضًا. |
...
يوضح نموذج التعليمات البرمجية هذا كيفية إزالة خصائص الفحص في مستند PDF.
