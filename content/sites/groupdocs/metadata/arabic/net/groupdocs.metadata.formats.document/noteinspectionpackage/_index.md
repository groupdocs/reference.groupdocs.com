...
description: يمثل حزمة بيانات وصفية تعرض الهيكل الداخلي لقسم الملاحظات.
type: docs
weight: 950
url: /ar/net/groupdocs.metadata.formats.document/noteinspectionpackage/
---
## NoteInspectionPackage class

يمثل حزمة بيانات وصفية تعرض الهيكل الداخلي لقسم الملاحظات.
...
| [Pages](../../groupdocs.metadata.formats.document/noteinspectionpackage/pages) { get; } | الحصول على مصفوفة من صفحات الأقسام. |
