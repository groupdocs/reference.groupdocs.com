...
description: يمثل تعليقًا في مستند معالجة الكلمات.
type: docs
weight: 1240
url: /ar/net/groupdocs.metadata.formats.document/wordprocessingcomment/
---
## WordProcessingComment class

يمثل تعليقًا في مستند معالجة الكلمات.
...
| اسم | وصف |
| --- | --- |
| [Author](../../groupdocs.metadata.formats.document/wordprocessingcomment/author) { get; set; } | الحصول على أو تعيين المؤلف. |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | الحصول على عدد خصائص البيانات الوصفية. |
| [CreatedDate](../../groupdocs.metadata.formats.document/wordprocessingcomment/createddate) { get; set; } | الحصول على أو تحديد تاريخ إنشاء التعليق. |
| [Id](../../groupdocs.metadata.formats.document/wordprocessingcomment/id) { get; } | يحصل على معرف التعليق. |
| [Initials](../../groupdocs.metadata.formats.document/wordprocessingcomment/initials) { get; set; } | الحصول على أو تعيين الأحرف الأولى للمؤلف. |
...
| [Text](../../groupdocs.metadata.formats.document/wordprocessingcomment/text) { get; set; } | الحصول على نص التعليق أو تعيينه. |
