...
description: يمثل تعليق مستخدم في جدول بيانات.
type: docs
weight: 1150
url: /ar/net/groupdocs.metadata.formats.document/spreadsheetcomment/
---
## SpreadsheetComment class

يمثل تعليق مستخدم في جدول بيانات.
...
| اسم | وصف |
| --- | --- |
| [Author](../../groupdocs.metadata.formats.document/spreadsheetcomment/author) { get; } | الحصول على كاتب التعليق. |
| [Column](../../groupdocs.metadata.formats.document/spreadsheetcomment/column) { get; } | الحصول على فهرس العمود الواحد للتعليق. |
...
| [Row](../../groupdocs.metadata.formats.document/spreadsheetcomment/row) { get; } | الحصول على فهرس صف واحد للتعليق. |
| [SheetNumber](../../groupdocs.metadata.formats.document/spreadsheetcomment/sheetnumber) { get; } | الحصول على رقم الورقة. |
| [Text](../../groupdocs.metadata.formats.document/spreadsheetcomment/text) { get; } | يحصل على نص التعليق. |
