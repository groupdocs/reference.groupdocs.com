...
description: يمثل ورقة في مستند جدول بيانات.
type: docs
weight: 1220
url: /ar/net/groupdocs.metadata.formats.document/spreadsheetsheet/
---
## SpreadsheetSheet class

يمثل ورقة في مستند جدول بيانات.
...
| [Name](../../groupdocs.metadata.formats.document/spreadsheetsheet/name) { get; } | الحصول على اسم الورقة . |
| [Number](../../groupdocs.metadata.formats.document/spreadsheetsheet/number) { get; } | الحصول على رقم الورقة. |
