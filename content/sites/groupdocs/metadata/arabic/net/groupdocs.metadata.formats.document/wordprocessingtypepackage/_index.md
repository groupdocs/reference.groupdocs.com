...
description: يمثل حزمة بيانات وصفية تحتوي على معلومات تنسيق ملف خاص بالوثيقة.
type: docs
weight: 1320
url: /ar/net/groupdocs.metadata.formats.document/wordprocessingtypepackage/
---
## WordProcessingTypePackage class

يمثل حزمة بيانات وصفية تحتوي على معلومات تنسيق ملف خاص بالوثيقة.
...
| [WordProcessingFormat](../../groupdocs.metadata.formats.document/wordprocessingtypepackage/wordprocessingformat) { get; } | الحصول على تنسيق معالجة الكلمات الدقيق . |
