...
description: يمثل إشارة مرجعية في مستند PDF .
type: docs
weight: 1000
url: /ar/net/groupdocs.metadata.formats.document/pdfbookmark/
---
## PdfBookmark class

يمثل إشارة مرجعية في مستند PDF .
...
| [Title](../../groupdocs.metadata.formats.document/pdfbookmark/title) { get; } | الحصول على عنوان الإشارة المرجعية. |
