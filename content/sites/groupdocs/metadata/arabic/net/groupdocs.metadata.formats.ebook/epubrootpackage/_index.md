...
description: يمثل الحزمة الجذرية التي تسمح بالعمل مع البيانات الوصفية في كتاب إلكتروني EPUB.
type: docs
weight: 1340
url: /ar/net/groupdocs.metadata.formats.ebook/epubrootpackage/
---
## EpubRootPackage class

يمثل الحزمة الجذرية التي تسمح بالعمل مع البيانات الوصفية في كتاب إلكتروني EPUB.
...
| [DublinCorePackage](../../groupdocs.metadata.formats.ebook/epubrootpackage/dublincorepackage) { get; } | الحصول على حزمة بيانات تعريف دبلن كور المستخرجة من الكتاب الإلكتروني. |
| [EpubPackage](../../groupdocs.metadata.formats.ebook/epubrootpackage/epubpackage) { get; } | يحصل على حزمة البيانات الوصفية EPUB . |
...
* مساحة الاسم [GroupDocs.Metadata.Formats.Ebook](../../groupdocs.metadata.formats.ebook)
