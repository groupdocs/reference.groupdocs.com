...
description: يمثل vCard تاريخ وقت تسجيل فئة البيانات الوصفية.
type: docs
weight: 690
url: /ar/net/groupdocs.metadata.formats.businesscard/vcarddatetimerecord/
---
## VCardDateTimeRecord class

يمثل vCard تاريخ وقت تسجيل فئة البيانات الوصفية.
...
| override [ContentType](../../groupdocs.metadata.formats.businesscard/vcarddatetimerecord/contenttype) { get; } | يحصل على نوع محتوى السجل . |
...
| [Value](../../groupdocs.metadata.formats.businesscard/vcarddatetimerecord/value) { get; } | يحصل على قيمة السجل . |
