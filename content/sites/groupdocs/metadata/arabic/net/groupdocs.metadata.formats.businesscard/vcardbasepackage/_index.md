...
description: يمثل فئة بيانات تعريف VCard الأساسية.
type: docs
weight: 620
url: /ar/net/groupdocs.metadata.formats.businesscard/vcardbasepackage/
---
## VCardBasePackage class

يمثل فئة بيانات تعريف VCard الأساسية.
