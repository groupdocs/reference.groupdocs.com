...
description: يمثل فئة البيانات الوصفية لسجل vCard الملخص.
type: docs
weight: 770
url: /ar/net/groupdocs.metadata.formats.businesscard/vcardrecord/
---
## VCardRecord class

يمثل فئة البيانات الوصفية لسجل vCard الملخص.
...
| abstract [ContentType](../../groupdocs.metadata.formats.businesscard/vcardrecord/contenttype) { get; } | يحصل على نوع محتوى السجل . |
