...
description: يمثل VCF ملف جهة اتصال ظاهري بيانات وصفية لتنسيق بطاقة العمل الإلكترونية.
type: docs
weight: 760
url: /ar/net/groupdocs.metadata.formats.businesscard/vcardpackage/
---
## VCardPackage class

يمثل VCF (ملف جهة اتصال ظاهري) بيانات وصفية لتنسيق بطاقة العمل الإلكترونية.
...
| اسم | وصف |
| --- | --- |
| [Cards](../../groupdocs.metadata.formats.businesscard/vcardpackage/cards) { get; } | يحصل على مجموعة من البطاقات المستخرجة من الملف. |
