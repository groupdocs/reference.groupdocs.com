...
description: يمثل مجموعة من سجلات vCard الخاصة بعناوين التسليم. هذه الأنواع معنية بالمعلومات المتعلقة بـ عنونة التسليم أو التسمية الخاصة بكائن vCard .
type: docs
weight: 700
url: /ar/net/groupdocs.metadata.formats.businesscard/vcarddeliveryaddressingrecordset/
---
## VCardDeliveryAddressingRecordset class

يمثل مجموعة من سجلات vCard الخاصة بعناوين التسليم. هذه الأنواع معنية بالمعلومات المتعلقة بـ عنونة التسليم أو التسمية الخاصة بكائن vCard .
...
| اسم | وصف |
| --- | --- |
| [Addresses](../../groupdocs.metadata.formats.businesscard/vcarddeliveryaddressingrecordset/addresses) { get; } | يحصل على مكونات عنوان تسليم الكائن. |
| [AddressRecords](../../groupdocs.metadata.formats.businesscard/vcarddeliveryaddressingrecordset/addressrecords) { get; } | يحصل على مكونات عنوان تسليم الكائن. |
...
| [LabelRecords](../../groupdocs.metadata.formats.businesscard/vcarddeliveryaddressingrecordset/labelrecords) { get; } | يحصل على مصفوفة تحتوي على نص منسق مطابق لعنوان تسليم الكائن. |
| [Labels](../../groupdocs.metadata.formats.businesscard/vcarddeliveryaddressingrecordset/labels) { get; } | يحصل على مصفوفة تحتوي على نص منسق مطابق لعنوان تسليم الكائن. |
