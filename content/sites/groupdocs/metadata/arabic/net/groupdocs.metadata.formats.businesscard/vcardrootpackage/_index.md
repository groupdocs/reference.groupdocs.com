...
description: يمثل الحزمة الجذرية التي تسمح بالعمل مع البيانات الوصفية في ملف VCard.
type: docs
weight: 790
url: /ar/net/groupdocs.metadata.formats.businesscard/vcardrootpackage/
---
## VCardRootPackage class

يمثل الحزمة الجذرية التي تسمح بالعمل مع البيانات الوصفية في ملف VCard.
...
| [VCardPackage](../../groupdocs.metadata.formats.businesscard/vcardrootpackage/vcardpackage) { get; } | يحصل على حزمة بيانات تعريف VCard . |
...
يوضح نموذج التعليمات البرمجية هذا كيفية قراءة خصائص البيانات الوصفية لملف vCard.
