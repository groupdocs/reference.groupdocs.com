...
description: يمثل فئة البيانات الوصفية لسجل نص vCard.
type: docs
weight: 810
url: /ar/net/groupdocs.metadata.formats.businesscard/vcardtextrecord/
---
## VCardTextRecord class

يمثل فئة البيانات الوصفية لسجل نص vCard.
...
| [CharsetParameter](../../groupdocs.metadata.formats.businesscard/vcardtextrecord/charsetparameter) { get; } | يحصل على معلمة مجموعة الأحرف. |
| override [ContentType](../../groupdocs.metadata.formats.businesscard/vcardtextrecord/contenttype) { get; } | يحصل على نوع محتوى السجل . |
...
| [IsQuotedPrintable](../../groupdocs.metadata.formats.businesscard/vcardtextrecord/isquotedprintable) { get; } | يحصل على قيمة تشير إلى ما إذا كان هذا المثيل مقتبسًا من سلسلة قابلة للطباعة. |
...
| [MediaTypeParameter](../../groupdocs.metadata.formats.businesscard/vcardtextrecord/mediatypeparameter) { get; } | يحصل على قيمة معلمة نوع الوسائط. |
...
| [Value](../../groupdocs.metadata.formats.businesscard/vcardtextrecord/value) { get; } | يحصل على قيمة السجل . |
...
| [GetReadabilityValue](../../groupdocs.metadata.formats.businesscard/vcardtextrecord/getreadabilityvalue)(string) | يحصل على قيمة المقروئية. |
