...
description: يمثل مجموعة من سجلات vCard الخاصة بالتقويم.
type: docs
weight: 640
url: /ar/net/groupdocs.metadata.formats.businesscard/vcardcalendarrecordset/
---
## VCardCalendarRecordset class

يمثل مجموعة من سجلات vCard الخاصة بالتقويم.
...
| اسم | وصف |
| --- | --- |
| [BusyTimeEntries](../../groupdocs.metadata.formats.businesscard/vcardcalendarrecordset/busytimeentries) { get; } | الحصول على URIs لوقت الانشغال المرتبط بالكائن. |
| [BusyTimeRecords](../../groupdocs.metadata.formats.businesscard/vcardcalendarrecordset/busytimerecords) { get; } | الحصول على URIs لوقت الانشغال المرتبط بالكائن. |
| [CalendarAddresses](../../groupdocs.metadata.formats.businesscard/vcardcalendarrecordset/calendaraddresses) { get; } | يحصل على عناوين مستخدم التقويم التي يجب إرسال طلب الجدولة إليها للكائن الذي يمثله vCard . |
| [CalendarAddressRecords](../../groupdocs.metadata.formats.businesscard/vcardcalendarrecordset/calendaraddressrecords) { get; } | يحصل على عناوين مستخدم التقويم التي يجب إرسال طلب الجدولة إليها للكائن الذي يمثله vCard . |
| [CalendarUriRecords](../../groupdocs.metadata.formats.businesscard/vcardcalendarrecordset/calendarurirecords) { get; } | الحصول على URIs للتقويم المرتبط بالكائن الذي يمثله vCard . |
...
| [UriCalendarEntries](../../groupdocs.metadata.formats.businesscard/vcardcalendarrecordset/uricalendarentries) { get; } | الحصول على URIs للتقويم المرتبط بالكائن الذي يمثله vCard . |
