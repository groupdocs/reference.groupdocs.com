...
description: يمثل فئة بيانات تعريف السجل المخصص لـ vCard.
type: docs
weight: 680
url: /ar/net/groupdocs.metadata.formats.businesscard/vcardcustomrecord/
---
## VCardCustomRecord class

يمثل فئة بيانات تعريف السجل المخصص لـ vCard.
...
| override [ContentType](../../groupdocs.metadata.formats.businesscard/vcardcustomrecord/contenttype) { get; } | يحصل على نوع محتوى السجل . |
...
| [Value](../../groupdocs.metadata.formats.businesscard/vcardcustomrecord/value) { get; } | يحصل على قيمة السجل . |
