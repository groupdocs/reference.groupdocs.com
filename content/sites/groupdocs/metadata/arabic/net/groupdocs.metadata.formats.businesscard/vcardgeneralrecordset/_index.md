...
description: يمثل مجموعة من سجلات vCard العامة.
type: docs
weight: 720
url: /ar/net/groupdocs.metadata.formats.businesscard/vcardgeneralrecordset/
---
## VCardGeneralRecordset class

يمثل مجموعة من سجلات vCard العامة.
...
| [Kind](../../groupdocs.metadata.formats.businesscard/vcardgeneralrecordset/kind) { get; } | يحصل على نوع الكائن . |
| [MetadataType](../../groupdocs.metadata.common/metadatapackage/metadatatype) { get; } | الحصول على نوع البيانات الوصفية . |
| [NameOfSource](../../groupdocs.metadata.formats.businesscard/vcardgeneralrecordset/nameofsource) { get; } | يحصل على التمثيل النصي لخاصية المصدر. |
...
| [SourceRecords](../../groupdocs.metadata.formats.businesscard/vcardgeneralrecordset/sourcerecords) { get; } | يحصل على مصفوفة مصادر معلومات الدليل الموجودة في نوع المحتوى. |
| [Sources](../../groupdocs.metadata.formats.businesscard/vcardgeneralrecordset/sources) { get; } | يحصل على مصفوفة تحتوي على مصادر معلومات الدليل الموجودة في نوع المحتوى. |
| [XmlEntries](../../groupdocs.metadata.formats.businesscard/vcardgeneralrecordset/xmlentries) { get; } | يحصل على مصفوفة تحتوي على بيانات vCard بتشفير XML. |
| [XmlRecords](../../groupdocs.metadata.formats.businesscard/vcardgeneralrecordset/xmlrecords) { get; } | يحصل على مصفوفة تحتوي على بيانات vCard بتشفير XML. |
