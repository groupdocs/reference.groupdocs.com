...
description: يمثل فئة بيانات تعريف سجل وكيل vCard.
type: docs
weight: 610
url: /ar/net/groupdocs.metadata.formats.businesscard/vcardagentrecord/
---
## VCardAgentRecord class

يمثل فئة بيانات تعريف سجل وكيل vCard.
...
| override [ContentType](../../groupdocs.metadata.formats.businesscard/vcardagentrecord/contenttype) { get; } | يحصل على نوع محتوى السجل . |
...
| [Value](../../groupdocs.metadata.formats.businesscard/vcardagentrecord/value) { get; } | يحصل على قيمة السجل . |
