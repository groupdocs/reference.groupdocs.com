...
description: يمثل الحزمة الجذرية التي تسمح بالعمل مع البيانات الوصفية في أرشيف ZIP .
type: docs
weight: 370
url: /ar/net/groupdocs.metadata.formats.archive/ziprootpackage/
---
## ZipRootPackage class

يمثل الحزمة الجذرية التي تسمح بالعمل مع البيانات الوصفية في أرشيف ZIP .
...
| [ZipPackage](../../groupdocs.metadata.formats.archive/ziprootpackage/zippackage) { get; } | يحصل على حزمة البيانات الوصفية من نوع ZIP . |
