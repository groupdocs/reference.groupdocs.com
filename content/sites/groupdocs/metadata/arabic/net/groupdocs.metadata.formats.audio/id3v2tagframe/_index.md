...
description: يمثل إطارًا عامًا في ملفID3V2Tag./id3v2tag .
type: docs
weight: 500
url: /ar/net/groupdocs.metadata.formats.audio/id3v2tagframe/
---
## ID3V2TagFrame class

يمثل إطارًا عامًا في ملف[`ID3V2Tag`](../id3v2tag) .
...
| اسم | وصف |
| --- | --- |
| [ID3V2TagFrame](id3v2tagframe)(string, byte[]) | يقوم بتهيئة مثيل جديد لملف[`ID3V2TagFrame`](../id3v2tagframe) فئة . |
