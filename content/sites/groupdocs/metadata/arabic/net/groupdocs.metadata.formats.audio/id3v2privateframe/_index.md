...
description: يمثل إطار PRIV في ملفID3V2Tag./id3v2tag . يستخدم الإطار لاحتواء معلومات من منتج برمجيات أن برنامجه يستخدم ولا يتناسب مع الإطارات الأخرى .
type: docs
weight: 480
url: /ar/net/groupdocs.metadata.formats.audio/id3v2privateframe/
---
## ID3V2PrivateFrame class

يمثل إطار PRIV في ملف[`ID3V2Tag`](../id3v2tag) . يستخدم الإطار لاحتواء معلومات من منتج برمجيات أن برنامجه يستخدم ولا يتناسب مع الإطارات الأخرى .
...
| اسم | وصف |
| --- | --- |
| [ID3V2PrivateFrame](id3v2privateframe)(string, byte[]) | يقوم بتهيئة مثيل جديد لملف[`ID3V2PrivateFrame`](../id3v2privateframe) فئة . |

## الخصائص

| اسم | وصف |
| --- | --- |
| [BinaryData](../../groupdocs.metadata.formats.audio/id3v2privateframe/binarydata) { get; } | يحصل على البيانات الثنائية . |
...
| [OwnerIdentifier](../../groupdocs.metadata.formats.audio/id3v2privateframe/owneridentifier) { get; } | الحصول على معرف المالك. |
