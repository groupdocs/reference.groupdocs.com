...
description: يمثل إطار نص في ملفID3V2Tag./id3v2tag . تقع جميع الإطارات التي تبدأ بحرف T تقريبًا في هذه الفئة. هناك استثناء واحد فقط  وهو إطار TXXX الذي يمثله ملفID3V2UserDefinedFrame./id3v2userdefinedframe فئة .
type: docs
weight: 520
url: /ar/net/groupdocs.metadata.formats.audio/id3v2textframe/
---
## ID3V2TextFrame class

يمثل إطار نص في ملف[`ID3V2Tag`](../id3v2tag) . تقع جميع الإطارات التي تبدأ بحرف T تقريبًا في هذه الفئة. هناك استثناء واحد فقط ، وهو إطار TXXX الذي يمثله ملف[`ID3V2UserDefinedFrame`](../id3v2userdefinedframe) فئة .
...
| اسم | وصف |
| --- | --- |
| [ID3V2TextFrame](id3v2textframe)(string, ID3V2EncodingType, string) | يقوم بتهيئة مثيل جديد لملف[`ID3V2TextFrame`](../id3v2textframe) فئة . |
...
| [Text](../../groupdocs.metadata.formats.audio/id3v2textframe/text) { get; } | يحصل على قيمة النص . |
| [TextEncoding](../../groupdocs.metadata.formats.audio/id3v2textframe/textencoding) { get; } | يحصل على ترميز النص. |
