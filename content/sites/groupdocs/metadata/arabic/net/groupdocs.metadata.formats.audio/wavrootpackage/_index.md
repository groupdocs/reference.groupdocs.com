...
description: يمثل الحزمة الجذرية التي تسمح بالعمل مع البيانات الوصفية في صوت WAV.
type: docs
weight: 600
url: /ar/net/groupdocs.metadata.formats.audio/wavrootpackage/
---
## WavRootPackage class

يمثل الحزمة الجذرية التي تسمح بالعمل مع البيانات الوصفية في صوت WAV.
...
| [RiffInfoPackage](../../groupdocs.metadata.formats.audio/wavrootpackage/riffinfopackage) { get; } | يحصل على الحزمة التي تحتوي على علامات معلومات RIFF. |
| [WavPackage](../../groupdocs.metadata.formats.audio/wavrootpackage/wavpackage) { get; } | يحصل على حزمة البيانات الوصفية الأصلية لـ WAV . |
| [XmpPackage](../../groupdocs.metadata.formats.audio/wavrootpackage/xmppackage) { get; set; } | الحصول على حزمة بيانات تعريف XMP أو تعيينها. |
