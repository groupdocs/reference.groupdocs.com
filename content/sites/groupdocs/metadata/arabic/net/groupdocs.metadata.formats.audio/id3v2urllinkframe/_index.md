...
description: يمثل إطار ارتباط URL في ملفID3V2Tag./id3v2tag يبدأ اسم الإطار دائمًا بالحرف W.
type: docs
weight: 530
url: /ar/net/groupdocs.metadata.formats.audio/id3v2urllinkframe/
---
## ID3V2UrlLinkFrame class

يمثل إطار ارتباط URL في ملف[`ID3V2Tag`](../id3v2tag) يبدأ اسم الإطار دائمًا بالحرف W.
...
| اسم | وصف |
| --- | --- |
| [ID3V2UrlLinkFrame](id3v2urllinkframe)(string, string) | يقوم بتهيئة مثيل جديد لملف[`ID3V2UrlLinkFrame`](../id3v2urllinkframe) فئة . |
...
| [Url](../../groupdocs.metadata.formats.audio/id3v2urllinkframe/url) { get; } | يحصل على قيمة URL . |
