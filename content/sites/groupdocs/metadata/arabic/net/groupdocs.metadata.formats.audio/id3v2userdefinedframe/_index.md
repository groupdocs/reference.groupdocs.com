...
description: يمثل إطار TXXX في ملفID3V2Tag./id3v2tag .
type: docs
weight: 540
url: /ar/net/groupdocs.metadata.formats.audio/id3v2userdefinedframe/
---
## ID3V2UserDefinedFrame class

يمثل إطار TXXX في ملف[`ID3V2Tag`](../id3v2tag) .
...
| اسم | وصف |
| --- | --- |
| [ID3V2UserDefinedFrame](id3v2userdefinedframe#constructor_1)(string, string) | يقوم بتهيئة مثيل جديد لملف[`ID3V2UserDefinedFrame`](../id3v2userdefinedframe) فئة . |
| [ID3V2UserDefinedFrame](id3v2userdefinedframe#constructor)(ID3V2EncodingType, string, string) | يقوم بتهيئة مثيل جديد لملف[`ID3V2UserDefinedFrame`](../id3v2userdefinedframe) فئة . |
...
| [Description](../../groupdocs.metadata.formats.audio/id3v2userdefinedframe/description) { get; } | يحصل على الوصف . |
| [Encoding](../../groupdocs.metadata.formats.audio/id3v2userdefinedframe/encoding) { get; } | يحصل على تشفير الإطار . |
...
| [Value](../../groupdocs.metadata.formats.audio/id3v2userdefinedframe/value) { get; } | يحصل على القيمة . |
