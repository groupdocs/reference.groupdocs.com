...
description: يمثل فئة مجردة أساسية لعلامات الصوت ID3 v1 و ID3 v2.
type: docs
weight: 390
url: /ar/net/groupdocs.metadata.formats.audio/id3tag/
---
## ID3Tag class

يمثل فئة مجردة أساسية لعلامات الصوت ID3 (v1) و ID3 (v2).
...
| abstract [Version](../../groupdocs.metadata.formats.audio/id3tag/version) { get; } | يحصل على نسخة علامة ID3 في تنسيق سلسلة. على سبيل المثال: "ID3v1.1" . |
