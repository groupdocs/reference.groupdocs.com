...
description: يمثل حزمة بيانات تعريف خط OpenType.
type: docs
weight: 1530
url: /ar/net/groupdocs.metadata.formats.font/opentypepackage/
---
## OpenTypePackage class

يمثل حزمة بيانات تعريف خط OpenType.
...
| [Fonts](../../groupdocs.metadata.formats.font/opentypepackage/fonts) { get; } | يحصل على مصفوفة من الخطوط المستخرجة من الملف. |
