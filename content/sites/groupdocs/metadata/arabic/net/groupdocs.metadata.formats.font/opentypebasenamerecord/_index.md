...
description: يمثل فئة سجل جدول اسم OpenType الأساسي.
type: docs
weight: 1420
url: /ar/net/groupdocs.metadata.formats.font/opentypebasenamerecord/
---
## OpenTypeBaseNameRecord class

يمثل فئة سجل جدول اسم OpenType الأساسي.
...
| [NameID](../../groupdocs.metadata.formats.font/opentypebasenamerecord/nameid) { get; } | الحصول على معرف الاسم. |
| [Platform](../../groupdocs.metadata.formats.font/opentypebasenamerecord/platform) { get; } | يحصل على معرف النظام الأساسي . |
...
| [Value](../../groupdocs.metadata.formats.font/opentypebasenamerecord/value) { get; } | يحصل على قيمة السلسلة للسجل . |
