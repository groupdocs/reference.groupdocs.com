...
description: MSG ईमेल संदेश में मेटडेट के सथ कम करने क अनुमत देने वले रूट पैकेज क प्रतनधत्व करत है
type: docs
weight: 1410
url: /hi/net/groupdocs.metadata.formats.email/msgrootpackage/
---
## MsgRootPackage class

MSG ईमेल संदेश में मेटाडेटा के साथ काम करने की अनुमति देने वाले रूट पैकेज का प्रतिनिधित्व करता है।
...
| [EmailPackage](../../groupdocs.metadata.formats.email/msgrootpackage/emailpackage) { get; } | एमएसजी मेटाडेटा पैकेज प्राप्त करता है। (2 properties) |
...
यह कोड नमूना दिखाता है कि MSG संदेश से मेटाडेटा कैसे निकाला जाता है।
