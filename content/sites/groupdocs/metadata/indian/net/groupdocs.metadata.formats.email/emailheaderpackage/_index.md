...
description: ईमेल संदेश शर्षलेख वले मेटडेट पैकेज क प्रतनधत्व करत है
type: docs
weight: 1350
url: /hi/net/groupdocs.metadata.formats.email/emailheaderpackage/
---
## EmailHeaderPackage class

ईमेल संदेश शीर्षलेख वाले मेटाडेटा पैकेज का प्रतिनिधित्व करता है।
...
| [Get](../../groupdocs.metadata.formats.email/emailheaderpackage/get)(string) | निर्दिष्ट हेडर का मान प्राप्त करता है। |
