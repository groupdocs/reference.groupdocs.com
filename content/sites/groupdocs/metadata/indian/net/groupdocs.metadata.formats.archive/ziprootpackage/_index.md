...
description: ज़प संग्रह में मेटडेट के सथ कम करने क अनुमत देने वले रूट पैकेज क प्रतनधत्व करत है
type: docs
weight: 370
url: /hi/net/groupdocs.metadata.formats.archive/ziprootpackage/
---
## ZipRootPackage class

ज़िप संग्रह में मेटाडेटा के साथ काम करने की अनुमति देने वाले रूट पैकेज का प्रतिनिधित्व करता है।
...
| [ZipPackage](../../groupdocs.metadata.formats.archive/ziprootpackage/zippackage) { get; } | ZIP मेटाडेटा पैकेज प्राप्त करता है. |
