...
description: भगलक vCard रकर्ड के एक सेट क प्रतनधत्व करत है ये गुण भगलक स्थत य vCard जस वस्तु क प्रतनधत्व करत है उससे जुड़े क्षेत्रं से जुड़ जनकर से संबंधत हैं
type: docs
weight: 730
url: /hi/net/groupdocs.metadata.formats.businesscard/vcardgeographicalrecordset/
---
## VCardGeographicalRecordset class

भौगोलिक vCard रिकॉर्ड के एक सेट का प्रतिनिधित्व करता है। ये गुण भौगोलिक स्थिति या vCard जिस वस्तु का प्रतिनिधित्व करता है उससे जुड़े क्षेत्रों से जुड़ी जानकारी से संबंधित हैं।
...
| [GeographicPositionRecords](../../groupdocs.metadata.formats.businesscard/vcardgeographicalrecordset/geographicpositionrecords) { get; } | वस्तु की वैश्विक स्थिति से संबंधित जानकारी प्राप्त करता है। |
| [GeographicPositions](../../groupdocs.metadata.formats.businesscard/vcardgeographicalrecordset/geographicpositions) { get; } | वस्तु की वैश्विक स्थिति से संबंधित जानकारी प्राप्त करता है। |
...
| [TimeZoneRecords](../../groupdocs.metadata.formats.businesscard/vcardgeographicalrecordset/timezonerecords) { get; } | वस्तु का समय क्षेत्र प्राप्त करता है। |
| [TimeZones](../../groupdocs.metadata.formats.businesscard/vcardgeographicalrecordset/timezones) { get; } | वस्तु का समय क्षेत्र प्राप्त करता है। |
