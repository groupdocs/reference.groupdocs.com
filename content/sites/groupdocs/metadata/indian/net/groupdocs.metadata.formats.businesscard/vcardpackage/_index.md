...
description: वसएफ वर्चुअल कन्टैक्ट फइल इलेक्ट्रनक बजनेस कर्ड फर्मेट मेटडेट क प्रतनधत्व करत है
type: docs
weight: 760
url: /hi/net/groupdocs.metadata.formats.businesscard/vcardpackage/
---
## VCardPackage class

वीसीएफ (वर्चुअल कॉन्टैक्ट फाइल) इलेक्ट्रॉनिक बिजनेस कार्ड फॉर्मेट मेटाडेटा का प्रतिनिधित्व करता है।
...
| नाम | विवरण |
| --- | --- |
| [Cards](../../groupdocs.metadata.formats.businesscard/vcardpackage/cards) { get; } | फ़ाइल से निकाले गए कार्डों की एक सरणी प्राप्त करता है। |
