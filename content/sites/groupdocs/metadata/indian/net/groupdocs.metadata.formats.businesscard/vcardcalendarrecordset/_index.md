...
description: कैलेंडर vCard रकर्ड्स के एक सेट क प्रतनधत्व करत है
type: docs
weight: 640
url: /hi/net/groupdocs.metadata.formats.businesscard/vcardcalendarrecordset/
---
## VCardCalendarRecordset class

कैलेंडर vCard रिकॉर्ड्स के एक सेट का प्रतिनिधित्व करता है।
...
| नाम | विवरण |
| --- | --- |
| [BusyTimeEntries](../../groupdocs.metadata.formats.businesscard/vcardcalendarrecordset/busytimeentries) { get; } | ऑब्जेक्ट से जुड़े व्यस्त समय के लिए यूआरआई प्राप्त करता है। |
| [BusyTimeRecords](../../groupdocs.metadata.formats.businesscard/vcardcalendarrecordset/busytimerecords) { get; } | ऑब्जेक्ट से जुड़े व्यस्त समय के लिए यूआरआई प्राप्त करता है। |
| [CalendarAddresses](../../groupdocs.metadata.formats.businesscard/vcardcalendarrecordset/calendaraddresses) { get; } | उस कैलेंडर उपयोगकर्ता पते को प्राप्त करता है जिस पर vCard. द्वारा दर्शाए गए ऑब्जेक्ट के लिए शेड्यूलिंग अनुरोध भेजा जाना चाहिए |
| [CalendarAddressRecords](../../groupdocs.metadata.formats.businesscard/vcardcalendarrecordset/calendaraddressrecords) { get; } | उस कैलेंडर उपयोगकर्ता पते को प्राप्त करता है जिस पर vCard. द्वारा दर्शाए गए ऑब्जेक्ट के लिए शेड्यूलिंग अनुरोध भेजा जाना चाहिए |
| [CalendarUriRecords](../../groupdocs.metadata.formats.businesscard/vcardcalendarrecordset/calendarurirecords) { get; } | vCard. द्वारा दर्शाए गए ऑब्जेक्ट से जुड़े कैलेंडर के लिए URI प्राप्त करता है |
...
| [UriCalendarEntries](../../groupdocs.metadata.formats.businesscard/vcardcalendarrecordset/uricalendarentries) { get; } | vCard. द्वारा दर्शाए गए ऑब्जेक्ट से जुड़े कैलेंडर के लिए URI प्राप्त करता है |
