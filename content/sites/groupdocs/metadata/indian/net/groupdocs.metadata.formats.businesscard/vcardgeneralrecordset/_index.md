...
description: समन्य vCard रकर्ड के एक सेट क प्रतनधत्व करत है
type: docs
weight: 720
url: /hi/net/groupdocs.metadata.formats.businesscard/vcardgeneralrecordset/
---
## VCardGeneralRecordset class

सामान्य vCard रिकॉर्ड के एक सेट का प्रतिनिधित्व करता है।
...
| [Kind](../../groupdocs.metadata.formats.businesscard/vcardgeneralrecordset/kind) { get; } | वस्तु का प्रकार प्राप्त करता है। |
| [MetadataType](../../groupdocs.metadata.common/metadatapackage/metadatatype) { get; } | मेटाडेटा प्रकार प्राप्त करता है। |
| [NameOfSource](../../groupdocs.metadata.formats.businesscard/vcardgeneralrecordset/nameofsource) { get; } | स्रोत संपत्ति का शाब्दिक प्रतिनिधित्व प्राप्त करता है। |
...
| [SourceRecords](../../groupdocs.metadata.formats.businesscard/vcardgeneralrecordset/sourcerecords) { get; } | सामग्री प्रकार में निहित निर्देशिका जानकारी के स्रोतों की सरणी प्राप्त करता है। |
| [Sources](../../groupdocs.metadata.formats.businesscard/vcardgeneralrecordset/sources) { get; } | सामग्री प्रकार में निहित निर्देशिका जानकारी के स्रोतों वाली एक सरणी प्राप्त करता है। |
| [XmlEntries](../../groupdocs.metadata.formats.businesscard/vcardgeneralrecordset/xmlentries) { get; } | विस्तारित XML-एन्कोडेड vCard डेटा युक्त एक सरणी प्राप्त करता है। |
| [XmlRecords](../../groupdocs.metadata.formats.businesscard/vcardgeneralrecordset/xmlrecords) { get; } | विस्तारित XML-एन्कोडेड vCard डेटा युक्त एक सरणी प्राप्त करता है। |
