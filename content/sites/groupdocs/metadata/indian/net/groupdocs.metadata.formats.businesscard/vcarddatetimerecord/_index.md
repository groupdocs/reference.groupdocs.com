...
description: vCard दनंक समय रकर्ड मेटडेट वर्ग क प्रतनधत्व करत है
type: docs
weight: 690
url: /hi/net/groupdocs.metadata.formats.businesscard/vcarddatetimerecord/
---
## VCardDateTimeRecord class

vCard दिनांक समय रिकॉर्ड मेटाडेटा वर्ग का प्रतिनिधित्व करता है।
...
| override [ContentType](../../groupdocs.metadata.formats.businesscard/vcarddatetimerecord/contenttype) { get; } | सामग्री प्रकार का रिकॉर्ड प्राप्त करता है। |
...
| [Value](../../groupdocs.metadata.formats.businesscard/vcarddatetimerecord/value) { get; } | रिकॉर्ड मान प्राप्त करता है। |
