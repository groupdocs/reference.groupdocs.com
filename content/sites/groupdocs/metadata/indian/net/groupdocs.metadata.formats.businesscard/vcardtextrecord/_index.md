...
description: vCard टेक्स्ट रकर्ड मेटडेट वर्ग क प्रतनधत्व करत है
type: docs
weight: 810
url: /hi/net/groupdocs.metadata.formats.businesscard/vcardtextrecord/
---
## VCardTextRecord class

vCard टेक्स्ट रिकॉर्ड मेटाडेटा वर्ग का प्रतिनिधित्व करता है।
...
| [CharsetParameter](../../groupdocs.metadata.formats.businesscard/vcardtextrecord/charsetparameter) { get; } | वर्णसेट पैरामीटर प्राप्त करता है। |
| override [ContentType](../../groupdocs.metadata.formats.businesscard/vcardtextrecord/contenttype) { get; } | सामग्री प्रकार का रिकॉर्ड प्राप्त करता है। |
...
| [IsQuotedPrintable](../../groupdocs.metadata.formats.businesscard/vcardtextrecord/isquotedprintable) { get; } | एक मान प्राप्त करता है जो इंगित करता है कि यह उदाहरण प्रिंट करने योग्य स्ट्रिंग उद्धृत किया गया है या नहीं। |
...
| [MediaTypeParameter](../../groupdocs.metadata.formats.businesscard/vcardtextrecord/mediatypeparameter) { get; } | मीडिया प्रकार पैरामीटर मान प्राप्त करता है। |
...
| [Value](../../groupdocs.metadata.formats.businesscard/vcardtextrecord/value) { get; } | रिकॉर्ड मान प्राप्त करता है। |
...
| [GetReadabilityValue](../../groupdocs.metadata.formats.businesscard/vcardtextrecord/getreadabilityvalue)(string) | पठनीयता मूल्य प्राप्त करता है। |
