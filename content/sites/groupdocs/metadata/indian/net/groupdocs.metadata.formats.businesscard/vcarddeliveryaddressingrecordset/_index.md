...
description: डलवर एड्रेसंग vCard रकर्ड्स के एक सेट क प्रतनधत्व करत है ये प्रकर vCard ऑब्जेक्ट के लए डलवर एड्रेसंग य लेबल से संबंधत जनकर से संबंधत हैं
type: docs
weight: 700
url: /hi/net/groupdocs.metadata.formats.businesscard/vcarddeliveryaddressingrecordset/
---
## VCardDeliveryAddressingRecordset class

डिलीवरी एड्रेसिंग vCard रिकॉर्ड्स के एक सेट का प्रतिनिधित्व करता है। ये प्रकार vCard ऑब्जेक्ट के लिए डिलीवरी एड्रेसिंग या लेबल से संबंधित जानकारी से संबंधित हैं।
...
| नाम | विवरण |
| --- | --- |
| [Addresses](../../groupdocs.metadata.formats.businesscard/vcarddeliveryaddressingrecordset/addresses) { get; } | वस्तु के वितरण पते के घटक प्राप्त करता है। |
| [AddressRecords](../../groupdocs.metadata.formats.businesscard/vcarddeliveryaddressingrecordset/addressrecords) { get; } | वस्तु के वितरण पते के घटक प्राप्त करता है। |
...
| [LabelRecords](../../groupdocs.metadata.formats.businesscard/vcarddeliveryaddressingrecordset/labelrecords) { get; } | ऑब्जेक्ट के वितरण पते के अनुरूप स्वरूपित पाठ वाली एक सरणी प्राप्त करता है। |
| [Labels](../../groupdocs.metadata.formats.businesscard/vcarddeliveryaddressingrecordset/labels) { get; } | ऑब्जेक्ट के वितरण पते के अनुरूप स्वरूपित पाठ वाली एक सरणी प्राप्त करता है। |
