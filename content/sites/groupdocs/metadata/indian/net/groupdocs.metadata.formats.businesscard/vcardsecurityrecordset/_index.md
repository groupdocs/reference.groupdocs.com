...
description: सुरक्ष vCard रकर्ड के एक सेट क प्रतनधत्व करत है ये गुण संचर मर्गं क सुरक्ष य vCard तक पहुंच से संबंधत हैं
type: docs
weight: 800
url: /hi/net/groupdocs.metadata.formats.businesscard/vcardsecurityrecordset/
---
## VCardSecurityRecordset class

सुरक्षा vCard रिकॉर्ड के एक सेट का प्रतिनिधित्व करता है। ये गुण संचार मार्गों की सुरक्षा या vCard तक पहुंच से संबंधित हैं।
...
| नाम | विवरण |
| --- | --- |
| [AccessClassification](../../groupdocs.metadata.formats.businesscard/vcardsecurityrecordset/accessclassification) { get; } | vCard. में जानकारी की संवेदनशीलता प्राप्त करता है |
| [BinaryPublicKeys](../../groupdocs.metadata.formats.businesscard/vcardsecurityrecordset/binarypublickeys) { get; } | ऑब्जेक्ट से जुड़ी सार्वजनिक कुंजी या प्रमाणीकरण प्रमाणपत्र प्राप्त करता है। |
...
| [PublicKeyBinaryRecords](../../groupdocs.metadata.formats.businesscard/vcardsecurityrecordset/publickeybinaryrecords) { get; } | ऑब्जेक्ट से जुड़ी सार्वजनिक कुंजी या प्रमाणीकरण प्रमाणपत्र प्राप्त करता है। |
| [PublicKeyRecords](../../groupdocs.metadata.formats.businesscard/vcardsecurityrecordset/publickeyrecords) { get; } | ऑब्जेक्ट से जुड़ी सार्वजनिक कुंजी या प्रमाणीकरण प्रमाणपत्र प्राप्त करता है। |
| [PublicKeyUriRecords](../../groupdocs.metadata.formats.businesscard/vcardsecurityrecordset/publickeyurirecords) { get; } | ऑब्जेक्ट से जुड़ी सार्वजनिक कुंजी या प्रमाणीकरण प्रमाणपत्र प्राप्त करता है। |
| [UriPublicKeys](../../groupdocs.metadata.formats.businesscard/vcardsecurityrecordset/uripublickeys) { get; } | ऑब्जेक्ट से जुड़ी सार्वजनिक कुंजी या प्रमाणीकरण प्रमाणपत्र प्राप्त करता है। |
