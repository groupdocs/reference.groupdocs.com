...
description: vCard कस्टम रकर्ड मेटडेट वर्ग क प्रतनधत्व करत है
type: docs
weight: 680
url: /hi/net/groupdocs.metadata.formats.businesscard/vcardcustomrecord/
---
## VCardCustomRecord class

vCard कस्टम रिकॉर्ड मेटाडेटा वर्ग का प्रतिनिधित्व करता है।
...
| override [ContentType](../../groupdocs.metadata.formats.businesscard/vcardcustomrecord/contenttype) { get; } | सामग्री प्रकार का रिकॉर्ड प्राप्त करता है। |
...
| [Value](../../groupdocs.metadata.formats.businesscard/vcardcustomrecord/value) { get; } | रिकॉर्ड मान प्राप्त करता है। |
