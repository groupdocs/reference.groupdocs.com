...
description: एक संसधन के प्रसंस्करण में हुई एक उच्च स्तरय घटन क प्रतनधत्व करत है
type: docs
weight: 3540
url: /hi/net/groupdocs.metadata.standards.xmp/xmpresourceevent/
---
## XmpResourceEvent class

एक संसाधन के प्रसंस्करण में हुई एक उच्च स्तरीय घटना का प्रतिनिधित्व करता है।
...
| नाम | विवरण |
| --- | --- |
| [XmpResourceEvent](xmpresourceevent)() | का एक नया उदाहरण प्रारंभ करता है[`XmpResourceEvent`](../xmpresourceevent) वर्ग. |

## गुण

| नाम | विवरण |
| --- | --- |
| [Action](../../groupdocs.metadata.standards.xmp/xmpresourceevent/action) { get; set; } | हुई कार्रवाई को प्राप्त या सेट करता है। |
| [Changed](../../groupdocs.metadata.standards.xmp/xmpresourceevent/changed) { get; set; } | संसाधन के उन हिस्सों की अर्धविराम-सीमांकित सूची प्राप्त या सेट करता है जो पिछले ईवेंट इतिहास के बाद से बदल दिए गए थे। |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | मेटाडेटा गुणों की संख्या प्राप्त करता है। |
| [InstanceID](../../groupdocs.metadata.standards.xmp/xmpresourceevent/instanceid) { get; set; } | संशोधित (आउटपुट) संसाधन के लिए xmpMM:InstanceID गुण का मान प्राप्त या सेट करता है। |
...
| [Parameters](../../groupdocs.metadata.standards.xmp/xmpresourceevent/parameters) { get; set; } | कार्रवाई का अतिरिक्त विवरण प्राप्त या सेट करता है। |
...
| [SoftwareAgent](../../groupdocs.metadata.standards.xmp/xmpresourceevent/softwareagent) { get; set; } | कार्रवाई करने वाले सॉफ़्टवेयर एजेंट को प्राप्त या सेट करता है। |
| [When](../../groupdocs.metadata.standards.xmp/xmpresourceevent/when) { get; set; } | कार्रवाई होने पर टाइमस्टैम्प प्राप्त या सेट करता है। |
