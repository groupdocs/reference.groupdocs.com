...
description: नकर क प्रतनधत्व करत है
type: docs
weight: 3440
url: /hi/net/groupdocs.metadata.standards.xmp/xmpjob/
---
## XmpJob class

नौकरी का प्रतिनिधित्व करता है।
...
| नाम | विवरण |
| --- | --- |
| [XmpJob](xmpjob)() | का एक नया उदाहरण प्रारंभ करता है[`XmpJob`](../xmpjob) वर्ग. |
...
| [ID](../../groupdocs.metadata.standards.xmp/xmpjob/id) { get; set; } | कार्य के लिए अद्वितीय आईडी प्राप्त या सेट करता है। यह फ़ील्ड कुछ बाहरी कार्य प्रबंधन प्रणाली में एक संदर्भ है. |
...
| [Name](../../groupdocs.metadata.standards.xmp/xmpjob/name) { get; set; } | कार्य का अनौपचारिक नाम प्राप्त या सेट करता है। यह नाम उपयोक्ता प्रदर्शन और अनौपचारिक प्रणालियों के लिए है. |
...
| [Url](../../groupdocs.metadata.standards.xmp/xmpjob/url) { get; set; } | बाहरी कार्य प्रबंधन फ़ाइल को संदर्भित करने वाला फ़ाइल URL प्राप्त या सेट करता है। |
