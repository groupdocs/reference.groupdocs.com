...
description: सएमवईके कलरेंट क प्रतनधत्व करत है
type: docs
weight: 3310
url: /hi/net/groupdocs.metadata.standards.xmp/xmpcolorantcmyk/
---
## XmpColorantCmyk class

सीएमवाईके कलरेंट का प्रतिनिधित्व करता है।
...
| नाम | विवरण |
| --- | --- |
| [XmpColorantCmyk](xmpcolorantcmyk#constructor)() | का एक नया उदाहरण प्रारंभ करता है[`XmpColorantCmyk`](../xmpcolorantcmyk) वर्ग. |
| [XmpColorantCmyk](xmpcolorantcmyk#constructor_1)(double, double, double, double) | का एक नया उदाहरण प्रारंभ करता है[`XmpColorantCmyk`](../xmpcolorantcmyk) वर्ग. |

## गुण

| नाम | विवरण |
| --- | --- |
| [Black](../../groupdocs.metadata.standards.xmp/xmpcolorantcmyk/black) { get; set; } | काले घटक को प्राप्त या सेट करता है। |
...
| [Cyan](../../groupdocs.metadata.standards.xmp/xmpcolorantcmyk/cyan) { get; set; } | सियान घटक प्राप्त या सेट करता है। |
...
| [Magenta](../../groupdocs.metadata.standards.xmp/xmpcolorantcmyk/magenta) { get; set; } | मैजेंटा घटक प्राप्त या सेट करता है। |
...
| [Yellow](../../groupdocs.metadata.standards.xmp/xmpcolorantcmyk/yellow) { get; set; } | पीला घटक प्राप्त या सेट करता है। |
...
| नाम | विवरण |
| --- | --- |
| const [ColorValueMax](../../groupdocs.metadata.standards.xmp/xmpcolorantcmyk/colorvaluemax) | सीएमवाईके रंग में अधिकतम रंग मूल्य। |
| const [ColorValueMin](../../groupdocs.metadata.standards.xmp/xmpcolorantcmyk/colorvaluemin) | CMYK कलरेंट में न्यूनतम रंग मान. |
