...
description: XMP मेटडेट गुणं के लए एक कंटेनर क प्रतनधत्व करत है
type: docs
weight: 3470
url: /hi/net/groupdocs.metadata.standards.xmp/xmpmetadatacontainer/
---
## XmpMetadataContainer class

XMP मेटाडेटा गुणों के लिए एक कंटेनर का प्रतिनिधित्व करता है।
...
| abstract [GetXmpRepresentation](../../groupdocs.metadata.standards.xmp/xmpmetadatacontainer/getxmprepresentation)() | XMP मान को XML प्रतिनिधित्व में कनवर्ट करता है। |
