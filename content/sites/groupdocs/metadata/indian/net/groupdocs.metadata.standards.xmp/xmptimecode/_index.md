...
description: एक वडय में एक टइमकड मन क प्रतनधत्व करत है
type: docs
weight: 3600
url: /hi/net/groupdocs.metadata.standards.xmp/xmptimecode/
---
## XmpTimecode class

एक वीडियो में एक टाइमकोड मान का प्रतिनिधित्व करता है।
...
| नाम | विवरण |
| --- | --- |
| [XmpTimecode](xmptimecode#constructor)() | का एक नया उदाहरण प्रारंभ करता है[`XmpTimecode`](../xmptimecode) वर्ग. |
| [XmpTimecode](xmptimecode#constructor_1)(XmpTimeFormat, string) | का एक नया उदाहरण प्रारंभ करता है[`XmpTimecode`](../xmptimecode) वर्ग. |
...
| [TimeFormat](../../groupdocs.metadata.standards.xmp/xmptimecode/timeformat) { get; set; } | समय मान में प्रयुक्त प्रारूप प्राप्त या सेट करता है। |
| [TimeValue](../../groupdocs.metadata.standards.xmp/xmptimecode/timevalue) { get; set; } | निर्दिष्ट प्रारूप में समय मान प्राप्त या सेट करता है। समय मान 2997ड्रॉप और 5994ड्रॉप को छोड़कर सभी प्रारूपों में कोलन डिलीमीटर का उपयोग करते हैं, जो अर्धविराम का उपयोग करता है। चार फ़ील्ड घंटे, मिनट, सेकंड और फ़्रेम दर्शाते हैं: hh:mm:ss:ff |
...
| [SetTimeFormat](../../groupdocs.metadata.standards.xmp/xmptimecode/settimeformat)(XmpTimeFormat) | समय प्रारूप सेट करता है। |
