...
description: एक संरचन जसमें दस्तवेज़ में उपयग कए जने वले रंगन स्वैच क वशेषतएं हत हैं
type: docs
weight: 3300
url: /hi/net/groupdocs.metadata.standards.xmp/xmpcolorantbase/
---
## XmpColorantBase class

एक संरचना जिसमें दस्तावेज़ में उपयोग किए जाने वाले रंगीन (स्वैच) की विशेषताएं होती हैं।
