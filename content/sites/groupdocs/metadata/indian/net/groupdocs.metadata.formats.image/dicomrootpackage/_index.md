...
description: डआईसओएम छव में मेटडेट के सथ कम करने के उद्देश्य से रूट पैकेज क प्रतनधत्व करत है
type: docs
weight: 1680
url: /hi/net/groupdocs.metadata.formats.image/dicomrootpackage/
---
## DicomRootPackage class

डीआईसीओएम छवि में मेटाडेटा के साथ काम करने के उद्देश्य से रूट पैकेज का प्रतिनिधित्व करता है।
...
| [DicomPackage](../../groupdocs.metadata.formats.image/dicomrootpackage/dicompackage) { get; } | DICOM देशी मेटाडेटा पैकेज प्राप्त करता है। |
...
यह उदाहरण दर्शाता है कि डीआईसीओएम प्रारूप-विशिष्ट मेटाडेटा गुणों को कैसे पढ़ा जाए।
