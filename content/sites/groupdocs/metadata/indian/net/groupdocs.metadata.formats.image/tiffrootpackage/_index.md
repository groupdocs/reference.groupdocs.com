...
description: TIFF छव में मेटडेट के सथ कम करने क अनुमत देने वले रूट पैकेज क प्रतनधत्व करत है
type: docs
weight: 2020
url: /hi/net/groupdocs.metadata.formats.image/tiffrootpackage/
---
## TiffRootPackage class

TIFF छवि में मेटाडेटा के साथ काम करने की अनुमति देने वाले रूट पैकेज का प्रतिनिधित्व करता है।
...
| [ExifPackage](../../groupdocs.metadata.formats.image/tiffrootpackage/exifpackage) { get; set; } | EXIF मेटाडेटा पैकेज प्राप्त या सेट करता है। |
...
| [IptcPackage](../../groupdocs.metadata.formats.image/tiffrootpackage/iptcpackage) { get; set; } | IPTC मेटाडेटा पैकेज प्राप्त या सेट करता है। |
...
| [XmpPackage](../../groupdocs.metadata.formats.image/tiffrootpackage/xmppackage) { get; set; } | एक्सएमपी मेटाडेटा पैकेज प्राप्त या सेट करता है। |
...
* [TIFF छवियों में मेटाडेटा के साथ कार्य करना](https://docs.groupdocs.com/display/metadatanet/Working+with+metadata+in+TIFF+images)
