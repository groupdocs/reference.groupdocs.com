...
description: फटशप छव संसधनं वले मेटडेट पैकेज क प्रतनधत्व करत है
type: docs
weight: 1760
url: /hi/net/groupdocs.metadata.formats.image/imageresourcepackage/
---
## ImageResourcePackage class

फोटोशॉप छवि संसाधनों वाले मेटाडेटा पैकेज का प्रतिनिधित्व करता है।
...
| [ToList](../../groupdocs.metadata.formats.image/imageresourcepackage/tolist)() | पैकेज से एक सूची बनाता है। |
