...
description: फटशप दस्तवेज़ में मेटडेट के सथ कम करने क अनुमत देने वले रूट पैकेज क प्रतनधत्व करत है
type: docs
weight: 1930
url: /hi/net/groupdocs.metadata.formats.image/psdrootpackage/
---
## PsdRootPackage class

फोटोशॉप दस्तावेज़ में मेटाडेटा के साथ काम करने की अनुमति देने वाले रूट पैकेज का प्रतिनिधित्व करता है।
...
| [ExifPackage](../../groupdocs.metadata.formats.image/psdrootpackage/exifpackage) { get; set; } | EXIF मेटाडेटा पैकेज प्राप्त या सेट करता है। |
...
| [ImageResourcePackage](../../groupdocs.metadata.formats.image/psdrootpackage/imageresourcepackage) { get; } | फोटोशॉप इमेज रिसोर्स मेटाडेटा पैकेज प्राप्त करता है। इमेज रिसोर्स ब्लॉक फोटोशॉप नेटिव फाइल फॉर्मेट की मूल बिल्डिंग यूनिट हैं। |
| [IptcPackage](../../groupdocs.metadata.formats.image/psdrootpackage/iptcpackage) { get; set; } | IPTC मेटाडेटा पैकेज प्राप्त या सेट करता है। |
...
| [PsdPackage](../../groupdocs.metadata.formats.image/psdrootpackage/psdpackage) { get; } | मेटाडेटा पैकेज प्राप्त करता है जिसमें PSD फ़ाइल के बारे में जानकारी होती है। |
| [XmpPackage](../../groupdocs.metadata.formats.image/psdrootpackage/xmppackage) { get; set; } | एक्सएमपी मेटाडेटा पैकेज प्राप्त या सेट करता है। |
