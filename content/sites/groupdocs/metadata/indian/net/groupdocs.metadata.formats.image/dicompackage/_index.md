...
description: देश DICOM मेटडेट क प्रतनधत्व करत है
type: docs
weight: 1670
url: /hi/net/groupdocs.metadata.formats.image/dicompackage/
---
## DicomPackage class

देशी DICOM मेटाडेटा का प्रतिनिधित्व करता है।
...
| नाम | विवरण |
| --- | --- |
| [DicomPackage](dicompackage)() | का एक नया उदाहरण प्रारंभ करता है[`Metadata`](../../groupdocs.metadata/metadata) वर्ग. |

## गुण

| नाम | विवरण |
| --- | --- |
| [BitsAllocated](../../groupdocs.metadata.formats.image/dicompackage/bitsallocated) { get; } | बिट्स आवंटित मान प्राप्त करता है। |
| [Blues](../../groupdocs.metadata.formats.image/dicompackage/blues) { get; } | नीले रंग के सरणी रंग प्राप्त करता है। |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | मेटाडेटा गुणों की संख्या प्राप्त करता है। |
| [DicomInfo](../../groupdocs.metadata.formats.image/dicompackage/dicominfo) { get; } | DICOM फ़ाइल की हेडर जानकारी प्राप्त करता है। |
| [Greens](../../groupdocs.metadata.formats.image/dicompackage/greens) { get; } | हरे रंग के सरणी रंग प्राप्त करता है। |
| [HeaderBytes](../../groupdocs.metadata.formats.image/dicompackage/headerbytes) { get; } | बाइट्स द्वारा हेडर जानकारी प्राप्त करता है। |
| [HeaderOffset](../../groupdocs.metadata.formats.image/dicompackage/headeroffset) { get; } | हेडर ऑफ़सेट हो जाता है. |
...
| [NumberOfFrames](../../groupdocs.metadata.formats.image/dicompackage/numberofframes) { get; } | फ्रेम की संख्या प्राप्त करता है। |
...
| [Reds](../../groupdocs.metadata.formats.image/dicompackage/reds) { get; } | लाल के सरणी रंग प्राप्त करता है। |
