...
description: PNG छव से नकले गए अंतर्रष्ट्रय पठ्य डेट क प्रतनधत्व करत है
type: docs
weight: 1840
url: /hi/net/groupdocs.metadata.formats.image/pnginternationaltextchunk/
---
## PngInternationalTextChunk class

PNG छवि से निकाले गए अंतर्राष्ट्रीय पाठ्य डेटा का प्रतिनिधित्व करता है।
...
| नाम | विवरण |
| --- | --- |
| [CompressionMethod](../../groupdocs.metadata.formats.image/pngcompressedtextchunk/compressionmethod) { get; } | चंक डेटा को संपीड़ित करने के लिए उपयोग किया जाने वाला एल्गोरिथम प्राप्त करता है। |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | मेटाडेटा गुणों की संख्या प्राप्त करता है। |
| [IsCompressed](../../groupdocs.metadata.formats.image/pnginternationaltextchunk/iscompressed) { get; } | एक मान प्राप्त करता है जो इंगित करता है कि चंक संकुचित है या नहीं। |
...
| [Keyword](../../groupdocs.metadata.formats.image/pngtextchunk/keyword) { get; } | वह कीवर्ड प्राप्त करता है जो चंक द्वारा दर्शाई गई जानकारी के प्रकार को इंगित करता है। |
| [Language](../../groupdocs.metadata.formats.image/pnginternationaltextchunk/language) { get; } | अनुवादित कीवर्ड और टेक्स्ट द्वारा उपयोग की जाने वाली मानव भाषा प्राप्त करता है। |
...
| [Text](../../groupdocs.metadata.formats.image/pngtextchunk/text) { get; } | चंक द्वारा प्रस्तुत वास्तविक टेक्स्ट स्ट्रिंग प्राप्त करता है। |
| [TranslatedKeyword](../../groupdocs.metadata.formats.image/pnginternationaltextchunk/translatedkeyword) { get; } | अनुवादित कीवर्ड प्राप्त करता है जिसमें भाषा संपत्ति द्वारा इंगित भाषा में कीवर्ड का अनुवाद होता है। |
