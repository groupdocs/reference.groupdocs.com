...
description: नेटव फटशप मेटडेट क प्रतनधत्व करत है
type: docs
weight: 1920
url: /hi/net/groupdocs.metadata.formats.image/psdpackage/
---
## PsdPackage class

नेटिव फोटोशॉप मेटाडेटा का प्रतिनिधित्व करता है।
...
| नाम | विवरण |
| --- | --- |
| [ChannelCount](../../groupdocs.metadata.formats.image/psdpackage/channelcount) { get; } | चैनलों की संख्या प्राप्त करता है। |
| [ColorMode](../../groupdocs.metadata.formats.image/psdpackage/colormode) { get; } | पीएसडी कलर मोड प्राप्त करता है। |
| [Compression](../../groupdocs.metadata.formats.image/psdpackage/compression) { get; } | छवि डेटा के लिए उपयोग की जाने वाली संपीड़न विधि प्राप्त करता है। |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | मेटाडेटा गुणों की संख्या प्राप्त करता है। |
| [Height](../../groupdocs.metadata.formats.image/psdpackage/height) { get; } | छवि की ऊंचाई प्राप्त करता है। |
...
| [Layers](../../groupdocs.metadata.formats.image/psdpackage/layers) { get; } | फोटोशॉप परतें प्राप्त करता है। |
| [MetadataType](../../groupdocs.metadata.common/metadatapackage/metadatatype) { get; } | मेटाडेटा प्रकार प्राप्त करता है। |
| [PhotoshopVersion](../../groupdocs.metadata.formats.image/psdpackage/photoshopversion) { get; } | फोटोशॉप संस्करण प्राप्त करता है। |
...
| [Width](../../groupdocs.metadata.formats.image/psdpackage/width) { get; } | छवि की PSD चौड़ाई प्राप्त करता है। |
