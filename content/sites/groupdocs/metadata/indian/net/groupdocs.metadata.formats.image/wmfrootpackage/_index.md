...
description: WMF छव में मेटडेट के सथ कम करने के उद्देश्य से रूट पैकेज क प्रतनधत्व करत है
type: docs
weight: 2140
url: /hi/net/groupdocs.metadata.formats.image/wmfrootpackage/
---
## WmfRootPackage class

WMF छवि में मेटाडेटा के साथ काम करने के उद्देश्य से रूट पैकेज का प्रतिनिधित्व करता है।
