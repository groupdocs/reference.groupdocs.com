...
description: सभ छव रूट पैकेजं के लए एक आधर सर वर्ग प्रदन करत है
type: docs
weight: 1770
url: /hi/net/groupdocs.metadata.formats.image/imagerootpackage/
---
## ImageRootPackage class

सभी छवि रूट पैकेजों के लिए एक आधार सार वर्ग प्रदान करता है।
