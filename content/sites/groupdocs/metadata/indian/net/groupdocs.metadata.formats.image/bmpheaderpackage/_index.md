...
description: बएमप हेडर जनकर क प्रतनधत्व करत है
type: docs
weight: 1650
url: /hi/net/groupdocs.metadata.formats.image/bmpheaderpackage/
---
## BmpHeaderPackage class

बीएमपी हेडर जानकारी का प्रतिनिधित्व करता है।
...
| नाम | विवरण |
| --- | --- |
| [BitsPerPixel](../../groupdocs.metadata.formats.image/bmpheaderpackage/bitsperpixel) { get; } | बिट्स प्रति पिक्सेल मान प्राप्त करता है। |
| [ColorsImportant](../../groupdocs.metadata.formats.image/bmpheaderpackage/colorsimportant) { get; } | महत्वपूर्ण पैलेट रंगों की संख्या प्राप्त करता है। |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | मेटाडेटा गुणों की संख्या प्राप्त करता है। |
| [HeaderSize](../../groupdocs.metadata.formats.image/bmpheaderpackage/headersize) { get; } | बाइट्स में हेडर का आकार प्राप्त करता है। |
| [ImageSize](../../groupdocs.metadata.formats.image/bmpheaderpackage/imagesize) { get; } | बाइट्स में बिटमैप अपरिष्कृत डेटा आकार प्राप्त करता है। |
...
| [Planes](../../groupdocs.metadata.formats.image/bmpheaderpackage/planes) { get; } | विमानों की संख्या प्राप्त करता है। |
