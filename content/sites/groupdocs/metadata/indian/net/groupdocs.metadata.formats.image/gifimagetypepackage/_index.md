...
description: जआईएफवशष्ट फ़इल प्ररूप जनकर वले मेटडेट पैकेज क प्रतनधत्व करत है
type: docs
weight: 1710
url: /hi/net/groupdocs.metadata.formats.image/gifimagetypepackage/
---
## GifImageTypePackage class

जीआईएफ-विशिष्ट फ़ाइल प्रारूप जानकारी वाले मेटाडेटा पैकेज का प्रतिनिधित्व करता है।
...
| [Version](../../groupdocs.metadata.formats.image/gifimagetypepackage/version) { get; } | प्रारूप का संस्करण प्राप्त करता है। |
