...
description: छववशष्ट फ़इल प्ररूप जनकर वले मेटडेट पैकेज क प्रतनधत्व करत है
type: docs
weight: 1780
url: /hi/net/groupdocs.metadata.formats.image/imagetypepackage/
---
## ImageTypePackage class

छवि-विशिष्ट फ़ाइल प्रारूप जानकारी वाले मेटाडेटा पैकेज का प्रतिनिधित्व करता है।
...
| नाम | विवरण |
| --- | --- |
| [ByteOrder](../../groupdocs.metadata.formats.image/imagetypepackage/byteorder) { get; } | छवि का बाइट क्रम प्राप्त करता है। कृपया देखें[https://en.wikipedia.org/wiki/Endianness](https://en.wikipedia.org/wiki/Endianness) अधिक जानकारी के लिए. |
...
| [Height](../../groupdocs.metadata.formats.image/imagetypepackage/height) { get; } | छवि ऊंचाई प्राप्त करता है। |
...
| [Width](../../groupdocs.metadata.formats.image/imagetypepackage/width) { get; } | छवि चौड़ाई प्राप्त करता है। |
