...
description: मूल पएनज मेटडेट क प्रतनधत्व करत है
type: docs
weight: 1850
url: /hi/net/groupdocs.metadata.formats.image/pngpackage/
---
## PngPackage class

मूल पीएनजी मेटाडेटा का प्रतिनिधित्व करता है।
...
| [TextChunks](../../groupdocs.metadata.formats.image/pngpackage/textchunks) { get; } | छवि से निकाले गए पाठ के टुकड़ों का संग्रह प्राप्त करता है। |
