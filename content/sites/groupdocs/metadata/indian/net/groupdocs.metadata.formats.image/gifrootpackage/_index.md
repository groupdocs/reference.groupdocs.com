...
description: GIF छव में मेटडेट के सथ कम करने के उद्देश्य से रूट पैकेज क प्रतनधत्व करत है
type: docs
weight: 1720
url: /hi/net/groupdocs.metadata.formats.image/gifrootpackage/
---
## GifRootPackage class

GIF छवि में मेटाडेटा के साथ काम करने के उद्देश्य से रूट पैकेज का प्रतिनिधित्व करता है।
...
| [FileType](../../groupdocs.metadata.formats.image/gifrootpackage/filetype) { get; } | फ़ाइल प्रकार मेटाडेटा पैकेज प्राप्त करता है। (3 properties) |
| [IsXmpSupported](../../groupdocs.metadata.formats.image/gifrootpackage/isxmpsupported) { get; } | यह इंगित करने वाला मान प्राप्त करता है कि क्या इस छवि के लिए XMP मेटाडेटा समर्थित है. |
...
| [XmpPackage](../../groupdocs.metadata.formats.image/gifrootpackage/xmppackage) { get; set; } | एक्सएमपी मेटाडेटा पैकेज प्राप्त या सेट करता है। |
...
* [GIF छवियों में मेटाडेटा के साथ कार्य करना](https://docs.groupdocs.com/display/metadatanet/Working+with+metadata+in+GIF+images)
