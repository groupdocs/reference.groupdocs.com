...
description: डयग्रम में मेटडेट के सथ कम करने के उद्देश्य से रूट पैकेज क प्रतनधत्व करत है
type: docs
weight: 900
url: /hi/net/groupdocs.metadata.formats.document/diagramrootpackage/
---
## DiagramRootPackage class

डायग्राम में मेटाडेटा के साथ काम करने के उद्देश्य से रूट पैकेज का प्रतिनिधित्व करता है।
...
| [DocumentStatistics](../../groupdocs.metadata.formats.document/diagramrootpackage/documentstatistics) { get; } | दस्तावेज़ आँकड़े पैकेज प्राप्त करता है। |
| [FileType](../../groupdocs.metadata.formats.document/diagramrootpackage/filetype) { get; } | फ़ाइल प्रकार मेटाडेटा पैकेज प्राप्त करता है। (2 properties) |
...
निम्न कोड नमूना दर्शाता है कि आरेख दस्तावेज़ में अंतर्निहित मेटाडेटा गुणों को कैसे अपडेट किया जाए।
