...
description: वर्ड प्रसेसंग दस्तवेज़ में एक टप्पण क प्रतनधत्व करत है
type: docs
weight: 1240
url: /hi/net/groupdocs.metadata.formats.document/wordprocessingcomment/
---
## WordProcessingComment class

वर्ड प्रोसेसिंग दस्तावेज़ में एक टिप्पणी का प्रतिनिधित्व करता है।
...
| नाम | विवरण |
| --- | --- |
| [Author](../../groupdocs.metadata.formats.document/wordprocessingcomment/author) { get; set; } | लेखक को प्राप्त या सेट करता है। |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | मेटाडेटा गुणों की संख्या प्राप्त करता है। |
| [CreatedDate](../../groupdocs.metadata.formats.document/wordprocessingcomment/createddate) { get; set; } | वह दिनांक प्राप्त या सेट करता है जिस पर टिप्पणी की गई थी। |
| [Id](../../groupdocs.metadata.formats.document/wordprocessingcomment/id) { get; } | टिप्पणी आईडी प्राप्त करता है। |
| [Initials](../../groupdocs.metadata.formats.document/wordprocessingcomment/initials) { get; set; } | लेखक के आद्याक्षर प्राप्त करता है या सेट करता है। |
...
| [Text](../../groupdocs.metadata.formats.document/wordprocessingcomment/text) { get; set; } | टिप्पणी का पाठ प्राप्त या सेट करता है। |
