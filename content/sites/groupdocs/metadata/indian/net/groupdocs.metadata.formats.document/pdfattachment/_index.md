...
description: एक पडएफ दस्तवेज़ में एक अनुलग्नक क प्रतनधत्व करत है
type: docs
weight: 990
url: /hi/net/groupdocs.metadata.formats.document/pdfattachment/
---
## PdfAttachment class

एक पीडीएफ दस्तावेज़ में एक अनुलग्नक का प्रतिनिधित्व करता है।
...
| [Description](../../groupdocs.metadata.formats.document/pdfattachment/description) { get; } | अटैचमेंट विवरण प्राप्त करता है। |
...
| [MimeType](../../groupdocs.metadata.formats.document/pdfattachment/mimetype) { get; } | संलग्नक का MIME प्रकार प्राप्त करता है। |
| [Name](../../groupdocs.metadata.formats.document/pdfattachment/name) { get; } | अटैचमेंट का नाम मिलता है. |
