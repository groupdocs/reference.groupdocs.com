...
description: दस्तवेज़वशष्ट फ़इल स्वरूप जनकर वले मेटडेट पैकेज क प्रतनधत्व करत है
type: docs
weight: 1320
url: /hi/net/groupdocs.metadata.formats.document/wordprocessingtypepackage/
---
## WordProcessingTypePackage class

दस्तावेज़-विशिष्ट फ़ाइल स्वरूप जानकारी वाले मेटाडेटा पैकेज का प्रतिनिधित्व करता है।
...
| [WordProcessingFormat](../../groupdocs.metadata.formats.document/wordprocessingtypepackage/wordprocessingformat) { get; } | सटीक वर्ड प्रोसेसिंग प्रारूप प्राप्त करता है। |
