...
description: पडएफ दस्तवेज़ में एक फर्म फ़ल्ड क प्रतनधत्व करत है
type: docs
weight: 1010
url: /hi/net/groupdocs.metadata.formats.document/pdfformfield/
---
## PdfFormField class

पीडीएफ दस्तावेज़ में एक फॉर्म फ़ील्ड का प्रतिनिधित्व करता है।

```csharp
public class PdfFormField : CustomPackage
```
...
| [Name](../../groupdocs.metadata.formats.document/pdfformfield/name) { get; } | फ़ील्ड का नाम प्राप्त करता है। |
...
| [Value](../../groupdocs.metadata.formats.document/pdfformfield/value) { get; } | फ़ील्ड मान प्राप्त करता है। |
