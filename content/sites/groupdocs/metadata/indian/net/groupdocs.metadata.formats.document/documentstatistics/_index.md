...
description: दस्तवेज़ आँकड़ं के एक सेट क प्रतनधत्व करत है
type: docs
weight: 940
url: /hi/net/groupdocs.metadata.formats.document/documentstatistics/
---
## DocumentStatistics class

दस्तावेज़ आँकड़ों के एक सेट का प्रतिनिधित्व करता है।
...
| नाम | विवरण |
| --- | --- |
| [DocumentStatistics](documentstatistics)() | का एक नया उदाहरण प्रारंभ करता है[`DocumentStatistics`](../documentstatistics) वर्ग. |

## गुण

| नाम | विवरण |
| --- | --- |
| [CharacterCount](../../groupdocs.metadata.formats.document/documentstatistics/charactercount) { get; } | दस्तावेज़ में वर्णों की अनुमानित संख्या प्राप्त करता है। |
...
| [PageCount](../../groupdocs.metadata.formats.document/documentstatistics/pagecount) { get; } | दस्तावेज़ में पृष्ठों की अनुमानित संख्या प्राप्त करता है। |
...
| [WordCount](../../groupdocs.metadata.formats.document/documentstatistics/wordcount) { get; } | दस्तावेज़ में शब्दों की अनुमानित संख्या प्राप्त करता है। |
