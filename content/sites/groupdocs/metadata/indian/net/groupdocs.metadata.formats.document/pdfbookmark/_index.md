...
description: एक पडएफ दस्तवेज़ में एक बुकमर्क क प्रतनधत्व करत है
type: docs
weight: 1000
url: /hi/net/groupdocs.metadata.formats.document/pdfbookmark/
---
## PdfBookmark class

एक पीडीएफ दस्तावेज़ में एक बुकमार्क का प्रतिनिधित्व करता है।
...
| [Title](../../groupdocs.metadata.formats.document/pdfbookmark/title) { get; } | बुकमार्क का शीर्षक प्राप्त करता है। |
