...
description: आरेखवशष्ट फ़इल स्वरूप जनकर वले मेटडेट पैकेज क प्रतनधत्व करत है
type: docs
weight: 910
url: /hi/net/groupdocs.metadata.formats.document/diagramtypepackage/
---
## DiagramTypePackage class

आरेख-विशिष्ट फ़ाइल स्वरूप जानकारी वाले मेटाडेटा पैकेज का प्रतिनिधित्व करता है।
...
| [DiagramFormat](../../groupdocs.metadata.formats.document/diagramtypepackage/diagramformat) { get; } | सटीक आरेख प्रारूप प्राप्त करता है। |
