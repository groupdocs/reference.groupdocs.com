...
description: पडएफ दस्तवेज़ में मूल मेटडेट क प्रतनधत्व करत है
type: docs
weight: 1030
url: /hi/net/groupdocs.metadata.formats.document/pdfpackage/
---
## PdfPackage class

पीडीएफ दस्तावेज़ में मूल मेटाडेटा का प्रतिनिधित्व करता है।
...
| नाम | विवरण |
| --- | --- |
| [Author](../../groupdocs.metadata.formats.document/pdfpackage/author) { get; set; } | दस्तावेज़ लेखक को प्राप्त या सेट करता है। |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | मेटाडेटा गुणों की संख्या प्राप्त करता है। |
| [CreatedDate](../../groupdocs.metadata.formats.document/pdfpackage/createddate) { get; set; } | दस्तावेज़ निर्माण की तिथि प्राप्त या सेट करता है। |
| [Creator](../../groupdocs.metadata.formats.document/pdfpackage/creator) { get; } | दस्तावेज़ के निर्माता को प्राप्त करता है। |
...
| [Keywords](../../groupdocs.metadata.formats.document/pdfpackage/keywords) { get; set; } | कीवर्ड प्राप्त या सेट करता है। |
| [MetadataType](../../groupdocs.metadata.common/metadatapackage/metadatatype) { get; } | मेटाडेटा प्रकार प्राप्त करता है। |
| [ModifiedDate](../../groupdocs.metadata.formats.document/pdfpackage/modifieddate) { get; set; } | अंतिम संशोधन की तिथि प्राप्त या सेट करता है। |
| [Producer](../../groupdocs.metadata.formats.document/pdfpackage/producer) { get; } | दस्तावेज़ निर्माता प्राप्त करता है। |
...
| [Subject](../../groupdocs.metadata.formats.document/pdfpackage/subject) { get; set; } | दस्तावेज़ का विषय प्राप्त या सेट करता है। |
| [Title](../../groupdocs.metadata.formats.document/pdfpackage/title) { get; set; } | दस्तावेज़ का शीर्षक प्राप्त या सेट करता है। |
| [TrappedFlag](../../groupdocs.metadata.formats.document/pdfpackage/trappedflag) { get; set; } | फंसे हुए झंडे को प्राप्त या सेट करता है। |
...
| [Set](../../groupdocs.metadata.formats.document/pdfpackage/set)(string, string) | निर्दिष्ट नाम के साथ मेटाडेटा गुण जोड़ता या प्रतिस्थापित करता है। |
...
यह कोड स्निपेट दर्शाता है कि पीडीएफ दस्तावेज़ में अंतर्निहित मेटाडेटा गुणों को कैसे अपडेट किया जाए।
