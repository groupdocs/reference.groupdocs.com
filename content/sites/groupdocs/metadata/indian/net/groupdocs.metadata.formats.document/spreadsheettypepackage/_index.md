...
description: स्प्रेडशटवशष्ट फ़इल प्ररूप जनकर वले मेटडेट पैकेज क प्रतनधत्व करत है
type: docs
weight: 1230
url: /hi/net/groupdocs.metadata.formats.document/spreadsheettypepackage/
---
## SpreadsheetTypePackage class

स्प्रेडशीट-विशिष्ट फ़ाइल प्रारूप जानकारी वाले मेटाडेटा पैकेज का प्रतिनिधित्व करता है।
...
| [SpreadsheetFormat](../../groupdocs.metadata.formats.document/spreadsheettypepackage/spreadsheetformat) { get; } | सटीक स्प्रैडशीट प्रारूप प्राप्त करता है. |
