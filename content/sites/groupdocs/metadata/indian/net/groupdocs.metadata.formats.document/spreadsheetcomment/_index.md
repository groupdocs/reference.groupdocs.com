...
description: एक स्प्रेडशट में एक उपयगकर्त टप्पण क प्रतनधत्व करत है
type: docs
weight: 1150
url: /hi/net/groupdocs.metadata.formats.document/spreadsheetcomment/
---
## SpreadsheetComment class

एक स्प्रेडशीट में एक उपयोगकर्ता टिप्पणी का प्रतिनिधित्व करता है।
...
| नाम | विवरण |
| --- | --- |
| [Author](../../groupdocs.metadata.formats.document/spreadsheetcomment/author) { get; } | टिप्पणी के लेखक को प्राप्त करता है। |
| [Column](../../groupdocs.metadata.formats.document/spreadsheetcomment/column) { get; } | टिप्पणी का एक-आधारित कॉलम इंडेक्स प्राप्त करता है। |
...
| [Row](../../groupdocs.metadata.formats.document/spreadsheetcomment/row) { get; } | टिप्पणी का एक-आधारित पंक्ति सूचकांक प्राप्त करता है। |
| [SheetNumber](../../groupdocs.metadata.formats.document/spreadsheetcomment/sheetnumber) { get; } | शीट संख्या प्राप्त करता है। |
| [Text](../../groupdocs.metadata.formats.document/spreadsheetcomment/text) { get; } | टिप्पणी पाठ प्राप्त करता है। |
