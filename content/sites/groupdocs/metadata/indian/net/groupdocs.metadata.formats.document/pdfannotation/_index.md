...
description: पडएफ दस्तवेज़ में एक एनटेशन क प्रतनधत्व करत है
type: docs
weight: 980
url: /hi/net/groupdocs.metadata.formats.document/pdfannotation/
---
## PdfAnnotation class

पीडीएफ दस्तावेज़ में एक एनोटेशन का प्रतिनिधित्व करता है।
...
| [Name](../../groupdocs.metadata.formats.document/pdfannotation/name) { get; } | एनोटेशन का नाम प्राप्त करता है। |
| [PageNumber](../../groupdocs.metadata.formats.document/pdfannotation/pagenumber) { get; } | एनोटेशन वाले पृष्ठ की संख्या प्राप्त करता है। |
...
| [Text](../../groupdocs.metadata.formats.document/pdfannotation/text) { get; } | एनोटेशन टेक्स्ट प्राप्त करता है। |
