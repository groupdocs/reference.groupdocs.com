...
description: वर्ड प्रसेसंग दस्तवेज़ में एक फ़ल्ड क प्रतनधत्व करत है
type: docs
weight: 1250
url: /hi/net/groupdocs.metadata.formats.document/wordprocessingfield/
---
## WordProcessingField class

वर्ड प्रोसेसिंग दस्तावेज़ में एक फ़ील्ड का प्रतिनिधित्व करता है।
...
| नाम | विवरण |
| --- | --- |
| [Code](../../groupdocs.metadata.formats.document/wordprocessingfield/code) { get; } | फ़ील्ड कोड प्राप्त करता है। |
...
| [Result](../../groupdocs.metadata.formats.document/wordprocessingfield/result) { get; } | फ़ील्ड परिणाम प्राप्त करता है। |
