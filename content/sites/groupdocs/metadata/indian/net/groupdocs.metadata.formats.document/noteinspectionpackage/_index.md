...
description: एक नट अनुभग क आंतरक संरचन क उजगर करने वले मेटडेट पैकेज क प्रतनधत्व करत है
type: docs
weight: 950
url: /hi/net/groupdocs.metadata.formats.document/noteinspectionpackage/
---
## NoteInspectionPackage class

एक नोट अनुभाग की आंतरिक संरचना को उजागर करने वाले मेटाडेटा पैकेज का प्रतिनिधित्व करता है।
...
| [Pages](../../groupdocs.metadata.formats.document/noteinspectionpackage/pages) { get; } | अनुभाग पृष्ठों की एक सरणी प्राप्त करता है। |
