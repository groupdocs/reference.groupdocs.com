...
description: Matroska वडय से नकले गए सभ पैकेजं के लए एक आधर मेटडेट वर्ग प्रदन करत है
type: docs
weight: 2440
url: /hi/net/groupdocs.metadata.formats.video/matroskabasepackage/
---
## MatroskaBasePackage class

Matroska वीडियो से निकाले गए सभी पैकेजों के लिए एक आधार मेटाडेटा वर्ग प्रदान करता है।
