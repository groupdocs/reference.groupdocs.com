...
description: मैट्रस्क वडय में ट्रैक्स एडशन चैप्टर अटैचमेंट य सेगमेंट क वर्णन करने वले मेटडेट क प्रतनधत्व करत है
type: docs
weight: 2530
url: /hi/net/groupdocs.metadata.formats.video/matroskatag/
---
## MatroskaTag class

मैट्रोस्का वीडियो में ट्रैक्स, एडिशन, चैप्टर, अटैचमेंट या सेगमेंट का वर्णन करने वाले मेटाडेटा का प्रतिनिधित्व करता है।
...
| [SimpleTags](../../groupdocs.metadata.formats.video/matroskatag/simpletags) { get; } | लक्ष्य के बारे में सामान्य जानकारी प्राप्त करता है। |
| [TagTrackUid](../../groupdocs.metadata.formats.video/matroskatag/tagtrackuid) { get; } | टैग के संबंधित ट्रैक की पहचान करने के लिए एक अद्वितीय आईडी प्राप्त करता है। यदि इस स्तर पर मान 0 है, तो टैग सेगमेंट में सभी ट्रैक्स पर लागू होते हैं। |
| [TargetType](../../groupdocs.metadata.formats.video/matroskatag/targettype) { get; } | एक सूचनात्मक स्ट्रिंग प्राप्त करता है जिसका उपयोग लक्ष्य के तार्किक स्तर को प्रदर्शित करने के लिए किया जा सकता है। जैसे "ALBUM", "TRACK", "MOVIE", "CHAPTER", आदि। |
| [TargetTypeValue](../../groupdocs.metadata.formats.video/matroskatag/targettypevalue) { get; } | लक्ष्य के तार्किक स्तर को इंगित करने के लिए संख्या प्राप्त करता है। |
