...
description: AVI वडय में मेटडेट के सथ कम करने क अनुमत देने वले रूट पैकेज क प्रतनधत्व करत है
type: docs
weight: 2400
url: /hi/net/groupdocs.metadata.formats.video/avirootpackage/
---
## AviRootPackage class

AVI वीडियो में मेटाडेटा के साथ काम करने की अनुमति देने वाले रूट पैकेज का प्रतिनिधित्व करता है।
...
| [Header](../../groupdocs.metadata.formats.video/avirootpackage/header) { get; } | एवीआई हेडर पैकेज प्राप्त करता है। |
...
| [RiffInfoPackage](../../groupdocs.metadata.formats.video/avirootpackage/riffinfopackage) { get; } | RIFF जानकारी टैग वाले पैकेज को प्राप्त करता है। |
| [XmpPackage](../../groupdocs.metadata.formats.video/avirootpackage/xmppackage) { get; set; } | एक्सएमपी मेटाडेटा पैकेज प्राप्त या सेट करता है। |
