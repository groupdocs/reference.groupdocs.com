...
description: एक Matroska वडय में ऑडय मेटडेट क प्रतनधत्व करत है
type: docs
weight: 2430
url: /hi/net/groupdocs.metadata.formats.video/matroskaaudiotrack/
---
## MatroskaAudioTrack class

एक Matroska वीडियो में ऑडियो मेटाडेटा का प्रतिनिधित्व करता है।
...
| नाम | विवरण |
| --- | --- |
| [BitDepth](../../groupdocs.metadata.formats.video/matroskaaudiotrack/bitdepth) { get; } | प्रति नमूना बिट्स प्राप्त करता है, ज्यादातर पीसीएम के लिए उपयोग किया जाता है। |
| [Channels](../../groupdocs.metadata.formats.video/matroskaaudiotrack/channels) { get; } | ट्रैक में चैनलों की संख्या प्राप्त करता है। |
...
| [OutputSamplingFrequency](../../groupdocs.metadata.formats.video/matroskaaudiotrack/outputsamplingfrequency) { get; } | Hz में वास्तविक आउटपुट सैंपलिंग फ़्रीक्वेंसी प्राप्त करता है (SBR तकनीकों के लिए उपयोग किया जाता है)। |
...
| [SamplingFrequency](../../groupdocs.metadata.formats.video/matroskaaudiotrack/samplingfrequency) { get; } | Hz. में नमूना आवृत्ति प्राप्त करता है |
