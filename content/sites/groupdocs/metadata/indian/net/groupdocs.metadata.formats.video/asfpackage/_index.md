...
description: ASF मडय कंटेनर के मूल मेटडेट क प्रतनधत्व करत है
type: docs
weight: 2340
url: /hi/net/groupdocs.metadata.formats.video/asfpackage/
---
## AsfPackage class

ASF मीडिया कंटेनर के मूल मेटाडेटा का प्रतिनिधित्व करता है।
...
| नाम | विवरण |
| --- | --- |
| [CodecInformation](../../groupdocs.metadata.formats.video/asfpackage/codecinformation) { get; } | कोडेक जानकारी प्रविष्टियाँ प्राप्त करता है। |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | मेटाडेटा गुणों की संख्या प्राप्त करता है। |
| [CreationDate](../../groupdocs.metadata.formats.video/asfpackage/creationdate) { get; } | फ़ाइल के प्रारंभिक निर्माण की तिथि और समय प्राप्त करता है। |
| [FileID](../../groupdocs.metadata.formats.video/asfpackage/fileid) { get; } | इस फ़ाइल के लिए विशिष्ट पहचानकर्ता प्राप्त करता है। |
| [Flags](../../groupdocs.metadata.formats.video/asfpackage/flags) { get; } | हेडर फ्लैग प्राप्त करता है। |
...
| [MetadataDescriptors](../../groupdocs.metadata.formats.video/asfpackage/metadatadescriptors) { get; } | मेटाडेटा डिस्क्रिप्टर प्राप्त करता है। |
...
| [StreamProperties](../../groupdocs.metadata.formats.video/asfpackage/streamproperties) { get; } | डिजिटल मीडिया स्ट्रीम गुण प्राप्त करता है। |
