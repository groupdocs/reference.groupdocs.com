...
description: FLV वडय में मेटडेट के सथ कम करने क अनुमत देने वले रूट पैकेज क प्रतनधत्व करत है
type: docs
weight: 2420
url: /hi/net/groupdocs.metadata.formats.video/flvrootpackage/
---
## FlvRootPackage class

FLV वीडियो में मेटाडेटा के साथ काम करने की अनुमति देने वाले रूट पैकेज का प्रतिनिधित्व करता है।
...
| [Header](../../groupdocs.metadata.formats.video/flvrootpackage/header) { get; } | FLV हेडर पैकेज प्राप्त करता है। |
...
| [XmpPackage](../../groupdocs.metadata.formats.video/flvrootpackage/xmppackage) { get; set; } | एक्सएमपी मेटाडेटा पैकेज प्राप्त या सेट करता है। |
