...
description: एक Matroska वडय में मेटडेट के सथ कम करने क अनुमत देने वले रूट पैकेज क प्रतनधत्व करत है
type: docs
weight: 2480
url: /hi/net/groupdocs.metadata.formats.video/matroskarootpackage/
---
## MatroskaRootPackage class

एक Matroska वीडियो में मेटाडेटा के साथ काम करने की अनुमति देने वाले रूट पैकेज का प्रतिनिधित्व करता है।
...
| [MatroskaPackage](../../groupdocs.metadata.formats.video/matroskarootpackage/matroskapackage) { get; } | Matroska मेटाडेटा पैकेज प्राप्त करता है। |
...
यह उदाहरण दर्शाता है कि किसी MKV वीडियो से उपशीर्षक कैसे निकाले जाते हैं।
