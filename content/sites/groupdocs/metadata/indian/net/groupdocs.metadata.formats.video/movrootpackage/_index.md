...
description: क्वकटइम वडय में मेटडेट के सथ कम करने क अनुमत देने वले रूट पैकेज क प्रतनधत्व करत है
type: docs
weight: 2640
url: /hi/net/groupdocs.metadata.formats.video/movrootpackage/
---
## MovRootPackage class

क्विकटाइम वीडियो में मेटाडेटा के साथ काम करने की अनुमति देने वाले रूट पैकेज का प्रतिनिधित्व करता है।
...
| [MovPackage](../../groupdocs.metadata.formats.video/movrootpackage/movpackage) { get; } | क्विकटाइम मेटाडेटा पैकेज प्राप्त करता है। |
...
| [XmpPackage](../../groupdocs.metadata.formats.video/movrootpackage/xmppackage) { get; set; } | एक्सएमपी मेटाडेटा पैकेज प्राप्त या सेट करता है। |
...
यह उदाहरण दिखाता है कि MOV वीडियो में QuickTime परमाणुओं को कैसे पढ़ा जाए।
