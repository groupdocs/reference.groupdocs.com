...
description: ASF मडय कंटेनर में ऑडय स्ट्रम प्रपर्ट मेटडेट क प्रतनधत्व करत है
type: docs
weight: 2230
url: /hi/net/groupdocs.metadata.formats.video/asfaudiostreamproperty/
---
## AsfAudioStreamProperty class

ASF मीडिया कंटेनर में ऑडियो स्ट्रीम प्रॉपर्टी मेटाडेटा का प्रतिनिधित्व करता है।
...
| [BitsPerSample](../../groupdocs.metadata.formats.video/asfaudiostreamproperty/bitspersample) { get; } | मोनोरल डेटा के प्रति नमूने बिट्स की संख्या प्राप्त करता है। |
| [Channels](../../groupdocs.metadata.formats.video/asfaudiostreamproperty/channels) { get; } | ऑडियो चैनलों की संख्या प्राप्त करता है। |
...
| [FormatTag](../../groupdocs.metadata.formats.video/asfaudiostreamproperty/formattag) { get; } | ऑडियो डेटा को एन्कोड करने के लिए उपयोग किए जाने वाले कोडेक की विशिष्ट आईडी प्राप्त करता है। |
...
| [SamplesPerSecond](../../groupdocs.metadata.formats.video/asfaudiostreamproperty/samplespersecond) { get; } | हर्ट्ज़ (चक्र प्रति सेकेंड) में एक मान प्राप्त करता है जो ऑडियो स्ट्रीम की नमूनाकरण दर का प्रतिनिधित्व करता है। |
