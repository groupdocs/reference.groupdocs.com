...
description: एक सएमएस डजटल हस्तक्षर मेटडेट पैकेज क प्रतनधत्व करत है
type: docs
weight: 3000
url: /hi/net/groupdocs.metadata.standards.pkcs/cmspackage/
---
## CmsPackage class

एक सीएमएस डिजिटल हस्ताक्षर मेटाडेटा पैकेज का प्रतिनिधित्व करता है।
...
| [Flags](../../groupdocs.metadata.standards.pkcs/cmspackage/flags) { get; } | डिजिटल सिग्नेचर फ़्लैग प्राप्त करता है. |
...
| [Signatures](../../groupdocs.metadata.standards.pkcs/cmspackage/signatures) { get; } | फ़ाइल से निकाले गए हस्ताक्षरों की एक सरणी प्राप्त करता है। |
