...
description: एक सएमएस हस्तक्षरकर्त जनकर वशेषत क प्रतनधत्व करत है
type: docs
weight: 2970
url: /hi/net/groupdocs.metadata.standards.pkcs/cmsattribute/
---
## CmsAttribute class

एक सीएमएस हस्ताक्षरकर्ता जानकारी विशेषता का प्रतिनिधित्व करता है।
...
| [Oid](../../groupdocs.metadata.standards.pkcs/cmsattribute/oid) { get; } | विशेषता OID प्राप्त करता है। |
...
| [Value](../../groupdocs.metadata.standards.pkcs/cmsattribute/value) { get; } | एक स्ट्रिंग के रूप में प्रदर्शित विशेषता मान प्राप्त करता है। |
