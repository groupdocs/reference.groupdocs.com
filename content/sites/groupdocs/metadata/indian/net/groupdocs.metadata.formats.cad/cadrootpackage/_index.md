...
description: सएड ड्रइंग में मेटडेट के सथ कम करने क अनुमत देने वले रूट पैकेज क प्रतनधत्व करत है
type: docs
weight: 850
url: /hi/net/groupdocs.metadata.formats.cad/cadrootpackage/
---
## CadRootPackage class

सीएडी ड्राइंग में मेटाडेटा के साथ काम करने की अनुमति देने वाले रूट पैकेज का प्रतिनिधित्व करता है।
...
यह कोड नमूना दिखाता है कि सीएडी ड्राइंग के मेटाडेटा को कैसे पढ़ा जाए।
