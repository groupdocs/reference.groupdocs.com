...
description: कस्टम सएड मेटडेट गुणं के संग्रह क प्रतनधत्व करत है
type: docs
weight: 830
url: /hi/net/groupdocs.metadata.formats.cad/cadcustompropertypackage/
---
## CadCustomPropertyPackage class

कस्टम सीएडी मेटाडेटा गुणों के संग्रह का प्रतिनिधित्व करता है।
