...
description: एक DWG ड्रइंग में मेटडेट के सथ कम करने क अनुमत देने वले रूट पैकेज क प्रतनधत्व करत है
type: docs
weight: 860
url: /hi/net/groupdocs.metadata.formats.cad/dwgrootpackage/
---
## DwgRootPackage class

एक DWG ड्राइंग में मेटाडेटा के साथ काम करने की अनुमति देने वाले रूट पैकेज का प्रतिनिधित्व करता है।
...
| नाम | विवरण |
| --- | --- |
| [CadPackage](../../groupdocs.metadata.formats.cad/cadrootpackage/cadpackage) { get; } | सीएडी मेटाडेटा पैकेज प्राप्त करता है। |
