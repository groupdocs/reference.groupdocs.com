...
description: NIKON मेकरनट मेटडेट क प्रतनधत्व करत है
type: docs
weight: 2840
url: /hi/net/groupdocs.metadata.standards.exif.makernote/nikonmakernotepackage/
---
## NikonMakerNotePackage class

NIKON मेकरनोट मेटाडेटा का प्रतिनिधित्व करता है।
...
| नाम | विवरण |
| --- | --- |
| [NikonMakerNotePackage](nikonmakernotepackage)(TiffTag[]) | का एक नया उदाहरण प्रारंभ करता है[`NikonMakerNotePackage`](../nikonmakernotepackage) वर्ग. |

## गुण

| नाम | विवरण |
| --- | --- |
| [ColorMode](../../groupdocs.metadata.standards.exif.makernote/nikonmakernotepackage/colormode) { get; } | रंग मोड प्राप्त करता है। |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | मेटाडेटा गुणों की संख्या प्राप्त करता है। |
| [FlashSetting](../../groupdocs.metadata.standards.exif.makernote/nikonmakernotepackage/flashsetting) { get; } | फ्लैश सेटिंग प्राप्त करता है। |
| [FlashType](../../groupdocs.metadata.standards.exif.makernote/nikonmakernotepackage/flashtype) { get; } | फ्लैश का प्रकार प्राप्त करता है। |
| [FocusMode](../../groupdocs.metadata.standards.exif.makernote/nikonmakernotepackage/focusmode) { get; } | फोकस मोड प्राप्त करता है। |
| [Iso](../../groupdocs.metadata.standards.exif.makernote/nikonmakernotepackage/iso) { get; } | iso. प्राप्त करता है |
...
| [MakerNoteVersion](../../groupdocs.metadata.standards.exif.makernote/nikonmakernotepackage/makernoteversion) { get; } | मेकरनोट संस्करण प्राप्त करता है। |
...
| [Quality](../../groupdocs.metadata.standards.exif.makernote/nikonmakernotepackage/quality) { get; } | गुणवत्ता स्ट्रिंग प्राप्त करता है। |
| [Sharpness](../../groupdocs.metadata.standards.exif.makernote/nikonmakernotepackage/sharpness) { get; } | तीक्ष्णता प्राप्त करता है। |
| [WhiteBalance](../../groupdocs.metadata.standards.exif.makernote/nikonmakernotepackage/whitebalance) { get; } | सफेद संतुलन प्राप्त करता है। |
