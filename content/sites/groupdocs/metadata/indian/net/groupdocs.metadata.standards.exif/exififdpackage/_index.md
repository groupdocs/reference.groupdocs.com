...
description: Exif छव फ़इल नर्देशक क प्रतनधत्व करत है Exif IFD Exifवशष्ट वशेषत जनकर रकर्ड करने के लए टैग क एक सेट है
type: docs
weight: 2780
url: /hi/net/groupdocs.metadata.standards.exif/exififdpackage/
---
## ExifIfdPackage class

Exif छवि फ़ाइल निर्देशिका का प्रतिनिधित्व करता है। Exif IFD, Exif-विशिष्ट विशेषता जानकारी रिकॉर्ड करने के लिए टैग का एक सेट है।
...
| नाम | विवरण |
| --- | --- |
| [BodySerialNumber](../../groupdocs.metadata.standards.exif/exififdpackage/bodyserialnumber) { get; set; } | कैमरा बॉडी सीरियल नंबर प्राप्त या सेट करता है। |
| [CameraOwnerName](../../groupdocs.metadata.standards.exif/exififdpackage/cameraownername) { get; set; } | कैमरे के मालिक का नाम प्राप्त या सेट करता है। |
| [CfaPattern](../../groupdocs.metadata.standards.exif/exififdpackage/cfapattern) { get; set; } | इमेज सेंसर के कलर फिल्टर ऐरे (CFA) जियोमेट्रिक पैटर्न को प्राप्त या सेट करता है जब एक-चिप कलर एरिया सेंसर का उपयोग किया जाता है। |
...
| [UserComment](../../groupdocs.metadata.standards.exif/exififdpackage/usercomment) { get; set; } | उपयोगकर्ता टिप्पणी प्राप्त या सेट करता है। |
