...
description: EXIF मेटडेट शब्दकशं के लए एक सर आधर वर्ग प्रदन करत है
type: docs
weight: 2750
url: /hi/net/groupdocs.metadata.standards.exif/exifdictionarybasepackage/
---
## ExifDictionaryBasePackage class

EXIF मेटाडेटा शब्दकोशों के लिए एक सार आधार वर्ग प्रदान करता है।
