...
description: एक PRIV फ्रेम क प्रतनधत्व करत हैID3V2Tag./id3v2tag . फ्रेम क उपयग सफ़्टवेयर नर्मत से जनकर रखने के लए कय जत है क इसक प्रग्रम क उपयग करत है और अन्य फ्रेम में फट नहं हत है
type: docs
weight: 480
url: /hi/net/groupdocs.metadata.formats.audio/id3v2privateframe/
---
## ID3V2PrivateFrame class

एक PRIV फ्रेम का प्रतिनिधित्व करता है[`ID3V2Tag`](../id3v2tag) . फ्रेम का उपयोग सॉफ़्टवेयर निर्माता से जानकारी रखने के लिए किया जाता है कि इसका प्रोग्राम का उपयोग करता है और अन्य फ्रेम में फिट नहीं होता है।
...
| नाम | विवरण |
| --- | --- |
| [ID3V2PrivateFrame](id3v2privateframe)(string, byte[]) | का एक नया उदाहरण प्रारंभ करता है[`ID3V2PrivateFrame`](../id3v2privateframe) वर्ग. |

## गुण

| नाम | विवरण |
| --- | --- |
| [BinaryData](../../groupdocs.metadata.formats.audio/id3v2privateframe/binarydata) { get; } | बाइनरी डेटा प्राप्त करता है। |
...
| [OwnerIdentifier](../../groupdocs.metadata.formats.audio/id3v2privateframe/owneridentifier) { get; } | स्वामी पहचानकर्ता प्राप्त करता है। |
