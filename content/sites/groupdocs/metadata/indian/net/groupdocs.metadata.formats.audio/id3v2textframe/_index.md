...
description: एक टेक्स्ट फ्रेम क प्रतनधत्व करत हैID3V2Tag./id3v2tag . ट अक्षर से शुरू हने वले लगभग सभ फ्रेम इस श्रेण में आते हैं केवल एक अपवद है ज TXXX फ्रेम द्वर दर्शय गय हैID3V2UserDefinedFrame./id3v2userdefinedframe वर्ग.
type: docs
weight: 520
url: /hi/net/groupdocs.metadata.formats.audio/id3v2textframe/
---
## ID3V2TextFrame class

एक टेक्स्ट फ्रेम का प्रतिनिधित्व करता है[`ID3V2Tag`](../id3v2tag) . टी अक्षर से शुरू होने वाले लगभग सभी फ्रेम इस श्रेणी में आते हैं। केवल एक अपवाद है, जो TXXX फ्रेम द्वारा दर्शाया गया है[`ID3V2UserDefinedFrame`](../id3v2userdefinedframe) वर्ग.
...
| नाम | विवरण |
| --- | --- |
| [ID3V2TextFrame](id3v2textframe)(string, ID3V2EncodingType, string) | का एक नया उदाहरण प्रारंभ करता है[`ID3V2TextFrame`](../id3v2textframe) वर्ग. |
...
| [Text](../../groupdocs.metadata.formats.audio/id3v2textframe/text) { get; } | पाठ मान प्राप्त करता है। |
| [TextEncoding](../../groupdocs.metadata.formats.audio/id3v2textframe/textencoding) { get; } | टेक्स्ट एन्कोडिंग प्राप्त करता है। |
