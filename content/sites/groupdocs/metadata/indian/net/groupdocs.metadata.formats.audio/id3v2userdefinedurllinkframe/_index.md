...
description: एक WXXX फ्रेम क प्रतनधत्व करत हैID3V2Tag./id3v2tag .
type: docs
weight: 550
url: /hi/net/groupdocs.metadata.formats.audio/id3v2userdefinedurllinkframe/
---
## ID3V2UserDefinedUrlLinkFrame class

एक WXXX फ्रेम का प्रतिनिधित्व करता है[`ID3V2Tag`](../id3v2tag) .
...
| नाम | विवरण |
| --- | --- |
| [ID3V2UserDefinedUrlLinkFrame](id3v2userdefinedurllinkframe#constructor_1)(string, string) | का एक नया उदाहरण प्रारंभ करता है[`ID3V2UserDefinedUrlLinkFrame`](../id3v2userdefinedurllinkframe) वर्ग. |
| [ID3V2UserDefinedUrlLinkFrame](id3v2userdefinedurllinkframe#constructor)(ID3V2EncodingType, string, string) | का एक नया उदाहरण प्रारंभ करता है[`ID3V2UserDefinedUrlLinkFrame`](../id3v2userdefinedurllinkframe) वर्ग. |
...
| [Description](../../groupdocs.metadata.formats.audio/id3v2userdefinedurllinkframe/description) { get; } | विवरण प्राप्त करता है। |
| [Encoding](../../groupdocs.metadata.formats.audio/id3v2userdefinedurllinkframe/encoding) { get; } | फ्रेम का एन्कोडिंग प्राप्त करता है। |
...
| [Url](../../groupdocs.metadata.formats.audio/id3v2userdefinedurllinkframe/url) { get; } | URL प्राप्त करता है. |
