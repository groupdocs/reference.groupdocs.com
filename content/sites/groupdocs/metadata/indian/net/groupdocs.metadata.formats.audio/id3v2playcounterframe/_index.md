...
description: एक पसएनट फ्रेम क प्रतनधत्व करत हैID3V2Tag./id3v2tag . यह केवल एक फ़इल क चलने क संख्य क एक कउंटर है
type: docs
weight: 470
url: /hi/net/groupdocs.metadata.formats.audio/id3v2playcounterframe/
---
## ID3V2PlayCounterFrame class

एक पीसीएनटी फ्रेम का प्रतिनिधित्व करता है[`ID3V2Tag`](../id3v2tag) . यह केवल एक फ़ाइल को चलाने की संख्या का एक काउंटर है।
...
| [Value](../../groupdocs.metadata.formats.audio/id3v2playcounterframe/value) { get; } | फ़ाइल को चलाने की संख्या प्राप्त करता है। |
