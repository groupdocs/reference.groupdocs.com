...
description: एक यूआरएल लंक फ्रेम क प्रतनधत्व करत हैID3V2Tag./id3v2tag फ़्रेम क नम हमेश W अक्षर से शुरू हत है.
type: docs
weight: 530
url: /hi/net/groupdocs.metadata.formats.audio/id3v2urllinkframe/
---
## ID3V2UrlLinkFrame class

एक यूआरएल लिंक फ्रेम का प्रतिनिधित्व करता है[`ID3V2Tag`](../id3v2tag) फ़्रेम का नाम हमेशा W अक्षर से शुरू होता है.
...
| नाम | विवरण |
| --- | --- |
| [ID3V2UrlLinkFrame](id3v2urllinkframe)(string, string) | का एक नया उदाहरण प्रारंभ करता है[`ID3V2UrlLinkFrame`](../id3v2urllinkframe) वर्ग. |
...
| [Url](../../groupdocs.metadata.formats.audio/id3v2urllinkframe/url) { get; } | URL मान प्राप्त करता है। |
