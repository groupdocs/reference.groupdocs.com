...
description: WAV ऑडय में मेटडेट के सथ कम करने क अनुमत देने वले रूट पैकेज क प्रतनधत्व करत है
type: docs
weight: 600
url: /hi/net/groupdocs.metadata.formats.audio/wavrootpackage/
---
## WavRootPackage class

WAV ऑडियो में मेटाडेटा के साथ काम करने की अनुमति देने वाले रूट पैकेज का प्रतिनिधित्व करता है।
...
| [RiffInfoPackage](../../groupdocs.metadata.formats.audio/wavrootpackage/riffinfopackage) { get; } | RIFF जानकारी टैग वाले पैकेज को प्राप्त करता है। |
| [WavPackage](../../groupdocs.metadata.formats.audio/wavrootpackage/wavpackage) { get; } | WAV मूल मेटाडेटा पैकेज प्राप्त करता है। |
| [XmpPackage](../../groupdocs.metadata.formats.audio/wavrootpackage/xmppackage) { get; set; } | एक्सएमपी मेटाडेटा पैकेज प्राप्त या सेट करता है। |
