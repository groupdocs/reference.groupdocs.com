...
description: एक COMM फ्रेम क प्रतनधत्व करत हैID3V2Tag./id3v2tag .
type: docs
weight: 440
url: /hi/net/groupdocs.metadata.formats.audio/id3v2commentframe/
---
## ID3V2CommentFrame class

एक COMM फ्रेम का प्रतिनिधित्व करता है[`ID3V2Tag`](../id3v2tag) .
...
| नाम | विवरण |
| --- | --- |
| [ID3V2CommentFrame](id3v2commentframe)(ID3V2EncodingType, string, string, string) | का एक नया उदाहरण प्रारंभ करता है[`ID3V2CommentFrame`](../id3v2commentframe) वर्ग. |

## गुण

| नाम | विवरण |
| --- | --- |
| [CommentEncoding](../../groupdocs.metadata.formats.audio/id3v2commentframe/commentencoding) { get; } | टिप्पणी का एन्कोडिंग प्राप्त करता है। |
...
| [Language](../../groupdocs.metadata.formats.audio/id3v2commentframe/language) { get; } | टिप्पणी की भाषा प्राप्त करता है (3 वर्ण). |
...
| [ShortContentDescription](../../groupdocs.metadata.formats.audio/id3v2commentframe/shortcontentdescription) { get; } | संक्षिप्त सामग्री विवरण प्राप्त करता है। |
| [Text](../../groupdocs.metadata.formats.audio/id3v2commentframe/text) { get; } | टिप्पणी का पाठ प्राप्त करता है। |
...
यह फ्रेम किसी भी प्रकार की पूर्ण टेक्स्ट जानकारी के लिए अभिप्रेत है जो किसी अन्य फ्रेम में फिट नहीं होती है।
