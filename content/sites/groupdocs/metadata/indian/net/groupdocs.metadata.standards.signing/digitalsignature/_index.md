...
description: दस्तवेज़ पर हस्तक्षर करने के लए उपयग कए जने वले डजटल हस्तक्षर क प्रतनधत्व करत है
type: docs
weight: 3030
url: /hi/net/groupdocs.metadata.standards.signing/digitalsignature/
---
## DigitalSignature class

दस्तावेज़ पर हस्ताक्षर करने के लिए उपयोग किए जाने वाले डिजिटल हस्ताक्षर का प्रतिनिधित्व करता है।
...
| virtual [SignTime](../../groupdocs.metadata.standards.signing/digitalsignature/signtime) { get; } | उस समय को प्राप्त करता है जब दस्तावेज़ पर हस्ताक्षर किए गए थे। |
...
* नाम स्थान [GroupDocs.Metadata.Standards.Signing](../../groupdocs.metadata.standards.signing)
