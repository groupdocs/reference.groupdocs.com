...
description: टरेंट फ़इल के मेटडेट के सथ कम करने के उद्देश्य से रूट पैकेज क प्रतनधत्व करत है
type: docs
weight: 2200
url: /hi/net/groupdocs.metadata.formats.peer2peer/torrentrootpackage/
---
## TorrentRootPackage class

टोरेंट फ़ाइल के मेटाडेटा के साथ काम करने के उद्देश्य से रूट पैकेज का प्रतिनिधित्व करता है।
...
| [TorrentPackage](../../groupdocs.metadata.formats.peer2peer/torrentrootpackage/torrentpackage) { get; } | टोरेंट फ़ाइल मेटाडेटा पैकेज प्राप्त करता है। |
...
यह कोड नमूना दिखाता है कि टोरेंट फ़ाइल के मेटाडेटा को कैसे पढ़ा जाए।
