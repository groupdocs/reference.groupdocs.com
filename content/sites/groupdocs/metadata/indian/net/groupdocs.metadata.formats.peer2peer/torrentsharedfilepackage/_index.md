...
description: सझ फ़इल जनकर क प्रतनधत्व करत है टरेंट वतरण में प्रत्येक फ़इल के बरे में वस्तृत जनकर रखत है
type: docs
weight: 2210
url: /hi/net/groupdocs.metadata.formats.peer2peer/torrentsharedfilepackage/
---
## TorrentSharedFilePackage class

साझा फ़ाइल जानकारी का प्रतिनिधित्व करता है। टोरेंट वितरण में प्रत्येक फ़ाइल के बारे में विस्तृत जानकारी रखता है।
...
| [Length](../../groupdocs.metadata.formats.peer2peer/torrentsharedfilepackage/length) { get; } | बाइट्स में फ़ाइल की लंबाई प्राप्त करता है। |
| [MetadataType](../../groupdocs.metadata.common/metadatapackage/metadatatype) { get; } | मेटाडेटा प्रकार प्राप्त करता है। |
| [Name](../../groupdocs.metadata.formats.peer2peer/torrentsharedfilepackage/name) { get; } | फ़ाइल का पूरा नाम प्राप्त करता है (रूट टोरेंट फ़ोल्डर से फ़ाइल के सापेक्ष पथ)। |
