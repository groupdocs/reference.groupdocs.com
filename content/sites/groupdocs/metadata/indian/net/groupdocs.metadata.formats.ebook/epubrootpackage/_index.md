...
description: EPUB ईबुक में मेटडेट के सथ कम करने क अनुमत देने वले रूट पैकेज क प्रतनधत्व करत है
type: docs
weight: 1340
url: /hi/net/groupdocs.metadata.formats.ebook/epubrootpackage/
---
## EpubRootPackage class

EPUB ई-बुक में मेटाडेटा के साथ काम करने की अनुमति देने वाले रूट पैकेज का प्रतिनिधित्व करता है।
...
| [DublinCorePackage](../../groupdocs.metadata.formats.ebook/epubrootpackage/dublincorepackage) { get; } | ई-पुस्तक से निकाला गया डबलिन कोर मेटाडेटा पैकेज प्राप्त करता है। |
| [EpubPackage](../../groupdocs.metadata.formats.ebook/epubrootpackage/epubpackage) { get; } | EPUB मेटाडेटा पैकेज प्राप्त करता है। |
...
* नाम स्थान [GroupDocs.Metadata.Formats.Ebook](../../groupdocs.metadata.formats.ebook)
