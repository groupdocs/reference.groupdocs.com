...
description: फ़इल से नकले गए एकल फ़न्ट क प्रतनधत्व करत है
type: docs
weight: 1460
url: /hi/net/groupdocs.metadata.formats.font/opentypefont/
---
## OpenTypeFont class

फ़ाइल से निकाले गए एकल फ़ॉन्ट का प्रतिनिधित्व करता है।
...
| [Created](../../groupdocs.metadata.formats.font/opentypefont/created) { get; } | निर्मित तिथि प्राप्त करता है। |
| [DirectionHint](../../groupdocs.metadata.formats.font/opentypefont/directionhint) { get; } | दिशा संकेत मिलता है। |
| [EmbeddingLicensingRights](../../groupdocs.metadata.formats.font/opentypefont/embeddinglicensingrights) { get; } | एम्बेडिंग लाइसेंसिंग अधिकार प्रकार प्राप्त करता है. |
| [Flags](../../groupdocs.metadata.formats.font/opentypefont/flags) { get; } | हेडर फ्लैग प्राप्त करता है। |
| [FontFamilyName](../../groupdocs.metadata.formats.font/opentypefont/fontfamilyname) { get; } | फ़ॉन्ट परिवार का नाम प्राप्त करता है। |
| [FontRevision](../../groupdocs.metadata.formats.font/opentypefont/fontrevision) { get; } | फ़ॉन्ट संशोधन प्राप्त करता है। |
| [FontSubfamilyName](../../groupdocs.metadata.formats.font/opentypefont/fontsubfamilyname) { get; } | फ़ॉन्ट उपपरिवार का नाम प्राप्त करता है। |
| [FullFontName](../../groupdocs.metadata.formats.font/opentypefont/fullfontname) { get; } | फ़ॉन्ट का पूरा नाम प्राप्त करता है। |
| [GlyphBounds](../../groupdocs.metadata.formats.font/opentypefont/glyphbounds) { get; } | ग्लिफ़ सीमा प्राप्त करता है। |
...
| [MajorVersion](../../groupdocs.metadata.formats.font/opentypefont/majorversion) { get; } | हेडर प्रमुख संस्करण प्राप्त करता है। |
| [MetadataType](../../groupdocs.metadata.common/metadatapackage/metadatatype) { get; } | मेटाडेटा प्रकार प्राप्त करता है। |
| [MinorVersion](../../groupdocs.metadata.formats.font/opentypefont/minorversion) { get; } | हेडर लघु संस्करण प्राप्त करता है। |
| [Modified](../../groupdocs.metadata.formats.font/opentypefont/modified) { get; } | संशोधित दिनांक प्राप्त करता है। |
| [Names](../../groupdocs.metadata.formats.font/opentypefont/names) { get; } | नाम रिकॉर्ड प्राप्त करता है। |
...
| [SfntVersion](../../groupdocs.metadata.formats.font/opentypefont/sfntversion) { get; } | हेडर एसएफएनटी संस्करण प्राप्त करता है। |
| [Style](../../groupdocs.metadata.formats.font/opentypefont/style) { get; } | फ़ॉन्ट शैली प्राप्त करता है। |
| [TypographicFamily](../../groupdocs.metadata.formats.font/opentypefont/typographicfamily) { get; } | टाइपोग्राफिक परिवार प्राप्त करता है। |
| [TypographicSubfamily](../../groupdocs.metadata.formats.font/opentypefont/typographicsubfamily) { get; } | टाइपोग्राफिक सबफ़ैमिली प्राप्त करता है। |
| [Weight](../../groupdocs.metadata.formats.font/opentypefont/weight) { get; } | फ़ॉन्ट वजन प्राप्त करता है। |
| [Width](../../groupdocs.metadata.formats.font/opentypefont/width) { get; } | फ़ॉन्ट चौड़ाई प्राप्त करता है। |
