...
description: ओपनटइप फ़न्ट फ़इल में मेटडेट के सथ कम करने क अनुमत देने वले रूट पैकेज क प्रतनधत्व करत है
type: docs
weight: 1550
url: /hi/net/groupdocs.metadata.formats.font/opentyperootpackage/
---
## OpenTypeRootPackage class

ओपनटाइप फ़ॉन्ट फ़ाइल में मेटाडेटा के साथ काम करने की अनुमति देने वाले रूट पैकेज का प्रतिनिधित्व करता है।
...
| [DigitalSignaturePackage](../../groupdocs.metadata.formats.font/opentyperootpackage/digitalsignaturepackage) { get; } | डिजिटल सिग्नेचर मेटाडेटा पैकेज प्राप्त करता है. |
...
| [OpenTypePackage](../../groupdocs.metadata.formats.font/opentyperootpackage/opentypepackage) { get; } | ओपनटाइप मेटाडेटा पैकेज प्राप्त करता है। |
