...
description: एक ओपनटइप फ़न्ट मेटडेट पैकेज क प्रतनधत्व करत है
type: docs
weight: 1530
url: /hi/net/groupdocs.metadata.formats.font/opentypepackage/
---
## OpenTypePackage class

एक ओपनटाइप फ़ॉन्ट मेटाडेटा पैकेज का प्रतिनिधित्व करता है।
...
| [Fonts](../../groupdocs.metadata.formats.font/opentypepackage/fonts) { get; } | फ़ाइल से निकाले गए फोंट की एक सरणी प्राप्त करता है। |
