...
description: के लए नम रकर्ड तलक मन क प्रतनधत्व करत हैWindowsमंच.
type: docs
weight: 1640
url: /hi/net/groupdocs.metadata.formats.font/opentypewindowsnamerecord/
---
## OpenTypeWindowsNameRecord class

के लिए नाम रिकॉर्ड तालिका मान का प्रतिनिधित्व करता हैWindowsमंच.
...
| [Encoding](../../groupdocs.metadata.formats.font/opentypewindowsnamerecord/encoding) { get; } | एन्कोडिंग पहचानकर्ता प्राप्त करता है। |
...
| [Language](../../groupdocs.metadata.formats.font/opentypewindowsnamerecord/language) { get; } | भाषा पहचानकर्ता प्राप्त करता है। |
