...
| 姓名 | 描述 |
| --- | --- |
| [XmpColorantCmyk](xmpcolorantcmyk#constructor)() | 初始化一个新的实例[`XmpColorantCmyk`](../xmpcolorantcmyk)类. |
| [XmpColorantCmyk](xmpcolorantcmyk#constructor_1)(double, double, double, double) | 初始化一个新的实例[`XmpColorantCmyk`](../xmpcolorantcmyk)类. |
...
| [Magenta](../../groupdocs.metadata.standards.xmp/xmpcolorantcmyk/magenta) { get; set; } | 获取或设置品红色分量。 |
