...
| 姓名 | 描述 |
| --- | --- |
| [XmpResourceEvent](xmpresourceevent)() | 初始化[`XmpResourceEvent`](../xmpresourceevent)类. |

## 特性

| 姓名 | 描述 |
| --- | --- |
| [Action](../../groupdocs.metadata.standards.xmp/xmpresourceevent/action) { get; set; } | 获取或设置发生的动作。 |
| [Changed](../../groupdocs.metadata.standards.xmp/xmpresourceevent/changed) { get; set; } | 获取或设置自上次事件历史以来已更改的资源部分的分号分隔列表。 |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | 获取元数据属性的数量。 |
| [InstanceID](../../groupdocs.metadata.standards.xmp/xmpresourceevent/instanceid) { get; set; } | 获取或设置修改（输出）资源的 xmpMM:InstanceID 属性的值。 |
...
| [Parameters](../../groupdocs.metadata.standards.xmp/xmpresourceevent/parameters) { get; set; } | 获取或设置动作的附加描述。 |
...
| [When](../../groupdocs.metadata.standards.xmp/xmpresourceevent/when) { get; set; } | 获取或设置动作发生时间的时间戳。 |
