...
| 姓名 | 描述 |
| --- | --- |
| [XmpPackage](xmppackage)(string, string) | 初始化一个新的实例[`XmpPackage`](../xmppackage)类. |
...
| [Set](../../groupdocs.metadata.standards.xmp/xmppackage/set#set_6)(string, DateTime) | 集DateTime财产. |
