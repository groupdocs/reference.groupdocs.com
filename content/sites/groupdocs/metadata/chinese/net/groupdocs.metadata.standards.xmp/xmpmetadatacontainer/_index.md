...
description: 表示 XMP 元数据属性的容器
type: docs
weight: 3470
url: /zh/net/groupdocs.metadata.standards.xmp/xmpmetadatacontainer/
---
...
| abstract [GetXmpRepresentation](../../groupdocs.metadata.standards.xmp/xmpmetadatacontainer/getxmprepresentation)() | 将 XMP 值转换为 XML 表示形式。 |
