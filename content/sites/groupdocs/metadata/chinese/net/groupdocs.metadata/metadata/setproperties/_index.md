...
description: 设置满足指定谓词的已知元数据属性 该操作是递归的因此它也会影响所有嵌套包 此方法是AddPropertiesgroupdocs.metadata/metadata/addproperties和UpdatePropertiesgroupdocs.metadata/metadata/updateproperties 如果现有属性满足谓词则更新其值 如果包中缺少满足谓词的已知属性则将其添加到包中
type: docs
weight: 120
