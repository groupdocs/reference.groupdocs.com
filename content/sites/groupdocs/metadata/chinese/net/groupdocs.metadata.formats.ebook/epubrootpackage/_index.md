...
description: 表示允许在 EPUB 电子书中使用元数据的根包
type: docs
weight: 1340
url: /zh/net/groupdocs.metadata.formats.ebook/epubrootpackage/
---
## EpubRootPackage class

表示允许在 EPUB 电子书中使用元数据的根包。
...
| [DublinCorePackage](../../groupdocs.metadata.formats.ebook/epubrootpackage/dublincorepackage) { get; } | 获取从电子书中提取的 Dublin Core 元数据包。 |
| [EpubPackage](../../groupdocs.metadata.formats.ebook/epubrootpackage/epubpackage) { get; } | 获取 EPUB 元数据包。 |
...
* 命名空间 [GroupDocs.Metadata.Formats.Ebook](../../groupdocs.metadata.formats.ebook)
