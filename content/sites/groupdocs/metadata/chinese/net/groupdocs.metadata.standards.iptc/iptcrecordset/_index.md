...
| 姓名 | 描述 |
| --- | --- |
| [IptcRecordSet](iptcrecordset#constructor)() | 初始化一个新的实例[`IptcRecordSet`](../iptcrecordset)类. |
| [IptcRecordSet](iptcrecordset#constructor_1)(IptcDataSet[]) | 初始化一个新的实例[`IptcRecordSet`](../iptcrecordset)类. |
...
| [Item](../../groupdocs.metadata.standards.iptc/iptcrecordset/item) { get; } | 获取[`IptcRecord`](../iptcrecord)用指定的数字. (3 indexers) |
...
| 姓名 | 描述 |
| --- | --- |
| [Add](../../groupdocs.metadata.standards.iptc/iptcrecordset/add)(IptcDataSet) | 将指定的数据集添加到适当的记录中。 如果具有指定编号的数据集已经存在，则该数据集被认为是可重复的。 |
...
| [Remove](../../groupdocs.metadata.standards.iptc/iptcrecordset/remove#remove)(byte) | 删除具有指定记录号的记录。 |
...
| [Set](../../groupdocs.metadata.standards.iptc/iptcrecordset/set)(IptcDataSet) | 在适当的记录中添加或更新指定的数据集。 |
...
| [ToDataSetList](../../groupdocs.metadata.standards.iptc/iptcrecordset/todatasetlist)() | 从包中创建数据集列表。 |
