...
| 姓名 | 描述 |
| --- | --- |
| [XmpBasicPackage](xmpbasicpackage)() | 初始化一个新的实例[`XmpBasicPackage`](../xmpbasicpackage)类. |

## 特性

| 姓名 | 描述 |
| --- | --- |
| [BaseUrl](../../groupdocs.metadata.standards.xmp.schemes/xmpbasicpackage/baseurl) { get; set; } | 获取或设置文档内容中相对 URL 的基本 URL。 如果此文档包含 Internet 链接，并且这些链接是相对的，则它们是相对于此基本 URL 的。 |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | 获取元数据属性的数量。 |
| [CreateDate](../../groupdocs.metadata.standards.xmp.schemes/xmpbasicpackage/createdate) { get; set; } | 获取或设置创建资源的日期和时间。 |
| [CreatorTool](../../groupdocs.metadata.standards.xmp.schemes/xmpbasicpackage/creatortool) { get; set; } | 获取或设置用于创建资源的工具的名称。 |
| [Identifiers](../../groupdocs.metadata.standards.xmp.schemes/xmpbasicpackage/identifiers) { get; set; } | 获取或设置一个无序的文本字符串数组，这些字符串明确标识给定上下文中的资源。 |
...
| [Label](../../groupdocs.metadata.standards.xmp.schemes/xmpbasicpackage/label) { get; set; } | 获取或设置将资源标识为用户定义集合成员的词或短语。 |
...
| [Thumbnails](../../groupdocs.metadata.standards.xmp.schemes/xmpbasicpackage/thumbnails) { get; set; } | 获取或设置文件的缩略图数组，这些缩略图在大小或图像编码等特性上可能不同。 |
...
| const [RatingMin](../../groupdocs.metadata.standards.xmp.schemes/xmpbasicpackage/ratingmin) | 评级最小值。 |
