...
type: docs
weight: 3090
url: /zh/net/groupdocs.metadata.standards.xmp.schemes/xmpbasicpackage/
---
...
| 姓名 | 描述 |
| --- | --- |
| [XmpBasicPackage](xmpbasicpackage)() | 初始化[`XmpBasicPackage`](../xmpbasicpackage)类. |

## 特性

| 姓名 | 描述 |
| --- | --- |
| [BaseUrl](../../groupdocs.metadata.standards.xmp.schemes/xmpbasicpackage/baseurl) { get; set; } | 获取或设置文档内容中相对 URL 的基本 URL。 如果此文档包含 Internet 链接，并且这些链接是相对的，则它们相对于此基本 URL。 |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | 获取元数据属性的数量。 |
| [CreateDate](../../groupdocs.metadata.standards.xmp.schemes/xmpbasicpackage/createdate) { get; set; } | 获取或设置资源创建的日期和时间。 |
| [CreatorTool](../../groupdocs.metadata.standards.xmp.schemes/xmpbasicpackage/creatortool) { get; set; } | 获取或设置用于创建资源的工具的名称。 |
| [Identifiers](../../groupdocs.metadata.standards.xmp.schemes/xmpbasicpackage/identifiers) { get; set; } | 获取或设置一个无序的文本字符串数组，明确标识给定上下文中的资源。 |
...
| [Label](../../groupdocs.metadata.standards.xmp.schemes/xmpbasicpackage/label) { get; set; } | 获取或设置将资源标识为用户定义集合成员的单词或短语。 |
| [MetadataDate](../../groupdocs.metadata.standards.xmp.schemes/xmpbasicpackage/metadatadate) { get; set; } | 获取或设置上次更改此资源的任何元数据的日期和时间。 |
| [MetadataType](../../groupdocs.metadata.common/metadatapackage/metadatatype) { get; } | 获取元数据类型。 |
| [ModifyDate](../../groupdocs.metadata.standards.xmp.schemes/xmpbasicpackage/modifydate) { get; set; } | 获取或设置上次修改资源的日期和时间。 |
| [NamespaceUri](../../groupdocs.metadata.standards.xmp/xmppackage/namespaceuri) { get; } | 获取命名空间 URI。 |
| [Nickname](../../groupdocs.metadata.standards.xmp.schemes/xmpbasicpackage/nickname) { get; set; } | 获取或设置资源的简短非正式名称。 |
...
| [Rating](../../groupdocs.metadata.standards.xmp.schemes/xmpbasicpackage/rating) { get; set; } | 获取或设置此文件的用户指定评级。 值应为 -1 或在 [0..5] 范围内，其中 -1 表示“拒绝”，0 表示“未评级”。 |
| [Thumbnails](../../groupdocs.metadata.standards.xmp.schemes/xmpbasicpackage/thumbnails) { get; set; } | 获取或设置文件的缩略图数组，其大小或图像编码等特征可能不同。 |
...
| override [Set](../../groupdocs.metadata.standards.xmp.schemes/xmpbasicpackage/set#set_7)(string, string) | 添加字符串属性。 |
...
| 姓名 | 描述 |
| --- | --- |
| const [RatingMax](../../groupdocs.metadata.standards.xmp.schemes/xmpbasicpackage/ratingmax) | 评级最大值。 |
| const [RatingMin](../../groupdocs.metadata.standards.xmp.schemes/xmpbasicpackage/ratingmin) | 评分最小值。 |
| const [RatingRejected](../../groupdocs.metadata.standards.xmp.schemes/xmpbasicpackage/ratingrejected) | 评级拒绝值。 |
