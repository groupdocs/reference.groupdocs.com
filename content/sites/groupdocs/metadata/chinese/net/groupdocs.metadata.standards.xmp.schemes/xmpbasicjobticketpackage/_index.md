...
description: 表示基本作业单命名空间
type: docs
weight: 3080
url: /zh/net/groupdocs.metadata.standards.xmp.schemes/xmpbasicjobticketpackage/
---
...
| 姓名 | 描述 |
| --- | --- |
| [XmpBasicJobTicketPackage](xmpbasicjobticketpackage)() | 初始化[`XmpBasicJobTicketPackage`](../xmpbasicjobticketpackage)类. |
...
| [Jobs](../../groupdocs.metadata.standards.xmp.schemes/xmpbasicjobticketpackage/jobs) { get; set; } | 获取或设置作业。 |
