...
| 姓名 | 描述 |
| --- | --- |
| [XmpDublinCorePackage](xmpdublincorepackage)() | 初始化[`XmpDublinCorePackage`](../xmpdublincorepackage)类. |
...
| [Creators](../../groupdocs.metadata.standards.xmp.schemes/xmpdublincorepackage/creators) { get; set; } | 获取或设置创建者数组。 |
...
| [Identifier](../../groupdocs.metadata.standards.xmp.schemes/xmpdublincorepackage/identifier) { get; set; } | 获取或设置一个字符串值，表示对给定上下文中资源的明确引用。 |
...
| [Rights](../../groupdocs.metadata.standards.xmp.schemes/xmpdublincorepackage/rights) { get; set; } | 获取或设置一系列非正式权利声明，以各种语言给出。 |
| [Source](../../groupdocs.metadata.standards.xmp.schemes/xmpdublincorepackage/source) { get; set; } | 获取或设置所描述资源的相关资源。 |
| [Subjects](../../groupdocs.metadata.standards.xmp.schemes/xmpdublincorepackage/subjects) { get; set; } | 获取或设置一组描述性短语或关键字，用于指定资源的内容。 |
| [Titles](../../groupdocs.metadata.standards.xmp.schemes/xmpdublincorepackage/titles) { get; set; } | 获取或设置资源的标题或名称，以各种语言给出。 |
| [Types](../../groupdocs.metadata.standards.xmp.schemes/xmpdublincorepackage/types) { get; set; } | 获取或设置表示资源性质或类型的字符串值数组。 |
...
| [SetDescription](../../groupdocs.metadata.standards.xmp.schemes/xmpdublincorepackage/setdescription)(string) | 设置资源描述，以单一语言给出。 |
...
| [SetRights](../../groupdocs.metadata.standards.xmp.schemes/xmpdublincorepackage/setrights)(string) | 设置资源权限，以单一语言给出。 |
| [SetSubject](../../groupdocs.metadata.standards.xmp.schemes/xmpdublincorepackage/setsubject)(string) | 设置资源的单个主题。 |
| [SetTitle](../../groupdocs.metadata.standards.xmp.schemes/xmpdublincorepackage/settitle)(string) | 设置资源标题，以单一语言给出。 |
| [SetType](../../groupdocs.metadata.standards.xmp.schemes/xmpdublincorepackage/settype)(string) | 设置资源的单一类型。 |
