...
| 姓名 | 描述 |
| --- | --- |
| [XmpRightsManagementPackage](xmprightsmanagementpackage)() | 初始化[`XmpRightsManagementPackage`](../xmprightsmanagementpackage)类. |
...
| [Marked](../../groupdocs.metadata.standards.xmp.schemes/xmprightsmanagementpackage/marked) { get; set; } | 获取或设置一个值，指示这是否是一个权限管理的资源。 |
