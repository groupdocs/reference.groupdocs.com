...
description: 表示 XMP 分页文本包
type: docs
weight: 3180
url: /zh/net/groupdocs.metadata.standards.xmp.schemes/xmppagedtextpackage/
---
...
| 姓名 | 描述 |
| --- | --- |
| [XmpPagedTextPackage](xmppagedtextpackage)() | 初始化[`XmpPagedTextPackage`](../xmppagedtextpackage)类. |

## 特性

| 姓名 | 描述 |
| --- | --- |
| [Colorants](../../groupdocs.metadata.standards.xmp.schemes/xmppagedtextpackage/colorants) { get; set; } | 获取或设置文档（包括包含的任何文档）中使用的着色剂（色板）的有序数组。 |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | 获取元数据属性的数量。 |
| [Fonts](../../groupdocs.metadata.standards.xmp.schemes/xmppagedtextpackage/fonts) { get; set; } | 获取或设置文档中使用的无序字体数组（包括包含的任何文档）。 |
...
| [MaxPageSize](../../groupdocs.metadata.standards.xmp.schemes/xmppagedtextpackage/maxpagesize) { get; set; } | 获取或设置文档中最大页面的大小（包括包含的任何文档）。 |
...
| [NumberOfPages](../../groupdocs.metadata.standards.xmp.schemes/xmppagedtextpackage/numberofpages) { get; set; } | 获取或设置文档的页数。 |
| [PlateNames](../../groupdocs.metadata.standards.xmp.schemes/xmppagedtextpackage/platenames) { get; set; } | 获取或设置打印文档（包括包含的任何文档）所需的板名的有序数组。 |
...
| override [Set](../../groupdocs.metadata.standards.xmp.schemes/xmppagedtextpackage/set#set_7)(string, string) | 设置字符串属性。 |
| override [Set](../../groupdocs.metadata.standards.xmp.schemes/xmppagedtextpackage/set#set_2)(string, XmpArray) | 设置继承自的值[`XmpArray`](../../groupdocs.metadata.standards.xmp/xmparray). |
