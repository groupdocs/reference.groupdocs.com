...
| 姓名 | 描述 |
| --- | --- |
| [XmpPagedTextPackage](xmppagedtextpackage)() | 初始化一个新的实例[`XmpPagedTextPackage`](../xmppagedtextpackage)类. |

## 特性

| 姓名 | 描述 |
| --- | --- |
| [Colorants](../../groupdocs.metadata.standards.xmp.schemes/xmppagedtextpackage/colorants) { get; set; } | 获取或设置文档中使用的着色剂（样本）的有序数组（包括包含的文档中的任何内容）。 |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | 获取元数据属性的数量。 |
| [Fonts](../../groupdocs.metadata.standards.xmp.schemes/xmppagedtextpackage/fonts) { get; set; } | 获取或设置文档中使用的无序字体数组（包括包含的文档中的任何字体）。 |
...
| [MaxPageSize](../../groupdocs.metadata.standards.xmp.schemes/xmppagedtextpackage/maxpagesize) { get; set; } | 获取或设置文档中最大页面的大小（包括包含文档中的任何页面）。 |
...
| [NumberOfPages](../../groupdocs.metadata.standards.xmp.schemes/xmppagedtextpackage/numberofpages) { get; set; } | 获取或设置文档中的页数。 |
| [PlateNames](../../groupdocs.metadata.standards.xmp.schemes/xmppagedtextpackage/platenames) { get; set; } | 获取或设置打印文档（包括包含的文档中的任何内容）所需的印版名称的有序数组。 |
