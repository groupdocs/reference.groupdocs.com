...
| 姓名 | 描述 |
| --- | --- |
| [XmpPdfPackage](xmppdfpackage)() | 初始化一个新的实例[`XmpPdfPackage`](../xmppdfpackage)类. |
...
| [IsTrapped](../../groupdocs.metadata.standards.xmp.schemes/xmppdfpackage/istrapped) { get; set; } | 获取或设置一个值，指示文档是否已被陷印。 |
