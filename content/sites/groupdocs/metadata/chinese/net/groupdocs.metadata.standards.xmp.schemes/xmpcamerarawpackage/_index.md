...
| 姓名 | 描述 |
| --- | --- |
| [XmpCameraRawPackage](xmpcamerarawpackage)() | 初始化[`XmpCameraRawPackage`](../xmpcamerarawpackage)类. |

## 特性

| 姓名 | 描述 |
| --- | --- |
| [AutoBrightness](../../groupdocs.metadata.standards.xmp.schemes/xmpcamerarawpackage/autobrightness) { get; set; } | 获取或设置 AutoBrightness 值。真实时，[`Brightness`](./brightness)自动调整。 |
...
| [AutoExposure](../../groupdocs.metadata.standards.xmp.schemes/xmpcamerarawpackage/autoexposure) { get; set; } | 获取或设置 AutoExposure 值。为真时，“曝光”会自动调整。 |
...
| [BlueHue](../../groupdocs.metadata.standards.xmp.schemes/xmpcamerarawpackage/bluehue) { get; set; } | 获取或设置 BlueHue 值。如果未定义，则为空。 |
| [BlueSaturation](../../groupdocs.metadata.standards.xmp.schemes/xmpcamerarawpackage/bluesaturation) { get; set; } | 获取或设置 BlueSaturation。如果未定义，则为空。 |
| [Brightness](../../groupdocs.metadata.standards.xmp.schemes/xmpcamerarawpackage/brightness) { get; set; } | 获取或设置亮度值。如果未定义，则为空。 |
| [CameraProfile](../../groupdocs.metadata.standards.xmp.schemes/xmpcamerarawpackage/cameraprofile) { get; set; } | 获取或设置 CameraProfile 值。 |
| [ChromaticAberrationB](../../groupdocs.metadata.standards.xmp.schemes/xmpcamerarawpackage/chromaticaberrationb) { get; set; } | 获取或设置“色差，修复蓝色/黄色边缘”设置。如果未定义，则为空。 |
| [ChromaticAberrationR](../../groupdocs.metadata.standards.xmp.schemes/xmpcamerarawpackage/chromaticaberrationr) { get; set; } | 获取或设置“色差，修复红色/青色边缘”设置。如果未定义，则为空。 |
...
| [CropHeight](../../groupdocs.metadata.standards.xmp.schemes/xmpcamerarawpackage/cropheight) { get; set; } | 获取或设置裁剪后图像的高度[`CropUnits`](./cropunits)单位. |
...
| [CropRight](../../groupdocs.metadata.standards.xmp.schemes/xmpcamerarawpackage/cropright) { get; set; } | 获取或设置 CropRight 设置。当 HasCrop 为真时，裁剪矩形的右侧。 |
...
| [CropWidth](../../groupdocs.metadata.standards.xmp.schemes/xmpcamerarawpackage/cropwidth) { get; set; } | 获取或设置裁剪后图像的宽度[`CropUnits`](./cropunits)单位. |
...
| [HasSettings](../../groupdocs.metadata.standards.xmp.schemes/xmpcamerarawpackage/hassettings) { get; set; } | 获取或设置 HasSettings 值。如果为 true，则为非默认相机原始设置。 |
...
| [Version](../../groupdocs.metadata.standards.xmp.schemes/xmpcamerarawpackage/version) { get; set; } | 获取或设置 Camera Raw 插件的版本。 |
| [VignetteAmount](../../groupdocs.metadata.standards.xmp.schemes/xmpcamerarawpackage/vignetteamount) { get; set; } | 获取或设置晕影数量设置。范围 -100 到 100. |
...
| [WhiteBalance](../../groupdocs.metadata.standards.xmp.schemes/xmpcamerarawpackage/whitebalance) { get; } | 获取白平衡设置。利用[`SetWhiteBalance`](./setwhitebalance)设置白平衡值。 |
