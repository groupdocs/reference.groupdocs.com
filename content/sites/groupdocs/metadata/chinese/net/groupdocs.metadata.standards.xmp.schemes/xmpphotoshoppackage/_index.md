...
| 姓名 | 描述 |
| --- | --- |
| [XmpPhotoshopPackage](xmpphotoshoppackage)() | 初始化一个新的实例[`XmpPhotoshopPackage`](../xmpphotoshoppackage)类. |
...
| [CaptionWriter](../../groupdocs.metadata.standards.xmp.schemes/xmpphotoshoppackage/captionwriter) { get; set; } | 获取或设置编写器/编辑器。 |
| [Category](../../groupdocs.metadata.standards.xmp.schemes/xmpphotoshoppackage/category) { get; set; } | 获取或设置类别。限于 3 个 7 位 ASCII 字符。 |
...
| [Credit](../../groupdocs.metadata.standards.xmp.schemes/xmpphotoshoppackage/credit) { get; set; } | 获取或设置积分。 |
...
| [IccProfile](../../groupdocs.metadata.standards.xmp.schemes/xmpphotoshoppackage/iccprofile) { get; set; } | 获取或设置颜色配置文件，如 AppleRGB、AdobeRGB1998. |
