...
description: 表示一个通用帧ID3V2Tag./id3v2tag.
type: docs
weight: 500
url: /zh/net/groupdocs.metadata.formats.audio/id3v2tagframe/
---
## ID3V2TagFrame class

表示一个通用帧[`ID3V2Tag`](../id3v2tag).
...
| 姓名 | 描述 |
| --- | --- |
| [ID3V2TagFrame](id3v2tagframe)(string, byte[]) | 初始化一个新的实例[`ID3V2TagFrame`](../id3v2tagframe)类. |
