...
description: 表示一个PRIV帧ID3V2Tag./id3v2tag. 该框架用于包含来自软件生产商的信息即其程序使用 并且不适合其他框架
type: docs
weight: 480
url: /zh/net/groupdocs.metadata.formats.audio/id3v2privateframe/
---
## ID3V2PrivateFrame class

表示一个PRIV帧[`ID3V2Tag`](../id3v2tag). 该框架用于包含来自软件生产商的信息，即其程序使用 并且不适合其他框架。
...
| 姓名 | 描述 |
| --- | --- |
| [ID3V2PrivateFrame](id3v2privateframe)(string, byte[]) | 初始化一个新的实例[`ID3V2PrivateFrame`](../id3v2privateframe)类. |

## 特性

| 姓名 | 描述 |
| --- | --- |
| [BinaryData](../../groupdocs.metadata.formats.audio/id3v2privateframe/binarydata) { get; } | 获取二进制数据。 |
...
| [OwnerIdentifier](../../groupdocs.metadata.formats.audio/id3v2privateframe/owneridentifier) { get; } | 获取所有者标识符。 |
