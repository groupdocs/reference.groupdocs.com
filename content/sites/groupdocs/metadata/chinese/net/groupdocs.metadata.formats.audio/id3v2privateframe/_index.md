...
description: 表示一个 PRIV 帧ID3V2Tag./id3v2tag. 该框架用于包含来自软件生产商的信息即其程序使用 并且不适合其他框架
type: docs
weight: 480
...
表示一个 PRIV 帧[`ID3V2Tag`](../id3v2tag). 该框架用于包含来自软件生产商的信息，即其程序使用 并且不适合其他框架。
...
| 姓名 | 描述 |
| --- | --- |
| [ID3V2PrivateFrame](id3v2privateframe)(string, byte[]) | 初始化[`ID3V2PrivateFrame`](../id3v2privateframe)类. |
