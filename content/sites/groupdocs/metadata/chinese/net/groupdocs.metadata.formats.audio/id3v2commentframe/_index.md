...
description: 表示一个 COMM 帧ID3V2Tag./id3v2tag.
type: docs
weight: 440
url: /zh/net/groupdocs.metadata.formats.audio/id3v2commentframe/
---
## ID3V2CommentFrame class

表示一个 COMM 帧[`ID3V2Tag`](../id3v2tag).
...
| 姓名 | 描述 |
| --- | --- |
| [ID3V2CommentFrame](id3v2commentframe)(ID3V2EncodingType, string, string, string) | 初始化一个新的实例[`ID3V2CommentFrame`](../id3v2commentframe)类. |

## 特性

| 姓名 | 描述 |
| --- | --- |
| [CommentEncoding](../../groupdocs.metadata.formats.audio/id3v2commentframe/commentencoding) { get; } | 获取注释的编码。 |
...
| [Language](../../groupdocs.metadata.formats.audio/id3v2commentframe/language) { get; } | 获取评论的语言（3 个字符）。 |
...
| [ShortContentDescription](../../groupdocs.metadata.formats.audio/id3v2commentframe/shortcontentdescription) { get; } | 获取简短的内容描述。 |
| [Text](../../groupdocs.metadata.formats.audio/id3v2commentframe/text) { get; } | 获取评论的文本。 |
