...
description: 表示 ID3v1 标签 请在以下位置找到更多信息https//en.wikipedia.org/wiki/ID3ID3v1https//en.wikipedia.org/wiki/ID3ID3v1.
type: docs
weight: 410
...
表示 ID3v1 标签。 请在以下位置找到更多信息[https://en.wikipedia.org/wiki/ID3#ID3v1](https://en.wikipedia.org/wiki/ID3#ID3v1).
...
| 姓名 | 描述 |
| --- | --- |
| [ID3V1Tag](id3v1tag)() | 初始化[`ID3V1Tag`](../id3v1tag)类. |

## 特性

| 姓名 | 描述 |
| --- | --- |
| [Album](../../groupdocs.metadata.formats.audio/id3v1tag/album) { get; set; } | 获取或设置专辑。最大长度为 30 个字符。 |
...
| [TrackNumber](../../groupdocs.metadata.formats.audio/id3v1tag/tracknumber) { get; set; } | 获取或设置轨道号。仅在 ID3v1.1 标记中呈现。 |
| override [Version](../../groupdocs.metadata.formats.audio/id3v1tag/version) { get; } | 获取 ID3 版本。可以是 ID3 或 ID3v1.1 |
