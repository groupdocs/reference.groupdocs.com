...
description: 表示 ID3v1 和 ID3v2 音频标签的基本抽象类
type: docs
weight: 390
url: /zh/net/groupdocs.metadata.formats.audio/id3tag/
---
## ID3Tag class

表示 ID3(v1) 和 ID3(v2) 音频标签的基本抽象类。
...
| abstract [Version](../../groupdocs.metadata.formats.audio/id3tag/version) { get; } | 以字符串格式获取 ID3 标签的版本。例如：'ID3v1.1'. |
