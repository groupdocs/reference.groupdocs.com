...
description: 表示一个文本框ID3V2Tag./id3v2tag. 几乎所有以 T 字符开头的帧都属于这一类只有一个例外就是由ID3V2UserDefinedFrame./id3v2userdefinedframe类.
type: docs
weight: 520
...
表示一个文本框[`ID3V2Tag`](../id3v2tag). 几乎所有以 T 字符开头的帧都属于这一类。只有一个例外，就是由[`ID3V2UserDefinedFrame`](../id3v2userdefinedframe)类.
...
| 姓名 | 描述 |
| --- | --- |
| [ID3V2TextFrame](id3v2textframe)(string, ID3V2EncodingType, string) | 初始化[`ID3V2TextFrame`](../id3v2textframe)类. |
