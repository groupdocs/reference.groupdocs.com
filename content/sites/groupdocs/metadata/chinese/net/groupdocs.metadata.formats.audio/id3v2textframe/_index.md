...
description: 表示一个文本框ID3V2Tag./id3v2tag. 几乎所有以 T 字符开头的帧都属于此类只有一个例外就是由ID3V2UserDefinedFrame./id3v2userdefinedframe类.
type: docs
weight: 520
url: /zh/net/groupdocs.metadata.formats.audio/id3v2textframe/
---
## ID3V2TextFrame class

表示一个文本框[`ID3V2Tag`](../id3v2tag). 几乎所有以 T 字符开头的帧都属于此类。只有一个例外，就是由[`ID3V2UserDefinedFrame`](../id3v2userdefinedframe)类.
...
| 姓名 | 描述 |
| --- | --- |
| [ID3V2TextFrame](id3v2textframe)(string, ID3V2EncodingType, string) | 初始化一个新的实例[`ID3V2TextFrame`](../id3v2textframe)类. |
...
| [Text](../../groupdocs.metadata.formats.audio/id3v2textframe/text) { get; } | 获取文本值。 |
| [TextEncoding](../../groupdocs.metadata.formats.audio/id3v2textframe/textencoding) { get; } | 获取文本编码。 |
