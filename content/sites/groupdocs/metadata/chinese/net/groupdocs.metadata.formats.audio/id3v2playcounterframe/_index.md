...
description: 表示一个 PCNT 帧ID3V2Tag./id3v2tag. 这只是一个文件播放次数的计数器
type: docs
weight: 470
url: /zh/net/groupdocs.metadata.formats.audio/id3v2playcounterframe/
---
## ID3V2PlayCounterFrame class

表示一个 PCNT 帧[`ID3V2Tag`](../id3v2tag). 这只是一个文件播放次数的计数器。
...
| [Value](../../groupdocs.metadata.formats.audio/id3v2playcounterframe/value) { get; } | 获取文件已播放的次数。 |
