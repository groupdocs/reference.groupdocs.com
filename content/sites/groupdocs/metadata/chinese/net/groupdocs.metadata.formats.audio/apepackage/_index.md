...
| [Album](../../groupdocs.metadata.formats.audio/apepackage/album) { get; } | 获取专辑。 |
...
| [Comment](../../groupdocs.metadata.formats.audio/apepackage/comment) { get; } | 获取注释。 |
| [Composer](../../groupdocs.metadata.formats.audio/apepackage/composer) { get; } | 获取作曲家。 |
| [Conductor](../../groupdocs.metadata.formats.audio/apepackage/conductor) { get; } | 获取指挥。 |
...
| [DebutAlbum](../../groupdocs.metadata.formats.audio/apepackage/debutalbum) { get; } | 获取首张专辑。 |
| [File](../../groupdocs.metadata.formats.audio/apepackage/file) { get; } | 获取文件。 |
| [Genre](../../groupdocs.metadata.formats.audio/apepackage/genre) { get; } | 获取类型。 |
...
| [Isrc](../../groupdocs.metadata.formats.audio/apepackage/isrc) { get; } | 获取国际标准记录号。 |
...
| [PublicationRight](../../groupdocs.metadata.formats.audio/apepackage/publicationright) { get; } | 获得发表权。 |
...
| [Track](../../groupdocs.metadata.formats.audio/apepackage/track) { get; } | 获取轨道号。 |
