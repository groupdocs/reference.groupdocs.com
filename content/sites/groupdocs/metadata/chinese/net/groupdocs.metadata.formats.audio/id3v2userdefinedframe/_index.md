...
description: 表示一个 TXXX 帧ID3V2Tag./id3v2tag.
type: docs
weight: 540
...
| 姓名 | 描述 |
| --- | --- |
| [ID3V2UserDefinedFrame](id3v2userdefinedframe#constructor_1)(string, string) | 初始化[`ID3V2UserDefinedFrame`](../id3v2userdefinedframe)类. |
| [ID3V2UserDefinedFrame](id3v2userdefinedframe#constructor)(ID3V2EncodingType, string, string) | 初始化[`ID3V2UserDefinedFrame`](../id3v2userdefinedframe)类. |
