...
description: 表示一个TXXX帧ID3V2Tag./id3v2tag.
type: docs
weight: 540
url: /zh/net/groupdocs.metadata.formats.audio/id3v2userdefinedframe/
---
## ID3V2UserDefinedFrame class

表示一个TXXX帧[`ID3V2Tag`](../id3v2tag).
...
| 姓名 | 描述 |
| --- | --- |
| [ID3V2UserDefinedFrame](id3v2userdefinedframe#constructor_1)(string, string) | 初始化一个新的实例[`ID3V2UserDefinedFrame`](../id3v2userdefinedframe)类. |
| [ID3V2UserDefinedFrame](id3v2userdefinedframe#constructor)(ID3V2EncodingType, string, string) | 初始化一个新的实例[`ID3V2UserDefinedFrame`](../id3v2userdefinedframe)类. |
...
| [Description](../../groupdocs.metadata.formats.audio/id3v2userdefinedframe/description) { get; } | 获取描述。 |
| [Encoding](../../groupdocs.metadata.formats.audio/id3v2userdefinedframe/encoding) { get; } | 获取帧的编码。 |
...
| [Value](../../groupdocs.metadata.formats.audio/id3v2userdefinedframe/value) { get; } | 获取值。 |
