...
description: 表示允许在 WAV 音频中使用元数据的根包
type: docs
weight: 600
...
| [RiffInfoPackage](../../groupdocs.metadata.formats.audio/wavrootpackage/riffinfopackage) { get; } | 获取包含 RIFF 信息标签的包。 |
