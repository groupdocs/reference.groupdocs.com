...
description: 表示允许使用 WAV 音频中的元数据的根包
type: docs
weight: 600
url: /zh/net/groupdocs.metadata.formats.audio/wavrootpackage/
---
## WavRootPackage class

表示允许使用 WAV 音频中的元数据的根包。
...
| [RiffInfoPackage](../../groupdocs.metadata.formats.audio/wavrootpackage/riffinfopackage) { get; } | 获取包含 RIFF Info 标记的包。 |
| [WavPackage](../../groupdocs.metadata.formats.audio/wavrootpackage/wavpackage) { get; } | 获取 WAV 原生元数据包。 |
| [XmpPackage](../../groupdocs.metadata.formats.audio/wavrootpackage/xmppackage) { get; set; } | 获取或设置 XMP 元数据包。 |
