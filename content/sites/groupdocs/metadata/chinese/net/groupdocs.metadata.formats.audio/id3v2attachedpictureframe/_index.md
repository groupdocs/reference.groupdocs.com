...
description: 表示一个 APIC 帧ID3V2Tag./id3v2tag.
type: docs
weight: 420
...
| 姓名 | 描述 |
| --- | --- |
| [ID3V2AttachedPictureFrame](id3v2attachedpictureframe#constructor)(byte[]) | 初始化[`ID3V2AttachedPictureFrame`](../id3v2attachedpictureframe)类. |
| [ID3V2AttachedPictureFrame](id3v2attachedpictureframe#constructor_1)(ID3V2AttachedPictureType, string, byte[]) | 初始化[`ID3V2AttachedPictureFrame`](../id3v2attachedpictureframe)类. |
| [ID3V2AttachedPictureFrame](id3v2attachedpictureframe#constructor_2)(ID3V2EncodingType, string, ID3V2AttachedPictureType, string, byte[]) | 初始化[`ID3V2AttachedPictureFrame`](../id3v2attachedpictureframe)类. |
