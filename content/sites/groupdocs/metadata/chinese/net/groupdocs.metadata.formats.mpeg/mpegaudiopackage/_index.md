...
| 姓名 | 描述 |
| --- | --- |
| [MpegAudioPackage](mpegaudiopackage)() | 初始化[`MpegAudioPackage`](../mpegaudiopackage)类. |
...
| [Emphasis](../../groupdocs.metadata.formats.mpeg/mpegaudiopackage/emphasis) { get; } | 获得重点。 |
| [Frequency](../../groupdocs.metadata.formats.mpeg/mpegaudiopackage/frequency) { get; } | 获取频率。 |
| [HeaderPosition](../../groupdocs.metadata.formats.mpeg/mpegaudiopackage/headerposition) { get; } | 获取头偏移量。 |
...
| [MpegAudioVersion](../../groupdocs.metadata.formats.mpeg/mpegaudiopackage/mpegaudioversion) { get; } | 获取 MPEG 音频版本。可以是MPEG-1、MPEG-2等 |
