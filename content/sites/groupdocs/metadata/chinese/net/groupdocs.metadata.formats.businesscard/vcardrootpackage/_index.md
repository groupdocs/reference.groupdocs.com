...
description: 表示允许使用 VCard 文件中的元数据的根包
type: docs
weight: 790
url: /zh/net/groupdocs.metadata.formats.businesscard/vcardrootpackage/
---
...
| [VCardPackage](../../groupdocs.metadata.formats.businesscard/vcardrootpackage/vcardpackage) { get; } | 获取 VCard 元数据包。 |
