...
description: 表示 vCard 日期时间记录元数据类
type: docs
weight: 690
url: /zh/net/groupdocs.metadata.formats.businesscard/vcarddatetimerecord/
---
...
| override [ContentType](../../groupdocs.metadata.formats.businesscard/vcarddatetimerecord/contenttype) { get; } | 获取记录的内容类型。 |
...
| [Value](../../groupdocs.metadata.formats.businesscard/vcarddatetimerecord/value) { get; } | 获取记录值。 |
