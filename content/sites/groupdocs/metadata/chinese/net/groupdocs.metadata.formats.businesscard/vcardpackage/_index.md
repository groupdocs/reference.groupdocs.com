...
description: 代表VCFVirtual Contact File电子名片格式元数据
type: docs
weight: 760
url: /zh/net/groupdocs.metadata.formats.businesscard/vcardpackage/
---
## VCardPackage class

代表VCF（Virtual Contact File）电子名片格式元数据。
...
| 姓名 | 描述 |
| --- | --- |
| [Cards](../../groupdocs.metadata.formats.businesscard/vcardpackage/cards) { get; } | 获取从文件中提取的卡片数组。 |
