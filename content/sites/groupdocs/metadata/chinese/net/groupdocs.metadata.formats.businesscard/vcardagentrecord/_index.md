...
description: 表示 vCard Agent 记录元数据类
type: docs
weight: 610
url: /zh/net/groupdocs.metadata.formats.businesscard/vcardagentrecord/
---
## VCardAgentRecord class

表示 vCard Agent 记录元数据类。
...
| override [ContentType](../../groupdocs.metadata.formats.businesscard/vcardagentrecord/contenttype) { get; } | 获取记录的内容类型。 |
...
| [Value](../../groupdocs.metadata.formats.businesscard/vcardagentrecord/value) { get; } | 获取记录值。 |
