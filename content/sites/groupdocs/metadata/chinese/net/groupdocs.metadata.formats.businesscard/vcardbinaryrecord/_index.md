...
description: 表示 vCard 二进制记录元数据类
type: docs
weight: 630
url: /zh/net/groupdocs.metadata.formats.businesscard/vcardbinaryrecord/
---
...
| override [ContentType](../../groupdocs.metadata.formats.businesscard/vcardbinaryrecord/contenttype) { get; } | 获取记录的内容类型。 |
...
| [Value](../../groupdocs.metadata.formats.businesscard/vcardbinaryrecord/value) { get; } | 获取记录值。 |
