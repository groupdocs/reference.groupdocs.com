...
description: 表示一组组织 vCard 记录 这些属性与关联的信息有关 vCard 代表的对象的组织或组织单元的特征
type: docs
weight: 750
...
表示一组组织 vCard 记录。 这些属性与关联的信息有关 vCard 代表的对象的组织或组织单元的特征。
...
| 姓名 | 描述 |
| --- | --- |
| [AgentObjectRecord](../../groupdocs.metadata.formats.businesscard/vcardorganizationalrecordset/agentobjectrecord) { get; } | 获取代表 vCard 对象的另一个人的信息。 |
| [AgentRecords](../../groupdocs.metadata.formats.businesscard/vcardorganizationalrecordset/agentrecords) { get; } | 获取代表 vCard 对象的另一个人的信息。 |
| [AgentUriRecords](../../groupdocs.metadata.formats.businesscard/vcardorganizationalrecordset/agenturirecords) { get; } | 获取代表 vCard 对象的另一个人的信息。 |
...
| [MemberRecords](../../groupdocs.metadata.formats.businesscard/vcardorganizationalrecordset/memberrecords) { get; } | 获取此 vCard 代表的组中的成员。 |
| [Members](../../groupdocs.metadata.formats.businesscard/vcardorganizationalrecordset/members) { get; } | 获取此 vCard 代表的组中的成员。 |
| [MetadataType](../../groupdocs.metadata.common/metadatapackage/metadatatype) { get; } | 获取元数据类型。 |
| [ObjectAgent](../../groupdocs.metadata.formats.businesscard/vcardorganizationalrecordset/objectagent) { get; } | 获取代表 vCard 对象的另一个人的信息。 |
...
| [RelationshipRecords](../../groupdocs.metadata.formats.businesscard/vcardorganizationalrecordset/relationshiprecords) { get; } | 获取另一个实体与此 vCard 代表的实体之间的关系。 |
| [Relationships](../../groupdocs.metadata.formats.businesscard/vcardorganizationalrecordset/relationships) { get; } | 获取另一个实体与此 vCard 代表的实体之间的关系。 |
| [RoleRecords](../../groupdocs.metadata.formats.businesscard/vcardorganizationalrecordset/rolerecords) { get; } | 获取对象在特定情况下所起的作用或部分。 |
| [Roles](../../groupdocs.metadata.formats.businesscard/vcardorganizationalrecordset/roles) { get; } | 获取对象在特定情况下所起的作用或部分。 |
| [TitleRecords](../../groupdocs.metadata.formats.businesscard/vcardorganizationalrecordset/titlerecords) { get; } | 获取对象的位置或工作。 |
| [Titles](../../groupdocs.metadata.formats.businesscard/vcardorganizationalrecordset/titles) { get; } | 获取对象的位置或工作。 |
| [UriAgents](../../groupdocs.metadata.formats.businesscard/vcardorganizationalrecordset/uriagents) { get; } | 获取代表 vCard 对象的另一个人的信息。 |
