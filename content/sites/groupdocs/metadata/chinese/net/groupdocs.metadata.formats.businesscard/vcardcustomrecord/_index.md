...
description: 表示 vCard 自定义记录元数据类
type: docs
weight: 680
url: /zh/net/groupdocs.metadata.formats.businesscard/vcardcustomrecord/
---
...
| override [ContentType](../../groupdocs.metadata.formats.businesscard/vcardcustomrecord/contenttype) { get; } | 获取记录的内容类型。 |
...
| [Value](../../groupdocs.metadata.formats.businesscard/vcardcustomrecord/value) { get; } | 获取记录值。 |
