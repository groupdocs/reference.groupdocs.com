...
description: 表示一组解释性 vCard 记录 这些属性与附加说明有关 例如与特定于 vCard 的信息说明或修订相关的说明
type: docs
weight: 710
...
表示一组解释性 vCard 记录。 这些属性与附加说明有关， 例如与特定于 vCard 的信息说明或修订相关的说明。
...
| [Categories](../../groupdocs.metadata.formats.businesscard/vcardexplanatoryrecordset/categories) { get; } | 获取vCard的应用类别信息，也称为“标签”。 |
| [CategoryRecords](../../groupdocs.metadata.formats.businesscard/vcardexplanatoryrecordset/categoryrecords) { get; } | 获取vCard的应用类别信息，也称为“标签”。 |
...
| [PidIdentifierRecords](../../groupdocs.metadata.formats.businesscard/vcardexplanatoryrecordset/pididentifierrecords) { get; } | 获取本地 PID 源标识符的全局含义。 |
| [PidIdentifiers](../../groupdocs.metadata.formats.businesscard/vcardexplanatoryrecordset/pididentifiers) { get; } | 获取本地 PID 源标识符的全局含义。 |
...
| [Revision](../../groupdocs.metadata.formats.businesscard/vcardexplanatoryrecordset/revision) { get; } | 获取当前vCard的修订信息。 |
| [SortString](../../groupdocs.metadata.formats.businesscard/vcardexplanatoryrecordset/sortstring) { get; } | 获取用于国家语言特定排序的姓氏或名字文本[`FormattedNames`](../vcardidentificationrecordset/formattednames)和[`Name`](../vcardidentificationrecordset/name)类型. |
...
| [UrlRecords](../../groupdocs.metadata.formats.businesscard/vcardexplanatoryrecordset/urlrecords) { get; } | 获取指向以某种方式代表人物的网站的 URL 数组。 |
| [Urls](../../groupdocs.metadata.formats.businesscard/vcardexplanatoryrecordset/urls) { get; } | 获取指向以某种方式代表人物的网站的 URL 数组。 |
