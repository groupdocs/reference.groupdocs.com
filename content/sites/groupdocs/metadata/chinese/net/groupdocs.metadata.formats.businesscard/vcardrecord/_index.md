...
description: 表示抽象的 vCard 记录元数据类
type: docs
weight: 770
url: /zh/net/groupdocs.metadata.formats.businesscard/vcardrecord/
---
## VCardRecord class
...
| abstract [ContentType](../../groupdocs.metadata.formats.businesscard/vcardrecord/contenttype) { get; } | 获取记录的内容类型。 |
