...
description: 表示一组 Calendar vCard 记录
type: docs
weight: 640
url: /zh/net/groupdocs.metadata.formats.businesscard/vcardcalendarrecordset/
---
## VCardCalendarRecordset class

表示一组 Calendar vCard 记录。
...
| 姓名 | 描述 |
| --- | --- |
| [BusyTimeEntries](../../groupdocs.metadata.formats.businesscard/vcardcalendarrecordset/busytimeentries) { get; } | 获取与对象关联的忙碌时间的 URI。 |
| [BusyTimeRecords](../../groupdocs.metadata.formats.businesscard/vcardcalendarrecordset/busytimerecords) { get; } | 获取与对象关联的忙碌时间的 URI。 |
| [CalendarAddresses](../../groupdocs.metadata.formats.businesscard/vcardcalendarrecordset/calendaraddresses) { get; } | 获取日历用户地址，为 vCard 表示的对象发送计划请求。 |
| [CalendarAddressRecords](../../groupdocs.metadata.formats.businesscard/vcardcalendarrecordset/calendaraddressrecords) { get; } | 获取日历用户地址，为 vCard 表示的对象发送计划请求。 |
| [CalendarUriRecords](../../groupdocs.metadata.formats.businesscard/vcardcalendarrecordset/calendarurirecords) { get; } | 获取与 vCard 表示的对象关联的日历的 URI。 |
...
| [UriCalendarEntries](../../groupdocs.metadata.formats.businesscard/vcardcalendarrecordset/uricalendarentries) { get; } | 获取与 vCard 表示的对象关联的日历的 URI。 |
