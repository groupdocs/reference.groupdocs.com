...
| 姓名 | 描述 |
| --- | --- |
| [BusyTimeEntries](../../groupdocs.metadata.formats.businesscard/vcardcalendarrecordset/busytimeentries) { get; } | 获取与对象关联的繁忙时间的 URI。 |
| [BusyTimeRecords](../../groupdocs.metadata.formats.businesscard/vcardcalendarrecordset/busytimerecords) { get; } | 获取与对象关联的繁忙时间的 URI。 |
| [CalendarAddresses](../../groupdocs.metadata.formats.businesscard/vcardcalendarrecordset/calendaraddresses) { get; } | 获取应为 vCard 表示的对象发送调度请求的日历用户地址。 |
| [CalendarAddressRecords](../../groupdocs.metadata.formats.businesscard/vcardcalendarrecordset/calendaraddressrecords) { get; } | 获取应为 vCard 表示的对象发送调度请求的日历用户地址。 |
