...
description: 表示用于签署文档的数字签名
type: docs
weight: 3030
url: /zh/net/groupdocs.metadata.standards.signing/digitalsignature/
---
...
| virtual [SignTime](../../groupdocs.metadata.standards.signing/digitalsignature/signtime) { get; } | 获取文档签署的时间。 |
...
* 命名空间 [GroupDocs.Metadata.Standards.Signing](../../groupdocs.metadata.standards.signing)
