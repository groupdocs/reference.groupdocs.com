...
description: 表示名称记录表的值Macintosh平台.
type: docs
weight: 1510
url: /zh/net/groupdocs.metadata.formats.font/opentypemacintoshnamerecord/
---
## OpenTypeMacintoshNameRecord class

表示名称记录表的值Macintosh平台.
...
| [Encoding](../../groupdocs.metadata.formats.font/opentypemacintoshnamerecord/encoding) { get; } | 获取编码标识符。 |
...
| [Language](../../groupdocs.metadata.formats.font/opentypemacintoshnamerecord/language) { get; } | 获取语言标识符。 |
