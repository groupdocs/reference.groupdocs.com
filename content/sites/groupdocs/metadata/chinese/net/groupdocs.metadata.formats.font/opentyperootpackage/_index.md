...
description: 表示允许使用 OpenType 字体文件中的元数据的根包
type: docs
weight: 1550
url: /zh/net/groupdocs.metadata.formats.font/opentyperootpackage/
---
## OpenTypeRootPackage class

表示允许使用 OpenType 字体文件中的元数据的根包。
...
| [DigitalSignaturePackage](../../groupdocs.metadata.formats.font/opentyperootpackage/digitalsignaturepackage) { get; } | 获取数字签名元数据包。 |
...
| [OpenTypePackage](../../groupdocs.metadata.formats.font/opentyperootpackage/opentypepackage) { get; } | 获取 OpenType 元数据包。 |
