...
description: 代表一个Byte标签
type: docs
weight: 1960
url: /zh/net/groupdocs.metadata.formats.image/tiffbytetag/
---
## TiffByteTag class
...
| 姓名 | 描述 |
| --- | --- |
| [TiffByteTag](tiffbytetag)(TiffTagID, byte[]) | 初始化一个新的实例[`TiffByteTag`](../tiffbytetag)类. |
