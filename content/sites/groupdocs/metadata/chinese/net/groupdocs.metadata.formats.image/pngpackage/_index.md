...
description: 表示本机 PNG 元数据
type: docs
weight: 1850
url: /zh/net/groupdocs.metadata.formats.image/pngpackage/
---
## PngPackage class
...
| [TextChunks](../../groupdocs.metadata.formats.image/pngpackage/textchunks) { get; } | 获取从图像中提取的文本块的集合。 |
