...
description: 表示从 PNG 图像中提取的国际文本数据
type: docs
weight: 1840
url: /zh/net/groupdocs.metadata.formats.image/pnginternationaltextchunk/
---
## PngInternationalTextChunk class

表示从 PNG 图像中提取的国际文本数据。
...
| [IsCompressed](../../groupdocs.metadata.formats.image/pnginternationaltextchunk/iscompressed) { get; } | 获取一个值，该值指示该块是否被压缩。 |
...
| [Language](../../groupdocs.metadata.formats.image/pnginternationaltextchunk/language) { get; } | 获取翻译的关键字和文本使用的人类语言。 |
...
| [TranslatedKeyword](../../groupdocs.metadata.formats.image/pnginternationaltextchunk/translatedkeyword) { get; } | 获取已翻译的关键字，其中包含将关键字翻译成语言属性指示的语言。 |
