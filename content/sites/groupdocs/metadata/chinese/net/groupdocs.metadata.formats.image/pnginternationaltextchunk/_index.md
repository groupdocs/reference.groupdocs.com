...
| [IsCompressed](../../groupdocs.metadata.formats.image/pnginternationaltextchunk/iscompressed) { get; } | 获取指示块是否被压缩的值。 |
...
| [Keyword](../../groupdocs.metadata.formats.image/pngtextchunk/keyword) { get; } | 获取表示chunk所代表的信息类型的关键字。 |
| [Language](../../groupdocs.metadata.formats.image/pnginternationaltextchunk/language) { get; } | 获取翻译后的关键字和文本使用的人类语言。 |
...
| [Text](../../groupdocs.metadata.formats.image/pngtextchunk/text) { get; } | 获取由块表示的实际文本字符串。 |
