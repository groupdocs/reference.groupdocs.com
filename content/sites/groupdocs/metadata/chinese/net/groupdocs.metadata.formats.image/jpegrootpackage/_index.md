...
description: 表示允许使用 JPEG 图像中的元数据的根包
type: docs
weight: 1810
url: /zh/net/groupdocs.metadata.formats.image/jpegrootpackage/
---
## JpegRootPackage class

表示允许使用 JPEG 图像中的元数据的根包。
...
| [ExifPackage](../../groupdocs.metadata.formats.image/jpegrootpackage/exifpackage) { get; set; } | 获取或设置 EXIF 元数据包。 |
| [FileType](../../groupdocs.metadata.formats.image/imagerootpackage/filetype) { get; } | 获取文件类型元数据包。 (2 properties) |
| [ImageResourcePackage](../../groupdocs.metadata.formats.image/jpegrootpackage/imageresourcepackage) { get; } | 获取 Photoshop 图像资源元数据包。 图像资源块是 Photoshop 本机文件格式的基本构建单元。 |
| [IptcPackage](../../groupdocs.metadata.formats.image/jpegrootpackage/iptcpackage) { get; set; } | 获取或设置 IPTC 元数据包。 |
...
| [MakerNotePackage](../../groupdocs.metadata.formats.image/jpegrootpackage/makernotepackage) { get; } | 获取或设置 MakerNote 元数据包。 |
...
| [XmpPackage](../../groupdocs.metadata.formats.image/jpegrootpackage/xmppackage) { get; set; } | 获取或设置 XMP 元数据包。 |
...
| [DetectBarcodeTypes](../../groupdocs.metadata.formats.image/jpegrootpackage/detectbarcodetypes)() | 提取图像中显示的条形码类型。 |
...
| [RemoveImageResourcePackage](../../groupdocs.metadata.formats.image/jpegrootpackage/removeimageresourcepackage)() | 删除 Photoshop 图像资源元数据包。 |
...
| override [Sanitize](../../groupdocs.metadata.formats.image/jpegrootpackage/sanitize)() | 从包中删除可写元数据属性。 该操作是递归的，因此它也会影响所有嵌套包。 |
