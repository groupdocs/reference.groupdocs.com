...
description: 表示用于处理 JPEG2000 图像中的元数据的根包
type: docs
weight: 1800
url: /zh/net/groupdocs.metadata.formats.image/jpeg2000rootpackage/
---
## Jpeg2000RootPackage class

表示用于处理 JPEG2000 图像中的元数据的根包。
...
| [ExifPackage](../../groupdocs.metadata.formats.image/jpeg2000rootpackage/exifpackage) { get; set; } | 获取或设置 EXIF 元数据包。 |
...
| [Jpeg2000Package](../../groupdocs.metadata.formats.image/jpeg2000rootpackage/jpeg2000package) { get; } | 获取 JPEG2000 本机元数据包。 |
...
| [XmpPackage](../../groupdocs.metadata.formats.image/jpeg2000rootpackage/xmppackage) { get; set; } | 获取或设置 XMP 元数据包。 |
