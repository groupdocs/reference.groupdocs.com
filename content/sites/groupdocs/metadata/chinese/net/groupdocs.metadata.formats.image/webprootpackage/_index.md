...
description: 表示允许在 WEBP 图像中使用元数据的根包
type: docs
weight: 2130
url: /zh/net/groupdocs.metadata.formats.image/webprootpackage/
---
## WebPRootPackage class

表示允许在 WEBP 图像中使用元数据的根包。
...
| [ExifPackage](../../groupdocs.metadata.formats.image/webprootpackage/exifpackage) { get; set; } | 获取或设置 EXIF 元数据包。 |
...
| [XmpPackage](../../groupdocs.metadata.formats.image/webprootpackage/xmppackage) { get; set; } | 获取或设置 XMP 元数据包。 |
