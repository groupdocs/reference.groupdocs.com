...
description: 表示包含 GIF 特定文件格式信息的元数据包
type: docs
weight: 1710
url: /zh/net/groupdocs.metadata.formats.image/gifimagetypepackage/
---
## GifImageTypePackage class

表示包含 GIF 特定文件格式信息的元数据包。
...
| [Version](../../groupdocs.metadata.formats.image/gifimagetypepackage/version) { get; } | 获取格式的版本。 |
