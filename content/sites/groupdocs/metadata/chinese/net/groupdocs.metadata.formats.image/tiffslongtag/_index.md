...
description: 表示 TIFF SLong 标记
type: docs
weight: 2040
url: /zh/net/groupdocs.metadata.formats.image/tiffslongtag/
---
## TiffSLongTag class
...
| 姓名 | 描述 |
| --- | --- |
| [TiffSLongTag](tiffslongtag)(TiffTagID, int[]) | 初始化一个新的实例[`TiffSLongTag`](../tiffslongtag)类. |
