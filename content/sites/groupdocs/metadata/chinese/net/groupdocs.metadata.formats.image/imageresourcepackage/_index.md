...
description: 表示包含 Photoshop 图像资源的元数据包
type: docs
weight: 1760
url: /zh/net/groupdocs.metadata.formats.image/imageresourcepackage/
---
## ImageResourcePackage class

表示包含 Photoshop 图像资源的元数据包。
...
| [ToList](../../groupdocs.metadata.formats.image/imageresourcepackage/tolist)() | 从包中创建一个列表。 |
