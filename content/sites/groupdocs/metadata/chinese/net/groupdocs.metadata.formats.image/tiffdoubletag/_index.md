...
description: 表示一个 TIFF Double 标签
type: docs
weight: 1970
url: /zh/net/groupdocs.metadata.formats.image/tiffdoubletag/
---
## TiffDoubleTag class
...
| 姓名 | 描述 |
| --- | --- |
| [TiffDoubleTag](tiffdoubletag)(TiffTagID, double[]) | 初始化一个新的实例[`TiffDoubleTag`](../tiffdoubletag)类. |
