...
description: 表示本机 Photoshop 元数据
type: docs
weight: 1920
url: /zh/net/groupdocs.metadata.formats.image/psdpackage/
---
## PsdPackage class
...
| 姓名 | 描述 |
| --- | --- |
| [ChannelCount](../../groupdocs.metadata.formats.image/psdpackage/channelcount) { get; } | 获取通道数。 |
| [ColorMode](../../groupdocs.metadata.formats.image/psdpackage/colormode) { get; } | 获取psd颜色模式。 |
| [Compression](../../groupdocs.metadata.formats.image/psdpackage/compression) { get; } | 获取用于图像数据的压缩方法。 |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | 获取元数据属性的数量。 |
| [Height](../../groupdocs.metadata.formats.image/psdpackage/height) { get; } | 获取图像的高度。 |
...
| [Layers](../../groupdocs.metadata.formats.image/psdpackage/layers) { get; } | 获取 Photoshop 图层。 |
| [MetadataType](../../groupdocs.metadata.common/metadatapackage/metadatatype) { get; } | 获取元数据类型。 |
| [PhotoshopVersion](../../groupdocs.metadata.formats.image/psdpackage/photoshopversion) { get; } | 获取 Photoshop 版本。 |
...
| [Width](../../groupdocs.metadata.formats.image/psdpackage/width) { get; } | 获取图像的 PSD 宽度。 |
