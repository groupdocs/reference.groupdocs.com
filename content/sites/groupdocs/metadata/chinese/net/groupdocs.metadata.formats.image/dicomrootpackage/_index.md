...
description: 表示用于处理 DICOM 图像中的元数据的根包
type: docs
weight: 1680
url: /zh/net/groupdocs.metadata.formats.image/dicomrootpackage/
---
## DicomRootPackage class

表示用于处理 DICOM 图像中的元数据的根包。
...
| [DicomPackage](../../groupdocs.metadata.formats.image/dicomrootpackage/dicompackage) { get; } | 获取 DICOM 原生元数据包。 |
