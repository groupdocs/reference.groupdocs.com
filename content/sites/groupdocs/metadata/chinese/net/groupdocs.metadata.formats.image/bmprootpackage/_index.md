...
description: 表示用于处理 BMP 图像中的元数据的根包
type: docs
weight: 1660
url: /zh/net/groupdocs.metadata.formats.image/bmprootpackage/
---
## BmpRootPackage class

表示用于处理 BMP 图像中的元数据的根包。
...
| 姓名 | 描述 |
| --- | --- |
| [BmpHeader](../../groupdocs.metadata.formats.image/bmprootpackage/bmpheader) { get; } | 获取 BMP 头元数据包。 |
