...
description: 表示用于处理 HEIF 图像中的元数据的根包
type: docs
weight: 1730
url: /zh/net/groupdocs.metadata.formats.image/heifrootpackage/
---
## HeifRootPackage class

表示用于处理 HEIF 图像中的元数据的根包。
...
| [ExifPackage](../../groupdocs.metadata.formats.image/heifrootpackage/exifpackage) { get; set; } | 获取或设置 EXIF 元数据包。 |
...
| [XmpPackage](../../groupdocs.metadata.formats.image/heifrootpackage/xmppackage) { get; set; } | 获取或设置 XMP 元数据包。 |
