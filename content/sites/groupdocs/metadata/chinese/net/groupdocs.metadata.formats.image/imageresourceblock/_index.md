...
description: 表示 Photoshop 图像资源块  图像资源块是多种文件格式的基本构建单元包括 Photoshop 的本机文件格式JPEG 和 TIFF 图像资源用于存储与图像相关的非像素数据例如钢笔工具路径
type: docs
weight: 1740
url: /zh/net/groupdocs.metadata.formats.image/imageresourceblock/
---
## ImageResourceBlock class

表示 Photoshop 图像资源块。  图像资源块是多种文件格式的基本构建单元，包括 Photoshop 的本机文件格式、JPEG 和 TIFF。 图像资源用于存储与图像相关的非像素数据，例如钢笔工具路径。
...
| [Data](../../groupdocs.metadata.formats.image/imageresourceblock/data) { get; } | 获取资源数据。 |
| [ID](../../groupdocs.metadata.formats.image/imageresourceblock/id) { get; } | 获取资源的唯一标识符。 |
...
| [Name](../../groupdocs.metadata.formats.image/imageresourceblock/name) { get; } | 获取图像资源块名称。 |
...
| [Signature](../../groupdocs.metadata.formats.image/imageresourceblock/signature) { get; } | 获取图片资源块签名。 |
