...
description: 表示允许在 ASF 视频中使用元数据的根包
type: docs
weight: 2350
url: /zh/net/groupdocs.metadata.formats.video/asfrootpackage/
---
## AsfRootPackage class

表示允许在 ASF 视频中使用元数据的根包。
...
| 姓名 | 描述 |
| --- | --- |
| [AsfPackage](../../groupdocs.metadata.formats.video/asfrootpackage/asfpackage) { get; } | 获取 ASF 元数据包。 |
...
| [XmpPackage](../../groupdocs.metadata.formats.video/asfrootpackage/xmppackage) { get; set; } | 获取或设置 XMP 元数据包。 |
