...
description: 表示允许在 FLV 视频中使用元数据的根包
type: docs
weight: 2420
url: /zh/net/groupdocs.metadata.formats.video/flvrootpackage/
---
## FlvRootPackage class

表示允许在 FLV 视频中使用元数据的根包。
...
| [Header](../../groupdocs.metadata.formats.video/flvrootpackage/header) { get; } | 获取FLV头包 |
...
| [XmpPackage](../../groupdocs.metadata.formats.video/flvrootpackage/xmppackage) { get; set; } | 获取或设置 XMP 元数据包。 |
