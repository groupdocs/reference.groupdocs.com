...
description: 表示允许在 Matroska 视频中使用元数据的根包
type: docs
weight: 2480
url: /zh/net/groupdocs.metadata.formats.video/matroskarootpackage/
---
## MatroskaRootPackage class

表示允许在 Matroska 视频中使用元数据的根包。
...
| [MatroskaPackage](../../groupdocs.metadata.formats.video/matroskarootpackage/matroskapackage) { get; } | 获取 Matroska 元数据包。 |
