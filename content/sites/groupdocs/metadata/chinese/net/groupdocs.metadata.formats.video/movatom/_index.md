...
| [DataSize](../../groupdocs.metadata.formats.video/movatom/datasize) { get; } | 获取以字节为单位的数据大小。 |
| [HasExtendedSize](../../groupdocs.metadata.formats.video/movatom/hasextendedsize) { get; } | 获取一个值，指示扩展大小字段是否用于存储原子数据。 |
...
| [LongSize](../../groupdocs.metadata.formats.video/movatom/longsize) { get; } | 获取以字节为单位的原子大小。 |
...
| [Size](../../groupdocs.metadata.formats.video/movatom/size) { get; } | 获取以字节为单位的原子大小。 |
