...
| [DocTypeReadVersion](../../groupdocs.metadata.formats.video/matroskaebmlheader/doctypereadversion) { get; } | 获取最小版本号a[`DocType`](./doctype)解析器必须符合才能读取文件。 |
| [DocTypeVersion](../../groupdocs.metadata.formats.video/matroskaebmlheader/doctypeversion) { get; } | 获取的版本[`DocType`](./doctype)writer 用于创建文件. |
