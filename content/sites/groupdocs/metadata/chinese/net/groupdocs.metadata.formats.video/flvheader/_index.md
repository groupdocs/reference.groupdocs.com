...
| [HasAudioTags](../../groupdocs.metadata.formats.video/flvheader/hasaudiotags) { get; } | 获取一个值，指示文件中是否存在音频标签。 |
| [HasVideoTags](../../groupdocs.metadata.formats.video/flvheader/hasvideotags) { get; } | 获取一个值，指示文件中是否存在视频标签。 |
