...
description: 表示 FLV 视频头
type: docs
weight: 2410
url: /zh/net/groupdocs.metadata.formats.video/flvheader/
---
## FlvHeader class
...
| [HasAudioTags](../../groupdocs.metadata.formats.video/flvheader/hasaudiotags) { get; } | 获取一个值，该值指示文件中是否存在音频标签。 |
| [HasVideoTags](../../groupdocs.metadata.formats.video/flvheader/hasvideotags) { get; } | 获取一个值，该值指示文件中是否存在视频标签。 |
...
| [TypeFlags](../../groupdocs.metadata.formats.video/flvheader/typeflags) { get; } | 获取 FLV 类型标志。 |
| [Version](../../groupdocs.metadata.formats.video/flvheader/version) { get; } | 获取文件版本。 |
