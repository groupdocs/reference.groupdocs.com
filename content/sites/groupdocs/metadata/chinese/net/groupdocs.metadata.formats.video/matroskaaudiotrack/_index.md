...
description: 表示 Matroska 视频中的音频元数据
type: docs
weight: 2430
url: /zh/net/groupdocs.metadata.formats.video/matroskaaudiotrack/
---
...
| 姓名 | 描述 |
| --- | --- |
| [BitDepth](../../groupdocs.metadata.formats.video/matroskaaudiotrack/bitdepth) { get; } | 获取每个样本的位数，主要用于 PCM。 |
| [Channels](../../groupdocs.metadata.formats.video/matroskaaudiotrack/channels) { get; } | 获取轨道中的通道数。 |
...
| [OutputSamplingFrequency](../../groupdocs.metadata.formats.video/matroskaaudiotrack/outputsamplingfrequency) { get; } | 获取以 Hz 为单位的实际输出采样频率（用于 SBR 技术）。 |
...
| [SamplingFrequency](../../groupdocs.metadata.formats.video/matroskaaudiotrack/samplingfrequency) { get; } | 以 Hz 为单位获取采样频率。 |
