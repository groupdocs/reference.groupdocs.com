...
description: 表示 ASF 编解码器元数据
type: docs
weight: 2260
url: /zh/net/groupdocs.metadata.formats.video/asfcodec/
---
## AsfCodec class
...
| 姓名 | 描述 |
| --- | --- |
| [CodecType](../../groupdocs.metadata.formats.video/asfcodec/codectype) { get; } | 获取编解码器的类型。 |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | 获取元数据属性的数量。 |
| [Description](../../groupdocs.metadata.formats.video/asfcodec/description) { get; } | 获取描述。 |
| [Information](../../groupdocs.metadata.formats.video/asfcodec/information) { get; } | 获取信息字符串。 |
...
| [Name](../../groupdocs.metadata.formats.video/asfcodec/name) { get; } | 获取属性名称。 |
