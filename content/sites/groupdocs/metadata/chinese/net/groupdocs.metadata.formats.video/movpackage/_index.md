...
description: 表示 QuickTime 元数据
type: docs
weight: 2630
url: /zh/net/groupdocs.metadata.formats.video/movpackage/
---
## MovPackage class
...
| 姓名 | 描述 |
| --- | --- |
| [Atoms](../../groupdocs.metadata.formats.video/movpackage/atoms) { get; } | 获取一个数组[`MovAtom`](../movatom)原子. |
