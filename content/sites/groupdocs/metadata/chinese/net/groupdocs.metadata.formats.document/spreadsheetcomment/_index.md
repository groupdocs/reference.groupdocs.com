...
description: 表示电子表格中的用户评论
type: docs
weight: 1150
url: /zh/net/groupdocs.metadata.formats.document/spreadsheetcomment/
---
...
| 姓名 | 描述 |
| --- | --- |
| [Author](../../groupdocs.metadata.formats.document/spreadsheetcomment/author) { get; } | 获取评论的作者。 |
| [Column](../../groupdocs.metadata.formats.document/spreadsheetcomment/column) { get; } | 获取评论的从一开始的列索引。 |
...
| [Row](../../groupdocs.metadata.formats.document/spreadsheetcomment/row) { get; } | 获取评论的从一开始的行索引。 |
| [SheetNumber](../../groupdocs.metadata.formats.document/spreadsheetcomment/sheetnumber) { get; } | 获取工作表编号。 |
| [Text](../../groupdocs.metadata.formats.document/spreadsheetcomment/text) { get; } | 获取注释文本。 |
