...
description: 表示电子表格文档中的工作表
type: docs
weight: 1220
url: /zh/net/groupdocs.metadata.formats.document/spreadsheetsheet/
---
...
| [Name](../../groupdocs.metadata.formats.document/spreadsheetsheet/name) { get; } | 获取工作表名称。 |
| [Number](../../groupdocs.metadata.formats.document/spreadsheetsheet/number) { get; } | 获取工作表编号。 |
