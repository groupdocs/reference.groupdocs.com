...
| [Comments](../../groupdocs.metadata.formats.document/spreadsheetpackage/comments) { get; set; } | 获取或设置评论。 |
...
| [HyperlinkBase](../../groupdocs.metadata.formats.document/spreadsheetpackage/hyperlinkbase) { get; set; } | 获取或设置超链接库。 |
...
| [LastSavedBy](../../groupdocs.metadata.formats.document/spreadsheetpackage/lastsavedby) { get; set; } | 获取或设置最后作者的姓名。 |
| [LastSavedTime](../../groupdocs.metadata.formats.document/spreadsheetpackage/lastsavedtime) { get; set; } | 获取或设置上次以 UTC 保存的时间。 |
...
| [TotalEditingTime](../../groupdocs.metadata.formats.document/spreadsheetpackage/totaleditingtime) { get; set; } | 获取或设置总编辑时间，以分钟为单位。 |
