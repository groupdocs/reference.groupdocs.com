...
description: 表示文字处理文档中的一个字段
type: docs
weight: 1250
url: /zh/net/groupdocs.metadata.formats.document/wordprocessingfield/
---
...
| 姓名 | 描述 |
| --- | --- |
| [Code](../../groupdocs.metadata.formats.document/wordprocessingfield/code) { get; } | 获取域代码。 |
...
| [Result](../../groupdocs.metadata.formats.document/wordprocessingfield/result) { get; } | 获取字段结果。 |
