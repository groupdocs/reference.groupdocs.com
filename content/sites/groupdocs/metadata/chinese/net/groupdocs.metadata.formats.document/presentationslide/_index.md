...
type: docs
weight: 1110
url: /zh/net/groupdocs.metadata.formats.document/presentationslide/
---
...
| [Name](../../groupdocs.metadata.formats.document/presentationslide/name) { get; } | 获取幻灯片名称。 |
| [Number](../../groupdocs.metadata.formats.document/presentationslide/number) { get; } | 获取幻灯片编号。 |
...
| [SlideId](../../groupdocs.metadata.formats.document/presentationslide/slideid) { get; } | 获取幻灯片 ID。 |
