...
description: 表示允许在 PDF 文档中处理元数据的根包
type: docs
weight: 1040
...
| [InspectionPackage](../../groupdocs.metadata.formats.document/pdfrootpackage/inspectionpackage) { get; } | 获取包含文档检查结果的元数据包。 该包包含有关在某些情况下可被视为元数据的文档部分的信息。 |
