...
description: 表示 PDFWordProcessingSpreadsheetPresentation 等文档格式的根包
type: docs
weight: 930
url: /zh/net/groupdocs.metadata.formats.document/documentrootpackage-1/
---
## DocumentRootPackage&lt;TPackage&gt; class

表示 PDF、WordProcessing、Spreadsheet、Presentation 等文档格式的根包
