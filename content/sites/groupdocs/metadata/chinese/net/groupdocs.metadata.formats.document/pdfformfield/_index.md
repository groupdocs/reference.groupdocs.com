...
description: 表示 PDF 文档中的表单域
type: docs
weight: 1010
url: /zh/net/groupdocs.metadata.formats.document/pdfformfield/
---
## PdfFormField class
...
| [Name](../../groupdocs.metadata.formats.document/pdfformfield/name) { get; } | 获取字段的名称。 |
...
| [Value](../../groupdocs.metadata.formats.document/pdfformfield/value) { get; } | 获取字段值。 |
