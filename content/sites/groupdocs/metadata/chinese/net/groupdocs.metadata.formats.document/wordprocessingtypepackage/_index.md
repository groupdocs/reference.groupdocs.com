...
description: 表示包含文档特定文件格式信息的元数据包
type: docs
weight: 1320
url: /zh/net/groupdocs.metadata.formats.document/wordprocessingtypepackage/
---
...
| [WordProcessingFormat](../../groupdocs.metadata.formats.document/wordprocessingtypepackage/wordprocessingformat) { get; } | 获取准确的文字处理格式。 |
