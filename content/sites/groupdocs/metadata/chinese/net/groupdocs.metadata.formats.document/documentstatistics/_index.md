...
| 姓名 | 描述 |
| --- | --- |
| [DocumentStatistics](documentstatistics)() | 初始化[`DocumentStatistics`](../documentstatistics)类. |

## 特性

| 姓名 | 描述 |
| --- | --- |
| [CharacterCount](../../groupdocs.metadata.formats.document/documentstatistics/charactercount) { get; } | 获取文档中的估计字符数。 |
...
| [WordCount](../../groupdocs.metadata.formats.document/documentstatistics/wordcount) { get; } | 获取文档中的估计字数。 |
