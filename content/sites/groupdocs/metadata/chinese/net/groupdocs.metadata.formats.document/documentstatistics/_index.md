...
description: 表示一组文档统计
type: docs
weight: 940
url: /zh/net/groupdocs.metadata.formats.document/documentstatistics/
---
...
| 姓名 | 描述 |
| --- | --- |
| [DocumentStatistics](documentstatistics)() | 初始化一个新的实例[`DocumentStatistics`](../documentstatistics)类. |

## 特性

| 姓名 | 描述 |
| --- | --- |
| [CharacterCount](../../groupdocs.metadata.formats.document/documentstatistics/charactercount) { get; } | 获取文档中估计的字符数。 |
...
| [PageCount](../../groupdocs.metadata.formats.document/documentstatistics/pagecount) { get; } | 获取文档中的估计页数。 |
...
| [WordCount](../../groupdocs.metadata.formats.document/documentstatistics/wordcount) { get; } | 获取文档中估计的单词数。 |
