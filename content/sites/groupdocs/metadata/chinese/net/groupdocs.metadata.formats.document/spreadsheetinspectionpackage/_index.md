...
description: 包含有关在某些情况下可被视为元数据的电子表格部分的信息
type: docs
weight: 1190
...
| [DigitalSignatures](../../groupdocs.metadata.formats.document/spreadsheetinspectionpackage/digitalsignatures) { get; } | 获取文档中显示的数字签名数组。 |
