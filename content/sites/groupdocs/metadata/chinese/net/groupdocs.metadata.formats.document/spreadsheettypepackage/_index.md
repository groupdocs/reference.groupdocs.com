...
description: 表示包含特定于电子表格的文件格式信息的元数据包
type: docs
weight: 1230
url: /zh/net/groupdocs.metadata.formats.document/spreadsheettypepackage/
---
## SpreadsheetTypePackage class

表示包含特定于电子表格的文件格式信息的元数据包。
...
| [SpreadsheetFormat](../../groupdocs.metadata.formats.document/spreadsheettypepackage/spreadsheetformat) { get; } | 获取准确的电子表格格式。 |
