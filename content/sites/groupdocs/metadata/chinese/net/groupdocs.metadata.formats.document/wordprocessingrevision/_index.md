...
description: 表示文档中的修订跟踪更改
type: docs
weight: 1290
url: /zh/net/groupdocs.metadata.formats.document/wordprocessingrevision/
---
...
| 姓名 | 描述 |
| --- | --- |
| [Author](../../groupdocs.metadata.formats.document/wordprocessingrevision/author) { get; } | 获取修订的作者。 |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | 获取元数据属性的数量。 |
| [DateTime](../../groupdocs.metadata.formats.document/wordprocessingrevision/datetime) { get; } | 获取修订的日期/时间。 |
...
| [RevisionType](../../groupdocs.metadata.formats.document/wordprocessingrevision/revisiontype) { get; } | 获取修订的类型。 |
