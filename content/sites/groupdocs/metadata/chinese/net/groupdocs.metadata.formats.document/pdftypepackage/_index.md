...
description: 表示包含 PDF 特定文件格式信息的元数据包
type: docs
weight: 1050
url: /zh/net/groupdocs.metadata.formats.document/pdftypepackage/
---
## PdfTypePackage class

表示包含 PDF 特定文件格式信息的元数据包。
...
| [Version](../../groupdocs.metadata.formats.document/pdftypepackage/version) { get; } | 获取格式的版本。 |
