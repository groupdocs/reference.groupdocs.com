...
description: 表示文字处理文档中的注释
type: docs
weight: 1240
url: /zh/net/groupdocs.metadata.formats.document/wordprocessingcomment/
---
...
| 姓名 | 描述 |
| --- | --- |
| [Author](../../groupdocs.metadata.formats.document/wordprocessingcomment/author) { get; set; } | 获取或设置作者。 |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | 获取元数据属性的数量。 |
| [CreatedDate](../../groupdocs.metadata.formats.document/wordprocessingcomment/createddate) { get; set; } | 获取或设置评论的创建日期。 |
| [Id](../../groupdocs.metadata.formats.document/wordprocessingcomment/id) { get; } | 获取评论id. |
| [Initials](../../groupdocs.metadata.formats.document/wordprocessingcomment/initials) { get; set; } | 获取或设置作者姓名首字母。 |
...
| [Text](../../groupdocs.metadata.formats.document/wordprocessingcomment/text) { get; set; } | 获取或设置评论的文本。 |
