...
| [Comments](../../groupdocs.metadata.formats.document/wordprocessingpackage/comments) { get; set; } | 获取或设置注释。 |
...
| [HyperlinkBase](../../groupdocs.metadata.formats.document/wordprocessingpackage/hyperlinkbase) { get; set; } | 获取或设置超链接基础。 |
...
| [LastPrintedDate](../../groupdocs.metadata.formats.document/wordprocessingpackage/lastprinteddate) { get; set; } | 获取或设置最后打印日期。 |
| [LastSavedBy](../../groupdocs.metadata.formats.document/wordprocessingpackage/lastsavedby) { get; set; } | 获取或设置最后一位作者的姓名。 |
...
| [TotalEditingTime](../../groupdocs.metadata.formats.document/wordprocessingpackage/totaleditingtime) { get; set; } | 获取或设置以分钟为单位的总编辑时间。 |
...
此代码示例显示如何更新 WordProcessing 文档中的内置元数据属性。
