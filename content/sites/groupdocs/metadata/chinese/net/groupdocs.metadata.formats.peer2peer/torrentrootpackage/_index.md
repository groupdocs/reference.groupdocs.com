...
description: 表示用于处理 TORRENT 文件元数据的根包
type: docs
weight: 2200
url: /zh/net/groupdocs.metadata.formats.peer2peer/torrentrootpackage/
---
## TorrentRootPackage class

表示用于处理 TORRENT 文件元数据的根包。
...
| [TorrentPackage](../../groupdocs.metadata.formats.peer2peer/torrentrootpackage/torrentpackage) { get; } | 获取 TORRENT 文件元数据包。 |
