...
description: 表示共享文件信息 包含有关种子分发中每个文件的详细信息
type: docs
weight: 2210
...
| [Length](../../groupdocs.metadata.formats.peer2peer/torrentsharedfilepackage/length) { get; } | 以字节为单位获取文件的长度。 |
