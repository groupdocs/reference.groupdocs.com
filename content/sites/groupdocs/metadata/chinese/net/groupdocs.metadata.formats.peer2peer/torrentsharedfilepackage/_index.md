...
description: 表示共享文件信息 包含有关 torrent 分发中每个文件的详细信息
type: docs
weight: 2210
url: /zh/net/groupdocs.metadata.formats.peer2peer/torrentsharedfilepackage/
---
## TorrentSharedFilePackage class

表示共享文件信息。 包含有关 torrent 分发中每个文件的详细信息。
...
| [Length](../../groupdocs.metadata.formats.peer2peer/torrentsharedfilepackage/length) { get; } | 获取文件的字节长度。 |
| [MetadataType](../../groupdocs.metadata.common/metadatapackage/metadatatype) { get; } | 获取元数据类型。 |
| [Name](../../groupdocs.metadata.formats.peer2peer/torrentsharedfilepackage/name) { get; } | 获取文件的全名（从根 torrent 文件夹到文件的相对路径）。 |
