...
description: 表示 MSG 消息元数据
type: docs
weight: 1400
url: /zh/net/groupdocs.metadata.formats.email/msgpackage/
---
## MsgPackage class
...
| [Body](../../groupdocs.metadata.formats.email/msgpackage/body) { get; } | 获取电子邮件消息文本。 |
| [CarbonCopyRecipients](../../groupdocs.metadata.formats.email/emailpackage/carboncopyrecipients) { get; set; } | 获取或设置电子邮件的抄送（抄送）收件人数组。 |
| [Categories](../../groupdocs.metadata.formats.email/msgpackage/categories) { get; } | 获取类别或关键字的数组。 |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | 获取元数据属性的数量。 |
| [DeliveryTime](../../groupdocs.metadata.formats.email/msgpackage/deliverytime) { get; } | 获取消息传递的日期和时间。 |
