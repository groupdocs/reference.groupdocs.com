...
description: 表示包含电子邮件标题的元数据包
type: docs
weight: 1350
url: /zh/net/groupdocs.metadata.formats.email/emailheaderpackage/
---
...
| [Get](../../groupdocs.metadata.formats.email/emailheaderpackage/get)(string) | 获取指定标头的值。 |
