...
description: 表示允许在电子邮件消息中使用元数据的根包
type: docs
weight: 1370
url: /zh/net/groupdocs.metadata.formats.email/emailrootpackage/
---
## EmailRootPackage class

表示允许在电子邮件消息中使用元数据的根包。
...
| [EmailPackage](../../groupdocs.metadata.formats.email/emailrootpackage/emailpackage) { get; } | 获取电子邮件元数据包。 |
...
| [ClearAttachments](../../groupdocs.metadata.formats.email/emailrootpackage/clearattachments)() | 删除电子邮件中的所有附件。 |
