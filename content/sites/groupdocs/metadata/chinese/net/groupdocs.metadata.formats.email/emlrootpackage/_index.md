...
description: 表示允许在 EML 电子邮件消息中使用元数据的根包
type: docs
weight: 1390
url: /zh/net/groupdocs.metadata.formats.email/emlrootpackage/
---
...
| [EmailPackage](../../groupdocs.metadata.formats.email/emlrootpackage/emailpackage) { get; } | 获取 EML 元数据包。 (2 properties) |
