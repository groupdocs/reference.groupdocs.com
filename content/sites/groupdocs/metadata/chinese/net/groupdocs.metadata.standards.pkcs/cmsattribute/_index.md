...
description: 表示 CMS 签名者信息属性
type: docs
weight: 2970
url: /zh/net/groupdocs.metadata.standards.pkcs/cmsattribute/
---
## CmsAttribute class
...
| [Oid](../../groupdocs.metadata.standards.pkcs/cmsattribute/oid) { get; } | 获取属性 OID。 |
...
| [Value](../../groupdocs.metadata.standards.pkcs/cmsattribute/value) { get; } | 获取以字符串表示的属性值。 |
