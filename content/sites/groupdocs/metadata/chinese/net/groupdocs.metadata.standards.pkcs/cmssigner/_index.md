...
description: 表示 CMS 每个签名者的信息
type: docs
weight: 3010
url: /zh/net/groupdocs.metadata.standards.pkcs/cmssigner/
---
## CmsSigner class
...
| [DigestAlgorithm](../../groupdocs.metadata.standards.pkcs/cmssigner/digestalgorithm) { get; } | 获取签名者使用的消息摘要算法和任何相关参数。 |
...
| [SignatureAlgorithm](../../groupdocs.metadata.standards.pkcs/cmssigner/signaturealgorithm) { get; } | 获取签名者用于生成数字签名的签名算法和任何相关参数。 |
| [SignatureValue](../../groupdocs.metadata.standards.pkcs/cmssigner/signaturevalue) { get; } | 获取数字签名生成结果，使用消息摘要和签名者的私钥。 |
| [SignedAttributes](../../groupdocs.metadata.standards.pkcs/cmssigner/signedattributes) { get; } | 获取已签名的属性集合。 |
| [SignerIdentifier](../../groupdocs.metadata.standards.pkcs/cmssigner/signeridentifier) { get; } | 获取签名者的证书（以及签名者的公钥）原始数据。 |
| [SigningTime](../../groupdocs.metadata.standards.pkcs/cmssigner/signingtime) { get; } | 获取签名者（据称）执行签名过程的时间。 |
| [UnsignedAttributes](../../groupdocs.metadata.standards.pkcs/cmssigner/unsignedattributes) { get; } | 获取未签名的属性集合。 |
