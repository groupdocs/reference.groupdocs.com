...
| [SignatureAlgorithm](../../groupdocs.metadata.standards.pkcs/cmssigner/signaturealgorithm) { get; } | 获取签名者用来生成数字签名的签名算法和任何相关参数。 |
| [SignatureValue](../../groupdocs.metadata.standards.pkcs/cmssigner/signaturevalue) { get; } | 使用消息摘要和签名者的私钥获取数字签名生成的结果。 |
