...
description: 代表一个CMS证书
type: docs
weight: 2980
url: /zh/net/groupdocs.metadata.standards.pkcs/cmscertificate/
---
...
| [NotAfter](../../groupdocs.metadata.standards.pkcs/cmscertificate/notafter) { get; } | 获取证书不再有效的本地时间日期。 |
| [NotBefore](../../groupdocs.metadata.standards.pkcs/cmscertificate/notbefore) { get; } | 获取证书生效的本地时间日期。 |
...
| [RawData](../../groupdocs.metadata.standards.pkcs/cmscertificate/rawdata) { get; } | 获取此证书的原始数据。 |
