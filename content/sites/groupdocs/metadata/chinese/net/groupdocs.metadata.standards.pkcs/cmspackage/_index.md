...
description: 表示 CMS 数字签名元数据包
type: docs
weight: 3000
url: /zh/net/groupdocs.metadata.standards.pkcs/cmspackage/
---
## CmsPackage class
...
| [Flags](../../groupdocs.metadata.standards.pkcs/cmspackage/flags) { get; } | 获取数字签名标志。 |
...
| [Signatures](../../groupdocs.metadata.standards.pkcs/cmspackage/signatures) { get; } | 获取从文件中提取的签名数组。 |
