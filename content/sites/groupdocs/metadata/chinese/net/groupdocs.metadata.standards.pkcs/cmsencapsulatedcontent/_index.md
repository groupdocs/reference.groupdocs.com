...
description: 表示一个签名的内容容器由内容类型标识符和内容本身组成
type: docs
weight: 2990
url: /zh/net/groupdocs.metadata.standards.pkcs/cmsencapsulatedcontent/
---
## CmsEncapsulatedContent class

表示一个签名的内容容器，由内容类型标识符和内容本身组成。
...
| 姓名 | 描述 |
| --- | --- |
| [ContentRawData](../../groupdocs.metadata.standards.pkcs/cmsencapsulatedcontent/contentrawdata) { get; } | 获取内容信息的原始数据。 |
| [ContentType](../../groupdocs.metadata.standards.pkcs/cmsencapsulatedcontent/contenttype) { get; } | 获取唯一指定内容类型的对象标识符。 |
