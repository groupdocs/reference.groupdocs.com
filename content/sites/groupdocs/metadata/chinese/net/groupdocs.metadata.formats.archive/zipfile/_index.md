...
| 姓名 | 描述 |
| --- | --- |
| [CompressedSize](../../groupdocs.metadata.formats.archive/zipfile/compressedsize) { get; } | 获取以字节为单位的压缩大小。 |
...
| [ModificationDateTime](../../groupdocs.metadata.formats.archive/zipfile/modificationdatetime) { get; } | 获取最后修改日期和时间。 |
...
| [UncompressedSize](../../groupdocs.metadata.formats.archive/zipfile/uncompressedsize) { get; } | 获取以字节为单位的未压缩大小。 |
