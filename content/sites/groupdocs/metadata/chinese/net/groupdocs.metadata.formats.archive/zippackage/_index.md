...
| 姓名 | 描述 |
| --- | --- |
| [Comment](../../groupdocs.metadata.formats.archive/zippackage/comment) { get; set; } | 获取或设置用户创建的 ZIP 存档评论。 |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | 获取元数据属性的数量。 |
| [Files](../../groupdocs.metadata.formats.archive/zippackage/files) { get; } | 获取数组[`ZipFile`](../zipfile) ZIP 存档中的条目. |
