...
description: 初始化一个新的实例PreviewOptionsgroupdocs.metadata.options/previewoptions导致输出流关闭的类
type: docs
weight: 10
url: /zh/net/groupdocs.metadata.options/previewoptions/previewoptions/
---
...
初始化一个新实例[`PreviewOptions`](../../previewoptions)导致输出流返回给客户端以供进一步使用的类。
