...
description: Representerar jobb.
type: docs
weight: 3440
url: /sv/net/groupdocs.metadata.standards.xmp/xmpjob/
---
## XmpJob class
...
| namn | Beskrivning |
| --- | --- |
| [XmpJob](xmpjob)() | Initierar en ny instans av[`XmpJob`](../xmpjob) class. |
...
| [ID](../../groupdocs.metadata.standards.xmp/xmpjob/id) { get; set; } | Hämtar eller ställer in unikt ID för jobbet. Det här fältet är en referens till något externt jobbhanteringssystem. |
| [Item](../../groupdocs.metadata.common/metadatapackage/item) { get; } | Får[`MetadataProperty`](../../groupdocs.metadata.common/metadataproperty) med det angivna namnet. |
| [Keys](../../groupdocs.metadata.common/metadatapackage/keys) { get; } | Hämtar en samling av metadataegenskapsnamnen. |
| [MetadataType](../../groupdocs.metadata.common/metadatapackage/metadatatype) { get; } | Hämtar metadatatypen. |
| [Name](../../groupdocs.metadata.standards.xmp/xmpjob/name) { get; set; } | Hämtar eller ställer in informellt namn på jobbet. Detta namn är för användardisplay och informella system. |
...
| [Url](../../groupdocs.metadata.standards.xmp/xmpjob/url) { get; set; } | Hämtar eller ställer in en fil-URL som refererar till en extern jobbhanteringsfil. |
