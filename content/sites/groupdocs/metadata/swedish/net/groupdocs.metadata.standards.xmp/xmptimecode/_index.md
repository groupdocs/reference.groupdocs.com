...
description: Representerar ett tidskodvärde i en video.
type: docs
weight: 3600
url: /sv/net/groupdocs.metadata.standards.xmp/xmptimecode/
---
## XmpTimecode class
...
| namn | Beskrivning |
| --- | --- |
| [XmpTimecode](xmptimecode#constructor)() | Initierar en ny instans av[`XmpTimecode`](../xmptimecode) class. |
| [XmpTimecode](xmptimecode#constructor_1)(XmpTimeFormat, string) | Initierar en ny instans av[`XmpTimecode`](../xmptimecode) class. |
...
| [TimeFormat](../../groupdocs.metadata.standards.xmp/xmptimecode/timeformat) { get; set; } | Hämtar eller ställer in formatet som används i tidsvärdet. |
| [TimeValue](../../groupdocs.metadata.standards.xmp/xmptimecode/timevalue) { get; set; } | Hämtar eller ställer in tidsvärdet i det angivna formatet. Tidsvärden använder en kolonavgränsare i alla format utom 2997drop och 5994drop, som använder semikolon. De fyra fälten indikerar timmar, minuter, sekunder och bildrutor: hh:mm:ss:ff |
...
| [SetTimeFormat](../../groupdocs.metadata.standards.xmp/xmptimecode/settimeformat)(XmpTimeFormat) | Ställer in tidsformatet. |
