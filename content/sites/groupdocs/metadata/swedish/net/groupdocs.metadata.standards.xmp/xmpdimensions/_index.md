...
type: docs
weight: 3380
url: /sv/net/groupdocs.metadata.standards.xmp/xmpdimensions/
---
## XmpDimensions class
...
| namn | Beskrivning |
| --- | --- |
| [XmpDimensions](xmpdimensions#constructor)() | Initierar en ny instans av[`XmpDimensions`](../xmpdimensions) class. |
| [XmpDimensions](xmpdimensions#constructor_1)(double, double) | Initierar en ny instans av[`XmpDimensions`](../xmpdimensions) class. |
...
| [Height](../../groupdocs.metadata.standards.xmp/xmpdimensions/height) { get; set; } | Hämtar eller ställer in höjden. |
...
| [Units](../../groupdocs.metadata.standards.xmp/xmpdimensions/units) { get; set; } | Hämtar eller ställer in enheterna. |
| [Width](../../groupdocs.metadata.standards.xmp/xmpdimensions/width) { get; set; } | Hämtar eller ställer in bredden. |
