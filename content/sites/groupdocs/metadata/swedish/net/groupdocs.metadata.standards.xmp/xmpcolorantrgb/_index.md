...
description: Representerar RGBfärgämnet.
type: docs
weight: 3340
url: /sv/net/groupdocs.metadata.standards.xmp/xmpcolorantrgb/
---
## XmpColorantRgb class

Representerar RGB-färgämnet.
...
| namn | Beskrivning |
| --- | --- |
| [XmpColorantRgb](xmpcolorantrgb#constructor)() | Initierar en ny instans av[`XmpColorantRgb`](../xmpcolorantrgb) class. |
| [XmpColorantRgb](xmpcolorantrgb#constructor_1)(byte, byte, byte) | Initierar en ny instans av[`XmpColorantRgb`](../xmpcolorantrgb) class. |

## Egenskaper

| namn | Beskrivning |
| --- | --- |
| [Blue](../../groupdocs.metadata.standards.xmp/xmpcolorantrgb/blue) { get; set; } | Hämtar eller ställer in den blå komponenten. |
...
| [Green](../../groupdocs.metadata.standards.xmp/xmpcolorantrgb/green) { get; set; } | Hämtar eller ställer in det gröna värdet. |
...
| [Red](../../groupdocs.metadata.standards.xmp/xmpcolorantrgb/red) { get; set; } | Hämtar eller ställer in den röda komponenten. |
