...
description: En struktur som innehåller egenskaperna hos ett färgämne swatch som används i ett dokument.
type: docs
weight: 3300
url: /sv/net/groupdocs.metadata.standards.xmp/xmpcolorantbase/
---
## XmpColorantBase class

En struktur som innehåller egenskaperna hos ett färgämne (swatch) som används i ett dokument.
