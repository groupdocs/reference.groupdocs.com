...
description: Representerar rotpaketet som tillåter arbete med metadata i en CADritning.
type: docs
weight: 850
url: /sv/net/groupdocs.metadata.formats.cad/cadrootpackage/
---
## CadRootPackage class

Representerar rotpaketet som tillåter arbete med metadata i en CAD-ritning.
...
Detta kodexempel visar hur man läser metadata från en CAD-ritning.
