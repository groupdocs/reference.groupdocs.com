...
description: Representerar MSGmeddelandemetadata.
type: docs
weight: 1400
url: /sv/net/groupdocs.metadata.formats.email/msgpackage/
---
## MsgPackage class

Representerar MSG-meddelandemetadata.
...
| [Body](../../groupdocs.metadata.formats.email/msgpackage/body) { get; } | Hämtar e-postmeddelandet. |
...
| [Categories](../../groupdocs.metadata.formats.email/msgpackage/categories) { get; } | Får mängden kategorier eller sökord. |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | Hämtar antalet metadataegenskaper. |
| [DeliveryTime](../../groupdocs.metadata.formats.email/msgpackage/deliverytime) { get; } | Hämtar datum och tid då meddelandet levererades. |
