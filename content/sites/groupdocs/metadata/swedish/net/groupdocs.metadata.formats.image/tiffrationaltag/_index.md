...
description: Representerar en TIFF Rationaltagg.
type: docs
weight: 2010
url: /sv/net/groupdocs.metadata.formats.image/tiffrationaltag/
---
## TiffRationalTag class

Representerar en TIFF Rational-tagg.
...
| namn | Beskrivning |
| --- | --- |
| [TiffRationalTag](tiffrationaltag)(TiffTagID, TiffRational[]) | Initierar en ny instans av[`TiffRationalTag`](../tiffrationaltag) class. |
