...
description: Representerar en TIFF SBytetagg.
type: docs
weight: 2030
url: /sv/net/groupdocs.metadata.formats.image/tiffsbytetag/
---
## TiffSByteTag class

Representerar en TIFF SByte-tagg.
...
| namn | Beskrivning |
| --- | --- |
| [TiffSByteTag](tiffsbytetag)(TiffTagID, sbyte[]) | Initierar en ny instans av[`TiffSByteTag`](../tiffsbytetag) class. |
