...
description: Representerar rotpaketet som tillåter arbete med metadata i en WEBPbild.
type: docs
weight: 2130
url: /sv/net/groupdocs.metadata.formats.image/webprootpackage/
---
## WebPRootPackage class

Representerar rotpaketet som tillåter arbete med metadata i en WEBP-bild.
...
| [ExifPackage](../../groupdocs.metadata.formats.image/webprootpackage/exifpackage) { get; set; } | Hämtar eller ställer in EXIF-metadatapaketet. |
...
| [XmpPackage](../../groupdocs.metadata.formats.image/webprootpackage/xmppackage) { get; set; } | Hämtar eller ställer in XMP-metadatapaketet. |
