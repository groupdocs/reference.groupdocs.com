...
description: Representerar en kort TIFFtagg.
type: docs
weight: 2080
url: /sv/net/groupdocs.metadata.formats.image/tiffshorttag/
---
## TiffShortTag class

Representerar en kort TIFF-tagg.
...
| namn | Beskrivning |
| --- | --- |
| [TiffShortTag](tiffshorttag)(TiffTagID, ushort[]) | Initierar en ny instans av[`TiffShortTag`](../tiffshorttag) class. |
