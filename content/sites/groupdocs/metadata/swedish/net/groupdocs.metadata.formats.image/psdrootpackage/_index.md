...
description: Representerar rotpaketet som tillåter arbete med metadata i ett Photoshopdokument.
type: docs
weight: 1930
url: /sv/net/groupdocs.metadata.formats.image/psdrootpackage/
---
## PsdRootPackage class

Representerar rotpaketet som tillåter arbete med metadata i ett Photoshop-dokument.
...
| [ExifPackage](../../groupdocs.metadata.formats.image/psdrootpackage/exifpackage) { get; set; } | Hämtar eller ställer in EXIF-metadatapaketet. |
| [FileType](../../groupdocs.metadata.formats.image/imagerootpackage/filetype) { get; } | Hämtar filtypens metadatapaket. (2 properties) |
| [ImageResourcePackage](../../groupdocs.metadata.formats.image/psdrootpackage/imageresourcepackage) { get; } | Får metadatapaketet Photoshop Image Resource. Bildresursblock är den grundläggande byggnadsenheten i Photoshops ursprungliga filformat. |
| [IptcPackage](../../groupdocs.metadata.formats.image/psdrootpackage/iptcpackage) { get; set; } | Hämtar eller ställer in IPTC-metadatapaketet. |
| [Item](../../groupdocs.metadata.common/metadatapackage/item) { get; } | Får[`MetadataProperty`](../../groupdocs.metadata.common/metadataproperty) med det angivna namnet. |
| [Keys](../../groupdocs.metadata.common/metadatapackage/keys) { get; } | Hämtar en samling av metadataegenskapsnamnen. |
| [MetadataType](../../groupdocs.metadata.common/metadatapackage/metadatatype) { get; } | Hämtar metadatatypen. |
| [PropertyDescriptors](../../groupdocs.metadata.common/metadatapackage/propertydescriptors) { get; } | Får en samling beskrivningar som innehåller information om egenskaper som är tillgängliga via sökmotorn GroupDocs.Metadata. |
| [PsdPackage](../../groupdocs.metadata.formats.image/psdrootpackage/psdpackage) { get; } | Hämtar metadatapaketet som innehåller information om PSD-filen. |
| [XmpPackage](../../groupdocs.metadata.formats.image/psdrootpackage/xmppackage) { get; set; } | Hämtar eller ställer in XMP-metadatapaketet. |
