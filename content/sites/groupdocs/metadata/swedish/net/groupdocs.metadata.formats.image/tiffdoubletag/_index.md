...
description: Representerar en TIFFdubbeltagg.
type: docs
weight: 1970
url: /sv/net/groupdocs.metadata.formats.image/tiffdoubletag/
---
## TiffDoubleTag class

Representerar en TIFF-dubbeltagg.
...
| namn | Beskrivning |
| --- | --- |
| [TiffDoubleTag](tiffdoubletag)(TiffTagID, double[]) | Initierar en ny instans av[`TiffDoubleTag`](../tiffdoubletag) class. |
