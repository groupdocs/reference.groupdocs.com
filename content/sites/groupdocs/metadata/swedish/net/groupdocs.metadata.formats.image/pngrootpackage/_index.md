...
description: Representerar rotpaketet som är avsett att fungera med metadata i en PNGbild.
type: docs
weight: 1860
url: /sv/net/groupdocs.metadata.formats.image/pngrootpackage/
---
## PngRootPackage class

Representerar rotpaketet som är avsett att fungera med metadata i en PNG-bild.
...
| [ExifPackage](../../groupdocs.metadata.formats.image/pngrootpackage/exifpackage) { get; set; } | Hämtar eller ställer in EXIF-metadatapaketet. |
...
| [PngPackage](../../groupdocs.metadata.formats.image/pngrootpackage/pngpackage) { get; } | Hämtar det inbyggda PNG-metadatapaketet. |
| [PropertyDescriptors](../../groupdocs.metadata.common/metadatapackage/propertydescriptors) { get; } | Får en samling beskrivningar som innehåller information om egenskaper som är tillgängliga via sökmotorn GroupDocs.Metadata. |
| [XmpPackage](../../groupdocs.metadata.formats.image/pngrootpackage/xmppackage) { get; set; } | Hämtar eller ställer in XMP-metadatapaketet. |
...
* [Arbeta med metadata i PNG-bilder](https://docs.groupdocs.com/display/metadatanet/Working+with+metadata+in+PNG+images)
