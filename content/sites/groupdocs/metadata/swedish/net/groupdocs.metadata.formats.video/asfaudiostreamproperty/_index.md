...
description: Representerar ljudströmsegenskapsmetadata i ASFmediebehållaren.
type: docs
weight: 2230
url: /sv/net/groupdocs.metadata.formats.video/asfaudiostreamproperty/
---
## AsfAudioStreamProperty class

Representerar ljudströmsegenskapsmetadata i ASF-mediebehållaren.
...
| [BitsPerSample](../../groupdocs.metadata.formats.video/asfaudiostreamproperty/bitspersample) { get; } | Hämtar antalet bitar per sampel av monodata. |
| [Channels](../../groupdocs.metadata.formats.video/asfaudiostreamproperty/channels) { get; } | Hämtar antalet ljudkanaler. |
...
| [FormatTag](../../groupdocs.metadata.formats.video/asfaudiostreamproperty/formattag) { get; } | Får det unika ID:t för den codec som används för att koda ljuddata. |
...
| [SamplesPerSecond](../../groupdocs.metadata.formats.video/asfaudiostreamproperty/samplespersecond) { get; } | Får ett värde i Hertz (cykler per sekund) som representerar samplingshastigheten för ljudströmmen. |
