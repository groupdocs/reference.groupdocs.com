...
description: Representerar rotpaketet som gör det möjligt att arbeta med metadata i en QuickTimevideo.
type: docs
weight: 2640
url: /sv/net/groupdocs.metadata.formats.video/movrootpackage/
---
## MovRootPackage class

Representerar rotpaketet som gör det möjligt att arbeta med metadata i en QuickTime-video.
...
| [MovPackage](../../groupdocs.metadata.formats.video/movrootpackage/movpackage) { get; } | Hämtar QuickTime-metadatapaketet. |
| [PropertyDescriptors](../../groupdocs.metadata.common/metadatapackage/propertydescriptors) { get; } | Får en samling beskrivningar som innehåller information om egenskaper som är tillgängliga via sökmotorn GroupDocs.Metadata. |
| [XmpPackage](../../groupdocs.metadata.formats.video/movrootpackage/xmppackage) { get; set; } | Hämtar eller ställer in XMP-metadatapaketet. |
...
Det här exemplet visar hur man läser QuickTime-atomer i en MOV-video.
