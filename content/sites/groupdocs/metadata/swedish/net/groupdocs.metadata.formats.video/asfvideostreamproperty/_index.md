...
description: Representerar videoströmsegenskapsmetadata i ASFmediebehållaren.
type: docs
weight: 2370
url: /sv/net/groupdocs.metadata.formats.video/asfvideostreamproperty/
---
## AsfVideoStreamProperty class

Representerar videoströmsegenskapsmetadata i ASF-mediebehållaren.
...
| [BitsPerPixels](../../groupdocs.metadata.formats.video/asfvideostreamproperty/bitsperpixels) { get; } | Hämtar bitarna per pixel. |
| [Compression](../../groupdocs.metadata.formats.video/asfvideostreamproperty/compression) { get; } | Hämtar videokomprimerings-ID. |
...
| [ImageHeight](../../groupdocs.metadata.formats.video/asfvideostreamproperty/imageheight) { get; } | Hämtar höjden på den kodade bilden i pixlar. |
| [ImageWidth](../../groupdocs.metadata.formats.video/asfvideostreamproperty/imagewidth) { get; } | Hämtar bredden på den kodade bilden i pixlar. |
