...
description: Representerar rotpaketet som tillåter arbete med metadata i en ASFvideo.
type: docs
weight: 2350
url: /sv/net/groupdocs.metadata.formats.video/asfrootpackage/
---
## AsfRootPackage class

Representerar rotpaketet som tillåter arbete med metadata i en ASF-video.
...
| namn | Beskrivning |
| --- | --- |
| [AsfPackage](../../groupdocs.metadata.formats.video/asfrootpackage/asfpackage) { get; } | Hämtar ASF-metadatapaketet. |
...
| [XmpPackage](../../groupdocs.metadata.formats.video/asfrootpackage/xmppackage) { get; set; } | Hämtar eller ställer in XMP-metadatapaketet. |
