...
description: Representerar rotpaketet som tillåter arbete med metadata i en Matroskavideo.
type: docs
weight: 2480
url: /sv/net/groupdocs.metadata.formats.video/matroskarootpackage/
---
## MatroskaRootPackage class

Representerar rotpaketet som tillåter arbete med metadata i en Matroska-video.
...
| [MatroskaPackage](../../groupdocs.metadata.formats.video/matroskarootpackage/matroskapackage) { get; } | Hämtar Matroska-metadatapaketet. |
...
Det här exemplet visar hur man extraherar undertexter från en MKV-video.
