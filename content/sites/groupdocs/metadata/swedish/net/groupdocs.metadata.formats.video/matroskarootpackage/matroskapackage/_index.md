...
description: Hämtar Matroskametadatapaketet.
type: docs
weight: 10
url: /sv/net/groupdocs.metadata.formats.video/matroskarootpackage/matroskapackage/
---
## MatroskaRootPackage.MatroskaPackage property

Hämtar Matroska-metadatapaketet.
...
Det här exemplet visar hur man läser Matroska-formatspecifika metadataegenskaper.
...
using (Metadata metadata = new Metadata(Constants.InputMkv))
{
    ...
    // Läs Matroska segmentinformation
...
* namnutrymme [GroupDocs.Metadata.Formats.Video](../../matroskarootpackage)
