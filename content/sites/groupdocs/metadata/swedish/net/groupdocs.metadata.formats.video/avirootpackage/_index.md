...
description: Representerar rotpaketet som tillåter arbete med metadata i en AVIvideo.
type: docs
weight: 2400
url: /sv/net/groupdocs.metadata.formats.video/avirootpackage/
---
## AviRootPackage class

Representerar rotpaketet som tillåter arbete med metadata i en AVI-video.
...
| [Header](../../groupdocs.metadata.formats.video/avirootpackage/header) { get; } | Hämtar AVI-header-paketet. |
| [Item](../../groupdocs.metadata.common/metadatapackage/item) { get; } | Får[`MetadataProperty`](../../groupdocs.metadata.common/metadataproperty) med det angivna namnet. |
| [Keys](../../groupdocs.metadata.common/metadatapackage/keys) { get; } | Hämtar en samling av metadataegenskapsnamnen. |
| [MetadataType](../../groupdocs.metadata.common/metadatapackage/metadatatype) { get; } | Hämtar metadatatypen. |
| [PropertyDescriptors](../../groupdocs.metadata.common/metadatapackage/propertydescriptors) { get; } | Får en samling beskrivningar som innehåller information om egenskaper som är tillgängliga via sökmotorn GroupDocs.Metadata. |
| [RiffInfoPackage](../../groupdocs.metadata.formats.video/avirootpackage/riffinfopackage) { get; } | Hämtar paketet som innehåller RIFF Info-taggar. |
| [XmpPackage](../../groupdocs.metadata.formats.video/avirootpackage/xmppackage) { get; set; } | Hämtar eller ställer in XMP-metadatapaketet. |
