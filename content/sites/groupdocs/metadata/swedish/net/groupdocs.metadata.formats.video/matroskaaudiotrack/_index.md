...
description: Representerar ljudmetadata i en Matroskavideo.
type: docs
weight: 2430
url: /sv/net/groupdocs.metadata.formats.video/matroskaaudiotrack/
---
...
| namn | Beskrivning |
| --- | --- |
| [BitDepth](../../groupdocs.metadata.formats.video/matroskaaudiotrack/bitdepth) { get; } | Hämtar bitarna per sampel, som oftast används för PCM. |
| [Channels](../../groupdocs.metadata.formats.video/matroskaaudiotrack/channels) { get; } | Hämtar antalet kanaler i spåret. |
...
| [OutputSamplingFrequency](../../groupdocs.metadata.formats.video/matroskaaudiotrack/outputsamplingfrequency) { get; } | Får den verkliga utgångssamplingsfrekvensen i Hz (används för SBR-tekniker). |
| [PropertyDescriptors](../../groupdocs.metadata.common/metadatapackage/propertydescriptors) { get; } | Får en samling beskrivningar som innehåller information om egenskaper som är tillgängliga via sökmotorn GroupDocs.Metadata. |
| [SamplingFrequency](../../groupdocs.metadata.formats.video/matroskaaudiotrack/samplingfrequency) { get; } | Får samplingsfrekvensen i Hz. |
