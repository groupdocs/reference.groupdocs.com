...
description: Representerar Basic JobTicket namespace.
type: docs
weight: 3080
url: /sv/net/groupdocs.metadata.standards.xmp.schemes/xmpbasicjobticketpackage/
---
## XmpBasicJobTicketPackage class

Representerar Basic Job-Ticket namespace.
...
| namn | Beskrivning |
| --- | --- |
| [XmpBasicJobTicketPackage](xmpbasicjobticketpackage)() | Initierar en ny instans av[`XmpBasicJobTicketPackage`](../xmpbasicjobticketpackage) class. |
...
| [Jobs](../../groupdocs.metadata.standards.xmp.schemes/xmpbasicjobticketpackage/jobs) { get; set; } | Får eller ställer in jobben. |
