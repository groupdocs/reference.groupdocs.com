...
description: Representerar XMP PagedTextpaketet.
type: docs
weight: 3180
url: /sv/net/groupdocs.metadata.standards.xmp.schemes/xmppagedtextpackage/
---
...
| namn | Beskrivning |
| --- | --- |
| [XmpPagedTextPackage](xmppagedtextpackage)() | Initierar en ny instans av[`XmpPagedTextPackage`](../xmppagedtextpackage) class. |

## Egenskaper

| namn | Beskrivning |
| --- | --- |
| [Colorants](../../groupdocs.metadata.standards.xmp.schemes/xmppagedtextpackage/colorants) { get; set; } | Hämtar eller ställer in en ordnad uppsättning färgämnen (prover) som används i dokumentet (inklusive eventuella ingående dokument). |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | Hämtar antalet metadataegenskaper. |
| [Fonts](../../groupdocs.metadata.standards.xmp.schemes/xmppagedtextpackage/fonts) { get; set; } | Hämtar eller ställer in en oordnad uppsättning teckensnitt som används i dokumentet (inklusive alla ingående dokument). |
| [Item](../../groupdocs.metadata.common/metadatapackage/item) { get; } | Får[`MetadataProperty`](../../groupdocs.metadata.common/metadataproperty) med det angivna namnet. |
| [Keys](../../groupdocs.metadata.common/metadatapackage/keys) { get; } | Hämtar en samling av metadataegenskapsnamnen. |
| [MaxPageSize](../../groupdocs.metadata.standards.xmp.schemes/xmppagedtextpackage/maxpagesize) { get; set; } | Hämtar eller ställer in storleken på den största sidan i dokumentet (inklusive eventuella ingående dokument). |
| [MetadataType](../../groupdocs.metadata.common/metadatapackage/metadatatype) { get; } | Hämtar metadatatypen. |
| [NamespaceUri](../../groupdocs.metadata.standards.xmp/xmppackage/namespaceuri) { get; } | Hämtar namnutrymmets URI. |
| [NumberOfPages](../../groupdocs.metadata.standards.xmp.schemes/xmppagedtextpackage/numberofpages) { get; set; } | Hämtar eller ställer in antalet sidor i dokumentet. |
| [PlateNames](../../groupdocs.metadata.standards.xmp.schemes/xmppagedtextpackage/platenames) { get; set; } | Hämtar eller ställer in en ordnad uppsättning plåtnamn som behövs för att skriva ut dokumentet (inklusive eventuella ingående dokument). |
...
| override [Set](../../groupdocs.metadata.standards.xmp.schemes/xmppagedtextpackage/set#set_7)(string, string) | Anger strängegenskap. |
| override [Set](../../groupdocs.metadata.standards.xmp.schemes/xmppagedtextpackage/set#set_2)(string, XmpArray) | Ställer in värdet som ärvs från[`XmpArray`](../../groupdocs.metadata.standards.xmp/xmparray) . |
