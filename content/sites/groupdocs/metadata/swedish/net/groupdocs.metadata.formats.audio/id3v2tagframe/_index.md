...
description: Representerar en generisk ram i enID3V2Tag./id3v2tag .
type: docs
weight: 500
url: /sv/net/groupdocs.metadata.formats.audio/id3v2tagframe/
---
## ID3V2TagFrame class

Representerar en generisk ram i en[`ID3V2Tag`](../id3v2tag) .
...
| namn | Beskrivning |
| --- | --- |
| [ID3V2TagFrame](id3v2tagframe)(string, byte[]) | Initierar en ny instans av[`ID3V2TagFrame`](../id3v2tagframe) class. |
