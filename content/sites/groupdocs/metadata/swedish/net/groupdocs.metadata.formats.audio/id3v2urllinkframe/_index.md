...
description: Representerar en URLlänkram i enID3V2Tag./id3v2tag Namnet på ramen börjar alltid med tecknet W.
type: docs
weight: 530
url: /sv/net/groupdocs.metadata.formats.audio/id3v2urllinkframe/
---
## ID3V2UrlLinkFrame class

Representerar en URL-länkram i en[`ID3V2Tag`](../id3v2tag) Namnet på ramen börjar alltid med tecknet W.
...
| namn | Beskrivning |
| --- | --- |
| [ID3V2UrlLinkFrame](id3v2urllinkframe)(string, string) | Initierar en ny instans av[`ID3V2UrlLinkFrame`](../id3v2urllinkframe) class. |
...
| [Url](../../groupdocs.metadata.formats.audio/id3v2urllinkframe/url) { get; } | Hämtar URL-värdet. |
