...
description: Representerar metadataklass för anpassad vCardpost.
type: docs
weight: 680
url: /sv/net/groupdocs.metadata.formats.businesscard/vcardcustomrecord/
---
## VCardCustomRecord class

Representerar metadataklass för anpassad vCard-post.
...
| override [ContentType](../../groupdocs.metadata.formats.businesscard/vcardcustomrecord/contenttype) { get; } | Hämtar innehållstypen för posten. |
...
| [Value](../../groupdocs.metadata.formats.businesscard/vcardcustomrecord/value) { get; } | Hämtar rekordvärdet. |
