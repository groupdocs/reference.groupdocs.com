...
description: Representerar metadataklass för binär vCardpost.
type: docs
weight: 630
url: /sv/net/groupdocs.metadata.formats.businesscard/vcardbinaryrecord/
---
## VCardBinaryRecord class

Representerar metadataklass för binär vCard-post.
...
| override [ContentType](../../groupdocs.metadata.formats.businesscard/vcardbinaryrecord/contenttype) { get; } | Hämtar innehållstypen för posten. |
...
| [Value](../../groupdocs.metadata.formats.businesscard/vcardbinaryrecord/value) { get; } | Hämtar rekordvärdet. |
