...
description: Representerar metadataklass för vCard datum och tidpost.
type: docs
weight: 690
url: /sv/net/groupdocs.metadata.formats.businesscard/vcarddatetimerecord/
---
## VCardDateTimeRecord class

Representerar metadataklass för vCard datum och tidpost.
...
| override [ContentType](../../groupdocs.metadata.formats.businesscard/vcarddatetimerecord/contenttype) { get; } | Hämtar innehållstypen för posten. |
...
| [Value](../../groupdocs.metadata.formats.businesscard/vcarddatetimerecord/value) { get; } | Hämtar rekordvärdet. |
