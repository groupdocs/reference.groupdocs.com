...
description: Representerar rotpaketet som är avsett att arbeta med metadata i ett diagram.
type: docs
weight: 900
url: /sv/net/groupdocs.metadata.formats.document/diagramrootpackage/
---
## DiagramRootPackage class

Representerar rotpaketet som är avsett att arbeta med metadata i ett diagram.
...
| [DocumentStatistics](../../groupdocs.metadata.formats.document/diagramrootpackage/documentstatistics) { get; } | Hämtar dokumentstatistikpaketet. |
| [FileType](../../groupdocs.metadata.formats.document/diagramrootpackage/filetype) { get; } | Hämtar filtypens metadatapaket. (2 properties) |
...
Följande kodexempel visar hur man uppdaterar inbyggda metadataegenskaper i ett diagramdokument.
