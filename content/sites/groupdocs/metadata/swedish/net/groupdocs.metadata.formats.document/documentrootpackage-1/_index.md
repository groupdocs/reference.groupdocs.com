...
description: Representerar ett rotpaket för dokumentformat som PDF WordProcessing Spreadsheet Presentation etc.
type: docs
weight: 930
url: /sv/net/groupdocs.metadata.formats.document/documentrootpackage-1/
---
## DocumentRootPackage&lt;TPackage&gt; class

Representerar ett rotpaket för dokumentformat som PDF, WordProcessing, Spreadsheet, Presentation, etc.
...
| --- | --- |
| TPackage | Typen av det inbyggda metadatapaketet. |
