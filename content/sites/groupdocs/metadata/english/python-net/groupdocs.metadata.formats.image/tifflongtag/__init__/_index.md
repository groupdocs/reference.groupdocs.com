---
title: TiffLongTag constructor
second_title: GroupDocs.Metadata for Python via .NET API References
description: 
type: docs
url: /python-net/groupdocs.metadata.formats.image/tifflongtag/__init__/
is_root: false
weight: 10
---
...
Initializes a new instance of the [`TiffLongTag`](/metadata/python-net/groupdocs.metadata.formats.image/tifflongtag) class.
