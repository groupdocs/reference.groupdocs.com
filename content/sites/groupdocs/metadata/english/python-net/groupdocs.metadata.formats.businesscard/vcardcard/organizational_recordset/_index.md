---
title: organizational_recordset property
second_title: GroupDocs.Metadata for Python via .NET API References
description: 
type: docs
url: /python-net/groupdocs.metadata.formats.businesscard/vcardcard/organizational_recordset/
is_root: false
weight: 260
---

## organizational_recordset property
...
```python
@property
def organizational_recordset(self):
    ...
```
