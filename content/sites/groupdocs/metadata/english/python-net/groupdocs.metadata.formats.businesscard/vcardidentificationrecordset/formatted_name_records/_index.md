---
title: formatted_name_records property
second_title: GroupDocs.Metadata for Python via .NET API References
description: 
type: docs
weight: 200
url: /python-net/groupdocs.metadata.formats.businesscard/vcardidentificationrecordset/formatted_name_records/
is_root: false
---

## formatted_name_records property
...
```python
@property
def formatted_name_records(self):
    ...
```
