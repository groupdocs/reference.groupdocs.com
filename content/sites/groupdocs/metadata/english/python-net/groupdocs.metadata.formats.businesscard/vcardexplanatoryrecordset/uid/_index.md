...
This property is a simplified version of [`VCardExplanatoryRecordset.uid_record`](/metadata/python-net/groupdocs.metadata.formats.businesscard/vcardexplanatoryrecordset#uid_record).
### Definition:
```python
@property
def uid(self):
