...
| [__init__](/metadata/python-net/groupdocs.metadata.common/propertyvalue/__init__/#System.String) | Initializes a new instance of the [`PropertyValue`](/metadata/python-net/groupdocs.metadata.common/propertyvalue) class with a string value. |
| [__init__](/metadata/python-net/groupdocs.metadata.common/propertyvalue/__init__/#System.Object) | Initializes a new instance of the [`PropertyValue`](/metadata/python-net/groupdocs.metadata.common/propertyvalue) class with a object value. |
| [__init__](/metadata/python-net/groupdocs.metadata.common/propertyvalue/__init__/#System.DateTime) | Initializes a new instance of the [`PropertyValue`](/metadata/python-net/groupdocs.metadata.common/propertyvalue) class with a DateTime value. |
| [__init__](/metadata/python-net/groupdocs.metadata.common/propertyvalue/__init__/#System.TimeSpan) | Initializes a new instance of the [`PropertyValue`](/metadata/python-net/groupdocs.metadata.common/propertyvalue) class with a TimeSpan value. |
