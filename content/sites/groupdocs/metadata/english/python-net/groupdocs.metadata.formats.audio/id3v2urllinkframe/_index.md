...
| :- | :- |
| [__init__](/metadata/python-net/groupdocs.metadata.formats.audio/id3v2urllinkframe/__init__/#str-str) | Initializes a new instance of the [`ID3V2UrlLinkFrame`](/metadata/python-net/groupdocs.metadata.formats.audio/id3v2urllinkframe) class. |
...
| Method | Description |
| :- | :- |
| [contains](/metadata/python-net/groupdocs.metadata.formats.audio/id3v2urllinkframe/contains/#str) | Determines whether the package contains a metadata property with the specified name. |
