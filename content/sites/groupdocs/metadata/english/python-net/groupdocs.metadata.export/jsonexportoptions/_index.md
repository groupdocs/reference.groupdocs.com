...
| :- | :- |
| [`__init__(self)`](/metadata/python-net/groupdocs.metadata.export/jsonexportoptions/__init__/#) | Initializes a new instance of the [`JsonExportOptions`](/metadata/python-net/groupdocs.metadata.export/jsonexportoptions) class. |
