...
| [__init__](/metadata/python-net/groupdocs.metadata.standards.xmp/xmpcolorantlab/__init__/#int-int-float) | Initializes a new instance of the [`XmpColorantLab`](/metadata/python-net/groupdocs.metadata.standards.xmp/xmpcolorantlab) class. |
...
| Method | Description |
| :- | :- |
| [contains](/metadata/python-net/groupdocs.metadata.standards.xmp/xmpcolorantlab/contains/#System.String) | Determines whether the package contains a metadata property with the specified name. |
...
| [get_namespace_uri](/metadata/python-net/groupdocs.metadata.standards.xmp/xmpcolorantlab/get_namespace_uri/#System.String) | Gets the namespace URI associated with the specified prefix. |
