...
| Method | Description |
| :- | :- |
| [contains](/metadata/python-net/groupdocs.metadata.standards.xmp/xmpresourceevent/contains/#str) | Determines whether the package contains a metadata property with the specified name. |
...
| [get_namespace_uri](/metadata/python-net/groupdocs.metadata.standards.xmp/xmpresourceevent/get_namespace_uri/#str) | Gets the namespace URI associated with the specified prefix. |
