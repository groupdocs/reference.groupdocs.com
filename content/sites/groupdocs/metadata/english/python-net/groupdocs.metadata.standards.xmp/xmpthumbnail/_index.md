...
| Method | Description |
| :- | :- |
| [contains](/metadata/python-net/groupdocs.metadata.standards.xmp/xmpthumbnail/contains/#str) | Determines whether the package contains a metadata property with the specified name. |
...
| [get_namespace_uri](/metadata/python-net/groupdocs.metadata.standards.xmp/xmpthumbnail/get_namespace_uri/#str) | Gets the namespace URI associated with the specified prefix. |
