...
**Inheritance:** [`XmpText`](/metadata/python-net/groupdocs.metadata.standards.xmp/xmptext) → 
...
| :- | :- |
| [type](/metadata/python-net/groupdocs.metadata.standards.xmp/xmptext/type) | Gets the [`MetadataPropertyType`](/metadata/python-net/groupdocs.metadata.common/metadatapropertytype). |
| [raw_value](/metadata/python-net/groupdocs.metadata.standards.xmp/xmptext/raw_value) | Gets the raw value. |
| [value](/metadata/python-net/groupdocs.metadata.standards.xmp/xmptext/value) | Gets the value. |
