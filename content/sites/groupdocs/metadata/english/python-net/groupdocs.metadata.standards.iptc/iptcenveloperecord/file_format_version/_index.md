---
title: file_format_version property
...
A number representing the particular version of the File Format specified in [`IptcEnvelopeRecord.file_format`](/metadata/python-net/groupdocs.metadata.standards.iptc/iptcenveloperecord#file_format).
### Definition:
```python
@property
...
def file_format_version(self, value):
    ...
```
