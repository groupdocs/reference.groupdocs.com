...
| Method | Description |
| :- | :- |
| [set](/metadata/python-net/groupdocs.metadata.formats.document/projectmanagementpackage/set/#System.String-System.String) | Adds or replaces the metadata property with the specified name. |
| [set](/metadata/python-net/groupdocs.metadata.formats.document/projectmanagementpackage/set/#System.String-float) | Adds or replaces the metadata property with the specified name. |
| [set](/metadata/python-net/groupdocs.metadata.formats.document/projectmanagementpackage/set/#System.String-bool) | Adds or replaces the metadata property with the specified name. |
| [set](/metadata/python-net/groupdocs.metadata.formats.document/projectmanagementpackage/set/#System.String-System.DateTime) | Adds or replaces the metadata property with the specified name. |
| [set](/metadata/python-net/groupdocs.metadata.formats.document/projectmanagementpackage/set/#System.String-int) | Adds or replaces the metadata property with the specified name. |
| [contains](/metadata/python-net/groupdocs.metadata.formats.document/projectmanagementpackage/contains/#System.String) | Determines whether the package contains a metadata property with the specified name. |
...
| [remove](/metadata/python-net/groupdocs.metadata.formats.document/projectmanagementpackage/remove/#System.String) | Removes a writable metadata property by the specified name. |
