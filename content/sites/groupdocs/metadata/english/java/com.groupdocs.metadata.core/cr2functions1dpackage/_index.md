...
type: docs
weight: 51
url: /java/com.groupdocs.metadata.core/cr2functions1dpackage/
---
**Inheritance:**
...
```
public final class Cr2Functions1DPackage extends RawDictionaryBasePackage
```
...
```
public final int getFocusingScreen()
```
