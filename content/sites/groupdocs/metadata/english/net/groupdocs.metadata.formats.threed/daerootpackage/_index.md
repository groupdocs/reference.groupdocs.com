---
title: DaeRootPackage
second_title: GroupDocs.Metadata for .NET API Reference
description: Represents .dae file metadata.
type: docs
weight: 3580
url: /net/groupdocs.metadata.formats.threed/daerootpackage/
---
...
```csharp
public class DaeRootPackage : RootMetadataPackage
```
...
| [DaePackage](../../groupdocs.metadata.formats.threed/daerootpackage/daepackage) { get; } | Gets the Dae metadata package. |
