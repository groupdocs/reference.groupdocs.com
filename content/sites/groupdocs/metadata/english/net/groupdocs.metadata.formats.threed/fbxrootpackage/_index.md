---
title: FbxRootPackage
second_title: GroupDocs.Metadata for .NET API Reference
description: Represents .fbx file metadata.
type: docs
weight: 3610
url: /net/groupdocs.metadata.formats.threed/fbxrootpackage/
---
...
```csharp
public class FbxRootPackage : RootMetadataPackage
```
...
| [FbxPackage](../../groupdocs.metadata.formats.threed/fbxrootpackage/fbxpackage) { get; } | Gets the Fbx metadata package. |
