...
type: docs
weight: 2960
url: /net/groupdocs.metadata.formats.raw/cr2lightingoptpackage/
---
...
| Name | Description |
| --- | --- |
| [AutoLightingOptimizer](../../groupdocs.metadata.formats.raw/cr2lightingoptpackage/autolightingoptimizer) { get; } | Gets the AutoLightingOptimizer. |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | Gets the number of metadata properties. |
| [DigitalLensOptimizer](../../groupdocs.metadata.formats.raw/cr2lightingoptpackage/digitallensoptimizer) { get; } | Gets the DigitalLensOptimizer. |
| [HighISONoiseReduction](../../groupdocs.metadata.formats.raw/cr2lightingoptpackage/highisonoisereduction) { get; } | Gets the HighISONoiseReduction. |
| [HighlightTonePriority](../../groupdocs.metadata.formats.raw/cr2lightingoptpackage/highlighttonepriority) { get; } | Gets the HighlightTonePriority. |
...
| [LongExposureNoiseReduction](../../groupdocs.metadata.formats.raw/cr2lightingoptpackage/longexposurenoisereduction) { get; } | Gets the LongExposureNoiseReduction. |
| [MetadataType](../../groupdocs.metadata.common/metadatapackage/metadatatype) { get; } | Gets the metadata type. |
| [PeripheralIlluminationCorr](../../groupdocs.metadata.formats.raw/cr2lightingoptpackage/peripheralilluminationcorr) { get; } | Gets the PeripheralIlluminationCorr. |
| [PropertyDescriptors](../../groupdocs.metadata.common/metadatapackage/propertydescriptors) { get; } | Gets a collection of descriptors that contain information about properties accessible through the GroupDocs.Metadata search engine. |
| [Size](../../groupdocs.metadata.formats.raw/cr2lightingoptpackage/size) { get; set; } | Gets the Size. |
