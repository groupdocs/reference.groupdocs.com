...
type: docs
weight: 3290
url: /net/groupdocs.metadata.formats.raw/rawifd1package/
---
...
```csharp
public sealed class RawIFD1Package : RawDictionaryBasePackage
```
...
| [ThumbnailLenght](../../groupdocs.metadata.formats.raw/rawifd1package/thumbnaillenght) { get; } | Gets the ThumbnailLenght. |
| [ThumbnailOffset](../../groupdocs.metadata.formats.raw/rawifd1package/thumbnailoffset) { get; } | Gets the ThumbnailOffset. |
