...
type: docs
weight: 3140
url: /net/groupdocs.metadata.formats.raw/cr2rootpackage/
---
...
```csharp
public class Cr2RootPackage : RootMetadataPackage
```
...
| [Cr2Package](../../groupdocs.metadata.formats.raw/cr2rootpackage/cr2package) { get; } | Gets the CR2 header metadata package. |
