...
type: docs
weight: 530
url: /net/groupdocs.metadata.formats.archive.rar/rarrootpackage/
---
...
```csharp
public class RarRootPackage : RootMetadataPackage
```
...
| [RarPackage](../../groupdocs.metadata.formats.archive.rar/rarrootpackage/rarpackage) { get; } | Gets the ZIP metadata package. |
