...
description: Represents a generic frame in an ID3V2Tag./id3v2tag.
type: docs
weight: 490
url: /net/groupdocs.metadata.formats.audio/id3v2tagframe/
---
## ID3V2TagFrame class

Represents a generic frame in an [`ID3V2Tag`](../id3v2tag).
...
| Name | Description |
| --- | --- |
| [ID3V2TagFrame](id3v2tagframe)(string, byte[]) | Initializes a new instance of the [`ID3V2TagFrame`](../id3v2tagframe) class. |
