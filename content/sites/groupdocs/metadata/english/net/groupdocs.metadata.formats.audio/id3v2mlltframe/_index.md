...
description: Represents an MLLT frame in an ID3V2Tag./id3v2tag.
type: docs
weight: 600
url: /net/groupdocs.metadata.formats.audio/id3v2mlltframe/
---
## ID3V2MlltFrame class

Represents an MLLT frame in an [`ID3V2Tag`](../id3v2tag).
