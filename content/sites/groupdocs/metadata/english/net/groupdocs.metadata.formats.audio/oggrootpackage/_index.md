...
```csharp
public class OggRootPackage : RootMetadataPackage
```
...
| [OggPackage](../../groupdocs.metadata.formats.audio/oggrootpackage/oggpackage) { get; } | Gets the Ogg native metadata package. |
