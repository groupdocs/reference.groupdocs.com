...
Represents a PCNT frame in an [`ID3V2Tag`](../id3v2tag). This is simply a counter of the number of times a file has been played.
...
| [Value](../../groupdocs.metadata.formats.audio/id3v2playcounterframe/value) { get; } | Gets the number of times the file has been played. |
