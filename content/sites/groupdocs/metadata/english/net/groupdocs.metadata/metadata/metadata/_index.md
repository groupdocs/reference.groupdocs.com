...
| Parameter | Type | Description |
| --- | --- | --- |
| uri | Uri | A uri that contains the document to load. |
...
## Metadata(Uri, LoadOptions) {#constructor_5}

Initializes a new instance of the [`Metadata`](../../metadata) class.

```csharp
public Metadata(Uri uri, LoadOptions loadOptions)
```
