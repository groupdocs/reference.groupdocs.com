...
type: docs
weight: 590
url: /net/groupdocs.metadata.formats.archive.tar/tarrootpackage/
---
...
```csharp
public class TarRootPackage : RootMetadataPackage
```
...
| [TarPackage](../../groupdocs.metadata.formats.archive.tar/tarrootpackage/tarpackage) { get; } | Gets the ZIP metadata package. |
