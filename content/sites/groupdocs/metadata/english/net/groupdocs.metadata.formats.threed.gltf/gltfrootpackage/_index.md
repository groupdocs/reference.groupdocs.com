---
title: GltfRootPackage
second_title: GroupDocs.Metadata for .NET API Reference
description: Represents .glTF file metadata.
type: docs
weight: 3650
url: /net/groupdocs.metadata.formats.threed.gltf/gltfrootpackage/
---
...
```csharp
public class GltfRootPackage : RootMetadataPackage
```
...
| [GltfPackage](../../groupdocs.metadata.formats.threed.gltf/gltfrootpackage/gltfpackage) { get; } | Gets the Gltf metadata package. |
...
{
    var root = metadata.GetRootPackage<GltfPackage>();

    Console.WriteLine(root.Name);

    foreach (var node in root.GltfPackage.Nodes)
    {
