...
| Name | Description |
| --- | --- |
| [XmpThumbnail](xmpthumbnail#constructor)() | Initializes a new instance of the [`XmpThumbnail`](../xmpthumbnail) class. |
| [XmpThumbnail](xmpthumbnail#constructor_1)(int, int) | Initializes a new instance of the [`XmpThumbnail`](../xmpthumbnail) class. |
...
| [Format](../../groupdocs.metadata.standards.xmp/xmpthumbnail/format) { get; set; } | Gets or sets the image format. Defined value: JPEG. |
| [Height](../../groupdocs.metadata.standards.xmp/xmpthumbnail/height) { get; set; } | Gets or sets the image height in pixels. |
| [ImageBase64](../../groupdocs.metadata.standards.xmp/xmpthumbnail/imagebase64) { get; set; } | Gets or sets the full thumbnail image data, converted to base 64 notation. |
| [ImageData](../../groupdocs.metadata.standards.xmp/xmpthumbnail/imagedata) { get; } | Gets the image data. |
...
| [Width](../../groupdocs.metadata.standards.xmp/xmpthumbnail/width) { get; set; } | Gets or sets the image width in pixels. |
