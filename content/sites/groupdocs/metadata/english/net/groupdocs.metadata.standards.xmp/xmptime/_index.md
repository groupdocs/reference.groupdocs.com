...
| Name | Description |
| --- | --- |
| [XmpTime](xmptime#constructor)() | Initializes a new instance of the [`XmpTime`](../xmptime) class. |
| [XmpTime](xmptime#constructor_1)(XmpRational, int) | Initializes a new instance of the [`XmpTime`](../xmptime) class. |
...
| [Scale](../../groupdocs.metadata.standards.xmp/xmptime/scale) { get; set; } | Gets or sets the scale for the time value. |
| [Value](../../groupdocs.metadata.standards.xmp/xmptime/value) { get; set; } | Gets or sets the time value in the specified scale. |
