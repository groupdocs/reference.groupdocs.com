...
| Name | Description |
| --- | --- |
| [XmpColorantRgb](xmpcolorantrgb#constructor)() | Initializes a new instance of the [`XmpColorantRgb`](../xmpcolorantrgb) class. |
| [XmpColorantRgb](xmpcolorantrgb#constructor_1)(byte, byte, byte) | Initializes a new instance of the [`XmpColorantRgb`](../xmpcolorantrgb) class. |

## Properties

| Name | Description |
| --- | --- |
| [Blue](../../groupdocs.metadata.standards.xmp/xmpcolorantrgb/blue) { get; set; } | Gets or sets the blue component. |
...
| [Green](../../groupdocs.metadata.standards.xmp/xmpcolorantrgb/green) { get; set; } | Gets or sets the green value. |
...
| [Red](../../groupdocs.metadata.standards.xmp/xmpcolorantrgb/red) { get; set; } | Gets or sets the red component. |
