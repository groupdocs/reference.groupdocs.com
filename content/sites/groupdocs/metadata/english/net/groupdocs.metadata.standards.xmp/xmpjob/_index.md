...
| Name | Description |
| --- | --- |
| [XmpJob](xmpjob)() | Initializes a new instance of the [`XmpJob`](../xmpjob) class. |
...
| [ID](../../groupdocs.metadata.standards.xmp/xmpjob/id) { get; set; } | Gets or sets unique id for the job. This field is a reference into some external job management system. |
| [Item](../../groupdocs.metadata.common/metadatapackage/item) { get; } | Gets the [`MetadataProperty`](../../groupdocs.metadata.common/metadataproperty) with the specified name. |
| [Keys](../../groupdocs.metadata.common/metadatapackage/keys) { get; } | Gets a collection of the metadata property names. |
| [MetadataType](../../groupdocs.metadata.common/metadatapackage/metadatatype) { get; } | Gets the metadata type. |
| [Name](../../groupdocs.metadata.standards.xmp/xmpjob/name) { get; set; } | Gets or sets informal name of the job. This name is for user display and informal systems. |
...
| [Url](../../groupdocs.metadata.standards.xmp/xmpjob/url) { get; set; } | Gets or sets a file URL referencing an external job management file. |
