...
| Name | Description |
| --- | --- |
| [XmpColorantLab](xmpcolorantlab#constructor)() | Initializes a new instance of the [`XmpColorantLab`](../xmpcolorantlab) class. |
| [XmpColorantLab](xmpcolorantlab#constructor_1)(sbyte, sbyte, double) | Initializes a new instance of the [`XmpColorantLab`](../xmpcolorantlab) class. |

## Properties

| Name | Description |
| --- | --- |
| [A](../../groupdocs.metadata.standards.xmp/xmpcolorantlab/a) { get; set; } | Gets or sets the A component. |
| [B](../../groupdocs.metadata.standards.xmp/xmpcolorantlab/b) { get; set; } | Gets or sets the B component. |
...
| [L](../../groupdocs.metadata.standards.xmp/xmpcolorantlab/l) { get; set; } | Gets or sets the L component. |
...
| Name | Description |
| --- | --- |
| const [MaxL](../../groupdocs.metadata.standards.xmp/xmpcolorantlab/maxl) | Component L max value. |
| const [MinL](../../groupdocs.metadata.standards.xmp/xmpcolorantlab/minl) | Component L min value. |
