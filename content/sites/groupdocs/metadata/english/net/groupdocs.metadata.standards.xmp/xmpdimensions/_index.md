...
| Name | Description |
| --- | --- |
| [XmpDimensions](xmpdimensions#constructor)() | Initializes a new instance of the [`XmpDimensions`](../xmpdimensions) class. |
| [XmpDimensions](xmpdimensions#constructor_1)(double, double) | Initializes a new instance of the [`XmpDimensions`](../xmpdimensions) class. |
...
| [Height](../../groupdocs.metadata.standards.xmp/xmpdimensions/height) { get; set; } | Gets or sets the height. |
...
| [Units](../../groupdocs.metadata.standards.xmp/xmpdimensions/units) { get; set; } | Gets or sets the units. |
| [Width](../../groupdocs.metadata.standards.xmp/xmpdimensions/width) { get; set; } | Gets or sets the width. |
