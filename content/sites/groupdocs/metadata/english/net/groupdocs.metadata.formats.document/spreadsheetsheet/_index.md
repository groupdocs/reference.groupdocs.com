...
| [Name](../../groupdocs.metadata.formats.document/spreadsheetsheet/name) { get; } | Gets the sheet name. |
| [Number](../../groupdocs.metadata.formats.document/spreadsheetsheet/number) { get; } | Gets the sheet number. |
