...
| [DocumentStatistics](../../groupdocs.metadata.formats.document/noterootpackage/documentstatistics) { get; } | Gets the document statistics package. |
| [FileType](../../groupdocs.metadata.common/rootmetadatapackage/filetype) { get; } | Gets the file type metadata package. |
| [InspectionPackage](../../groupdocs.metadata.formats.document/noterootpackage/inspectionpackage) { get; } | Gets a metadata package containing inspection results for the document. The package contains information about document parts that can be considered as metadata in some cases. |
