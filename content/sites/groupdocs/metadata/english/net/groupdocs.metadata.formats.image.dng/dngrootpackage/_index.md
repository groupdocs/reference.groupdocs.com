...
```csharp
public class DngRootPackage : ImageRootPackage
```
...
| [DngPackage](../../groupdocs.metadata.formats.image.dng/dngrootpackage/dngpackage) { get; } | Gets the DNG header metadata package. |
...
* [Working with metadata in DNG images](https://docs.groupdocs.com/display/metadatanet/Working+with+metadata+in+DNG+images)
