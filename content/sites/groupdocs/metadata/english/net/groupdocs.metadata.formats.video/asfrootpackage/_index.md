...
type: docs
weight: 3690
url: /net/groupdocs.metadata.formats.video/asfrootpackage/
---
...
| Name | Description |
| --- | --- |
| [AsfPackage](../../groupdocs.metadata.formats.video/asfrootpackage/asfpackage) { get; } | Gets the ASF metadata package. |
...
| [XmpPackage](../../groupdocs.metadata.formats.video/asfrootpackage/xmppackage) { get; set; } | Gets or sets the XMP metadata package. |
