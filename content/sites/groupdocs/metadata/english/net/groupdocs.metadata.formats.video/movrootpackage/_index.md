...
| [MovPackage](../../groupdocs.metadata.formats.video/movrootpackage/movpackage) { get; } | Gets the QuickTime metadata package. |
| [PropertyDescriptors](../../groupdocs.metadata.common/metadatapackage/propertydescriptors) { get; } | Gets a collection of descriptors that contain information about properties accessible through the GroupDocs.Metadata search engine. |
| [XmpPackage](../../groupdocs.metadata.formats.video/movrootpackage/xmppackage) { get; set; } | Gets or sets the XMP metadata package. |
