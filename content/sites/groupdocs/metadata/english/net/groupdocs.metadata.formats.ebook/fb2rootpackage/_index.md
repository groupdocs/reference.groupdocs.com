...
```csharp
public class Fb2RootPackage : RootMetadataPackage
```
...
| [Fb2Package](../../groupdocs.metadata.formats.ebook/fb2rootpackage/fb2package) { get; } | Gets the Fb2 metadata package. |
