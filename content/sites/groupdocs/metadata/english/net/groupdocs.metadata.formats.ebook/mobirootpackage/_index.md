...
```csharp
public class MobiRootPackage : RootMetadataPackage
```
...
| [MobiPackage](../../groupdocs.metadata.formats.ebook/mobirootpackage/mobipackage) { get; } | Gets the Mobi metadata package. |
