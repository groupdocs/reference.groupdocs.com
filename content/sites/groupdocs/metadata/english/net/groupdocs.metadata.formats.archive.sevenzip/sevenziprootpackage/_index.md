...
type: docs
weight: 560
url: /net/groupdocs.metadata.formats.archive.sevenzip/sevenziprootpackage/
---
...
```csharp
public class SevenZipRootPackage : RootMetadataPackage
```
...
| [SevenZipPackage](../../groupdocs.metadata.formats.archive.sevenzip/sevenziprootpackage/sevenzippackage) { get; } | Gets the ZIP metadata package. |
