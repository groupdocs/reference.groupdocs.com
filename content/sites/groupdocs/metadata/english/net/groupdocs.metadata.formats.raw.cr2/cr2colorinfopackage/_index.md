...
type: docs
weight: 2500
url: /net/groupdocs.metadata.formats.raw.cr2/cr2colorinfopackage/
---
...
```csharp
public sealed class Cr2ColorInfoPackage : RawDictionaryBasePackage
```
...
| Name | Description |
| --- | --- |
| [Cr2ColorInfoPackage](cr2colorinfopackage)() | Initializes a new instance of the [`Cr2ColorInfoPackage`](../cr2colorinfopackage) class. |

## Properties

| Name | Description |
| --- | --- |
| [ColorSpace](../../groupdocs.metadata.formats.raw.cr2/cr2colorinfopackage/colorspace) { get; } | Gets the ColorSpace. |
| [ColorTone](../../groupdocs.metadata.formats.raw.cr2/cr2colorinfopackage/colortone) { get; } | Gets the ColorTone. |
...
| [Saturation](../../groupdocs.metadata.formats.raw.cr2/cr2colorinfopackage/saturation) { get; } | Gets the Saturation. |
