...
| Name | Description |
| --- | --- |
| [AudioBitrate](../../groupdocs.metadata.formats.raw.cr2/cr2movieinfopackage/audiobitrate) { get; } | Gets the AudioBitrate. |
| [AudioChannels](../../groupdocs.metadata.formats.raw.cr2/cr2movieinfopackage/audiochannels) { get; } | Gets the AudioChannels. |
| [AudioSampleRate](../../groupdocs.metadata.formats.raw.cr2/cr2movieinfopackage/audiosamplerate) { get; } | Gets the AudioSampleRate. |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | Gets the number of metadata properties. |
| [Duration](../../groupdocs.metadata.formats.raw.cr2/cr2movieinfopackage/duration) { get; } | Gets the Duration. |
...
| [VideoCodec](../../groupdocs.metadata.formats.raw.cr2/cr2movieinfopackage/videocodec) { get; } | Gets the VideoCodec. |
