...
type: docs
weight: 2920
url: /net/groupdocs.metadata.formats.raw.cr2/cr2timeinfopackage/
---
...
```csharp
public sealed class Cr2TimeInfoPackage : RawDictionaryBasePackage
```
...
| Name | Description |
| --- | --- |
| [Cr2TimeInfoPackage](cr2timeinfopackage)() | Initializes a new instance of the [`Cr2TimeInfoPackage`](../cr2timeinfopackage) class. |
...
| [DaylightSavings](../../groupdocs.metadata.formats.raw.cr2/cr2timeinfopackage/daylightsavings) { get; } | Gets the DaylightSavings. |
...
| [TimeZone](../../groupdocs.metadata.formats.raw.cr2/cr2timeinfopackage/timezone) { get; } | Gets the TimeZone. |
| [TimeZoneCity](../../groupdocs.metadata.formats.raw.cr2/cr2timeinfopackage/timezonecity) { get; } | Gets the TimeZoneCity. |
