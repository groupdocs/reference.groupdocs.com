...
```csharp
public sealed class Cr2PanoramaPackage : RawDictionaryBasePackage
```
...
| Name | Description |
| --- | --- |
| [Cr2PanoramaPackage](cr2panoramapackage)() | Initializes a new instance of the [`Cr2PanoramaPackage`](../cr2panoramapackage) class. |
...
| [PanoramaDirection](../../groupdocs.metadata.formats.raw.cr2/cr2panoramapackage/panoramadirection) { get; } | Gets the PanoramaDirection. |
| [PanoramaFrameNumber](../../groupdocs.metadata.formats.raw.cr2/cr2panoramapackage/panoramaframenumber) { get; } | Gets the PanoramaFrameNumber. |
