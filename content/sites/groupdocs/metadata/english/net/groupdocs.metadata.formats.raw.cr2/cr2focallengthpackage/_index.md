...
type: docs
weight: 2610
url: /net/groupdocs.metadata.formats.raw.cr2/cr2focallengthpackage/
---
...
```csharp
public sealed class Cr2FocalLengthPackage : RawDictionaryBasePackage
```
...
| Name | Description |
| --- | --- |
| [Cr2FocalLengthPackage](cr2focallengthpackage)() | Initializes a new instance of the [`Cr2FocalLengthPackage`](../cr2focallengthpackage) class. |
...
| [FocalLength](../../groupdocs.metadata.formats.raw.cr2/cr2focallengthpackage/focallength) { get; } | Gets the FocalLength. |
| [FocalPlaneXSize](../../groupdocs.metadata.formats.raw.cr2/cr2focallengthpackage/focalplanexsize) { get; } | Gets the FocalPlaneXSize. |
| [FocalPlaneYSize](../../groupdocs.metadata.formats.raw.cr2/cr2focallengthpackage/focalplaneysize) { get; } | Gets the FocalPlaneYSize. |
| [FocalType](../../groupdocs.metadata.formats.raw.cr2/cr2focallengthpackage/focaltype) { get; } | Gets the FocalType. |
