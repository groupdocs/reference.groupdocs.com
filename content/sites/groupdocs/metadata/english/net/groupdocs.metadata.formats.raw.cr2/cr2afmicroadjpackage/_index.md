...
type: docs
weight: 2780
url: /net/groupdocs.metadata.formats.raw.cr2/cr2afmicroadjpackage/
---
...
```csharp
public sealed class Cr2AFMicroAdjPackage : RawDictionaryBasePackage
```
...
| Name | Description |
| --- | --- |
| [Cr2AFMicroAdjPackage](cr2afmicroadjpackage)() | Initializes a new instance of the [`Cr2AFMicroAdjPackage`](../cr2afmicroadjpackage) class. |

## Properties

| Name | Description |
| --- | --- |
| [AFMicroAdjMode](../../groupdocs.metadata.formats.raw.cr2/cr2afmicroadjpackage/afmicroadjmode) { get; } | Gets the AFMicroAdjMode. |
| [AFMicroAdjValue](../../groupdocs.metadata.formats.raw.cr2/cr2afmicroadjpackage/afmicroadjvalue) { get; } | Gets the AFMicroAdjValue. |
