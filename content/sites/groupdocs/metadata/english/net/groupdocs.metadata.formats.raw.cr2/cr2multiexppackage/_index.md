...
type: docs
weight: 2770
url: /net/groupdocs.metadata.formats.raw.cr2/cr2multiexppackage/
---
...
```csharp
public sealed class Cr2MultiExpPackage : RawDictionaryBasePackage
```
...
| Name | Description |
| --- | --- |
| [Cr2MultiExpPackage](cr2multiexppackage)() | Initializes a new instance of the [`Cr2MultiExpPackage`](../cr2multiexppackage) class. |
...
| [MultiExposure](../../groupdocs.metadata.formats.raw.cr2/cr2multiexppackage/multiexposure) { get; } | Gets the MultiExposure. |
| [MultiExposureControl](../../groupdocs.metadata.formats.raw.cr2/cr2multiexppackage/multiexposurecontrol) { get; } | Gets the MultiExposureControl. |
| [MultiExposureShots](../../groupdocs.metadata.formats.raw.cr2/cr2multiexppackage/multiexposureshots) { get; } | Gets the MultiExposureShots. |
