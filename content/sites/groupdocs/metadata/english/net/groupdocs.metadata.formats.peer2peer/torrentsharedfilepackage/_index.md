...
| [Length](../../groupdocs.metadata.formats.peer2peer/torrentsharedfilepackage/length) { get; } | Gets the length of the file in bytes. |
| [MetadataType](../../groupdocs.metadata.common/metadatapackage/metadatatype) { get; } | Gets the metadata type. |
| [Name](../../groupdocs.metadata.formats.peer2peer/torrentsharedfilepackage/name) { get; } | Gets the full name of the file (relative path to the file from the root torrent folder). |
