---
title: StlRootPackage
second_title: GroupDocs.Metadata for .NET API Reference
description: Represents .stl file metadata.
type: docs
weight: 3530
url: /net/groupdocs.metadata.formats.threed.stl/stlrootpackage/
---
...
```csharp
public class StlRootPackage : RootMetadataPackage
```
...
| [StlPackage](../../groupdocs.metadata.formats.threed.stl/stlrootpackage/stlpackage) { get; } | Gets the Stl package package. |
