...
| [Name](../../groupdocs.metadata.formats.threed.stl/stlpackage/name) { get; } | Gets the node name. |
| [Nodes](../../groupdocs.metadata.formats.threed.stl/stlpackage/nodes) { get; } | Gets an array of [`StlNode`](../stlnode) entries inside the 3ds file. |
