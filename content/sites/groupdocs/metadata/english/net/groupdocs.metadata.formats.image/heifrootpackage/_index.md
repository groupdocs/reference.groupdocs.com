...
| [ExifPackage](../../groupdocs.metadata.formats.image/heifrootpackage/exifpackage) { get; set; } | Gets or sets the EXIF metadata package. |
...
| [XmpPackage](../../groupdocs.metadata.formats.image/heifrootpackage/xmppackage) { get; set; } | Gets or sets the XMP metadata package. |
