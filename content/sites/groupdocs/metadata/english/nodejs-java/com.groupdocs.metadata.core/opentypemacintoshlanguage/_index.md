...
type: docs
weight: 387
url: /nodejs-java/com.groupdocs.metadata.core/opentypemacintoshlanguage/
---
**Inheritance:**
...
```
public enum OpenTypeMacintoshLanguage extends Enum<OpenTypeMacintoshLanguage> implements IEnumValue
```
...
### English {#English}
```
public static final OpenTypeMacintoshLanguage English
```
...
**Returns:**
com.groupdocs.metadata.core.OpenTypeMacintoshLanguage[]
### valueOf(String name) {#valueOf-java.lang.String-}
```
public static OpenTypeMacintoshLanguage valueOf(String name)
```
...
**Returns:**
[OpenTypeMacintoshLanguage](../../com.groupdocs.metadata.core/opentypemacintoshlanguage)
### getByRawValue(int rawValue) {#getByRawValue-int-}
```
public static OpenTypeMacintoshLanguage getByRawValue(int rawValue)
```
