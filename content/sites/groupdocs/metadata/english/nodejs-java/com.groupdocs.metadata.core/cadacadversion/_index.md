...
type: docs
weight: 365
url: /nodejs-java/com.groupdocs.metadata.core/cadacadversion/
---
**Inheritance:**
...
```
public enum CadAcadVersion extends Enum<CadAcadVersion> implements IEnumValue
```
...
### None {#None}
```
public static final CadAcadVersion None
```
...
**Returns:**
com.groupdocs.metadata.core.CadAcadVersion[]
### valueOf(String name) {#valueOf-java.lang.String-}
```
public static CadAcadVersion valueOf(String name)
```
...
**Returns:**
[CadAcadVersion](../../com.groupdocs.metadata.core/cadacadversion)
### getByRawValue(int rawValue) {#getByRawValue-int-}
```
public static CadAcadVersion getByRawValue(int rawValue)
```
