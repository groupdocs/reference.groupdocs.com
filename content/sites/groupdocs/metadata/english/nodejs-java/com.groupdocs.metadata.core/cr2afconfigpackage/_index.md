...
type: docs
weight: 40
url: /nodejs-java/com.groupdocs.metadata.core/cr2afconfigpackage/
---
**Inheritance:**
...
```
public final class Cr2AFConfigPackage extends RawDictionaryBasePackage
```
...
```
public final int getAFConfigTool()
```
