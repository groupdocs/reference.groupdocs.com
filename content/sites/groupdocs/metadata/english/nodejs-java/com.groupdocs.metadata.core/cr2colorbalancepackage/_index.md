...
type: docs
weight: 46
url: /nodejs-java/com.groupdocs.metadata.core/cr2colorbalancepackage/
---
**Inheritance:**
...
```
public final class Cr2ColorBalancePackage extends RawDictionaryBasePackage
```
...
```
public final int getWB_RGGBLevelsAuto()
```
