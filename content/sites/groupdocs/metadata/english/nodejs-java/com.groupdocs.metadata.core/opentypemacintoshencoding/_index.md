...
type: docs
weight: 386
url: /nodejs-java/com.groupdocs.metadata.core/opentypemacintoshencoding/
---
**Inheritance:**
...
**Returns:**
com.groupdocs.metadata.core.OpenTypeMacintoshEncoding[]
### valueOf(String name) {#valueOf-java.lang.String-}
```
...
**Returns:**
[OpenTypeMacintoshEncoding](../../com.groupdocs.metadata.core/opentypemacintoshencoding)
### getByRawValue(int rawValue) {#getByRawValue-int-}
```
public static OpenTypeMacintoshEncoding getByRawValue(int rawValue)
```
