...
type: docs
weight: 68
url: /nodejs-java/com.groupdocs.metadata.core/cr2wbinfopackage/
---
**Inheritance:**
...
```
public final class Cr2WBInfoPackage extends RawDictionaryBasePackage
```
...
```
public final int[] getWB_GRBGLevelsAuto()
```
