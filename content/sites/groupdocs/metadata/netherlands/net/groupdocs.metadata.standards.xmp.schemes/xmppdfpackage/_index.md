...
description: Specificeert eigenschappen die worden gebruikt met Adobe PDFdocumenten.
type: docs
weight: 3190
url: /nl/net/groupdocs.metadata.standards.xmp.schemes/xmppdfpackage/
---
## XmpPdfPackage class

Specificeert eigenschappen die worden gebruikt met Adobe PDF-documenten.
...
| Naam | Beschrijving |
| --- | --- |
| [XmpPdfPackage](xmppdfpackage)() | Initialiseert een nieuw exemplaar van het[`XmpPdfPackage`](../xmppdfpackage) klasse. |
...
| [IsTrapped](../../groupdocs.metadata.standards.xmp.schemes/xmppdfpackage/istrapped) { get; set; } | Haalt of stelt een waarde in die aangeeft of het document is overvuld. |
| [Item](../../groupdocs.metadata.common/metadatapackage/item) { get; } | Krijgt de[`MetadataProperty`](../../groupdocs.metadata.common/metadataproperty) met de opgegeven naam. |
| [Keys](../../groupdocs.metadata.common/metadatapackage/keys) { get; } | Haalt een verzameling van de metadata-eigenschapsnamen op. |
| [Keywords](../../groupdocs.metadata.standards.xmp.schemes/xmppdfpackage/keywords) { get; set; } | Haalt of stelt de trefwoorden in. |
| [MetadataType](../../groupdocs.metadata.common/metadatapackage/metadatatype) { get; } | Haalt het metadatatype op. |
| [NamespaceUri](../../groupdocs.metadata.standards.xmp/xmppackage/namespaceuri) { get; } | Haalt de naamruimte-URI op. |
| [PdfVersion](../../groupdocs.metadata.standards.xmp.schemes/xmppdfpackage/pdfversion) { get; set; } | Haalt de versie van het PDF-bestand op of stelt deze in. Bijvoorbeeld 1.0, 1.3 enzovoort. |
| [Prefix](../../groupdocs.metadata.standards.xmp/xmppackage/prefix) { get; } | Haalt het xmlns-voorvoegsel op. |
| [Producer](../../groupdocs.metadata.standards.xmp.schemes/xmppdfpackage/producer) { get; set; } | Haalt of stelt de naam in van de tool die het PDF-document heeft gemaakt. |
...
| override [Set](../../groupdocs.metadata.standards.xmp.schemes/xmppdfpackage/set#set_7)(string, string) | Stelt tekenreekseigenschap in. |
