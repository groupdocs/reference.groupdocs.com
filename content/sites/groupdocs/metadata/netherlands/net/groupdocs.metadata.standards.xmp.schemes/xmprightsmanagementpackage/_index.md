...
description: Vertegenwoordigt XMP Rights Managementnaamruimte.
type: docs
weight: 3220
url: /nl/net/groupdocs.metadata.standards.xmp.schemes/xmprightsmanagementpackage/
---
## XmpRightsManagementPackage class

Vertegenwoordigt XMP Rights Management-naamruimte.
...
| Naam | Beschrijving |
| --- | --- |
| [XmpRightsManagementPackage](xmprightsmanagementpackage)() | Initialiseert een nieuw exemplaar van het[`XmpRightsManagementPackage`](../xmprightsmanagementpackage) klasse. |

## Eigenschappen

| Naam | Beschrijving |
| --- | --- |
| [Certificate](../../groupdocs.metadata.standards.xmp.schemes/xmprightsmanagementpackage/certificate) { get; set; } | Haalt de web-URL voor een rechtenbeheercertificaat op of stelt deze in. |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | Haalt het aantal metadata-eigenschappen op. |
| [Item](../../groupdocs.metadata.common/metadatapackage/item) { get; } | Krijgt de[`MetadataProperty`](../../groupdocs.metadata.common/metadataproperty) met de opgegeven naam. |
| [Keys](../../groupdocs.metadata.common/metadatapackage/keys) { get; } | Haalt een verzameling van de metadata-eigenschapsnamen op. |
| [Marked](../../groupdocs.metadata.standards.xmp.schemes/xmprightsmanagementpackage/marked) { get; set; } | Hiermee wordt een waarde opgehaald of ingesteld die aangeeft of dit een door rechten beheerde bron is. |
| [MetadataType](../../groupdocs.metadata.common/metadatapackage/metadatatype) { get; } | Haalt het metadatatype op. |
| [NamespaceUri](../../groupdocs.metadata.standards.xmp/xmppackage/namespaceuri) { get; } | Haalt de naamruimte-URI op. |
| [Owners](../../groupdocs.metadata.standards.xmp.schemes/xmprightsmanagementpackage/owners) { get; set; } | Krijgt of stelt de wettelijke eigenaren in. |
...
| [UsageTerms](../../groupdocs.metadata.standards.xmp.schemes/xmprightsmanagementpackage/usageterms) { get; set; } | Krijgt of stelt de instructies in over hoe de bron legaal kan worden gebruikt, gegeven in verschillende talen. |
| [WebStatement](../../groupdocs.metadata.standards.xmp.schemes/xmprightsmanagementpackage/webstatement) { get; set; } | Haalt de web-URL op of stelt deze in voor een verklaring van de eigendoms- en gebruiksrechten voor deze bron. |
...
| override [Set](../../groupdocs.metadata.standards.xmp.schemes/xmprightsmanagementpackage/set#set_7)(string, string) | Stelt tekenreekseigenschap in. |
