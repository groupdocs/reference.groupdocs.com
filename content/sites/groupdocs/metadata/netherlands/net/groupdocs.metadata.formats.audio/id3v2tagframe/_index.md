...
description: Vertegenwoordigt een generiek frame in eenID3V2Tag./id3v2tag .
type: docs
weight: 500
url: /nl/net/groupdocs.metadata.formats.audio/id3v2tagframe/
---
## ID3V2TagFrame class

Vertegenwoordigt een generiek frame in een[`ID3V2Tag`](../id3v2tag) .
...
| Naam | Beschrijving |
| --- | --- |
| [ID3V2TagFrame](id3v2tagframe)(string, byte[]) | Initialiseert een nieuw exemplaar van het[`ID3V2TagFrame`](../id3v2tagframe) klasse. |
