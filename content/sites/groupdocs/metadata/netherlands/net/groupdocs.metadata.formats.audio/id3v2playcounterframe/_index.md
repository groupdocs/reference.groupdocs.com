...
description: Vertegenwoordigt een PCNTframe in eenID3V2Tag./id3v2tag . Dit is gewoon een teller van het aantal keren dat een bestand is afgespeeld.
type: docs
weight: 470
url: /nl/net/groupdocs.metadata.formats.audio/id3v2playcounterframe/
---
## ID3V2PlayCounterFrame class

Vertegenwoordigt een PCNT-frame in een[`ID3V2Tag`](../id3v2tag) . Dit is gewoon een teller van het aantal keren dat een bestand is afgespeeld.
...
| [Value](../../groupdocs.metadata.formats.audio/id3v2playcounterframe/value) { get; } | Krijgt het aantal keren dat het bestand is afgespeeld. |
