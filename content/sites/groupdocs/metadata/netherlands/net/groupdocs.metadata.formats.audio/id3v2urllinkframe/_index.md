...
description: Vertegenwoordigt een URLlinkframe in eenID3V2Tag./id3v2tag De naam van het frame begint altijd met het Wteken.
type: docs
weight: 530
url: /nl/net/groupdocs.metadata.formats.audio/id3v2urllinkframe/
---
## ID3V2UrlLinkFrame class

Vertegenwoordigt een URL-linkframe in een[`ID3V2Tag`](../id3v2tag) De naam van het frame begint altijd met het W-teken.
...
| Naam | Beschrijving |
| --- | --- |
| [ID3V2UrlLinkFrame](id3v2urllinkframe)(string, string) | Initialiseert een nieuw exemplaar van het[`ID3V2UrlLinkFrame`](../id3v2urllinkframe) klasse. |
...
| [Url](../../groupdocs.metadata.formats.audio/id3v2urllinkframe/url) { get; } | Haalt de URL-waarde op. |
