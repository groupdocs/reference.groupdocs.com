...
description: Vertegenwoordigt het rootpakket dat het werken met metadata in een CADtekening mogelijk maakt.
type: docs
weight: 850
url: /nl/net/groupdocs.metadata.formats.cad/cadrootpackage/
---
## CadRootPackage class

Vertegenwoordigt het rootpakket dat het werken met metadata in een CAD-tekening mogelijk maakt.
...
| Naam | Beschrijving |
| --- | --- |
| [CadPackage](../../groupdocs.metadata.formats.cad/cadrootpackage/cadpackage) { get; } | Haalt het CAD-metadatapakket op. |
...
Dit codevoorbeeld laat zien hoe metadata van een CAD-tekening gelezen moet worden.
