...
description: Vertegenwoordigt audiometadata in een Matroskavideo.
type: docs
weight: 2430
url: /nl/net/groupdocs.metadata.formats.video/matroskaaudiotrack/
---
## MatroskaAudioTrack class

Vertegenwoordigt audiometadata in een Matroska-video.
...
| Naam | Beschrijving |
| --- | --- |
| [BitDepth](../../groupdocs.metadata.formats.video/matroskaaudiotrack/bitdepth) { get; } | Haalt de bits per sample op, meestal gebruikt voor PCM. |
| [Channels](../../groupdocs.metadata.formats.video/matroskaaudiotrack/channels) { get; } | Haalt het aantal kanalen in de track op. |
...
| [OutputSamplingFrequency](../../groupdocs.metadata.formats.video/matroskaaudiotrack/outputsamplingfrequency) { get; } | Verkrijgt de werkelijke uitgangsbemonsteringsfrequentie in Hz (gebruikt voor SBR-technieken). |
| [PropertyDescriptors](../../groupdocs.metadata.common/metadatapackage/propertydescriptors) { get; } | Haalt een verzameling descriptors op die informatie bevatten over eigenschappen die toegankelijk zijn via de GroupDocs.Metadata-zoekmachine. |
| [SamplingFrequency](../../groupdocs.metadata.formats.video/matroskaaudiotrack/samplingfrequency) { get; } | Krijgt de bemonsteringsfrequentie in Hz. |
