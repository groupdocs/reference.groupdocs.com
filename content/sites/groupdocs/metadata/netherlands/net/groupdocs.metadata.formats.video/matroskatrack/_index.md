...
description: Vertegenwoordigt trackmetadata in een Matroskavideo.
type: docs
weight: 2550
url: /nl/net/groupdocs.metadata.formats.video/matroskatrack/
---
## MatroskaTrack class
...
| [Language](../../groupdocs.metadata.formats.video/matroskatrack/language) { get; } | Krijgt de taal van de track in de Matroska-taalvorm. Dit element MOET worden genegeerd als de[`LanguageIetf`](./languageietf) Element wordt gebruikt in dezelfde TrackEntry. |
| [LanguageIetf](../../groupdocs.metadata.formats.video/matroskatrack/languageietf) { get; } | Haalt de taal van de track op volgens BCP 47 en met behulp van de IANA Language Subtag Registry. Als dit element wordt gebruikt, dan is any[`Language`](./language) Elementen die in dezelfde TrackEntry worden gebruikt, MOETEN worden genegeerd. |
