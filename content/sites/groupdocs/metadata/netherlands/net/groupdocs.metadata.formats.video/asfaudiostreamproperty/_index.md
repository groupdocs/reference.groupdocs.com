...
description: Vertegenwoordigt de metadata van audiostreameigenschappen in de ASFmediacontainer.
type: docs
weight: 2230
url: /nl/net/groupdocs.metadata.formats.video/asfaudiostreamproperty/
---
## AsfAudioStreamProperty class

Vertegenwoordigt de metadata van audiostreameigenschappen in de ASF-mediacontainer.
...
| [BitsPerSample](../../groupdocs.metadata.formats.video/asfaudiostreamproperty/bitspersample) { get; } | Krijgt het aantal bits per monster van monogegevens. |
| [Channels](../../groupdocs.metadata.formats.video/asfaudiostreamproperty/channels) { get; } | Haalt het aantal audiokanalen op. |
...
| [FormatTag](../../groupdocs.metadata.formats.video/asfaudiostreamproperty/formattag) { get; } | Haalt de unieke ID op van de codec die is gebruikt om de audiogegevens te coderen. |
...
| [SamplesPerSecond](../../groupdocs.metadata.formats.video/asfaudiostreamproperty/samplespersecond) { get; } | Krijgt een waarde in Hertz (cycli per seconde) die de bemonsteringsfrequentie van de audiostream vertegenwoordigt. |
