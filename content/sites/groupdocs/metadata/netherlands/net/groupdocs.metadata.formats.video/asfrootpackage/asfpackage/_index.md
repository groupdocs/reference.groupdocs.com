...
description: Haalt het ASFmetadatapakket op.
type: docs
weight: 10
url: /nl/net/groupdocs.metadata.formats.video/asfrootpackage/asfpackage/
---
## AsfRootPackage.AsfPackage property

Haalt het ASF-metadatapakket op.
...
Dit codevoorbeeld demonstreert hoe native ASF-metadata moeten worden gelezen.
...
using (Metadata metadata = new Metadata(Constants.InputAsf))
{
    ...
    // Geef Asf Codec-informatie weer
    ...
    //Geef de eigenschappen van de basisstream weer
    foreach (AsfBaseStreamProperty property in package.StreamProperties)
    {
        ...
        //Geef de eigenschappen van de audiostream weer
        ...
        //Geef de eigenschappen van de videostream weer
...
* naamruimte [GroupDocs.Metadata.Formats.Video](../../asfrootpackage)
