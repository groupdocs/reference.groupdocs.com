...
description: Vertegenwoordigt het rootpakket dat het werken met metadata in een ASFvideo mogelijk maakt.
type: docs
weight: 2350
url: /nl/net/groupdocs.metadata.formats.video/asfrootpackage/
---
## AsfRootPackage class

Vertegenwoordigt het rootpakket dat het werken met metadata in een ASF-video mogelijk maakt.
...
| Naam | Beschrijving |
| --- | --- |
| [AsfPackage](../../groupdocs.metadata.formats.video/asfrootpackage/asfpackage) { get; } | Haalt het ASF-metadatapakket op. |
...
| [XmpPackage](../../groupdocs.metadata.formats.video/asfrootpackage/xmppackage) { get; set; } | Haalt het XMP-metadatapakket op of stelt het in. |
