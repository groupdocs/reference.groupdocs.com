...
description: Haalt het Matroskametadatapakket op.
type: docs
weight: 10
url: /nl/net/groupdocs.metadata.formats.video/matroskarootpackage/matroskapackage/
---
## MatroskaRootPackage.MatroskaPackage property

Haalt het Matroska-metadatapakket op.
...
Dit voorbeeld laat zien hoe u Matroska formaatspecifieke metadata-eigenschappen kunt lezen.
...
using (Metadata metadata = new Metadata(Constants.InputMkv))
{
    ...
    // Lees Matroska-segmentinformatie
    ...
    // Lees de metadata van de Matroska-tag
    ...
    // Lees de metadata van Matroska-tracks
...
* naamruimte [GroupDocs.Metadata.Formats.Video](../../matroskarootpackage)
