...
description: Vertegenwoordigt het rootpakket dat het werken met metadata in een QuickTimevideo mogelijk maakt.
type: docs
weight: 2640
url: /nl/net/groupdocs.metadata.formats.video/movrootpackage/
---
## MovRootPackage class

Vertegenwoordigt het rootpakket dat het werken met metadata in een QuickTime-video mogelijk maakt.
...
| [MovPackage](../../groupdocs.metadata.formats.video/movrootpackage/movpackage) { get; } | Haalt het QuickTime-metadatapakket op. |
| [PropertyDescriptors](../../groupdocs.metadata.common/metadatapackage/propertydescriptors) { get; } | Haalt een verzameling descriptors op die informatie bevatten over eigenschappen die toegankelijk zijn via de GroupDocs.Metadata-zoekmachine. |
| [XmpPackage](../../groupdocs.metadata.formats.video/movrootpackage/xmppackage) { get; set; } | Haalt het XMP-metadatapakket op of stelt het in. |
...
Dit voorbeeld laat zien hoe je QuickTime-atomen leest in een MOV-video.
