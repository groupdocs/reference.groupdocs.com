...
description: Vertegenwoordigt het rootpakket dat bedoeld is om te werken met metadata in een DjVuimage.
type: docs
weight: 1690
url: /nl/net/groupdocs.metadata.formats.image/djvurootpackage/
---
## DjVuRootPackage class

Vertegenwoordigt het rootpakket dat bedoeld is om te werken met metadata in een DjVu-image.
