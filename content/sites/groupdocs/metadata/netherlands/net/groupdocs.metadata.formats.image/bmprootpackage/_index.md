...
description: Vertegenwoordigt het rootpakket dat bedoeld is om te werken met metagegevens in een BMPafbeelding.
type: docs
weight: 1660
url: /nl/net/groupdocs.metadata.formats.image/bmprootpackage/
---
## BmpRootPackage class

Vertegenwoordigt het rootpakket dat bedoeld is om te werken met metagegevens in een BMP-afbeelding.
...
| Naam | Beschrijving |
| --- | --- |
| [BmpHeader](../../groupdocs.metadata.formats.image/bmprootpackage/bmpheader) { get; } | Haalt het metadatapakket van de BMP-header op. |
...
Dit codevoorbeeld laat zien hoe de header van een BMP-bestand moet worden gelezen.
