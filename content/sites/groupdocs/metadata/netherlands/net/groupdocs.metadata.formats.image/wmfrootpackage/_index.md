...
description: Vertegenwoordigt het hoofdpakket dat bedoeld is om te werken met metadata in een WMFimage.
type: docs
weight: 2140
url: /nl/net/groupdocs.metadata.formats.image/wmfrootpackage/
---
## WmfRootPackage class

Vertegenwoordigt het hoofdpakket dat bedoeld is om te werken met metadata in een WMF-image.
