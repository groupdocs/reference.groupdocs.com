...
description: Vertegenwoordigt het rootpakket dat bedoeld is om te werken met metagegevens in een HEIFafbeelding.
type: docs
weight: 1730
url: /nl/net/groupdocs.metadata.formats.image/heifrootpackage/
---
## HeifRootPackage class

Vertegenwoordigt het rootpakket dat bedoeld is om te werken met metagegevens in een HEIF-afbeelding.
...
| [ExifPackage](../../groupdocs.metadata.formats.image/heifrootpackage/exifpackage) { get; set; } | Haalt het EXIF-metadatapakket op of stelt het in. |
...
| [XmpPackage](../../groupdocs.metadata.formats.image/heifrootpackage/xmppackage) { get; set; } | Haalt het XMP-metadatapakket op of stelt het in. |
