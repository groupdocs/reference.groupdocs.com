...
description: Vertegenwoordigt het rootpakket dat het werken met metadata in een WEBPimage mogelijk maakt.
type: docs
weight: 2130
url: /nl/net/groupdocs.metadata.formats.image/webprootpackage/
---
## WebPRootPackage class

Vertegenwoordigt het rootpakket dat het werken met metadata in een WEBP-image mogelijk maakt.
...
| [ExifPackage](../../groupdocs.metadata.formats.image/webprootpackage/exifpackage) { get; set; } | Haalt het EXIF-metadatapakket op of stelt het in. |
...
| [XmpPackage](../../groupdocs.metadata.formats.image/webprootpackage/xmppackage) { get; set; } | Haalt het XMP-metadatapakket op of stelt het in. |
