...
description: Vertegenwoordigt het rootpakket waarmee met metagegevens in een Photoshopdocument kan worden gewerkt.
type: docs
weight: 1930
url: /nl/net/groupdocs.metadata.formats.image/psdrootpackage/
---
## PsdRootPackage class

Vertegenwoordigt het rootpakket waarmee met metagegevens in een Photoshop-document kan worden gewerkt.
...
| [ExifPackage](../../groupdocs.metadata.formats.image/psdrootpackage/exifpackage) { get; set; } | Haalt het EXIF-metadatapakket op of stelt het in. |
...
| [ImageResourcePackage](../../groupdocs.metadata.formats.image/psdrootpackage/imageresourcepackage) { get; } | Krijgt het Photoshop Image Resource-metadatapakket. Afbeeldingsresourceblokken zijn de basisbouweenheid van de native bestandsindeling van Photoshop. |
| [IptcPackage](../../groupdocs.metadata.formats.image/psdrootpackage/iptcpackage) { get; set; } | Haalt het IPTC-metadatapakket op of stelt het in. |
| [Item](../../groupdocs.metadata.common/metadatapackage/item) { get; } | Krijgt de[`MetadataProperty`](../../groupdocs.metadata.common/metadataproperty) met de opgegeven naam. |
| [Keys](../../groupdocs.metadata.common/metadatapackage/keys) { get; } | Haalt een verzameling van de metadata-eigenschapsnamen op. |
| [MetadataType](../../groupdocs.metadata.common/metadatapackage/metadatatype) { get; } | Haalt het metadatatype op. |
| [PropertyDescriptors](../../groupdocs.metadata.common/metadatapackage/propertydescriptors) { get; } | Haalt een verzameling descriptors op die informatie bevatten over eigenschappen die toegankelijk zijn via de GroupDocs.Metadata-zoekmachine. |
| [PsdPackage](../../groupdocs.metadata.formats.image/psdrootpackage/psdpackage) { get; } | Haalt het metadatapakket op met informatie over het PSD-bestand. |
| [XmpPackage](../../groupdocs.metadata.formats.image/psdrootpackage/xmppackage) { get; set; } | Haalt het XMP-metadatapakket op of stelt het in. |
