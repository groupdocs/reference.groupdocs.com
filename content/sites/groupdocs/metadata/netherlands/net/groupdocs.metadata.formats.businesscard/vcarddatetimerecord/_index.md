...
description: Vertegenwoordigt vCard datum tijd record metadata klasse.
type: docs
weight: 690
url: /nl/net/groupdocs.metadata.formats.businesscard/vcarddatetimerecord/
---
## VCardDateTimeRecord class

Vertegenwoordigt vCard datum tijd record metadata klasse.
...
| override [ContentType](../../groupdocs.metadata.formats.businesscard/vcarddatetimerecord/contenttype) { get; } | Haalt het inhoudstype van record op. |
...
| [Value](../../groupdocs.metadata.formats.businesscard/vcarddatetimerecord/value) { get; } | Haalt de recordwaarde op. |
