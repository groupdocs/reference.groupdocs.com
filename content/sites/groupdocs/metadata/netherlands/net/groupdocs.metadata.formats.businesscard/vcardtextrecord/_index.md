...
description: Vertegenwoordigt de metadataklasse van vCardtekstrecords.
type: docs
weight: 810
url: /nl/net/groupdocs.metadata.formats.businesscard/vcardtextrecord/
---
## VCardTextRecord class

Vertegenwoordigt de metadataklasse van vCard-tekstrecords.
...
| [CharsetParameter](../../groupdocs.metadata.formats.businesscard/vcardtextrecord/charsetparameter) { get; } | Haalt de tekensetparameter op. |
| override [ContentType](../../groupdocs.metadata.formats.businesscard/vcardtextrecord/contenttype) { get; } | Haalt het inhoudstype van record op. |
...
| [IsQuotedPrintable](../../groupdocs.metadata.formats.businesscard/vcardtextrecord/isquotedprintable) { get; } | Krijgt een waarde die aangeeft of deze instantie een afdrukbare tekenreeks tussen aanhalingstekens is. |
...
| [MediaTypeParameter](../../groupdocs.metadata.formats.businesscard/vcardtextrecord/mediatypeparameter) { get; } | Haalt de parameterwaarde van het mediatype op. |
...
| [Value](../../groupdocs.metadata.formats.businesscard/vcardtextrecord/value) { get; } | Haalt de recordwaarde op. |
...
| [GetReadabilityValue](../../groupdocs.metadata.formats.businesscard/vcardtextrecord/getreadabilityvalue)(string) | Haalt de leesbaarheidswaarde op. |
