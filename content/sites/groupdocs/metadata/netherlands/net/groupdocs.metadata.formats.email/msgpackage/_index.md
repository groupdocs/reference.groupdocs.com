...
description: Vertegenwoordigt MSGberichtmetadata.
type: docs
weight: 1400
url: /nl/net/groupdocs.metadata.formats.email/msgpackage/
---
## MsgPackage class

Vertegenwoordigt MSG-berichtmetadata.
...
| [Body](../../groupdocs.metadata.formats.email/msgpackage/body) { get; } | Krijgt de tekst van het e-mailbericht. |
...
| [Categories](../../groupdocs.metadata.formats.email/msgpackage/categories) { get; } | Haalt de reeks categorieën of trefwoorden op. |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | Haalt het aantal metadata-eigenschappen op. |
| [DeliveryTime](../../groupdocs.metadata.formats.email/msgpackage/deliverytime) { get; } | Haalt de datum en tijd op waarop het bericht is bezorgd. |
