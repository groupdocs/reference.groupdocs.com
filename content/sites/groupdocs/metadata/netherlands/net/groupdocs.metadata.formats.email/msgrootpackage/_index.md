...
description: Vertegenwoordigt het rootpakket dat het werken met metadata in een MSGemailbericht mogelijk maakt.
type: docs
weight: 1410
url: /nl/net/groupdocs.metadata.formats.email/msgrootpackage/
---
## MsgRootPackage class

Vertegenwoordigt het rootpakket dat het werken met metadata in een MSG-e-mailbericht mogelijk maakt.
...
| [EmailPackage](../../groupdocs.metadata.formats.email/msgrootpackage/emailpackage) { get; } | Haalt het MSG-metadatapakket op. (2 properties) |
...
Dit codevoorbeeld laat zien hoe metagegevens uit een MSG-bericht kunnen worden geëxtraheerd.
