...
description: Vertegenwoordigt XMP Real.
type: docs
weight: 3520
url: /nl/net/groupdocs.metadata.standards.xmp/xmpreal/
---
## XmpReal class

Vertegenwoordigt XMP Real.
...
| Naam | Beschrijving |
| --- | --- |
| [XmpReal](xmpreal#constructor)(double) | Initialiseert een nieuw exemplaar van het[`XmpReal`](../xmpreal) klasse. |
| [XmpReal](xmpreal#constructor_1)(string) | Initialiseert een nieuw exemplaar van het[`XmpReal`](../xmpreal) klasse. |
...
| [Value](../../groupdocs.metadata.standards.xmp/xmpreal/value) { get; } | Krijgt de waarde. |
...
| override [GetXmpRepresentation](../../groupdocs.metadata.standards.xmp/xmpreal/getxmprepresentation)() | Retourneert een tekenreeks die een waarde bevat in XMP-indeling. |
