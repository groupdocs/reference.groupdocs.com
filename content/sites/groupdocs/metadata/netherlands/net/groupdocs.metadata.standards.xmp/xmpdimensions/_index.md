...
type: docs
weight: 3380
url: /nl/net/groupdocs.metadata.standards.xmp/xmpdimensions/
---
## XmpDimensions class
...
| Naam | Beschrijving |
| --- | --- |
| [XmpDimensions](xmpdimensions#constructor)() | Initialiseert een nieuw exemplaar van het[`XmpDimensions`](../xmpdimensions) klasse. |
| [XmpDimensions](xmpdimensions#constructor_1)(double, double) | Initialiseert een nieuw exemplaar van het[`XmpDimensions`](../xmpdimensions) klasse. |
...
| [Height](../../groupdocs.metadata.standards.xmp/xmpdimensions/height) { get; set; } | Haalt of stelt de hoogte in. |
...
| [Units](../../groupdocs.metadata.standards.xmp/xmpdimensions/units) { get; set; } | Haalt of stelt de eenheden in. |
| [Width](../../groupdocs.metadata.standards.xmp/xmpdimensions/width) { get; set; } | Haalt of stelt de breedte in. |
