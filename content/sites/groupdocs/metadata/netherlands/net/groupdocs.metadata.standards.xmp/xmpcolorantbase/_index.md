...
description: Een structuur die de kenmerken bevat van een kleurstof staal die in een document wordt gebruikt.
type: docs
weight: 3300
url: /nl/net/groupdocs.metadata.standards.xmp/xmpcolorantbase/
---
## XmpColorantBase class

Een structuur die de kenmerken bevat van een kleurstof (staal) die in een document wordt gebruikt.
