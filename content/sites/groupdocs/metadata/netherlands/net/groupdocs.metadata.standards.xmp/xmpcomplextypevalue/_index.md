...
description: Vertegenwoordigt een XMPwaarde die een instantie van een complex type bevat.
type: docs
weight: 3360
url: /nl/net/groupdocs.metadata.standards.xmp/xmpcomplextypevalue/
---
## XmpComplexTypeValue class

Vertegenwoordigt een XMP-waarde die een instantie van een complex type bevat.
...
| override [GetXmpRepresentation](../../groupdocs.metadata.standards.xmp/xmpcomplextypevalue/getxmprepresentation)() | Retourneert een tekenreeks die een waarde bevat in XMP-indeling. |
