...
description: Stellt das Stammpaket dar das mit Metadaten in einer elektronischen Notizdatei arbeiten soll.
type: docs
weight: 970
url: /de/net/groupdocs.metadata.formats.document/noterootpackage/
---
## NoteRootPackage class

Stellt das Stammpaket dar, das mit Metadaten in einer elektronischen Notizdatei arbeiten soll.
...
| [DocumentStatistics](../../groupdocs.metadata.formats.document/noterootpackage/documentstatistics) { get; } | Ruft das Dokumentstatistikpaket ab. |
| [FileType](../../groupdocs.metadata.common/rootmetadatapackage/filetype) { get; } | Ruft das Dateityp-Metadatenpaket ab. |
| [InspectionPackage](../../groupdocs.metadata.formats.document/noterootpackage/inspectionpackage) { get; } | Ruft ein Metadatenpaket ab, das Inspektionsergebnisse für das Dokument enthält. Das Paket enthält Informationen zu Dokumententeilen, die in einigen Fällen als Metadaten betrachtet werden können. |
...
Dieses Codebeispiel zeigt, wie ein Notizdokument untersucht wird.
