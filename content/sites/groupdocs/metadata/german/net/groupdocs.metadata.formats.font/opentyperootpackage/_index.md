...
description: Stellt das Stammpaket dar das die Arbeit mit Metadaten in einer OpenTypeSchriftartdatei ermöglicht.
type: docs
weight: 1550
url: /de/net/groupdocs.metadata.formats.font/opentyperootpackage/
---
## OpenTypeRootPackage class

Stellt das Stammpaket dar, das die Arbeit mit Metadaten in einer OpenType-Schriftartdatei ermöglicht.
...
| [DigitalSignaturePackage](../../groupdocs.metadata.formats.font/opentyperootpackage/digitalsignaturepackage) { get; } | Ruft das Metadatenpaket der digitalen Signatur ab. |
...
| [OpenTypePackage](../../groupdocs.metadata.formats.font/opentyperootpackage/opentypepackage) { get; } | Ruft das OpenType-Metadatenpaket ab. |
