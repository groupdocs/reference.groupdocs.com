...
description: Ruft das Metadatenpaket der digitalen Signatur ab.
type: docs
weight: 10
url: /de/net/groupdocs.metadata.formats.font/opentyperootpackage/digitalsignaturepackage/
---
## OpenTypeRootPackage.DigitalSignaturePackage property

Ruft das Metadatenpaket der digitalen Signatur ab.
...
Das Metadatenpaket für digitale Signaturen.
...
Dieses Code-Snippet zeigt, wie digitale Signaturen extrahiert werden, die einer OpenType-Schriftart zugeordnet sind.
...
{
    // Eigenschaftsnamen und Wert von OID anzeigen
    if (oid != null)
    {
...
{
    //CmsAttributes einer OID anzeigen
    if (attributes != null)
    {
