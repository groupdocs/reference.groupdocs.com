...
| [AgesOfModels](../../groupdocs.metadata.standards.xmp.schemes/xmpiptcextensionpackage/agesofmodels) { get; set; } | Ruft das Alter der menschlichen Modelle ab oder legt es fest, als dieses Bild in einem von einem Modell veröffentlichten Bild aufgenommen wurde. |
