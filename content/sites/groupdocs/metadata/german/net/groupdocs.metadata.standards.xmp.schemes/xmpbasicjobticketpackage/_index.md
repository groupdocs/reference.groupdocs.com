...
description: Repräsentiert den BasisJobTicketNamensraum.
type: docs
weight: 3080
url: /de/net/groupdocs.metadata.standards.xmp.schemes/xmpbasicjobticketpackage/
---
## XmpBasicJobTicketPackage class

Repräsentiert den Basis-Job-Ticket-Namensraum.
...
| Name | Beschreibung |
| --- | --- |
| [XmpBasicJobTicketPackage](xmpbasicjobticketpackage)() | Initialisiert eine neue Instanz von[`XmpBasicJobTicketPackage`](../xmpbasicjobticketpackage) Klasse. |
...
| [Jobs](../../groupdocs.metadata.standards.xmp.schemes/xmpbasicjobticketpackage/jobs) { get; set; } | Ruft die Jobs ab oder legt sie fest. |
