...
description: Repräsentiert die benutzerdefinierte vCardDatensatzMetadatenklasse.
type: docs
weight: 680
url: /de/net/groupdocs.metadata.formats.businesscard/vcardcustomrecord/
---
## VCardCustomRecord class

Repräsentiert die benutzerdefinierte vCard-Datensatz-Metadatenklasse.
...
| override [ContentType](../../groupdocs.metadata.formats.businesscard/vcardcustomrecord/contenttype) { get; } | Ruft den Inhaltstyp des Datensatzes ab. |
...
| [Value](../../groupdocs.metadata.formats.businesscard/vcardcustomrecord/value) { get; } | Ruft den Datensatzwert ab. |
