...
description: Stellt das RootPaket dar das die Arbeit mit Metadaten in einer VCardDatei ermöglicht.
type: docs
weight: 790
url: /de/net/groupdocs.metadata.formats.businesscard/vcardrootpackage/
---
## VCardRootPackage class

Stellt das Root-Paket dar, das die Arbeit mit Metadaten in einer VCard-Datei ermöglicht.
...
| [VCardPackage](../../groupdocs.metadata.formats.businesscard/vcardrootpackage/vcardpackage) { get; } | Ruft das VCard-Metadatenpaket ab. |
...
Dieses Codebeispiel zeigt, wie Metadateneigenschaften einer vCard-Datei gelesen werden.
