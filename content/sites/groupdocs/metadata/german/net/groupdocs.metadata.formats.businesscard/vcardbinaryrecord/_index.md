...
description: Stellt die Metadatenklasse für vCardBinärdatensätze dar.
type: docs
weight: 630
url: /de/net/groupdocs.metadata.formats.businesscard/vcardbinaryrecord/
---
## VCardBinaryRecord class

Stellt die Metadatenklasse für vCard-Binärdatensätze dar.
...
| override [ContentType](../../groupdocs.metadata.formats.businesscard/vcardbinaryrecord/contenttype) { get; } | Ruft den Inhaltstyp des Datensatzes ab. |
...
| [Value](../../groupdocs.metadata.formats.businesscard/vcardbinaryrecord/value) { get; } | Ruft den Datensatzwert ab. |
