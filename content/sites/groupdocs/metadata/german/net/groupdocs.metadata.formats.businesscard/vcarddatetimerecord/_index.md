...
description: Repräsentiert die vCardMetadatenklasse für Datum und Uhrzeit.
type: docs
weight: 690
url: /de/net/groupdocs.metadata.formats.businesscard/vcarddatetimerecord/
---
## VCardDateTimeRecord class

Repräsentiert die vCard-Metadatenklasse für Datum und Uhrzeit.
...
| override [ContentType](../../groupdocs.metadata.formats.businesscard/vcarddatetimerecord/contenttype) { get; } | Ruft den Inhaltstyp des Datensatzes ab. |
...
| [Value](../../groupdocs.metadata.formats.businesscard/vcarddatetimerecord/value) { get; } | Ruft den Datensatzwert ab. |
