...
description: Repräsentiert TrackMetadaten in einem MatroskaVideo.
type: docs
weight: 2550
url: /de/net/groupdocs.metadata.formats.video/matroskatrack/
---
## MatroskaTrack class

Repräsentiert Track-Metadaten in einem Matroska-Video.
...
| [Language](../../groupdocs.metadata.formats.video/matroskatrack/language) { get; } | Ruft die Sprache des Tracks im Matroska-Sprachenformat ab. Dieses Element MUSS ignoriert werden, wenn die[`LanguageIetf`](./languageietf) Element wird im selben TrackEntry verwendet. |
| [LanguageIetf](../../groupdocs.metadata.formats.video/matroskatrack/languageietf) { get; } | Ruft die Sprache des Tracks gemäß BCP 47 und unter Verwendung der IANA Language Subtag Registry ab. Wenn dieses Element verwendet wird, dann beliebig[`Language`](./language) Elemente, die im selben TrackEntry verwendet werden, MÜSSEN ignoriert werden. |
