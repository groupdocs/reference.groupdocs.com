...
description: Stellt das RootPaket dar das die Arbeit mit Metadaten in einem ASFVideo ermöglicht.
type: docs
weight: 2350
url: /de/net/groupdocs.metadata.formats.video/asfrootpackage/
---
## AsfRootPackage class

Stellt das Root-Paket dar, das die Arbeit mit Metadaten in einem ASF-Video ermöglicht.
...
| Name | Beschreibung |
| --- | --- |
| [AsfPackage](../../groupdocs.metadata.formats.video/asfrootpackage/asfpackage) { get; } | Ruft das ASF-Metadatenpaket ab. |
...
| [XmpPackage](../../groupdocs.metadata.formats.video/asfrootpackage/xmppackage) { get; set; } | Ruft das XMP-Metadatenpaket ab oder legt es fest. |
