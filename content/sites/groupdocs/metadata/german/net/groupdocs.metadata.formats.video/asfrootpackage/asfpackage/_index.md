...
description: Ruft das ASFMetadatenpaket ab.
type: docs
weight: 10
url: /de/net/groupdocs.metadata.formats.video/asfrootpackage/asfpackage/
---
## AsfRootPackage.AsfPackage property

Ruft das ASF-Metadatenpaket ab.
...
Dieses Codebeispiel zeigt, wie native ASF-Metadaten gelesen werden.
...
using (Metadata metadata = new Metadata(Constants.InputAsf))
{
    ...
    // Asf-Codec-Informationen anzeigen
    ...
    // Metadatendeskriptoren anzeigen
    ...
    //Zeige die Basis-Stream-Eigenschaften an
    foreach (AsfBaseStreamProperty property in package.StreamProperties)
    {
        ...
        //Eigenschaften des Audiostreams anzeigen
        ...
        //Eigenschaften des Videostreams anzeigen
...
* namensraum [GroupDocs.Metadata.Formats.Video](../../asfrootpackage)
