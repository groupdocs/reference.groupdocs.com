...
description: Stellt das RootPaket dar das die Arbeit mit Metadaten in einem AVIVideo ermöglicht.
type: docs
weight: 2400
url: /de/net/groupdocs.metadata.formats.video/avirootpackage/
---
## AviRootPackage class

Stellt das Root-Paket dar, das die Arbeit mit Metadaten in einem AVI-Video ermöglicht.
...
| [Header](../../groupdocs.metadata.formats.video/avirootpackage/header) { get; } | Ruft das AVI-Header-Paket ab. |
| [Item](../../groupdocs.metadata.common/metadatapackage/item) { get; } | Ruft die ab[`MetadataProperty`](../../groupdocs.metadata.common/metadataproperty) mit dem angegebenen Namen. |
| [Keys](../../groupdocs.metadata.common/metadatapackage/keys) { get; } | Ruft eine Sammlung der Metadaten-Eigenschaftsnamen ab. |
| [MetadataType](../../groupdocs.metadata.common/metadatapackage/metadatatype) { get; } | Ruft den Metadatentyp ab. |
| [PropertyDescriptors](../../groupdocs.metadata.common/metadatapackage/propertydescriptors) { get; } | Ruft eine Sammlung von Deskriptoren ab, die Informationen zu Eigenschaften enthalten, auf die über die Suchmaschine GroupDocs.Metadata zugegriffen werden kann. |
| [RiffInfoPackage](../../groupdocs.metadata.formats.video/avirootpackage/riffinfopackage) { get; } | Ruft das Paket ab, das RIFF-Info-Tags enthält. |
| [XmpPackage](../../groupdocs.metadata.formats.video/avirootpackage/xmppackage) { get; set; } | Ruft das XMP-Metadatenpaket ab oder legt es fest. |
