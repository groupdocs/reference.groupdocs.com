...
description: Stellt das RootPaket dar das die Arbeit mit Metadaten in einem QuickTimeVideo ermöglicht.
type: docs
weight: 2640
url: /de/net/groupdocs.metadata.formats.video/movrootpackage/
---
## MovRootPackage class

Stellt das Root-Paket dar, das die Arbeit mit Metadaten in einem QuickTime-Video ermöglicht.
...
| [MovPackage](../../groupdocs.metadata.formats.video/movrootpackage/movpackage) { get; } | Ruft das QuickTime-Metadatenpaket ab. |
| [PropertyDescriptors](../../groupdocs.metadata.common/metadatapackage/propertydescriptors) { get; } | Ruft eine Sammlung von Deskriptoren ab, die Informationen zu Eigenschaften enthalten, auf die über die Suchmaschine GroupDocs.Metadata zugegriffen werden kann. |
| [XmpPackage](../../groupdocs.metadata.formats.video/movrootpackage/xmppackage) { get; set; } | Ruft das XMP-Metadatenpaket ab oder legt es fest. |
...
Dieses Beispiel zeigt, wie QuickTime-Atome in einem MOV-Video gelesen werden.
