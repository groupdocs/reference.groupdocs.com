...
description: Stellt das RootPaket dar das die Arbeit mit Metadaten in einem MatroskaVideo ermöglicht.
type: docs
weight: 2480
url: /de/net/groupdocs.metadata.formats.video/matroskarootpackage/
---
## MatroskaRootPackage class

Stellt das Root-Paket dar, das die Arbeit mit Metadaten in einem Matroska-Video ermöglicht.
...
| [MatroskaPackage](../../groupdocs.metadata.formats.video/matroskarootpackage/matroskapackage) { get; } | Ruft das Matroska-Metadatenpaket ab. |
...
Dieses Beispiel zeigt, wie Untertitel aus einem MKV-Video extrahiert werden.
