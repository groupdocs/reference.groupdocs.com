...
description: Ruft das MatroskaMetadatenpaket ab.
type: docs
weight: 10
url: /de/net/groupdocs.metadata.formats.video/matroskarootpackage/matroskapackage/
---
## MatroskaRootPackage.MatroskaPackage property

Ruft das Matroska-Metadatenpaket ab.
...
Dieses Beispiel zeigt, wie matroska-formatspezifische Metadateneigenschaften gelesen werden.
...
using (Metadata metadata = new Metadata(Constants.InputMkv))
{
    ...
    // Matroska-Segmentinformationen lesen
    ...
    // Matroska-Track-Metadaten lesen
...
* namensraum [GroupDocs.Metadata.Formats.Video](../../matroskarootpackage)
