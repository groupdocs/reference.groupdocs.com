...
description: Stellt das Stammpaket dar das die Arbeit mit Metadaten in einer CADZeichnung ermöglicht.
type: docs
weight: 850
url: /de/net/groupdocs.metadata.formats.cad/cadrootpackage/
---
## CadRootPackage class

Stellt das Stammpaket dar, das die Arbeit mit Metadaten in einer CAD-Zeichnung ermöglicht.
...
| Name | Beschreibung |
| --- | --- |
| [CadPackage](../../groupdocs.metadata.formats.cad/cadrootpackage/cadpackage) { get; } | Ruft das CAD-Metadatenpaket ab. |
...
Dieses Codebeispiel zeigt, wie Metadaten einer CAD-Zeichnung gelesen werden.
