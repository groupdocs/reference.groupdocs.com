...
type: docs
weight: 3580
url: /de/net/groupdocs.metadata.standards.xmp/xmpthumbnail/
---
## XmpThumbnail class
...
| Name | Beschreibung |
| --- | --- |
| [XmpThumbnail](xmpthumbnail#constructor)() | Initialisiert eine neue Instanz von[`XmpThumbnail`](../xmpthumbnail) Klasse. |
| [XmpThumbnail](xmpthumbnail#constructor_1)(int, int) | Initialisiert eine neue Instanz von[`XmpThumbnail`](../xmpthumbnail) Klasse. |
...
| [Format](../../groupdocs.metadata.standards.xmp/xmpthumbnail/format) { get; set; } | Holt oder setzt das Bildformat. Definierter Wert: JPEG. |
| [Height](../../groupdocs.metadata.standards.xmp/xmpthumbnail/height) { get; set; } | Holt oder setzt die Bildhöhe in Pixel. |
| [ImageBase64](../../groupdocs.metadata.standards.xmp/xmpthumbnail/imagebase64) { get; set; } | Ruft die vollständigen Thumbnail-Bilddaten ab oder legt sie fest, konvertiert in Base-64-Notation. |
| [ImageData](../../groupdocs.metadata.standards.xmp/xmpthumbnail/imagedata) { get; } | Ruft die Bilddaten ab. |
...
| [Width](../../groupdocs.metadata.standards.xmp/xmpthumbnail/width) { get; set; } | Holt oder setzt die Bildbreite in Pixel. |
