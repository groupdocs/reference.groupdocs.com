...
description: steht für den LABFarbstoff.
type: docs
weight: 3330
url: /de/net/groupdocs.metadata.standards.xmp/xmpcolorantlab/
---
## XmpColorantLab class

steht für den LAB-Farbstoff.
...
| Name | Beschreibung |
| --- | --- |
| [XmpColorantLab](xmpcolorantlab#constructor)() | Initialisiert eine neue Instanz von[`XmpColorantLab`](../xmpcolorantlab) Klasse. |
| [XmpColorantLab](xmpcolorantlab#constructor_1)(sbyte, sbyte, double) | Initialisiert eine neue Instanz von[`XmpColorantLab`](../xmpcolorantlab) Klasse. |

## Eigenschaften

| Name | Beschreibung |
| --- | --- |
| [A](../../groupdocs.metadata.standards.xmp/xmpcolorantlab/a) { get; set; } | Ruft die A-Komponente ab oder setzt sie. |
| [B](../../groupdocs.metadata.standards.xmp/xmpcolorantlab/b) { get; set; } | Holt oder setzt die B-Komponente. |
...
| [L](../../groupdocs.metadata.standards.xmp/xmpcolorantlab/l) { get; set; } | Ruft die L-Komponente ab oder legt sie fest. |
...
| Name | Beschreibung |
| --- | --- |
| const [MaxL](../../groupdocs.metadata.standards.xmp/xmpcolorantlab/maxl) | Komponente L max. Wert. |
| const [MinL](../../groupdocs.metadata.standards.xmp/xmpcolorantlab/minl) | Komponente L min Wert. |
