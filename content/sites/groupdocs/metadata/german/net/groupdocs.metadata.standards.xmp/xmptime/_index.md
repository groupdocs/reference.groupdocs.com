...
type: docs
weight: 3590
url: /de/net/groupdocs.metadata.standards.xmp/xmptime/
---
## XmpTime class
...
| Name | Beschreibung |
| --- | --- |
| [XmpTime](xmptime#constructor)() | Initialisiert eine neue Instanz von[`XmpTime`](../xmptime) Klasse. |
| [XmpTime](xmptime#constructor_1)(XmpRational, int) | Initialisiert eine neue Instanz von[`XmpTime`](../xmptime) Klasse. |
...
| [Scale](../../groupdocs.metadata.standards.xmp/xmptime/scale) { get; set; } | Ruft die Skala für den Zeitwert ab oder legt sie fest. |
| [Value](../../groupdocs.metadata.standards.xmp/xmptime/value) { get; set; } | Ruft den Zeitwert in der angegebenen Skala ab oder legt ihn fest. |
