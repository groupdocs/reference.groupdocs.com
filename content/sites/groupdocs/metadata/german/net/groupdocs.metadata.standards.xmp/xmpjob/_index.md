...
description: steht für Job.
type: docs
weight: 3440
url: /de/net/groupdocs.metadata.standards.xmp/xmpjob/
---
## XmpJob class
...
| Name | Beschreibung |
| --- | --- |
| [XmpJob](xmpjob)() | Initialisiert eine neue Instanz von[`XmpJob`](../xmpjob) Klasse. |
...
| [ID](../../groupdocs.metadata.standards.xmp/xmpjob/id) { get; set; } | Ruft eine eindeutige ID für den Job ab oder legt sie fest. Dieses Feld ist ein Verweis auf ein externes Jobverwaltungssystem. |
| [Item](../../groupdocs.metadata.common/metadatapackage/item) { get; } | Ruft die ab[`MetadataProperty`](../../groupdocs.metadata.common/metadataproperty) mit dem angegebenen Namen. |
| [Keys](../../groupdocs.metadata.common/metadatapackage/keys) { get; } | Ruft eine Sammlung der Metadaten-Eigenschaftsnamen ab. |
| [MetadataType](../../groupdocs.metadata.common/metadatapackage/metadatatype) { get; } | Ruft den Metadatentyp ab. |
| [Name](../../groupdocs.metadata.standards.xmp/xmpjob/name) { get; set; } | Ruft den informellen Namen des Jobs ab oder setzt ihn. Dieser Name ist für die Benutzeranzeige und informelle Systeme. |
...
| [Url](../../groupdocs.metadata.standards.xmp/xmpjob/url) { get; set; } | Ruft eine Datei-URL ab oder legt sie fest, die auf eine externe Auftragsverwaltungsdatei verweist. |
