...
description: Repräsentiert den RGBFarbstoff.
type: docs
weight: 3340
url: /de/net/groupdocs.metadata.standards.xmp/xmpcolorantrgb/
---
## XmpColorantRgb class

Repräsentiert den RGB-Farbstoff.
...
| Name | Beschreibung |
| --- | --- |
| [XmpColorantRgb](xmpcolorantrgb#constructor)() | Initialisiert eine neue Instanz von[`XmpColorantRgb`](../xmpcolorantrgb) Klasse. |
| [XmpColorantRgb](xmpcolorantrgb#constructor_1)(byte, byte, byte) | Initialisiert eine neue Instanz von[`XmpColorantRgb`](../xmpcolorantrgb) Klasse. |

## Eigenschaften

| Name | Beschreibung |
| --- | --- |
| [Blue](../../groupdocs.metadata.standards.xmp/xmpcolorantrgb/blue) { get; set; } | Ruft die blaue Komponente ab oder legt sie fest. |
...
| [Green](../../groupdocs.metadata.standards.xmp/xmpcolorantrgb/green) { get; set; } | Ruft den grünen Wert ab oder setzt ihn. |
...
| [Red](../../groupdocs.metadata.standards.xmp/xmpcolorantrgb/red) { get; set; } | Ruft die rote Komponente ab oder legt sie fest. |
