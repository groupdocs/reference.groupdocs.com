...
description: Stellt das RootPaket dar das die Arbeit mit Metadaten in einem ZIPArchiv ermöglicht.
type: docs
weight: 370
url: /de/net/groupdocs.metadata.formats.archive/ziprootpackage/
---
## ZipRootPackage class

Stellt das Root-Paket dar, das die Arbeit mit Metadaten in einem ZIP-Archiv ermöglicht.
...
| [ZipPackage](../../groupdocs.metadata.formats.archive/ziprootpackage/zippackage) { get; } | Ruft das ZIP-Metadatenpaket ab. |
