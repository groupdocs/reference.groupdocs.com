...
description: Stellt das RootPaket dar das die Arbeit mit Metadaten in einer MSGEMailNachricht ermöglicht.
type: docs
weight: 1410
url: /de/net/groupdocs.metadata.formats.email/msgrootpackage/
---
## MsgRootPackage class

Stellt das Root-Paket dar, das die Arbeit mit Metadaten in einer MSG-E-Mail-Nachricht ermöglicht.
...
| [EmailPackage](../../groupdocs.metadata.formats.email/msgrootpackage/emailpackage) { get; } | Ruft das MSG-Metadatenpaket ab. (2 properties) |
...
Dieses Codebeispiel zeigt, wie Metadaten aus einer MSG-Nachricht extrahiert werden.
