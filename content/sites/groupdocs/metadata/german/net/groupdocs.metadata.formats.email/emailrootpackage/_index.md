...
description: Stellt das RootPaket dar das die Arbeit mit Metadaten in einer EMailNachricht ermöglicht.
type: docs
weight: 1370
url: /de/net/groupdocs.metadata.formats.email/emailrootpackage/
---
## EmailRootPackage class

Stellt das Root-Paket dar, das die Arbeit mit Metadaten in einer E-Mail-Nachricht ermöglicht.
...
| [EmailPackage](../../groupdocs.metadata.formats.email/emailrootpackage/emailpackage) { get; } | Ruft das E-Mail-Metadatenpaket ab. |
