...
description: Stellt das RootPaket dar das die Arbeit mit Metadaten in einem WAVAudio ermöglicht.
type: docs
weight: 600
url: /de/net/groupdocs.metadata.formats.audio/wavrootpackage/
---
## WavRootPackage class

Stellt das Root-Paket dar, das die Arbeit mit Metadaten in einem WAV-Audio ermöglicht.
...
| [RiffInfoPackage](../../groupdocs.metadata.formats.audio/wavrootpackage/riffinfopackage) { get; } | Ruft das Paket ab, das RIFF-Info-Tags enthält. |
| [WavPackage](../../groupdocs.metadata.formats.audio/wavrootpackage/wavpackage) { get; } | Ruft das native WAV-Metadatenpaket ab. |
| [XmpPackage](../../groupdocs.metadata.formats.audio/wavrootpackage/xmppackage) { get; set; } | Ruft das XMP-Metadatenpaket ab oder legt es fest. |
