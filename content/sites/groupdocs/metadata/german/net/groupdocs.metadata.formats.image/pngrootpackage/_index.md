...
description: Stellt das Stammpaket dar das mit Metadaten in einem PNGBild arbeiten soll.
type: docs
weight: 1860
url: /de/net/groupdocs.metadata.formats.image/pngrootpackage/
---
## PngRootPackage class

Stellt das Stammpaket dar, das mit Metadaten in einem PNG-Bild arbeiten soll.
...
| [ExifPackage](../../groupdocs.metadata.formats.image/pngrootpackage/exifpackage) { get; set; } | Ruft das EXIF-Metadatenpaket ab oder legt es fest. |
...
| [PngPackage](../../groupdocs.metadata.formats.image/pngrootpackage/pngpackage) { get; } | Ruft das native PNG-Metadatenpaket ab. |
| [PropertyDescriptors](../../groupdocs.metadata.common/metadatapackage/propertydescriptors) { get; } | Ruft eine Sammlung von Deskriptoren ab, die Informationen zu Eigenschaften enthalten, auf die über die Suchmaschine GroupDocs.Metadata zugegriffen werden kann. |
| [XmpPackage](../../groupdocs.metadata.formats.image/pngrootpackage/xmppackage) { get; set; } | Ruft das XMP-Metadatenpaket ab oder legt es fest. |
...
* [Arbeiten mit Metadaten in PNG-Bildern](https://docs.groupdocs.com/display/metadatanet/Working+with+metadata+in+PNG+images)
