...
description: Stellt das RootPaket dar das die Arbeit mit Metadaten in einem WEBPImage ermöglicht.
type: docs
weight: 2130
url: /de/net/groupdocs.metadata.formats.image/webprootpackage/
---
## WebPRootPackage class

Stellt das Root-Paket dar, das die Arbeit mit Metadaten in einem WEBP-Image ermöglicht.
...
| [ExifPackage](../../groupdocs.metadata.formats.image/webprootpackage/exifpackage) { get; set; } | Ruft das EXIF-Metadatenpaket ab oder legt es fest. |
...
| [XmpPackage](../../groupdocs.metadata.formats.image/webprootpackage/xmppackage) { get; set; } | Ruft das XMP-Metadatenpaket ab oder legt es fest. |
