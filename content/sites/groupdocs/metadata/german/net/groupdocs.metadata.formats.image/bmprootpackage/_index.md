...
description: Stellt das Stammpaket dar das mit Metadaten in einem BMPBild arbeiten soll.
type: docs
weight: 1660
url: /de/net/groupdocs.metadata.formats.image/bmprootpackage/
---
## BmpRootPackage class

Stellt das Stammpaket dar, das mit Metadaten in einem BMP-Bild arbeiten soll.
...
| Name | Beschreibung |
| --- | --- |
| [BmpHeader](../../groupdocs.metadata.formats.image/bmprootpackage/bmpheader) { get; } | Ruft das BMP-Header-Metadatenpaket ab. |
...
Dieses Codebeispiel zeigt, wie der Header einer BMP-Datei gelesen wird.
