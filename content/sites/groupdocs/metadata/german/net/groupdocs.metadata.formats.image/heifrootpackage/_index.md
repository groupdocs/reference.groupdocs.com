...
description: Stellt das RootPaket dar das mit Metadaten in einem HEIFBild arbeiten soll.
type: docs
weight: 1730
url: /de/net/groupdocs.metadata.formats.image/heifrootpackage/
---
## HeifRootPackage class

Stellt das Root-Paket dar, das mit Metadaten in einem HEIF-Bild arbeiten soll.
...
| [ExifPackage](../../groupdocs.metadata.formats.image/heifrootpackage/exifpackage) { get; set; } | Ruft das EXIF-Metadatenpaket ab oder legt es fest. |
...
| [XmpPackage](../../groupdocs.metadata.formats.image/heifrootpackage/xmppackage) { get; set; } | Ruft das XMP-Metadatenpaket ab oder legt es fest. |
