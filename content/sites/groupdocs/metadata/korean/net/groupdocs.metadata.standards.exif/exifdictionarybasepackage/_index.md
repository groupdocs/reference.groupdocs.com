...
description: EXIF 메타데이터 사전에 대한 추상 기본 클래스를 제공합니다.
type: docs
weight: 2750
url: /ko/net/groupdocs.metadata.standards.exif/exifdictionarybasepackage/
---
## ExifDictionaryBasePackage class

EXIF 메타데이터 사전에 대한 추상 기본 클래스를 제공합니다.
