...
description: DXF 도면에서 메타데이터 작업을 허용하는 루트 패키지를 나타냅니다.
type: docs
weight: 870
url: /ko/net/groupdocs.metadata.formats.cad/dxfrootpackage/
---
## DxfRootPackage class

DXF 도면에서 메타데이터 작업을 허용하는 루트 패키지를 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [CadPackage](../../groupdocs.metadata.formats.cad/cadrootpackage/cadpackage) { get; } | CAD 메타데이터 패키지를 가져옵니다. |
