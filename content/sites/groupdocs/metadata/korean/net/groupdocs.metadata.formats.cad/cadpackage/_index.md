...
description: CADComputerAided Design 메타데이터를 나타냅니다.
type: docs
weight: 840
url: /ko/net/groupdocs.metadata.formats.cad/cadpackage/
---
## CadPackage class

CAD(Computer-Aided Design) 메타데이터를 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [AcadVersion](../../groupdocs.metadata.formats.cad/cadpackage/acadversion) { get; } | AutoCAD 드로잉 데이터베이스 버전 번호를 가져옵니다. |
| [Author](../../groupdocs.metadata.formats.cad/cadpackage/author) { get; } | 드로잉 작성자를 가져옵니다. |
| [Comments](../../groupdocs.metadata.formats.cad/cadpackage/comments) { get; } | 사용자 의견을 가져옵니다. |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | 메타데이터 속성의 수를 가져옵니다. |
| [CreatedDateTime](../../groupdocs.metadata.formats.cad/cadpackage/createddatetime) { get; } | 도면이 생성된 날짜와 시간을 가져옵니다. |
| [CustomProperties](../../groupdocs.metadata.formats.cad/cadpackage/customproperties) { get; } | 사용자 지정 메타데이터 속성이 포함된 패키지를 가져옵니다. |
| [Height](../../groupdocs.metadata.formats.cad/cadpackage/height) { get; } | 도면 높이를 가져옵니다. |
| [HyperlinkBase](../../groupdocs.metadata.formats.cad/cadpackage/hyperlinkbase) { get; } | 하이퍼링크 기준을 가져옵니다. |
...
| [Keywords](../../groupdocs.metadata.formats.cad/cadpackage/keywords) { get; } | 키워드를 가져옵니다. |
| [LastSavedBy](../../groupdocs.metadata.formats.cad/cadpackage/lastsavedby) { get; } | 마지막 편집자의 이름을 가져옵니다. |
| [MetadataType](../../groupdocs.metadata.common/metadatapackage/metadatatype) { get; } | 메타데이터 유형을 가져옵니다. |
| [ModifiedDateTime](../../groupdocs.metadata.formats.cad/cadpackage/modifieddatetime) { get; } | 도면이 수정된 날짜와 시간을 가져옵니다. |
...
| [RevisionNumber](../../groupdocs.metadata.formats.cad/cadpackage/revisionnumber) { get; } | 개정 번호를 가져옵니다. |
| [Subject](../../groupdocs.metadata.formats.cad/cadpackage/subject) { get; } | 제목을 가져옵니다. |
| [Title](../../groupdocs.metadata.formats.cad/cadpackage/title) { get; } | 제목을 가져옵니다. |
| [Width](../../groupdocs.metadata.formats.cad/cadpackage/width) { get; } | 드로잉 너비를 가져옵니다. |
