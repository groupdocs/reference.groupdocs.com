...
description: CAD 드로잉에서 메타데이터 작업을 허용하는 루트 패키지를 나타냅니다.
type: docs
weight: 850
url: /ko/net/groupdocs.metadata.formats.cad/cadrootpackage/
---
## CadRootPackage class

CAD 드로잉에서 메타데이터 작업을 허용하는 루트 패키지를 나타냅니다.
...
이 코드 샘플은 CAD 도면의 메타데이터를 읽는 방법을 보여줍니다.
