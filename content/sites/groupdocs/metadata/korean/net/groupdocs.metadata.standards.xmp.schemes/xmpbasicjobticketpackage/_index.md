...
description: 기본 JobTicket 네임스페이스를 나타냅니다.
type: docs
weight: 3080
url: /ko/net/groupdocs.metadata.standards.xmp.schemes/xmpbasicjobticketpackage/
---
## XmpBasicJobTicketPackage class

기본 Job-Ticket 네임스페이스를 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [XmpBasicJobTicketPackage](xmpbasicjobticketpackage)() | 의 새 인스턴스를 초기화합니다.[`XmpBasicJobTicketPackage`](../xmpbasicjobticketpackage) 클래스. |
...
| [Jobs](../../groupdocs.metadata.standards.xmp.schemes/xmpbasicjobticketpackage/jobs) { get; set; } | 작업을 가져오거나 설정합니다. |
