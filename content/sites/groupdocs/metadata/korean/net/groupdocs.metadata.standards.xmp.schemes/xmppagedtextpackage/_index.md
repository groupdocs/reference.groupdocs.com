...
description: XMP 페이지 텍스트 패키지를 나타냅니다.
type: docs
weight: 3180
url: /ko/net/groupdocs.metadata.standards.xmp.schemes/xmppagedtextpackage/
---
## XmpPagedTextPackage class

XMP 페이지 텍스트 패키지를 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [XmpPagedTextPackage](xmppagedtextpackage)() | 의 새 인스턴스를 초기화합니다.[`XmpPagedTextPackage`](../xmppagedtextpackage) 클래스. |

## 속성

| 이름 | 설명 |
| --- | --- |
| [Colorants](../../groupdocs.metadata.standards.xmp.schemes/xmppagedtextpackage/colorants) { get; set; } | 문서(포함된 문서 포함)에서 사용되는 착색제(견본)의 정렬된 배열을 가져오거나 설정합니다. |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | 메타데이터 속성의 수를 가져옵니다. |
| [Fonts](../../groupdocs.metadata.standards.xmp.schemes/xmppagedtextpackage/fonts) { get; set; } | 문서(포함된 문서 포함)에서 사용되는 정렬되지 않은 글꼴 배열을 가져오거나 설정합니다. |
...
| [MaxPageSize](../../groupdocs.metadata.standards.xmp.schemes/xmppagedtextpackage/maxpagesize) { get; set; } | 문서에서 가장 큰 페이지(포함된 문서 포함)의 크기를 가져오거나 설정합니다. |
...
| [NumberOfPages](../../groupdocs.metadata.standards.xmp.schemes/xmppagedtextpackage/numberofpages) { get; set; } | 문서의 페이지 수를 가져오거나 설정합니다. |
| [PlateNames](../../groupdocs.metadata.standards.xmp.schemes/xmppagedtextpackage/platenames) { get; set; } | 문서를 인쇄하는 데 필요한 번호판 이름의 정렬된 배열을 가져오거나 설정합니다(포함된 문서 포함). |
...
| override [Set](../../groupdocs.metadata.standards.xmp.schemes/xmppagedtextpackage/set#set_7)(string, string) | 문자열 속성을 설정합니다. |
| override [Set](../../groupdocs.metadata.standards.xmp.schemes/xmppagedtextpackage/set#set_2)(string, XmpArray) | 에서 상속된 값을 설정합니다.[`XmpArray`](../../groupdocs.metadata.standards.xmp/xmparray) . |
