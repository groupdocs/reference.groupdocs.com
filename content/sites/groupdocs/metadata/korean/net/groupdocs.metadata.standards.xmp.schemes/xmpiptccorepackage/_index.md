...
description: 는 IPTC Core XMP 패키지를 나타냅니다.
type: docs
weight: 3140
url: /ko/net/groupdocs.metadata.standards.xmp.schemes/xmpiptccorepackage/
---
## XmpIptcCorePackage class

는 IPTC Core XMP 패키지를 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [XmpIptcCorePackage](xmpiptccorepackage)() | 의 새 인스턴스를 초기화합니다.[`XmpIptcCorePackage`](../xmpiptccorepackage) 클래스. |
...
| [CountryCode](../../groupdocs.metadata.standards.xmp.schemes/xmpiptccorepackage/countrycode) { get; set; } | 콘텐츠가 집중하고 있는 국가의 코드를 가져오거나 설정합니다. 코드는 ISO 3166 2~3자 코드에서 가져와야 합니다. |
| [IntellectualGenre](../../groupdocs.metadata.standards.xmp.schemes/xmpiptccorepackage/intellectualgenre) { get; set; } | 지적 장르를 가져오거나 설정합니다. 구체적으로 내용이 아니라 뉴스 개체의 성격, 지적, 예술적 또는 저널리즘 특성을 설명합니다. |
...
| [Location](../../groupdocs.metadata.standards.xmp.schemes/xmpiptccorepackage/location) { get; set; } | 콘텐츠가 초점을 맞추고 있는 위치를 가져오거나 설정합니다. |
...
| [Scenes](../../groupdocs.metadata.standards.xmp.schemes/xmpiptccorepackage/scenes) { get; set; } | 사진 콘텐츠의 장면을 가져오거나 설정합니다. |
| [SubjectCodes](../../groupdocs.metadata.standards.xmp.schemes/xmpiptccorepackage/subjectcodes) { get; set; } | 콘텐츠를 분류하기 위해 IPTC "Subject-NewsCodes" 분류에서 하나 이상의 주제를 가져오거나 설정합니다. 각 주제는 정렬되지 않은 목록에서 8자리 문자열로 표시됩니다. |
