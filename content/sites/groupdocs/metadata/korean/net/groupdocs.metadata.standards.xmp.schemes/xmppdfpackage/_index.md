...
description: Adobe PDF 문서에 사용되는 속성을 지정합니다.
type: docs
weight: 3190
url: /ko/net/groupdocs.metadata.standards.xmp.schemes/xmppdfpackage/
---
## XmpPdfPackage class

Adobe PDF 문서에 사용되는 속성을 지정합니다.
...
| 이름 | 설명 |
| --- | --- |
| [XmpPdfPackage](xmppdfpackage)() | 의 새 인스턴스를 초기화합니다.[`XmpPdfPackage`](../xmppdfpackage) 클래스. |
...
| [IsTrapped](../../groupdocs.metadata.standards.xmp.schemes/xmppdfpackage/istrapped) { get; set; } | 문서가 트랩되었는지 여부를 나타내는 값을 가져오거나 설정합니다. |
...
| [Keywords](../../groupdocs.metadata.standards.xmp.schemes/xmppdfpackage/keywords) { get; set; } | 키워드를 가져오거나 설정합니다. |
...
| [PdfVersion](../../groupdocs.metadata.standards.xmp.schemes/xmppdfpackage/pdfversion) { get; set; } | PDF 파일 버전을 가져오거나 설정합니다. 예를 들어 1.0, 1.3 등입니다. |
| [Prefix](../../groupdocs.metadata.standards.xmp/xmppackage/prefix) { get; } | xmlns 접두사를 가져옵니다. |
| [Producer](../../groupdocs.metadata.standards.xmp.schemes/xmppdfpackage/producer) { get; set; } | PDF 문서를 만든 도구의 이름을 가져오거나 설정합니다. |
...
| override [Set](../../groupdocs.metadata.standards.xmp.schemes/xmppdfpackage/set#set_7)(string, string) | 문자열 속성을 설정합니다. |
