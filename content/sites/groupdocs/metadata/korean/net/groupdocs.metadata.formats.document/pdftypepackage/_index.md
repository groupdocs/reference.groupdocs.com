...
description: PDF 관련 파일 형식 정보가 포함된 메타데이터 패키지를 나타냅니다.
type: docs
weight: 1050
url: /ko/net/groupdocs.metadata.formats.document/pdftypepackage/
---
## PdfTypePackage class

PDF 관련 파일 형식 정보가 포함된 메타데이터 패키지를 나타냅니다.
...
| [Version](../../groupdocs.metadata.formats.document/pdftypepackage/version) { get; } | 형식의 버전을 가져옵니다. |
