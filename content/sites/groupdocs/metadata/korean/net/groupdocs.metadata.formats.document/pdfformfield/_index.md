...
description: PDF 문서의 양식 필드를 나타냅니다.
type: docs
weight: 1010
url: /ko/net/groupdocs.metadata.formats.document/pdfformfield/
---
## PdfFormField class

PDF 문서의 양식 필드를 나타냅니다.
...
| [Name](../../groupdocs.metadata.formats.document/pdfformfield/name) { get; } | 필드 이름을 가져옵니다. |
...
| [Value](../../groupdocs.metadata.formats.document/pdfformfield/value) { get; } | 필드 값을 가져옵니다. |
