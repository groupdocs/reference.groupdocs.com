...
description: 다이어그램별 파일 형식 정보가 포함된 메타데이터 패키지를 나타냅니다.
type: docs
weight: 910
url: /ko/net/groupdocs.metadata.formats.document/diagramtypepackage/
---
## DiagramTypePackage class

다이어그램별 파일 형식 정보가 포함된 메타데이터 패키지를 나타냅니다.
...
| [DiagramFormat](../../groupdocs.metadata.formats.document/diagramtypepackage/diagramformat) { get; } | 정확한 다이어그램 형식을 가져옵니다. |
