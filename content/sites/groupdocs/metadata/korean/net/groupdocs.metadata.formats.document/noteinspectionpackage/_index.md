...
description: 메모 섹션의 내부 구조를 노출하는 메타데이터 패키지를 나타냅니다.
type: docs
weight: 950
url: /ko/net/groupdocs.metadata.formats.document/noteinspectionpackage/
---
## NoteInspectionPackage class

메모 섹션의 내부 구조를 노출하는 메타데이터 패키지를 나타냅니다.
...
| [Pages](../../groupdocs.metadata.formats.document/noteinspectionpackage/pages) { get; } | 섹션 페이지의 배열을 가져옵니다. |
