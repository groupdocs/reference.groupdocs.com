...
description: PDF WordProcessing 스프레드시트 프리젠테이션 등과 같은 문서 형식의 루트 패키지를 나타냅니다.
type: docs
weight: 930
url: /ko/net/groupdocs.metadata.formats.document/documentrootpackage-1/
---
## DocumentRootPackage&lt;TPackage&gt; class

PDF, WordProcessing, 스프레드시트, 프리젠테이션 등과 같은 문서 형식의 루트 패키지를 나타냅니다.
...
| 모수 | 설명 |
| --- | --- |
| TPackage | 네이티브 메타데이터 패키지의 유형입니다. |
