...
description: OneNote 섹션의 페이지를 나타냅니다.
type: docs
weight: 960
url: /ko/net/groupdocs.metadata.formats.document/notepage/
---
## NotePage class

OneNote 섹션의 페이지를 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [Author](../../groupdocs.metadata.formats.document/notepage/author) { get; } | 페이지 작성자를 가져옵니다. |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | 메타데이터 속성의 수를 가져옵니다. |
| [CreationTime](../../groupdocs.metadata.formats.document/notepage/creationtime) { get; } | 생성 시간을 가져옵니다. |
...
| [LastModificationTime](../../groupdocs.metadata.formats.document/notepage/lastmodificationtime) { get; } | 마지막 수정 시간을 가져옵니다. |
...
| [Title](../../groupdocs.metadata.formats.document/notepage/title) { get; } | 페이지 제목을 가져옵니다. |
