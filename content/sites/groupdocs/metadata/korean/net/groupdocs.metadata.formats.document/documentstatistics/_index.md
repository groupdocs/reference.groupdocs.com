...
description: 문서 통계 집합을 나타냅니다.
type: docs
weight: 940
url: /ko/net/groupdocs.metadata.formats.document/documentstatistics/
---
...
| 이름 | 설명 |
| --- | --- |
| [DocumentStatistics](documentstatistics)() | 의 새 인스턴스를 초기화합니다.[`DocumentStatistics`](../documentstatistics) 클래스. |

## 속성

| 이름 | 설명 |
| --- | --- |
| [CharacterCount](../../groupdocs.metadata.formats.document/documentstatistics/charactercount) { get; } | 문서의 예상 문자 수를 가져옵니다. |
...
| [PageCount](../../groupdocs.metadata.formats.document/documentstatistics/pagecount) { get; } | 문서의 예상 페이지 수를 가져옵니다. |
...
| [WordCount](../../groupdocs.metadata.formats.document/documentstatistics/wordcount) { get; } | 문서의 예상 단어 수를 가져옵니다. |
