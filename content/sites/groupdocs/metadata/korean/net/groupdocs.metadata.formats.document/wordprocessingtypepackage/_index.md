...
description: 문서별 파일 형식 정보가 포함된 메타데이터 패키지를 나타냅니다.
type: docs
weight: 1320
url: /ko/net/groupdocs.metadata.formats.document/wordprocessingtypepackage/
---
## WordProcessingTypePackage class

문서별 파일 형식 정보가 포함된 메타데이터 패키지를 나타냅니다.
...
| [WordProcessingFormat](../../groupdocs.metadata.formats.document/wordprocessingtypepackage/wordprocessingformat) { get; } | 정확한 워드 프로세싱 형식을 가져옵니다. |
