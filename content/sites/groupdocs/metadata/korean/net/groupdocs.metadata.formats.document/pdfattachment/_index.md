...
description: PDF 문서의 첨부 파일을 나타냅니다.
type: docs
weight: 990
url: /ko/net/groupdocs.metadata.formats.document/pdfattachment/
---
## PdfAttachment class

PDF 문서의 첨부 파일을 나타냅니다.
...
| [Description](../../groupdocs.metadata.formats.document/pdfattachment/description) { get; } | 첨부 파일 설명을 가져옵니다. |
...
| [MimeType](../../groupdocs.metadata.formats.document/pdfattachment/mimetype) { get; } | 첨부 파일의 MIME 형식을 가져옵니다. |
| [Name](../../groupdocs.metadata.formats.document/pdfattachment/name) { get; } | 첨부 파일 이름을 가져옵니다. |
