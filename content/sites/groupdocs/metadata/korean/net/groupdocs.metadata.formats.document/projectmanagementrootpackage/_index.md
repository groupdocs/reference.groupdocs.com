...
description: 프로젝트 관리 형식의 메타데이터 작업을 위한 루트 패키지를 나타냅니다.
type: docs
weight: 1140
url: /ko/net/groupdocs.metadata.formats.document/projectmanagementrootpackage/
---
## ProjectManagementRootPackage class

프로젝트 관리 형식의 메타데이터 작업을 위한 루트 패키지를 나타냅니다.
...
이 코드 샘플은 ProjectManagement 문서의 내장 속성을 추출하는 방법을 보여줍니다.
