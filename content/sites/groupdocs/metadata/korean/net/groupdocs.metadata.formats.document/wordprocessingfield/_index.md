...
description: 워드 프로세싱 문서의 필드를 나타냅니다.
type: docs
weight: 1250
url: /ko/net/groupdocs.metadata.formats.document/wordprocessingfield/
---
## WordProcessingField class

워드 프로세싱 문서의 필드를 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [Code](../../groupdocs.metadata.formats.document/wordprocessingfield/code) { get; } | 필드 코드를 가져옵니다. |
...
| [Result](../../groupdocs.metadata.formats.document/wordprocessingfield/result) { get; } | 필드 결과를 가져옵니다. |
