...
description: 스프레드시트 문서의 시트를 나타냅니다.
type: docs
weight: 1220
url: /ko/net/groupdocs.metadata.formats.document/spreadsheetsheet/
---
## SpreadsheetSheet class

스프레드시트 문서의 시트를 나타냅니다.
...
| [Name](../../groupdocs.metadata.formats.document/spreadsheetsheet/name) { get; } | 시트 이름을 가져옵니다. |
| [Number](../../groupdocs.metadata.formats.document/spreadsheetsheet/number) { get; } | 시트 번호를 가져옵니다. |
