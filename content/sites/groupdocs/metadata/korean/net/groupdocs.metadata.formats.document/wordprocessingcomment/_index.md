...
description: 워드 프로세싱 문서의 주석을 나타냅니다.
type: docs
weight: 1240
url: /ko/net/groupdocs.metadata.formats.document/wordprocessingcomment/
---
## WordProcessingComment class

워드 프로세싱 문서의 주석을 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [Author](../../groupdocs.metadata.formats.document/wordprocessingcomment/author) { get; set; } | 작성자를 가져오거나 설정합니다. |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | 메타데이터 속성의 수를 가져옵니다. |
| [CreatedDate](../../groupdocs.metadata.formats.document/wordprocessingcomment/createddate) { get; set; } | 댓글이 생성된 날짜를 가져오거나 설정합니다. |
| [Id](../../groupdocs.metadata.formats.document/wordprocessingcomment/id) { get; } | 댓글 ID를 가져옵니다. |
| [Initials](../../groupdocs.metadata.formats.document/wordprocessingcomment/initials) { get; set; } | 작성자의 이니셜을 가져오거나 설정합니다. |
...
| [Text](../../groupdocs.metadata.formats.document/wordprocessingcomment/text) { get; set; } | 설명 텍스트를 가져오거나 설정합니다. |
