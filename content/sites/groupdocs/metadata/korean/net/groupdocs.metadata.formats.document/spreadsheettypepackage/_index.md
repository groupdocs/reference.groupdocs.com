...
description: 스프레드시트 관련 파일 형식 정보가 포함된 메타데이터 패키지를 나타냅니다.
type: docs
weight: 1230
url: /ko/net/groupdocs.metadata.formats.document/spreadsheettypepackage/
---
## SpreadsheetTypePackage class

스프레드시트 관련 파일 형식 정보가 포함된 메타데이터 패키지를 나타냅니다.
...
| [SpreadsheetFormat](../../groupdocs.metadata.formats.document/spreadsheettypepackage/spreadsheetformat) { get; } | 정확한 스프레드시트 형식을 가져옵니다. |
