...
description: 스프레드시트 콘텐츠 유형 속성을 포함하는 메타데이터 패키지를 나타냅니다.
type: docs
weight: 1160
url: /ko/net/groupdocs.metadata.formats.document/spreadsheetcontenttypepackage/
---
## SpreadsheetContentTypePackage class

스프레드시트 콘텐츠 유형 속성을 포함하는 메타데이터 패키지를 나타냅니다.
...
| [Clear](../../groupdocs.metadata.formats.document/spreadsheetcontenttypepackage/clear)() | 쓰기 가능한 모든 메타데이터 속성을 제거합니다. |
...
| [Remove](../../groupdocs.metadata.formats.document/spreadsheetcontenttypepackage/remove)(string) | 지정된 이름을 가진 콘텐츠 유형 속성을 제거합니다. |
...
| [Set](../../groupdocs.metadata.formats.document/spreadsheetcontenttypepackage/set#set)(string, string) | 콘텐츠 유형 속성을 지정된 이름으로 추가하거나 바꿉니다. |
| [Set](../../groupdocs.metadata.formats.document/spreadsheetcontenttypepackage/set#set_1)(string, string, string) | 콘텐츠 유형 속성을 지정된 이름으로 추가하거나 바꿉니다. |
...
| [ToList](../../groupdocs.metadata.formats.document/spreadsheetcontenttypepackage/tolist)() | 패키지에서 목록을 만듭니다. |
