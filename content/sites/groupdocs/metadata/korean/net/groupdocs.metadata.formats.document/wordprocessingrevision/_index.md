...
description: 문서의 개정추적된 변경 사항을 나타냅니다.
type: docs
weight: 1290
url: /ko/net/groupdocs.metadata.formats.document/wordprocessingrevision/
---
## WordProcessingRevision class

문서의 개정(추적된 변경 사항)을 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [Author](../../groupdocs.metadata.formats.document/wordprocessingrevision/author) { get; } | 개정의 작성자를 가져옵니다. |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | 메타데이터 속성의 수를 가져옵니다. |
| [DateTime](../../groupdocs.metadata.formats.document/wordprocessingrevision/datetime) { get; } | 개정 날짜/시간을 가져옵니다. |
...
| [RevisionType](../../groupdocs.metadata.formats.document/wordprocessingrevision/revisiontype) { get; } | 개정 유형을 가져옵니다. |
