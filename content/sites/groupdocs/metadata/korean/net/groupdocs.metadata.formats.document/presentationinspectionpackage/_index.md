...
description: 경우에 따라 메타데이터로 간주될 수 있는 프레젠테이션 부분에 대한 정보를 포함합니다.
type: docs
weight: 1080
url: /ko/net/groupdocs.metadata.formats.document/presentationinspectionpackage/
---
## PresentationInspectionPackage class

경우에 따라 메타데이터로 간주될 수 있는 프레젠테이션 부분에 대한 정보를 포함합니다.
...
| 이름 | 설명 |
| --- | --- |
| [Comments](../../groupdocs.metadata.formats.document/presentationinspectionpackage/comments) { get; } | 댓글 배열을 가져옵니다. |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | 메타데이터 속성의 수를 가져옵니다. |
| [HiddenSlides](../../groupdocs.metadata.formats.document/presentationinspectionpackage/hiddenslides) { get; } | 숨겨진 슬라이드의 배열을 가져옵니다. |
...
| [ClearComments](../../groupdocs.metadata.formats.document/presentationinspectionpackage/clearcomments)() | 감지된 모든 사용자 댓글을 프레젠테이션에서 제거합니다. |
| [ClearHiddenSlides](../../groupdocs.metadata.formats.document/presentationinspectionpackage/clearhiddenslides)() | 감지된 모든 숨겨진 슬라이드를 프레젠테이션에서 제거합니다. |
...
| override [RemoveProperties](../../groupdocs.metadata.formats.document/presentationinspectionpackage/removeproperties)(Func&lt;MetadataProperty, bool&gt;) | 지정된 조건자를 만족하는 메타데이터 속성을 제거합니다. |
| override [Sanitize](../../groupdocs.metadata.formats.document/presentationinspectionpackage/sanitize)() | 패키지에서 쓰기 가능한 메타데이터 속성을 제거합니다. 이 작업은 재귀적이므로 중첩된 모든 패키지에도 영향을 미칩니다. |
...
이 코드 샘플은 프레젠테이션에서 검사 속성을 정리하는 방법을 보여줍니다.
