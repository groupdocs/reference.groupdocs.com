...
type: docs
weight: 1110
url: /ko/net/groupdocs.metadata.formats.document/presentationslide/
---
...
| [Name](../../groupdocs.metadata.formats.document/presentationslide/name) { get; } | 슬라이드 이름을 가져옵니다. |
| [Number](../../groupdocs.metadata.formats.document/presentationslide/number) { get; } | 슬라이드 번호를 가져옵니다. |
...
| [SlideId](../../groupdocs.metadata.formats.document/presentationslide/slideid) { get; } | 슬라이드 ID를 가져옵니다. |
