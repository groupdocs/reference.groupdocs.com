...
type: docs
weight: 980
url: /ko/net/groupdocs.metadata.formats.document/pdfannotation/
---
## PdfAnnotation class
...
| [Name](../../groupdocs.metadata.formats.document/pdfannotation/name) { get; } | 주석의 이름을 가져옵니다. |
| [PageNumber](../../groupdocs.metadata.formats.document/pdfannotation/pagenumber) { get; } | 주석이 포함된 페이지 번호를 가져옵니다. |
...
| [Text](../../groupdocs.metadata.formats.document/pdfannotation/text) { get; } | 주석 텍스트를 가져옵니다. |
