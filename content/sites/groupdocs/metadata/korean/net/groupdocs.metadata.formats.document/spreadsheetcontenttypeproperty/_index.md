...
description: 스프레드시트의 콘텐츠 유형 속성을 나타냅니다.
type: docs
weight: 1170
url: /ko/net/groupdocs.metadata.formats.document/spreadsheetcontenttypeproperty/
---
...
| [SpreadsheetPropertyType](../../groupdocs.metadata.formats.document/spreadsheetcontenttypeproperty/spreadsheetpropertytype) { get; } | 속성 유형을 가져옵니다. |
| [SpreadsheetPropertyValue](../../groupdocs.metadata.formats.document/spreadsheetcontenttypeproperty/spreadsheetpropertyvalue) { get; } | 속성 값을 가져옵니다. |
