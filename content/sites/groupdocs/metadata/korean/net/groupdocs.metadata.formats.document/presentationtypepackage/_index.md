...
description: 프레젠테이션 관련 파일 형식 정보가 포함된 메타데이터 패키지를 나타냅니다.
type: docs
weight: 1120
url: /ko/net/groupdocs.metadata.formats.document/presentationtypepackage/
---
## PresentationTypePackage class

프레젠테이션 관련 파일 형식 정보가 포함된 메타데이터 패키지를 나타냅니다.
...
| [PresentationFormat](../../groupdocs.metadata.formats.document/presentationtypepackage/presentationformat) { get; } | 정확한 프레젠테이션 형식을 가져옵니다. |
