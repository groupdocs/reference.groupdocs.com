...
description: 프레젠테이션의 사용자 설명을 나타냅니다.
type: docs
weight: 1060
url: /ko/net/groupdocs.metadata.formats.document/presentationcomment/
---
## PresentationComment class

프레젠테이션의 사용자 설명을 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [Author](../../groupdocs.metadata.formats.document/presentationcomment/author) { get; } | 댓글 작성자를 가져옵니다. |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | 메타데이터 속성의 수를 가져옵니다. |
| [CreatedTime](../../groupdocs.metadata.formats.document/presentationcomment/createdtime) { get; } | 댓글이 생성된 시간을 가져옵니다. |
...
| [SlideNumber](../../groupdocs.metadata.formats.document/presentationcomment/slidenumber) { get; } | 주석이 속한 슬라이드 번호를 가져옵니다. |
| [Text](../../groupdocs.metadata.formats.document/presentationcomment/text) { get; } | 댓글 텍스트를 가져옵니다. |
