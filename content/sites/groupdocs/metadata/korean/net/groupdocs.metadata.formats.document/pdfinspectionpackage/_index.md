...
description: 경우에 따라 메타데이터로 간주될 수 있는 PDF 문서 부분에 대한 정보를 포함합니다.
type: docs
weight: 1020
url: /ko/net/groupdocs.metadata.formats.document/pdfinspectionpackage/
---
## PdfInspectionPackage class

경우에 따라 메타데이터로 간주될 수 있는 PDF 문서 부분에 대한 정보를 포함합니다.
...
| 이름 | 설명 |
| --- | --- |
| [Annotations](../../groupdocs.metadata.formats.document/pdfinspectionpackage/annotations) { get; } | 주석 배열을 가져옵니다. |
| [Attachments](../../groupdocs.metadata.formats.document/pdfinspectionpackage/attachments) { get; } | 첨부 파일의 배열을 가져옵니다. |
| [Bookmarks](../../groupdocs.metadata.formats.document/pdfinspectionpackage/bookmarks) { get; } | 책갈피 배열을 가져옵니다. |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | 메타데이터 속성의 수를 가져옵니다. |
| [DigitalSignatures](../../groupdocs.metadata.formats.document/pdfinspectionpackage/digitalsignatures) { get; } | 디지털 서명 배열을 가져옵니다. |
| [Fields](../../groupdocs.metadata.formats.document/pdfinspectionpackage/fields) { get; } | 양식 필드의 배열을 가져옵니다. |
...
| [ClearAnnotations](../../groupdocs.metadata.formats.document/pdfinspectionpackage/clearannotations)() | 문서에서 감지된 모든 주석을 제거합니다. |
| [ClearAttachments](../../groupdocs.metadata.formats.document/pdfinspectionpackage/clearattachments)() | 문서에서 감지된 모든 첨부 파일을 제거합니다. |
| [ClearBookmarks](../../groupdocs.metadata.formats.document/pdfinspectionpackage/clearbookmarks)() | 문서에서 감지된 모든 책갈피를 제거합니다. |
| [ClearDigitalSignatures](../../groupdocs.metadata.formats.document/pdfinspectionpackage/cleardigitalsignatures)() | 문서에서 감지된 모든 디지털 서명을 제거합니다. |
| [ClearFields](../../groupdocs.metadata.formats.document/pdfinspectionpackage/clearfields)() | 문서에서 감지된 모든 양식 필드를 제거합니다. |
...
| override [RemoveProperties](../../groupdocs.metadata.formats.document/pdfinspectionpackage/removeproperties)(Func&lt;MetadataProperty, bool&gt;) | 지정된 조건자를 만족하는 메타데이터 속성을 제거합니다. |
| override [Sanitize](../../groupdocs.metadata.formats.document/pdfinspectionpackage/sanitize)() | 패키지에서 쓰기 가능한 메타데이터 속성을 제거합니다. 이 작업은 재귀적이므로 중첩된 모든 패키지에도 영향을 미칩니다. |
...
이 코드 샘플은 PDF 문서에서 검사 속성을 제거하는 방법을 보여줍니다.
