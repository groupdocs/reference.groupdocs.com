...
description: EPUB 전자책에서 메타데이터 작업을 허용하는 루트 패키지를 나타냅니다.
type: docs
weight: 1340
url: /ko/net/groupdocs.metadata.formats.ebook/epubrootpackage/
---
## EpubRootPackage class

EPUB 전자책에서 메타데이터 작업을 허용하는 루트 패키지를 나타냅니다.
...
| [DublinCorePackage](../../groupdocs.metadata.formats.ebook/epubrootpackage/dublincorepackage) { get; } | e-book에서 추출한 Dublin Core 메타데이터 패키지를 가져옵니다. |
| [EpubPackage](../../groupdocs.metadata.formats.ebook/epubrootpackage/epubpackage) { get; } | EPUB 메타데이터 패키지를 가져옵니다. |
...
* 네임스페이스 [GroupDocs.Metadata.Formats.Ebook](../../groupdocs.metadata.formats.ebook)
