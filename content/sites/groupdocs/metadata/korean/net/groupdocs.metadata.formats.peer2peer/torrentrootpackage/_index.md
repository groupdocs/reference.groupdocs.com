...
description: TORRENT 파일의 메타데이터로 작업하기 위한 루트 패키지를 나타냅니다.
type: docs
weight: 2200
url: /ko/net/groupdocs.metadata.formats.peer2peer/torrentrootpackage/
---
## TorrentRootPackage class

TORRENT 파일의 메타데이터로 작업하기 위한 루트 패키지를 나타냅니다.
...
| [TorrentPackage](../../groupdocs.metadata.formats.peer2peer/torrentrootpackage/torrentpackage) { get; } | TORRENT 파일 메타데이터 패키지를 가져옵니다. |
...
이 코드 샘플은 TORRENT 파일의 메타데이터를 읽는 방법을 보여줍니다.
