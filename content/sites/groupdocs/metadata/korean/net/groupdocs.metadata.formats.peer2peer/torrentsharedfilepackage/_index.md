...
description: 공유 파일 정보를 나타냅니다. 토렌트 배포의 각 파일에 대한 자세한 정보를 포함합니다.
type: docs
weight: 2210
url: /ko/net/groupdocs.metadata.formats.peer2peer/torrentsharedfilepackage/
---
## TorrentSharedFilePackage class

공유 파일 정보를 나타냅니다. 토렌트 배포의 각 파일에 대한 자세한 정보를 포함합니다.
...
| [Length](../../groupdocs.metadata.formats.peer2peer/torrentsharedfilepackage/length) { get; } | 파일 길이를 바이트 단위로 가져옵니다. |
| [MetadataType](../../groupdocs.metadata.common/metadatapackage/metadatatype) { get; } | 메타데이터 유형을 가져옵니다. |
| [Name](../../groupdocs.metadata.formats.peer2peer/torrentsharedfilepackage/name) { get; } | 파일의 전체 이름을 가져옵니다(루트 torrent 폴더에서 파일에 대한 상대 경로). |
