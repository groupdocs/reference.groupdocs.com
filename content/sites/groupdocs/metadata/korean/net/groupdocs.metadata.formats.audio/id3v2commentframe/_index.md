...
description: 는 COMM 프레임을 나타냅니다.ID3V2Tag./id3v2tag .
type: docs
weight: 440
url: /ko/net/groupdocs.metadata.formats.audio/id3v2commentframe/
---
## ID3V2CommentFrame class

는 COMM 프레임을 나타냅니다.[`ID3V2Tag`](../id3v2tag) .
...
| 이름 | 설명 |
| --- | --- |
| [ID3V2CommentFrame](id3v2commentframe)(ID3V2EncodingType, string, string, string) | 의 새 인스턴스를 초기화합니다.[`ID3V2CommentFrame`](../id3v2commentframe) 클래스. |

## 속성

| 이름 | 설명 |
| --- | --- |
| [CommentEncoding](../../groupdocs.metadata.formats.audio/id3v2commentframe/commentencoding) { get; } | 주석의 인코딩을 가져옵니다. |
...
| [Language](../../groupdocs.metadata.formats.audio/id3v2commentframe/language) { get; } | 댓글의 언어를 가져옵니다(3자). |
...
| [ShortContentDescription](../../groupdocs.metadata.formats.audio/id3v2commentframe/shortcontentdescription) { get; } | 짧은 콘텐츠 설명을 가져옵니다. |
| [Text](../../groupdocs.metadata.formats.audio/id3v2commentframe/text) { get; } | 댓글 텍스트를 가져옵니다. |
...
이 프레임은 다른 프레임에 맞지 않는 모든 종류의 전체 텍스트 정보를 위한 것입니다.
