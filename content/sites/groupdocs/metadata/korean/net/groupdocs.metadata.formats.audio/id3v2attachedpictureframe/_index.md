...
description: 는 APIC 프레임을ID3V2Tag./id3v2tag .
type: docs
weight: 420
url: /ko/net/groupdocs.metadata.formats.audio/id3v2attachedpictureframe/
---
## ID3V2AttachedPictureFrame class

는 APIC 프레임을[`ID3V2Tag`](../id3v2tag) .
...
| 이름 | 설명 |
| --- | --- |
| [ID3V2AttachedPictureFrame](id3v2attachedpictureframe#constructor)(byte[]) | 의 새 인스턴스를 초기화합니다.[`ID3V2AttachedPictureFrame`](../id3v2attachedpictureframe) 클래스. |
| [ID3V2AttachedPictureFrame](id3v2attachedpictureframe#constructor_1)(ID3V2AttachedPictureType, string, byte[]) | 의 새 인스턴스를 초기화합니다.[`ID3V2AttachedPictureFrame`](../id3v2attachedpictureframe) 클래스. |
| [ID3V2AttachedPictureFrame](id3v2attachedpictureframe#constructor_2)(ID3V2EncodingType, string, ID3V2AttachedPictureType, string, byte[]) | 의 새 인스턴스를 초기화합니다.[`ID3V2AttachedPictureFrame`](../id3v2attachedpictureframe) 클래스. |

## 속성

| 이름 | 설명 |
| --- | --- |
| [AttachedPictureType](../../groupdocs.metadata.formats.audio/id3v2attachedpictureframe/attachedpicturetype) { get; } | 그림의 유형을 가져옵니다. |
...
| [Description](../../groupdocs.metadata.formats.audio/id3v2attachedpictureframe/description) { get; } | 그림 설명을 가져옵니다. 설명의 최대 길이는 64자이지만 비어 있을 수 있습니다. |
| [DescriptionEncoding](../../groupdocs.metadata.formats.audio/id3v2attachedpictureframe/descriptionencoding) { get; } | 그림 설명을 인코딩하는 데 사용되는 인코딩을 가져옵니다. |
...
| [MimeType](../../groupdocs.metadata.formats.audio/id3v2attachedpictureframe/mimetype) { get; } | 그림의 MIME 형식을 가져옵니다. |
| [PictureData](../../groupdocs.metadata.formats.audio/id3v2attachedpictureframe/picturedata) { get; } | 사진 데이터를 가져옵니다. |
