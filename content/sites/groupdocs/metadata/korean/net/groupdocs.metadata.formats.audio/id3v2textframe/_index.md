...
description: 는ID3V2Tag./id3v2tag . T 문자로 시작하는 거의 모든 프레임이 이 범주에 속합니다. 단 하나의 예외가 있는데 이는ID3V2UserDefinedFrame./id3v2userdefinedframe 클래스.
type: docs
weight: 520
url: /ko/net/groupdocs.metadata.formats.audio/id3v2textframe/
---
## ID3V2TextFrame class

는[`ID3V2Tag`](../id3v2tag) . T 문자로 시작하는 거의 모든 프레임이 이 범주에 속합니다. 단 하나의 예외가 있는데, 이는[`ID3V2UserDefinedFrame`](../id3v2userdefinedframe) 클래스.
...
| 이름 | 설명 |
| --- | --- |
| [ID3V2TextFrame](id3v2textframe)(string, ID3V2EncodingType, string) | 의 새 인스턴스를 초기화합니다.[`ID3V2TextFrame`](../id3v2textframe) 클래스. |
...
| [Text](../../groupdocs.metadata.formats.audio/id3v2textframe/text) { get; } | 텍스트 값을 가져옵니다. |
| [TextEncoding](../../groupdocs.metadata.formats.audio/id3v2textframe/textencoding) { get; } | 텍스트 인코딩을 가져옵니다. |
