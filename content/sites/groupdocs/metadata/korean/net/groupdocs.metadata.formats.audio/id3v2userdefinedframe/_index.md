...
description: 는 TXXX 프레임을ID3V2Tag./id3v2tag .
type: docs
weight: 540
url: /ko/net/groupdocs.metadata.formats.audio/id3v2userdefinedframe/
---
## ID3V2UserDefinedFrame class

는 TXXX 프레임을[`ID3V2Tag`](../id3v2tag) .
...
| 이름 | 설명 |
| --- | --- |
| [ID3V2UserDefinedFrame](id3v2userdefinedframe#constructor_1)(string, string) | 의 새 인스턴스를 초기화합니다.[`ID3V2UserDefinedFrame`](../id3v2userdefinedframe) 클래스. |
| [ID3V2UserDefinedFrame](id3v2userdefinedframe#constructor)(ID3V2EncodingType, string, string) | 의 새 인스턴스를 초기화합니다.[`ID3V2UserDefinedFrame`](../id3v2userdefinedframe) 클래스. |
...
| [Description](../../groupdocs.metadata.formats.audio/id3v2userdefinedframe/description) { get; } | 설명을 가져옵니다. |
| [Encoding](../../groupdocs.metadata.formats.audio/id3v2userdefinedframe/encoding) { get; } | 프레임의 인코딩을 가져옵니다. |
...
| [Value](../../groupdocs.metadata.formats.audio/id3v2userdefinedframe/value) { get; } | 값을 가져옵니다. |
