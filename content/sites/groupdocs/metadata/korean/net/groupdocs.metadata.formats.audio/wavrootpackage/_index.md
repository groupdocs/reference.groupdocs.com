...
description: WAV 오디오에서 메타데이터 작업을 허용하는 루트 패키지를 나타냅니다.
type: docs
weight: 600
url: /ko/net/groupdocs.metadata.formats.audio/wavrootpackage/
---
## WavRootPackage class

WAV 오디오에서 메타데이터 작업을 허용하는 루트 패키지를 나타냅니다.
...
| [RiffInfoPackage](../../groupdocs.metadata.formats.audio/wavrootpackage/riffinfopackage) { get; } | RIFF 정보 태그가 포함된 패키지를 가져옵니다. |
| [WavPackage](../../groupdocs.metadata.formats.audio/wavrootpackage/wavpackage) { get; } | WAV 기본 메타데이터 패키지를 가져옵니다. |
| [XmpPackage](../../groupdocs.metadata.formats.audio/wavrootpackage/xmppackage) { get; set; } | XMP 메타데이터 패키지를 가져오거나 설정합니다. |
