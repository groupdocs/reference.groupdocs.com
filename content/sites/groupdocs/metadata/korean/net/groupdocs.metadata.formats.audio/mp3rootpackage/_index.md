...
description: MP3 오디오에서 메타데이터 작업을 허용하는 루트 패키지를 나타냅니다.
type: docs
weight: 580
url: /ko/net/groupdocs.metadata.formats.audio/mp3rootpackage/
---
## MP3RootPackage class

MP3 오디오에서 메타데이터 작업을 허용하는 루트 패키지를 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [ApeV2](../../groupdocs.metadata.formats.audio/mp3rootpackage/apev2) { get; } | APE v2 메타데이터를 가져옵니다. |
...
| [ID3V1](../../groupdocs.metadata.formats.audio/mp3rootpackage/id3v1) { get; set; } | ID3v1 메타데이터 태그를 가져오거나 설정합니다. 자세한 내용은 다음을 참조하십시오.[http://id3.org/ID3v1](http://id3.org/ID3v1) . |
| [ID3V2](../../groupdocs.metadata.formats.audio/mp3rootpackage/id3v2) { get; set; } | ID3v2 메타데이터 태그를 가져오거나 설정합니다. |
...
| [Lyrics3V2](../../groupdocs.metadata.formats.audio/mp3rootpackage/lyrics3v2) { get; set; } | Lyrics3v2 메타데이터 태그를 가져오거나 설정합니다. |
| [MetadataType](../../groupdocs.metadata.common/metadatapackage/metadatatype) { get; } | 메타데이터 유형을 가져옵니다. |
| [MpegAudioPackage](../../groupdocs.metadata.formats.audio/mp3rootpackage/mpegaudiopackage) { get; } | MPEG 오디오 메타데이터 패키지를 가져옵니다. |
...
| [XmpPackage](../../groupdocs.metadata.formats.audio/mp3rootpackage/xmppackage) { get; set; } | XMP 메타데이터 패키지를 가져오거나 설정합니다. |
...
| [RemoveApeV2](../../groupdocs.metadata.formats.audio/mp3rootpackage/removeapev2)() | APEv2 오디오 태그를 제거합니다. |
...
| override [Sanitize](../../groupdocs.metadata.formats.audio/mp3rootpackage/sanitize)() | 패키지에서 쓰기 가능한 메타데이터 속성을 제거합니다. 이 작업은 재귀적이므로 중첩된 모든 패키지에도 영향을 미칩니다. |
...
* [MP3 메타데이터 작업](https://docs.groupdocs.com/display/metadatanet/Working+with+MP3+metadata)
