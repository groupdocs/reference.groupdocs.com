...
description: 는 URL 링크 프레임을 나타냅니다.ID3V2Tag./id3v2tag 프레임 이름은 항상 W 문자로 시작합니다.
type: docs
weight: 530
url: /ko/net/groupdocs.metadata.formats.audio/id3v2urllinkframe/
---
## ID3V2UrlLinkFrame class

는 URL 링크 프레임을 나타냅니다.[`ID3V2Tag`](../id3v2tag) 프레임 이름은 항상 W 문자로 시작합니다.
...
| 이름 | 설명 |
| --- | --- |
| [ID3V2UrlLinkFrame](id3v2urllinkframe)(string, string) | 의 새 인스턴스를 초기화합니다.[`ID3V2UrlLinkFrame`](../id3v2urllinkframe) 클래스. |
...
| [Url](../../groupdocs.metadata.formats.audio/id3v2urllinkframe/url) { get; } | URL 값을 가져옵니다. |
