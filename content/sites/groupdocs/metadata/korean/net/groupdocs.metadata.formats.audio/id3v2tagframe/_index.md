...
description: 는ID3V2Tag./id3v2tag .
type: docs
weight: 500
url: /ko/net/groupdocs.metadata.formats.audio/id3v2tagframe/
---
## ID3V2TagFrame class
...
| 이름 | 설명 |
| --- | --- |
| [ID3V2TagFrame](id3v2tagframe)(string, byte[]) | 의 새 인스턴스를 초기화합니다.[`ID3V2TagFrame`](../id3v2tagframe) 클래스. |
