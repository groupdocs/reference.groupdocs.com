...
description: 는 PRIV 프레임을 나타냅니다.ID3V2Tag./id3v2tag . 프레임은 해당 프로그램이 를 사용하고 다른 프레임에 맞지 않는다는 소프트웨어 제작자의 정보를 포함하는 데 사용됩니다.
type: docs
weight: 480
url: /ko/net/groupdocs.metadata.formats.audio/id3v2privateframe/
---
## ID3V2PrivateFrame class

는 PRIV 프레임을 나타냅니다.[`ID3V2Tag`](../id3v2tag) . 프레임은 해당 프로그램이 를 사용하고 다른 프레임에 맞지 않는다는 소프트웨어 제작자의 정보를 포함하는 데 사용됩니다.
...
| 이름 | 설명 |
| --- | --- |
| [ID3V2PrivateFrame](id3v2privateframe)(string, byte[]) | 의 새 인스턴스를 초기화합니다.[`ID3V2PrivateFrame`](../id3v2privateframe) 클래스. |

## 속성

| 이름 | 설명 |
| --- | --- |
| [BinaryData](../../groupdocs.metadata.formats.audio/id3v2privateframe/binarydata) { get; } | 이진 데이터를 가져옵니다. |
...
| [OwnerIdentifier](../../groupdocs.metadata.formats.audio/id3v2privateframe/owneridentifier) { get; } | 소유자 식별자를 가져옵니다. |
