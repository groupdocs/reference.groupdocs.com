...
description: ID3v1 및 ID3v2 오디오 태그에 대한 기본 추상 클래스를 나타냅니다.
type: docs
weight: 390
url: /ko/net/groupdocs.metadata.formats.audio/id3tag/
---
## ID3Tag class

ID3(v1) 및 ID3(v2) 오디오 태그에 대한 기본 추상 클래스를 나타냅니다.
...
| abstract [Version](../../groupdocs.metadata.formats.audio/id3tag/version) { get; } | 문자열 형식의 ID3 태그 버전을 가져옵니다. 예: 'ID3v1.1'. |
