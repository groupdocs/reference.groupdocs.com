...
description: 문서에 서명하는 데 사용되는 디지털 서명을 나타냅니다.
type: docs
weight: 3030
url: /ko/net/groupdocs.metadata.standards.signing/digitalsignature/
---
## DigitalSignature class

문서에 서명하는 데 사용되는 디지털 서명을 나타냅니다.
...
| virtual [SignTime](../../groupdocs.metadata.standards.signing/digitalsignature/signtime) { get; } | 문서가 서명된 시간을 가져옵니다. |
...
* 네임스페이스 [GroupDocs.Metadata.Standards.Signing](../../groupdocs.metadata.standards.signing)
