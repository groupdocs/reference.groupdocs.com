...
description: 콘텐츠 유형 식별자와 콘텐츠 자체로 구성된 서명된 콘텐츠 컨테이너를 나타냅니다.
type: docs
weight: 2990
url: /ko/net/groupdocs.metadata.standards.pkcs/cmsencapsulatedcontent/
---
## CmsEncapsulatedContent class

콘텐츠 유형 식별자와 콘텐츠 자체로 구성된 서명된 콘텐츠 컨테이너를 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [ContentRawData](../../groupdocs.metadata.standards.pkcs/cmsencapsulatedcontent/contentrawdata) { get; } | 콘텐츠 정보의 원시 데이터를 가져옵니다. |
| [ContentType](../../groupdocs.metadata.standards.pkcs/cmsencapsulatedcontent/contenttype) { get; } | 콘텐츠 유형을 고유하게 지정하는 개체 식별자를 가져옵니다. |
