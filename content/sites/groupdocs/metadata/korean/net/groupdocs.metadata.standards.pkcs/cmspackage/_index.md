...
description: CMS 디지털 서명 메타데이터 패키지를 나타냅니다.
type: docs
weight: 3000
url: /ko/net/groupdocs.metadata.standards.pkcs/cmspackage/
---
## CmsPackage class

CMS 디지털 서명 메타데이터 패키지를 나타냅니다.
...
| [Flags](../../groupdocs.metadata.standards.pkcs/cmspackage/flags) { get; } | 디지털 서명 플래그를 가져옵니다. |
...
| [Signatures](../../groupdocs.metadata.standards.pkcs/cmspackage/signatures) { get; } | 파일에서 추출된 서명 배열을 가져옵니다. |
