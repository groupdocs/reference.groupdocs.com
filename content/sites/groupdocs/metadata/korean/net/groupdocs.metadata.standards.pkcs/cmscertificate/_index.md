...
description: CMS 인증서를 나타냅니다.
type: docs
weight: 2980
url: /ko/net/groupdocs.metadata.standards.pkcs/cmscertificate/
---
...
| [NotAfter](../../groupdocs.metadata.standards.pkcs/cmscertificate/notafter) { get; } | 인증서가 더 이상 유효하지 않은 날짜를 현지 시간으로 가져옵니다. |
| [NotBefore](../../groupdocs.metadata.standards.pkcs/cmscertificate/notbefore) { get; } | 인증서가 유효한 날짜를 현지 시간으로 가져옵니다. |
...
| [RawData](../../groupdocs.metadata.standards.pkcs/cmscertificate/rawdata) { get; } | 이 인증서의 원시 데이터를 가져옵니다. |
