...
description: 개체 식별자OID를 나타냅니다. 국제 전기 통신 연합ITU 및 ISO/IEC 에서 전역적으로 명확한 영구 이름을 사용하여 개체 개념 또는 사물의 이름을 지정하기 위해 표준화한 식별자 메커니즘입니다.
type: docs
weight: 3020
url: /ko/net/groupdocs.metadata.standards.pkcs/oid/
---
## Oid class

개체 식별자(OID)를 나타냅니다. 국제 전기 통신 연합(ITU) 및 ISO/IEC 에서 전역적으로 명확한 영구 이름을 사용하여 개체, 개념 또는 "사물"의 이름을 지정하기 위해 표준화한 식별자 메커니즘입니다.
...
| [FriendlyName](../../groupdocs.metadata.standards.pkcs/oid/friendlyname) { get; } | 친숙한 이름을 가져옵니다. |
...
| [Value](../../groupdocs.metadata.standards.pkcs/oid/value) { get; } | 개체 식별자(OID) 값을 가져옵니다. |
