...
description: 서명자별 CMS 정보를 나타냅니다.
type: docs
weight: 3010
url: /ko/net/groupdocs.metadata.standards.pkcs/cmssigner/
---
## CmsSigner class
...
| [DigestAlgorithm](../../groupdocs.metadata.standards.pkcs/cmssigner/digestalgorithm) { get; } | 서명자가 사용하는 메시지 다이제스트 알고리즘 및 관련 매개변수를 가져옵니다. |
...
| [SignatureAlgorithm](../../groupdocs.metadata.standards.pkcs/cmssigner/signaturealgorithm) { get; } | 디지털 서명을 생성하기 위해 서명자가 사용하는 서명 알고리즘 및 관련 매개변수를 가져옵니다. |
| [SignatureValue](../../groupdocs.metadata.standards.pkcs/cmssigner/signaturevalue) { get; } | 메시지 다이제스트와 서명자의 개인 키를 사용하여 디지털 서명 생성 결과를 가져옵니다. |
| [SignedAttributes](../../groupdocs.metadata.standards.pkcs/cmssigner/signedattributes) { get; } | 서명된 속성 모음을 가져옵니다. |
| [SignerIdentifier](../../groupdocs.metadata.standards.pkcs/cmssigner/signeridentifier) { get; } | 서명자의 인증서(및 서명자의 공개 키) 원시 데이터를 가져옵니다. |
| [SigningTime](../../groupdocs.metadata.standards.pkcs/cmssigner/signingtime) { get; } | 서명자가 서명 프로세스를 수행한 시간을 가져옵니다. |
| [UnsignedAttributes](../../groupdocs.metadata.standards.pkcs/cmssigner/unsignedattributes) { get; } | 서명되지 않은 속성 모음을 가져옵니다. |
