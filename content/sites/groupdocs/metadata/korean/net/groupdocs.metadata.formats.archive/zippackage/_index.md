...
description: ZIP 아카이브 메타데이터를 나타냅니다.
type: docs
weight: 360
url: /ko/net/groupdocs.metadata.formats.archive/zippackage/
---
## ZipPackage class

ZIP 아카이브 메타데이터를 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [Comment](../../groupdocs.metadata.formats.archive/zippackage/comment) { get; set; } | 사용자가 만든 ZIP 아카이브 주석을 가져오거나 설정합니다. |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | 메타데이터 속성의 수를 가져옵니다. |
| [Files](../../groupdocs.metadata.formats.archive/zippackage/files) { get; } | 배열을 가져옵니다.[`ZipFile`](../zipfile) ZIP 아카이브 내부의 항목. |
...
| [TotalEntries](../../groupdocs.metadata.formats.archive/zippackage/totalentries) { get; } | ZIP 아카이브 내부의 총 항목 수를 가져옵니다. |
