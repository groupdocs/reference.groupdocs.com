...
description: ZIP 아카이브에서 메타데이터 작업을 허용하는 루트 패키지를 나타냅니다.
type: docs
weight: 370
url: /ko/net/groupdocs.metadata.formats.archive/ziprootpackage/
---
## ZipRootPackage class

ZIP 아카이브에서 메타데이터 작업을 허용하는 루트 패키지를 나타냅니다.
...
| [ZipPackage](../../groupdocs.metadata.formats.archive/ziprootpackage/zippackage) { get; } | ZIP 메타데이터 패키지를 가져옵니다. |
...
다음 코드 스니펫은 ZIP 아카이브에서 메타데이터를 가져오는 방법을 보여줍니다.
