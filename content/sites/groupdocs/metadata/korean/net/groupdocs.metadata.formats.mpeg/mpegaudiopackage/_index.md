...
description: MPEG 오디오 메타데이터를 나타냅니다.
type: docs
weight: 2150
url: /ko/net/groupdocs.metadata.formats.mpeg/mpegaudiopackage/
---
## MpegAudioPackage class

MPEG 오디오 메타데이터를 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [MpegAudioPackage](mpegaudiopackage)() | 의 새 인스턴스를 초기화합니다.[`MpegAudioPackage`](../mpegaudiopackage) 클래스. |

## 속성

| 이름 | 설명 |
| --- | --- |
| [Bitrate](../../groupdocs.metadata.formats.mpeg/mpegaudiopackage/bitrate) { get; } | 비트 전송률을 가져옵니다. |
| [ChannelMode](../../groupdocs.metadata.formats.mpeg/mpegaudiopackage/channelmode) { get; } | 채널 모드를 가져옵니다. |
| [Copyright](../../groupdocs.metadata.formats.mpeg/mpegaudiopackage/copyright) { get; } | 저작권 비트를 가져옵니다. |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | 메타데이터 속성의 수를 가져옵니다. |
| [Emphasis](../../groupdocs.metadata.formats.mpeg/mpegaudiopackage/emphasis) { get; } | 강조를 가져옵니다. |
| [Frequency](../../groupdocs.metadata.formats.mpeg/mpegaudiopackage/frequency) { get; } | 주파수를 가져옵니다. |
| [HeaderPosition](../../groupdocs.metadata.formats.mpeg/mpegaudiopackage/headerposition) { get; } | 헤더 오프셋을 가져옵니다. |
| [IsOriginal](../../groupdocs.metadata.formats.mpeg/mpegaudiopackage/isoriginal) { get; } | 원본 비트를 가져옵니다. |
| [IsProtected](../../groupdocs.metadata.formats.mpeg/mpegaudiopackage/isprotected) { get; } | 가져오기`진실` 보호된 경우. |
...
| [Layer](../../groupdocs.metadata.formats.mpeg/mpegaudiopackage/layer) { get; } | 레이어 설명을 가져옵니다. MP3 오디오의 경우 '3'입니다. |
| [MetadataType](../../groupdocs.metadata.common/metadatapackage/metadatatype) { get; } | 메타데이터 유형을 가져옵니다. |
| [ModeExtensionBits](../../groupdocs.metadata.formats.mpeg/mpegaudiopackage/modeextensionbits) { get; } | 모드 확장 비트를 가져옵니다. |
| [MpegAudioVersion](../../groupdocs.metadata.formats.mpeg/mpegaudiopackage/mpegaudioversion) { get; } | MPEG 오디오 버전을 가져옵니다. MPEG-1, MPEG-2 등일 수 있습니다. |
| [PaddingBit](../../groupdocs.metadata.formats.mpeg/mpegaudiopackage/paddingbit) { get; } | 패딩 비트를 가져옵니다. |
| [PrivateBit](../../groupdocs.metadata.formats.mpeg/mpegaudiopackage/privatebit) { get; } | [private bit]. 여부를 나타내는 값을 가져옵니다. |
