...
description: 파일 형식 정보를 포함하는 메타데이터 패키지를 나타냅니다.
type: docs
weight: 60
url: /ko/net/groupdocs.metadata.common/filetypepackage/
---
## FileTypePackage class

파일 형식 정보를 포함하는 메타데이터 패키지를 나타냅니다.
...
| [Item](../../groupdocs.metadata.common/metadatapackage/item) { get; } | 가져오기[`MetadataProperty`](../metadataproperty) 지정된 이름으로. |
...
* [지원되는 파일 형식](https://docs.groupdocs.com/display/metadatanet/Supported+File+Formats)
