...
description: MakerNote 메타데이터 패키지에 대한 추상 기본 클래스를 제공합니다.
type: docs
weight: 2830
url: /ko/net/groupdocs.metadata.standards.exif.makernote/makernotepackage/
---
## MakerNotePackage class

MakerNote 메타데이터 패키지에 대한 추상 기본 클래스를 제공합니다.
