...
description: ASF 미디어 컨테이너의 기본 메타데이터를 나타냅니다.
type: docs
weight: 2340
url: /ko/net/groupdocs.metadata.formats.video/asfpackage/
---
## AsfPackage class

ASF 미디어 컨테이너의 기본 메타데이터를 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [CodecInformation](../../groupdocs.metadata.formats.video/asfpackage/codecinformation) { get; } | 코덱 정보 항목을 가져옵니다. |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | 메타데이터 속성의 수를 가져옵니다. |
| [CreationDate](../../groupdocs.metadata.formats.video/asfpackage/creationdate) { get; } | 파일을 처음 만든 날짜와 시간을 가져옵니다. |
| [FileID](../../groupdocs.metadata.formats.video/asfpackage/fileid) { get; } | 이 파일의 고유 식별자를 가져옵니다. |
| [Flags](../../groupdocs.metadata.formats.video/asfpackage/flags) { get; } | 헤더 플래그를 가져옵니다. |
...
| [MetadataDescriptors](../../groupdocs.metadata.formats.video/asfpackage/metadatadescriptors) { get; } | 메타데이터 설명자를 가져옵니다. |
...
| [StreamProperties](../../groupdocs.metadata.formats.video/asfpackage/streamproperties) { get; } | 디지털 미디어 스트림 속성을 가져옵니다. |
