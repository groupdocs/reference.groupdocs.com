...
description: ASF 미디어 컨테이너의 비디오 스트림 속성 메타데이터를 나타냅니다.
type: docs
weight: 2370
url: /ko/net/groupdocs.metadata.formats.video/asfvideostreamproperty/
---
## AsfVideoStreamProperty class

ASF 미디어 컨테이너의 비디오 스트림 속성 메타데이터를 나타냅니다.
...
| [BitsPerPixels](../../groupdocs.metadata.formats.video/asfvideostreamproperty/bitsperpixels) { get; } | 픽셀당 비트를 가져옵니다. |
| [Compression](../../groupdocs.metadata.formats.video/asfvideostreamproperty/compression) { get; } | 비디오 압축 ID를 가져옵니다. |
...
| [ImageHeight](../../groupdocs.metadata.formats.video/asfvideostreamproperty/imageheight) { get; } | 인코딩된 이미지의 높이를 픽셀 단위로 가져옵니다. |
| [ImageWidth](../../groupdocs.metadata.formats.video/asfvideostreamproperty/imagewidth) { get; } | 인코딩된 이미지의 너비를 픽셀 단위로 가져옵니다. |
