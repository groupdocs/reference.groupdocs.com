...
description: QuickTime 비디오에서 메타데이터 작업을 허용하는 루트 패키지를 나타냅니다.
type: docs
weight: 2640
url: /ko/net/groupdocs.metadata.formats.video/movrootpackage/
---
## MovRootPackage class

QuickTime 비디오에서 메타데이터 작업을 허용하는 루트 패키지를 나타냅니다.
...
| [MovPackage](../../groupdocs.metadata.formats.video/movrootpackage/movpackage) { get; } | QuickTime 메타데이터 패키지를 가져옵니다. |
...
| [XmpPackage](../../groupdocs.metadata.formats.video/movrootpackage/xmppackage) { get; set; } | XMP 메타데이터 패키지를 가져오거나 설정합니다. |
...
이 예는 MOV 비디오에서 QuickTime 아톰을 읽는 방법을 보여줍니다.
