...
description: 는 QuickTime 메타데이터를 나타냅니다.
type: docs
weight: 2630
url: /ko/net/groupdocs.metadata.formats.video/movpackage/
---
## MovPackage class

는 QuickTime 메타데이터를 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [Atoms](../../groupdocs.metadata.formats.video/movpackage/atoms) { get; } | 배열을 가져옵니다.[`MovAtom`](../movatom) 원자. |
