...
description: Matroska 비디오의 자막 메타데이터를 나타냅니다.
type: docs
weight: 2510
url: /ko/net/groupdocs.metadata.formats.video/matroskasubtitle/
---
## MatroskaSubtitle class

Matroska 비디오의 자막 메타데이터를 나타냅니다.
...
| [Duration](../../groupdocs.metadata.formats.video/matroskasubtitle/duration) { get; } | 기간을 가져옵니다. |
...
| [Text](../../groupdocs.metadata.formats.video/matroskasubtitle/text) { get; } | 자막 텍스트를 가져옵니다. |
| [Timecode](../../groupdocs.metadata.formats.video/matroskasubtitle/timecode) { get; } | 시간 코드를 가져옵니다. |
