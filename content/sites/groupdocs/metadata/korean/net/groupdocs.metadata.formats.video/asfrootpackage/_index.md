...
description: ASF 비디오에서 메타데이터 작업을 허용하는 루트 패키지를 나타냅니다.
type: docs
weight: 2350
url: /ko/net/groupdocs.metadata.formats.video/asfrootpackage/
---
## AsfRootPackage class

ASF 비디오에서 메타데이터 작업을 허용하는 루트 패키지를 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [AsfPackage](../../groupdocs.metadata.formats.video/asfrootpackage/asfpackage) { get; } | ASF 메타데이터 패키지를 가져옵니다. |
...
| [XmpPackage](../../groupdocs.metadata.formats.video/asfrootpackage/xmppackage) { get; set; } | XMP 메타데이터 패키지를 가져오거나 설정합니다. |
