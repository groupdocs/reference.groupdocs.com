...
description: Matroska 비디오의 오디오 메타데이터를 나타냅니다.
type: docs
weight: 2430
url: /ko/net/groupdocs.metadata.formats.video/matroskaaudiotrack/
---
## MatroskaAudioTrack class

Matroska 비디오의 오디오 메타데이터를 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [BitDepth](../../groupdocs.metadata.formats.video/matroskaaudiotrack/bitdepth) { get; } | 주로 PCM에 사용되는 샘플당 비트를 가져옵니다. |
| [Channels](../../groupdocs.metadata.formats.video/matroskaaudiotrack/channels) { get; } | 트랙의 채널 수를 가져옵니다. |
...
| [OutputSamplingFrequency](../../groupdocs.metadata.formats.video/matroskaaudiotrack/outputsamplingfrequency) { get; } | 실제 출력 샘플링 주파수를 Hz 단위로 가져옵니다(SBR 기술에 사용됨). |
...
| [SamplingFrequency](../../groupdocs.metadata.formats.video/matroskaaudiotrack/samplingfrequency) { get; } | 샘플링 주파수를 Hz로 가져옵니다. |
