...
description: Matroska 비디오에서 추출한 모든 패키지에 대한 기본 메타데이터 클래스를 제공합니다.
type: docs
weight: 2440
url: /ko/net/groupdocs.metadata.formats.video/matroskabasepackage/
---
## MatroskaBasePackage class

Matroska 비디오에서 추출한 모든 패키지에 대한 기본 메타데이터 클래스를 제공합니다.
