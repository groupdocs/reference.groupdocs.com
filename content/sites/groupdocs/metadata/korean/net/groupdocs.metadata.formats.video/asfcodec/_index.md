...
description: ASF 코덱 메타데이터를 나타냅니다.
type: docs
weight: 2260
url: /ko/net/groupdocs.metadata.formats.video/asfcodec/
---
## AsfCodec class
...
| 이름 | 설명 |
| --- | --- |
| [CodecType](../../groupdocs.metadata.formats.video/asfcodec/codectype) { get; } | 코덱의 유형을 가져옵니다. |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | 메타데이터 속성의 수를 가져옵니다. |
| [Description](../../groupdocs.metadata.formats.video/asfcodec/description) { get; } | 설명을 가져옵니다. |
| [Information](../../groupdocs.metadata.formats.video/asfcodec/information) { get; } | 정보 문자열을 가져옵니다. |
...
| [Name](../../groupdocs.metadata.formats.video/asfcodec/name) { get; } | 속성 이름을 가져옵니다. |
