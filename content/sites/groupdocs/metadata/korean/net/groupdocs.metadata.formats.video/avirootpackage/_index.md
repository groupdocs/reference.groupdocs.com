...
description: AVI 비디오에서 메타데이터 작업을 허용하는 루트 패키지를 나타냅니다.
type: docs
weight: 2400
url: /ko/net/groupdocs.metadata.formats.video/avirootpackage/
---
## AviRootPackage class

AVI 비디오에서 메타데이터 작업을 허용하는 루트 패키지를 나타냅니다.
...
| [Header](../../groupdocs.metadata.formats.video/avirootpackage/header) { get; } | AVI 헤더 패키지를 가져옵니다. |
...
| [RiffInfoPackage](../../groupdocs.metadata.formats.video/avirootpackage/riffinfopackage) { get; } | RIFF 정보 태그가 포함된 패키지를 가져옵니다. |
| [XmpPackage](../../groupdocs.metadata.formats.video/avirootpackage/xmppackage) { get; set; } | XMP 메타데이터 패키지를 가져오거나 설정합니다. |
