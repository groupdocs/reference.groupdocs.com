...
description: 는 QuickTime 원자를 나타냅니다.
type: docs
weight: 2620
url: /ko/net/groupdocs.metadata.formats.video/movatom/
---
## MovAtom class

는 QuickTime 원자를 나타냅니다.
...
| [DataOffset](../../groupdocs.metadata.formats.video/movatom/dataoffset) { get; } | 데이터 오프셋을 가져옵니다. |
| [DataSize](../../groupdocs.metadata.formats.video/movatom/datasize) { get; } | 데이터 크기를 바이트 단위로 가져옵니다. |
| [HasExtendedSize](../../groupdocs.metadata.formats.video/movatom/hasextendedsize) { get; } | 확장된 크기 필드가 원자 데이터를 저장하는 데 사용되었는지 여부를 나타내는 값을 가져옵니다. |
...
| [LongSize](../../groupdocs.metadata.formats.video/movatom/longsize) { get; } | 원자 크기를 바이트 단위로 가져옵니다. |
| [MetadataType](../../groupdocs.metadata.common/metadatapackage/metadatatype) { get; } | 메타데이터 유형을 가져옵니다. |
| [Offset](../../groupdocs.metadata.formats.video/movatom/offset) { get; } | 원자 오프셋을 가져옵니다. |
...
| [Size](../../groupdocs.metadata.formats.video/movatom/size) { get; } | 원자 크기를 바이트 단위로 가져옵니다. |
| [Type](../../groupdocs.metadata.formats.video/movatom/type) { get; } | 4자 형식을 가져옵니다. |
