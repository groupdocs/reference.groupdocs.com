...
description: Matroska 동영상의 메타데이터 컨테이너를 나타냅니다.
type: docs
weight: 2470
url: /ko/net/groupdocs.metadata.formats.video/matroskapackage/
---
## MatroskaPackage class

Matroska 동영상의 메타데이터 컨테이너를 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [ContentType](../../groupdocs.metadata.formats.video/matroskapackage/contenttype) { get; } | Matroska 콘텐츠 유형을 가져옵니다. |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | 메타데이터 속성의 수를 가져옵니다. |
| [EbmlHeader](../../groupdocs.metadata.formats.video/matroskapackage/ebmlheader) { get; } | EBML 헤더 메타데이터를 가져옵니다. |
...
| [Segments](../../groupdocs.metadata.formats.video/matroskapackage/segments) { get; } | 세그먼트 정보 메타데이터를 가져옵니다. |
| [SubtitleTracks](../../groupdocs.metadata.formats.video/matroskapackage/subtitletracks) { get; } | 자막 메타데이터 항목을 가져옵니다. |
| [Tags](../../groupdocs.metadata.formats.video/matroskapackage/tags) { get; } | 태깅 메타데이터를 가져옵니다. |
| [Tracks](../../groupdocs.metadata.formats.video/matroskapackage/tracks) { get; } | 트랙 메타데이터 항목을 가져옵니다. |
