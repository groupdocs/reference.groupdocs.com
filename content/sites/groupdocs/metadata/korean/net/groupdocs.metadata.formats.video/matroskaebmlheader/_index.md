...
description: Matroska 비디오의 EBML 헤더 메타데이터를 나타냅니다.
type: docs
weight: 2460
url: /ko/net/groupdocs.metadata.formats.video/matroskaebmlheader/
---
## MatroskaEbmlHeader class

Matroska 비디오의 EBML 헤더 메타데이터를 나타냅니다.
...
| [DocType](../../groupdocs.metadata.formats.video/matroskaebmlheader/doctype) { get; } | 파일의 내용을 가져옵니다. MATROSKA 파일의 경우 그 값은 'matroska'. |
| [DocTypeReadVersion](../../groupdocs.metadata.formats.video/matroskaebmlheader/doctypereadversion) { get; } | 최소 버전 번호를 가져옵니다.[`DocType`](./doctype) 파일을 읽으려면 파서가 준수해야 합니다. |
| [DocTypeVersion](../../groupdocs.metadata.formats.video/matroskaebmlheader/doctypeversion) { get; } | 버전을 가져옵니다.[`DocType`](./doctype) file. 를 생성하는 데 사용된 작성자 |
...
| [ReadVersion](../../groupdocs.metadata.formats.video/matroskaebmlheader/readversion) { get; } | EBML 파서가 파일을 읽기 위해 준수해야 하는 최소 버전을 가져옵니다. |
| [Version](../../groupdocs.metadata.formats.video/matroskaebmlheader/version) { get; } | 파일을 생성하는 데 사용된 EBML Writer의 버전을 가져옵니다. |
