...
description: Matroska 비디오에서 메타데이터 작업을 허용하는 루트 패키지를 나타냅니다.
type: docs
weight: 2480
url: /ko/net/groupdocs.metadata.formats.video/matroskarootpackage/
---
## MatroskaRootPackage class

Matroska 비디오에서 메타데이터 작업을 허용하는 루트 패키지를 나타냅니다.
...
| [MatroskaPackage](../../groupdocs.metadata.formats.video/matroskarootpackage/matroskapackage) { get; } | Matroska 메타데이터 패키지를 가져옵니다. |
...
이 예는 MKV 비디오에서 자막을 추출하는 방법을 보여줍니다.
