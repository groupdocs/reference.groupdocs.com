...
description: ASF 미디어 컨테이너의 오디오 스트림 속성 메타데이터를 나타냅니다.
type: docs
weight: 2230
url: /ko/net/groupdocs.metadata.formats.video/asfaudiostreamproperty/
---
## AsfAudioStreamProperty class

ASF 미디어 컨테이너의 오디오 스트림 속성 메타데이터를 나타냅니다.
...
| [BitsPerSample](../../groupdocs.metadata.formats.video/asfaudiostreamproperty/bitspersample) { get; } | 모노럴 데이터의 샘플당 비트 수를 가져옵니다. |
| [Channels](../../groupdocs.metadata.formats.video/asfaudiostreamproperty/channels) { get; } | 오디오 채널 수를 가져옵니다. |
...
| [FormatTag](../../groupdocs.metadata.formats.video/asfaudiostreamproperty/formattag) { get; } | 오디오 데이터를 인코딩하는 데 사용되는 코덱의 고유 ID를 가져옵니다. |
...
| [SamplesPerSecond](../../groupdocs.metadata.formats.video/asfaudiostreamproperty/samplespersecond) { get; } | 오디오 스트림의 샘플링 속도를 나타내는 헤르츠(초당 사이클) 값을 가져옵니다. |
