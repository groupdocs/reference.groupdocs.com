...
description: 는 FLV 비디오 헤더를 나타냅니다.
type: docs
weight: 2410
url: /ko/net/groupdocs.metadata.formats.video/flvheader/
---
## FlvHeader class
...
| [HasAudioTags](../../groupdocs.metadata.formats.video/flvheader/hasaudiotags) { get; } | 파일에 오디오 태그가 있는지 여부를 나타내는 값을 가져옵니다. |
| [HasVideoTags](../../groupdocs.metadata.formats.video/flvheader/hasvideotags) { get; } | 파일에 비디오 태그가 있는지 여부를 나타내는 값을 가져옵니다. |
...
| [TypeFlags](../../groupdocs.metadata.formats.video/flvheader/typeflags) { get; } | FLV 유형 플래그를 가져옵니다. |
| [Version](../../groupdocs.metadata.formats.video/flvheader/version) { get; } | 파일 버전을 가져옵니다. |
