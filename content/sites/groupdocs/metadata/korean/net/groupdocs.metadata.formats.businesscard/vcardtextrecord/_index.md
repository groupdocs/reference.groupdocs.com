...
description: vCard 텍스트 레코드 메타데이터 클래스를 나타냅니다.
type: docs
weight: 810
url: /ko/net/groupdocs.metadata.formats.businesscard/vcardtextrecord/
---
## VCardTextRecord class

vCard 텍스트 레코드 메타데이터 클래스를 나타냅니다.
...
| [CharsetParameter](../../groupdocs.metadata.formats.businesscard/vcardtextrecord/charsetparameter) { get; } | 문자 집합 매개 변수를 가져옵니다. |
| override [ContentType](../../groupdocs.metadata.formats.businesscard/vcardtextrecord/contenttype) { get; } | 레코드의 콘텐츠 유형을 가져옵니다. |
...
| [IsQuotedPrintable](../../groupdocs.metadata.formats.businesscard/vcardtextrecord/isquotedprintable) { get; } | 이 인스턴스가 인용된 인쇄 가능한 문자열인지 여부를 나타내는 값을 가져옵니다. |
...
| [MediaTypeParameter](../../groupdocs.metadata.formats.businesscard/vcardtextrecord/mediatypeparameter) { get; } | 미디어 유형 매개변수 값을 가져옵니다. |
...
| [Value](../../groupdocs.metadata.formats.businesscard/vcardtextrecord/value) { get; } | 레코드 값을 가져옵니다. |
...
| [GetReadabilityValue](../../groupdocs.metadata.formats.businesscard/vcardtextrecord/getreadabilityvalue)(string) | 가독성 값을 가져옵니다. |
