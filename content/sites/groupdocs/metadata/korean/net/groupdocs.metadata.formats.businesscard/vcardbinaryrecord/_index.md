...
description: vCard 이진 레코드 메타데이터 클래스를 나타냅니다.
type: docs
weight: 630
url: /ko/net/groupdocs.metadata.formats.businesscard/vcardbinaryrecord/
---
## VCardBinaryRecord class

vCard 이진 레코드 메타데이터 클래스를 나타냅니다.
...
| override [ContentType](../../groupdocs.metadata.formats.businesscard/vcardbinaryrecord/contenttype) { get; } | 레코드의 콘텐츠 유형을 가져옵니다. |
...
| [Value](../../groupdocs.metadata.formats.businesscard/vcardbinaryrecord/value) { get; } | 레코드 값을 가져옵니다. |
