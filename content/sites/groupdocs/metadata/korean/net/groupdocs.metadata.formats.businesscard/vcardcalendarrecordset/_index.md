...
description: 일정 vCard 레코드 집합을 나타냅니다.
type: docs
weight: 640
url: /ko/net/groupdocs.metadata.formats.businesscard/vcardcalendarrecordset/
---
## VCardCalendarRecordset class

일정 vCard 레코드 집합을 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [BusyTimeEntries](../../groupdocs.metadata.formats.businesscard/vcardcalendarrecordset/busytimeentries) { get; } | 개체와 관련된 바쁜 시간에 대한 URI를 가져옵니다. |
| [BusyTimeRecords](../../groupdocs.metadata.formats.businesscard/vcardcalendarrecordset/busytimerecords) { get; } | 개체와 관련된 바쁜 시간에 대한 URI를 가져옵니다. |
| [CalendarAddresses](../../groupdocs.metadata.formats.businesscard/vcardcalendarrecordset/calendaraddresses) { get; } | vCard가 나타내는 개체에 대한 일정 요청을 보내야 하는 일정 사용자 주소를 가져옵니다. |
| [CalendarAddressRecords](../../groupdocs.metadata.formats.businesscard/vcardcalendarrecordset/calendaraddressrecords) { get; } | vCard가 나타내는 개체에 대한 일정 요청을 보내야 하는 일정 사용자 주소를 가져옵니다. |
| [CalendarUriRecords](../../groupdocs.metadata.formats.businesscard/vcardcalendarrecordset/calendarurirecords) { get; } | vCard. 가 나타내는 개체와 연결된 달력의 URI를 가져옵니다. |
...
| [UriCalendarEntries](../../groupdocs.metadata.formats.businesscard/vcardcalendarrecordset/uricalendarentries) { get; } | vCard. 가 나타내는 개체와 연결된 달력의 URI를 가져옵니다. |
