...
description: 보안 vCard 레코드 집합을 나타냅니다. 이러한 속성은 통신 경로의 보안 또는 vCard에 대한 액세스와 관련이 있습니다.
type: docs
weight: 800
url: /ko/net/groupdocs.metadata.formats.businesscard/vcardsecurityrecordset/
---
## VCardSecurityRecordset class

보안 vCard 레코드 집합을 나타냅니다. 이러한 속성은 통신 경로의 보안 또는 vCard에 대한 액세스와 관련이 있습니다.
...
| 이름 | 설명 |
| --- | --- |
| [AccessClassification](../../groupdocs.metadata.formats.businesscard/vcardsecurityrecordset/accessclassification) { get; } | vCard에 있는 정보의 민감도를 가져옵니다. |
| [BinaryPublicKeys](../../groupdocs.metadata.formats.businesscard/vcardsecurityrecordset/binarypublickeys) { get; } | 개체와 연결된 공개 키 또는 인증 인증서를 가져옵니다. |
...
| [PublicKeyBinaryRecords](../../groupdocs.metadata.formats.businesscard/vcardsecurityrecordset/publickeybinaryrecords) { get; } | 개체와 연결된 공개 키 또는 인증 인증서를 가져옵니다. |
| [PublicKeyRecords](../../groupdocs.metadata.formats.businesscard/vcardsecurityrecordset/publickeyrecords) { get; } | 개체와 연결된 공개 키 또는 인증 인증서를 가져옵니다. |
| [PublicKeyUriRecords](../../groupdocs.metadata.formats.businesscard/vcardsecurityrecordset/publickeyurirecords) { get; } | 개체와 연결된 공개 키 또는 인증 인증서를 가져옵니다. |
| [UriPublicKeys](../../groupdocs.metadata.formats.businesscard/vcardsecurityrecordset/uripublickeys) { get; } | 개체와 연결된 공개 키 또는 인증 인증서를 가져옵니다. |
