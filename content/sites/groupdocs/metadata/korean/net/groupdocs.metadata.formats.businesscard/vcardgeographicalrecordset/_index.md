...
description: 지리적 vCard 레코드 집합을 나타냅니다. 이러한 속성은 vCard가 나타내는 개체와 관련된 지리적 위치 또는 지역과 관련된 정보입니다.
type: docs
weight: 730
url: /ko/net/groupdocs.metadata.formats.businesscard/vcardgeographicalrecordset/
---
## VCardGeographicalRecordset class

지리적 vCard 레코드 집합을 나타냅니다. 이러한 속성은 vCard가 나타내는 개체와 관련된 지리적 위치 또는 지역과 관련된 정보입니다.
...
| [GeographicPositionRecords](../../groupdocs.metadata.formats.businesscard/vcardgeographicalrecordset/geographicpositionrecords) { get; } | 객체의 글로벌 포지셔닝과 관련된 정보를 가져옵니다. |
| [GeographicPositions](../../groupdocs.metadata.formats.businesscard/vcardgeographicalrecordset/geographicpositions) { get; } | 객체의 글로벌 포지셔닝과 관련된 정보를 가져옵니다. |
...
| [TimeZoneRecords](../../groupdocs.metadata.formats.businesscard/vcardgeographicalrecordset/timezonerecords) { get; } | 개체의 표준 시간대를 가져옵니다. |
| [TimeZones](../../groupdocs.metadata.formats.businesscard/vcardgeographicalrecordset/timezones) { get; } | 개체의 표준 시간대를 가져옵니다. |
