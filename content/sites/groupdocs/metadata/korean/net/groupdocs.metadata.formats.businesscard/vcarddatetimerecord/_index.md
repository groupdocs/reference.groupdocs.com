...
description: vCard 날짜 시간 레코드 메타데이터 클래스를 나타냅니다.
type: docs
weight: 690
url: /ko/net/groupdocs.metadata.formats.businesscard/vcarddatetimerecord/
---
## VCardDateTimeRecord class

vCard 날짜 시간 레코드 메타데이터 클래스를 나타냅니다.
...
| override [ContentType](../../groupdocs.metadata.formats.businesscard/vcarddatetimerecord/contenttype) { get; } | 레코드의 콘텐츠 유형을 가져옵니다. |
...
| [Value](../../groupdocs.metadata.formats.businesscard/vcarddatetimerecord/value) { get; } | 레코드 값을 가져옵니다. |
