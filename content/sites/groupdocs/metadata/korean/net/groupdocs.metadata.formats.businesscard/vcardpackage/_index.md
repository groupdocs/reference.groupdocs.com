...
description: VCFVirtual Contact File 전자 명함 형식 메타데이터를 나타냅니다.
type: docs
weight: 760
url: /ko/net/groupdocs.metadata.formats.businesscard/vcardpackage/
---
## VCardPackage class

VCF(Virtual Contact File) 전자 명함 형식 메타데이터를 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [Cards](../../groupdocs.metadata.formats.businesscard/vcardpackage/cards) { get; } | 파일에서 추출한 카드 배열을 가져옵니다. |
