...
description: vCard 에이전트 레코드 메타데이터 클래스를 나타냅니다.
type: docs
weight: 610
url: /ko/net/groupdocs.metadata.formats.businesscard/vcardagentrecord/
---
## VCardAgentRecord class

vCard 에이전트 레코드 메타데이터 클래스를 나타냅니다.
...
| override [ContentType](../../groupdocs.metadata.formats.businesscard/vcardagentrecord/contenttype) { get; } | 레코드의 콘텐츠 유형을 가져옵니다. |
...
| [Value](../../groupdocs.metadata.formats.businesscard/vcardagentrecord/value) { get; } | 레코드 값을 가져옵니다. |
