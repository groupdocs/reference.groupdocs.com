...
description: 통신 vCard 레코드 집합을 나타냅니다. 이러한 속성은 vCard가 나타내는 개체와 통신하는 방법에 대한 정보를 설명합니다.
type: docs
weight: 660
url: /ko/net/groupdocs.metadata.formats.businesscard/vcardcommunicationrecordset/
---
## VCardCommunicationRecordset class

통신 vCard 레코드 집합을 나타냅니다. 이러한 속성은 vCard가 나타내는 개체와 통신하는 방법에 대한 정보를 설명합니다.
...
| [EmailRecords](../../groupdocs.metadata.formats.businesscard/vcardcommunicationrecordset/emailrecords) { get; } | 개체와 통신하기 위한 전자 메일 주소를 가져옵니다. |
| [Emails](../../groupdocs.metadata.formats.businesscard/vcardcommunicationrecordset/emails) { get; } | 개체와 통신하기 위한 전자 메일 주소를 가져옵니다. |
| [ImppEntries](../../groupdocs.metadata.formats.businesscard/vcardcommunicationrecordset/imppentries) { get; } | 개체와의 인스턴트 메시징 및 프레즌스 프로토콜 통신을 위한 URI를 가져옵니다. |
| [ImppRecords](../../groupdocs.metadata.formats.businesscard/vcardcommunicationrecordset/impprecords) { get; } | 개체와의 인스턴트 메시징 및 프레즌스 프로토콜 통신을 위한 URI를 가져옵니다. |
...
| [LanguageRecords](../../groupdocs.metadata.formats.businesscard/vcardcommunicationrecordset/languagerecords) { get; } | 개체에 연결하는 데 사용할 수 있는 언어를 가져옵니다. |
| [Languages](../../groupdocs.metadata.formats.businesscard/vcardcommunicationrecordset/languages) { get; } | 개체에 연결하는 데 사용할 수 있는 언어를 가져옵니다. |
| [Mailer](../../groupdocs.metadata.formats.businesscard/vcardcommunicationrecordset/mailer) { get; } | vCard와 연결된 개인이 사용하는 전자 메일 소프트웨어 유형을 가져옵니다. |
...
| [TelephoneRecords](../../groupdocs.metadata.formats.businesscard/vcardcommunicationrecordset/telephonerecords) { get; } | 개체와의 전화 통신을 위한 전화 번호를 가져옵니다. |
| [Telephones](../../groupdocs.metadata.formats.businesscard/vcardcommunicationrecordset/telephones) { get; } | 개체와의 전화 통신을 위한 전화 번호를 가져옵니다. |
