...
description: 일반 vCard 레코드 집합을 나타냅니다.
type: docs
weight: 720
url: /ko/net/groupdocs.metadata.formats.businesscard/vcardgeneralrecordset/
---
## VCardGeneralRecordset class

일반 vCard 레코드 집합을 나타냅니다.
...
| [Kind](../../groupdocs.metadata.formats.businesscard/vcardgeneralrecordset/kind) { get; } | 개체의 종류를 가져옵니다. |
| [MetadataType](../../groupdocs.metadata.common/metadatapackage/metadatatype) { get; } | 메타데이터 유형을 가져옵니다. |
| [NameOfSource](../../groupdocs.metadata.formats.businesscard/vcardgeneralrecordset/nameofsource) { get; } | SOURCE 속성의 텍스트 표현을 가져옵니다. |
...
| [SourceRecords](../../groupdocs.metadata.formats.businesscard/vcardgeneralrecordset/sourcerecords) { get; } | 콘텐츠 유형에 포함된 디렉터리 정보 소스의 배열을 가져옵니다. |
| [Sources](../../groupdocs.metadata.formats.businesscard/vcardgeneralrecordset/sources) { get; } | 콘텐츠 유형에 포함된 디렉터리 정보의 소스를 포함하는 배열을 가져옵니다. |
| [XmlEntries](../../groupdocs.metadata.formats.businesscard/vcardgeneralrecordset/xmlentries) { get; } | 확장된 XML 인코딩 vCard 데이터를 포함하는 배열을 가져옵니다. |
| [XmlRecords](../../groupdocs.metadata.formats.businesscard/vcardgeneralrecordset/xmlrecords) { get; } | 확장된 XML 인코딩 vCard 데이터를 포함하는 배열을 가져옵니다. |
