...
description: 배달 주소 지정 vCard 레코드 집합을 나타냅니다. 이러한 유형은 배달 주소 지정 또는 vCard 개체의 레이블과 관련된 정보와 관련이 있습니다.
type: docs
weight: 700
url: /ko/net/groupdocs.metadata.formats.businesscard/vcarddeliveryaddressingrecordset/
---
## VCardDeliveryAddressingRecordset class

배달 주소 지정 vCard 레코드 집합을 나타냅니다. 이러한 유형은 배달 주소 지정 또는 vCard 개체의 레이블과 관련된 정보와 관련이 있습니다.
...
| 이름 | 설명 |
| --- | --- |
| [Addresses](../../groupdocs.metadata.formats.businesscard/vcarddeliveryaddressingrecordset/addresses) { get; } | 개체의 배달 주소 구성 요소를 가져옵니다. |
| [AddressRecords](../../groupdocs.metadata.formats.businesscard/vcarddeliveryaddressingrecordset/addressrecords) { get; } | 개체의 배달 주소 구성 요소를 가져옵니다. |
...
| [LabelRecords](../../groupdocs.metadata.formats.businesscard/vcarddeliveryaddressingrecordset/labelrecords) { get; } | 개체의 배달 주소에 해당하는 형식화된 텍스트를 포함하는 배열을 가져옵니다. |
| [Labels](../../groupdocs.metadata.formats.businesscard/vcarddeliveryaddressingrecordset/labels) { get; } | 개체의 배달 주소에 해당하는 형식화된 텍스트를 포함하는 배열을 가져옵니다. |
