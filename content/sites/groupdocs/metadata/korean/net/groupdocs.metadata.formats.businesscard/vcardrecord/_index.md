...
description: 추상 vCard 레코드 메타데이터 클래스를 나타냅니다.
type: docs
weight: 770
url: /ko/net/groupdocs.metadata.formats.businesscard/vcardrecord/
---
## VCardRecord class

추상 vCard 레코드 메타데이터 클래스를 나타냅니다.
...
| abstract [ContentType](../../groupdocs.metadata.formats.businesscard/vcardrecord/contenttype) { get; } | 레코드의 콘텐츠 유형을 가져옵니다. |
