...
description: VCard 파일에서 메타데이터 작업을 허용하는 루트 패키지를 나타냅니다.
type: docs
weight: 790
url: /ko/net/groupdocs.metadata.formats.businesscard/vcardrootpackage/
---
## VCardRootPackage class

VCard 파일에서 메타데이터 작업을 허용하는 루트 패키지를 나타냅니다.
...
| [VCardPackage](../../groupdocs.metadata.formats.businesscard/vcardrootpackage/vcardpackage) { get; } | VCard 메타데이터 패키지를 가져옵니다. |
...
이 코드 샘플은 vCard 파일의 메타데이터 속성을 읽는 방법을 보여줍니다.
