...
description: 는 IPTC 레코드를 나타냅니다.
type: docs
weight: 2930
url: /ko/net/groupdocs.metadata.standards.iptc/iptcrecord/
---
## IptcRecord class
...
| [Item](../../groupdocs.metadata.standards.iptc/iptcrecord/item) { get; } | 가져오기[`IptcDataSet`](../iptcdataset) 지정된 데이터세트 번호. (2 indexers) |
