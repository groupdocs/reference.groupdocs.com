...
description: 전자 메일 메시지 헤더를 포함하는 메타데이터 패키지를 나타냅니다.
type: docs
weight: 1350
url: /ko/net/groupdocs.metadata.formats.email/emailheaderpackage/
---
## EmailHeaderPackage class

전자 메일 메시지 헤더를 포함하는 메타데이터 패키지를 나타냅니다.
...
| [Get](../../groupdocs.metadata.formats.email/emailheaderpackage/get)(string) | 지정된 헤더의 값을 가져옵니다. |
