...
description: MSG 메시지 메타데이터를 나타냅니다.
type: docs
weight: 1400
url: /ko/net/groupdocs.metadata.formats.email/msgpackage/
---
## MsgPackage class

MSG 메시지 메타데이터를 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [AttachedFileNames](../../groupdocs.metadata.formats.email/emailpackage/attachedfilenames) { get; } | 첨부 파일 이름의 배열을 가져옵니다. |
| [BlindCarbonCopyRecipients](../../groupdocs.metadata.formats.email/emailpackage/blindcarboncopyrecipients) { get; set; } | 전자 메일 메시지의 BCC(숨은 참조) 수신자 배열을 가져오거나 설정합니다. |
| [Body](../../groupdocs.metadata.formats.email/msgpackage/body) { get; } | 이메일 메시지 텍스트를 가져옵니다. |
| [CarbonCopyRecipients](../../groupdocs.metadata.formats.email/emailpackage/carboncopyrecipients) { get; set; } | 이메일 메시지의 CC(카본 카피) 수신자 배열을 가져오거나 설정합니다. |
| [Categories](../../groupdocs.metadata.formats.email/msgpackage/categories) { get; } | 카테고리 또는 키워드의 배열을 가져옵니다. |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | 메타데이터 속성의 수를 가져옵니다. |
| [DeliveryTime](../../groupdocs.metadata.formats.email/msgpackage/deliverytime) { get; } | 메시지가 배달된 날짜와 시간을 가져옵니다. |
| [Headers](../../groupdocs.metadata.formats.email/emailpackage/headers) { get; } | 이메일 헤더가 포함된 메타데이터 패키지를 가져옵니다. |
...
| [Recipients](../../groupdocs.metadata.formats.email/emailpackage/recipients) { get; set; } | 이메일 수신자 배열을 가져오거나 설정합니다. |
| [Sender](../../groupdocs.metadata.formats.email/emailpackage/sender) { get; } | 보낸 사람의 이메일 주소를 가져옵니다. |
| [Subject](../../groupdocs.metadata.formats.email/emailpackage/subject) { get; set; } | 이메일 제목을 가져오거나 설정합니다. |
