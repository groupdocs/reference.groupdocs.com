...
description: EML 전자 메일 메시지에서 메타데이터 작업을 허용하는 루트 패키지를 나타냅니다.
type: docs
weight: 1390
url: /ko/net/groupdocs.metadata.formats.email/emlrootpackage/
---
## EmlRootPackage class

EML 전자 메일 메시지에서 메타데이터 작업을 허용하는 루트 패키지를 나타냅니다.
...
| [EmailPackage](../../groupdocs.metadata.formats.email/emlrootpackage/emailpackage) { get; } | EML 메타데이터 패키지를 가져옵니다. (2 properties) |
...
이 코드 샘플은 EML 메시지에서 메타데이터를 추출하는 방법을 보여줍니다.
