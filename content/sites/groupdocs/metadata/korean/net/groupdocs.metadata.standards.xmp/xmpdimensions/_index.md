...
description: 그려진 개체의 치수를 포함합니다.
type: docs
weight: 3380
url: /ko/net/groupdocs.metadata.standards.xmp/xmpdimensions/
---
## XmpDimensions class
...
| 이름 | 설명 |
| --- | --- |
| [XmpDimensions](xmpdimensions#constructor)() | 의 새 인스턴스를 초기화합니다.[`XmpDimensions`](../xmpdimensions) 클래스. |
| [XmpDimensions](xmpdimensions#constructor_1)(double, double) | 의 새 인스턴스를 초기화합니다.[`XmpDimensions`](../xmpdimensions) 클래스. |
...
| [Height](../../groupdocs.metadata.standards.xmp/xmpdimensions/height) { get; set; } | 높이를 가져오거나 설정합니다. |
...
| [Units](../../groupdocs.metadata.standards.xmp/xmpdimensions/units) { get; set; } | 단위를 가져오거나 설정합니다. |
| [Width](../../groupdocs.metadata.standards.xmp/xmpdimensions/width) { get; set; } | 너비를 가져오거나 설정합니다. |
