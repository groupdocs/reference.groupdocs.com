...
description: 리소스에 대한 여러 부분 참조를 나타냅니다. 이전 버전 변환의 원본 파생 문서의 원본 등을 나타내는 데 사용됩니다.
type: docs
weight: 3550
url: /ko/net/groupdocs.metadata.standards.xmp/xmpresourceref/
---
## XmpResourceRef class

리소스에 대한 여러 부분 참조를 나타냅니다. 이전 버전, 변환의 원본, 파생 문서의 원본 등을 나타내는 데 사용됩니다.
...
| 이름 | 설명 |
| --- | --- |
| [XmpResourceRef](xmpresourceref)() | 의 새 인스턴스를 초기화합니다.[`XmpResourceRef`](../xmpresourceref) 클래스. |

## 속성

| 이름 | 설명 |
| --- | --- |
| [AlternatePaths](../../groupdocs.metadata.standards.xmp/xmpresourceref/alternatepaths) { get; set; } | 참조된 리소스의 대체 파일 경로 또는 URL을 가져오거나 설정합니다. |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | 메타데이터 속성의 수를 가져옵니다. |
| [DocumentID](../../groupdocs.metadata.standards.xmp/xmpresourceref/documentid) { get; set; } | 참조된 리소스에서 xmpMM:DocumentID 속성 값을 가져오거나 설정합니다. |
| [FilePath](../../groupdocs.metadata.standards.xmp/xmpresourceref/filepath) { get; set; } | 참조된 리소스의 파일 경로 또는 URL을 가져오거나 설정합니다. |
| [InstanceID](../../groupdocs.metadata.standards.xmp/xmpresourceref/instanceid) { get; set; } | 참조된 리소스에서 xmpMM:InstanceID 속성 값을 가져오거나 설정합니다. |
...
| [LastModifyDate](../../groupdocs.metadata.standards.xmp/xmpresourceref/lastmodifydate) { get; set; } | 파일이 마지막으로 기록된 stEvt:when의 값을 가져오거나 설정합니다. |
| [Manager](../../groupdocs.metadata.standards.xmp/xmpresourceref/manager) { get; set; } | 참조된 리소스의 xmpMM:Manager를 가져오거나 설정합니다. |
| [ManagerVariant](../../groupdocs.metadata.standards.xmp/xmpresourceref/managervariant) { get; set; } | 참조된 리소스의 xmpMM:Manager를 가져오거나 설정합니다. |
| [ManageTo](../../groupdocs.metadata.standards.xmp/xmpresourceref/manageto) { get; set; } | 참조된 리소스의 xmpMM:ManageTo를 가져오거나 설정합니다. |
| [ManageUI](../../groupdocs.metadata.standards.xmp/xmpresourceref/manageui) { get; set; } | 참조된 리소스의 xmpMM:ManageUI를 가져오거나 설정합니다. |
...
| [PartMapping](../../groupdocs.metadata.standards.xmp/xmpresourceref/partmapping) { get; set; } | fromPart를 toPart에 매핑하는 데 사용되는 매핑 함수의 이름 또는 URI를 가져오거나 설정합니다. |
...
| [RenditionClass](../../groupdocs.metadata.standards.xmp/xmpresourceref/renditionclass) { get; set; } | 참조 리소스에서 xmpMM:RenditionClass 속성 값을 가져오거나 설정합니다. |
| [RenditionParams](../../groupdocs.metadata.standards.xmp/xmpresourceref/renditionparams) { get; set; } | 참조된 리소스에서 xmpMM:RenditionParams 속성 값을 가져오거나 설정합니다. |
| [VersionID](../../groupdocs.metadata.standards.xmp/xmpresourceref/versionid) { get; set; } | 참조된 리소스에서 xmpMM:RenditionParams 속성 값을 가져오거나 설정합니다. |
