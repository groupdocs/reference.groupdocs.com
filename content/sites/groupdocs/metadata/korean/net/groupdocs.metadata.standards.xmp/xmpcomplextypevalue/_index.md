...
description: 복합 유형 인스턴스를 포함하는 XMP 값을 나타냅니다.
type: docs
weight: 3360
url: /ko/net/groupdocs.metadata.standards.xmp/xmpcomplextypevalue/
---
## XmpComplexTypeValue class

복합 유형 인스턴스를 포함하는 XMP 값을 나타냅니다.
...
| override [GetXmpRepresentation](../../groupdocs.metadata.standards.xmp/xmpcomplextypevalue/getxmprepresentation)() | XMP 형식의 값이 포함된 문자열을 반환합니다. |
