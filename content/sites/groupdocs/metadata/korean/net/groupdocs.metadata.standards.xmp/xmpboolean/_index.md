...
description: XMP 부울 기본 유형을 나타냅니다.
type: docs
weight: 3270
url: /ko/net/groupdocs.metadata.standards.xmp/xmpboolean/
---
## XmpBoolean class
...
| 이름 | 설명 |
| --- | --- |
| [XmpBoolean](xmpboolean#constructor)() | 의 새 인스턴스를 초기화합니다.[`XmpBoolean`](../xmpboolean) 기본값이 있는 클래스. |
| [XmpBoolean](xmpboolean#constructor_1)(bool) | 의 새 인스턴스를 초기화합니다.[`XmpBoolean`](../xmpboolean) 부울 값에 기반한 클래스. |
| [XmpBoolean](xmpboolean#constructor_2)(string) | 의 새 인스턴스를 초기화합니다.[`XmpBoolean`](../xmpboolean) 클래스. |
...
| [Value](../../groupdocs.metadata.standards.xmp/xmpboolean/value) { get; } | 값을 가져옵니다. |
...
| override [GetXmpRepresentation](../../groupdocs.metadata.standards.xmp/xmpboolean/getxmprepresentation)() | XMP 형식의 값이 포함된 문자열을 반환합니다. |
