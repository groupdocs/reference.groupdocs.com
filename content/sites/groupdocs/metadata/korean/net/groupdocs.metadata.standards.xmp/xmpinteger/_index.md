...
description: XMP 정수 기본 유형을 나타냅니다.
type: docs
weight: 3430
url: /ko/net/groupdocs.metadata.standards.xmp/xmpinteger/
---
## XmpInteger class
...
| 이름 | 설명 |
| --- | --- |
| [XmpInteger](xmpinteger#constructor)(int) | 의 새 인스턴스를 초기화합니다.[`XmpInteger`](../xmpinteger) 클래스. |
| [XmpInteger](xmpinteger#constructor_1)(long) | 의 새 인스턴스를 초기화합니다.[`XmpInteger`](../xmpinteger) 클래스. |
| [XmpInteger](xmpinteger#constructor_2)(string) | 의 새 인스턴스를 초기화합니다.[`XmpInteger`](../xmpinteger) 클래스. |
...
| [Value](../../groupdocs.metadata.standards.xmp/xmpinteger/value) { get; } | 값을 가져옵니다. |
...
| override [GetXmpRepresentation](../../groupdocs.metadata.standards.xmp/xmpinteger/getxmprepresentation)() | XMP 형식의 값이 포함된 문자열을 반환합니다. |
