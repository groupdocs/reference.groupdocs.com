...
description: 문서에서 사용되는 폰트의 특징을 담고 있는 구조체.
type: docs
weight: 3400
url: /ko/net/groupdocs.metadata.standards.xmp/xmpfont/
---
## XmpFont class

문서에서 사용되는 폰트의 특징을 담고 있는 구조체.
...
| 이름 | 설명 |
| --- | --- |
| [XmpFont](xmpfont#constructor)() | 의 새 인스턴스를 초기화합니다.[`XmpFont`](../xmpfont) 클래스. |
| [XmpFont](xmpfont#constructor_1)(string) | 의 새 인스턴스를 초기화합니다.[`XmpFont`](../xmpfont) 클래스. |

## 속성

| 이름 | 설명 |
| --- | --- |
| [ChildFontFiles](../../groupdocs.metadata.standards.xmp/xmpfont/childfontfiles) { get; set; } | 합성 글꼴을 구성하는 글꼴의 파일 이름 목록을 가져오거나 설정합니다. |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | 메타데이터 속성의 수를 가져옵니다. |
| [FontFace](../../groupdocs.metadata.standards.xmp/xmpfont/fontface) { get; set; } | 글꼴 이름을 가져오거나 설정합니다. |
| [FontFamily](../../groupdocs.metadata.standards.xmp/xmpfont/fontfamily) { get; set; } | 글꼴 패밀리 이름을 가져오거나 설정합니다. |
| [FontFileName](../../groupdocs.metadata.standards.xmp/xmpfont/fontfilename) { get; set; } | 글꼴 파일 이름을 가져오거나 설정합니다(완전한 경로 아님). |
| [FontName](../../groupdocs.metadata.standards.xmp/xmpfont/fontname) { get; set; } | 글꼴의 PostScript 이름을 가져오거나 설정합니다. |
| [FontType](../../groupdocs.metadata.standards.xmp/xmpfont/fonttype) { get; set; } | 글꼴 유형을 가져오거나 설정합니다. |
| [IsComposite](../../groupdocs.metadata.standards.xmp/xmpfont/iscomposite) { get; set; } | 합성 여부를 나타내는 값을 가져오거나 설정합니다. |
...
| [Version](../../groupdocs.metadata.standards.xmp/xmpfont/version) { get; set; } | 글꼴 버전을 가져오거나 설정합니다. |
