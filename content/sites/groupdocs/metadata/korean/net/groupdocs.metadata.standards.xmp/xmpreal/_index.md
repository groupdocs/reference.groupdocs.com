...
description: 는 XMP Real을 나타냅니다.
type: docs
weight: 3520
url: /ko/net/groupdocs.metadata.standards.xmp/xmpreal/
---
## XmpReal class
...
| 이름 | 설명 |
| --- | --- |
| [XmpReal](xmpreal#constructor)(double) | 의 새 인스턴스를 초기화합니다.[`XmpReal`](../xmpreal) 클래스. |
| [XmpReal](xmpreal#constructor_1)(string) | 의 새 인스턴스를 초기화합니다.[`XmpReal`](../xmpreal) 클래스. |
...
| [Value](../../groupdocs.metadata.standards.xmp/xmpreal/value) { get; } | 값을 가져옵니다. |
...
| override [GetXmpRepresentation](../../groupdocs.metadata.standards.xmp/xmpreal/getxmprepresentation)() | XMP 형식의 값이 포함된 문자열을 반환합니다. |
