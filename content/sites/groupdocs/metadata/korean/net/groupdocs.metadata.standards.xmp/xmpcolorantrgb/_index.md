...
description: 는 RGB 착색제를 나타냅니다.
type: docs
weight: 3340
url: /ko/net/groupdocs.metadata.standards.xmp/xmpcolorantrgb/
---
...
| 이름 | 설명 |
| --- | --- |
| [XmpColorantRgb](xmpcolorantrgb#constructor)() | 의 새 인스턴스를 초기화합니다.[`XmpColorantRgb`](../xmpcolorantrgb) 클래스. |
| [XmpColorantRgb](xmpcolorantrgb#constructor_1)(byte, byte, byte) | 의 새 인스턴스를 초기화합니다.[`XmpColorantRgb`](../xmpcolorantrgb) 클래스. |

## 속성

| 이름 | 설명 |
| --- | --- |
| [Blue](../../groupdocs.metadata.standards.xmp/xmpcolorantrgb/blue) { get; set; } | 파란색 구성 요소를 가져오거나 설정합니다. |
...
| [Green](../../groupdocs.metadata.standards.xmp/xmpcolorantrgb/green) { get; set; } | 녹색 값을 가져오거나 설정합니다. |
...
| [Red](../../groupdocs.metadata.standards.xmp/xmpcolorantrgb/red) { get; set; } | 빨간색 구성 요소를 가져오거나 설정합니다. |
