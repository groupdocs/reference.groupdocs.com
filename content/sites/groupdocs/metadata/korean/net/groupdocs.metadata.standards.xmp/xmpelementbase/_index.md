...
description: 속성을 포함하는 기본 XMP 요소를 나타냅니다.
type: docs
weight: 3390
url: /ko/net/groupdocs.metadata.standards.xmp/xmpelementbase/
---
## XmpElementBase class

속성을 포함하는 기본 XMP 요소를 나타냅니다.
...
| virtual [SetAttribute](../../groupdocs.metadata.standards.xmp/xmpelementbase/setattribute)(string, string) | 속성을 추가합니다. |
