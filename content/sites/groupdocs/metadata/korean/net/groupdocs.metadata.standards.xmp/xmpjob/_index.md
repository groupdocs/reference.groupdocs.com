...
description: 작업을 나타냅니다.
type: docs
weight: 3440
url: /ko/net/groupdocs.metadata.standards.xmp/xmpjob/
---
## XmpJob class
...
| 이름 | 설명 |
| --- | --- |
| [XmpJob](xmpjob)() | 의 새 인스턴스를 초기화합니다.[`XmpJob`](../xmpjob) 클래스. |
...
| [ID](../../groupdocs.metadata.standards.xmp/xmpjob/id) { get; set; } | 작업의 고유 ID를 가져오거나 설정합니다. 이 필드는 일부 외부 작업 관리 시스템에 대한 참조입니다. |
...
| [Name](../../groupdocs.metadata.standards.xmp/xmpjob/name) { get; set; } | 작업의 비공식 이름을 가져오거나 설정합니다. 이 이름은 사용자 표시 및 비공식 시스템용입니다. |
...
| [Url](../../groupdocs.metadata.standards.xmp/xmpjob/url) { get; set; } | 외부 작업 관리 파일을 참조하는 파일 URL을 가져오거나 설정합니다. |
