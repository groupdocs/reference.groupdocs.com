...
description: XMP 메타데이터 속성의 컨테이너를 나타냅니다.
type: docs
weight: 3470
url: /ko/net/groupdocs.metadata.standards.xmp/xmpmetadatacontainer/
---
## XmpMetadataContainer class

XMP 메타데이터 속성의 컨테이너를 나타냅니다.
...
| abstract [GetXmpRepresentation](../../groupdocs.metadata.standards.xmp/xmpmetadatacontainer/getxmprepresentation)() | XMP 값을 XML 표현으로 변환합니다. |
