...
description: 리소스 처리 중 발생한 상위 이벤트를 나타냅니다.
type: docs
weight: 3540
url: /ko/net/groupdocs.metadata.standards.xmp/xmpresourceevent/
---
## XmpResourceEvent class

리소스 처리 중 발생한 상위 이벤트를 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [XmpResourceEvent](xmpresourceevent)() | 의 새 인스턴스를 초기화합니다.[`XmpResourceEvent`](../xmpresourceevent) 클래스. |

## 속성

| 이름 | 설명 |
| --- | --- |
| [Action](../../groupdocs.metadata.standards.xmp/xmpresourceevent/action) { get; set; } | 발생한 작업을 가져오거나 설정합니다. |
| [Changed](../../groupdocs.metadata.standards.xmp/xmpresourceevent/changed) { get; set; } | 이전 이벤트 기록 이후에 변경된 리소스 부분의 세미콜론으로 구분된 목록을 가져오거나 설정합니다. |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | 메타데이터 속성의 수를 가져옵니다. |
| [InstanceID](../../groupdocs.metadata.standards.xmp/xmpresourceevent/instanceid) { get; set; } | 수정된(출력) 리소스에 대한 xmpMM:InstanceID 속성 값을 가져오거나 설정합니다. |
...
| [Parameters](../../groupdocs.metadata.standards.xmp/xmpresourceevent/parameters) { get; set; } | 작업에 대한 추가 설명을 가져오거나 설정합니다. |
...
| [SoftwareAgent](../../groupdocs.metadata.standards.xmp/xmpresourceevent/softwareagent) { get; set; } | 작업을 수행한 소프트웨어 에이전트를 가져오거나 설정합니다. |
| [When](../../groupdocs.metadata.standards.xmp/xmpresourceevent/when) { get; set; } | 작업이 발생한 시점의 타임스탬프를 가져오거나 설정합니다. |
