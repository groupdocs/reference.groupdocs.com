...
type: docs
weight: 3410
url: /ko/net/groupdocs.metadata.standards.xmp/xmpguid/
---
## XmpGuid class
...
| 이름 | 설명 |
| --- | --- |
| [XmpGuid](xmpguid#constructor)(Guid) | 의 새 인스턴스를 초기화합니다.[`XmpGuid`](../xmpguid) 클래스. |
| [XmpGuid](xmpguid#constructor_1)(string) | 의 새 인스턴스를 초기화합니다.[`XmpGuid`](../xmpguid) 클래스. |
...
| [Value](../../groupdocs.metadata.standards.xmp/xmpguid/value) { get; } | 값을 가져옵니다. |
...
| override [GetXmpRepresentation](../../groupdocs.metadata.standards.xmp/xmpguid/getxmprepresentation)() | XMP 형식의 값이 포함된 문자열을 반환합니다. |
