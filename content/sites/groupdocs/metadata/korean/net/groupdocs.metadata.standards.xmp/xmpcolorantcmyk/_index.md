...
description: 는 CMYK 착색제를 나타냅니다.
type: docs
weight: 3310
url: /ko/net/groupdocs.metadata.standards.xmp/xmpcolorantcmyk/
---
...
| 이름 | 설명 |
| --- | --- |
| [XmpColorantCmyk](xmpcolorantcmyk#constructor)() | 의 새 인스턴스를 초기화합니다.[`XmpColorantCmyk`](../xmpcolorantcmyk) 클래스. |
| [XmpColorantCmyk](xmpcolorantcmyk#constructor_1)(double, double, double, double) | 의 새 인스턴스를 초기화합니다.[`XmpColorantCmyk`](../xmpcolorantcmyk) 클래스. |

## 속성

| 이름 | 설명 |
| --- | --- |
| [Black](../../groupdocs.metadata.standards.xmp/xmpcolorantcmyk/black) { get; set; } | 검은 구성 요소를 가져오거나 설정합니다. |
...
| [Cyan](../../groupdocs.metadata.standards.xmp/xmpcolorantcmyk/cyan) { get; set; } | 청록색 구성 요소를 가져오거나 설정합니다. |
...
| [Magenta](../../groupdocs.metadata.standards.xmp/xmpcolorantcmyk/magenta) { get; set; } | 자홍색 구성 요소를 가져오거나 설정합니다. |
...
| [Yellow](../../groupdocs.metadata.standards.xmp/xmpcolorantcmyk/yellow) { get; set; } | 노란색 구성 요소를 가져오거나 설정합니다. |
...
| 이름 | 설명 |
| --- | --- |
| const [ColorValueMax](../../groupdocs.metadata.standards.xmp/xmpcolorantcmyk/colorvaluemax) | CMYK 착색제의 최대 색상 값. |
| const [ColorValueMin](../../groupdocs.metadata.standards.xmp/xmpcolorantcmyk/colorvaluemin) | CMYK 착색제의 색상 최소값. |
