...
description: OpenType 글꼴 메타데이터 패키지를 나타냅니다.
type: docs
weight: 1530
url: /ko/net/groupdocs.metadata.formats.font/opentypepackage/
---
## OpenTypePackage class

OpenType 글꼴 메타데이터 패키지를 나타냅니다.
...
| [Fonts](../../groupdocs.metadata.formats.font/opentypepackage/fonts) { get; } | 파일에서 추출한 글꼴 배열을 가져옵니다. |
