...
description: 에 대한 이름 레코드 테이블 값을 나타냅니다.Macintosh플랫폼.
type: docs
weight: 1510
url: /ko/net/groupdocs.metadata.formats.font/opentypemacintoshnamerecord/
---
## OpenTypeMacintoshNameRecord class

에 대한 이름 레코드 테이블 값을 나타냅니다.Macintosh플랫폼.
...
| [Encoding](../../groupdocs.metadata.formats.font/opentypemacintoshnamerecord/encoding) { get; } | 인코딩 식별자를 가져옵니다. |
...
| [Language](../../groupdocs.metadata.formats.font/opentypemacintoshnamerecord/language) { get; } | 언어 식별자를 가져옵니다. |
| [MetadataType](../../groupdocs.metadata.common/metadatapackage/metadatatype) { get; } | 메타데이터 유형을 가져옵니다. |
| [NameID](../../groupdocs.metadata.formats.font/opentypebasenamerecord/nameid) { get; } | 이름 식별자를 가져옵니다. |
| [Platform](../../groupdocs.metadata.formats.font/opentypebasenamerecord/platform) { get; } | 플랫폼 식별자를 가져옵니다. |
...
| [Value](../../groupdocs.metadata.formats.font/opentypebasenamerecord/value) { get; } | 레코드의 문자열 값을 가져옵니다. |
