...
description: 에 대한 이름 레코드 테이블 값을 나타냅니다.Windows플랫폼.
type: docs
weight: 1640
url: /ko/net/groupdocs.metadata.formats.font/opentypewindowsnamerecord/
---
## OpenTypeWindowsNameRecord class

에 대한 이름 레코드 테이블 값을 나타냅니다.Windows플랫폼.
...
| [Encoding](../../groupdocs.metadata.formats.font/opentypewindowsnamerecord/encoding) { get; } | 인코딩 식별자를 가져옵니다. |
...
| [Language](../../groupdocs.metadata.formats.font/opentypewindowsnamerecord/language) { get; } | 언어 식별자를 가져옵니다. |
