...
description: 에 대한 이름 레코드 테이블 값을 나타냅니다.Unicode플랫폼.
type: docs
weight: 1580
url: /ko/net/groupdocs.metadata.formats.font/opentypeunicodenamerecord/
---
## OpenTypeUnicodeNameRecord class

에 대한 이름 레코드 테이블 값을 나타냅니다.Unicode플랫폼.
...
| [Encoding](../../groupdocs.metadata.formats.font/opentypeunicodenamerecord/encoding) { get; } | 인코딩 식별자를 가져옵니다. |
