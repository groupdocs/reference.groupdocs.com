...
description: OpenType 글꼴 파일에서 메타데이터 작업을 허용하는 루트 패키지를 나타냅니다.
type: docs
weight: 1550
url: /ko/net/groupdocs.metadata.formats.font/opentyperootpackage/
---
## OpenTypeRootPackage class

OpenType 글꼴 파일에서 메타데이터 작업을 허용하는 루트 패키지를 나타냅니다.
...
| [DigitalSignaturePackage](../../groupdocs.metadata.formats.font/opentyperootpackage/digitalsignaturepackage) { get; } | 디지털 서명 메타데이터 패키지를 가져옵니다. |
...
| [OpenTypePackage](../../groupdocs.metadata.formats.font/opentyperootpackage/opentypepackage) { get; } | OpenType 메타데이터 패키지를 가져옵니다. |
