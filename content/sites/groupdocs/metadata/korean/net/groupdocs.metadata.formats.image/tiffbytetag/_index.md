...
description: 바이트 태그를 나타냅니다.
type: docs
weight: 1960
url: /ko/net/groupdocs.metadata.formats.image/tiffbytetag/
---
## TiffByteTag class
...
| 이름 | 설명 |
| --- | --- |
| [TiffByteTag](tiffbytetag)(TiffTagID, byte[]) | 의 새 인스턴스를 초기화합니다.[`TiffByteTag`](../tiffbytetag) 클래스. |
