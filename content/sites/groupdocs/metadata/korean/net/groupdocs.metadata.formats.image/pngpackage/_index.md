...
description: 기본 PNG 메타데이터를 나타냅니다.
type: docs
weight: 1850
url: /ko/net/groupdocs.metadata.formats.image/pngpackage/
---
## PngPackage class
...
| [TextChunks](../../groupdocs.metadata.formats.image/pngpackage/textchunks) { get; } | 이미지에서 추출한 텍스트 청크 모음을 가져옵니다. |
