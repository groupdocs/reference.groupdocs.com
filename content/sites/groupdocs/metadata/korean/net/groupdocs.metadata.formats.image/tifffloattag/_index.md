...
description: TIFF 부동 태그를 나타냅니다.
type: docs
weight: 1980
url: /ko/net/groupdocs.metadata.formats.image/tifffloattag/
---
## TiffFloatTag class
...
| 이름 | 설명 |
| --- | --- |
| [TiffFloatTag](tifffloattag)(TiffTagID, float[]) | 의 새 인스턴스를 초기화합니다.[`TiffFloatTag`](../tifffloattag) 클래스. |
