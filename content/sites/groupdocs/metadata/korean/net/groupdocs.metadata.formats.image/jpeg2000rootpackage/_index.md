...
description: JPEG2000 이미지의 메타데이터 작업을 위한 루트 패키지를 나타냅니다.
type: docs
weight: 1800
url: /ko/net/groupdocs.metadata.formats.image/jpeg2000rootpackage/
---
## Jpeg2000RootPackage class

JPEG2000 이미지의 메타데이터 작업을 위한 루트 패키지를 나타냅니다.
...
| [ExifPackage](../../groupdocs.metadata.formats.image/jpeg2000rootpackage/exifpackage) { get; set; } | EXIF 메타데이터 패키지를 가져오거나 설정합니다. |
...
| [Jpeg2000Package](../../groupdocs.metadata.formats.image/jpeg2000rootpackage/jpeg2000package) { get; } | JPEG2000 기본 메타데이터 패키지를 가져옵니다. |
...
| [XmpPackage](../../groupdocs.metadata.formats.image/jpeg2000rootpackage/xmppackage) { get; set; } | XMP 메타데이터 패키지를 가져오거나 설정합니다. |
