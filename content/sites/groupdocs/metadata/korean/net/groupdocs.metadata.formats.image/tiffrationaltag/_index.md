...
description: TIFF Rational 태그를 나타냅니다.
type: docs
weight: 2010
url: /ko/net/groupdocs.metadata.formats.image/tiffrationaltag/
---
## TiffRationalTag class

TIFF Rational 태그를 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [TiffRationalTag](tiffrationaltag)(TiffTagID, TiffRational[]) | 의 새 인스턴스를 초기화합니다.[`TiffRationalTag`](../tiffrationaltag) 클래스. |
