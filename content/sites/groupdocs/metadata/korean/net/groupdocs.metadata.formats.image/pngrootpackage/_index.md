...
description: PNG 이미지에서 메타데이터로 작업하기 위한 루트 패키지를 나타냅니다.
type: docs
weight: 1860
url: /ko/net/groupdocs.metadata.formats.image/pngrootpackage/
---
## PngRootPackage class

PNG 이미지에서 메타데이터로 작업하기 위한 루트 패키지를 나타냅니다.
...
| [ExifPackage](../../groupdocs.metadata.formats.image/pngrootpackage/exifpackage) { get; set; } | EXIF 메타데이터 패키지를 가져오거나 설정합니다. |
...
| [PngPackage](../../groupdocs.metadata.formats.image/pngrootpackage/pngpackage) { get; } | PNG 기본 메타데이터 패키지를 가져옵니다. |
...
| [XmpPackage](../../groupdocs.metadata.formats.image/pngrootpackage/xmppackage) { get; set; } | XMP 메타데이터 패키지를 가져오거나 설정합니다. |
...
* [PNG 이미지의 메타데이터 작업](https://docs.groupdocs.com/display/metadatanet/Working+with+metadata+in+PNG+images)
