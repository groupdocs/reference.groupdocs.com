...
description: 기본 Photoshop 메타데이터를 나타냅니다.
type: docs
weight: 1920
url: /ko/net/groupdocs.metadata.formats.image/psdpackage/
---
## PsdPackage class

기본 Photoshop 메타데이터를 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [ChannelCount](../../groupdocs.metadata.formats.image/psdpackage/channelcount) { get; } | 채널 수를 가져옵니다. |
| [ColorMode](../../groupdocs.metadata.formats.image/psdpackage/colormode) { get; } | psd 색상 모드를 가져옵니다. |
| [Compression](../../groupdocs.metadata.formats.image/psdpackage/compression) { get; } | 이미지 데이터에 사용되는 압축 방법을 가져옵니다. |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | 메타데이터 속성의 수를 가져옵니다. |
| [Height](../../groupdocs.metadata.formats.image/psdpackage/height) { get; } | 이미지의 높이를 가져옵니다. |
...
| [Layers](../../groupdocs.metadata.formats.image/psdpackage/layers) { get; } | Photoshop 레이어를 가져옵니다. |
| [MetadataType](../../groupdocs.metadata.common/metadatapackage/metadatatype) { get; } | 메타데이터 유형을 가져옵니다. |
| [PhotoshopVersion](../../groupdocs.metadata.formats.image/psdpackage/photoshopversion) { get; } | Photoshop 버전을 가져옵니다. |
...
| [Width](../../groupdocs.metadata.formats.image/psdpackage/width) { get; } | 이미지의 PSD 너비를 가져옵니다. |
