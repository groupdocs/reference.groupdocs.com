...
description: 이미지별 파일 형식 정보가 포함된 메타데이터 패키지를 나타냅니다.
type: docs
weight: 1780
url: /ko/net/groupdocs.metadata.formats.image/imagetypepackage/
---
## ImageTypePackage class

이미지별 파일 형식 정보가 포함된 메타데이터 패키지를 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [ByteOrder](../../groupdocs.metadata.formats.image/imagetypepackage/byteorder) { get; } | 이미지의 바이트 순서를 가져옵니다. 참조하십시오.[https://en.wikipedia.org/wiki/Endianness](https://en.wikipedia.org/wiki/Endianness) 자세한 내용은. |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | 메타데이터 속성의 수를 가져옵니다. |
| [Extension](../../groupdocs.metadata.common/filetypepackage/extension) { get; } | 파일 확장자를 가져옵니다. |
| [FileFormat](../../groupdocs.metadata.common/filetypepackage/fileformat) { get; } | 파일 형식을 가져옵니다. |
| [Height](../../groupdocs.metadata.formats.image/imagetypepackage/height) { get; } | 이미지 높이를 가져옵니다. |
...
| [MimeType](../../groupdocs.metadata.common/filetypepackage/mimetype) { get; } | MIME 유형을 가져옵니다. |
...
| [Width](../../groupdocs.metadata.formats.image/imagetypepackage/width) { get; } | 이미지 너비를 가져옵니다. |
