...
description: BMP 헤더 정보를 나타냅니다.
type: docs
weight: 1650
url: /ko/net/groupdocs.metadata.formats.image/bmpheaderpackage/
---
...
| 이름 | 설명 |
| --- | --- |
| [BitsPerPixel](../../groupdocs.metadata.formats.image/bmpheaderpackage/bitsperpixel) { get; } | 픽셀 값당 비트를 가져옵니다. |
| [ColorsImportant](../../groupdocs.metadata.formats.image/bmpheaderpackage/colorsimportant) { get; } | 중요한 팔레트 색상의 수를 가져옵니다. |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | 메타데이터 속성의 수를 가져옵니다. |
| [HeaderSize](../../groupdocs.metadata.formats.image/bmpheaderpackage/headersize) { get; } | 헤더 크기를 바이트 단위로 가져옵니다. |
| [ImageSize](../../groupdocs.metadata.formats.image/bmpheaderpackage/imagesize) { get; } | 비트맵 원시 데이터 크기를 바이트 단위로 가져옵니다. |
...
| [Planes](../../groupdocs.metadata.formats.image/bmpheaderpackage/planes) { get; } | 평면 수를 가져옵니다. |
