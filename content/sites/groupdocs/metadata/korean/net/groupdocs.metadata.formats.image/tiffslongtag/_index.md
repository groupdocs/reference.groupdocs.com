...
description: TIFF SLong 태그를 나타냅니다.
type: docs
weight: 2040
url: /ko/net/groupdocs.metadata.formats.image/tiffslongtag/
---
## TiffSLongTag class

TIFF SLong 태그를 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [TiffSLongTag](tiffslongtag)(TiffTagID, int[]) | 의 새 인스턴스를 초기화합니다.[`TiffSLongTag`](../tiffslongtag) 클래스. |
