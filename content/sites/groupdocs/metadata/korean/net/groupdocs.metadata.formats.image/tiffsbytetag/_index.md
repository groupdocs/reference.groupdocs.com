...
description: TIFF SByte 태그를 나타냅니다.
type: docs
weight: 2030
url: /ko/net/groupdocs.metadata.formats.image/tiffsbytetag/
---
## TiffSByteTag class

TIFF SByte 태그를 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [TiffSByteTag](tiffsbytetag)(TiffTagID, sbyte[]) | 의 새 인스턴스를 초기화합니다.[`TiffSByteTag`](../tiffsbytetag) 클래스. |
