...
description: 는 TIFF 짧은 태그를 나타냅니다.
type: docs
weight: 2080
url: /ko/net/groupdocs.metadata.formats.image/tiffshorttag/
---
## TiffShortTag class
...
| 이름 | 설명 |
| --- | --- |
| [TiffShortTag](tiffshorttag)(TiffTagID, ushort[]) | 의 새 인스턴스를 초기화합니다.[`TiffShortTag`](../tiffshorttag) 클래스. |
