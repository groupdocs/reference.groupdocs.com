...
description: 정의되지 않은 유형의 TIFF 태그를 나타냅니다.
type: docs
weight: 2120
url: /ko/net/groupdocs.metadata.formats.image/tiffundefinedtag/
---
## TiffUndefinedTag class

정의되지 않은 유형의 TIFF 태그를 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [TiffUndefinedTag](tiffundefinedtag)(TiffTagID, byte[]) | 의 새 인스턴스를 초기화합니다.[`TiffUndefinedTag`](../tiffundefinedtag) 클래스. |
