...
description: 네이티브 JPEG2000 메타데이터를 나타냅니다.
type: docs
weight: 1790
url: /ko/net/groupdocs.metadata.formats.image/jpeg2000package/
---
## Jpeg2000Package class

네이티브 JPEG2000 메타데이터를 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [Comments](../../groupdocs.metadata.formats.image/jpeg2000package/comments) { get; } | JPEG2000 주석을 가져옵니다. |
