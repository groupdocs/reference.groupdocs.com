...
description: BMP 이미지에서 메타데이터로 작업하기 위한 루트 패키지를 나타냅니다.
type: docs
weight: 1660
url: /ko/net/groupdocs.metadata.formats.image/bmprootpackage/
---
## BmpRootPackage class

BMP 이미지에서 메타데이터로 작업하기 위한 루트 패키지를 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [BmpHeader](../../groupdocs.metadata.formats.image/bmprootpackage/bmpheader) { get; } | BMP 헤더 메타데이터 패키지를 가져옵니다. |
...
이 코드 샘플은 BMP 파일의 헤더를 읽는 방법을 보여줍니다.
