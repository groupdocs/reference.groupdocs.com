...
description: DICOM 이미지에서 메타데이터로 작업하기 위한 루트 패키지를 나타냅니다.
type: docs
weight: 1680
url: /ko/net/groupdocs.metadata.formats.image/dicomrootpackage/
---
## DicomRootPackage class

DICOM 이미지에서 메타데이터로 작업하기 위한 루트 패키지를 나타냅니다.
...
| [DicomPackage](../../groupdocs.metadata.formats.image/dicomrootpackage/dicompackage) { get; } | DICOM 기본 메타데이터 패키지를 가져옵니다. |
...
이 예는 DICOM 형식별 메타데이터 속성을 읽는 방법을 보여줍니다.
