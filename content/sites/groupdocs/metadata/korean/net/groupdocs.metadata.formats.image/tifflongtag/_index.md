...
description: TIFF 긴 태그를 나타냅니다.
type: docs
weight: 1990
url: /ko/net/groupdocs.metadata.formats.image/tifflongtag/
---
## TiffLongTag class
...
| 이름 | 설명 |
| --- | --- |
| [TiffLongTag](tifflongtag)(TiffTagID, uint[]) | 의 새 인스턴스를 초기화합니다.[`TiffLongTag`](../tifflongtag) 클래스. |
