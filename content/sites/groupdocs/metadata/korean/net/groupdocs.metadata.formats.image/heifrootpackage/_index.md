...
description: HEIF 이미지에서 메타데이터로 작업하기 위한 루트 패키지를 나타냅니다.
type: docs
weight: 1730
url: /ko/net/groupdocs.metadata.formats.image/heifrootpackage/
---
## HeifRootPackage class

HEIF 이미지에서 메타데이터로 작업하기 위한 루트 패키지를 나타냅니다.
...
| [ExifPackage](../../groupdocs.metadata.formats.image/heifrootpackage/exifpackage) { get; set; } | EXIF 메타데이터 패키지를 가져오거나 설정합니다. |
...
| [XmpPackage](../../groupdocs.metadata.formats.image/heifrootpackage/xmppackage) { get; set; } | XMP 메타데이터 패키지를 가져오거나 설정합니다. |
