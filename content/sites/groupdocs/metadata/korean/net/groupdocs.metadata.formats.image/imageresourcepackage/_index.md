...
description: Photoshop 이미지 리소스를 포함하는 메타데이터 패키지를 나타냅니다.
type: docs
weight: 1760
url: /ko/net/groupdocs.metadata.formats.image/imageresourcepackage/
---
## ImageResourcePackage class

Photoshop 이미지 리소스를 포함하는 메타데이터 패키지를 나타냅니다.
...
| [ToList](../../groupdocs.metadata.formats.image/imageresourcepackage/tolist)() | 패키지에서 목록을 만듭니다. |
