...
description: TIFF SRational 태그를 나타냅니다.
type: docs
weight: 2060
url: /ko/net/groupdocs.metadata.formats.image/tiffsrationaltag/
---
## TiffSRationalTag class

TIFF SRational 태그를 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [TiffSRationalTag](tiffsrationaltag)(TiffTagID, TiffSRational[]) | 의 새 인스턴스를 초기화합니다.[`TiffSRationalTag`](../tiffsrationaltag) 클래스. |
