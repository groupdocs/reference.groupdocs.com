...
description: TIFF ASCII 태그를 나타냅니다.
type: docs
weight: 1950
url: /ko/net/groupdocs.metadata.formats.image/tiffasciitag/
---
## TiffAsciiTag class

TIFF ASCII 태그를 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [TiffAsciiTag](tiffasciitag)(TiffTagID, string) | 의 새 인스턴스를 초기화합니다.[`TiffAsciiTag`](../tiffasciitag) 클래스. |
...
| [TagValue](../../groupdocs.metadata.formats.image/tiffasciitag/tagvalue) { get; } | 태그 값을 가져옵니다. |
