...
type: docs
weight: 20
url: /ko/net/groupdocs.metadata.formats.image/jpegrootpackage/imageresourcepackage/
---
...
아래 코드 샘플은 JPEG 이미지에서 이미지 리소스 블록(Photoshop 파일 형식의 빌딩 블록)을 추출하는 방법을 보여줍니다.
