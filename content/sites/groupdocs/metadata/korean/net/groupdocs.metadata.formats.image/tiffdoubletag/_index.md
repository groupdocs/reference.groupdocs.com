...
description: TIFF 이중 태그를 나타냅니다.
type: docs
weight: 1970
url: /ko/net/groupdocs.metadata.formats.image/tiffdoubletag/
---
## TiffDoubleTag class
...
| 이름 | 설명 |
| --- | --- |
| [TiffDoubleTag](tiffdoubletag)(TiffTagID, double[]) | 의 새 인스턴스를 초기화합니다.[`TiffDoubleTag`](../tiffdoubletag) 클래스. |
