...
description: EML 電子メール メッセージでメタデータを操作できるようにするルート パッケージを表します
type: docs
weight: 1390
url: /ja/net/groupdocs.metadata.formats.email/emlrootpackage/
---
## EmlRootPackage class

EML 電子メール メッセージでメタデータを操作できるようにするルート パッケージを表します。
...
| [EmailPackage](../../groupdocs.metadata.formats.email/emlrootpackage/emailpackage) { get; } | EML メタデータ パッケージを取得します。 (2 properties) |
...
このコード サンプルは、EML メッセージからメタデータを抽出する方法を示しています。
