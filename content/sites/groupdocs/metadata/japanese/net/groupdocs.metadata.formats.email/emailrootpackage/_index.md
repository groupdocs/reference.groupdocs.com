...
description: 電子メール メッセージ内のメタデータを操作できるルート パッケージを表します
type: docs
weight: 1370
url: /ja/net/groupdocs.metadata.formats.email/emailrootpackage/
---
## EmailRootPackage class

電子メール メッセージ内のメタデータを操作できるルート パッケージを表します。
...
| [EmailPackage](../../groupdocs.metadata.formats.email/emailrootpackage/emailpackage) { get; } | 電子メール メタデータ パッケージを取得します。 |
