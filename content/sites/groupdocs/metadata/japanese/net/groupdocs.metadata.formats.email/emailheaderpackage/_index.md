...
description: 電子メール メッセージ ヘッダーを含むメタデータ パッケージを表します
type: docs
weight: 1350
url: /ja/net/groupdocs.metadata.formats.email/emailheaderpackage/
---
## EmailHeaderPackage class

電子メール メッセージ ヘッダーを含むメタデータ パッケージを表します。
...
| [Get](../../groupdocs.metadata.formats.email/emailheaderpackage/get)(string) | 指定されたヘッダーの値を取得します。 |
