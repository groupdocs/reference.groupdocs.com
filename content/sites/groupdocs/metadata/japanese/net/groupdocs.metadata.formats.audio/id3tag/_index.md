...
description: ID3v1 および ID3v2 オーディオ タグの基本抽象クラスを表します
type: docs
weight: 390
url: /ja/net/groupdocs.metadata.formats.audio/id3tag/
---
## ID3Tag class

ID3(v1) および ID3(v2) オーディオ タグの基本抽象クラスを表します。
...
| abstract [Version](../../groupdocs.metadata.formats.audio/id3tag/version) { get; } | ID3 タグのバージョンを文字列形式で取得します。例: 'ID3v1.1'. |
