...
description: の APIC フレームを表しますID3V2Tag./id3v2tag.
type: docs
weight: 420
url: /ja/net/groupdocs.metadata.formats.audio/id3v2attachedpictureframe/
---
## ID3V2AttachedPictureFrame class

の APIC フレームを表します。[`ID3V2Tag`](../id3v2tag).
...
| 名前 | 説明 |
| --- | --- |
| [ID3V2AttachedPictureFrame](id3v2attachedpictureframe#constructor)(byte[]) | の新しいインスタンスを初期化します[`ID3V2AttachedPictureFrame`](../id3v2attachedpictureframe)class. |
| [ID3V2AttachedPictureFrame](id3v2attachedpictureframe#constructor_1)(ID3V2AttachedPictureType, string, byte[]) | の新しいインスタンスを初期化します[`ID3V2AttachedPictureFrame`](../id3v2attachedpictureframe)class. |
| [ID3V2AttachedPictureFrame](id3v2attachedpictureframe#constructor_2)(ID3V2EncodingType, string, ID3V2AttachedPictureType, string, byte[]) | の新しいインスタンスを初期化します[`ID3V2AttachedPictureFrame`](../id3v2attachedpictureframe)class. |

## プロパティ

| 名前 | 説明 |
| --- | --- |
| [AttachedPictureType](../../groupdocs.metadata.formats.audio/id3v2attachedpictureframe/attachedpicturetype) { get; } | ピクチャのタイプを取得します。 |
...
| [Description](../../groupdocs.metadata.formats.audio/id3v2attachedpictureframe/description) { get; } | 画像の説明を取得します. 説明の最大長は 64 文字ですが、空にすることもできます. |
| [DescriptionEncoding](../../groupdocs.metadata.formats.audio/id3v2attachedpictureframe/descriptionencoding) { get; } | 画像の説明をエンコードするために使用されるエンコードを取得します. |
...
| [MimeType](../../groupdocs.metadata.formats.audio/id3v2attachedpictureframe/mimetype) { get; } | 画像の MIME タイプを取得します。 |
| [PictureData](../../groupdocs.metadata.formats.audio/id3v2attachedpictureframe/picturedata) { get; } | 画像データを取得します。 |
