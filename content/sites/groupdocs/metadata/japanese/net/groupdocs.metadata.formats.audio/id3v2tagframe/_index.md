...
description: の汎用フレームを表しますID3V2Tag./id3v2tag.
type: docs
weight: 500
url: /ja/net/groupdocs.metadata.formats.audio/id3v2tagframe/
---
## ID3V2TagFrame class

の汎用フレームを表します[`ID3V2Tag`](../id3v2tag).
...
| 名前 | 説明 |
| --- | --- |
| [ID3V2TagFrame](id3v2tagframe)(string, byte[]) | の新しいインスタンスを初期化します[`ID3V2TagFrame`](../id3v2tagframe)class. |
