...
description: 内の URL リンク フレームを表しますID3V2Tag./id3v2tag.フレームの名前は常に W 文字で始まります
type: docs
weight: 530
url: /ja/net/groupdocs.metadata.formats.audio/id3v2urllinkframe/
---
## ID3V2UrlLinkFrame class

内の URL リンク フレームを表します。[`ID3V2Tag`](../id3v2tag).フレームの名前は常に W 文字で始まります。
...
| 名前 | 説明 |
| --- | --- |
| [ID3V2UrlLinkFrame](id3v2urllinkframe)(string, string) | の新しいインスタンスを初期化します[`ID3V2UrlLinkFrame`](../id3v2urllinkframe)class. |
...
| [Url](../../groupdocs.metadata.formats.audio/id3v2urllinkframe/url) { get; } | URL 値を取得します。 |
