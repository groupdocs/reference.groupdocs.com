...
description: の COMM フレームを表しますID3V2Tag./id3v2tag.
type: docs
weight: 440
url: /ja/net/groupdocs.metadata.formats.audio/id3v2commentframe/
---
## ID3V2CommentFrame class

の COMM フレームを表します。[`ID3V2Tag`](../id3v2tag).
...
| 名前 | 説明 |
| --- | --- |
| [ID3V2CommentFrame](id3v2commentframe)(ID3V2EncodingType, string, string, string) | の新しいインスタンスを初期化します[`ID3V2CommentFrame`](../id3v2commentframe)class. |

## プロパティ

| 名前 | 説明 |
| --- | --- |
| [CommentEncoding](../../groupdocs.metadata.formats.audio/id3v2commentframe/commentencoding) { get; } | コメントのエンコーディングを取得します。 |
...
| [Language](../../groupdocs.metadata.formats.audio/id3v2commentframe/language) { get; } | コメントの言語を取得します (3 文字). |
...
| [ShortContentDescription](../../groupdocs.metadata.formats.audio/id3v2commentframe/shortcontentdescription) { get; } | コンテンツの短い説明を取得します。 |
| [Text](../../groupdocs.metadata.formats.audio/id3v2commentframe/text) { get; } | コメントのテキストを取得します。 |
...
このフレームは、他のフレームに収まらないあらゆる種類の全文情報を対象としています。
