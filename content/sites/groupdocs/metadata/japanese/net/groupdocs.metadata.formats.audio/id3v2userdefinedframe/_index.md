...
description: の TXXX フレームを表しますID3V2Tag./id3v2tag.
type: docs
weight: 540
url: /ja/net/groupdocs.metadata.formats.audio/id3v2userdefinedframe/
---
## ID3V2UserDefinedFrame class

の TXXX フレームを表します。[`ID3V2Tag`](../id3v2tag).
...
| 名前 | 説明 |
| --- | --- |
| [ID3V2UserDefinedFrame](id3v2userdefinedframe#constructor_1)(string, string) | の新しいインスタンスを初期化します[`ID3V2UserDefinedFrame`](../id3v2userdefinedframe)class. |
| [ID3V2UserDefinedFrame](id3v2userdefinedframe#constructor)(ID3V2EncodingType, string, string) | の新しいインスタンスを初期化します[`ID3V2UserDefinedFrame`](../id3v2userdefinedframe)class. |
...
| [Description](../../groupdocs.metadata.formats.audio/id3v2userdefinedframe/description) { get; } | 説明を取得します。 |
| [Encoding](../../groupdocs.metadata.formats.audio/id3v2userdefinedframe/encoding) { get; } | フレームのエンコーディングを取得します。 |
...
| [Value](../../groupdocs.metadata.formats.audio/id3v2userdefinedframe/value) { get; } | 値を取得します。 |
