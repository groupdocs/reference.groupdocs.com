...
description: の WXXX フレームを表しますID3V2Tag./id3v2tag.
type: docs
weight: 550
url: /ja/net/groupdocs.metadata.formats.audio/id3v2userdefinedurllinkframe/
---
## ID3V2UserDefinedUrlLinkFrame class

の WXXX フレームを表します。[`ID3V2Tag`](../id3v2tag).
...
| 名前 | 説明 |
| --- | --- |
| [ID3V2UserDefinedUrlLinkFrame](id3v2userdefinedurllinkframe#constructor_1)(string, string) | の新しいインスタンスを初期化します[`ID3V2UserDefinedUrlLinkFrame`](../id3v2userdefinedurllinkframe)class. |
| [ID3V2UserDefinedUrlLinkFrame](id3v2userdefinedurllinkframe#constructor)(ID3V2EncodingType, string, string) | の新しいインスタンスを初期化します[`ID3V2UserDefinedUrlLinkFrame`](../id3v2userdefinedurllinkframe)class. |
...
| [Description](../../groupdocs.metadata.formats.audio/id3v2userdefinedurllinkframe/description) { get; } | 説明を取得します。 |
| [Encoding](../../groupdocs.metadata.formats.audio/id3v2userdefinedurllinkframe/encoding) { get; } | フレームのエンコーディングを取得します。 |
...
| [Url](../../groupdocs.metadata.formats.audio/id3v2userdefinedurllinkframe/url) { get; } | URL を取得します。 |
