...
description: PRIV フレームを表しますID3V2Tag./id3v2tag . フレームはそのプログラムが を使用し他のフレームに適合しないというソフトウェア プロデューサーからの情報を含めるために使用されます
type: docs
weight: 480
url: /ja/net/groupdocs.metadata.formats.audio/id3v2privateframe/
---
## ID3V2PrivateFrame class

PRIV フレームを表します。[`ID3V2Tag`](../id3v2tag) . フレームは、そのプログラムが を使用し、他のフレームに適合しないというソフトウェア プロデューサーからの情報を含めるために使用されます。
...
| 名前 | 説明 |
| --- | --- |
| [ID3V2PrivateFrame](id3v2privateframe)(string, byte[]) | の新しいインスタンスを初期化します[`ID3V2PrivateFrame`](../id3v2privateframe)class. |

## プロパティ

| 名前 | 説明 |
| --- | --- |
| [BinaryData](../../groupdocs.metadata.formats.audio/id3v2privateframe/binarydata) { get; } | バイナリデータを取得します。 |
...
| [OwnerIdentifier](../../groupdocs.metadata.formats.audio/id3v2privateframe/owneridentifier) { get; } | 所有者識別子を取得します。 |
