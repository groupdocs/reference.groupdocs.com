...
description: のテキスト フレームを表しますID3V2Tag./id3v2tag. T 文字で始まるほとんどすべてのフレームがこのカテゴリに分類されます例外は 1 つだけですID3V2UserDefinedFrame./id3v2userdefinedframeclass.
type: docs
weight: 520
url: /ja/net/groupdocs.metadata.formats.audio/id3v2textframe/
---
## ID3V2TextFrame class

のテキスト フレームを表します[`ID3V2Tag`](../id3v2tag). T 文字で始まるほとんどすべてのフレームがこのカテゴリに分類されます。例外は 1 つだけです。[`ID3V2UserDefinedFrame`](../id3v2userdefinedframe)class.
...
| 名前 | 説明 |
| --- | --- |
| [ID3V2TextFrame](id3v2textframe)(string, ID3V2EncodingType, string) | の新しいインスタンスを初期化します[`ID3V2TextFrame`](../id3v2textframe)class. |
...
| [Text](../../groupdocs.metadata.formats.audio/id3v2textframe/text) { get; } | テキスト値を取得します。 |
| [TextEncoding](../../groupdocs.metadata.formats.audio/id3v2textframe/textencoding) { get; } | テキストのエンコーディングを取得します。 |
