...
description: の Name レコード テーブルの値を表しますMacintoshplatform.
type: docs
weight: 1510
url: /ja/net/groupdocs.metadata.formats.font/opentypemacintoshnamerecord/
---
## OpenTypeMacintoshNameRecord class

の Name レコード テーブルの値を表します。Macintoshplatform.
...
| [Encoding](../../groupdocs.metadata.formats.font/opentypemacintoshnamerecord/encoding) { get; } | エンコーディング識別子を取得します。 |
...
| [Language](../../groupdocs.metadata.formats.font/opentypemacintoshnamerecord/language) { get; } | 言語識別子を取得します。 |
| [MetadataType](../../groupdocs.metadata.common/metadatapackage/metadatatype) { get; } | メタデータ タイプを取得します。 |
| [NameID](../../groupdocs.metadata.formats.font/opentypebasenamerecord/nameid) { get; } | 名前識別子を取得します。 |
| [Platform](../../groupdocs.metadata.formats.font/opentypebasenamerecord/platform) { get; } | プラットフォーム識別子を取得します。 |
...
| [Value](../../groupdocs.metadata.formats.font/opentypebasenamerecord/value) { get; } | レコードの文字列値を取得します。 |
