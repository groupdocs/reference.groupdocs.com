...
description: の Name レコード テーブルの値を表しますUnicodeplatform.
type: docs
weight: 1580
url: /ja/net/groupdocs.metadata.formats.font/opentypeunicodenamerecord/
---
## OpenTypeUnicodeNameRecord class

の Name レコード テーブルの値を表します。Unicodeplatform.
...
| [Encoding](../../groupdocs.metadata.formats.font/opentypeunicodenamerecord/encoding) { get; } | エンコーディング識別子を取得します。 |
