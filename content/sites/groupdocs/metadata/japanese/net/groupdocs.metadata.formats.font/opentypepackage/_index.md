...
description: OpenType フォント メタデータ パッケージを表します
type: docs
weight: 1530
url: /ja/net/groupdocs.metadata.formats.font/opentypepackage/
---
## OpenTypePackage class

OpenType フォント メタデータ パッケージを表します。
...
| [Fonts](../../groupdocs.metadata.formats.font/opentypepackage/fonts) { get; } | ファイルから抽出されたフォントの配列を取得します。 |
