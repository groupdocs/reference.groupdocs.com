...
description: デジタル署名メタデータ パッケージを取得します
type: docs
weight: 10
url: /ja/net/groupdocs.metadata.formats.font/opentyperootpackage/digitalsignaturepackage/
---
## OpenTypeRootPackage.DigitalSignaturePackage property

デジタル署名メタデータ パッケージを取得します。
...
このコード スニペットは、OpenType フォントに関連付けられたデジタル署名を抽出する方法を示しています。
