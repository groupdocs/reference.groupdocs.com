...
description: OpenType フォント ファイルのメタデータを操作できるルート パッケージを表します
type: docs
weight: 1550
url: /ja/net/groupdocs.metadata.formats.font/opentyperootpackage/
---
## OpenTypeRootPackage class

OpenType フォント ファイルのメタデータを操作できるルート パッケージを表します。
...
| [DigitalSignaturePackage](../../groupdocs.metadata.formats.font/opentyperootpackage/digitalsignaturepackage) { get; } | デジタル署名メタデータ パッケージを取得します。 |
...
| [OpenTypePackage](../../groupdocs.metadata.formats.font/opentyperootpackage/opentypepackage) { get; } | OpenType メタデータ パッケージを取得します。 |
