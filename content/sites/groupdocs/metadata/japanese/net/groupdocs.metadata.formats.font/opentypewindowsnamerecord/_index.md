...
description: の名前レコード テーブルの値を表しますWindowsplatform.
type: docs
weight: 1640
url: /ja/net/groupdocs.metadata.formats.font/opentypewindowsnamerecord/
---
## OpenTypeWindowsNameRecord class

の名前レコード テーブルの値を表しますWindowsplatform.
...
| [Encoding](../../groupdocs.metadata.formats.font/opentypewindowsnamerecord/encoding) { get; } | エンコーディング識別子を取得します。 |
...
| [Language](../../groupdocs.metadata.formats.font/opentypewindowsnamerecord/language) { get; } | 言語識別子を取得します。 |
