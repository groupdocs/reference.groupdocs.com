...
description: BMP イメージ内のメタデータを操作するためのルート パッケージを表します
type: docs
weight: 1660
url: /ja/net/groupdocs.metadata.formats.image/bmprootpackage/
---
## BmpRootPackage class

BMP イメージ内のメタデータを操作するためのルート パッケージを表します。
...
| 名前 | 説明 |
| --- | --- |
| [BmpHeader](../../groupdocs.metadata.formats.image/bmprootpackage/bmpheader) { get; } | BMP ヘッダー メタデータ パッケージを取得します。 |
...
このコード サンプルは、BMP ファイルのヘッダーを読み取る方法を示しています。
