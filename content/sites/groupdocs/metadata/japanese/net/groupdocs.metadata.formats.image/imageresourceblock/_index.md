...
description: Photoshop Image Resource ブロックを表します  画像リソース ブロックはPhotoshop のネイティブ ファイル形式JPEGTIFF などいくつかのファイル形式の基本的な構成単位です 画像リソースはペン ツール パスなど画像に関連付けられた非ピクセル データを格納するために使用されます
type: docs
weight: 1740
url: /ja/net/groupdocs.metadata.formats.image/imageresourceblock/
---
## ImageResourceBlock class

Photoshop Image Resource ブロックを表します。  画像リソース ブロックは、Photoshop のネイティブ ファイル形式、JPEG、TIFF など、いくつかのファイル形式の基本的な構成単位です。 画像リソースは、ペン ツール パスなど、画像に関連付けられた非ピクセル データを格納するために使用されます。
...
| [Data](../../groupdocs.metadata.formats.image/imageresourceblock/data) { get; } | リソースデータを取得します。 |
| [ID](../../groupdocs.metadata.formats.image/imageresourceblock/id) { get; } | リソースの一意の識別子を取得します。 |
...
| [Name](../../groupdocs.metadata.formats.image/imageresourceblock/name) { get; } | 画像リソースブロック名を取得します. |
...
| [Signature](../../groupdocs.metadata.formats.image/imageresourceblock/signature) { get; } | 画像リソース ブロック署名を取得します。 |
