...
description: Photoshop 画像リソースを含むメタデータ パッケージを表します
type: docs
weight: 1760
url: /ja/net/groupdocs.metadata.formats.image/imageresourcepackage/
---
## ImageResourcePackage class

Photoshop 画像リソースを含むメタデータ パッケージを表します。
...
| [ToList](../../groupdocs.metadata.formats.image/imageresourcepackage/tolist)() | パッケージからリストを作成します。 |
