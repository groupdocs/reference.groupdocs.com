...
description: WEBP イメージのメタデータを操作できるルート パッケージを表します
type: docs
weight: 2130
url: /ja/net/groupdocs.metadata.formats.image/webprootpackage/
---
## WebPRootPackage class

WEBP イメージのメタデータを操作できるルート パッケージを表します。
...
| [ExifPackage](../../groupdocs.metadata.formats.image/webprootpackage/exifpackage) { get; set; } | EXIF メタデータ パッケージを取得または設定します。 |
...
| [XmpPackage](../../groupdocs.metadata.formats.image/webprootpackage/xmppackage) { get; set; } | XMP メタデータ パッケージを取得または設定します。 |
