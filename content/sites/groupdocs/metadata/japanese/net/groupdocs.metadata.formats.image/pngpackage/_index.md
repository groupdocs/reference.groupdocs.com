...
description: ネイティブの PNG メタデータを表します
type: docs
weight: 1850
url: /ja/net/groupdocs.metadata.formats.image/pngpackage/
---
## PngPackage class

ネイティブの PNG メタデータを表します。
...
| [TextChunks](../../groupdocs.metadata.formats.image/pngpackage/textchunks) { get; } | 画像から抽出されたテキスト チャンクのコレクションを取得します。 |
