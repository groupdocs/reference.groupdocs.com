...
description: PNG 画像のメタデータを操作するためのルート パッケージを表します
type: docs
weight: 1860
url: /ja/net/groupdocs.metadata.formats.image/pngrootpackage/
---
## PngRootPackage class

PNG 画像のメタデータを操作するためのルート パッケージを表します。
...
| [ExifPackage](../../groupdocs.metadata.formats.image/pngrootpackage/exifpackage) { get; set; } | EXIF メタデータ パッケージを取得または設定します。 |
...
| [PngPackage](../../groupdocs.metadata.formats.image/pngrootpackage/pngpackage) { get; } | PNG ネイティブ メタデータ パッケージを取得します。 |
...
| [XmpPackage](../../groupdocs.metadata.formats.image/pngrootpackage/xmppackage) { get; set; } | XMP メタデータ パッケージを取得または設定します。 |
...
* [PNG 画像のメタデータの操作](https://docs.groupdocs.com/display/metadatanet/Working+with+metadata+in+PNG+images)
