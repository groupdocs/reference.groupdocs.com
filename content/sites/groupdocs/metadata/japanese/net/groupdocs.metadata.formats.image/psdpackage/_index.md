...
description: ネイティブの Photoshop メタデータを表します
type: docs
weight: 1920
url: /ja/net/groupdocs.metadata.formats.image/psdpackage/
---
## PsdPackage class

ネイティブの Photoshop メタデータを表します。
...
| 名前 | 説明 |
| --- | --- |
| [ChannelCount](../../groupdocs.metadata.formats.image/psdpackage/channelcount) { get; } | チャネル数を取得します。 |
| [ColorMode](../../groupdocs.metadata.formats.image/psdpackage/colormode) { get; } | psd カラー モードを取得します。 |
| [Compression](../../groupdocs.metadata.formats.image/psdpackage/compression) { get; } | 画像データの圧縮方式を取得します。 |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | メタデータ プロパティの数を取得します。 |
| [Height](../../groupdocs.metadata.formats.image/psdpackage/height) { get; } | 画像の高さを取得します. |
...
| [Layers](../../groupdocs.metadata.formats.image/psdpackage/layers) { get; } | Photoshop レイヤーを取得します。 |
| [MetadataType](../../groupdocs.metadata.common/metadatapackage/metadatatype) { get; } | メタデータ タイプを取得します。 |
| [PhotoshopVersion](../../groupdocs.metadata.formats.image/psdpackage/photoshopversion) { get; } | Photoshop のバージョンを取得します。 |
...
| [Width](../../groupdocs.metadata.formats.image/psdpackage/width) { get; } | 画像の PSD 幅を取得します。 |
