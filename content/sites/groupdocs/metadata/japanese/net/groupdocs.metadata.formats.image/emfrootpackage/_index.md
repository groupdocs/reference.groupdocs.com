...
description: EMF イメージ内のメタデータを操作するためのルート パッケージを表します
type: docs
weight: 1700
url: /ja/net/groupdocs.metadata.formats.image/emfrootpackage/
---
## EmfRootPackage class

EMF イメージ内のメタデータを操作するためのルート パッケージを表します。

```csharp
public class EmfRootPackage : ImageRootPackage
```
