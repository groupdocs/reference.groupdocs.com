...
description: ネイティブ DICOM メタデータを表します
type: docs
weight: 1670
url: /ja/net/groupdocs.metadata.formats.image/dicompackage/
---
## DicomPackage class

ネイティブ DICOM メタデータを表します。
...
| 名前 | 説明 |
| --- | --- |
| [DicomPackage](dicompackage)() | の新しいインスタンスを初期化します[`Metadata`](../../groupdocs.metadata/metadata)class. |

## プロパティ

| 名前 | 説明 |
| --- | --- |
| [BitsAllocated](../../groupdocs.metadata.formats.image/dicompackage/bitsallocated) { get; } | ビット割り当て値を取得します。 |
| [Blues](../../groupdocs.metadata.formats.image/dicompackage/blues) { get; } | 青の配列色を取得します。 |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | メタデータ プロパティの数を取得します。 |
| [DicomInfo](../../groupdocs.metadata.formats.image/dicompackage/dicominfo) { get; } | DICOM ファイルのヘッダー情報を取得します。 |
| [Greens](../../groupdocs.metadata.formats.image/dicompackage/greens) { get; } | 緑の配列色を取得します。 |
| [HeaderBytes](../../groupdocs.metadata.formats.image/dicompackage/headerbytes) { get; } | ヘッダー情報をバイト単位で取得します。 |
| [HeaderOffset](../../groupdocs.metadata.formats.image/dicompackage/headeroffset) { get; } | ヘッダーのオフセットを取得します。 |
...
| [NumberOfFrames](../../groupdocs.metadata.formats.image/dicompackage/numberofframes) { get; } | フレーム数を取得します。 |
...
| [Reds](../../groupdocs.metadata.formats.image/dicompackage/reds) { get; } | 赤の配列色を取得します。 |
