...
description: TIFF 画像のメタデータを操作できるルート パッケージを表します
type: docs
weight: 2020
url: /ja/net/groupdocs.metadata.formats.image/tiffrootpackage/
---
## TiffRootPackage class

TIFF 画像のメタデータを操作できるルート パッケージを表します。
...
| [ExifPackage](../../groupdocs.metadata.formats.image/tiffrootpackage/exifpackage) { get; set; } | EXIF メタデータ パッケージを取得または設定します。 |
| [FileType](../../groupdocs.metadata.formats.image/imagerootpackage/filetype) { get; } | ファイルの種類のメタデータ パッケージを取得します。 (2 properties) |
| [IptcPackage](../../groupdocs.metadata.formats.image/tiffrootpackage/iptcpackage) { get; set; } | IPTC メタデータ パッケージを取得または設定します。 |
...
| [XmpPackage](../../groupdocs.metadata.formats.image/tiffrootpackage/xmppackage) { get; set; } | XMP メタデータ パッケージを取得または設定します。 |
...
* [TIFF 画像のメタデータの操作](https://docs.groupdocs.com/display/metadatanet/Working+with+metadata+in+TIFF+images)
