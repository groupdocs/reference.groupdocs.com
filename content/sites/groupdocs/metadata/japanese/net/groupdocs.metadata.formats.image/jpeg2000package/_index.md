...
description: ネイティブ JPEG2000 メタデータを表します
type: docs
weight: 1790
url: /ja/net/groupdocs.metadata.formats.image/jpeg2000package/
---
## Jpeg2000Package class

ネイティブ JPEG2000 メタデータを表します。
...
| 名前 | 説明 |
| --- | --- |
| [Comments](../../groupdocs.metadata.formats.image/jpeg2000package/comments) { get; } | JPEG2000 コメントを取得します。 |
