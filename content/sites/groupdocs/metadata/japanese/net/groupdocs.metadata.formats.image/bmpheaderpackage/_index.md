...
description: BMP ヘッダー情報を表します
type: docs
weight: 1650
url: /ja/net/groupdocs.metadata.formats.image/bmpheaderpackage/
---
...
| 名前 | 説明 |
| --- | --- |
| [BitsPerPixel](../../groupdocs.metadata.formats.image/bmpheaderpackage/bitsperpixel) { get; } | ピクセルあたりのビット数を取得します。 |
| [ColorsImportant](../../groupdocs.metadata.formats.image/bmpheaderpackage/colorsimportant) { get; } | 重要なパレット色の数を取得します. |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | メタデータ プロパティの数を取得します。 |
| [HeaderSize](../../groupdocs.metadata.formats.image/bmpheaderpackage/headersize) { get; } | ヘッダーのサイズをバイト単位で取得します。 |
| [ImageSize](../../groupdocs.metadata.formats.image/bmpheaderpackage/imagesize) { get; } | ビットマップ生データ サイズをバイト単位で取得します。 |
...
| [Planes](../../groupdocs.metadata.formats.image/bmpheaderpackage/planes) { get; } | 平面の数を取得します。 |
