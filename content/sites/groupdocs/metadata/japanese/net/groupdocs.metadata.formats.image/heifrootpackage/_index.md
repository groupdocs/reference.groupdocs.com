...
description: HEIF 画像のメタデータを操作するためのルート パッケージを表します
type: docs
weight: 1730
url: /ja/net/groupdocs.metadata.formats.image/heifrootpackage/
---
## HeifRootPackage class

HEIF 画像のメタデータを操作するためのルート パッケージを表します。
...
| [ExifPackage](../../groupdocs.metadata.formats.image/heifrootpackage/exifpackage) { get; set; } | EXIF メタデータ パッケージを取得または設定します。 |
...
| [XmpPackage](../../groupdocs.metadata.formats.image/heifrootpackage/xmppackage) { get; set; } | XMP メタデータ パッケージを取得または設定します。 |
