...
description: 描画オブジェクトの寸法を含む.
type: docs
weight: 3380
url: /ja/net/groupdocs.metadata.standards.xmp/xmpdimensions/
---
## XmpDimensions class
...
| 名前 | 説明 |
| --- | --- |
| [XmpDimensions](xmpdimensions#constructor)() | の新しいインスタンスを初期化します[`XmpDimensions`](../xmpdimensions)class. |
| [XmpDimensions](xmpdimensions#constructor_1)(double, double) | の新しいインスタンスを初期化します[`XmpDimensions`](../xmpdimensions)class. |
...
| [Height](../../groupdocs.metadata.standards.xmp/xmpdimensions/height) { get; set; } | 高さを取得または設定します。 |
...
| [Units](../../groupdocs.metadata.standards.xmp/xmpdimensions/units) { get; set; } | 単位を取得または設定します。 |
| [Width](../../groupdocs.metadata.standards.xmp/xmpdimensions/width) { get; set; } | 幅を取得または設定します。 |
