...
description: XMP メタデータ プロパティのコンテナーを表します
type: docs
weight: 3470
url: /ja/net/groupdocs.metadata.standards.xmp/xmpmetadatacontainer/
---
## XmpMetadataContainer class

XMP メタデータ プロパティのコンテナーを表します。
...
| abstract [GetXmpRepresentation](../../groupdocs.metadata.standards.xmp/xmpmetadatacontainer/getxmprepresentation)() | XMP 値を XML 表現に変換します。 |
