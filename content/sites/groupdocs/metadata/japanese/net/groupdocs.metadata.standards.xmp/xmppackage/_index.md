...
description: XMP パッケージの基本抽象化を表します
type: docs
weight: 3490
url: /ja/net/groupdocs.metadata.standards.xmp/xmppackage/
---
## XmpPackage class
...
| 名前 | 説明 |
| --- | --- |
| [XmpPackage](xmppackage)(string, string) | の新しいインスタンスを初期化します[`XmpPackage`](../xmppackage)class. |
...
| [Set](../../groupdocs.metadata.standards.xmp/xmppackage/set#set)(string, bool) | ブール値のプロパティを設定します。 |
| [Set](../../groupdocs.metadata.standards.xmp/xmppackage/set#set_6)(string, DateTime) | セットDateTimeプロパティ. |
| [Set](../../groupdocs.metadata.standards.xmp/xmppackage/set#set_1)(string, double) | double プロパティを設定します。 |
| [Set](../../groupdocs.metadata.standards.xmp/xmppackage/set#set_5)(string, int) | 整数プロパティを設定します。 |
| virtual [Set](../../groupdocs.metadata.standards.xmp/xmppackage/set#set_7)(string, string) | 文字列プロパティを設定します。 |
| virtual [Set](../../groupdocs.metadata.standards.xmp/xmppackage/set#set_2)(string, XmpArray) | から継承された値を設定します[`XmpArray`](../xmparray). |
| virtual [Set](../../groupdocs.metadata.standards.xmp/xmppackage/set#set_3)(string, XmpComplexType) | から継承された値を設定します[`XmpComplexType`](../xmpcomplextype). |
| [Set](../../groupdocs.metadata.standards.xmp/xmppackage/set#set_4)(string, XmpValueBase) | から継承された値を設定します[`XmpValueBase`](../xmpvaluebase). |
