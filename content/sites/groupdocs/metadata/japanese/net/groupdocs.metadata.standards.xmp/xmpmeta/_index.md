...
description: xmpmeta を表します Optional. この要素の目的はRDF の他の非 XMP 使用を含む可能性のある一般的な XML テキスト内の XMP メタデータを識別することです
type: docs
weight: 3460
url: /ja/net/groupdocs.metadata.standards.xmp/xmpmeta/
---
## XmpMeta class

xmpmeta を表します。 Optional. この要素の目的は、RDF の他の非 XMP 使用を含む可能性のある一般的な XML テキスト内の XMP メタデータを識別することです。
...
| 名前 | 説明 |
| --- | --- |
| [XmpMeta](xmpmeta)() | デフォルトのコンストラクター。 |

## プロパティ

| 名前 | 説明 |
| --- | --- |
| [AdobeXmpToolkit](../../groupdocs.metadata.standards.xmp/xmpmeta/adobexmptoolkit) { get; } | Adobe XMP ツールキットのバージョンを取得します。 |
...
| [GetXmpRepresentation](../../groupdocs.metadata.standards.xmp/xmpmeta/getxmprepresentation)() | XMP 値を xml 表現に変換します。 |
...
| override [SetAttribute](../../groupdocs.metadata.standards.xmp/xmpmeta/setattribute)(string, string) | 属性を追加します。 |
