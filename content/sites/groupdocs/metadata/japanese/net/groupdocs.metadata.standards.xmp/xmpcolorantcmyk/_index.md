...
description: CMYK 着色剤を表します
type: docs
weight: 3310
url: /ja/net/groupdocs.metadata.standards.xmp/xmpcolorantcmyk/
---
...
| 名前 | 説明 |
| --- | --- |
| [XmpColorantCmyk](xmpcolorantcmyk#constructor)() | の新しいインスタンスを初期化します[`XmpColorantCmyk`](../xmpcolorantcmyk)class. |
| [XmpColorantCmyk](xmpcolorantcmyk#constructor_1)(double, double, double, double) | の新しいインスタンスを初期化します[`XmpColorantCmyk`](../xmpcolorantcmyk)class. |

## プロパティ

| 名前 | 説明 |
| --- | --- |
| [Black](../../groupdocs.metadata.standards.xmp/xmpcolorantcmyk/black) { get; set; } | 黒のコンポーネントを取得または設定します。 |
...
| [Cyan](../../groupdocs.metadata.standards.xmp/xmpcolorantcmyk/cyan) { get; set; } | シアン コンポーネントを取得または設定します。 |
...
| [Magenta](../../groupdocs.metadata.standards.xmp/xmpcolorantcmyk/magenta) { get; set; } | マゼンタ コンポーネントを取得または設定します。 |
...
| [Yellow](../../groupdocs.metadata.standards.xmp/xmpcolorantcmyk/yellow) { get; set; } | 黄色のコンポーネントを取得または設定します。 |
...
| 名前 | 説明 |
| --- | --- |
| const [ColorValueMax](../../groupdocs.metadata.standards.xmp/xmpcolorantcmyk/colorvaluemax) | CMYK 着色剤の色の最大値. |
| const [ColorValueMin](../../groupdocs.metadata.standards.xmp/xmpcolorantcmyk/colorvaluemin) | CMYK 着色剤の色の最小値. |
