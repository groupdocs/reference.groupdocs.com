...
description: ドキュメントのバージョンを表します
type: docs
weight: 3630
url: /ja/net/groupdocs.metadata.standards.xmp/xmpversion/
---
## XmpVersion class
...
| 名前 | 説明 |
| --- | --- |
| [XmpVersion](xmpversion)() | の新しいインスタンスを初期化します[`XmpVersion`](../xmpversion)class. |

## プロパティ

| 名前 | 説明 |
| --- | --- |
| [Comments](../../groupdocs.metadata.standards.xmp/xmpversion/comments) { get; set; } | 変更内容に関するコメントを取得または設定します。 |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | メタデータ プロパティの数を取得します。 |
| [Event](../../groupdocs.metadata.standards.xmp/xmpversion/event) { get; set; } | ユーザーが実行した操作の高レベルで正式な説明を取得または設定します。 |
...
| [Modifier](../../groupdocs.metadata.standards.xmp/xmpversion/modifier) { get; set; } | このバージョンを変更した人を取得または設定します。 |
| [ModifyDate](../../groupdocs.metadata.standards.xmp/xmpversion/modifydate) { get; set; } | このバージョンがチェックインされた日付を取得または設定します。 |
...
| [VersionNumber](../../groupdocs.metadata.standards.xmp/xmpversion/versionnumber) { get; set; } | 新しいバージョン番号を取得または設定します。 |
