...
description: RGB 着色剤を表します
type: docs
weight: 3340
url: /ja/net/groupdocs.metadata.standards.xmp/xmpcolorantrgb/
---
...
| 名前 | 説明 |
| --- | --- |
| [XmpColorantRgb](xmpcolorantrgb#constructor)() | の新しいインスタンスを初期化します[`XmpColorantRgb`](../xmpcolorantrgb)class. |
| [XmpColorantRgb](xmpcolorantrgb#constructor_1)(byte, byte, byte) | の新しいインスタンスを初期化します[`XmpColorantRgb`](../xmpcolorantrgb)class. |

## プロパティ

| 名前 | 説明 |
| --- | --- |
| [Blue](../../groupdocs.metadata.standards.xmp/xmpcolorantrgb/blue) { get; set; } | 青のコンポーネントを取得または設定します。 |
...
| [Green](../../groupdocs.metadata.standards.xmp/xmpcolorantrgb/green) { get; set; } | 緑の値を取得または設定します。 |
...
| [Red](../../groupdocs.metadata.standards.xmp/xmpcolorantrgb/red) { get; set; } | 赤のコンポーネントを取得または設定します。 |
