...
description: XMP Boolean 基本タイプを表します
type: docs
weight: 3270
url: /ja/net/groupdocs.metadata.standards.xmp/xmpboolean/
---
## XmpBoolean class
...
| 名前 | 説明 |
| --- | --- |
| [XmpBoolean](xmpboolean#constructor)() | の新しいインスタンスを初期化します[`XmpBoolean`](../xmpboolean)デフォルト値を持つクラス. |
| [XmpBoolean](xmpboolean#constructor_1)(bool) | の新しいインスタンスを初期化します[`XmpBoolean`](../xmpboolean)ブール値に基づくクラス. |
| [XmpBoolean](xmpboolean#constructor_2)(string) | の新しいインスタンスを初期化します[`XmpBoolean`](../xmpboolean)class. |
...
| [Value](../../groupdocs.metadata.standards.xmp/xmpboolean/value) { get; } | 値を取得します。 |
...
| override [GetXmpRepresentation](../../groupdocs.metadata.standards.xmp/xmpboolean/getxmprepresentation)() | 文字列に含まれる値を XMP 形式で返します。 |
