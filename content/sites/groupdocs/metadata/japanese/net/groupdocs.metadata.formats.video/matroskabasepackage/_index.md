...
description: Matroska ビデオから抽出されたすべてのパッケージの基本メタデータ クラスを提供します
type: docs
weight: 2440
url: /ja/net/groupdocs.metadata.formats.video/matroskabasepackage/
---
## MatroskaBasePackage class

Matroska ビデオから抽出されたすべてのパッケージの基本メタデータ クラスを提供します。
