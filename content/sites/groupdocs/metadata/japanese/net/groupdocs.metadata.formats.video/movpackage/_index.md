...
description: QuickTime メタデータを表します
type: docs
weight: 2630
url: /ja/net/groupdocs.metadata.formats.video/movpackage/
---
## MovPackage class

QuickTime メタデータを表します。
...
| 名前 | 説明 |
| --- | --- |
| [Atoms](../../groupdocs.metadata.formats.video/movpackage/atoms) { get; } | の配列を取得します[`MovAtom`](../movatom)atom. |
