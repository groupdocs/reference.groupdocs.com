...
description: Matroska ビデオの EBML ヘッダー メタデータを表します
type: docs
weight: 2460
url: /ja/net/groupdocs.metadata.formats.video/matroskaebmlheader/
---
## MatroskaEbmlHeader class

Matroska ビデオの EBML ヘッダー メタデータを表します。
...
| [DocType](../../groupdocs.metadata.formats.video/matroskaebmlheader/doctype) { get; } | ファイルの内容を取得します。 MATROSKA ファイルの場合、その値は 'matroska'. です。 |
| [DocTypeReadVersion](../../groupdocs.metadata.formats.video/matroskaebmlheader/doctypereadversion) { get; } | 最小バージョン番号を取得します[`DocType`](./doctype)パーサーは、ファイルを読み取るために準拠している必要があります. |
| [DocTypeVersion](../../groupdocs.metadata.formats.video/matroskaebmlheader/doctypeversion) { get; } | のバージョンを取得します[`DocType`](./doctype)ファイルの作成に使用されたライター. |
...
| [ReadVersion](../../groupdocs.metadata.formats.video/matroskaebmlheader/readversion) { get; } | EBML パーサーがファイルを読み取るために準拠する必要がある最小バージョンを取得します。 |
| [Version](../../groupdocs.metadata.formats.video/matroskaebmlheader/version) { get; } | ファイルの作成に使用された EBML Writer のバージョンを取得します。 |
