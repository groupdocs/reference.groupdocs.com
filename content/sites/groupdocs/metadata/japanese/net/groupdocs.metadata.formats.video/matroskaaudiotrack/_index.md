...
description: Matroska ビデオのオーディオ メタデータを表します
type: docs
weight: 2430
url: /ja/net/groupdocs.metadata.formats.video/matroskaaudiotrack/
---
...
| 名前 | 説明 |
| --- | --- |
| [BitDepth](../../groupdocs.metadata.formats.video/matroskaaudiotrack/bitdepth) { get; } | サンプルあたりのビット数を取得します。主に PCM に使用されます。 |
| [Channels](../../groupdocs.metadata.formats.video/matroskaaudiotrack/channels) { get; } | トラック内のチャネル数を取得します。 |
...
| [OutputSamplingFrequency](../../groupdocs.metadata.formats.video/matroskaaudiotrack/outputsamplingfrequency) { get; } | 実際の出力サンプリング周波数を Hz 単位で取得します (SBR 技術に使用されます). |
...
| [SamplingFrequency](../../groupdocs.metadata.formats.video/matroskaaudiotrack/samplingfrequency) { get; } | サンプリング周波数を Hz 単位で取得します。 |
