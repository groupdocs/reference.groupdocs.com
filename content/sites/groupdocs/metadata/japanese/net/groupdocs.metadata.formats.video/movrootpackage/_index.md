...
description: QuickTime ビデオのメタデータを操作できるルート パッケージを表します
type: docs
weight: 2640
url: /ja/net/groupdocs.metadata.formats.video/movrootpackage/
---
## MovRootPackage class

QuickTime ビデオのメタデータを操作できるルート パッケージを表します。
...
| [MovPackage](../../groupdocs.metadata.formats.video/movrootpackage/movpackage) { get; } | QuickTime メタデータ パッケージを取得します。 |
...
| [XmpPackage](../../groupdocs.metadata.formats.video/movrootpackage/xmppackage) { get; set; } | XMP メタデータ パッケージを取得または設定します。 |
...
この例では、MOV ビデオで QuickTime アトムを読み取る方法を示します。
