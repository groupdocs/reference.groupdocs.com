...
description: ASF ビデオのメタデータを操作できるルート パッケージを表します
type: docs
weight: 2350
url: /ja/net/groupdocs.metadata.formats.video/asfrootpackage/
---
## AsfRootPackage class

ASF ビデオのメタデータを操作できるルート パッケージを表します。
...
| 名前 | 説明 |
| --- | --- |
| [AsfPackage](../../groupdocs.metadata.formats.video/asfrootpackage/asfpackage) { get; } | ASF メタデータ パッケージを取得します。 |
...
| [XmpPackage](../../groupdocs.metadata.formats.video/asfrootpackage/xmppackage) { get; set; } | XMP メタデータ パッケージを取得または設定します。 |
