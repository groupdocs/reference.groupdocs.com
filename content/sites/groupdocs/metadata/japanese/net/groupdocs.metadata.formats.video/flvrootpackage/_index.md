...
description: FLV ビデオのメタデータを操作できるルート パッケージを表します
type: docs
weight: 2420
url: /ja/net/groupdocs.metadata.formats.video/flvrootpackage/
---
## FlvRootPackage class

FLV ビデオのメタデータを操作できるルート パッケージを表します。
...
| [Header](../../groupdocs.metadata.formats.video/flvrootpackage/header) { get; } | FLV ヘッダー パッケージを取得します。 |
...
| [XmpPackage](../../groupdocs.metadata.formats.video/flvrootpackage/xmppackage) { get; set; } | XMP メタデータ パッケージを取得または設定します。 |
