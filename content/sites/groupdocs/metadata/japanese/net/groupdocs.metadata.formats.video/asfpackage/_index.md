...
description: ASF メディア コンテナーのネイティブ メタデータを表します
type: docs
weight: 2340
url: /ja/net/groupdocs.metadata.formats.video/asfpackage/
---
## AsfPackage class

ASF メディア コンテナーのネイティブ メタデータを表します。
...
| 名前 | 説明 |
| --- | --- |
| [CodecInformation](../../groupdocs.metadata.formats.video/asfpackage/codecinformation) { get; } | コーデック情報エントリを取得します。 |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | メタデータ プロパティの数を取得します。 |
| [CreationDate](../../groupdocs.metadata.formats.video/asfpackage/creationdate) { get; } | ファイルの初回作成日時を取得します。 |
| [FileID](../../groupdocs.metadata.formats.video/asfpackage/fileid) { get; } | このファイルの一意の識別子を取得します。 |
| [Flags](../../groupdocs.metadata.formats.video/asfpackage/flags) { get; } | ヘッダー フラグを取得します。 |
...
| [MetadataDescriptors](../../groupdocs.metadata.formats.video/asfpackage/metadatadescriptors) { get; } | メタデータ記述子を取得します。 |
...
| [StreamProperties](../../groupdocs.metadata.formats.video/asfpackage/streamproperties) { get; } | デジタル メディア ストリームのプロパティを取得します。 |
