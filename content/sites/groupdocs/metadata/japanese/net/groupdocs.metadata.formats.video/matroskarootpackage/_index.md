...
description: Matroska ビデオのメタデータの操作を可能にするルート パッケージを表します
type: docs
weight: 2480
url: /ja/net/groupdocs.metadata.formats.video/matroskarootpackage/
---
## MatroskaRootPackage class

Matroska ビデオのメタデータの操作を可能にするルート パッケージを表します。
...
| [MatroskaPackage](../../groupdocs.metadata.formats.video/matroskarootpackage/matroskapackage) { get; } | Matroska メタデータ パッケージを取得します。 |
