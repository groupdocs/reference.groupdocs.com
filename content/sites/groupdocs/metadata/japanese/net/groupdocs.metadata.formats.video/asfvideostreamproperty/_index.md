...
description: ASF メディア コンテナー内のビデオ ストリーム プロパティのメタデータを表します
type: docs
weight: 2370
url: /ja/net/groupdocs.metadata.formats.video/asfvideostreamproperty/
---
## AsfVideoStreamProperty class

ASF メディア コンテナー内のビデオ ストリーム プロパティのメタデータを表します。
...
| [BitsPerPixels](../../groupdocs.metadata.formats.video/asfvideostreamproperty/bitsperpixels) { get; } | ピクセルあたりのビット数を取得します。 |
| [Compression](../../groupdocs.metadata.formats.video/asfvideostreamproperty/compression) { get; } | ビデオ圧縮 ID を取得します。 |
...
| [ImageHeight](../../groupdocs.metadata.formats.video/asfvideostreamproperty/imageheight) { get; } | エンコードされた画像の高さをピクセル単位で取得します. |
| [ImageWidth](../../groupdocs.metadata.formats.video/asfvideostreamproperty/imagewidth) { get; } | エンコードされた画像の幅をピクセル単位で取得します. |
