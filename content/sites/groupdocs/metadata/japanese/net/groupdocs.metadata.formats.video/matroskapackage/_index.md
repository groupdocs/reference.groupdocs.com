...
description: Matroska ビデオのメタデータ コンテナーを表します
type: docs
weight: 2470
url: /ja/net/groupdocs.metadata.formats.video/matroskapackage/
---
## MatroskaPackage class

Matroska ビデオのメタデータ コンテナーを表します。
...
| 名前 | 説明 |
| --- | --- |
| [ContentType](../../groupdocs.metadata.formats.video/matroskapackage/contenttype) { get; } | Matroska コンテンツ タイプを取得します。 |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | メタデータ プロパティの数を取得します。 |
| [EbmlHeader](../../groupdocs.metadata.formats.video/matroskapackage/ebmlheader) { get; } | EBML ヘッダーのメタデータを取得します。 |
...
| [Segments](../../groupdocs.metadata.formats.video/matroskapackage/segments) { get; } | セグメント情報メタデータを取得します。 |
| [SubtitleTracks](../../groupdocs.metadata.formats.video/matroskapackage/subtitletracks) { get; } | 字幕メタデータ エントリを取得します。 |
| [Tags](../../groupdocs.metadata.formats.video/matroskapackage/tags) { get; } | タグ付けメタデータを取得します。 |
| [Tracks](../../groupdocs.metadata.formats.video/matroskapackage/tracks) { get; } | トラック メタデータ エントリを取得します。 |
