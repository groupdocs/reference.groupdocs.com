...
description: MakerNote メタデータ パッケージの抽象基本クラスを提供します
type: docs
weight: 2830
url: /ja/net/groupdocs.metadata.standards.exif.makernote/makernotepackage/
---
## MakerNotePackage class

MakerNote メタデータ パッケージの抽象基本クラスを提供します。
