...
description: スプレッドシート ドキュメントのシートを表します
type: docs
weight: 1220
url: /ja/net/groupdocs.metadata.formats.document/spreadsheetsheet/
---
## SpreadsheetSheet class

スプレッドシート ドキュメントのシートを表します。
...
| [Name](../../groupdocs.metadata.formats.document/spreadsheetsheet/name) { get; } | シート名を取得します。 |
| [Number](../../groupdocs.metadata.formats.document/spreadsheetsheet/number) { get; } | シート番号を取得します。 |
