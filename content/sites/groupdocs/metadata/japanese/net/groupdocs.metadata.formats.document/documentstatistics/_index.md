...
description: ドキュメント統計のセットを表します
type: docs
weight: 940
url: /ja/net/groupdocs.metadata.formats.document/documentstatistics/
---
...
| 名前 | 説明 |
| --- | --- |
| [DocumentStatistics](documentstatistics)() | の新しいインスタンスを初期化します[`DocumentStatistics`](../documentstatistics)class. |

## プロパティ

| 名前 | 説明 |
| --- | --- |
| [CharacterCount](../../groupdocs.metadata.formats.document/documentstatistics/charactercount) { get; } | ドキュメント内の推定文字数を取得します。 |
...
| [PageCount](../../groupdocs.metadata.formats.document/documentstatistics/pagecount) { get; } | ドキュメントの推定ページ数を取得します。 |
...
| [WordCount](../../groupdocs.metadata.formats.document/documentstatistics/wordcount) { get; } | ドキュメント内の推定単語数を取得します。 |
