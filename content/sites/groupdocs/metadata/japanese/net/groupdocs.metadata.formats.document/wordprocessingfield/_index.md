...
description: ワード プロセッシング ドキュメントのフィールドを表します
type: docs
weight: 1250
url: /ja/net/groupdocs.metadata.formats.document/wordprocessingfield/
---
## WordProcessingField class

ワード プロセッシング ドキュメントのフィールドを表します。
...
| 名前 | 説明 |
| --- | --- |
| [Code](../../groupdocs.metadata.formats.document/wordprocessingfield/code) { get; } | フィールドコードを取得します。 |
...
| [Result](../../groupdocs.metadata.formats.document/wordprocessingfield/result) { get; } | フィールドの結果を取得します。 |
