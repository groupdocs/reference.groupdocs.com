...
description: OneNote セクションのページを表します
type: docs
weight: 960
url: /ja/net/groupdocs.metadata.formats.document/notepage/
---
## NotePage class

OneNote セクションのページを表します。
...
| 名前 | 説明 |
| --- | --- |
| [Author](../../groupdocs.metadata.formats.document/notepage/author) { get; } | ページの作成者を取得します。 |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | メタデータ プロパティの数を取得します。 |
| [CreationTime](../../groupdocs.metadata.formats.document/notepage/creationtime) { get; } | 作成時刻を取得します。 |
...
| [LastModificationTime](../../groupdocs.metadata.formats.document/notepage/lastmodificationtime) { get; } | 最終更新時刻を取得します。 |
...
| [Title](../../groupdocs.metadata.formats.document/notepage/title) { get; } | ページのタイトルを取得します。 |
