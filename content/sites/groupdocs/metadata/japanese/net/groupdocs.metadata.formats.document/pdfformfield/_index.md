...
description: PDF ドキュメントのフォーム フィールドを表します
type: docs
weight: 1010
url: /ja/net/groupdocs.metadata.formats.document/pdfformfield/
---
## PdfFormField class

PDF ドキュメントのフォーム フィールドを表します。
...
| [Name](../../groupdocs.metadata.formats.document/pdfformfield/name) { get; } | フィールドの名前を取得します。 |
...
| [Value](../../groupdocs.metadata.formats.document/pdfformfield/value) { get; } | フィールド値を取得します。 |
