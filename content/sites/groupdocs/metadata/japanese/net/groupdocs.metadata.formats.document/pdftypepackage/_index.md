...
description: PDF 固有のファイル形式情報を含むメタデータ パッケージを表します
type: docs
weight: 1050
url: /ja/net/groupdocs.metadata.formats.document/pdftypepackage/
---
## PdfTypePackage class

PDF 固有のファイル形式情報を含むメタデータ パッケージを表します。
...
| [Version](../../groupdocs.metadata.formats.document/pdftypepackage/version) { get; } | フォーマットのバージョンを取得します。 |
