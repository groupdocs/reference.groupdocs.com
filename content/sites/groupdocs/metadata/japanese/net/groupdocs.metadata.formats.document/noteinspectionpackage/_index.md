...
description: メモ セクションの内部構造を公開するメタデータ パッケージを表します
type: docs
weight: 950
url: /ja/net/groupdocs.metadata.formats.document/noteinspectionpackage/
---
## NoteInspectionPackage class

メモ セクションの内部構造を公開するメタデータ パッケージを表します。
...
| [Pages](../../groupdocs.metadata.formats.document/noteinspectionpackage/pages) { get; } | セクション ページの配列を取得します。 |
