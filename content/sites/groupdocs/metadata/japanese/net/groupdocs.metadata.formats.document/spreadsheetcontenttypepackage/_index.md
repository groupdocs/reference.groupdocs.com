...
description: スプレッドシートのコンテンツ タイプ プロパティを含むメタデータ パッケージを表します
type: docs
weight: 1160
url: /ja/net/groupdocs.metadata.formats.document/spreadsheetcontenttypepackage/
---
## SpreadsheetContentTypePackage class

スプレッドシートのコンテンツ タイプ プロパティを含むメタデータ パッケージを表します。
...
| [Clear](../../groupdocs.metadata.formats.document/spreadsheetcontenttypepackage/clear)() | 書き込み可能なすべてのメタデータ プロパティを削除します。 |
...
| [Remove](../../groupdocs.metadata.formats.document/spreadsheetcontenttypepackage/remove)(string) | 指定された名前のコンテンツ タイプ プロパティを削除します。 |
...
| [Set](../../groupdocs.metadata.formats.document/spreadsheetcontenttypepackage/set#set)(string, string) | コンテンツ タイプ プロパティを指定された名前で追加または置換します。 |
| [Set](../../groupdocs.metadata.formats.document/spreadsheetcontenttypepackage/set#set_1)(string, string, string) | コンテンツ タイプ プロパティを指定された名前で追加または置換します。 |
...
| [ToList](../../groupdocs.metadata.formats.document/spreadsheetcontenttypepackage/tolist)() | パッケージからリストを作成します。 |
