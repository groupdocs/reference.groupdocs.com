...
description: スプレッドシート固有のファイル形式情報を含むメタデータ パッケージを表します
type: docs
weight: 1230
url: /ja/net/groupdocs.metadata.formats.document/spreadsheettypepackage/
---
## SpreadsheetTypePackage class

スプレッドシート固有のファイル形式情報を含むメタデータ パッケージを表します。
...
| [SpreadsheetFormat](../../groupdocs.metadata.formats.document/spreadsheettypepackage/spreadsheetformat) { get; } | 正確なスプレッドシート形式を取得します。 |
