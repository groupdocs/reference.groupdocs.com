...
description: プレゼンテーション固有のファイル形式情報を含むメタデータ パッケージを表します
type: docs
weight: 1120
url: /ja/net/groupdocs.metadata.formats.document/presentationtypepackage/
---
## PresentationTypePackage class

プレゼンテーション固有のファイル形式情報を含むメタデータ パッケージを表します。
...
| [PresentationFormat](../../groupdocs.metadata.formats.document/presentationtypepackage/presentationformat) { get; } | 正確なプレゼンテーション形式を取得します。 |
