...
description: スプレッドシート内のユーザー コメントを表します
type: docs
weight: 1150
url: /ja/net/groupdocs.metadata.formats.document/spreadsheetcomment/
---
## SpreadsheetComment class

スプレッドシート内のユーザー コメントを表します。
...
| 名前 | 説明 |
| --- | --- |
| [Author](../../groupdocs.metadata.formats.document/spreadsheetcomment/author) { get; } | コメントの作成者を取得します。 |
| [Column](../../groupdocs.metadata.formats.document/spreadsheetcomment/column) { get; } | コメントの 1 から始まる列インデックスを取得します。 |
...
| [Row](../../groupdocs.metadata.formats.document/spreadsheetcomment/row) { get; } | コメントの 1 ベースの行インデックスを取得します。 |
| [SheetNumber](../../groupdocs.metadata.formats.document/spreadsheetcomment/sheetnumber) { get; } | シート番号を取得します。 |
| [Text](../../groupdocs.metadata.formats.document/spreadsheetcomment/text) { get; } | コメントテキストを取得します. |
