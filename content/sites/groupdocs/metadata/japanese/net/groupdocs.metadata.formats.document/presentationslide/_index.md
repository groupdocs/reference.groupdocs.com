...
description: プレゼンテーションのスライドを表します
type: docs
weight: 1110
url: /ja/net/groupdocs.metadata.formats.document/presentationslide/
---
...
| [Name](../../groupdocs.metadata.formats.document/presentationslide/name) { get; } | スライド名を取得します。 |
| [Number](../../groupdocs.metadata.formats.document/presentationslide/number) { get; } | スライド番号を取得します。 |
...
| [SlideId](../../groupdocs.metadata.formats.document/presentationslide/slideid) { get; } | スライド ID を取得します。 |
