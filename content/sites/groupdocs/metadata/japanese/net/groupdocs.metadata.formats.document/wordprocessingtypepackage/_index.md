...
description: ドキュメント固有のファイル形式情報を含むメタデータ パッケージを表します
type: docs
weight: 1320
url: /ja/net/groupdocs.metadata.formats.document/wordprocessingtypepackage/
---
## WordProcessingTypePackage class

ドキュメント固有のファイル形式情報を含むメタデータ パッケージを表します。
...
| [WordProcessingFormat](../../groupdocs.metadata.formats.document/wordprocessingtypepackage/wordprocessingformat) { get; } | 正確なワード プロセッシング形式を取得します。 |
