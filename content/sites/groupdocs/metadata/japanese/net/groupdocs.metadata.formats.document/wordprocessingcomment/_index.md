...
description: ワープロ ドキュメントのコメントを表します
type: docs
weight: 1240
url: /ja/net/groupdocs.metadata.formats.document/wordprocessingcomment/
---
## WordProcessingComment class

ワープロ ドキュメントのコメントを表します。
...
| 名前 | 説明 |
| --- | --- |
| [Author](../../groupdocs.metadata.formats.document/wordprocessingcomment/author) { get; set; } | 作成者を取得または設定します。 |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | メタデータ プロパティの数を取得します。 |
| [CreatedDate](../../groupdocs.metadata.formats.document/wordprocessingcomment/createddate) { get; set; } | コメントが作成された日付を取得または設定します。 |
| [Id](../../groupdocs.metadata.formats.document/wordprocessingcomment/id) { get; } | コメントIDを取得します. |
| [Initials](../../groupdocs.metadata.formats.document/wordprocessingcomment/initials) { get; set; } | 作成者のイニシャルを取得または設定します。 |
...
| [Text](../../groupdocs.metadata.formats.document/wordprocessingcomment/text) { get; set; } | コメントのテキストを取得または設定します。 |
