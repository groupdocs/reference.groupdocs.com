...
description: PDF ドキュメントのブックマークを表します
type: docs
weight: 1000
url: /ja/net/groupdocs.metadata.formats.document/pdfbookmark/
---
## PdfBookmark class

PDF ドキュメントのブックマークを表します。
...
| [Title](../../groupdocs.metadata.formats.document/pdfbookmark/title) { get; } | ブックマークのタイトルを取得します。 |
