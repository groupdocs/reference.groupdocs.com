...
description: PDFWordProcessingスプレッドシートプレゼンテーションなどのドキュメント形式のルート パッケージを表します
type: docs
weight: 930
url: /ja/net/groupdocs.metadata.formats.document/documentrootpackage-1/
---
## DocumentRootPackage&lt;TPackage&gt; class

PDF、WordProcessing、スプレッドシート、プレゼンテーションなどのドキュメント形式のルート パッケージを表します。
...
| パラメータ | 説明 |
| --- | --- |
| TPackage | ネイティブ メタデータ パッケージのタイプ。 |
