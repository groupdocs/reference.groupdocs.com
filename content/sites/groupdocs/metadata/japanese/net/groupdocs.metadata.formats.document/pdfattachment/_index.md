...
description: PDF ドキュメントの添付ファイルを表します
type: docs
weight: 990
url: /ja/net/groupdocs.metadata.formats.document/pdfattachment/
---
## PdfAttachment class

PDF ドキュメントの添付ファイルを表します。
...
| [Description](../../groupdocs.metadata.formats.document/pdfattachment/description) { get; } | 添付ファイルの説明を取得します。 |
...
| [MimeType](../../groupdocs.metadata.formats.document/pdfattachment/mimetype) { get; } | 添付ファイルの MIME タイプを取得します。 |
| [Name](../../groupdocs.metadata.formats.document/pdfattachment/name) { get; } | 添付ファイル名を取得します。 |
