...
description: ドキュメント内のリビジョン 追跡された変更 を表します
type: docs
weight: 1290
url: /ja/net/groupdocs.metadata.formats.document/wordprocessingrevision/
---
## WordProcessingRevision class

ドキュメント内のリビジョン (追跡された変更) を表します。
...
| 名前 | 説明 |
| --- | --- |
| [Author](../../groupdocs.metadata.formats.document/wordprocessingrevision/author) { get; } | リビジョンの作成者を取得します。 |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | メタデータ プロパティの数を取得します。 |
| [DateTime](../../groupdocs.metadata.formats.document/wordprocessingrevision/datetime) { get; } | リビジョンの日時を取得します。 |
...
| [RevisionType](../../groupdocs.metadata.formats.document/wordprocessingrevision/revisiontype) { get; } | リビジョンのタイプを取得します。 |
