...
description: ダイアグラム固有のファイル形式情報を含むメタデータ パッケージを表します
type: docs
weight: 910
url: /ja/net/groupdocs.metadata.formats.document/diagramtypepackage/
---
## DiagramTypePackage class

ダイアグラム固有のファイル形式情報を含むメタデータ パッケージを表します。
...
| [DiagramFormat](../../groupdocs.metadata.formats.document/diagramtypepackage/diagramformat) { get; } | 正確なダイアグラム形式を取得します。 |
