...
description: ファイル形式情報を含むメタデータ パッケージを表します
type: docs
weight: 60
url: /ja/net/groupdocs.metadata.common/filetypepackage/
---
## FileTypePackage class

ファイル形式情報を含むメタデータ パッケージを表します。
...
* [サポートされているファイル形式](https://docs.groupdocs.com/display/metadatanet/Supported+File+Formats)
