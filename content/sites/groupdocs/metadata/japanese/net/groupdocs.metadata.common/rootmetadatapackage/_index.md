...
description: 特定のファイルで提示されるすべてのメタデータ パッケージへのエントリ ポイントを表します
type: docs
weight: 240
url: /ja/net/groupdocs.metadata.common/rootmetadatapackage/
---
## RootMetadataPackage class

特定のファイルで提示されるすべてのメタデータ パッケージへのエントリ ポイントを表します。
