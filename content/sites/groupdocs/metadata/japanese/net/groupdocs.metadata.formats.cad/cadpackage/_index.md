...
description: CAD コンピューター支援設計 メタデータを表します
type: docs
weight: 840
url: /ja/net/groupdocs.metadata.formats.cad/cadpackage/
---
## CadPackage class

CAD (コンピューター支援設計) メタデータを表します。
...
| 名前 | 説明 |
| --- | --- |
| [AcadVersion](../../groupdocs.metadata.formats.cad/cadpackage/acadversion) { get; } | AutoCAD 図面データベースのバージョン番号を取得します。 |
| [Author](../../groupdocs.metadata.formats.cad/cadpackage/author) { get; } | 図面作成者を取得します。 |
| [Comments](../../groupdocs.metadata.formats.cad/cadpackage/comments) { get; } | ユーザーのコメントを取得します。 |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | メタデータ プロパティの数を取得します。 |
| [CreatedDateTime](../../groupdocs.metadata.formats.cad/cadpackage/createddatetime) { get; } | 図面が作成された日時を取得します。 |
| [CustomProperties](../../groupdocs.metadata.formats.cad/cadpackage/customproperties) { get; } | カスタム メタデータ プロパティを含むパッケージを取得します。 |
| [Height](../../groupdocs.metadata.formats.cad/cadpackage/height) { get; } | 描画高さを取得します. |
| [HyperlinkBase](../../groupdocs.metadata.formats.cad/cadpackage/hyperlinkbase) { get; } | ハイパーリンク ベースを取得します。 |
...
| [Keywords](../../groupdocs.metadata.formats.cad/cadpackage/keywords) { get; } | キーワードを取得します。 |
| [LastSavedBy](../../groupdocs.metadata.formats.cad/cadpackage/lastsavedby) { get; } | 最後の編集者の名前を取得します。 |
| [MetadataType](../../groupdocs.metadata.common/metadatapackage/metadatatype) { get; } | メタデータ タイプを取得します。 |
| [ModifiedDateTime](../../groupdocs.metadata.formats.cad/cadpackage/modifieddatetime) { get; } | 図面が変更された日時を取得します。 |
...
| [RevisionNumber](../../groupdocs.metadata.formats.cad/cadpackage/revisionnumber) { get; } | リビジョン番号を取得します。 |
| [Subject](../../groupdocs.metadata.formats.cad/cadpackage/subject) { get; } | 件名を取得します。 |
| [Title](../../groupdocs.metadata.formats.cad/cadpackage/title) { get; } | タイトルを取得します。 |
| [Width](../../groupdocs.metadata.formats.cad/cadpackage/width) { get; } | 描画幅を取得します. |
