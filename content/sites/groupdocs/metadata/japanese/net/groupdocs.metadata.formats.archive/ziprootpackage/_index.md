...
description: ZIP アーカイブ内のメタデータを操作できるルート パッケージを表します
type: docs
weight: 370
url: /ja/net/groupdocs.metadata.formats.archive/ziprootpackage/
---
## ZipRootPackage class

ZIP アーカイブ内のメタデータを操作できるルート パッケージを表します。
...
| [ZipPackage](../../groupdocs.metadata.formats.archive/ziprootpackage/zippackage) { get; } | ZIP メタデータ パッケージを取得します。 |
