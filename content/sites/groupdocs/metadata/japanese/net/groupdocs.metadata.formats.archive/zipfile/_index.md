...
description: アーカイブされたファイルまたはディレクトリに関連付けられたメタデータを表します
type: docs
weight: 350
url: /ja/net/groupdocs.metadata.formats.archive/zipfile/
---
## ZipFile class

アーカイブされたファイルまたはディレクトリに関連付けられたメタデータを表します。
...
| 名前 | 説明 |
| --- | --- |
| [CompressedSize](../../groupdocs.metadata.formats.archive/zipfile/compressedsize) { get; } | 圧縮サイズをバイト単位で取得します。 |
| [CompressionMethod](../../groupdocs.metadata.formats.archive/zipfile/compressionmethod) { get; } | 圧縮方法を取得します。 |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | メタデータ プロパティの数を取得します。 |
| [Flags](../../groupdocs.metadata.formats.archive/zipfile/flags) { get; } | ZIP エントリ フラグを取得します。 |
...
| [ModificationDateTime](../../groupdocs.metadata.formats.archive/zipfile/modificationdatetime) { get; } | 最終更新日時を取得します。 |
| [Name](../../groupdocs.metadata.formats.archive/zipfile/name) { get; } | エントリ名を取得します。 |
...
| [RawName](../../groupdocs.metadata.formats.archive/zipfile/rawname) { get; } | エントリの名前を表すバイト配列を取得します。 |
| [UncompressedSize](../../groupdocs.metadata.formats.archive/zipfile/uncompressedsize) { get; } | 圧縮されていないサイズをバイト単位で取得します. |
