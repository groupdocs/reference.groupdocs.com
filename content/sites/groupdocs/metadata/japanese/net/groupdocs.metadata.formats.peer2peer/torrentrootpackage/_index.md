...
description: TORRENT ファイルのメタデータを操作するためのルート パッケージを表します
type: docs
weight: 2200
url: /ja/net/groupdocs.metadata.formats.peer2peer/torrentrootpackage/
---
## TorrentRootPackage class

TORRENT ファイルのメタデータを操作するためのルート パッケージを表します。
...
| [TorrentPackage](../../groupdocs.metadata.formats.peer2peer/torrentrootpackage/torrentpackage) { get; } | TORRENT ファイル メタデータ パッケージを取得します。 |
...
このコード サンプルは、TORRENT ファイルのメタデータを読み取る方法を示しています。
