...
description: XMP PagedText パッケージを表します
type: docs
weight: 3180
url: /ja/net/groupdocs.metadata.standards.xmp.schemes/xmppagedtextpackage/
---
## XmpPagedTextPackage class

XMP Paged-Text パッケージを表します。
...
| 名前 | 説明 |
| --- | --- |
| [XmpPagedTextPackage](xmppagedtextpackage)() | の新しいインスタンスを初期化します[`XmpPagedTextPackage`](../xmppagedtextpackage)class. |

## プロパティ

| 名前 | 説明 |
| --- | --- |
| [Colorants](../../groupdocs.metadata.standards.xmp.schemes/xmppagedtextpackage/colorants) { get; set; } | ドキュメント (含まれているドキュメントを含む) で使用される色材 (スウォッチ) の順序付けられた配列を取得または設定します。 |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | メタデータ プロパティの数を取得します。 |
| [Fonts](../../groupdocs.metadata.standards.xmp.schemes/xmppagedtextpackage/fonts) { get; set; } | ドキュメントで使用されているフォントの順序付けられていない配列を取得または設定します (含まれているドキュメントを含む)。 |
...
| [MaxPageSize](../../groupdocs.metadata.standards.xmp.schemes/xmppagedtextpackage/maxpagesize) { get; set; } | ドキュメント内の最大ページのサイズを取得または設定します (含まれるドキュメント内のページを含む)。 |
...
| [NumberOfPages](../../groupdocs.metadata.standards.xmp.schemes/xmppagedtextpackage/numberofpages) { get; set; } | ドキュメントのページ数を取得または設定します。 |
| [PlateNames](../../groupdocs.metadata.standards.xmp.schemes/xmppagedtextpackage/platenames) { get; set; } | ドキュメントを印刷するために必要なプレート名の順序付けられた配列を取得または設定します (含まれているドキュメントを含む)。 |
...
| override [Set](../../groupdocs.metadata.standards.xmp.schemes/xmppagedtextpackage/set#set_7)(string, string) | 文字列プロパティを設定します。 |
| override [Set](../../groupdocs.metadata.standards.xmp.schemes/xmppagedtextpackage/set#set_2)(string, XmpArray) | から継承された値を設定します[`XmpArray`](../../groupdocs.metadata.standards.xmp/xmparray). |
