...
description: XMP Rights Management 名前空間を表します
type: docs
weight: 3220
url: /ja/net/groupdocs.metadata.standards.xmp.schemes/xmprightsmanagementpackage/
---
## XmpRightsManagementPackage class

XMP Rights Management 名前空間を表します。
...
| 名前 | 説明 |
| --- | --- |
| [XmpRightsManagementPackage](xmprightsmanagementpackage)() | の新しいインスタンスを初期化します[`XmpRightsManagementPackage`](../xmprightsmanagementpackage)class. |

## プロパティ

| 名前 | 説明 |
| --- | --- |
| [Certificate](../../groupdocs.metadata.standards.xmp.schemes/xmprightsmanagementpackage/certificate) { get; set; } | Rights Management 証明書の Web URL を取得または設定します。 |
...
| [Marked](../../groupdocs.metadata.standards.xmp.schemes/xmprightsmanagementpackage/marked) { get; set; } | これが権利管理されたリソースであるかどうかを示す値を取得または設定します。 |
...
| [Owners](../../groupdocs.metadata.standards.xmp.schemes/xmprightsmanagementpackage/owners) { get; set; } | 法的所有者を取得または設定します。 |
...
| [UsageTerms](../../groupdocs.metadata.standards.xmp.schemes/xmprightsmanagementpackage/usageterms) { get; set; } | リソースを合法的に使用する方法に関する指示をさまざまな言語で取得または設定します。 |
| [WebStatement](../../groupdocs.metadata.standards.xmp.schemes/xmprightsmanagementpackage/webstatement) { get; set; } | このリソースの所有権と使用権に関するステートメントの Web URL を取得または設定します。 |
...
| override [Set](../../groupdocs.metadata.standards.xmp.schemes/xmprightsmanagementpackage/set#set_7)(string, string) | 文字列プロパティを設定します。 |
