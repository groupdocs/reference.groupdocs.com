...
description: Adobe PDF ドキュメントで使用されるプロパティを指定します
type: docs
weight: 3190
url: /ja/net/groupdocs.metadata.standards.xmp.schemes/xmppdfpackage/
---
## XmpPdfPackage class

Adobe PDF ドキュメントで使用されるプロパティを指定します。
...
| 名前 | 説明 |
| --- | --- |
| [XmpPdfPackage](xmppdfpackage)() | の新しいインスタンスを初期化します[`XmpPdfPackage`](../xmppdfpackage)class. |
...
| [IsTrapped](../../groupdocs.metadata.standards.xmp.schemes/xmppdfpackage/istrapped) { get; set; } | ドキュメントがトラップされたかどうかを示す値を取得または設定します。 |
...
| [Keywords](../../groupdocs.metadata.standards.xmp.schemes/xmppdfpackage/keywords) { get; set; } | キーワードを取得または設定します。 |
...
| [PdfVersion](../../groupdocs.metadata.standards.xmp.schemes/xmppdfpackage/pdfversion) { get; set; } | PDF ファイルのバージョンを取得または設定します。たとえば、1.0、1.3 などです。 |
| [Prefix](../../groupdocs.metadata.standards.xmp/xmppackage/prefix) { get; } | xmlns プレフィックスを取得します。 |
| [Producer](../../groupdocs.metadata.standards.xmp.schemes/xmppdfpackage/producer) { get; set; } | PDF ドキュメントを作成したツールの名前を取得または設定します。 |
...
| override [Set](../../groupdocs.metadata.standards.xmp.schemes/xmppdfpackage/set#set_7)(string, string) | 文字列プロパティを設定します。 |
