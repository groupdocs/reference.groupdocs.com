...
description: CMS デジタル署名メタデータ パッケージを表します
type: docs
weight: 3000
url: /ja/net/groupdocs.metadata.standards.pkcs/cmspackage/
---
## CmsPackage class

CMS デジタル署名メタデータ パッケージを表します。
...
| [Flags](../../groupdocs.metadata.standards.pkcs/cmspackage/flags) { get; } | デジタル署名フラグを取得します。 |
...
| [Signatures](../../groupdocs.metadata.standards.pkcs/cmspackage/signatures) { get; } | ファイルから抽出された署名の配列を取得します。 |
