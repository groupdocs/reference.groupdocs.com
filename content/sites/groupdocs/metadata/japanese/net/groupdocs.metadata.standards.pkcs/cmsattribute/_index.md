...
description: CMS 署名者情報属性を表します
type: docs
weight: 2970
url: /ja/net/groupdocs.metadata.standards.pkcs/cmsattribute/
---
## CmsAttribute class
...
| [Oid](../../groupdocs.metadata.standards.pkcs/cmsattribute/oid) { get; } | 属性 OID を取得します。 |
...
| [Value](../../groupdocs.metadata.standards.pkcs/cmsattribute/value) { get; } | 文字列として表される属性値を取得します。 |
