...
description: コンテンツ タイプ識別子とコンテンツ自体で構成される署名されたコンテンツ コンテナーを表します
type: docs
weight: 2990
url: /ja/net/groupdocs.metadata.standards.pkcs/cmsencapsulatedcontent/
---
## CmsEncapsulatedContent class

コンテンツ タイプ識別子とコンテンツ自体で構成される、署名されたコンテンツ コンテナーを表します。
...
| 名前 | 説明 |
| --- | --- |
| [ContentRawData](../../groupdocs.metadata.standards.pkcs/cmsencapsulatedcontent/contentrawdata) { get; } | コンテンツ情報の生データを取得します。 |
| [ContentType](../../groupdocs.metadata.standards.pkcs/cmsencapsulatedcontent/contenttype) { get; } | コンテンツ タイプを一意に指定するオブジェクト識別子を取得します。 |
