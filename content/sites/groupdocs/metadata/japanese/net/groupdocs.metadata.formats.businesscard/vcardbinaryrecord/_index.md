...
description: vCard バイナリ レコード メタデータ クラスを表します
type: docs
weight: 630
url: /ja/net/groupdocs.metadata.formats.businesscard/vcardbinaryrecord/
---
## VCardBinaryRecord class

vCard バイナリ レコード メタデータ クラスを表します。
...
| override [ContentType](../../groupdocs.metadata.formats.businesscard/vcardbinaryrecord/contenttype) { get; } | レコードのコンテンツ タイプを取得します。 |
...
| [Value](../../groupdocs.metadata.formats.businesscard/vcardbinaryrecord/value) { get; } | レコード値を取得します。 |
