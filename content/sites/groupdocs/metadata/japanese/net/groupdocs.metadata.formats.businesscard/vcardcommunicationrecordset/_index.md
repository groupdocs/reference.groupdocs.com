...
description: Communication vCard レコードのセットを表します これらのプロパティはvCard が表すオブジェクトとの通信方法に関する情報を記述します
type: docs
weight: 660
url: /ja/net/groupdocs.metadata.formats.businesscard/vcardcommunicationrecordset/
---
## VCardCommunicationRecordset class

Communication vCard レコードのセットを表します。 これらのプロパティは、vCard が表すオブジェクトとの通信方法に関する情報を記述します。
...
| [EmailRecords](../../groupdocs.metadata.formats.businesscard/vcardcommunicationrecordset/emailrecords) { get; } | オブジェクトと通信するための電子メール アドレスを取得します。 |
| [Emails](../../groupdocs.metadata.formats.businesscard/vcardcommunicationrecordset/emails) { get; } | オブジェクトと通信するための電子メール アドレスを取得します。 |
| [ImppEntries](../../groupdocs.metadata.formats.businesscard/vcardcommunicationrecordset/imppentries) { get; } | オブジェクトとのインスタント メッセージングおよびプレゼンス プロトコル通信の URI を取得します。 |
| [ImppRecords](../../groupdocs.metadata.formats.businesscard/vcardcommunicationrecordset/impprecords) { get; } | オブジェクトとのインスタント メッセージングおよびプレゼンス プロトコル通信の URI を取得します。 |
...
| [LanguageRecords](../../groupdocs.metadata.formats.businesscard/vcardcommunicationrecordset/languagerecords) { get; } | オブジェクトへの接続に使用できる言語を取得します。 |
| [Languages](../../groupdocs.metadata.formats.businesscard/vcardcommunicationrecordset/languages) { get; } | オブジェクトへの接続に使用できる言語を取得します。 |
| [Mailer](../../groupdocs.metadata.formats.businesscard/vcardcommunicationrecordset/mailer) { get; } | vCard に関連付けられた個人が使用する電子メール ソフトウェアの種類を取得します。 |
...
| [TelephoneRecords](../../groupdocs.metadata.formats.businesscard/vcardcommunicationrecordset/telephonerecords) { get; } | オブジェクトとのテレフォニー通信用の電話番号を取得します。 |
| [Telephones](../../groupdocs.metadata.formats.businesscard/vcardcommunicationrecordset/telephones) { get; } | オブジェクトとのテレフォニー通信用の電話番号を取得します。 |
