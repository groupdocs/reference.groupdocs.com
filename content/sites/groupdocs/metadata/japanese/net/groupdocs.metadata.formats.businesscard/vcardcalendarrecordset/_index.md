...
description: Calendar vCard レコードのセットを表します
type: docs
weight: 640
url: /ja/net/groupdocs.metadata.formats.businesscard/vcardcalendarrecordset/
---
## VCardCalendarRecordset class

Calendar vCard レコードのセットを表します。
...
| 名前 | 説明 |
| --- | --- |
| [BusyTimeEntries](../../groupdocs.metadata.formats.businesscard/vcardcalendarrecordset/busytimeentries) { get; } | オブジェクトに関連付けられたビジー時間の URI を取得します。 |
| [BusyTimeRecords](../../groupdocs.metadata.formats.businesscard/vcardcalendarrecordset/busytimerecords) { get; } | オブジェクトに関連付けられたビジー時間の URI を取得します。 |
| [CalendarAddresses](../../groupdocs.metadata.formats.businesscard/vcardcalendarrecordset/calendaraddresses) { get; } | vCard. で表されるオブジェクトのスケジュール要求を送信するカレンダー ユーザー アドレスを取得します。 |
| [CalendarAddressRecords](../../groupdocs.metadata.formats.businesscard/vcardcalendarrecordset/calendaraddressrecords) { get; } | vCard. で表されるオブジェクトのスケジュール要求を送信するカレンダー ユーザー アドレスを取得します。 |
| [CalendarUriRecords](../../groupdocs.metadata.formats.businesscard/vcardcalendarrecordset/calendarurirecords) { get; } | vCard で表されるオブジェクトに関連付けられたカレンダーの URI を取得します。 |
...
| [UriCalendarEntries](../../groupdocs.metadata.formats.businesscard/vcardcalendarrecordset/uricalendarentries) { get; } | vCard で表されるオブジェクトに関連付けられたカレンダーの URI を取得します。 |
