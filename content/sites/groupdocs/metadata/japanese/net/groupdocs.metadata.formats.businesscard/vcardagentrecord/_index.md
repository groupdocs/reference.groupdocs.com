...
description: vCard エージェント レコードのメタデータ クラスを表します
type: docs
weight: 610
url: /ja/net/groupdocs.metadata.formats.businesscard/vcardagentrecord/
---
## VCardAgentRecord class

vCard エージェント レコードのメタデータ クラスを表します。
...
| override [ContentType](../../groupdocs.metadata.formats.businesscard/vcardagentrecord/contenttype) { get; } | レコードのコンテンツ タイプを取得します。 |
...
| [Value](../../groupdocs.metadata.formats.businesscard/vcardagentrecord/value) { get; } | レコード値を取得します。 |
