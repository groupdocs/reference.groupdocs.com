...
description: 抽象 vCard レコード メタデータ クラスを表します
type: docs
weight: 770
url: /ja/net/groupdocs.metadata.formats.businesscard/vcardrecord/
---
## VCardRecord class

抽象 vCard レコード メタデータ クラスを表します。
...
| abstract [ContentType](../../groupdocs.metadata.formats.businesscard/vcardrecord/contenttype) { get; } | レコードのコンテンツ タイプを取得します。 |
