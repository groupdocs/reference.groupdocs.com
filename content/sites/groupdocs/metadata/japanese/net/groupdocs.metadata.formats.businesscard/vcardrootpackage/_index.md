...
description: VCard ファイル内のメタデータを操作できるルート パッケージを表します
type: docs
weight: 790
url: /ja/net/groupdocs.metadata.formats.businesscard/vcardrootpackage/
---
...
| [VCardPackage](../../groupdocs.metadata.formats.businesscard/vcardrootpackage/vcardpackage) { get; } | VCard メタデータ パッケージを取得します。 |
