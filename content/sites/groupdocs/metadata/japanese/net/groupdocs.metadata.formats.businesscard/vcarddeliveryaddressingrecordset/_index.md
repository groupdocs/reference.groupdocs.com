...
description: 配信アドレス指定 vCard レコードのセットを表します. これらのタイプは vCard オブジェクトの配信アドレス指定またはラベルに関連する情報に関係しています.
type: docs
weight: 700
url: /ja/net/groupdocs.metadata.formats.businesscard/vcarddeliveryaddressingrecordset/
---
## VCardDeliveryAddressingRecordset class

配信アドレス指定 vCard レコードのセットを表します. これらのタイプは、 vCard オブジェクトの配信アドレス指定またはラベルに関連する情報に関係しています.
...
| 名前 | 説明 |
| --- | --- |
| [Addresses](../../groupdocs.metadata.formats.businesscard/vcarddeliveryaddressingrecordset/addresses) { get; } | オブジェクトの配送先住所のコンポーネントを取得します。 |
| [AddressRecords](../../groupdocs.metadata.formats.businesscard/vcarddeliveryaddressingrecordset/addressrecords) { get; } | オブジェクトの配送先住所のコンポーネントを取得します。 |
...
| [LabelRecords](../../groupdocs.metadata.formats.businesscard/vcarddeliveryaddressingrecordset/labelrecords) { get; } | オブジェクトの配送先住所に対応するフォーマットされたテキストを含む配列を取得します. |
| [Labels](../../groupdocs.metadata.formats.businesscard/vcarddeliveryaddressingrecordset/labels) { get; } | オブジェクトの配送先住所に対応するフォーマットされたテキストを含む配列を取得します. |
