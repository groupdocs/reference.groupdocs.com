...
description: vCard テキスト レコード メタデータ クラスを表します
type: docs
weight: 810
url: /ja/net/groupdocs.metadata.formats.businesscard/vcardtextrecord/
---
## VCardTextRecord class

vCard テキスト レコード メタデータ クラスを表します。
...
| [CharsetParameter](../../groupdocs.metadata.formats.businesscard/vcardtextrecord/charsetparameter) { get; } | charset パラメータを取得します。 |
| override [ContentType](../../groupdocs.metadata.formats.businesscard/vcardtextrecord/contenttype) { get; } | レコードのコンテンツ タイプを取得します。 |
...
| [IsQuotedPrintable](../../groupdocs.metadata.formats.businesscard/vcardtextrecord/isquotedprintable) { get; } | このインスタンスが印刷可能な文字列で引用されているかどうかを示す値を取得します。 |
...
| [MediaTypeParameter](../../groupdocs.metadata.formats.businesscard/vcardtextrecord/mediatypeparameter) { get; } | メディア タイプ パラメータ値を取得します。 |
...
| [Value](../../groupdocs.metadata.formats.businesscard/vcardtextrecord/value) { get; } | レコード値を取得します。 |
...
| [GetReadabilityValue](../../groupdocs.metadata.formats.businesscard/vcardtextrecord/getreadabilityvalue)(string) | 読みやすさの値を取得します。 |
