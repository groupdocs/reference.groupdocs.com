...
description: vCard 日時レコード メタデータ クラスを表します
type: docs
weight: 690
url: /ja/net/groupdocs.metadata.formats.businesscard/vcarddatetimerecord/
---
## VCardDateTimeRecord class

vCard 日時レコード メタデータ クラスを表します。
...
| override [ContentType](../../groupdocs.metadata.formats.businesscard/vcarddatetimerecord/contenttype) { get; } | レコードのコンテンツ タイプを取得します。 |
...
| [Value](../../groupdocs.metadata.formats.businesscard/vcarddatetimerecord/value) { get; } | レコード値を取得します。 |
