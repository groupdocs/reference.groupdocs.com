...
description: VCF 仮想連絡先ファイル 電子名刺形式のメタデータを表します
type: docs
weight: 760
url: /ja/net/groupdocs.metadata.formats.businesscard/vcardpackage/
---
## VCardPackage class

VCF (仮想連絡先ファイル) 電子名刺形式のメタデータを表します。
...
| 名前 | 説明 |
| --- | --- |
| [Cards](../../groupdocs.metadata.formats.businesscard/vcardpackage/cards) { get; } | ファイルから抽出されたカードの配列を取得します。 |
