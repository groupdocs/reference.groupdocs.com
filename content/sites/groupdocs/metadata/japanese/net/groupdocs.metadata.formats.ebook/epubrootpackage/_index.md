...
description: EPUB 電子書籍のメタデータを操作できるルート パッケージを表します
type: docs
weight: 1340
url: /ja/net/groupdocs.metadata.formats.ebook/epubrootpackage/
---
## EpubRootPackage class

EPUB 電子書籍のメタデータを操作できるルート パッケージを表します。
...
| [DublinCorePackage](../../groupdocs.metadata.formats.ebook/epubrootpackage/dublincorepackage) { get; } | 電子書籍から抽出された Dublin Core メタデータ パッケージを取得します。 |
| [EpubPackage](../../groupdocs.metadata.formats.ebook/epubrootpackage/epubpackage) { get; } | EPUB メタデータ パッケージを取得します。 |
...
* 名前空間 [GroupDocs.Metadata.Formats.Ebook](../../groupdocs.metadata.formats.ebook)
