...
description: Αντιπροσωπεύει τον βασικό χώρο ονομάτων JobTicket.
type: docs
weight: 3080
url: /el/net/groupdocs.metadata.standards.xmp.schemes/xmpbasicjobticketpackage/
---
## XmpBasicJobTicketPackage class

Αντιπροσωπεύει τον βασικό χώρο ονομάτων Job-Ticket.
...
| Ονομα | Περιγραφή |
| --- | --- |
| [XmpBasicJobTicketPackage](xmpbasicjobticketpackage)() | Αρχικοποιεί μια νέα παρουσία του[`XmpBasicJobTicketPackage`](../xmpbasicjobticketpackage) τάξη. |
...
| [Jobs](../../groupdocs.metadata.standards.xmp.schemes/xmpbasicjobticketpackage/jobs) { get; set; } | Παίρνει ή ορίζει τις εργασίες. |
