...
description: Αντιπροσωπεύει τη βασική κλάση μεταδεδομένων VCard.
type: docs
weight: 620
url: /el/net/groupdocs.metadata.formats.businesscard/vcardbasepackage/
---
## VCardBasePackage class

Αντιπροσωπεύει τη βασική κλάση μεταδεδομένων VCard.

```csharp
public abstract class VCardBasePackage : CustomPackage
```
