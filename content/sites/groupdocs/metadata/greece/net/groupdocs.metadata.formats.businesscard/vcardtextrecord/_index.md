...
description: Αντιπροσωπεύει την κλάση μεταδεδομένων εγγραφής κειμένου vCard.
type: docs
weight: 810
url: /el/net/groupdocs.metadata.formats.businesscard/vcardtextrecord/
---
## VCardTextRecord class

Αντιπροσωπεύει την κλάση μεταδεδομένων εγγραφής κειμένου vCard.
...
| [CharsetParameter](../../groupdocs.metadata.formats.businesscard/vcardtextrecord/charsetparameter) { get; } | Λαμβάνει την παράμετρο συνόλου χαρακτήρων. |
| override [ContentType](../../groupdocs.metadata.formats.businesscard/vcardtextrecord/contenttype) { get; } | Λαμβάνει τον τύπο περιεχομένου της εγγραφής. |
...
| [IsQuotedPrintable](../../groupdocs.metadata.formats.businesscard/vcardtextrecord/isquotedprintable) { get; } | Λαμβάνει μια τιμή που υποδεικνύει εάν αυτή η παρουσία είναι εισαγωγική εκτυπώσιμη συμβολοσειρά. |
...
| [MediaTypeParameter](../../groupdocs.metadata.formats.businesscard/vcardtextrecord/mediatypeparameter) { get; } | Λαμβάνει την τιμή της παραμέτρου τύπου μέσου. |
...
| [Value](../../groupdocs.metadata.formats.businesscard/vcardtextrecord/value) { get; } | Λαμβάνει την τιμή εγγραφής. |
...
| [GetReadabilityValue](../../groupdocs.metadata.formats.businesscard/vcardtextrecord/getreadabilityvalue)(string) | Λαμβάνει την τιμή αναγνωσιμότητας. |
