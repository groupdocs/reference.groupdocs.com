...
description: Αντιπροσωπεύει το ριζικό πακέτο που επιτρέπει την εργασία με μεταδεδομένα σε ένα αρχείο VCard.
type: docs
weight: 790
url: /el/net/groupdocs.metadata.formats.businesscard/vcardrootpackage/
---
## VCardRootPackage class

Αντιπροσωπεύει το ριζικό πακέτο που επιτρέπει την εργασία με μεταδεδομένα σε ένα αρχείο VCard.
...
| [VCardPackage](../../groupdocs.metadata.formats.businesscard/vcardrootpackage/vcardpackage) { get; } | Λαμβάνει το πακέτο μεταδεδομένων VCard. |
...
Αυτό το δείγμα κώδικα δείχνει πώς να διαβάζετε τις ιδιότητες μεταδεδομένων ενός αρχείου vCard.
