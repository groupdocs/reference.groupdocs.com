...
description: Αντιπροσωπεύει την κλάση μεταδεδομένων εγγραφής vCard Agent.
type: docs
weight: 610
url: /el/net/groupdocs.metadata.formats.businesscard/vcardagentrecord/
---
## VCardAgentRecord class

Αντιπροσωπεύει την κλάση μεταδεδομένων εγγραφής vCard Agent.
...
| override [ContentType](../../groupdocs.metadata.formats.businesscard/vcardagentrecord/contenttype) { get; } | Λαμβάνει τον τύπο περιεχομένου της εγγραφής. |
...
| [Value](../../groupdocs.metadata.formats.businesscard/vcardagentrecord/value) { get; } | Λαμβάνει την τιμή εγγραφής. |
