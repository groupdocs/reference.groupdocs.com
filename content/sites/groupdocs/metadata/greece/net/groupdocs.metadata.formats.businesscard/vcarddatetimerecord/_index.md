...
description: Αντιπροσωπεύει την κλάση μεταδεδομένων εγγραφής ημερομηνίας vCard ώρας.
type: docs
weight: 690
url: /el/net/groupdocs.metadata.formats.businesscard/vcarddatetimerecord/
---
## VCardDateTimeRecord class

Αντιπροσωπεύει την κλάση μεταδεδομένων εγγραφής ημερομηνίας vCard ώρας.
...
| override [ContentType](../../groupdocs.metadata.formats.businesscard/vcarddatetimerecord/contenttype) { get; } | Λαμβάνει τον τύπο περιεχομένου της εγγραφής. |
...
| [Value](../../groupdocs.metadata.formats.businesscard/vcarddatetimerecord/value) { get; } | Λαμβάνει την τιμή εγγραφής. |
