...
description: Αντιπροσωπεύει την κλάση μεταδεδομένων προσαρμοσμένης εγγραφής vCard.
type: docs
weight: 680
url: /el/net/groupdocs.metadata.formats.businesscard/vcardcustomrecord/
---
## VCardCustomRecord class

Αντιπροσωπεύει την κλάση μεταδεδομένων προσαρμοσμένης εγγραφής vCard.
...
| override [ContentType](../../groupdocs.metadata.formats.businesscard/vcardcustomrecord/contenttype) { get; } | Λαμβάνει τον τύπο περιεχομένου της εγγραφής. |
...
| [Value](../../groupdocs.metadata.formats.businesscard/vcardcustomrecord/value) { get; } | Λαμβάνει την τιμή εγγραφής. |
