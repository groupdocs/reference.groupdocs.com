...
description: Αντιπροσωπεύει μεταδεδομένα μορφής ηλεκτρονικής επαγγελματικής κάρτας VCF Virtual Contact File.
type: docs
weight: 760
url: /el/net/groupdocs.metadata.formats.businesscard/vcardpackage/
---
## VCardPackage class

Αντιπροσωπεύει μεταδεδομένα μορφής ηλεκτρονικής επαγγελματικής κάρτας VCF (Virtual Contact File).
...
| Ονομα | Περιγραφή |
| --- | --- |
| [Cards](../../groupdocs.metadata.formats.businesscard/vcardpackage/cards) { get; } | Λαμβάνει μια σειρά από τις κάρτες που εξάγονται από το αρχείο. |
