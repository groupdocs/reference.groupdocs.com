...
description: Παρέχει μια βασική κλάση ένωσης εγγραφής vCard.
type: docs
weight: 780
url: /el/net/groupdocs.metadata.formats.businesscard/vcardrecordset/
---
## VCardRecordset class

Παρέχει μια βασική κλάση ένωσης εγγραφής vCard.
