...
description: Αντιπροσωπεύει τα μεταδεδομένα κομματιού σε ένα βίντεο Matroska.
type: docs
weight: 2550
url: /el/net/groupdocs.metadata.formats.video/matroskatrack/
---
## MatroskaTrack class
...
| [Language](../../groupdocs.metadata.formats.video/matroskatrack/language) { get; } | Λαμβάνει τη γλώσσα του κομματιού στη φόρμα γλωσσών Matroska. Αυτό το στοιχείο ΠΡΕΠΕΙ να αγνοηθεί εάν[`LanguageIetf`](./languageietf) Το στοιχείο χρησιμοποιείται στο ίδιο TrackEntry. |
| [LanguageIetf](../../groupdocs.metadata.formats.video/matroskatrack/languageietf) { get; } | Λαμβάνει τη γλώσσα του κομματιού σύμφωνα με το BCP 47 και χρησιμοποιώντας το Μητρώο υποετικέτας γλώσσας IANA. Εάν χρησιμοποιείται αυτό το Στοιχείο, τότε οποιοδήποτε[`Language`](./language) Τα στοιχεία που χρησιμοποιούνται στο ίδιο TrackEntry ΠΡΕΠΕΙ να αγνοηθούν. |
