...
description: Αντιπροσωπεύει μεταδεδομένα ήχου σε βίντεο Matroska.
type: docs
weight: 2430
url: /el/net/groupdocs.metadata.formats.video/matroskaaudiotrack/
---
## MatroskaAudioTrack class

Αντιπροσωπεύει μεταδεδομένα ήχου σε βίντεο Matroska.
...
| Ονομα | Περιγραφή |
| --- | --- |
| [BitDepth](../../groupdocs.metadata.formats.video/matroskaaudiotrack/bitdepth) { get; } | Λαμβάνει τα bit ανά δείγμα, που χρησιμοποιούνται κυρίως για PCM. |
| [Channels](../../groupdocs.metadata.formats.video/matroskaaudiotrack/channels) { get; } | Λαμβάνει τους αριθμούς των καναλιών στο κομμάτι. |
...
| [OutputSamplingFrequency](../../groupdocs.metadata.formats.video/matroskaaudiotrack/outputsamplingfrequency) { get; } | Λαμβάνει την πραγματική συχνότητα δειγματοληψίας εξόδου σε Hz (χρησιμοποιείται για τεχνικές SBR). |
| [PropertyDescriptors](../../groupdocs.metadata.common/metadatapackage/propertydescriptors) { get; } | Λαμβάνει μια συλλογή περιγραφών που περιέχουν πληροφορίες σχετικά με ιδιότητες προσβάσιμες μέσω της μηχανής αναζήτησης GroupDocs.Metadata. |
| [SamplingFrequency](../../groupdocs.metadata.formats.video/matroskaaudiotrack/samplingfrequency) { get; } | Λαμβάνει τη συχνότητα δειγματοληψίας σε Hz. |
