...
description: Αντιπροσωπεύει το ριζικό πακέτο που επιτρέπει την εργασία με μεταδεδομένα σε ένα βίντεο AVI.
type: docs
weight: 2400
url: /el/net/groupdocs.metadata.formats.video/avirootpackage/
---
## AviRootPackage class

Αντιπροσωπεύει το ριζικό πακέτο που επιτρέπει την εργασία με μεταδεδομένα σε ένα βίντεο AVI.
...
| [Header](../../groupdocs.metadata.formats.video/avirootpackage/header) { get; } | Λαμβάνει το πακέτο κεφαλίδων AVI. |
...
| [RiffInfoPackage](../../groupdocs.metadata.formats.video/avirootpackage/riffinfopackage) { get; } | Λαμβάνει το πακέτο που περιέχει ετικέτες πληροφοριών RIFF. |
| [XmpPackage](../../groupdocs.metadata.formats.video/avirootpackage/xmppackage) { get; set; } | Λαμβάνει ή ορίζει το πακέτο μεταδεδομένων XMP. |
