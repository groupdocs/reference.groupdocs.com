...
description: Λαμβάνει το πακέτο μεταδεδομένων ASF.
type: docs
weight: 10
url: /el/net/groupdocs.metadata.formats.video/asfrootpackage/asfpackage/
---
## AsfRootPackage.AsfPackage property

Λαμβάνει το πακέτο μεταδεδομένων ASF.
...
Αυτό το δείγμα κώδικα δείχνει πώς να διαβάζετε εγγενή μεταδεδομένα ASF.
...
using (Metadata metadata = new Metadata(Constants.InputAsf))
{
    ...
    // Εμφάνιση περιγραφών μεταδεδομένων
    ...
    //Εμφάνιση των ιδιοτήτων της βασικής ροής
    foreach (AsfBaseStreamProperty property in package.StreamProperties)
    {
        ...
        //Εμφάνιση των ιδιοτήτων ροής ήχου
        ...
        //Εμφάνιση των ιδιοτήτων ροής βίντεο
...
* χώρος ονομάτων [GroupDocs.Metadata.Formats.Video](../../asfrootpackage)
