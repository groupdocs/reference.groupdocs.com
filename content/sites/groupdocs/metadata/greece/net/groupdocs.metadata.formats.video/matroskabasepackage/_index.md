...
description: Παρέχει μια βασική κατηγορία μεταδεδομένων για όλα τα πακέτα που εξάγονται από ένα βίντεο Matroska.
type: docs
weight: 2440
url: /el/net/groupdocs.metadata.formats.video/matroskabasepackage/
---
## MatroskaBasePackage class

Παρέχει μια βασική κατηγορία μεταδεδομένων για όλα τα πακέτα που εξάγονται από ένα βίντεο Matroska.
