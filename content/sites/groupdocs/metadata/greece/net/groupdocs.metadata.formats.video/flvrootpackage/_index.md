...
description: Αντιπροσωπεύει το ριζικό πακέτο που επιτρέπει την εργασία με μεταδεδομένα σε βίντεο FLV.
type: docs
weight: 2420
url: /el/net/groupdocs.metadata.formats.video/flvrootpackage/
---
## FlvRootPackage class

Αντιπροσωπεύει το ριζικό πακέτο που επιτρέπει την εργασία με μεταδεδομένα σε βίντεο FLV.
...
| [Header](../../groupdocs.metadata.formats.video/flvrootpackage/header) { get; } | Λαμβάνει το πακέτο κεφαλίδων FLV. |
...
| [XmpPackage](../../groupdocs.metadata.formats.video/flvrootpackage/xmppackage) { get; set; } | Λαμβάνει ή ορίζει το πακέτο μεταδεδομένων XMP. |
