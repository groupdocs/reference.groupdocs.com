...
description: Αντιπροσωπεύει μεταδεδομένα ιδιότητας ροής βίντεο στο κοντέινερ πολυμέσων ASF.
type: docs
weight: 2370
url: /el/net/groupdocs.metadata.formats.video/asfvideostreamproperty/
---
## AsfVideoStreamProperty class

Αντιπροσωπεύει μεταδεδομένα ιδιότητας ροής βίντεο στο κοντέινερ πολυμέσων ASF.
...
| [BitsPerPixels](../../groupdocs.metadata.formats.video/asfvideostreamproperty/bitsperpixels) { get; } | Λαμβάνει τα bit ανά pixel. |
| [Compression](../../groupdocs.metadata.formats.video/asfvideostreamproperty/compression) { get; } | Λαμβάνει τη συμπίεση βίντεο Id. |
...
| [ImageHeight](../../groupdocs.metadata.formats.video/asfvideostreamproperty/imageheight) { get; } | Λαμβάνει το ύψος της κωδικοποιημένης εικόνας σε pixel. |
| [ImageWidth](../../groupdocs.metadata.formats.video/asfvideostreamproperty/imagewidth) { get; } | Λαμβάνει το πλάτος της κωδικοποιημένης εικόνας σε pixel. |
