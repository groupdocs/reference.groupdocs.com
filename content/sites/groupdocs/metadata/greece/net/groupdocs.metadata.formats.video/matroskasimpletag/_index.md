...
description: Αντιπροσωπεύει γενικές πληροφορίες σχετικά με τον στόχο σε ένα βίντεο Matroska.
type: docs
weight: 2500
url: /el/net/groupdocs.metadata.formats.video/matroskasimpletag/
---
## MatroskaSimpleTag class

Αντιπροσωπεύει γενικές πληροφορίες σχετικά με τον στόχο σε ένα βίντεο Matroska.
