...
description: Λαμβάνει το πακέτο μεταδεδομένων Matroska.
type: docs
weight: 10
url: /el/net/groupdocs.metadata.formats.video/matroskarootpackage/matroskapackage/
---
## MatroskaRootPackage.MatroskaPackage property

Λαμβάνει το πακέτο μεταδεδομένων Matroska.
...
Το πακέτο μεταδεδομένων Matroska.
...
Αυτό το παράδειγμα δείχνει πώς να διαβάζετε ιδιότητες μεταδεδομένων για συγκεκριμένη μορφή Matroska.
...
using (Metadata metadata = new Metadata(Constants.InputMkv))
{
    ...
    // Διαβάστε πληροφορίες τμήματος Matroska
    ...
    // Διαβάστε τα μεταδεδομένα ετικέτας Matroska
    ...
    // Διαβάστε τα μεταδεδομένα του κομματιού Matroska
...
* χώρος ονομάτων [GroupDocs.Metadata.Formats.Video](../../matroskarootpackage)
