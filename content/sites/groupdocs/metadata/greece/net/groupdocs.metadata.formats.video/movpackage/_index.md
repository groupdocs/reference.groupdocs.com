...
description: Αντιπροσωπεύει μεταδεδομένα QuickTime.
type: docs
weight: 2630
url: /el/net/groupdocs.metadata.formats.video/movpackage/
---
## MovPackage class

Αντιπροσωπεύει μεταδεδομένα QuickTime.
...
| Ονομα | Περιγραφή |
| --- | --- |
| [Atoms](../../groupdocs.metadata.formats.video/movpackage/atoms) { get; } | Λαμβάνει έναν πίνακα από[`MovAtom`](../movatom) άτομα. |
