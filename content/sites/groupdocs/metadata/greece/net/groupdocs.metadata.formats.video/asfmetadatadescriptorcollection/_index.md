...
description: Αντιπροσωπεύει μια συλλογή περιγραφών μεταδεδομένων.
type: docs
weight: 2330
url: /el/net/groupdocs.metadata.formats.video/asfmetadatadescriptorcollection/
---
## AsfMetadataDescriptorCollection class

Αντιπροσωπεύει μια συλλογή περιγραφών μεταδεδομένων.
