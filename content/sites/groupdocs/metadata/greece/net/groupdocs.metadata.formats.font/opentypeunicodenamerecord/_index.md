...
description: Αντιπροσωπεύει την τιμή του πίνακα εγγραφής ονόματος για τοUnicodeπλατφόρμα.
type: docs
weight: 1580
url: /el/net/groupdocs.metadata.formats.font/opentypeunicodenamerecord/
---
## OpenTypeUnicodeNameRecord class

Αντιπροσωπεύει την τιμή του πίνακα εγγραφής ονόματος για τοUnicodeπλατφόρμα.
...
| [Encoding](../../groupdocs.metadata.formats.font/opentypeunicodenamerecord/encoding) { get; } | Λαμβάνει το αναγνωριστικό κωδικοποίησης. |
