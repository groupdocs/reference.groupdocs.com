...
description: Αντιπροσωπεύει το ριζικό πακέτο που επιτρέπει την εργασία με μεταδεδομένα σε ένα αρχείο γραμματοσειράς OpenType.
type: docs
weight: 1550
url: /el/net/groupdocs.metadata.formats.font/opentyperootpackage/
---
## OpenTypeRootPackage class

Αντιπροσωπεύει το ριζικό πακέτο που επιτρέπει την εργασία με μεταδεδομένα σε ένα αρχείο γραμματοσειράς OpenType.
...
| [DigitalSignaturePackage](../../groupdocs.metadata.formats.font/opentyperootpackage/digitalsignaturepackage) { get; } | Λαμβάνει το πακέτο μεταδεδομένων ψηφιακής υπογραφής. |
...
| [OpenTypePackage](../../groupdocs.metadata.formats.font/opentyperootpackage/opentypepackage) { get; } | Λαμβάνει το πακέτο μεταδεδομένων OpenType. |
