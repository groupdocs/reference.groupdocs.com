...
description: Παρέχει μια αφηρημένη βασική κλάση για λεξικά μεταδεδομένων EXIF.
type: docs
weight: 2750
url: /el/net/groupdocs.metadata.standards.exif/exifdictionarybasepackage/
---
## ExifDictionaryBasePackage class

Παρέχει μια αφηρημένη βασική κλάση για λεξικά μεταδεδομένων EXIF.
