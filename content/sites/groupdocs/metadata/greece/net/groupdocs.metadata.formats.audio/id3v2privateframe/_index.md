...
description: Αντιπροσωπεύει ένα πλαίσιο PRIV σε έναID3V2Tag./id3v2tag . Το πλαίσιο χρησιμοποιείται για να περιέχει πληροφορίες από έναν παραγωγό λογισμικού ότι το πρόγραμμά του χρησιμοποιεί και δεν ταιριάζει στα άλλα πλαίσια.
type: docs
weight: 480
url: /el/net/groupdocs.metadata.formats.audio/id3v2privateframe/
---
## ID3V2PrivateFrame class

Αντιπροσωπεύει ένα πλαίσιο PRIV σε ένα[`ID3V2Tag`](../id3v2tag) . Το πλαίσιο χρησιμοποιείται για να περιέχει πληροφορίες από έναν παραγωγό λογισμικού ότι το πρόγραμμά του χρησιμοποιεί και δεν ταιριάζει στα άλλα πλαίσια.
...
| Ονομα | Περιγραφή |
| --- | --- |
| [ID3V2PrivateFrame](id3v2privateframe)(string, byte[]) | Αρχικοποιεί μια νέα παρουσία του[`ID3V2PrivateFrame`](../id3v2privateframe) τάξη. |

## Ιδιότητες

| Ονομα | Περιγραφή |
| --- | --- |
| [BinaryData](../../groupdocs.metadata.formats.audio/id3v2privateframe/binarydata) { get; } | Λαμβάνει τα δυαδικά δεδομένα. |
...
| [OwnerIdentifier](../../groupdocs.metadata.formats.audio/id3v2privateframe/owneridentifier) { get; } | Λαμβάνει το αναγνωριστικό κατόχου. |
