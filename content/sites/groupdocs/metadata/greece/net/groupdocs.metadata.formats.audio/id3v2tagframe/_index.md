...
description: Αντιπροσωπεύει ένα γενικό πλαίσιο σε έναID3V2Tag./id3v2tag .
type: docs
weight: 500
url: /el/net/groupdocs.metadata.formats.audio/id3v2tagframe/
---
## ID3V2TagFrame class

Αντιπροσωπεύει ένα γενικό πλαίσιο σε ένα[`ID3V2Tag`](../id3v2tag) .
...
| Ονομα | Περιγραφή |
| --- | --- |
| [ID3V2TagFrame](id3v2tagframe)(string, byte[]) | Αρχικοποιεί μια νέα παρουσία του[`ID3V2TagFrame`](../id3v2tagframe) τάξη. |
