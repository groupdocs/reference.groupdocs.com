...
description: Αντιπροσωπεύει μια βασική αφηρημένη κλάση για τις ετικέτες ήχου ID3v1 και ID3v2.
type: docs
weight: 390
url: /el/net/groupdocs.metadata.formats.audio/id3tag/
---
## ID3Tag class

Αντιπροσωπεύει μια βασική αφηρημένη κλάση για τις ετικέτες ήχου ID3(v1) και ID3(v2).
...
| abstract [Version](../../groupdocs.metadata.formats.audio/id3tag/version) { get; } | Λαμβάνει την έκδοση της ετικέτας ID3 σε μορφή συμβολοσειράς. Για παράδειγμα: 'ID3v1.1'. |
