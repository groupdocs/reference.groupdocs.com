...
description: Αντιπροσωπεύει ένα πλαίσιο συνδέσμου URL σε έναID3V2Tag./id3v2tag Το όνομα του πλαισίου ξεκινά πάντα με τον χαρακτήρα W.
type: docs
weight: 530
url: /el/net/groupdocs.metadata.formats.audio/id3v2urllinkframe/
---
## ID3V2UrlLinkFrame class

Αντιπροσωπεύει ένα πλαίσιο συνδέσμου URL σε ένα[`ID3V2Tag`](../id3v2tag) Το όνομα του πλαισίου ξεκινά πάντα με τον χαρακτήρα W.
...
| Ονομα | Περιγραφή |
| --- | --- |
| [ID3V2UrlLinkFrame](id3v2urllinkframe)(string, string) | Αρχικοποιεί μια νέα παρουσία του[`ID3V2UrlLinkFrame`](../id3v2urllinkframe) τάξη. |
...
| [Url](../../groupdocs.metadata.formats.audio/id3v2urllinkframe/url) { get; } | Λαμβάνει την τιμή της διεύθυνσης URL. |
