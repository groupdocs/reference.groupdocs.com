...
description: Αντιπροσωπεύει ένα πλαίσιο MLLT σε έναID3V2Tag./id3v2tag .
type: docs
weight: 460
url: /el/net/groupdocs.metadata.formats.audio/id3v2mlltframe/
---
## ID3V2MlltFrame class

Αντιπροσωπεύει ένα πλαίσιο MLLT σε ένα[`ID3V2Tag`](../id3v2tag) .
