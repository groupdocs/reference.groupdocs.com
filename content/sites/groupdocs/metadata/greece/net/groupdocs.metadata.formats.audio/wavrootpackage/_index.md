...
description: Αντιπροσωπεύει το ριζικό πακέτο που επιτρέπει την εργασία με μεταδεδομένα σε ήχο WAV.
type: docs
weight: 600
url: /el/net/groupdocs.metadata.formats.audio/wavrootpackage/
---
## WavRootPackage class

Αντιπροσωπεύει το ριζικό πακέτο που επιτρέπει την εργασία με μεταδεδομένα σε ήχο WAV.
...
| [RiffInfoPackage](../../groupdocs.metadata.formats.audio/wavrootpackage/riffinfopackage) { get; } | Λαμβάνει το πακέτο που περιέχει ετικέτες πληροφοριών RIFF. |
| [WavPackage](../../groupdocs.metadata.formats.audio/wavrootpackage/wavpackage) { get; } | Λαμβάνει το πακέτο εγγενών μεταδεδομένων WAV. |
| [XmpPackage](../../groupdocs.metadata.formats.audio/wavrootpackage/xmppackage) { get; set; } | Λαμβάνει ή ορίζει το πακέτο μεταδεδομένων XMP. |
