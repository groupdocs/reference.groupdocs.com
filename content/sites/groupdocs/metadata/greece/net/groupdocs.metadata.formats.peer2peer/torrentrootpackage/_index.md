...
description: Αντιπροσωπεύει το ριζικό πακέτο που προορίζεται να λειτουργήσει με μεταδεδομένα ενός αρχείου TORRENT.
type: docs
weight: 2200
url: /el/net/groupdocs.metadata.formats.peer2peer/torrentrootpackage/
---
## TorrentRootPackage class

Αντιπροσωπεύει το ριζικό πακέτο που προορίζεται να λειτουργήσει με μεταδεδομένα ενός αρχείου TORRENT.
...
| [TorrentPackage](../../groupdocs.metadata.formats.peer2peer/torrentrootpackage/torrentpackage) { get; } | Λαμβάνει το πακέτο μεταδεδομένων του αρχείου TORRENT. |
...
Αυτό το δείγμα κώδικα δείχνει πώς να διαβάζετε τα μεταδεδομένα ενός αρχείου TORRENT.
