...
description: Αντιπροσωπεύει το ριζικό πακέτο που προορίζεται για εργασία με μεταδεδομένα σε μια εικόνα WMF.
type: docs
weight: 2140
url: /el/net/groupdocs.metadata.formats.image/wmfrootpackage/
---
## WmfRootPackage class

Αντιπροσωπεύει το ριζικό πακέτο που προορίζεται για εργασία με μεταδεδομένα σε μια εικόνα WMF.
