...
description: Αντιπροσωπεύει το ριζικό πακέτο που επιτρέπει την εργασία με μεταδεδομένα σε μια εικόνα WEBP.
type: docs
weight: 2130
url: /el/net/groupdocs.metadata.formats.image/webprootpackage/
---
## WebPRootPackage class

Αντιπροσωπεύει το ριζικό πακέτο που επιτρέπει την εργασία με μεταδεδομένα σε μια εικόνα WEBP.
...
| [ExifPackage](../../groupdocs.metadata.formats.image/webprootpackage/exifpackage) { get; set; } | Λαμβάνει ή ορίζει το πακέτο μεταδεδομένων EXIF. |
...
| [XmpPackage](../../groupdocs.metadata.formats.image/webprootpackage/xmppackage) { get; set; } | Λαμβάνει ή ορίζει το πακέτο μεταδεδομένων XMP. |
