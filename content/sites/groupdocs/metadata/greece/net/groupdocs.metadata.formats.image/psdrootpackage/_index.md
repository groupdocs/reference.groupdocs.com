...
description: Αντιπροσωπεύει το ριζικό πακέτο που επιτρέπει την εργασία με μεταδεδομένα σε ένα έγγραφο Photoshop.
type: docs
weight: 1930
url: /el/net/groupdocs.metadata.formats.image/psdrootpackage/
---
## PsdRootPackage class

Αντιπροσωπεύει το ριζικό πακέτο που επιτρέπει την εργασία με μεταδεδομένα σε ένα έγγραφο Photoshop.
...
| [ExifPackage](../../groupdocs.metadata.formats.image/psdrootpackage/exifpackage) { get; set; } | Λαμβάνει ή ορίζει το πακέτο μεταδεδομένων EXIF. |
...
| [ImageResourcePackage](../../groupdocs.metadata.formats.image/psdrootpackage/imageresourcepackage) { get; } | Λαμβάνει το πακέτο μεταδεδομένων του Photoshop Image Resource. Τα μπλοκ πόρων εικόνας είναι η βασική δομική μονάδα της εγγενούς μορφής αρχείου Photoshop. |
| [IptcPackage](../../groupdocs.metadata.formats.image/psdrootpackage/iptcpackage) { get; set; } | Λαμβάνει ή ορίζει το πακέτο μεταδεδομένων IPTC. |
...
| [PsdPackage](../../groupdocs.metadata.formats.image/psdrootpackage/psdpackage) { get; } | Λαμβάνει το πακέτο μεταδεδομένων που περιέχει πληροφορίες σχετικά με το αρχείο PSD. |
| [XmpPackage](../../groupdocs.metadata.formats.image/psdrootpackage/xmppackage) { get; set; } | Λαμβάνει ή ορίζει το πακέτο μεταδεδομένων XMP. |
