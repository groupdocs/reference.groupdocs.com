...
description: Αντιπροσωπεύει δεδομένα κειμένου που εξάγονται από μια εικόνα PNG.
type: docs
weight: 1870
url: /el/net/groupdocs.metadata.formats.image/pngtextchunk/
---
## PngTextChunk class

Αντιπροσωπεύει δεδομένα κειμένου που εξάγονται από μια εικόνα PNG.
