...
description: Αντιπροσωπεύει εγγενή μεταδεδομένα PNG.
type: docs
weight: 1850
url: /el/net/groupdocs.metadata.formats.image/pngpackage/
---
## PngPackage class

Αντιπροσωπεύει εγγενή μεταδεδομένα PNG.
...
| [TextChunks](../../groupdocs.metadata.formats.image/pngpackage/textchunks) { get; } | Λαμβάνει τη συλλογή των τμημάτων κειμένου που εξάγονται από την εικόνα. |
