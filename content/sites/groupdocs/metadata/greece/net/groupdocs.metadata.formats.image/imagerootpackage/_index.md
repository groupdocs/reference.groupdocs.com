...
description: Παρέχει μια βασική αφηρημένη κλάση για όλα τα ριζικά πακέτα εικόνων.
type: docs
weight: 1770
url: /el/net/groupdocs.metadata.formats.image/imagerootpackage/
---
## ImageRootPackage class

Παρέχει μια βασική αφηρημένη κλάση για όλα τα ριζικά πακέτα εικόνων.
