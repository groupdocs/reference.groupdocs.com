...
description: Αντιπροσωπεύει συμπιεσμένα δεδομένα κειμένου που εξάγονται από μια εικόνα PNG.
type: docs
weight: 1820
url: /el/net/groupdocs.metadata.formats.image/pngcompressedtextchunk/
---
## PngCompressedTextChunk class

Αντιπροσωπεύει συμπιεσμένα δεδομένα κειμένου που εξάγονται από μια εικόνα PNG.
