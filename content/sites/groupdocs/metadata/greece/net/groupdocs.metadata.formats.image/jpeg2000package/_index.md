...
description: Αντιπροσωπεύει εγγενή μεταδεδομένα JPEG2000.
type: docs
weight: 1790
url: /el/net/groupdocs.metadata.formats.image/jpeg2000package/
---
## Jpeg2000Package class

Αντιπροσωπεύει εγγενή μεταδεδομένα JPEG2000.
...
| Ονομα | Περιγραφή |
| --- | --- |
| [Comments](../../groupdocs.metadata.formats.image/jpeg2000package/comments) { get; } | Λαμβάνει τα σχόλια JPEG2000. |
