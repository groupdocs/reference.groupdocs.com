...
type: docs
weight: 980
url: /el/net/groupdocs.metadata.formats.document/pdfannotation/
---
## PdfAnnotation class
...
| [Name](../../groupdocs.metadata.formats.document/pdfannotation/name) { get; } | Παίρνει το όνομα του σχολιασμού. |
| [PageNumber](../../groupdocs.metadata.formats.document/pdfannotation/pagenumber) { get; } | Λαμβάνει τον αριθμό της σελίδας που περιέχει τον σχολιασμό. |
| [PropertyDescriptors](../../groupdocs.metadata.common/metadatapackage/propertydescriptors) { get; } | Λαμβάνει μια συλλογή περιγραφών που περιέχουν πληροφορίες σχετικά με ιδιότητες προσβάσιμες μέσω της μηχανής αναζήτησης GroupDocs.Metadata. |
| [Text](../../groupdocs.metadata.formats.document/pdfannotation/text) { get; } | Λαμβάνει το κείμενο σχολιασμού. |
