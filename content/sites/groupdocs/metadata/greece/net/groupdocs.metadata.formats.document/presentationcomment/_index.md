...
description: Αντιπροσωπεύει ένα σχόλιο χρήστη σε μια παρουσίαση.
type: docs
weight: 1060
url: /el/net/groupdocs.metadata.formats.document/presentationcomment/
---
## PresentationComment class

Αντιπροσωπεύει ένα σχόλιο χρήστη σε μια παρουσίαση.
...
| Ονομα | Περιγραφή |
| --- | --- |
| [Author](../../groupdocs.metadata.formats.document/presentationcomment/author) { get; } | Λαμβάνει τον συγγραφέα του σχολίου. |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | Λαμβάνει τον αριθμό των ιδιοτήτων μεταδεδομένων. |
| [CreatedTime](../../groupdocs.metadata.formats.document/presentationcomment/createdtime) { get; } | Λαμβάνει την ώρα δημιουργίας του σχολίου. |
...
| [SlideNumber](../../groupdocs.metadata.formats.document/presentationcomment/slidenumber) { get; } | Λαμβάνει τον αριθμό διαφάνειας στον οποίο ανήκει το σχόλιο. |
| [Text](../../groupdocs.metadata.formats.document/presentationcomment/text) { get; } | Λαμβάνει το κείμενο του σχολίου. |
