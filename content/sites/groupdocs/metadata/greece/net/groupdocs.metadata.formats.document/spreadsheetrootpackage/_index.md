...
description: Αντιπροσωπεύει το ριζικό πακέτο που επιτρέπει την εργασία με μεταδεδομένα σε ένα υπολογιστικό φύλλο.
type: docs
weight: 1210
url: /el/net/groupdocs.metadata.formats.document/spreadsheetrootpackage/
---
## SpreadsheetRootPackage class

Αντιπροσωπεύει το ριζικό πακέτο που επιτρέπει την εργασία με μεταδεδομένα σε ένα υπολογιστικό φύλλο.
...
| [DocumentStatistics](../../groupdocs.metadata.formats.document/spreadsheetrootpackage/documentstatistics) { get; } | Λαμβάνει το πακέτο στατιστικών εγγράφων. |
| [FileType](../../groupdocs.metadata.formats.document/spreadsheetrootpackage/filetype) { get; } | Λαμβάνει το πακέτο μεταδεδομένων τύπου αρχείου. (2 properties) |
| [InspectionPackage](../../groupdocs.metadata.formats.document/spreadsheetrootpackage/inspectionpackage) { get; } | Λαμβάνει ένα πακέτο μεταδεδομένων που περιέχει αποτελέσματα επιθεώρησης για το έγγραφο. Το πακέτο περιέχει πληροφορίες σχετικά με μέρη εγγράφου που μπορούν να θεωρηθούν ως μεταδεδομένα σε ορισμένες περιπτώσεις. |
...
Αυτό το απόσπασμα κώδικα δείχνει πώς να εξαγάγετε ενσωματωμένες ιδιότητες μεταδεδομένων από ένα υπολογιστικό φύλλο.

```csharp
/// χρησιμοποιώντας (Μεταδεδομένα μεταδεδομένα = νέα μεταδεδομένα(Constants.InputXlsx))
{
