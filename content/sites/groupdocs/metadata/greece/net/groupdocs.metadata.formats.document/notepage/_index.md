...
description: Αντιπροσωπεύει μια σελίδα σε μια ενότητα OneNote.
type: docs
weight: 960
url: /el/net/groupdocs.metadata.formats.document/notepage/
---
## NotePage class

Αντιπροσωπεύει μια σελίδα σε μια ενότητα OneNote.
...
| Ονομα | Περιγραφή |
| --- | --- |
| [Author](../../groupdocs.metadata.formats.document/notepage/author) { get; } | Λαμβάνει τον συγγραφέα της σελίδας. |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | Λαμβάνει τον αριθμό των ιδιοτήτων μεταδεδομένων. |
| [CreationTime](../../groupdocs.metadata.formats.document/notepage/creationtime) { get; } | Λαμβάνει το χρόνο δημιουργίας. |
...
| [LastModificationTime](../../groupdocs.metadata.formats.document/notepage/lastmodificationtime) { get; } | Λαμβάνει τον χρόνο τελευταίας τροποποίησης. |
| [MetadataType](../../groupdocs.metadata.common/metadatapackage/metadatatype) { get; } | Λαμβάνει τον τύπο μεταδεδομένων. |
| [PropertyDescriptors](../../groupdocs.metadata.common/metadatapackage/propertydescriptors) { get; } | Λαμβάνει μια συλλογή περιγραφών που περιέχουν πληροφορίες σχετικά με ιδιότητες προσβάσιμες μέσω της μηχανής αναζήτησης GroupDocs.Metadata. |
| [Title](../../groupdocs.metadata.formats.document/notepage/title) { get; } | Λαμβάνει τον τίτλο της σελίδας. |
