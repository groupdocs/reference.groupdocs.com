...
description: Αντιπροσωπεύει ένα πεδίο σε ένα έγγραφο επεξεργασίας κειμένου.
type: docs
weight: 1250
url: /el/net/groupdocs.metadata.formats.document/wordprocessingfield/
---
## WordProcessingField class

Αντιπροσωπεύει ένα πεδίο σε ένα έγγραφο επεξεργασίας κειμένου.
...
| Ονομα | Περιγραφή |
| --- | --- |
| [Code](../../groupdocs.metadata.formats.document/wordprocessingfield/code) { get; } | Λαμβάνει τον κωδικό πεδίου. |
...
| [Result](../../groupdocs.metadata.formats.document/wordprocessingfield/result) { get; } | Λαμβάνει το αποτέλεσμα του πεδίου. |
