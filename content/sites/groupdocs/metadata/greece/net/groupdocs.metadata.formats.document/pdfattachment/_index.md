...
description: Αντιπροσωπεύει ένα συνημμένο σε ένα έγγραφο PDF.
type: docs
weight: 990
url: /el/net/groupdocs.metadata.formats.document/pdfattachment/
---
## PdfAttachment class

Αντιπροσωπεύει ένα συνημμένο σε ένα έγγραφο PDF.
...
| [Description](../../groupdocs.metadata.formats.document/pdfattachment/description) { get; } | Λαμβάνει την περιγραφή του συνημμένου. |
...
| [MimeType](../../groupdocs.metadata.formats.document/pdfattachment/mimetype) { get; } | Λαμβάνει τον τύπο MIME του συνημμένου. |
| [Name](../../groupdocs.metadata.formats.document/pdfattachment/name) { get; } | Λαμβάνει το όνομα συνημμένου. |
