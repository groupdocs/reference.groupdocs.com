...
description: Αντιπροσωπεύει το ριζικό πακέτο που προορίζεται για εργασία με μεταδεδομένα σε μια παρουσίαση.
type: docs
weight: 1100
url: /el/net/groupdocs.metadata.formats.document/presentationrootpackage/
---
## PresentationRootPackage class

Αντιπροσωπεύει το ριζικό πακέτο που προορίζεται για εργασία με μεταδεδομένα σε μια παρουσίαση.
...
| [DocumentStatistics](../../groupdocs.metadata.formats.document/presentationrootpackage/documentstatistics) { get; } | Λαμβάνει το πακέτο στατιστικών εγγράφων. |
| [FileType](../../groupdocs.metadata.formats.document/presentationrootpackage/filetype) { get; } | Λαμβάνει το πακέτο μεταδεδομένων τύπου αρχείου. (2 properties) |
| [InspectionPackage](../../groupdocs.metadata.formats.document/presentationrootpackage/inspectionpackage) { get; } | Λαμβάνει ένα πακέτο μεταδεδομένων που περιέχει αποτελέσματα επιθεώρησης για το έγγραφο. Το πακέτο περιέχει πληροφορίες σχετικά με μέρη εγγράφου που μπορούν να θεωρηθούν ως μεταδεδομένα σε ορισμένες περιπτώσεις. |
...
Αυτό το παράδειγμα δείχνει πώς να εξαγάγετε ενσωματωμένες ιδιότητες μεταδεδομένων από μια παρουσίαση.
