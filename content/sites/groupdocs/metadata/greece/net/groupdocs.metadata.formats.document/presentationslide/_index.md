...
type: docs
weight: 1110
url: /el/net/groupdocs.metadata.formats.document/presentationslide/
---
...
| [Name](../../groupdocs.metadata.formats.document/presentationslide/name) { get; } | Λαμβάνει το όνομα της διαφάνειας. |
| [Number](../../groupdocs.metadata.formats.document/presentationslide/number) { get; } | Λαμβάνει τον αριθμό της διαφάνειας. |
| [PropertyDescriptors](../../groupdocs.metadata.common/metadatapackage/propertydescriptors) { get; } | Λαμβάνει μια συλλογή περιγραφών που περιέχουν πληροφορίες σχετικά με ιδιότητες προσβάσιμες μέσω της μηχανής αναζήτησης GroupDocs.Metadata. |
| [SlideId](../../groupdocs.metadata.formats.document/presentationslide/slideid) { get; } | Λαμβάνει το αναγνωριστικό της διαφάνειας. |
