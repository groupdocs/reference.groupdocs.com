...
description: Αντιπροσωπεύει έναν σελιδοδείκτη σε ένα έγγραφο PDF.
type: docs
weight: 1000
url: /el/net/groupdocs.metadata.formats.document/pdfbookmark/
---
## PdfBookmark class

Αντιπροσωπεύει έναν σελιδοδείκτη σε ένα έγγραφο PDF.
...
| [Title](../../groupdocs.metadata.formats.document/pdfbookmark/title) { get; } | Λαμβάνει τον τίτλο του σελιδοδείκτη. |
