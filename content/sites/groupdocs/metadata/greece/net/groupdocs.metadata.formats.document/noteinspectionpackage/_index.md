...
description: Αντιπροσωπεύει ένα πακέτο μεταδεδομένων που εκθέτει την εσωτερική δομή μιας ενότητας σημειώσεων.
type: docs
weight: 950
url: /el/net/groupdocs.metadata.formats.document/noteinspectionpackage/
---
## NoteInspectionPackage class

Αντιπροσωπεύει ένα πακέτο μεταδεδομένων που εκθέτει την εσωτερική δομή μιας ενότητας σημειώσεων.
...
| [Pages](../../groupdocs.metadata.formats.document/noteinspectionpackage/pages) { get; } | Λαμβάνει μια σειρά από σελίδες ενοτήτων. |
