...
description: Αντιπροσωπεύει τα εγγενή μεταδεδομένα σε ένα έγγραφο γραφείου.
type: docs
weight: 920
url: /el/net/groupdocs.metadata.formats.document/documentpackage/
---
## DocumentPackage class

Αντιπροσωπεύει τα εγγενή μεταδεδομένα σε ένα έγγραφο γραφείου.
