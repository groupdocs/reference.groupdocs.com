...
description: Αντιπροσωπεύει ένα φύλλο σε ένα έγγραφο υπολογιστικού φύλλου.
type: docs
weight: 1220
url: /el/net/groupdocs.metadata.formats.document/spreadsheetsheet/
---
## SpreadsheetSheet class

Αντιπροσωπεύει ένα φύλλο σε ένα έγγραφο υπολογιστικού φύλλου.
...
| [Name](../../groupdocs.metadata.formats.document/spreadsheetsheet/name) { get; } | Λαμβάνει το όνομα του φύλλου. |
| [Number](../../groupdocs.metadata.formats.document/spreadsheetsheet/number) { get; } | Λαμβάνει τον αριθμό φύλλου. |
