...
description: Αντιπροσωπεύει ένα πεδίο φόρμας σε ένα έγγραφο PDF.
type: docs
weight: 1010
url: /el/net/groupdocs.metadata.formats.document/pdfformfield/
---
## PdfFormField class

Αντιπροσωπεύει ένα πεδίο φόρμας σε ένα έγγραφο PDF.
...
| [Name](../../groupdocs.metadata.formats.document/pdfformfield/name) { get; } | Παίρνει το όνομα του πεδίου. |
| [PropertyDescriptors](../../groupdocs.metadata.common/metadatapackage/propertydescriptors) { get; } | Λαμβάνει μια συλλογή περιγραφών που περιέχουν πληροφορίες σχετικά με ιδιότητες προσβάσιμες μέσω της μηχανής αναζήτησης GroupDocs.Metadata. |
| [Value](../../groupdocs.metadata.formats.document/pdfformfield/value) { get; } | Λαμβάνει την τιμή του πεδίου. |
