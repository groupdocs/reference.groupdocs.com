...
description: Αντιπροσωπεύει το ριζικό πακέτο που επιτρέπει την εργασία με μεταδεδομένα σε σχέδιο CAD.
type: docs
weight: 850
url: /el/net/groupdocs.metadata.formats.cad/cadrootpackage/
---
## CadRootPackage class

Αντιπροσωπεύει το ριζικό πακέτο που επιτρέπει την εργασία με μεταδεδομένα σε σχέδιο CAD.
...
Αυτό το δείγμα κώδικα δείχνει πώς να διαβάζετε τα μεταδεδομένα ενός σχεδίου CAD.
