...
description: Αντιπροσωπεύει μια συλλογή προσαρμοσμένων ιδιοτήτων μεταδεδομένων CAD.
type: docs
weight: 830
url: /el/net/groupdocs.metadata.formats.cad/cadcustompropertypackage/
---
## CadCustomPropertyPackage class

Αντιπροσωπεύει μια συλλογή προσαρμοσμένων ιδιοτήτων μεταδεδομένων CAD.
