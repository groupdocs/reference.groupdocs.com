...
description: Αντιπροσωπεύει ένα κοντέινερ για ιδιότητες μεταδεδομένων XMP.
type: docs
weight: 3470
url: /el/net/groupdocs.metadata.standards.xmp/xmpmetadatacontainer/
---
## XmpMetadataContainer class

Αντιπροσωπεύει ένα κοντέινερ για ιδιότητες μεταδεδομένων XMP.
...
| abstract [GetXmpRepresentation](../../groupdocs.metadata.standards.xmp/xmpmetadatacontainer/getxmprepresentation)() | Μετατρέπει την τιμή XMP στην αναπαράσταση XML. |
