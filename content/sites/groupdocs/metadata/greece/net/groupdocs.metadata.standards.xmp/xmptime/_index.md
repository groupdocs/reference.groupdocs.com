...
description: Αναπαράσταση μιας τιμής χρόνου σε δευτερόλεπτα.
type: docs
weight: 3590
url: /el/net/groupdocs.metadata.standards.xmp/xmptime/
---
## XmpTime class
...
| Ονομα | Περιγραφή |
| --- | --- |
| [XmpTime](xmptime#constructor)() | Αρχικοποιεί μια νέα παρουσία του[`XmpTime`](../xmptime) τάξη. |
| [XmpTime](xmptime#constructor_1)(XmpRational, int) | Αρχικοποιεί μια νέα παρουσία του[`XmpTime`](../xmptime) τάξη. |
...
| [Scale](../../groupdocs.metadata.standards.xmp/xmptime/scale) { get; set; } | Λαμβάνει ή ορίζει την κλίμακα για την τιμή χρόνου. |
| [Value](../../groupdocs.metadata.standards.xmp/xmptime/value) { get; set; } | Λαμβάνει ή ορίζει την τιμή χρόνου στην καθορισμένη κλίμακα. |
