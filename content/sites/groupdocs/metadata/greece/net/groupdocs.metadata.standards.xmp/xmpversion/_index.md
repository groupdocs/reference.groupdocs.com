...
description: Αντιπροσωπεύει μια έκδοση ενός εγγράφου.
type: docs
weight: 3630
url: /el/net/groupdocs.metadata.standards.xmp/xmpversion/
---
## XmpVersion class

Αντιπροσωπεύει μια έκδοση ενός εγγράφου.
...
| Ονομα | Περιγραφή |
| --- | --- |
| [XmpVersion](xmpversion)() | Αρχικοποιεί μια νέα παρουσία του[`XmpVersion`](../xmpversion) τάξη. |

## Ιδιότητες

| Ονομα | Περιγραφή |
| --- | --- |
| [Comments](../../groupdocs.metadata.standards.xmp/xmpversion/comments) { get; set; } | Λαμβάνει ή ορίζει τα σχόλια σχετικά με το τι άλλαξε. |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | Λαμβάνει τον αριθμό των ιδιοτήτων μεταδεδομένων. |
| [Event](../../groupdocs.metadata.standards.xmp/xmpversion/event) { get; set; } | Λαμβάνει ή ορίζει την υψηλού επιπέδου, επίσημη περιγραφή της λειτουργίας που εκτέλεσε ο χρήστης. |
...
| [Modifier](../../groupdocs.metadata.standards.xmp/xmpversion/modifier) { get; set; } | Λαμβάνει ή ορίζει το άτομο που τροποποίησε αυτήν την έκδοση. |
| [ModifyDate](../../groupdocs.metadata.standards.xmp/xmpversion/modifydate) { get; set; } | Λαμβάνει ή ορίζει την ημερομηνία κατά την οποία έγινε check in αυτή η έκδοση. |
...
| [VersionNumber](../../groupdocs.metadata.standards.xmp/xmpversion/versionnumber) { get; set; } | Λαμβάνει ή ορίζει τον αριθμό της νέας έκδοσης. |
