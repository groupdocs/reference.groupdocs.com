...
description: Αντιπροσωπεύει ένα συμβάν υψηλού επιπέδου που συνέβη κατά την επεξεργασία ενός πόρου.
type: docs
weight: 3540
url: /el/net/groupdocs.metadata.standards.xmp/xmpresourceevent/
---
## XmpResourceEvent class

Αντιπροσωπεύει ένα συμβάν υψηλού επιπέδου που συνέβη κατά την επεξεργασία ενός πόρου.
...
| Ονομα | Περιγραφή |
| --- | --- |
| [XmpResourceEvent](xmpresourceevent)() | Αρχικοποιεί μια νέα παρουσία του[`XmpResourceEvent`](../xmpresourceevent) τάξη. |

## Ιδιότητες

| Ονομα | Περιγραφή |
| --- | --- |
| [Action](../../groupdocs.metadata.standards.xmp/xmpresourceevent/action) { get; set; } | Λαμβάνει ή ορίζει την ενέργεια που συνέβη. |
| [Changed](../../groupdocs.metadata.standards.xmp/xmpresourceevent/changed) { get; set; } | Λαμβάνει ή ορίζει μια λίστα οριοθετημένη με ερωτηματικό των τμημάτων του πόρου που άλλαξαν από το προηγούμενο ιστορικό συμβάντων. |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | Λαμβάνει τον αριθμό των ιδιοτήτων μεταδεδομένων. |
| [InstanceID](../../groupdocs.metadata.standards.xmp/xmpresourceevent/instanceid) { get; set; } | Λαμβάνει ή ορίζει την τιμή της ιδιότητας xmpMM:InstanceID για τον τροποποιημένο πόρο (έξοδος). |
...
| [Parameters](../../groupdocs.metadata.standards.xmp/xmpresourceevent/parameters) { get; set; } | Λαμβάνει ή ορίζει την πρόσθετη περιγραφή της ενέργειας. |
...
| [SoftwareAgent](../../groupdocs.metadata.standards.xmp/xmpresourceevent/softwareagent) { get; set; } | Λαμβάνει ή ορίζει τον παράγοντα λογισμικού που εκτέλεσε την ενέργεια. |
| [When](../../groupdocs.metadata.standards.xmp/xmpresourceevent/when) { get; set; } | Λαμβάνει ή ορίζει τη χρονική σήμανση του χρόνου που έλαβε χώρα η ενέργεια. |
