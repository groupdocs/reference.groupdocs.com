...
type: docs
weight: 3310
url: /el/net/groupdocs.metadata.standards.xmp/xmpcolorantcmyk/
---
...
| Ονομα | Περιγραφή |
| --- | --- |
| [XmpColorantCmyk](xmpcolorantcmyk#constructor)() | Αρχικοποιεί μια νέα παρουσία του[`XmpColorantCmyk`](../xmpcolorantcmyk) τάξη. |
| [XmpColorantCmyk](xmpcolorantcmyk#constructor_1)(double, double, double, double) | Αρχικοποιεί μια νέα παρουσία του[`XmpColorantCmyk`](../xmpcolorantcmyk) τάξη. |

## Ιδιότητες

| Ονομα | Περιγραφή |
| --- | --- |
| [Black](../../groupdocs.metadata.standards.xmp/xmpcolorantcmyk/black) { get; set; } | Λαμβάνει ή ορίζει το μαύρο στοιχείο. |
...
| [Cyan](../../groupdocs.metadata.standards.xmp/xmpcolorantcmyk/cyan) { get; set; } | Λαμβάνει ή ορίζει το κυανό στοιχείο. |
...
| [Magenta](../../groupdocs.metadata.standards.xmp/xmpcolorantcmyk/magenta) { get; set; } | Λαμβάνει ή ορίζει το στοιχείο ματζέντα. |
...
| [Yellow](../../groupdocs.metadata.standards.xmp/xmpcolorantcmyk/yellow) { get; set; } | Λαμβάνει ή ορίζει το κίτρινο στοιχείο. |
...
| Ονομα | Περιγραφή |
| --- | --- |
| const [ColorValueMax](../../groupdocs.metadata.standards.xmp/xmpcolorantcmyk/colorvaluemax) | Μέγιστη τιμή χρώματος σε χρωστική CMYK. |
| const [ColorValueMin](../../groupdocs.metadata.standards.xmp/xmpcolorantcmyk/colorvaluemin) | Ελάχιστη τιμή χρώματος σε χρωστική CMYK. |
