...
description: Αντιπροσωπεύει τον βασικό τύπο κειμένου XMP.
type: docs
weight: 3570
url: /el/net/groupdocs.metadata.standards.xmp/xmptext/
---
## XmpText class
...
| Ονομα | Περιγραφή |
| --- | --- |
| [XmpText](xmptext)(string) | Αρχικοποιεί μια νέα παρουσία του[`XmpText`](../xmptext) τάξη. |
