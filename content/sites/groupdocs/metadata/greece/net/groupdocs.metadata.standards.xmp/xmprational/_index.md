...
description: Αντιπροσωπεύει XMP XmpRational.
type: docs
weight: 3510
url: /el/net/groupdocs.metadata.standards.xmp/xmprational/
---
## XmpRational class

Αντιπροσωπεύει XMP XmpRational.
...
| Ονομα | Περιγραφή |
| --- | --- |
| [XmpRational](xmprational#constructor_1)(string) | Αρχικοποιεί μια νέα παρουσία του[`XmpBoolean`](../xmpboolean) τάξη. |
| [XmpRational](xmprational#constructor)(long, long) | Αρχικοποιεί μια νέα παρουσία του[`XmpRational`](../xmprational) τάξη. |

## Ιδιότητες

| Ονομα | Περιγραφή |
| --- | --- |
| [Denominator](../../groupdocs.metadata.standards.xmp/xmprational/denominator) { get; } | Παίρνει παρονομαστή |
| [DoubleValue](../../groupdocs.metadata.standards.xmp/xmprational/doublevalue) { get; } | Λαμβάνει την τιμή του ορθολογικού τύπου που παρουσιάζεται σε διπλή μορφή. |
| [Numerator](../../groupdocs.metadata.standards.xmp/xmprational/numerator) { get; } | Παίρνει αριθμητή. |
...
| override [GetXmpRepresentation](../../groupdocs.metadata.standards.xmp/xmprational/getxmprepresentation)() | Επιστρέφει την τιμή που περιέχεται στη συμβολοσειρά σε μορφή XMP. |
