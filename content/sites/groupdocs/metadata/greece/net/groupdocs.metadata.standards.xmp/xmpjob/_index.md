...
description: Αντιπροσωπεύει Job.
type: docs
weight: 3440
url: /el/net/groupdocs.metadata.standards.xmp/xmpjob/
---
## XmpJob class
...
| Ονομα | Περιγραφή |
| --- | --- |
| [XmpJob](xmpjob)() | Αρχικοποιεί μια νέα παρουσία του[`XmpJob`](../xmpjob) τάξη. |
...
| [ID](../../groupdocs.metadata.standards.xmp/xmpjob/id) { get; set; } | Λαμβάνει ή ορίζει μοναδικό αναγνωριστικό για την εργασία. Αυτό το πεδίο αποτελεί αναφορά σε κάποιο εξωτερικό σύστημα διαχείρισης εργασιών. |
...
| [Name](../../groupdocs.metadata.standards.xmp/xmpjob/name) { get; set; } | Λαμβάνει ή ορίζει το άτυπο όνομα της εργασίας. Αυτό το όνομα είναι για προβολή χρήστη και ανεπίσημα συστήματα. |
...
| [Url](../../groupdocs.metadata.standards.xmp/xmpjob/url) { get; set; } | Λαμβάνει ή ορίζει μια διεύθυνση URL αρχείου που αναφέρεται σε ένα εξωτερικό αρχείο διαχείρισης εργασιών. |
