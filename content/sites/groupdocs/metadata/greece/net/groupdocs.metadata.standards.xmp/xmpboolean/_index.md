...
description: Αντιπροσωπεύει τον βασικό τύπο Boolean XMP.
type: docs
weight: 3270
url: /el/net/groupdocs.metadata.standards.xmp/xmpboolean/
---
## XmpBoolean class
...
| Ονομα | Περιγραφή |
| --- | --- |
| [XmpBoolean](xmpboolean#constructor)() | Αρχικοποιεί μια νέα παρουσία του[`XmpBoolean`](../xmpboolean) κλάση με προεπιλεγμένη τιμή. |
| [XmpBoolean](xmpboolean#constructor_1)(bool) | Αρχικοποιεί μια νέα παρουσία του[`XmpBoolean`](../xmpboolean) κλάση με βάση τη δυαδική τιμή. |
| [XmpBoolean](xmpboolean#constructor_2)(string) | Αρχικοποιεί μια νέα παρουσία του[`XmpBoolean`](../xmpboolean) τάξη. |
...
| [Value](../../groupdocs.metadata.standards.xmp/xmpboolean/value) { get; } | Παίρνει την τιμή. |
...
| override [GetXmpRepresentation](../../groupdocs.metadata.standards.xmp/xmpboolean/getxmprepresentation)() | Επιστρέφει την τιμή που περιέχεται στη συμβολοσειρά σε μορφή XMP. |
