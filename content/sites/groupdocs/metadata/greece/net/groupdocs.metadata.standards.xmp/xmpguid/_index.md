...
description: Αντιπροσωπεύει το παγκόσμιο μοναδικό αναγνωριστικό XMP.
type: docs
weight: 3410
url: /el/net/groupdocs.metadata.standards.xmp/xmpguid/
---
## XmpGuid class
...
| Ονομα | Περιγραφή |
| --- | --- |
| [XmpGuid](xmpguid#constructor)(Guid) | Αρχικοποιεί μια νέα παρουσία του[`XmpGuid`](../xmpguid) τάξη. |
| [XmpGuid](xmpguid#constructor_1)(string) | Αρχικοποιεί μια νέα παρουσία του[`XmpGuid`](../xmpguid) τάξη. |
...
| [Value](../../groupdocs.metadata.standards.xmp/xmpguid/value) { get; } | Παίρνει την τιμή. |
...
| override [GetXmpRepresentation](../../groupdocs.metadata.standards.xmp/xmpguid/getxmprepresentation)() | Επιστρέφει την τιμή που περιέχεται στη συμβολοσειρά σε μορφή XMP. |
