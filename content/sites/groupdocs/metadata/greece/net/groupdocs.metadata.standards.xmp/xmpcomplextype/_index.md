...
description: Αντιπροσωπεύει την αφαίρεση βάσης για τον τύπο σύνθετης τιμής XMP.
type: docs
weight: 3350
url: /el/net/groupdocs.metadata.standards.xmp/xmpcomplextype/
---
## XmpComplexType class

Αντιπροσωπεύει την αφαίρεση βάσης για τον τύπο σύνθετης τιμής XMP.
...
Δείτε περισσότερα: XMP Specification Part 2, Chapter 1.2.2
