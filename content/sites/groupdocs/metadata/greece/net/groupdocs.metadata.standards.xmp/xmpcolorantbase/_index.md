...
description: Μια δομή που περιέχει τα χαρακτηριστικά μιας χρωστικής ουσίας swatch που χρησιμοποιείται σε ένα έγγραφο.
type: docs
weight: 3300
url: /el/net/groupdocs.metadata.standards.xmp/xmpcolorantbase/
---
## XmpColorantBase class

Μια δομή που περιέχει τα χαρακτηριστικά μιας χρωστικής ουσίας (swatch) που χρησιμοποιείται σε ένα έγγραφο.
