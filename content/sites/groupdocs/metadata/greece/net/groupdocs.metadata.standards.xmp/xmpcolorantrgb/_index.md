...
description: Αντιπροσωπεύει το RGB Colorant.
type: docs
weight: 3340
url: /el/net/groupdocs.metadata.standards.xmp/xmpcolorantrgb/
---
## XmpColorantRgb class

Αντιπροσωπεύει το RGB Colorant.
...
| Ονομα | Περιγραφή |
| --- | --- |
| [XmpColorantRgb](xmpcolorantrgb#constructor)() | Αρχικοποιεί μια νέα παρουσία του[`XmpColorantRgb`](../xmpcolorantrgb) τάξη. |
| [XmpColorantRgb](xmpcolorantrgb#constructor_1)(byte, byte, byte) | Αρχικοποιεί μια νέα παρουσία του[`XmpColorantRgb`](../xmpcolorantrgb) τάξη. |

## Ιδιότητες

| Ονομα | Περιγραφή |
| --- | --- |
| [Blue](../../groupdocs.metadata.standards.xmp/xmpcolorantrgb/blue) { get; set; } | Λαμβάνει ή ορίζει το μπλε στοιχείο. |
...
| [Green](../../groupdocs.metadata.standards.xmp/xmpcolorantrgb/green) { get; set; } | Λαμβάνει ή ορίζει την πράσινη τιμή. |
...
| [Red](../../groupdocs.metadata.standards.xmp/xmpcolorantrgb/red) { get; set; } | Λαμβάνει ή ορίζει το κόκκινο στοιχείο. |
