...
description: Αντιπροσωπεύει μια εγγραφή IPTC.
type: docs
weight: 2930
url: /el/net/groupdocs.metadata.standards.iptc/iptcrecord/
---
## IptcRecord class

Αντιπροσωπεύει μια εγγραφή IPTC.
...
| [Item](../../groupdocs.metadata.standards.iptc/iptcrecord/item) { get; } | Λαμβάνει το[`IptcDataSet`](../iptcdataset) με τον καθορισμένο αριθμό συνόλου δεδομένων. (2 indexers) |
