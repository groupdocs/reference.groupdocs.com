...
description: Αντιπροσωπεύει το ριζικό πακέτο που επιτρέπει την εργασία με μεταδεδομένα σε ένα μήνυμα ηλεκτρονικού ταχυδρομείου EML.
type: docs
weight: 1390
url: /el/net/groupdocs.metadata.formats.email/emlrootpackage/
---
## EmlRootPackage class

Αντιπροσωπεύει το ριζικό πακέτο που επιτρέπει την εργασία με μεταδεδομένα σε ένα μήνυμα ηλεκτρονικού ταχυδρομείου EML.
...
| [EmailPackage](../../groupdocs.metadata.formats.email/emlrootpackage/emailpackage) { get; } | Λαμβάνει το πακέτο μεταδεδομένων EML. (2 properties) |
...
Αυτό το δείγμα κώδικα δείχνει πώς να εξαγάγετε μεταδεδομένα από ένα μήνυμα EML.
