...
description: Αντιπροσωπεύει ένα πακέτο μεταδεδομένων που περιέχει κεφαλίδες μηνυμάτων email.
type: docs
weight: 1350
url: /el/net/groupdocs.metadata.formats.email/emailheaderpackage/
---
## EmailHeaderPackage class

Αντιπροσωπεύει ένα πακέτο μεταδεδομένων που περιέχει κεφαλίδες μηνυμάτων email.
...
| [Get](../../groupdocs.metadata.formats.email/emailheaderpackage/get)(string) | Λαμβάνει την τιμή της καθορισμένης κεφαλίδας. |
