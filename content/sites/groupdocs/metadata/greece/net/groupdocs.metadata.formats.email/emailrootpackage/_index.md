...
description: Αντιπροσωπεύει το ριζικό πακέτο που επιτρέπει την εργασία με μεταδεδομένα σε ένα μήνυμα email.
type: docs
weight: 1370
url: /el/net/groupdocs.metadata.formats.email/emailrootpackage/
---
## EmailRootPackage class

Αντιπροσωπεύει το ριζικό πακέτο που επιτρέπει την εργασία με μεταδεδομένα σε ένα μήνυμα email.
...
| [EmailPackage](../../groupdocs.metadata.formats.email/emailrootpackage/emailpackage) { get; } | Λαμβάνει το πακέτο μεταδεδομένων email. |
