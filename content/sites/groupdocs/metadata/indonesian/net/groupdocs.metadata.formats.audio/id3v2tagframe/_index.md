...
description: Mewakili bingkai umum dalam sebuahID3V2Tag./id3v2tag .
type: docs
weight: 500
url: /id/net/groupdocs.metadata.formats.audio/id3v2tagframe/
---
## ID3V2TagFrame class

Mewakili bingkai umum dalam sebuah[`ID3V2Tag`](../id3v2tag) .
...
| Nama | Keterangan |
| --- | --- |
| [ID3V2TagFrame](id3v2tagframe)(string, byte[]) | Menginisialisasi instance baru dari[`ID3V2TagFrame`](../id3v2tagframe) kelas. |
