...
description: Mewakili bingkai link URL dalam sebuahID3V2Tag./id3v2tag Nama frame selalu dimulai dengan karakter W.
type: docs
weight: 530
url: /id/net/groupdocs.metadata.formats.audio/id3v2urllinkframe/
---
## ID3V2UrlLinkFrame class

Mewakili bingkai link URL dalam sebuah[`ID3V2Tag`](../id3v2tag) Nama frame selalu dimulai dengan karakter W.
...
| Nama | Keterangan |
| --- | --- |
| [ID3V2UrlLinkFrame](id3v2urllinkframe)(string, string) | Menginisialisasi instance baru dari[`ID3V2UrlLinkFrame`](../id3v2urllinkframe) kelas. |
...
| [Url](../../groupdocs.metadata.formats.audio/id3v2urllinkframe/url) { get; } | Mendapat nilai URL. |
