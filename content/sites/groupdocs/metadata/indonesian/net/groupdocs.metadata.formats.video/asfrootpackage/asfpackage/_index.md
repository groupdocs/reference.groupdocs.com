...
description: Mendapatkan paket metadata ASF.
type: docs
weight: 10
url: /id/net/groupdocs.metadata.formats.video/asfrootpackage/asfpackage/
---
## AsfRootPackage.AsfPackage property

Mendapatkan paket metadata ASF.
...
Contoh kode ini menunjukkan cara membaca metadata ASF asli.
...
using (Metadata metadata = new Metadata(Constants.InputAsf))
{
    ...
    //Tampilkan properti aliran dasar
    foreach (AsfBaseStreamProperty property in package.StreamProperties)
    {
        ...
        //Menampilkan properti streaming audio
        ...
        //Tampilkan properti aliran video
...
* ruang nama [GroupDocs.Metadata.Formats.Video](../../asfrootpackage)
