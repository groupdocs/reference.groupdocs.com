...
description: Mewakili paket root yang memungkinkan bekerja dengan metadata dalam video ASF.
type: docs
weight: 2350
url: /id/net/groupdocs.metadata.formats.video/asfrootpackage/
---
## AsfRootPackage class

Mewakili paket root yang memungkinkan bekerja dengan metadata dalam video ASF.
...
| Nama | Keterangan |
| --- | --- |
| [AsfPackage](../../groupdocs.metadata.formats.video/asfrootpackage/asfpackage) { get; } | Mendapatkan paket metadata ASF. |
...
| [XmpPackage](../../groupdocs.metadata.formats.video/asfrootpackage/xmppackage) { get; set; } | Mendapat atau menyetel paket metadata XMP. |
