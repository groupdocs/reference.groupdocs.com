...
description: Mewakili metadata properti aliran Video dalam wadah media ASF.
type: docs
weight: 2370
url: /id/net/groupdocs.metadata.formats.video/asfvideostreamproperty/
---
## AsfVideoStreamProperty class

Mewakili metadata properti aliran Video dalam wadah media ASF.
...
| [BitsPerPixels](../../groupdocs.metadata.formats.video/asfvideostreamproperty/bitsperpixels) { get; } | Mendapat bit per piksel. |
| [Compression](../../groupdocs.metadata.formats.video/asfvideostreamproperty/compression) { get; } | Mendapatkan ID kompresi video. |
...
| [ImageHeight](../../groupdocs.metadata.formats.video/asfvideostreamproperty/imageheight) { get; } | Mendapat tinggi gambar yang disandikan dalam piksel. |
| [ImageWidth](../../groupdocs.metadata.formats.video/asfvideostreamproperty/imagewidth) { get; } | Mendapatkan lebar gambar yang disandikan dalam piksel. |
