...
description: Mewakili metadata audio dalam video Matroska.
type: docs
weight: 2430
url: /id/net/groupdocs.metadata.formats.video/matroskaaudiotrack/
---
## MatroskaAudioTrack class

Mewakili metadata audio dalam video Matroska.
...
| Nama | Keterangan |
| --- | --- |
| [BitDepth](../../groupdocs.metadata.formats.video/matroskaaudiotrack/bitdepth) { get; } | Mendapat bit per sampel, sebagian besar digunakan untuk PCM. |
| [Channels](../../groupdocs.metadata.formats.video/matroskaaudiotrack/channels) { get; } | Mendapat jumlah saluran di trek. |
...
| [OutputSamplingFrequency](../../groupdocs.metadata.formats.video/matroskaaudiotrack/outputsamplingfrequency) { get; } | Mendapatkan frekuensi pengambilan sampel keluaran nyata dalam Hz (digunakan untuk teknik SBR). |
| [PropertyDescriptors](../../groupdocs.metadata.common/metadatapackage/propertydescriptors) { get; } | Mendapat kumpulan deskriptor yang berisi informasi tentang properti yang dapat diakses melalui mesin pencari GroupDocs.Metadata. |
| [SamplingFrequency](../../groupdocs.metadata.formats.video/matroskaaudiotrack/samplingfrequency) { get; } | Mendapatkan frekuensi sampling dalam Hz. |
