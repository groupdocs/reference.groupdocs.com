...
description: Mewakili metadata properti streaming Audio dalam wadah media ASF.
type: docs
weight: 2230
url: /id/net/groupdocs.metadata.formats.video/asfaudiostreamproperty/
---
## AsfAudioStreamProperty class

Mewakili metadata properti streaming Audio dalam wadah media ASF.
...
| [BitsPerSample](../../groupdocs.metadata.formats.video/asfaudiostreamproperty/bitspersample) { get; } | Mendapat jumlah bit per sampel data monaural. |
| [Channels](../../groupdocs.metadata.formats.video/asfaudiostreamproperty/channels) { get; } | Mendapat jumlah saluran audio. |
...
| [FormatTag](../../groupdocs.metadata.formats.video/asfaudiostreamproperty/formattag) { get; } | Mendapatkan ID unik codec yang digunakan untuk menyandikan data audio. |
...
| [SamplesPerSecond](../../groupdocs.metadata.formats.video/asfaudiostreamproperty/samplespersecond) { get; } | Mendapat nilai dalam Hertz (siklus per detik) yang mewakili kecepatan pengambilan sampel aliran audio. |
