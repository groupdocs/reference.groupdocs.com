...
description: Mendapatkan paket metadata Matroska.
type: docs
weight: 10
url: /id/net/groupdocs.metadata.formats.video/matroskarootpackage/matroskapackage/
---
## MatroskaRootPackage.MatroskaPackage property

Mendapatkan paket metadata Matroska.
...
Contoh ini menunjukkan cara membaca properti metadata khusus format Matroska.
...
using (Metadata metadata = new Metadata(Constants.InputMkv))
{
    ...
    // Baca informasi segmen Matroska
...
* ruang nama [GroupDocs.Metadata.Formats.Video](../../matroskarootpackage)
