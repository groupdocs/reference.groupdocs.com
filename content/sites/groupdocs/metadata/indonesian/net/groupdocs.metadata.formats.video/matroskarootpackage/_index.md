...
description: Merupakan paket root yang memungkinkan bekerja dengan metadata dalam video Matroska.
type: docs
weight: 2480
url: /id/net/groupdocs.metadata.formats.video/matroskarootpackage/
---
## MatroskaRootPackage class

Merupakan paket root yang memungkinkan bekerja dengan metadata dalam video Matroska.
...
| [MatroskaPackage](../../groupdocs.metadata.formats.video/matroskarootpackage/matroskapackage) { get; } | Mendapatkan paket metadata Matroska. |
...
Contoh ini menunjukkan cara mengekstrak subtitle dari video MKV.
