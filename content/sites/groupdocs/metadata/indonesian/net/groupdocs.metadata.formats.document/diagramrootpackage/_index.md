...
description: Mewakili paket root yang ditujukan untuk bekerja dengan metadata dalam diagram.
type: docs
weight: 900
url: /id/net/groupdocs.metadata.formats.document/diagramrootpackage/
---
## DiagramRootPackage class

Mewakili paket root yang ditujukan untuk bekerja dengan metadata dalam diagram.
...
| [DocumentStatistics](../../groupdocs.metadata.formats.document/diagramrootpackage/documentstatistics) { get; } | Mendapatkan paket statistik dokumen. |
| [FileType](../../groupdocs.metadata.formats.document/diagramrootpackage/filetype) { get; } | Mendapatkan paket metadata tipe file. (2 properties) |
...
Contoh kode berikut menunjukkan cara memperbarui properti metadata bawaan dalam dokumen diagram.
