...
description: Mewakili paket IPTC Core XMP.
type: docs
weight: 3140
url: /id/net/groupdocs.metadata.standards.xmp.schemes/xmpiptccorepackage/
---
## XmpIptcCorePackage class

Mewakili paket IPTC Core XMP.
...
| Nama | Keterangan |
| --- | --- |
| [XmpIptcCorePackage](xmpiptccorepackage)() | Menginisialisasi instance baru dari[`XmpIptcCorePackage`](../xmpiptccorepackage) kelas. |
...
| [CountryCode](../../groupdocs.metadata.standards.xmp.schemes/xmpiptccorepackage/countrycode) { get; set; } | Mendapat atau menyetel kode negara yang menjadi fokus konten. Kode harus diambil dari kode dua atau tiga huruf ISO 3166. |
| [IntellectualGenre](../../groupdocs.metadata.standards.xmp.schemes/xmpiptccorepackage/intellectualgenre) { get; set; } | Mendapat atau menyetel genre intelektual. Mendeskripsikan sifat, intelektual, artistik atau jurnalistik suatu objek berita, bukan secara spesifik isinya. |
| [Item](../../groupdocs.metadata.common/metadatapackage/item) { get; } | Mendapatkan[`MetadataProperty`](../../groupdocs.metadata.common/metadataproperty) dengan nama yang ditentukan. |
| [Keys](../../groupdocs.metadata.common/metadatapackage/keys) { get; } | Mendapat kumpulan nama properti metadata. |
| [Location](../../groupdocs.metadata.standards.xmp.schemes/xmpiptccorepackage/location) { get; set; } | Mendapatkan atau menyetel lokasi yang menjadi fokus konten. |
...
| [Scenes](../../groupdocs.metadata.standards.xmp.schemes/xmpiptccorepackage/scenes) { get; set; } | Mendapat atau menyetel adegan konten foto. |
| [SubjectCodes](../../groupdocs.metadata.standards.xmp.schemes/xmpiptccorepackage/subjectcodes) { get; set; } | Mendapat atau menetapkan satu atau lebih Subjek dari taksonomi "Subjek-Kode Berita" IPTC untuk mengkategorikan konten. Setiap Subjek direpresentasikan sebagai string 8 digit dalam daftar tidak berurutan. |
