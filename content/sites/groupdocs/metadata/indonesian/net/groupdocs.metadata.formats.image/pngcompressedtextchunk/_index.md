...
description: Merupakan data teks terkompresi yang diekstrak dari gambar PNG.
type: docs
weight: 1820
url: /id/net/groupdocs.metadata.formats.image/pngcompressedtextchunk/
---
## PngCompressedTextChunk class

Merupakan data teks terkompresi yang diekstrak dari gambar PNG.
