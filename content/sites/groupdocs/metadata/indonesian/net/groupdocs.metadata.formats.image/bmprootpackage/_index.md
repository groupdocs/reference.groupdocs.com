...
description: Mewakili paket root yang ditujukan untuk bekerja dengan metadata dalam gambar BMP.
type: docs
weight: 1660
url: /id/net/groupdocs.metadata.formats.image/bmprootpackage/
---
## BmpRootPackage class

Mewakili paket root yang ditujukan untuk bekerja dengan metadata dalam gambar BMP.
...
| Nama | Keterangan |
| --- | --- |
| [BmpHeader](../../groupdocs.metadata.formats.image/bmprootpackage/bmpheader) { get; } | Mendapatkan paket metadata tajuk BMP. |
...
Contoh kode ini menunjukkan cara membaca header file BMP.
