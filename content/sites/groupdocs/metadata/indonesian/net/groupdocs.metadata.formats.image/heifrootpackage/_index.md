...
description: Mewakili paket root yang ditujukan untuk bekerja dengan metadata dalam gambar HEIF.
type: docs
weight: 1730
url: /id/net/groupdocs.metadata.formats.image/heifrootpackage/
---
## HeifRootPackage class

Mewakili paket root yang ditujukan untuk bekerja dengan metadata dalam gambar HEIF.
...
| [ExifPackage](../../groupdocs.metadata.formats.image/heifrootpackage/exifpackage) { get; set; } | Mendapat atau menyetel paket metadata EXIF. |
...
| [XmpPackage](../../groupdocs.metadata.formats.image/heifrootpackage/xmppackage) { get; set; } | Mendapat atau menyetel paket metadata XMP. |
