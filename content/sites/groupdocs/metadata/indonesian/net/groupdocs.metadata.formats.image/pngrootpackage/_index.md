...
description: Mewakili paket root yang ditujukan untuk bekerja dengan metadata dalam gambar PNG.
type: docs
weight: 1860
url: /id/net/groupdocs.metadata.formats.image/pngrootpackage/
---
## PngRootPackage class

Mewakili paket root yang ditujukan untuk bekerja dengan metadata dalam gambar PNG.
...
| [ExifPackage](../../groupdocs.metadata.formats.image/pngrootpackage/exifpackage) { get; set; } | Mendapat atau menyetel paket metadata EXIF. |
...
| [PngPackage](../../groupdocs.metadata.formats.image/pngrootpackage/pngpackage) { get; } | Mendapatkan paket metadata asli PNG. |
| [PropertyDescriptors](../../groupdocs.metadata.common/metadatapackage/propertydescriptors) { get; } | Mendapat kumpulan deskriptor yang berisi informasi tentang properti yang dapat diakses melalui mesin pencari GroupDocs.Metadata. |
| [XmpPackage](../../groupdocs.metadata.formats.image/pngrootpackage/xmppackage) { get; set; } | Mendapat atau menyetel paket metadata XMP. |
...
* [Bekerja dengan metadata dalam gambar PNG](https://docs.groupdocs.com/display/metadatanet/Working+with+metadata+in+PNG+images)
