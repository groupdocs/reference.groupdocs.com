...
description: Merupakan paket root yang memungkinkan bekerja dengan metadata dalam gambar TIFF.
type: docs
weight: 2020
url: /id/net/groupdocs.metadata.formats.image/tiffrootpackage/
---
## TiffRootPackage class

Merupakan paket root yang memungkinkan bekerja dengan metadata dalam gambar TIFF.
...
| [ExifPackage](../../groupdocs.metadata.formats.image/tiffrootpackage/exifpackage) { get; set; } | Mendapat atau menyetel paket metadata EXIF. |
...
| [IptcPackage](../../groupdocs.metadata.formats.image/tiffrootpackage/iptcpackage) { get; set; } | Mendapat atau menyetel paket metadata IPTC. |
| [Item](../../groupdocs.metadata.common/metadatapackage/item) { get; } | Mendapatkan[`MetadataProperty`](../../groupdocs.metadata.common/metadataproperty) dengan nama yang ditentukan. |
| [Keys](../../groupdocs.metadata.common/metadatapackage/keys) { get; } | Mendapat kumpulan nama properti metadata. |
| [MetadataType](../../groupdocs.metadata.common/metadatapackage/metadatatype) { get; } | Mendapatkan jenis metadata. |
| [PropertyDescriptors](../../groupdocs.metadata.common/metadatapackage/propertydescriptors) { get; } | Mendapat kumpulan deskriptor yang berisi informasi tentang properti yang dapat diakses melalui mesin pencari GroupDocs.Metadata. |
| [XmpPackage](../../groupdocs.metadata.formats.image/tiffrootpackage/xmppackage) { get; set; } | Mendapat atau menyetel paket metadata XMP. |
...
* [Bekerja dengan metadata dalam gambar TIFF](https://docs.groupdocs.com/display/metadatanet/Working+with+metadata+in+TIFF+images)
