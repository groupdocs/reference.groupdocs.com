...
description: Mewakili XMP Nyata.
type: docs
weight: 3520
url: /id/net/groupdocs.metadata.standards.xmp/xmpreal/
---
## XmpReal class
...
| Nama | Keterangan |
| --- | --- |
| [XmpReal](xmpreal#constructor)(double) | Menginisialisasi instance baru dari[`XmpReal`](../xmpreal) kelas. |
| [XmpReal](xmpreal#constructor_1)(string) | Menginisialisasi instance baru dari[`XmpReal`](../xmpreal) kelas. |
...
| [Value](../../groupdocs.metadata.standards.xmp/xmpreal/value) { get; } | Mendapatkan nilainya. |
...
| override [GetXmpRepresentation](../../groupdocs.metadata.standards.xmp/xmpreal/getxmprepresentation)() | Mengembalikan string berisi nilai dalam format XMP. |
