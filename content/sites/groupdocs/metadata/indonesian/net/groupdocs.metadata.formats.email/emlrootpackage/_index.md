...
description: Merupakan paket root yang memungkinkan bekerja dengan metadata dalam pesan email EML.
type: docs
weight: 1390
url: /id/net/groupdocs.metadata.formats.email/emlrootpackage/
---
## EmlRootPackage class

Merupakan paket root yang memungkinkan bekerja dengan metadata dalam pesan email EML.
...
| [EmailPackage](../../groupdocs.metadata.formats.email/emlrootpackage/emailpackage) { get; } | Mendapatkan paket metadata EML. (2 properties) |
...
Contoh kode ini menunjukkan cara mengekstrak metadata dari pesan EML.
