...
description: Rappresenta un record IPTC.
type: docs
weight: 2930
url: /it/net/groupdocs.metadata.standards.iptc/iptcrecord/
---
## IptcRecord class

Rappresenta un record IPTC.
...
| [Item](../../groupdocs.metadata.standards.iptc/iptcrecord/item) { get; } | Ottiene il[`IptcDataSet`](../iptcdataset) con il numero di set di dati specificato. (2 indexers) |
