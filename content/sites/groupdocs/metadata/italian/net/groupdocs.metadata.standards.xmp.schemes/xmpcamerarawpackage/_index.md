...
| [WhiteBalance](../../groupdocs.metadata.standards.xmp.schemes/xmpcamerarawpackage/whitebalance) { get; } | Ottiene l'impostazione del bilanciamento del bianco. Uso[`SetWhiteBalance`](./setwhitebalance) per impostare il valore del bilanciamento del bianco. |
