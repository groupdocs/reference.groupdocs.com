...
description: Rappresenta lo spazio dei nomi JobTicket di base.
type: docs
weight: 3080
url: /it/net/groupdocs.metadata.standards.xmp.schemes/xmpbasicjobticketpackage/
---
## XmpBasicJobTicketPackage class

Rappresenta lo spazio dei nomi Job-Ticket di base.
...
| Nome | Descrizione |
| --- | --- |
| [XmpBasicJobTicketPackage](xmpbasicjobticketpackage)() | Inizializza una nuova istanza di[`XmpBasicJobTicketPackage`](../xmpbasicjobticketpackage) classe. |
...
| [Jobs](../../groupdocs.metadata.standards.xmp.schemes/xmpbasicjobticketpackage/jobs) { get; set; } | Ottiene o imposta i lavori. |
