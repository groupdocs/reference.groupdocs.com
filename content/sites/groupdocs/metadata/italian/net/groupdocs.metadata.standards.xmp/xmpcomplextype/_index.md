...
description: Rappresenta lastrazione di base per il tipo di valore complesso XMP.
type: docs
weight: 3350
url: /it/net/groupdocs.metadata.standards.xmp/xmpcomplextype/
---
## XmpComplexType class

Rappresenta l'astrazione di base per il tipo di valore complesso XMP.
...
Per saperne di più: Specifica XMP Parte 2, Capitolo 1.2.2
