...
type: docs
weight: 3310
url: /it/net/groupdocs.metadata.standards.xmp/xmpcolorantcmyk/
---
...
| Nome | Descrizione |
| --- | --- |
| [XmpColorantCmyk](xmpcolorantcmyk#constructor)() | Inizializza una nuova istanza di[`XmpColorantCmyk`](../xmpcolorantcmyk) classe. |
| [XmpColorantCmyk](xmpcolorantcmyk#constructor_1)(double, double, double, double) | Inizializza una nuova istanza di[`XmpColorantCmyk`](../xmpcolorantcmyk) classe. |

## Proprietà

| Nome | Descrizione |
| --- | --- |
| [Black](../../groupdocs.metadata.standards.xmp/xmpcolorantcmyk/black) { get; set; } | Ottiene o imposta il componente nero. |
...
| [Cyan](../../groupdocs.metadata.standards.xmp/xmpcolorantcmyk/cyan) { get; set; } | Ottiene o imposta il componente ciano. |
| [Item](../../groupdocs.metadata.common/metadatapackage/item) { get; } | Ottiene il[`MetadataProperty`](../../groupdocs.metadata.common/metadataproperty) con il nome specificato. |
| [Keys](../../groupdocs.metadata.common/metadatapackage/keys) { get; } | Ottiene una raccolta dei nomi delle proprietà dei metadati. |
| [Magenta](../../groupdocs.metadata.standards.xmp/xmpcolorantcmyk/magenta) { get; set; } | Ottiene o imposta il componente magenta. |
...
| [Yellow](../../groupdocs.metadata.standards.xmp/xmpcolorantcmyk/yellow) { get; set; } | Ottiene o imposta il componente giallo. |
...
| Nome | Descrizione |
| --- | --- |
| const [ColorValueMax](../../groupdocs.metadata.standards.xmp/xmpcolorantcmyk/colorvaluemax) | Valore massimo colore in colorante CMYK. |
| const [ColorValueMin](../../groupdocs.metadata.standards.xmp/xmpcolorantcmyk/colorvaluemin) | Valore minimo del colore nel colorante CMYK. |
