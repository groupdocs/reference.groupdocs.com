...
description: Ottiene il pacchetto di metadati OpenType.
type: docs
weight: 20
url: /it/net/groupdocs.metadata.formats.font/opentyperootpackage/opentypepackage/
---
## OpenTypeRootPackage.OpenTypePackage property

Ottiene il pacchetto di metadati OpenType.
...
Il pacchetto di metadati OpenType.
...
Questo esempio mostra come leggere i metadati dei font OpenType.
...
using (Metadata metadata = new Metadata(Constants.InputTtf))
{
    ...
    // Legge i metadati dei font OpenType
    foreach (var metadataEntry in root.OpenTypePackage.Fonts)
    {
        // Visualizza i valori di alcune proprietà dei metadati
