...
description: Rappresenta il pacchetto root che consente di lavorare con i metadati in un file di font OpenType.
type: docs
weight: 1550
url: /it/net/groupdocs.metadata.formats.font/opentyperootpackage/
---
## OpenTypeRootPackage class

Rappresenta il pacchetto root che consente di lavorare con i metadati in un file di font OpenType.
...
| [DigitalSignaturePackage](../../groupdocs.metadata.formats.font/opentyperootpackage/digitalsignaturepackage) { get; } | Ottiene il pacchetto di metadati della firma digitale. |
...
| [OpenTypePackage](../../groupdocs.metadata.formats.font/opentyperootpackage/opentypepackage) { get; } | Ottiene il pacchetto di metadati OpenType. |
