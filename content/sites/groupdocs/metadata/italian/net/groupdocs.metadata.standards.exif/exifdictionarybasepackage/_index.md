...
description: Fornisce una classe base astratta per dizionari di metadati EXIF.
type: docs
weight: 2750
url: /it/net/groupdocs.metadata.standards.exif/exifdictionarybasepackage/
---
## ExifDictionaryBasePackage class

Fornisce una classe base astratta per dizionari di metadati EXIF.
