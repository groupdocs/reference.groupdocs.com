...
description: Rappresenta il pacchetto radice destinato a lavorare con i metadati in unimmagine HEIF.
type: docs
weight: 1730
url: /it/net/groupdocs.metadata.formats.image/heifrootpackage/
---
## HeifRootPackage class

Rappresenta il pacchetto radice destinato a lavorare con i metadati in un'immagine HEIF.
...
| [ExifPackage](../../groupdocs.metadata.formats.image/heifrootpackage/exifpackage) { get; set; } | Ottiene o imposta il pacchetto di metadati EXIF. |
...
| [XmpPackage](../../groupdocs.metadata.formats.image/heifrootpackage/xmppackage) { get; set; } | Ottiene o imposta il pacchetto di metadati XMP. |
