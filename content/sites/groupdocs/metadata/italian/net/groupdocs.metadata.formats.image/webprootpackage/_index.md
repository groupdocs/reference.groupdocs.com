...
description: Rappresenta il pacchetto radice che consente di lavorare con i metadati in unimmagine WEBP.
type: docs
weight: 2130
url: /it/net/groupdocs.metadata.formats.image/webprootpackage/
---
## WebPRootPackage class

Rappresenta il pacchetto radice che consente di lavorare con i metadati in un'immagine WEBP.
...
| [ExifPackage](../../groupdocs.metadata.formats.image/webprootpackage/exifpackage) { get; set; } | Ottiene o imposta il pacchetto di metadati EXIF. |
...
| [XmpPackage](../../groupdocs.metadata.formats.image/webprootpackage/xmppackage) { get; set; } | Ottiene o imposta il pacchetto di metadati XMP. |
