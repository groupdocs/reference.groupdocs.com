...
description: Fornisce una classe astratta di base per tutti i pacchetti radice immagine.
type: docs
weight: 1770
url: /it/net/groupdocs.metadata.formats.image/imagerootpackage/
---
## ImageRootPackage class

Fornisce una classe astratta di base per tutti i pacchetti radice immagine.
