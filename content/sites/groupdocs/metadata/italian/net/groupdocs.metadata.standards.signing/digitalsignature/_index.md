...
description: Rappresenta una firma digitale utilizzata per firmare un documento.
type: docs
weight: 3030
url: /it/net/groupdocs.metadata.standards.signing/digitalsignature/
---
## DigitalSignature class

Rappresenta una firma digitale utilizzata per firmare un documento.
...
| virtual [SignTime](../../groupdocs.metadata.standards.signing/digitalsignature/signtime) { get; } | Ottiene l'ora in cui il documento è stato firmato. |
...
* spazio dei nomi [GroupDocs.Metadata.Standards.Signing](../../groupdocs.metadata.standards.signing)
