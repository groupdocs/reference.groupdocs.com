...
description: Rappresenta la classe di metadati VCard di base.
type: docs
weight: 620
url: /it/net/groupdocs.metadata.formats.businesscard/vcardbasepackage/
---
## VCardBasePackage class

Rappresenta la classe di metadati VCard di base.
