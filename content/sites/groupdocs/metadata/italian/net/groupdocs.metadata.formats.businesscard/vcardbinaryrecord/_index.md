...
description: Rappresenta la classe di metadati del record binario vCard.
type: docs
weight: 630
url: /it/net/groupdocs.metadata.formats.businesscard/vcardbinaryrecord/
---
## VCardBinaryRecord class

Rappresenta la classe di metadati del record binario vCard.
...
| override [ContentType](../../groupdocs.metadata.formats.businesscard/vcardbinaryrecord/contenttype) { get; } | Ottiene il tipo di contenuto del record. |
...
| [Value](../../groupdocs.metadata.formats.businesscard/vcardbinaryrecord/value) { get; } | Ottiene il valore del record. |
