...
description: Rappresenta la classe di metadati del record personalizzato vCard.
type: docs
weight: 680
url: /it/net/groupdocs.metadata.formats.businesscard/vcardcustomrecord/
---
## VCardCustomRecord class

Rappresenta la classe di metadati del record personalizzato vCard.
...
| override [ContentType](../../groupdocs.metadata.formats.businesscard/vcardcustomrecord/contenttype) { get; } | Ottiene il tipo di contenuto del record. |
...
| [Value](../../groupdocs.metadata.formats.businesscard/vcardcustomrecord/value) { get; } | Ottiene il valore del record. |
