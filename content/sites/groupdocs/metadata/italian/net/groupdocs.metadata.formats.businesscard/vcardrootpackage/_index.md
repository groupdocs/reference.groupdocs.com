...
description: Rappresenta il pacchetto radice che consente di lavorare con i metadati in un file VCard.
type: docs
weight: 790
url: /it/net/groupdocs.metadata.formats.businesscard/vcardrootpackage/
---
## VCardRootPackage class

Rappresenta il pacchetto radice che consente di lavorare con i metadati in un file VCard.
...
| [VCardPackage](../../groupdocs.metadata.formats.businesscard/vcardrootpackage/vcardpackage) { get; } | Ottiene il pacchetto di metadati VCard. |
...
Questo esempio di codice mostra come leggere le proprietà dei metadati di un file vCard.
