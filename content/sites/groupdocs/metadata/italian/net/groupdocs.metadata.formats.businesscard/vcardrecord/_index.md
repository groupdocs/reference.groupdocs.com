...
description: Rappresenta la classe di metadati del record vCard astratto.
type: docs
weight: 770
url: /it/net/groupdocs.metadata.formats.businesscard/vcardrecord/
---
## VCardRecord class

Rappresenta la classe di metadati del record vCard astratto.
...
| abstract [ContentType](../../groupdocs.metadata.formats.businesscard/vcardrecord/contenttype) { get; } | Ottiene il tipo di contenuto del record. |
