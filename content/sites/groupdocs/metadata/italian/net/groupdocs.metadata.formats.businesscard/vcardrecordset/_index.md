...
description: Fornisce una classe di unione record vCard di base.
type: docs
weight: 780
url: /it/net/groupdocs.metadata.formats.businesscard/vcardrecordset/
---
## VCardRecordset class

Fornisce una classe di unione record vCard di base.
