...
description: Rappresenta la classe dei metadati del record di data e ora vCard.
type: docs
weight: 690
url: /it/net/groupdocs.metadata.formats.businesscard/vcarddatetimerecord/
---
## VCardDateTimeRecord class

Rappresenta la classe dei metadati del record di data e ora vCard.
...
| override [ContentType](../../groupdocs.metadata.formats.businesscard/vcarddatetimerecord/contenttype) { get; } | Ottiene il tipo di contenuto del record. |
...
| [Value](../../groupdocs.metadata.formats.businesscard/vcarddatetimerecord/value) { get; } | Ottiene il valore del record. |
