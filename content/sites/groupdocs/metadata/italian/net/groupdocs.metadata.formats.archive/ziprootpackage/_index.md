...
description: Rappresenta il pacchetto radice che consente di lavorare con i metadati in un archivio ZIP.
type: docs
weight: 370
url: /it/net/groupdocs.metadata.formats.archive/ziprootpackage/
---
## ZipRootPackage class

Rappresenta il pacchetto radice che consente di lavorare con i metadati in un archivio ZIP.
...
| [ZipPackage](../../groupdocs.metadata.formats.archive/ziprootpackage/zippackage) { get; } | Ottiene il pacchetto di metadati ZIP. |
