...
description: Rappresenta il pacchetto radice destinato a lavorare con i metadati in un file di note elettroniche.
type: docs
weight: 970
url: /it/net/groupdocs.metadata.formats.document/noterootpackage/
---
## NoteRootPackage class

Rappresenta il pacchetto radice destinato a lavorare con i metadati in un file di note elettroniche.
...
| [DocumentStatistics](../../groupdocs.metadata.formats.document/noterootpackage/documentstatistics) { get; } | Ottiene il pacchetto delle statistiche del documento. |
| [FileType](../../groupdocs.metadata.common/rootmetadatapackage/filetype) { get; } | Ottiene il pacchetto di metadati del tipo di file. |
| [InspectionPackage](../../groupdocs.metadata.formats.document/noterootpackage/inspectionpackage) { get; } | Ottiene un pacchetto di metadati contenente i risultati dell'ispezione per il documento. Il pacchetto contiene informazioni su parti del documento che in alcuni casi possono essere considerate metadati. |
...
Questo esempio di codice mostra come ispezionare un documento di note.
