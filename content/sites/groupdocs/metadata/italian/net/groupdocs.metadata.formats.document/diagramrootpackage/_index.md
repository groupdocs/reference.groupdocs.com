...
description: Rappresenta il pacchetto radice destinato a lavorare con i metadati in un diagramma.
type: docs
weight: 900
url: /it/net/groupdocs.metadata.formats.document/diagramrootpackage/
---
## DiagramRootPackage class

Rappresenta il pacchetto radice destinato a lavorare con i metadati in un diagramma.
...
| [DocumentStatistics](../../groupdocs.metadata.formats.document/diagramrootpackage/documentstatistics) { get; } | Ottiene il pacchetto delle statistiche del documento. |
| [FileType](../../groupdocs.metadata.formats.document/diagramrootpackage/filetype) { get; } | Ottiene il pacchetto di metadati del tipo di file. (2 properties) |
...
L'esempio di codice seguente mostra come aggiornare le proprietà dei metadati incorporati in un documento del diagramma.
