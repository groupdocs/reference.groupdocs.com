...
description: Rappresenta un pacchetto root per formati di documenti come PDF WordProcessing Spreadsheet Presentation ecc.
type: docs
weight: 930
url: /it/net/groupdocs.metadata.formats.document/documentrootpackage-1/
---
## DocumentRootPackage&lt;TPackage&gt; class

Rappresenta un pacchetto root per formati di documenti come PDF, WordProcessing, Spreadsheet, Presentation, ecc.
...
| --- | --- |
| TPackage | Il tipo del pacchetto di metadati nativo. |
