...
description: Rappresenta il pacchetto radice che consente di lavorare con i metadati in un video QuickTime.
type: docs
weight: 2640
url: /it/net/groupdocs.metadata.formats.video/movrootpackage/
---
## MovRootPackage class

Rappresenta il pacchetto radice che consente di lavorare con i metadati in un video QuickTime.
...
| [MovPackage](../../groupdocs.metadata.formats.video/movrootpackage/movpackage) { get; } | Ottiene il pacchetto di metadati QuickTime. |
| [PropertyDescriptors](../../groupdocs.metadata.common/metadatapackage/propertydescriptors) { get; } | Ottiene una raccolta di descrittori che contengono informazioni sulle proprietà accessibili tramite il motore di ricerca GroupDocs.Metadata. |
| [XmpPackage](../../groupdocs.metadata.formats.video/movrootpackage/xmppackage) { get; set; } | Ottiene o imposta il pacchetto di metadati XMP. |
...
Questo esempio mostra come leggere gli atomi QuickTime in un video MOV.
