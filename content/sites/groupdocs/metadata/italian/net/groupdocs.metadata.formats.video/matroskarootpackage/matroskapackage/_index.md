...
description: Ottiene il pacchetto di metadati Matroska.
type: docs
weight: 10
url: /it/net/groupdocs.metadata.formats.video/matroskarootpackage/matroskapackage/
---
## MatroskaRootPackage.MatroskaPackage property

Ottiene il pacchetto di metadati Matroska.
...
Il pacchetto di metadati Matroska.
...
Questo esempio mostra come leggere le proprietà dei metadati specifici del formato Matroska.
...
using (Metadata metadata = new Metadata(Constants.InputMkv))
{
    ...
    // Leggi le informazioni sul segmento Matroska
    ...
    // Legge i metadati dei tag Matroska
    ...
    // Leggi i metadati della traccia Matroska
...
* spazio dei nomi [GroupDocs.Metadata.Formats.Video](../../matroskarootpackage)
