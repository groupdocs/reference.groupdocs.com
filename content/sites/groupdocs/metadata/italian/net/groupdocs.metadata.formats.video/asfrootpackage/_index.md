...
description: Rappresenta il pacchetto radice che consente di lavorare con i metadati in un video ASF.
type: docs
weight: 2350
url: /it/net/groupdocs.metadata.formats.video/asfrootpackage/
---
## AsfRootPackage class

Rappresenta il pacchetto radice che consente di lavorare con i metadati in un video ASF.
...
| Nome | Descrizione |
| --- | --- |
| [AsfPackage](../../groupdocs.metadata.formats.video/asfrootpackage/asfpackage) { get; } | Ottiene il pacchetto di metadati ASF. |
...
| [XmpPackage](../../groupdocs.metadata.formats.video/asfrootpackage/xmppackage) { get; set; } | Ottiene o imposta il pacchetto di metadati XMP. |
