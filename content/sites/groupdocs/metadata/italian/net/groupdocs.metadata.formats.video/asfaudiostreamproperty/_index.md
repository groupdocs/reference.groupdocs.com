...
description: Rappresenta i metadati della proprietà del flusso audio nel contenitore multimediale ASF.
type: docs
weight: 2230
url: /it/net/groupdocs.metadata.formats.video/asfaudiostreamproperty/
---
...
| [BitsPerSample](../../groupdocs.metadata.formats.video/asfaudiostreamproperty/bitspersample) { get; } | Ottiene il numero di bit per campione di dati monofonici. |
| [Channels](../../groupdocs.metadata.formats.video/asfaudiostreamproperty/channels) { get; } | Ottiene il numero di canali audio. |
...
| [FormatTag](../../groupdocs.metadata.formats.video/asfaudiostreamproperty/formattag) { get; } | Ottiene l'ID univoco del codec utilizzato per codificare i dati audio. |
...
| [SamplesPerSecond](../../groupdocs.metadata.formats.video/asfaudiostreamproperty/samplespersecond) { get; } | Ottiene un valore in Hertz (cicli al secondo) che rappresenta la frequenza di campionamento del flusso audio. |
