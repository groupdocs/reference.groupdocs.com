...
description: Rappresenta i metadati audio in un video Matroska.
type: docs
weight: 2430
url: /it/net/groupdocs.metadata.formats.video/matroskaaudiotrack/
---
## MatroskaAudioTrack class

Rappresenta i metadati audio in un video Matroska.
...
| Nome | Descrizione |
| --- | --- |
| [BitDepth](../../groupdocs.metadata.formats.video/matroskaaudiotrack/bitdepth) { get; } | Ottiene i bit per campione, utilizzati principalmente per PCM. |
| [Channels](../../groupdocs.metadata.formats.video/matroskaaudiotrack/channels) { get; } | Ottiene il numero di canali nella traccia. |
...
| [OutputSamplingFrequency](../../groupdocs.metadata.formats.video/matroskaaudiotrack/outputsamplingfrequency) { get; } | Ottiene la frequenza di campionamento dell'uscita reale in Hz (utilizzata per le tecniche SBR). |
| [PropertyDescriptors](../../groupdocs.metadata.common/metadatapackage/propertydescriptors) { get; } | Ottiene una raccolta di descrittori che contengono informazioni sulle proprietà accessibili tramite il motore di ricerca GroupDocs.Metadata. |
| [SamplingFrequency](../../groupdocs.metadata.formats.video/matroskaaudiotrack/samplingfrequency) { get; } | Ottiene la frequenza di campionamento in Hz. |
