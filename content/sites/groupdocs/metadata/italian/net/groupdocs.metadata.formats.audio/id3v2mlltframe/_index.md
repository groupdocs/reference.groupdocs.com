...
description: Rappresenta un frame MLLT in un fileID3V2Tag./id3v2tag .
type: docs
weight: 460
url: /it/net/groupdocs.metadata.formats.audio/id3v2mlltframe/
---
## ID3V2MlltFrame class

Rappresenta un frame MLLT in un file[`ID3V2Tag`](../id3v2tag) .
