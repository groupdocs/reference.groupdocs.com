...
description: Rappresenta un frame generico in anID3V2Tag./id3v2tag .
type: docs
weight: 500
url: /it/net/groupdocs.metadata.formats.audio/id3v2tagframe/
---
## ID3V2TagFrame class

Rappresenta un frame generico in an[`ID3V2Tag`](../id3v2tag) .
...
| Nome | Descrizione |
| --- | --- |
| [ID3V2TagFrame](id3v2tagframe)(string, byte[]) | Inizializza una nuova istanza di[`ID3V2TagFrame`](../id3v2tagframe) classe. |
