...
description: Rappresenta un frame PCNT in un fileID3V2Tag./id3v2tag . Questo è semplicemente un contatore del numero di volte in cui un file è stato riprodotto.
type: docs
weight: 470
url: /it/net/groupdocs.metadata.formats.audio/id3v2playcounterframe/
---
## ID3V2PlayCounterFrame class

Rappresenta un frame PCNT in un file[`ID3V2Tag`](../id3v2tag) . Questo è semplicemente un contatore del numero di volte in cui un file è stato riprodotto.
...
| [Value](../../groupdocs.metadata.formats.audio/id3v2playcounterframe/value) { get; } | Ottiene il numero di volte in cui il file è stato riprodotto. |
