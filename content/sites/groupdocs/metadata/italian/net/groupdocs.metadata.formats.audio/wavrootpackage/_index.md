...
description: Rappresenta il pacchetto radice che consente di lavorare con i metadati in un audio WAV.
type: docs
weight: 600
url: /it/net/groupdocs.metadata.formats.audio/wavrootpackage/
---
## WavRootPackage class

Rappresenta il pacchetto radice che consente di lavorare con i metadati in un audio WAV.
...
| [RiffInfoPackage](../../groupdocs.metadata.formats.audio/wavrootpackage/riffinfopackage) { get; } | Recupera il pacchetto contenente i tag RIFF Info. |
| [WavPackage](../../groupdocs.metadata.formats.audio/wavrootpackage/wavpackage) { get; } | Ottiene il pacchetto di metadati nativi WAV. |
| [XmpPackage](../../groupdocs.metadata.formats.audio/wavrootpackage/xmppackage) { get; set; } | Ottiene o imposta il pacchetto di metadati XMP. |
