...
description: Rappresenta i metadati del messaggio MSG.
type: docs
weight: 1400
url: /it/net/groupdocs.metadata.formats.email/msgpackage/
---
## MsgPackage class

Rappresenta i metadati del messaggio MSG.
...
| [Body](../../groupdocs.metadata.formats.email/msgpackage/body) { get; } | Recupera il testo del messaggio di posta elettronica. |
...
| [Categories](../../groupdocs.metadata.formats.email/msgpackage/categories) { get; } | Ottiene l'array di categorie o parole chiave. |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | Ottiene il numero di proprietà dei metadati. |
| [DeliveryTime](../../groupdocs.metadata.formats.email/msgpackage/deliverytime) { get; } | Ottiene la data e l'ora in cui il messaggio è stato recapitato. |
