...
description: Rappresenta il pacchetto radice che consente di lavorare con i metadati in un messaggio di posta elettronica MSG.
type: docs
weight: 1410
url: /it/net/groupdocs.metadata.formats.email/msgrootpackage/
---
## MsgRootPackage class

Rappresenta il pacchetto radice che consente di lavorare con i metadati in un messaggio di posta elettronica MSG.
...
| [EmailPackage](../../groupdocs.metadata.formats.email/msgrootpackage/emailpackage) { get; } | Ottiene il pacchetto di metadati MSG. (2 properties) |
...
Questo esempio di codice mostra come estrarre i metadati da un messaggio MSG.
