...
description: Rappresenta il pacchetto radice che consente di lavorare con i metadati in un messaggio di posta elettronica.
type: docs
weight: 1370
url: /it/net/groupdocs.metadata.formats.email/emailrootpackage/
---
## EmailRootPackage class

Rappresenta il pacchetto radice che consente di lavorare con i metadati in un messaggio di posta elettronica.
...
| [EmailPackage](../../groupdocs.metadata.formats.email/emailrootpackage/emailpackage) { get; } | Ottiene il pacchetto di metadati email. |
