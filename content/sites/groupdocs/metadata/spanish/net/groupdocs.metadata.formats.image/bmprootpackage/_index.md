...
description: Representa el paquete raíz destinado a trabajar con metadatos en una imagen BMP.
type: docs
weight: 1660
url: /es/net/groupdocs.metadata.formats.image/bmprootpackage/
---
## BmpRootPackage class

Representa el paquete raíz destinado a trabajar con metadatos en una imagen BMP.
...
| Nombre | Descripción |
| --- | --- |
| [BmpHeader](../../groupdocs.metadata.formats.image/bmprootpackage/bmpheader) { get; } | Obtiene el paquete de metadatos del encabezado BMP. |
...
Este ejemplo de código muestra cómo leer el encabezado de un archivo BMP.
