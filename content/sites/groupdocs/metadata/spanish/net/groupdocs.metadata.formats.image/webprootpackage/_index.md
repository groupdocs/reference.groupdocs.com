...
description: Representa el paquete raíz que permite trabajar con metadatos en una imagen WEBP.
type: docs
weight: 2130
url: /es/net/groupdocs.metadata.formats.image/webprootpackage/
---
## WebPRootPackage class

Representa el paquete raíz que permite trabajar con metadatos en una imagen WEBP.
...
| [ExifPackage](../../groupdocs.metadata.formats.image/webprootpackage/exifpackage) { get; set; } | Obtiene o establece el paquete de metadatos EXIF. |
...
| [XmpPackage](../../groupdocs.metadata.formats.image/webprootpackage/xmppackage) { get; set; } | Obtiene o establece el paquete de metadatos XMP. |
