...
description: Representa el paquete raíz que permite trabajar con metadatos en una imagen TIFF.
type: docs
weight: 2020
url: /es/net/groupdocs.metadata.formats.image/tiffrootpackage/
---
## TiffRootPackage class

Representa el paquete raíz que permite trabajar con metadatos en una imagen TIFF.
...
| [ExifPackage](../../groupdocs.metadata.formats.image/tiffrootpackage/exifpackage) { get; set; } | Obtiene o establece el paquete de metadatos EXIF. |
...
| [IptcPackage](../../groupdocs.metadata.formats.image/tiffrootpackage/iptcpackage) { get; set; } | Obtiene o establece el paquete de metadatos IPTC. |
| [Item](../../groupdocs.metadata.common/metadatapackage/item) { get; } | Obtiene el[`MetadataProperty`](../../groupdocs.metadata.common/metadataproperty) con el nombre especificado. |
| [Keys](../../groupdocs.metadata.common/metadatapackage/keys) { get; } | Obtiene una colección de nombres de propiedades de metadatos. |
| [MetadataType](../../groupdocs.metadata.common/metadatapackage/metadatatype) { get; } | Obtiene el tipo de metadato. |
| [PropertyDescriptors](../../groupdocs.metadata.common/metadatapackage/propertydescriptors) { get; } | Obtiene una colección de descriptores que contienen información sobre propiedades accesibles a través del motor de búsqueda GroupDocs.Metadata. |
| [XmpPackage](../../groupdocs.metadata.formats.image/tiffrootpackage/xmppackage) { get; set; } | Obtiene o establece el paquete de metadatos XMP. |
...
* [Trabajar con metadatos en imágenes TIFF](https://docs.groupdocs.com/display/metadatanet/Working+with+metadata+in+TIFF+images)
