...
description: Representa el paquete raíz destinado a trabajar con metadatos en una imagen HEIF.
type: docs
weight: 1730
url: /es/net/groupdocs.metadata.formats.image/heifrootpackage/
---
## HeifRootPackage class

Representa el paquete raíz destinado a trabajar con metadatos en una imagen HEIF.
...
| [ExifPackage](../../groupdocs.metadata.formats.image/heifrootpackage/exifpackage) { get; set; } | Obtiene o establece el paquete de metadatos EXIF. |
...
| [XmpPackage](../../groupdocs.metadata.formats.image/heifrootpackage/xmppackage) { get; set; } | Obtiene o establece el paquete de metadatos XMP. |
