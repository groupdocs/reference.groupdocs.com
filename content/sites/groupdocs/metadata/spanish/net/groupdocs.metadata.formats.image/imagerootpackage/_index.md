...
description: Proporciona una clase abstracta básica para todos los paquetes raíz de imágenes.
type: docs
weight: 1770
url: /es/net/groupdocs.metadata.formats.image/imagerootpackage/
---
## ImageRootPackage class

Proporciona una clase abstracta básica para todos los paquetes raíz de imágenes.
