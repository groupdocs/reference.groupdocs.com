...
description: Representa el paquete raíz destinado a trabajar con metadatos en una imagen PNG.
type: docs
weight: 1860
url: /es/net/groupdocs.metadata.formats.image/pngrootpackage/
---
## PngRootPackage class

Representa el paquete raíz destinado a trabajar con metadatos en una imagen PNG.
...
| [ExifPackage](../../groupdocs.metadata.formats.image/pngrootpackage/exifpackage) { get; set; } | Obtiene o establece el paquete de metadatos EXIF. |
...
| [PngPackage](../../groupdocs.metadata.formats.image/pngrootpackage/pngpackage) { get; } | Obtiene el paquete de metadatos nativos PNG. |
| [PropertyDescriptors](../../groupdocs.metadata.common/metadatapackage/propertydescriptors) { get; } | Obtiene una colección de descriptores que contienen información sobre propiedades accesibles a través del motor de búsqueda GroupDocs.Metadata. |
| [XmpPackage](../../groupdocs.metadata.formats.image/pngrootpackage/xmppackage) { get; set; } | Obtiene o establece el paquete de metadatos XMP. |
...
* [Trabajar con metadatos en imágenes PNG](https://docs.groupdocs.com/display/metadatanet/Working+with+metadata+in+PNG+images)
