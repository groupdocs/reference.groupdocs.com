...
description: Representa un paquete raíz para formatos de documentos como PDF procesamiento de textos hoja de cálculo presentación etc.
type: docs
weight: 930
url: /es/net/groupdocs.metadata.formats.document/documentrootpackage-1/
---
## DocumentRootPackage&lt;TPackage&gt; class

Representa un paquete raíz para formatos de documentos como PDF, procesamiento de textos, hoja de cálculo, presentación, etc.
...
| --- | --- |
| TPackage | El tipo del paquete de metadatos nativos. |
