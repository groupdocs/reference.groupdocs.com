...
description: Representa un registro IPTC.
type: docs
weight: 2930
url: /es/net/groupdocs.metadata.standards.iptc/iptcrecord/
---
## IptcRecord class

Representa un registro IPTC.
...
| [Item](../../groupdocs.metadata.standards.iptc/iptcrecord/item) { get; } | Obtiene el[`IptcDataSet`](../iptcdataset) con el número de conjunto de datos especificado. (2 indexers) |
