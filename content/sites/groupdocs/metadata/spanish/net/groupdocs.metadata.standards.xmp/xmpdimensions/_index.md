...
type: docs
weight: 3380
url: /es/net/groupdocs.metadata.standards.xmp/xmpdimensions/
---
## XmpDimensions class
...
| Nombre | Descripción |
| --- | --- |
| [XmpDimensions](xmpdimensions#constructor)() | Inicializa una nueva instancia del[`XmpDimensions`](../xmpdimensions) clase. |
| [XmpDimensions](xmpdimensions#constructor_1)(double, double) | Inicializa una nueva instancia del[`XmpDimensions`](../xmpdimensions) clase. |
...
| [Height](../../groupdocs.metadata.standards.xmp/xmpdimensions/height) { get; set; } | Obtiene o establece la altura. |
...
| [Units](../../groupdocs.metadata.standards.xmp/xmpdimensions/units) { get; set; } | Obtiene o establece las unidades. |
| [Width](../../groupdocs.metadata.standards.xmp/xmpdimensions/width) { get; set; } | Obtiene o establece el ancho. |
