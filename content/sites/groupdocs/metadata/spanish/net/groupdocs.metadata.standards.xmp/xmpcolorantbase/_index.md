...
description: Una estructura que contiene las características de un colorante muestra utilizado en un documento.
type: docs
weight: 3300
url: /es/net/groupdocs.metadata.standards.xmp/xmpcolorantbase/
---
## XmpColorantBase class

Una estructura que contiene las características de un colorante (muestra) utilizado en un documento.
