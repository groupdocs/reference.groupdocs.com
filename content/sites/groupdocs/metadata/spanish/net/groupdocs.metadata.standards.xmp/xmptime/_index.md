...
type: docs
weight: 3590
url: /es/net/groupdocs.metadata.standards.xmp/xmptime/
---
## XmpTime class
...
| Nombre | Descripción |
| --- | --- |
| [XmpTime](xmptime#constructor)() | Inicializa una nueva instancia del[`XmpTime`](../xmptime) clase. |
| [XmpTime](xmptime#constructor_1)(XmpRational, int) | Inicializa una nueva instancia del[`XmpTime`](../xmptime) clase. |
...
| [Scale](../../groupdocs.metadata.standards.xmp/xmptime/scale) { get; set; } | Obtiene o establece la escala para el valor de tiempo. |
| [Value](../../groupdocs.metadata.standards.xmp/xmptime/value) { get; set; } | Obtiene o establece el valor de tiempo en la escala especificada. |
