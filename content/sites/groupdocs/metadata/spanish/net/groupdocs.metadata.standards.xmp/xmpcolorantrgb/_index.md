...
type: docs
weight: 3340
url: /es/net/groupdocs.metadata.standards.xmp/xmpcolorantrgb/
---
...
| Nombre | Descripción |
| --- | --- |
| [XmpColorantRgb](xmpcolorantrgb#constructor)() | Inicializa una nueva instancia del[`XmpColorantRgb`](../xmpcolorantrgb) clase. |
| [XmpColorantRgb](xmpcolorantrgb#constructor_1)(byte, byte, byte) | Inicializa una nueva instancia del[`XmpColorantRgb`](../xmpcolorantrgb) clase. |

## Propiedades

| Nombre | Descripción |
| --- | --- |
| [Blue](../../groupdocs.metadata.standards.xmp/xmpcolorantrgb/blue) { get; set; } | Obtiene o establece el componente azul. |
...
| [Green](../../groupdocs.metadata.standards.xmp/xmpcolorantrgb/green) { get; set; } | Obtiene o establece el valor verde. |
...
| [Red](../../groupdocs.metadata.standards.xmp/xmpcolorantrgb/red) { get; set; } | Obtiene o establece el componente rojo. |
