...
description: Representa metadatos de mensajes de correo electrónico.
type: docs
weight: 1360
url: /es/net/groupdocs.metadata.formats.email/emailpackage/
---
## EmailPackage class

Representa metadatos de mensajes de correo electrónico.
...
Este ejemplo muestra cómo eliminar todos los archivos adjuntos de un correo electrónico.
