...
description: Representa los metadatos del mensaje MSG.
type: docs
weight: 1400
url: /es/net/groupdocs.metadata.formats.email/msgpackage/
---
## MsgPackage class

Representa los metadatos del mensaje MSG.
...
| [Body](../../groupdocs.metadata.formats.email/msgpackage/body) { get; } | Obtiene el texto del mensaje de correo electrónico. |
...
| [Categories](../../groupdocs.metadata.formats.email/msgpackage/categories) { get; } | Obtiene la matriz de categorías o palabras clave. |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | Obtiene el número de propiedades de metadatos. |
| [DeliveryTime](../../groupdocs.metadata.formats.email/msgpackage/deliverytime) { get; } | Obtiene la fecha y hora en que se entregó el mensaje. |
