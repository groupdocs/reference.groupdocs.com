...
description: Representa el paquete raíz que permite trabajar con metadatos en un mensaje de correo electrónico EML.
type: docs
weight: 1390
url: /es/net/groupdocs.metadata.formats.email/emlrootpackage/
---
...
| [EmailPackage](../../groupdocs.metadata.formats.email/emlrootpackage/emailpackage) { get; } | Obtiene el paquete de metadatos EML. (2 properties) |
