...
description: Representa el paquete raíz que permite trabajar con metadatos en un mensaje de correo electrónico MSG.
type: docs
weight: 1410
url: /es/net/groupdocs.metadata.formats.email/msgrootpackage/
---
## MsgRootPackage class

Representa el paquete raíz que permite trabajar con metadatos en un mensaje de correo electrónico MSG.
...
| [EmailPackage](../../groupdocs.metadata.formats.email/msgrootpackage/emailpackage) { get; } | Obtiene el paquete de metadatos MSG. (2 properties) |
...
Este ejemplo de código muestra cómo extraer metadatos de un mensaje MSG.
