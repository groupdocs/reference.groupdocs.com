...
description: Representa un marco de enlace URL en unID3V2Tag./id3v2tag El nombre del marco siempre comienza con el carácter W.
type: docs
weight: 530
url: /es/net/groupdocs.metadata.formats.audio/id3v2urllinkframe/
---
## ID3V2UrlLinkFrame class

Representa un marco de enlace URL en un[`ID3V2Tag`](../id3v2tag) El nombre del marco siempre comienza con el carácter W.
...
| Nombre | Descripción |
| --- | --- |
| [ID3V2UrlLinkFrame](id3v2urllinkframe)(string, string) | Inicializa una nueva instancia del[`ID3V2UrlLinkFrame`](../id3v2urllinkframe) clase. |
...
| [Url](../../groupdocs.metadata.formats.audio/id3v2urllinkframe/url) { get; } | Obtiene el valor de URL. |
