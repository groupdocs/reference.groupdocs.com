...
description: Representa una firma digital utilizada para firmar un documento.
type: docs
weight: 3030
url: /es/net/groupdocs.metadata.standards.signing/digitalsignature/
---
## DigitalSignature class

Representa una firma digital utilizada para firmar un documento.
...
| virtual [SignTime](../../groupdocs.metadata.standards.signing/digitalsignature/signtime) { get; } | Obtiene la hora a la que se firmó el documento. |
...
* espacio de nombres [GroupDocs.Metadata.Standards.Signing](../../groupdocs.metadata.standards.signing)
