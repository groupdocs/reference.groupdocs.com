...
description: Representa metadatos de propiedad de flujo de audio en el contenedor de medios ASF.
type: docs
weight: 2230
url: /es/net/groupdocs.metadata.formats.video/asfaudiostreamproperty/
---
## AsfAudioStreamProperty class

Representa metadatos de propiedad de flujo de audio en el contenedor de medios ASF.
...
| [BitsPerSample](../../groupdocs.metadata.formats.video/asfaudiostreamproperty/bitspersample) { get; } | Obtiene el número de bits por muestra de datos monoaurales. |
| [Channels](../../groupdocs.metadata.formats.video/asfaudiostreamproperty/channels) { get; } | Obtiene el número de canales de audio. |
...
| [FormatTag](../../groupdocs.metadata.formats.video/asfaudiostreamproperty/formattag) { get; } | Obtiene la ID única del códec utilizado para codificar los datos de audio. |
...
| [SamplesPerSecond](../../groupdocs.metadata.formats.video/asfaudiostreamproperty/samplespersecond) { get; } | Obtiene un valor en hercios (ciclos por segundo) que representa la frecuencia de muestreo del flujo de audio. |
