...
description: Obtiene el paquete de metadatos ASF.
type: docs
weight: 10
url: /es/net/groupdocs.metadata.formats.video/asfrootpackage/asfpackage/
---
## AsfRootPackage.AsfPackage property

Obtiene el paquete de metadatos ASF.
...
Este ejemplo de código demuestra cómo leer metadatos ASF nativos.
...
using (Metadata metadata = new Metadata(Constants.InputAsf))
{
    ...
    // Mostrar información del códec ASF
    ...
    // Mostrar descriptores de metadatos
    ...
    //Mostrar las propiedades de flujo base
    foreach (AsfBaseStreamProperty property in package.StreamProperties)
    {
        ...
        //Mostrar las propiedades del flujo de audio
        ...
        //Mostrar las propiedades del flujo de video
