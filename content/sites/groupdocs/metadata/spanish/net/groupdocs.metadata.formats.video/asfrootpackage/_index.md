...
description: Representa el paquete raíz que permite trabajar con metadatos en un video ASF.
type: docs
weight: 2350
url: /es/net/groupdocs.metadata.formats.video/asfrootpackage/
---
## AsfRootPackage class

Representa el paquete raíz que permite trabajar con metadatos en un video ASF.
...
| Nombre | Descripción |
| --- | --- |
| [AsfPackage](../../groupdocs.metadata.formats.video/asfrootpackage/asfpackage) { get; } | Obtiene el paquete de metadatos ASF. |
...
| [XmpPackage](../../groupdocs.metadata.formats.video/asfrootpackage/xmppackage) { get; set; } | Obtiene o establece el paquete de metadatos XMP. |
