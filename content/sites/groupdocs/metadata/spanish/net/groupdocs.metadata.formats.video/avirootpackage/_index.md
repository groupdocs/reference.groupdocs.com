...
description: Representa el paquete raíz que permite trabajar con metadatos en un video AVI.
type: docs
weight: 2400
url: /es/net/groupdocs.metadata.formats.video/avirootpackage/
---
## AviRootPackage class

Representa el paquete raíz que permite trabajar con metadatos en un video AVI.
...
| [Header](../../groupdocs.metadata.formats.video/avirootpackage/header) { get; } | Obtiene el paquete de cabecera AVI. |
| [Item](../../groupdocs.metadata.common/metadatapackage/item) { get; } | Obtiene el[`MetadataProperty`](../../groupdocs.metadata.common/metadataproperty) con el nombre especificado. |
| [Keys](../../groupdocs.metadata.common/metadatapackage/keys) { get; } | Obtiene una colección de nombres de propiedades de metadatos. |
| [MetadataType](../../groupdocs.metadata.common/metadatapackage/metadatatype) { get; } | Obtiene el tipo de metadato. |
| [PropertyDescriptors](../../groupdocs.metadata.common/metadatapackage/propertydescriptors) { get; } | Obtiene una colección de descriptores que contienen información sobre propiedades accesibles a través del motor de búsqueda GroupDocs.Metadata. |
| [RiffInfoPackage](../../groupdocs.metadata.formats.video/avirootpackage/riffinfopackage) { get; } | Obtiene el paquete que contiene las etiquetas de información RIFF. |
| [XmpPackage](../../groupdocs.metadata.formats.video/avirootpackage/xmppackage) { get; set; } | Obtiene o establece el paquete de metadatos XMP. |
