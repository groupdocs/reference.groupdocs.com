...
description: Representa los metadatos de la pista en un video de Matroska.
type: docs
weight: 2550
url: /es/net/groupdocs.metadata.formats.video/matroskatrack/
---
## MatroskaTrack class
...
| [Language](../../groupdocs.metadata.formats.video/matroskatrack/language) { get; } | Obtiene el idioma de la pista en el formulario de idiomas Matroska. Este elemento DEBE ignorarse si el[`LanguageIetf`](./languageietf) El elemento se utiliza en el mismo TrackEntry. |
| [LanguageIetf](../../groupdocs.metadata.formats.video/matroskatrack/languageietf) { get; } | Obtiene el idioma de la pista de acuerdo con BCP 47 y mediante el registro de subetiquetas de idioma de la IANA. Si se usa este Elemento, entonces cualquier[`Language`](./language) Los elementos utilizados en el mismo TrackEntry DEBEN ser ignorados. |
