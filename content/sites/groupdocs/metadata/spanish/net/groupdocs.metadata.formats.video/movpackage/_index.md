...
description: Representa metadatos de QuickTime.
type: docs
weight: 2630
url: /es/net/groupdocs.metadata.formats.video/movpackage/
---
## MovPackage class

Representa metadatos de QuickTime.
...
| Nombre | Descripción |
| --- | --- |
| [Atoms](../../groupdocs.metadata.formats.video/movpackage/atoms) { get; } | Obtiene una matriz de[`MovAtom`](../movatom) átomos. |
