...
description: Representa los metadatos de propiedad de transmisión de video en el contenedor de medios ASF.
type: docs
weight: 2370
url: /es/net/groupdocs.metadata.formats.video/asfvideostreamproperty/
---
## AsfVideoStreamProperty class

Representa los metadatos de propiedad de transmisión de video en el contenedor de medios ASF.
...
| [BitsPerPixels](../../groupdocs.metadata.formats.video/asfvideostreamproperty/bitsperpixels) { get; } | Obtiene los bits por píxel. |
| [Compression](../../groupdocs.metadata.formats.video/asfvideostreamproperty/compression) { get; } | Obtiene el Id. de compresión de video. |
...
| [ImageHeight](../../groupdocs.metadata.formats.video/asfvideostreamproperty/imageheight) { get; } | Obtiene la altura de la imagen codificada en píxeles. |
| [ImageWidth](../../groupdocs.metadata.formats.video/asfvideostreamproperty/imagewidth) { get; } | Obtiene el ancho de la imagen codificada en píxeles. |
