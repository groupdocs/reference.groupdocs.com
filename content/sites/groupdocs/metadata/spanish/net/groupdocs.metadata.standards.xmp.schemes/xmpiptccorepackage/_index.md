...
description: Representa el paquete IPTC Core XMP.
type: docs
weight: 3140
url: /es/net/groupdocs.metadata.standards.xmp.schemes/xmpiptccorepackage/
---
## XmpIptcCorePackage class

Representa el paquete IPTC Core XMP.
...
| Nombre | Descripción |
| --- | --- |
| [XmpIptcCorePackage](xmpiptccorepackage)() | Inicializa una nueva instancia del[`XmpIptcCorePackage`](../xmpiptccorepackage) clase. |
...
| [CountryCode](../../groupdocs.metadata.standards.xmp.schemes/xmpiptccorepackage/countrycode) { get; set; } | Obtiene o establece el código del país en el que se centra el contenido. El código debe tomarse del código de dos o tres letras ISO 3166. |
| [IntellectualGenre](../../groupdocs.metadata.standards.xmp.schemes/xmpiptccorepackage/intellectualgenre) { get; set; } | Obtiene o establece el género intelectual. Describe la naturaleza, característica intelectual, artística o periodística de un objeto informativo, no específicamente su contenido. |
| [Item](../../groupdocs.metadata.common/metadatapackage/item) { get; } | Obtiene el[`MetadataProperty`](../../groupdocs.metadata.common/metadataproperty) con el nombre especificado. |
| [Keys](../../groupdocs.metadata.common/metadatapackage/keys) { get; } | Obtiene una colección de nombres de propiedades de metadatos. |
| [Location](../../groupdocs.metadata.standards.xmp.schemes/xmpiptccorepackage/location) { get; set; } | Obtiene o establece la ubicación en la que se enfoca el contenido. |
...
| [Scenes](../../groupdocs.metadata.standards.xmp.schemes/xmpiptccorepackage/scenes) { get; set; } | Obtiene o establece la escena del contenido de la foto. |
| [SubjectCodes](../../groupdocs.metadata.standards.xmp.schemes/xmpiptccorepackage/subjectcodes) { get; set; } | Obtiene o establece uno o más Temas de la taxonomía IPTC "Subject-NewsCodes" para categorizar el contenido. Cada Tema se representa como una cadena de 8 dígitos en una lista desordenada. |
