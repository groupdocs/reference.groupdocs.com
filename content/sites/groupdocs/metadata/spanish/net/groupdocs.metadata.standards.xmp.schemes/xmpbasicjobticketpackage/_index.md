...
description: Representa el espacio de nombres del ticket de trabajo básico.
type: docs
weight: 3080
url: /es/net/groupdocs.metadata.standards.xmp.schemes/xmpbasicjobticketpackage/
---
## XmpBasicJobTicketPackage class

Representa el espacio de nombres del ticket de trabajo básico.
...
| Nombre | Descripción |
| --- | --- |
| [XmpBasicJobTicketPackage](xmpbasicjobticketpackage)() | Inicializa una nueva instancia del[`XmpBasicJobTicketPackage`](../xmpbasicjobticketpackage) clase. |
...
| [Jobs](../../groupdocs.metadata.standards.xmp.schemes/xmpbasicjobticketpackage/jobs) { get; set; } | Obtiene o establece los trabajos. |
