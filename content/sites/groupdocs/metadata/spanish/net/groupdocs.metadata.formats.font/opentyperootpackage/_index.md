...
description: Representa el paquete raíz que permite trabajar con metadatos en un archivo de fuente OpenType.
type: docs
weight: 1550
url: /es/net/groupdocs.metadata.formats.font/opentyperootpackage/
---
## OpenTypeRootPackage class

Representa el paquete raíz que permite trabajar con metadatos en un archivo de fuente OpenType.
...
| [DigitalSignaturePackage](../../groupdocs.metadata.formats.font/opentyperootpackage/digitalsignaturepackage) { get; } | Obtiene el paquete de metadatos de la firma digital. |
...
| [OpenTypePackage](../../groupdocs.metadata.formats.font/opentyperootpackage/opentypepackage) { get; } | Obtiene el paquete de metadatos OpenType. |
