...
description: Representa la clase de metadatos de registro binario vCard.
type: docs
weight: 630
url: /es/net/groupdocs.metadata.formats.businesscard/vcardbinaryrecord/
---
## VCardBinaryRecord class

Representa la clase de metadatos de registro binario vCard.
...
| override [ContentType](../../groupdocs.metadata.formats.businesscard/vcardbinaryrecord/contenttype) { get; } | Obtiene el tipo de contenido del registro. |
...
| [Value](../../groupdocs.metadata.formats.businesscard/vcardbinaryrecord/value) { get; } | Obtiene el valor del registro. |
