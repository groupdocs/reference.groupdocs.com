...
description: Representa el paquete raíz que permite trabajar con metadatos en un archivo VCard.
type: docs
weight: 790
url: /es/net/groupdocs.metadata.formats.businesscard/vcardrootpackage/
---
## VCardRootPackage class

Representa el paquete raíz que permite trabajar con metadatos en un archivo VCard.
...
| [VCardPackage](../../groupdocs.metadata.formats.businesscard/vcardrootpackage/vcardpackage) { get; } | Obtiene el paquete de metadatos de VCard. |
...
Este ejemplo de código muestra cómo leer las propiedades de metadatos de un archivo vCard.
