...
description: Representa la clase de metadatos del registro de fecha y hora de vCard.
type: docs
weight: 690
url: /es/net/groupdocs.metadata.formats.businesscard/vcarddatetimerecord/
---
## VCardDateTimeRecord class

Representa la clase de metadatos del registro de fecha y hora de vCard.
...
| override [ContentType](../../groupdocs.metadata.formats.businesscard/vcarddatetimerecord/contenttype) { get; } | Obtiene el tipo de contenido del registro. |
...
| [Value](../../groupdocs.metadata.formats.businesscard/vcarddatetimerecord/value) { get; } | Obtiene el valor del registro. |
