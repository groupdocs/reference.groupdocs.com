...
description: Proporciona una clase de unión de registros vCard base.
type: docs
weight: 780
url: /es/net/groupdocs.metadata.formats.businesscard/vcardrecordset/
---
## VCardRecordset class

Proporciona una clase de unión de registros vCard base.
