...
description: Representa la clase de metadatos de registro de texto vCard.
type: docs
weight: 810
url: /es/net/groupdocs.metadata.formats.businesscard/vcardtextrecord/
---
## VCardTextRecord class

Representa la clase de metadatos de registro de texto vCard.
...
| [CharsetParameter](../../groupdocs.metadata.formats.businesscard/vcardtextrecord/charsetparameter) { get; } | Obtiene el parámetro charset. |
| override [ContentType](../../groupdocs.metadata.formats.businesscard/vcardtextrecord/contenttype) { get; } | Obtiene el tipo de contenido del registro. |
...
| [IsQuotedPrintable](../../groupdocs.metadata.formats.businesscard/vcardtextrecord/isquotedprintable) { get; } | Obtiene un valor que indica si esta instancia es una cadena imprimible entrecomillada. |
...
| [MediaTypeParameter](../../groupdocs.metadata.formats.businesscard/vcardtextrecord/mediatypeparameter) { get; } | Obtiene el valor del parámetro de tipo de medio. |
...
| [Value](../../groupdocs.metadata.formats.businesscard/vcardtextrecord/value) { get; } | Obtiene el valor del registro. |
...
| [GetReadabilityValue](../../groupdocs.metadata.formats.businesscard/vcardtextrecord/getreadabilityvalue)(string) | Obtiene el valor de legibilidad. |
