...
description: Bir EML eposta iletisinde meta verilerle çalışmaya izin veren kök paketi temsil eder.
type: docs
weight: 1390
url: /tr/net/groupdocs.metadata.formats.email/emlrootpackage/
---
## EmlRootPackage class

Bir EML e-posta iletisinde meta verilerle çalışmaya izin veren kök paketi temsil eder.
...
| [EmailPackage](../../groupdocs.metadata.formats.email/emlrootpackage/emailpackage) { get; } | EML meta veri paketini alır. (2 properties) |
...
Bu kod örneği, meta verilerin bir EML mesajından nasıl çıkarılacağını gösterir.
