...
description: Eposta mesajı meta verilerini temsil eder.
type: docs
weight: 1360
url: /tr/net/groupdocs.metadata.formats.email/emailpackage/
---
## EmailPackage class

E-posta mesajı meta verilerini temsil eder.
...
Bu örnek, bir e-postadaki tüm eklerin nasıl kaldırılacağını gösterir.
