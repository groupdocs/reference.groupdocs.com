...
description: Eposta mesajı başlıklarını içeren bir meta veri paketini temsil eder.
type: docs
weight: 1350
url: /tr/net/groupdocs.metadata.formats.email/emailheaderpackage/
---
## EmailHeaderPackage class

E-posta mesajı başlıklarını içeren bir meta veri paketini temsil eder.
...
| [Get](../../groupdocs.metadata.formats.email/emailheaderpackage/get)(string) | Belirtilen başlığın değerini alır. |
