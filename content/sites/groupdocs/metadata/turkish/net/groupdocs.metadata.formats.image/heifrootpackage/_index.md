...
description: HEIF görüntüsünde meta verilerle çalışması amaçlanan kök paketi temsil eder.
type: docs
weight: 1730
url: /tr/net/groupdocs.metadata.formats.image/heifrootpackage/
---
## HeifRootPackage class

HEIF görüntüsünde meta verilerle çalışması amaçlanan kök paketi temsil eder.
...
| [ExifPackage](../../groupdocs.metadata.formats.image/heifrootpackage/exifpackage) { get; set; } | EXIF meta veri paketini alır veya ayarlar. |
...
| [XmpPackage](../../groupdocs.metadata.formats.image/heifrootpackage/xmppackage) { get; set; } | XMP meta veri paketini alır veya ayarlar. |
