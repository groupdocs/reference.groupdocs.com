...
description: Bir WMF görüntüsünde meta verilerle çalışması amaçlanan kök paketi temsil eder.
type: docs
weight: 2140
url: /tr/net/groupdocs.metadata.formats.image/wmfrootpackage/
---
## WmfRootPackage class

Bir WMF görüntüsünde meta verilerle çalışması amaçlanan kök paketi temsil eder.
