...
description: Bir TIFF Çift etiketini temsil eder.
type: docs
weight: 1970
url: /tr/net/groupdocs.metadata.formats.image/tiffdoubletag/
---
## TiffDoubleTag class

Bir TIFF Çift etiketini temsil eder.
...
| İsim | Tanım |
| --- | --- |
| [TiffDoubleTag](tiffdoubletag)(TiffTagID, double[]) | Yeni bir örneğini başlatır.[`TiffDoubleTag`](../tiffdoubletag) sınıf. |
