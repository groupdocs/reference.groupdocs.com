...
description: Bir Photoshop Belgesinde meta verilerle çalışmaya izin veren kök paketi temsil eder.
type: docs
weight: 1930
url: /tr/net/groupdocs.metadata.formats.image/psdrootpackage/
---
## PsdRootPackage class

Bir Photoshop Belgesinde meta verilerle çalışmaya izin veren kök paketi temsil eder.
...
| [ExifPackage](../../groupdocs.metadata.formats.image/psdrootpackage/exifpackage) { get; set; } | EXIF meta veri paketini alır veya ayarlar. |
| [FileType](../../groupdocs.metadata.formats.image/imagerootpackage/filetype) { get; } | Meta veri paketi dosya türünü alır. (2 properties) |
| [ImageResourcePackage](../../groupdocs.metadata.formats.image/psdrootpackage/imageresourcepackage) { get; } | Photoshop Görüntü Kaynağı meta veri paketini alır. Görüntü kaynağı blokları, Photoshop yerel dosya biçiminin temel yapı birimidir. |
| [IptcPackage](../../groupdocs.metadata.formats.image/psdrootpackage/iptcpackage) { get; set; } | IPTC meta veri paketini alır veya ayarlar. |
...
| [PsdPackage](../../groupdocs.metadata.formats.image/psdrootpackage/psdpackage) { get; } | PSD dosyası hakkında bilgi içeren meta veri paketini alır. |
| [XmpPackage](../../groupdocs.metadata.formats.image/psdrootpackage/xmppackage) { get; set; } | XMP meta veri paketini alır veya ayarlar. |
