...
description: Bir TIFF SByte etiketini temsil eder.
type: docs
weight: 2030
url: /tr/net/groupdocs.metadata.formats.image/tiffsbytetag/
---
## TiffSByteTag class

Bir TIFF SByte etiketini temsil eder.
...
| İsim | Tanım |
| --- | --- |
| [TiffSByteTag](tiffsbytetag)(TiffTagID, sbyte[]) | Yeni bir örneğini başlatır.[`TiffSByteTag`](../tiffsbytetag) sınıf. |
