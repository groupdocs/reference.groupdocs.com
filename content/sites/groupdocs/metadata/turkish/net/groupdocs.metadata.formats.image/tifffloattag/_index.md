...
description: Bir TIFF kayan etiketini temsil eder.
type: docs
weight: 1980
url: /tr/net/groupdocs.metadata.formats.image/tifffloattag/
---
## TiffFloatTag class

Bir TIFF kayan etiketini temsil eder.
...
| İsim | Tanım |
| --- | --- |
| [TiffFloatTag](tifffloattag)(TiffTagID, float[]) | Yeni bir örneğini başlatır.[`TiffFloatTag`](../tifffloattag) sınıf. |
