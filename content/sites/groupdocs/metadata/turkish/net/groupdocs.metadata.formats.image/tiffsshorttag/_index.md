...
description: Bir TIFF SShort etiketini temsil eder.
type: docs
weight: 2070
url: /tr/net/groupdocs.metadata.formats.image/tiffsshorttag/
---
## TiffSShortTag class

Bir TIFF SShort etiketini temsil eder.
...
| İsim | Tanım |
| --- | --- |
| [TiffSShortTag](tiffsshorttag)(TiffTagID, short[]) | Yeni bir örneğini başlatır.[`TiffSShortTag`](../tiffsshorttag) sınıf. |
