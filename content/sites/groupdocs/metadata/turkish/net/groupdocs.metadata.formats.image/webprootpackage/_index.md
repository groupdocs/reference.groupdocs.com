...
description: Bir WEBP görüntüsünde meta verilerle çalışmaya izin veren kök paketi temsil eder.
type: docs
weight: 2130
url: /tr/net/groupdocs.metadata.formats.image/webprootpackage/
---
## WebPRootPackage class

Bir WEBP görüntüsünde meta verilerle çalışmaya izin veren kök paketi temsil eder.
...
| [ExifPackage](../../groupdocs.metadata.formats.image/webprootpackage/exifpackage) { get; set; } | EXIF meta veri paketini alır veya ayarlar. |
...
| [XmpPackage](../../groupdocs.metadata.formats.image/webprootpackage/xmppackage) { get; set; } | XMP meta veri paketini alır veya ayarlar. |
