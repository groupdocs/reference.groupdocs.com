...
description: Tüm görüntü kök paketleri için bir temel soyut sınıf sağlar.
type: docs
weight: 1770
url: /tr/net/groupdocs.metadata.formats.image/imagerootpackage/
---
## ImageRootPackage class

Tüm görüntü kök paketleri için bir temel soyut sınıf sağlar.
