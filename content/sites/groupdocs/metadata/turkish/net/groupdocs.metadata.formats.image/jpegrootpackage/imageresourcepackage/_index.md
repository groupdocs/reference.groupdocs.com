...
type: docs
weight: 20
url: /tr/net/groupdocs.metadata.formats.image/jpegrootpackage/imageresourcepackage/
---
...
Aşağıdaki kod örneği, bir JPEG görüntüsünden görüntü kaynak bloklarının (Photoshop dosya biçiminin yapı taşları) nasıl çıkarılacağını gösterir.
