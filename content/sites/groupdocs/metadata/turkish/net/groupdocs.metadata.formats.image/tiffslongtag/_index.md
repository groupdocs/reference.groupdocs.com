...
description: Bir TIFF S Uzun etiketini temsil eder.
type: docs
weight: 2040
url: /tr/net/groupdocs.metadata.formats.image/tiffslongtag/
---
## TiffSLongTag class

Bir TIFF S Uzun etiketini temsil eder.
...
| İsim | Tanım |
| --- | --- |
| [TiffSLongTag](tiffslongtag)(TiffTagID, int[]) | Yeni bir örneğini başlatır.[`TiffSLongTag`](../tiffslongtag) sınıf. |
