...
description: Bir Bayt etiketini temsil eder.
type: docs
weight: 1960
url: /tr/net/groupdocs.metadata.formats.image/tiffbytetag/
---
## TiffByteTag class

Bir Bayt etiketini temsil eder.
...
| İsim | Tanım |
| --- | --- |
| [TiffByteTag](tiffbytetag)(TiffTagID, byte[]) | Yeni bir örneğini başlatır.[`TiffByteTag`](../tiffbytetag) sınıf. |
