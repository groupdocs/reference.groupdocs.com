...
description: QuickTime videosunda meta verilerle çalışmaya izin veren kök paketi temsil eder.
type: docs
weight: 2640
url: /tr/net/groupdocs.metadata.formats.video/movrootpackage/
---
## MovRootPackage class

QuickTime videosunda meta verilerle çalışmaya izin veren kök paketi temsil eder.
...
| [MovPackage](../../groupdocs.metadata.formats.video/movrootpackage/movpackage) { get; } | QuickTime meta veri paketini alır. |
...
| [XmpPackage](../../groupdocs.metadata.formats.video/movrootpackage/xmppackage) { get; set; } | XMP meta veri paketini alır veya ayarlar. |
...
Bu örnek, bir MOV videosunda QuickTime atomlarının nasıl okunacağını gösterir.
