...
description: Bir FLV videosunda meta verilerle çalışmaya izin veren kök paketi temsil eder.
type: docs
weight: 2420
url: /tr/net/groupdocs.metadata.formats.video/flvrootpackage/
---
## FlvRootPackage class

Bir FLV videosunda meta verilerle çalışmaya izin veren kök paketi temsil eder.
...
| [Header](../../groupdocs.metadata.formats.video/flvrootpackage/header) { get; } | FLV başlık paketini alır. |
...
| [XmpPackage](../../groupdocs.metadata.formats.video/flvrootpackage/xmppackage) { get; set; } | XMP meta veri paketini alır veya ayarlar. |
