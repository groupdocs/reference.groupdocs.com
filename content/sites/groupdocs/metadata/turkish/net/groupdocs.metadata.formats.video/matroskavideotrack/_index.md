...
description: Bir Matroska videosundaki video meta verilerini temsil eder.
type: docs
weight: 2610
url: /tr/net/groupdocs.metadata.formats.video/matroskavideotrack/
---
## MatroskaVideoTrack class

Bir Matroska videosundaki video meta verilerini temsil eder.
...
| İsim | Tanım |
| --- | --- |
| [AlphaMode](../../groupdocs.metadata.formats.video/matroskavideotrack/alphamode) { get; } | Alfa Video Modunu alır. Bu Öğenin varlığı, BlockAdditional Öğesinin Alfa verileri içerebileceğini gösterir. |
...
| [FlagInterlaced](../../groupdocs.metadata.formats.video/matroskavideotrack/flaginterlaced) { get; } | Videonun ilerici mi yoksa geçmeli mi olduğunun bilinip bilinmediğini bildiren bir bayrak alır ve uygulanabilirse, taramayla ilgili ayrıntıları bildirir. |
...
| [PixelCropBottom](../../groupdocs.metadata.formats.video/matroskavideotrack/pixelcropbottom) { get; } | Görüntünün altından kaldırılacak video piksellerinin sayısını alır. |
| [PixelCropLeft](../../groupdocs.metadata.formats.video/matroskavideotrack/pixelcropleft) { get; } | Görüntünün solunda kaldırılacak video piksellerinin sayısını alır. |
| [PixelCropRight](../../groupdocs.metadata.formats.video/matroskavideotrack/pixelcropright) { get; } | Görüntünün sağ tarafında kaldırılacak video piksellerinin sayısını alır. |
