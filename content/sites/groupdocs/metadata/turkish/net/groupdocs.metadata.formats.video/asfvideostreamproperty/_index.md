...
description: ASF ortam kapsayıcısındaki Video akış özelliği meta verilerini temsil eder.
type: docs
weight: 2370
url: /tr/net/groupdocs.metadata.formats.video/asfvideostreamproperty/
---
## AsfVideoStreamProperty class

ASF ortam kapsayıcısındaki Video akış özelliği meta verilerini temsil eder.
...
| [BitsPerPixels](../../groupdocs.metadata.formats.video/asfvideostreamproperty/bitsperpixels) { get; } | Piksel başına bitleri alır. |
| [Compression](../../groupdocs.metadata.formats.video/asfvideostreamproperty/compression) { get; } | Video sıkıştırma kimliğini alır. |
...
| [ImageHeight](../../groupdocs.metadata.formats.video/asfvideostreamproperty/imageheight) { get; } | Kodlanmış görüntünün yüksekliğini piksel cinsinden alır. |
| [ImageWidth](../../groupdocs.metadata.formats.video/asfvideostreamproperty/imagewidth) { get; } | Kodlanmış görüntünün genişliğini piksel olarak alır. |
