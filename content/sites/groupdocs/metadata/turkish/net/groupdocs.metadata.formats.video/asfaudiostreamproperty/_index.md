...
description: ASF ortam kapsayıcısındaki Ses akışı özelliği meta verilerini temsil eder.
type: docs
weight: 2230
url: /tr/net/groupdocs.metadata.formats.video/asfaudiostreamproperty/
---
## AsfAudioStreamProperty class

ASF ortam kapsayıcısındaki Ses akışı özelliği meta verilerini temsil eder.
...
| [BitsPerSample](../../groupdocs.metadata.formats.video/asfaudiostreamproperty/bitspersample) { get; } | Mono veri örneği başına bit sayısını alır. |
| [Channels](../../groupdocs.metadata.formats.video/asfaudiostreamproperty/channels) { get; } | Ses kanallarının sayısını alır. |
...
| [FormatTag](../../groupdocs.metadata.formats.video/asfaudiostreamproperty/formattag) { get; } | Ses verilerini kodlamak için kullanılan codec bileşeninin benzersiz kimliğini alır. |
...
| [SamplesPerSecond](../../groupdocs.metadata.formats.video/asfaudiostreamproperty/samplespersecond) { get; } | Ses akışının örnekleme oranını temsil eden Hertz (saniyedeki döngü) cinsinden bir değer alır. |
