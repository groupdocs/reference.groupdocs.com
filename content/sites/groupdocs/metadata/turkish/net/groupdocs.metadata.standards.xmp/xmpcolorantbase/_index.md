...
description: Bir belgede kullanılan renklendiricinin renk örneğinin özelliklerini içeren bir yapı.
type: docs
weight: 3300
url: /tr/net/groupdocs.metadata.standards.xmp/xmpcolorantbase/
---
## XmpColorantBase class

Bir belgede kullanılan renklendiricinin (renk örneğinin) özelliklerini içeren bir yapı.
