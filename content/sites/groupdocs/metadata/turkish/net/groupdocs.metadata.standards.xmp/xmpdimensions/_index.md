...
type: docs
weight: 3380
url: /tr/net/groupdocs.metadata.standards.xmp/xmpdimensions/
---
## XmpDimensions class
...
| İsim | Tanım |
| --- | --- |
| [XmpDimensions](xmpdimensions#constructor)() | Yeni bir örneğini başlatır.[`XmpDimensions`](../xmpdimensions) sınıf. |
| [XmpDimensions](xmpdimensions#constructor_1)(double, double) | Yeni bir örneğini başlatır.[`XmpDimensions`](../xmpdimensions) sınıf. |
...
| [Height](../../groupdocs.metadata.standards.xmp/xmpdimensions/height) { get; set; } | Yüksekliği alır veya ayarlar. |
...
| [Units](../../groupdocs.metadata.standards.xmp/xmpdimensions/units) { get; set; } | Birimleri alır veya ayarlar. |
| [Width](../../groupdocs.metadata.standards.xmp/xmpdimensions/width) { get; set; } | Genişliği alır veya ayarlar. |
