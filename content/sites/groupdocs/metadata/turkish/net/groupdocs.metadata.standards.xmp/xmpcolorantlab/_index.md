...
description: LAB Renklendiriciyi Temsil Eder.
type: docs
weight: 3330
url: /tr/net/groupdocs.metadata.standards.xmp/xmpcolorantlab/
---
...
| İsim | Tanım |
| --- | --- |
| [XmpColorantLab](xmpcolorantlab#constructor)() | Yeni bir örneğini başlatır.[`XmpColorantLab`](../xmpcolorantlab) sınıf. |
| [XmpColorantLab](xmpcolorantlab#constructor_1)(sbyte, sbyte, double) | Yeni bir örneğini başlatır.[`XmpColorantLab`](../xmpcolorantlab) sınıf. |

## Özellikleri

| İsim | Tanım |
| --- | --- |
| [A](../../groupdocs.metadata.standards.xmp/xmpcolorantlab/a) { get; set; } | A bileşenini alır veya ayarlar. |
| [B](../../groupdocs.metadata.standards.xmp/xmpcolorantlab/b) { get; set; } | B bileşenini alır veya ayarlar. |
...
| [L](../../groupdocs.metadata.standards.xmp/xmpcolorantlab/l) { get; set; } | L bileşenini alır veya ayarlar. |
...
| İsim | Tanım |
| --- | --- |
| const [MaxL](../../groupdocs.metadata.standards.xmp/xmpcolorantlab/maxl) | Bileşen L maks değeri. |
| const [MinL](../../groupdocs.metadata.standards.xmp/xmpcolorantlab/minl) | Bileşen L min değeri. |
