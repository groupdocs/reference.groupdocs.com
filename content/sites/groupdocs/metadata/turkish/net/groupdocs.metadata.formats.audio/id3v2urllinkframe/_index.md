...
description: Bir URL bağlantı çerçevesini temsil eder.ID3V2Tag./id3v2tag Çerçevenin adı her zaman W karakteriyle başlar.
type: docs
weight: 530
url: /tr/net/groupdocs.metadata.formats.audio/id3v2urllinkframe/
---
## ID3V2UrlLinkFrame class

Bir URL bağlantı çerçevesini temsil eder.[`ID3V2Tag`](../id3v2tag) Çerçevenin adı her zaman W karakteriyle başlar.
...
| İsim | Tanım |
| --- | --- |
| [ID3V2UrlLinkFrame](id3v2urllinkframe)(string, string) | Yeni bir örneğini başlatır.[`ID3V2UrlLinkFrame`](../id3v2urllinkframe) sınıf. |
...
| [Url](../../groupdocs.metadata.formats.audio/id3v2urllinkframe/url) { get; } | URL değerini alır. |
