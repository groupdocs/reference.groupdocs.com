...
description: Bir genel çerçeveyi temsil eder.ID3V2Tag./id3v2tag .
type: docs
weight: 500
url: /tr/net/groupdocs.metadata.formats.audio/id3v2tagframe/
---
## ID3V2TagFrame class

Bir genel çerçeveyi temsil eder.[`ID3V2Tag`](../id3v2tag) .
...
| İsim | Tanım |
| --- | --- |
| [ID3V2TagFrame](id3v2tagframe)(string, byte[]) | Yeni bir örneğini başlatır.[`ID3V2TagFrame`](../id3v2tagframe) sınıf. |
