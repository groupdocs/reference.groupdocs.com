...
description: Bir TXXX çerçevesini temsil eder.ID3V2Tag./id3v2tag .
type: docs
weight: 540
url: /tr/net/groupdocs.metadata.formats.audio/id3v2userdefinedframe/
---
## ID3V2UserDefinedFrame class

Bir TXXX çerçevesini temsil eder.[`ID3V2Tag`](../id3v2tag) .
...
| İsim | Tanım |
| --- | --- |
| [ID3V2UserDefinedFrame](id3v2userdefinedframe#constructor_1)(string, string) | Yeni bir örneğini başlatır.[`ID3V2UserDefinedFrame`](../id3v2userdefinedframe) sınıf. |
| [ID3V2UserDefinedFrame](id3v2userdefinedframe#constructor)(ID3V2EncodingType, string, string) | Yeni bir örneğini başlatır.[`ID3V2UserDefinedFrame`](../id3v2userdefinedframe) sınıf. |
...
| [Description](../../groupdocs.metadata.formats.audio/id3v2userdefinedframe/description) { get; } | Açıklamayı alır. |
| [Encoding](../../groupdocs.metadata.formats.audio/id3v2userdefinedframe/encoding) { get; } | Çerçevenin kodlamasını alır. |
...
| [Value](../../groupdocs.metadata.formats.audio/id3v2userdefinedframe/value) { get; } | Değeri alır. |
