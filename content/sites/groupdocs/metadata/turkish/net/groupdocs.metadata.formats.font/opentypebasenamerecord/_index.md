...
description: Temel OpenType Adı tablosu kayıt sınıfını temsil eder.
type: docs
weight: 1420
url: /tr/net/groupdocs.metadata.formats.font/opentypebasenamerecord/
---
## OpenTypeBaseNameRecord class

Temel OpenType Adı tablosu kayıt sınıfını temsil eder.
