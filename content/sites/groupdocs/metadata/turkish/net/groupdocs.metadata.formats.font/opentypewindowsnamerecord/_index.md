...
description: için Ad kayıt tablosu değerini temsil eder.Windows platform.
type: docs
weight: 1640
url: /tr/net/groupdocs.metadata.formats.font/opentypewindowsnamerecord/
---
## OpenTypeWindowsNameRecord class

için Ad kayıt tablosu değerini temsil eder.Windows platform.
...
| [Encoding](../../groupdocs.metadata.formats.font/opentypewindowsnamerecord/encoding) { get; } | Kodlama tanımlayıcısını alır. |
| [Item](../../groupdocs.metadata.common/metadatapackage/item) { get; } | Şunu alır:[`MetadataProperty`](../../groupdocs.metadata.common/metadataproperty) belirtilen ada sahip. |
| [Keys](../../groupdocs.metadata.common/metadatapackage/keys) { get; } | Meta veri özellik adlarının bir koleksiyonunu alır. |
| [Language](../../groupdocs.metadata.formats.font/opentypewindowsnamerecord/language) { get; } | Dil tanımlayıcısını alır. |
