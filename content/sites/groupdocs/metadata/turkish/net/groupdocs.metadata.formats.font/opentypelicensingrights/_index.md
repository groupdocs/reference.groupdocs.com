...
| EditableEmbedding | `8` | Düzenlenebilir gömme. Yazı tipi katıştırılabilir ve diğer sistemlere geçici olarak yüklenebilir. Önizleme ve Yazdırma gömmede olduğu gibi, Düzenlenebilir yazı tiplerini içeren belgeler okumak için açılabilir. Ayrıca, gömülü yazı tipini kullanarak yeni metni biçimlendirme yeteneği de dahil olmak üzere düzenlemeye izin verilir ve değişiklikler kaydedilebilir. |
