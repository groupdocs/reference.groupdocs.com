...
description: için Ad kayıt tablosu değerini temsil eder.Unicode platform.
type: docs
weight: 1580
url: /tr/net/groupdocs.metadata.formats.font/opentypeunicodenamerecord/
---
## OpenTypeUnicodeNameRecord class

için Ad kayıt tablosu değerini temsil eder.Unicode platform.
...
| [Encoding](../../groupdocs.metadata.formats.font/opentypeunicodenamerecord/encoding) { get; } | Kodlama tanımlayıcısını alır. |
