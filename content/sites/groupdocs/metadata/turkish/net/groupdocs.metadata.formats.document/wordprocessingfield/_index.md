...
description: Kelime işlem belgesindeki bir alanı temsil eder.
type: docs
weight: 1250
url: /tr/net/groupdocs.metadata.formats.document/wordprocessingfield/
---
## WordProcessingField class

Kelime işlem belgesindeki bir alanı temsil eder.
...
| İsim | Tanım |
| --- | --- |
| [Code](../../groupdocs.metadata.formats.document/wordprocessingfield/code) { get; } | Alan kodunu alır. |
...
| [Result](../../groupdocs.metadata.formats.document/wordprocessingfield/result) { get; } | Alan sonucunu alır. |
