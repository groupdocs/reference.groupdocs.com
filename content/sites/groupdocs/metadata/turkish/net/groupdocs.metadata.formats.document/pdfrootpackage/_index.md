...
description: Bir PDF belgesinde meta verilerle çalışmaya izin veren kök paketi temsil eder.
type: docs
weight: 1040
url: /tr/net/groupdocs.metadata.formats.document/pdfrootpackage/
---
## PdfRootPackage class

Bir PDF belgesinde meta verilerle çalışmaya izin veren kök paketi temsil eder.
...
| [DocumentStatistics](../../groupdocs.metadata.formats.document/pdfrootpackage/documentstatistics) { get; } | Belge istatistikleri paketini alır. |
| [FileType](../../groupdocs.metadata.formats.document/pdfrootpackage/filetype) { get; } | Meta veri paketi dosya türünü alır. (2 properties) |
| [InspectionPackage](../../groupdocs.metadata.formats.document/pdfrootpackage/inspectionpackage) { get; } | Belge için inceleme sonuçlarını içeren bir meta veri paketi alır. Paket, bazı durumlarda meta veri olarak kabul edilebilecek belge bölümleri hakkında bilgi içerir. |
...
| [XmpPackage](../../groupdocs.metadata.formats.document/pdfrootpackage/xmppackage) { get; set; } | XMP meta veri paketini alır veya ayarlar. |
...
Bu kod örneği, yerleşik meta veri özelliklerinin bir PDF belgesinden nasıl çıkarılacağını gösterir.
