...
description: PDF belgesindeki bir form alanını temsil eder.
type: docs
weight: 1010
url: /tr/net/groupdocs.metadata.formats.document/pdfformfield/
---
## PdfFormField class

PDF belgesindeki bir form alanını temsil eder.
...
| [Name](../../groupdocs.metadata.formats.document/pdfformfield/name) { get; } | Alanın adını alır. |
...
| [Value](../../groupdocs.metadata.formats.document/pdfformfield/value) { get; } | Alan değerini alır. |
