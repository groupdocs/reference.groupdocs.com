...
description: Bir belgedeki bir revizyonu izlenen değişiklik temsil eder.
type: docs
weight: 1290
url: /tr/net/groupdocs.metadata.formats.document/wordprocessingrevision/
---
## WordProcessingRevision class

Bir belgedeki bir revizyonu (izlenen değişiklik) temsil eder.
...
| İsim | Tanım |
| --- | --- |
| [Author](../../groupdocs.metadata.formats.document/wordprocessingrevision/author) { get; } | Düzeltmenin yazarını alır. |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | Meta veri özelliklerinin sayısını alır. |
| [DateTime](../../groupdocs.metadata.formats.document/wordprocessingrevision/datetime) { get; } | Revizyonun tarihini/saatini alır. |
...
| [RevisionType](../../groupdocs.metadata.formats.document/wordprocessingrevision/revisiontype) { get; } | Revizyonun türünü alır. |
