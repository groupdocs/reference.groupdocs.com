...
type: docs
weight: 980
url: /tr/net/groupdocs.metadata.formats.document/pdfannotation/
---
## PdfAnnotation class
...
| [Name](../../groupdocs.metadata.formats.document/pdfannotation/name) { get; } | Ek açıklamanın adını alır. |
| [PageNumber](../../groupdocs.metadata.formats.document/pdfannotation/pagenumber) { get; } | Ek açıklamayı içeren sayfanın numarasını alır. |
...
| [Text](../../groupdocs.metadata.formats.document/pdfannotation/text) { get; } | Ek açıklama metnini alır. |
