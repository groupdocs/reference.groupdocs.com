...
description: Bir şemada meta verilerle çalışması amaçlanan kök paketi temsil eder.
type: docs
weight: 900
url: /tr/net/groupdocs.metadata.formats.document/diagramrootpackage/
---
## DiagramRootPackage class

Bir şemada meta verilerle çalışması amaçlanan kök paketi temsil eder.
...
| [DocumentStatistics](../../groupdocs.metadata.formats.document/diagramrootpackage/documentstatistics) { get; } | Belge istatistikleri paketini alır. |
| [FileType](../../groupdocs.metadata.formats.document/diagramrootpackage/filetype) { get; } | Meta veri paketi dosya türünü alır. (2 properties) |
...
Aşağıdaki kod örneği, bir şema belgesinde yerleşik meta veri özelliklerinin nasıl güncelleneceğini gösterir.
