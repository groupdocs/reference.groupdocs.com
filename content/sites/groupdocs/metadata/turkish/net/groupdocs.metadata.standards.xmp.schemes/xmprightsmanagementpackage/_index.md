...
type: docs
weight: 3220
url: /tr/net/groupdocs.metadata.standards.xmp.schemes/xmprightsmanagementpackage/
---
...
| İsim | Tanım |
| --- | --- |
| [XmpRightsManagementPackage](xmprightsmanagementpackage)() | Yeni bir örneğini başlatır.[`XmpRightsManagementPackage`](../xmprightsmanagementpackage) sınıf. |

## Özellikleri

| İsim | Tanım |
| --- | --- |
| [Certificate](../../groupdocs.metadata.standards.xmp.schemes/xmprightsmanagementpackage/certificate) { get; set; } | Bir hak yönetimi sertifikası için Web URL'sini alır veya ayarlar. |
| [Count](../../groupdocs.metadata.common/metadatapackage/count) { get; } | Meta veri özelliklerinin sayısını alır. |
| [Item](../../groupdocs.metadata.common/metadatapackage/item) { get; } | Şunu alır:[`MetadataProperty`](../../groupdocs.metadata.common/metadataproperty) belirtilen ada sahip. |
| [Keys](../../groupdocs.metadata.common/metadatapackage/keys) { get; } | Meta veri özellik adlarının bir koleksiyonunu alır. |
| [Marked](../../groupdocs.metadata.standards.xmp.schemes/xmprightsmanagementpackage/marked) { get; set; } | Bunun haklarla yönetilen bir kaynak olup olmadığını gösteren bir değer alır veya ayarlar. |
| [MetadataType](../../groupdocs.metadata.common/metadatapackage/metadatatype) { get; } | Meta veri türünü alır. |
| [NamespaceUri](../../groupdocs.metadata.standards.xmp/xmppackage/namespaceuri) { get; } | Ad alanı URI'sini alır. |
| [Owners](../../groupdocs.metadata.standards.xmp.schemes/xmprightsmanagementpackage/owners) { get; set; } | Yasal sahipleri alır veya ayarlar. |
...
| [UsageTerms](../../groupdocs.metadata.standards.xmp.schemes/xmprightsmanagementpackage/usageterms) { get; set; } | Çeşitli dillerde verilen, kaynağın yasal olarak nasıl kullanılabileceğine ilişkin talimatları alır veya ayarlar. |
| [WebStatement](../../groupdocs.metadata.standards.xmp.schemes/xmprightsmanagementpackage/webstatement) { get; set; } | Bu kaynağın sahiplik ve kullanım hakları bildirimi için Web URL'sini alır veya ayarlar. |
...
| override [Set](../../groupdocs.metadata.standards.xmp.schemes/xmprightsmanagementpackage/set#set_7)(string, string) | Dizi özelliğini ayarlar. |
