...
description: Temel İş Bileti ad alanını temsil eder.
type: docs
weight: 3080
url: /tr/net/groupdocs.metadata.standards.xmp.schemes/xmpbasicjobticketpackage/
---
## XmpBasicJobTicketPackage class

Temel İş Bileti ad alanını temsil eder.
...
| İsim | Tanım |
| --- | --- |
| [XmpBasicJobTicketPackage](xmpbasicjobticketpackage)() | Yeni bir örneğini başlatır.[`XmpBasicJobTicketPackage`](../xmpbasicjobticketpackage) sınıf. |
...
| [Jobs](../../groupdocs.metadata.standards.xmp.schemes/xmpbasicjobticketpackage/jobs) { get; set; } | İşleri alır veya ayarlar. |
