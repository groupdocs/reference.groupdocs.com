...
description: VCF Sanal İletişim Dosyası elektronik kartvizit biçimi meta verilerini temsil eder.
type: docs
weight: 760
url: /tr/net/groupdocs.metadata.formats.businesscard/vcardpackage/
---
## VCardPackage class

VCF (Sanal İletişim Dosyası) elektronik kartvizit biçimi meta verilerini temsil eder.
...
| İsim | Tanım |
| --- | --- |
| [Cards](../../groupdocs.metadata.formats.businesscard/vcardpackage/cards) { get; } | Dosyadan çıkarılan kartların bir dizisini alır. |
