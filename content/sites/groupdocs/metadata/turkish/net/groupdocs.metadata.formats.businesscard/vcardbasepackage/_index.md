...
description: Temel VCard meta veri sınıfını temsil eder.
type: docs
weight: 620
url: /tr/net/groupdocs.metadata.formats.businesscard/vcardbasepackage/
---
## VCardBasePackage class

Temel VCard meta veri sınıfını temsil eder.
