...
description: Soyut vCard kaydı meta veri sınıfını temsil eder.
type: docs
weight: 770
url: /tr/net/groupdocs.metadata.formats.businesscard/vcardrecord/
---
## VCardRecord class

Soyut vCard kaydı meta veri sınıfını temsil eder.
...
| abstract [ContentType](../../groupdocs.metadata.formats.businesscard/vcardrecord/contenttype) { get; } | Kayıt içerik türünü alır. |
