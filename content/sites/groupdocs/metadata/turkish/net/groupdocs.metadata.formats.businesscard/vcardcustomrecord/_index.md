...
description: vCard özel kayıt meta veri sınıfını temsil eder.
type: docs
weight: 680
url: /tr/net/groupdocs.metadata.formats.businesscard/vcardcustomrecord/
---
## VCardCustomRecord class

vCard özel kayıt meta veri sınıfını temsil eder.
...
| override [ContentType](../../groupdocs.metadata.formats.businesscard/vcardcustomrecord/contenttype) { get; } | Kayıt içerik türünü alır. |
...
| [Value](../../groupdocs.metadata.formats.businesscard/vcardcustomrecord/value) { get; } | Kayıt değerini alır. |
