...
description: vCard Agent kaydı meta veri sınıfını temsil eder.
type: docs
weight: 610
url: /tr/net/groupdocs.metadata.formats.businesscard/vcardagentrecord/
---
## VCardAgentRecord class

vCard Agent kaydı meta veri sınıfını temsil eder.
...
| override [ContentType](../../groupdocs.metadata.formats.businesscard/vcardagentrecord/contenttype) { get; } | Kayıt içerik türünü alır. |
...
| [Value](../../groupdocs.metadata.formats.businesscard/vcardagentrecord/value) { get; } | Kayıt değerini alır. |
