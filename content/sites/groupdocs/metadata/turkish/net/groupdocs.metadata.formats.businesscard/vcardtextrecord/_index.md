...
description: vCard metin kaydı meta veri sınıfını temsil eder.
type: docs
weight: 810
url: /tr/net/groupdocs.metadata.formats.businesscard/vcardtextrecord/
---
...
| [CharsetParameter](../../groupdocs.metadata.formats.businesscard/vcardtextrecord/charsetparameter) { get; } | Karakter kümesi parametresini alır. |
| override [ContentType](../../groupdocs.metadata.formats.businesscard/vcardtextrecord/contenttype) { get; } | Kayıt içerik türünü alır. |
...
| [IsQuotedPrintable](../../groupdocs.metadata.formats.businesscard/vcardtextrecord/isquotedprintable) { get; } | Bu örneğin alıntılanmış yazdırılabilir dize olup olmadığını gösteren bir değer alır. |
...
| [MediaTypeParameter](../../groupdocs.metadata.formats.businesscard/vcardtextrecord/mediatypeparameter) { get; } | Ortam türü parametre değerini alır. |
...
| [Value](../../groupdocs.metadata.formats.businesscard/vcardtextrecord/value) { get; } | Kayıt değerini alır. |
...
| [GetReadabilityValue](../../groupdocs.metadata.formats.businesscard/vcardtextrecord/getreadabilityvalue)(string) | Okunabilirlik değerini alır. |
