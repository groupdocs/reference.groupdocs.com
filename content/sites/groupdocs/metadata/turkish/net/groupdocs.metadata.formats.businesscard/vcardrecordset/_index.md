...
description: Bir temel vCard kayıt birleştirme sınıfı sağlar.
type: docs
weight: 780
url: /tr/net/groupdocs.metadata.formats.businesscard/vcardrecordset/
---
## VCardRecordset class

Bir temel vCard kayıt birleştirme sınıfı sağlar.
