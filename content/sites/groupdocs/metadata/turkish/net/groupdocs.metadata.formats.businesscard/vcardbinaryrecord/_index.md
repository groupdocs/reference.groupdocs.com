...
description: vCard ikili kayıt meta veri sınıfını temsil eder.
type: docs
weight: 630
url: /tr/net/groupdocs.metadata.formats.businesscard/vcardbinaryrecord/
---
## VCardBinaryRecord class

vCard ikili kayıt meta veri sınıfını temsil eder.
...
| override [ContentType](../../groupdocs.metadata.formats.businesscard/vcardbinaryrecord/contenttype) { get; } | Kayıt içerik türünü alır. |
...
| [Value](../../groupdocs.metadata.formats.businesscard/vcardbinaryrecord/value) { get; } | Kayıt değerini alır. |
