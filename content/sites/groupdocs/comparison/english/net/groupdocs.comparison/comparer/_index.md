...
| [Comparer](comparer#constructor_6)(string, LoadOptions) | Initializes new instance of [`Comparer`](../comparer) with source file path and [`LoadOptions`](../../groupdocs.comparison.options/loadoptions). |
...
| [Comparer](comparer#constructor_7)(string, LoadOptions, ComparerSettings) | Initializes new instance of [`Comparer`](../comparer) class with source file path, [`LoadOptions`](../../groupdocs.comparison.options/loadoptions) and [`ComparerSettings`](../comparersettings). |
...
| [Add](../../groupdocs.comparison/comparer/add#add_3)(string, LoadOptions) | Adds file to comparison with loading options specified. |
