...
The classes in this package are used to represent revisions and tracked changes made to Word documents during the comparison process.
These revisions include insertions, deletions, formatting changes, and other modifications to the document content.


The key classes in this package include [RevisionHandler](../../com.groupdocs.comparison.words.revision/revisionhandler),
[RevisionAction](../../com.groupdocs.comparison.words.revision/revisionaction), and [RevisionInfo](../../com.groupdocs.comparison.words.revision/revisioninfo).
