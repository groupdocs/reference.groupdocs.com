...
More details about its usage can be found in [Document.getDocumentInfo()](../../com.groupdocs.comparison/document#getDocumentInfo--) method or in a [documentation](../https://docs.groupdocs.com/comparison/java/get-file-info/).
