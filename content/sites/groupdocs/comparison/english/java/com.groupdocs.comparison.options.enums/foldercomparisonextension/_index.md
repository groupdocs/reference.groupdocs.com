...
description: The FolderComparisonExtension class is an enumeration that represents different file extensions that can be used in folder comparison.
type: docs
weight: 11
url: /java/com.groupdocs.comparison.options.enums/foldercomparisonextension/
---
**Inheritance:**
java.lang.Object, java.lang.Enum
```
public enum FolderComparisonExtension extends Enum<FolderComparisonExtension>
```
...
### values() {#values--}
```
public static FolderComparisonExtension[] values()
```
...
### valueOf(String name) {#valueOf-java.lang.String-}
```
public static FolderComparisonExtension valueOf(String name)
```
...
```
public static FolderComparisonExtension fromString(String toStringValue)
```
