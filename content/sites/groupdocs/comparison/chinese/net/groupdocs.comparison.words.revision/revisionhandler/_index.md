...
| 姓名 | 描述 |
| --- | --- |
| [RevisionHandler](revisionhandler#constructor)(Stream) | 初始化的新实例[`RevisionHandler`](../revisionhandler)带有带有修订的文件流的类。 |
| [RevisionHandler](revisionhandler#constructor_1)(string) | 初始化的新实例[`RevisionHandler`](../revisionhandler)带有修订文件路径的类。 |

## 方法

| 姓名 | 描述 |
| --- | --- |
| [ApplyRevisionChanges](../../groupdocs.comparison.words.revision/revisionhandler/applyrevisionchanges#applyrevisionchanges)(ApplyRevisionOptions) | 处理修订中的更改并将它们应用到从中获取修订的同一文件。 |
...
| [ApplyRevisionChanges](../../groupdocs.comparison.words.revision/revisionhandler/applyrevisionchanges#applyrevisionchanges_2)(string, ApplyRevisionOptions) | 处理revision中的变化，结果按路径写入指定文件。 |
