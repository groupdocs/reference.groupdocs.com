...
| --- | --- |
| [RedactableImage(IImageFormatInstance img)](#RedactableImage-com.groupdocs.redaction.integration.IImageFormatInstance-) | Creates a new instace using an object, implementing 
IImageFormatInstance
 interface.
 |
| [RedactableImage(IMultipleAreaRedactable img)](#RedactableImage-com.groupdocs.redaction.integration.IMultipleAreaRedactable-) | Creates a new instace using an object, implementing 
