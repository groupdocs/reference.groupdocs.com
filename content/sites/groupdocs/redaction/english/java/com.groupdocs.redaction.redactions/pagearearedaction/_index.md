...
* More details about document metadata redactions: [Redaction basics](../https://docs.groupdocs.com/redaction/java/redaction-basics/)
...
| Method | Description |
| --- | --- |
| [getImageOptions()](#getImageOptions--) | Gets the 
