...
Represents color and area parameters for image region replacement. See 
ImageAreaRedaction
.
...
* More details about image redactions: [Image redactions](../https://docs.groupdocs.com/redaction/java/image-redactions/)
