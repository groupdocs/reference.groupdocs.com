...
* More details about policies: [Use of redaction policies](../https://docs.groupdocs.com/redaction/java/use-redaction-policies/)
...
| Method | Description |
| --- | --- |
| [getRedactions()](#getRedactions--) | Gets an array of fully configured 
Redaction
-derived classes.
 |
| [load(String filePath)](#load-java.lang.String-) | Loads an instance of 
RedactionPolicy
 from a file path.
 |
| [load(InputStream input)](#load-java.io.InputStream-) | Loads an instance of 
RedactionPolicy
 from a stream.
 |
