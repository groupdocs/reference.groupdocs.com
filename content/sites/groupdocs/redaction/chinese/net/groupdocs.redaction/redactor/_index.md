...
| 姓名 | 描述 |
| --- | --- |
| [Redactor](redactor#constructor)(Stream) | 初始化一个新实例[`Redactor`](../redactor)使用 stream. 的类 |
| [Redactor](redactor#constructor_3)(string) | 初始化一个新实例[`Redactor`](../redactor)使用文件路径的类. |
| [Redactor](redactor#constructor_1)(Stream, LoadOptions) | 初始化一个新实例[`Redactor`](../redactor)使用 stream. 的密码保护文档的类 |
| [Redactor](redactor#constructor_4)(string, LoadOptions) | 初始化一个新实例[`Redactor`](../redactor)使用其路径. 的受密码保护文档的类 |
| [Redactor](redactor#constructor_2)(Stream, LoadOptions, RedactorSettings) | 初始化一个新实例[`Redactor`](../redactor)使用流和设置的密码保护文档的类。 |
| [Redactor](redactor#constructor_5)(string, LoadOptions, RedactorSettings) | 初始化一个新实例[`Redactor`](../redactor)使用其路径和设置的受密码保护文档的类。 |

## 方法

| 姓名 | 描述 |
| --- | --- |
| [Apply](../../groupdocs.redaction/redactor/apply#apply)(Redaction) | 对文档应用密文。 |
| [Apply](../../groupdocs.redaction/redactor/apply#apply_1)(RedactionPolicy) | 将编辑策略应用于文档。 |
| [Apply](../../groupdocs.redaction/redactor/apply#apply_2)(Redaction[]) | 对文档应用一组修订。 |
...
| [Save](../../groupdocs.redaction/redactor/save#save)() | 使用以下选项将文档保存到文件：AddSuffix = true, RasterizeToPDF = true. |
