...
description: 表示文件类型提供获取 GroupDocs.Redaction 支持的所有文件类型列表的方法通过扩展名检测文件类型等
type: docs
weight: 90
...
表示文件类型。提供获取 GroupDocs.Redaction 支持的所有文件类型列表的方法，通过扩展名检测文件类型等。
...
| static [DOCX](../../groupdocs.redaction/filetype/docx) { get; } | Microsoft Word 打开 XML 文档 (.docx) |
...
| static [NUMBERS](../../groupdocs.redaction/filetype/numbers) { get; } | Apple Numbers 电子表格 (.numbers) |
...
| static [PDF](../../groupdocs.redaction/filetype/pdf) { get; } | 便携式文档格式文件 (.pdf) |
...
| static [Unknown](../../groupdocs.redaction/filetype/unknown) { get; } | 代表未知文件类型。 |
...
| static [XLSX](../../groupdocs.redaction/filetype/xlsx) { get; } | Microsoft Excel 打开 XML 电子表格 (.xlsx) |
...
| override [ToString](../../groupdocs.redaction/filetype/tostring)() | 返回表示当前对象的字符串。 |
| static [GetSupportedFileTypes](../../groupdocs.redaction/filetype/getsupportedfiletypes)() | 检索支持的文件类型 |
| [operator ==](../../groupdocs.redaction/filetype/op_equality) | 判断是否两个[`FileType`](../filetype)对象是相同的。 |
| [operator !=](../../groupdocs.redaction/filetype/op_inequality) | 判断是否两个[`FileType`](../filetype)对象不一样. |
