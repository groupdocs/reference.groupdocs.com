...
description: Opzioni per la conversione in tipo 3D.
type: docs
weight: 1910
url: /it/net/groupdocs.conversion.options.convert/threedconvertoptions/
---
## ThreeDConvertOptions class

Opzioni per la conversione in tipo 3D.
...
| Nome | Descrizione |
| --- | --- |
| [ThreeDConvertOptions](threedconvertoptions)() | Inizializza una nuova istanza di[`ThreeDConvertOptions`](../threedconvertoptions) classe. |
...
| [PageNumber](../../groupdocs.conversion.options.convert/threedconvertoptions/pagenumber) { get; set; } | Il numero di pagina da cui iniziare la conversione. |
| [PagesCount](../../groupdocs.conversion.options.convert/threedconvertoptions/pagescount) { get; set; } | Numero di pagine da convertire a partire da`Numero di pagina` . |
