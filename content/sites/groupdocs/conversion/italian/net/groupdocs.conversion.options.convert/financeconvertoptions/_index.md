...
description: Opzioni per la conversione in tipo finanziario.
type: docs
weight: 1520
url: /it/net/groupdocs.conversion.options.convert/financeconvertoptions/
---
## FinanceConvertOptions class

Opzioni per la conversione in tipo finanziario.
...
| Nome | Descrizione |
| --- | --- |
| [FinanceConvertOptions](financeconvertoptions)() | Inizializza una nuova istanza di[`FinanceConvertOptions`](../financeconvertoptions) classe. |
...
| [PageNumber](../../groupdocs.conversion.options.convert/financeconvertoptions/pagenumber) { get; set; } | Il numero di pagina da cui iniziare la conversione. |
| [PagesCount](../../groupdocs.conversion.options.convert/financeconvertoptions/pagescount) { get; set; } | Numero di pagine da convertire a partire da`Numero di pagina` . |
