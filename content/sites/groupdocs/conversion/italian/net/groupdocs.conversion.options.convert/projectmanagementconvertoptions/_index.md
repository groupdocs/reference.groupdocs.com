...
| Nome | Descrizione |
| --- | --- |
| [ProjectManagementConvertOptions](projectmanagementconvertoptions)() | Inizializza una nuova istanza di[`ProjectManagementConvertOptions`](../projectmanagementconvertoptions) classe. |
