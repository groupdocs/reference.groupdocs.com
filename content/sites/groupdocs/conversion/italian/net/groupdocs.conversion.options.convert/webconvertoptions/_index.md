...
description: Opzioni per la conversione nel tipo di file Web.
type: docs
weight: 1980
...
Opzioni per la conversione nel tipo di file Web.
...
| Nome | Descrizione |
| --- | --- |
| [WebConvertOptions](webconvertoptions)() | Inizializza una nuova istanza di[`WebConvertOptions`](../webconvertoptions) classe. |
