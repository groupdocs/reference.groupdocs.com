...
| Nome | Descrizione |
| --- | --- |
| static readonly [Fodp](../../groupdocs.conversion.filetypes/presentationfiletype/fodp) | I file con estensione FODP rappresentano la presentazione OpenDocument Flat XML. File di presentazione salvato nel formato OpenDocument, ma salvato utilizzando un formato XML piatto anziché il contenitore .ZIP utilizzato dai file .ODP standard |
...
| static readonly [Pot](../../groupdocs.conversion.filetypes/presentationfiletype/pot) | I file con estensione .POT rappresentano i file modello di Microsoft PowerPoint creati dalle versioni PowerPoint 97-2003. Ulteriori informazioni su questo formato di file[qui](https://wiki.fileformat.com/presentation/pot) . |
...
| static readonly [Potx](../../groupdocs.conversion.filetypes/presentationfiletype/potx) | I file con estensione .POTX rappresentano presentazioni modello Microsoft PowerPoint create con Microsoft PowerPoint 2007 e versioni successive. Ulteriori informazioni su questo formato di file[qui](https://wiki.fileformat.com/presentation/potx) . |
...
| static readonly [Pptm](../../groupdocs.conversion.filetypes/presentationfiletype/pptm) | I file con estensione PPTM sono file di presentazione abilitati per le macro creati con Microsoft PowerPoint 2007 o versioni successive. Ulteriori informazioni su questo formato di file[qui](https://wiki.fileformat.com/presentation/pptm) . |
