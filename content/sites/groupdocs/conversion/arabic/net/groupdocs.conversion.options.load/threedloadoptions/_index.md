...
خيارات لتحميل المستندات ثلاثية الأبعاد .
...
| اسم | وصف |
| --- | --- |
| [ThreeDLoadOptions](threedloadoptions)() | تهيئة مثيل جديد لـ[`ThreeDLoadOptions`](../threedloadoptions) فئة . |

## الخصائص

| اسم | وصف |
| --- | --- |
| [Format](../../groupdocs.conversion.options.load/threedloadoptions/format) { get; set; } | نوع ملف مستند الإدخال . |
