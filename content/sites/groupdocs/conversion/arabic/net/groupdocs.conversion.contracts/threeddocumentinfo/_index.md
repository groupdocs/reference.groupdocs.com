...
description: يحتوي على بيانات وصفية للمستندات ثلاثية الأبعاد
type: docs
weight: 540
url: /ar/net/groupdocs.conversion.contracts/threeddocumentinfo/
---
## ThreeDDocumentInfo class

يحتوي على بيانات وصفية للمستندات ثلاثية الأبعاد
