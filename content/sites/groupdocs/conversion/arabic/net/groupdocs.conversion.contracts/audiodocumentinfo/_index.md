...
description: يحتوي على بيانات وصفية للمستندات الصوتية
type: docs
weight: 40
url: /ar/net/groupdocs.conversion.contracts/audiodocumentinfo/
---
## AudioDocumentInfo class

يحتوي على بيانات وصفية للمستندات الصوتية
