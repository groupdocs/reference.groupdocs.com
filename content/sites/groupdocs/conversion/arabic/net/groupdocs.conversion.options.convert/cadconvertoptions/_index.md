...
description: خيارات للتحويل إلى نوع Cad .
type: docs
weight: 1430
url: /ar/net/groupdocs.conversion.options.convert/cadconvertoptions/
---
## CadConvertOptions class

خيارات للتحويل إلى نوع Cad .
...
| اسم | وصف |
| --- | --- |
| [CadConvertOptions](cadconvertoptions)() | تهيئة مثيل جديد لـ[`CadConvertOptions`](../cadconvertoptions) فئة . |
...
| [PageNumber](../../groupdocs.conversion.options.convert/cadconvertoptions/pagenumber) { get; set; } | رقم الصفحة الذي سيبدأ التحويل منه . |
| [PagesCount](../../groupdocs.conversion.options.convert/cadconvertoptions/pagescount) { get; set; } | عدد الصفحات المطلوب التحويل منها بدءًا من`رقم الصفحة` . |
