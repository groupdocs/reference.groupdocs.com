...
| 姓名 | 描述 |
| --- | --- |
| [CsvLoadOptions](csvloadoptions)() | 初始化新实例[`CsvLoadOptions`](../csvloadoptions)类. |
...
| [ConvertDateTimeData](../../groupdocs.conversion.options.load/csvloadoptions/convertdatetimedata) { get; set; } | 表示文件中的字符串是否转换为日期。默认为 True. |
| [ConvertNumericData](../../groupdocs.conversion.options.load/csvloadoptions/convertnumericdata) { get; set; } | 表示文件中的字符串是否转换为数字。默认为 True. |
