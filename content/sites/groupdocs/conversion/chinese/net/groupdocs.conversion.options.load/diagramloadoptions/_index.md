...
| 姓名 | 描述 |
| --- | --- |
| [DiagramLoadOptions](diagramloadoptions)() | 初始化新实例[`DiagramLoadOptions`](../diagramloadoptions)类. |

## 特性

| 姓名 | 描述 |
| --- | --- |
| [DefaultFont](../../groupdocs.conversion.options.load/diagramloadoptions/defaultfont) { get; set; } | 图文档的默认字体。如果缺少字体，将使用以下字体。 |
