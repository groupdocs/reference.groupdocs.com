...
description: 加载字体文件的选项
type: docs
weight: 2140
url: /zh/net/groupdocs.conversion.options.load/fontloadoptions/
---
...
| 姓名 | 描述 |
| --- | --- |
| [FontLoadOptions](fontloadoptions)() | 初始化新实例[`FontLoadOptions`](../fontloadoptions)类. |

## 特性

| 姓名 | 描述 |
| --- | --- |
| [Format](../../groupdocs.conversion.options.load/fontloadoptions/format) { get; set; } | 输入文档文件类型. |
