...
description: 加载数据库文件的选项
type: docs
weight: 2070
url: /zh/net/groupdocs.conversion.options.load/databaseloadoptions/
---
...
| 姓名 | 描述 |
| --- | --- |
| [DatabaseLoadOptions](databaseloadoptions)() | 初始化新实例[`DataLoadOptions`](../dataloadoptions)类. |

## 特性

| 姓名 | 描述 |
| --- | --- |
| [Format](../../groupdocs.conversion.options.load/databaseloadoptions/format) { get; set; } | 输入文档文件类型. |
