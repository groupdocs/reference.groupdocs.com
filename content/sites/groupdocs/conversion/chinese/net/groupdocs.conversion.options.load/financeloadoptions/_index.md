...
description: 加载财务文件的选项
type: docs
weight: 2130
url: /zh/net/groupdocs.conversion.options.load/financeloadoptions/
---
...
| 姓名 | 描述 |
| --- | --- |
| [FinanceLoadOptions](financeloadoptions)() | 初始化新实例[`FinanceLoadOptions`](../financeloadoptions)类. |

## 特性

| 姓名 | 描述 |
| --- | --- |
| [Format](../../groupdocs.conversion.options.load/financeloadoptions/format) { get; set; } | 输入文档文件类型. |
