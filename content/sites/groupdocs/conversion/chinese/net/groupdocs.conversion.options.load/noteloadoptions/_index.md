...
| 姓名 | 描述 |
| --- | --- |
| [NoteLoadOptions](noteloadoptions)() | 初始化新实例[`NoteLoadOptions`](../noteloadoptions)类. |
...
| [FontSubstitutes](../../groupdocs.conversion.options.load/noteloadoptions/fontsubstitutes) { get; set; } | 转换笔记文档时替换特定字体。 |
