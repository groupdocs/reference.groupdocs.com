...
| 姓名 | 描述 |
| --- | --- |
| [WordProcessingConvertOptions](wordprocessingconvertoptions)() | 初始化的新实例[`WordProcessingConvertOptions`](../wordprocessingconvertoptions)类. |
...
| [PdfRecognitionMode](../../groupdocs.conversion.options.convert/wordprocessingconvertoptions/pdfrecognitionmode) { get; set; } | 从pdf转换时的识别模式 |
...
| [Zoom](../../groupdocs.conversion.options.convert/wordprocessingconvertoptions/zoom) { get; set; } | 以百分比指定缩放级别。默认为 100. 在 Microsoft Word 2010 之前支持默认缩放。从 Microsoft Word 2013 开始，默认缩放不再设置为文档，而是使用上次打开文档的缩放系数。 |
