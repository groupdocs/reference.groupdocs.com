...
| 姓名 | 描述 |
| --- | --- |
| [CadConvertOptions](cadconvertoptions)() | 初始化的新实例[`CadConvertOptions`](../cadconvertoptions)类. |
...
| [PageNumber](../../groupdocs.conversion.options.convert/cadconvertoptions/pagenumber) { get; set; } | 开始转换的页码。 |
| [PagesCount](../../groupdocs.conversion.options.convert/cadconvertoptions/pagescount) { get; set; } | 开始转换的页数`页码`. |
