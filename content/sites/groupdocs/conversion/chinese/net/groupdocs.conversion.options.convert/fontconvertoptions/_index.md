...
description: 转换为字体类型的选项
type: docs
weight: 1540
url: /zh/net/groupdocs.conversion.options.convert/fontconvertoptions/
---
...
| 姓名 | 描述 |
| --- | --- |
| [FontConvertOptions](fontconvertoptions)() | 初始化新实例[`AudioConvertOptions`](../audioconvertoptions)类. |
