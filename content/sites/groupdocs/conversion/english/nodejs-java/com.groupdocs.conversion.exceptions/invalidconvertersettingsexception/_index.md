...
type: docs
weight: 17
url: /nodejs-java/com.groupdocs.conversion.exceptions/invalidconvertersettingsexception/
---
**Inheritance:**
...
```
public final class InvalidConverterSettingsException extends GroupDocsConversionException
```
