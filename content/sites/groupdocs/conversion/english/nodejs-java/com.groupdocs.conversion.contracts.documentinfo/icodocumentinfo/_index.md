...
```
public class IcoDocumentInfo extends ImageDocumentInfo
```
...
| --- | --- |
| [IcoDocumentInfo(Image ico, FileType format, long size)](#IcoDocumentInfo-com.aspose.imaging.Image-com.groupdocs.conversion.filetypes.FileType-long-) |  |
### IcoDocumentInfo(Image ico, FileType format, long size) {#IcoDocumentInfo-com.aspose.imaging.Image-com.groupdocs.conversion.filetypes.FileType-long-}
```
public IcoDocumentInfo(Image ico, FileType format, long size)
```
