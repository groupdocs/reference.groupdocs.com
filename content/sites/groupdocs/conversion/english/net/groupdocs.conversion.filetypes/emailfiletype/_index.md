...
| static readonly [Ics](../../groupdocs.conversion.filetypes/emailfiletype/ics) | ICS (iCalendar) file format is used to represent and exchange calendaring and scheduling information such as events, to-dos, and free/busy data. Learn more about this file format [here](https://wiki.fileformat.com/email/ics). |
