...
| static readonly [Wmv](../../groupdocs.conversion.filetypes/videofiletype/wmv) | Windows Media Video is the compressed video format developed by Microsoft. After the standardization by the Society of Motion Picture and Television Engineers (SMPTE), WMV is now considered to be an open standard format. Learn more about this file format [here](https://docs.fileformat.com/video/wmv/). |
