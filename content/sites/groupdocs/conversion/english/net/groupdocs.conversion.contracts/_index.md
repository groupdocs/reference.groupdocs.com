...
description: The namespace provides members to instantiate and release output document manage font substitutions etc.
type: docs
weight: 30
url: /net/groupdocs.conversion.contracts/
---
...
| [DocumentInfo](./documentinfo) | Provides base implementation for retrieving polymorphic document information |
...
| [TarDocumentInfo](./tardocumentinfo) | Contains Tar document metadata |
| [TargetConversion](./targetconversion) | Represents possible target conversion and a flag is it a primary or secondary |
