---
title: WimDocumentInfo
second_title: GroupDocs.Conversion for .NET API Reference
description: Contains Wim document metadata
type: docs
weight: 740
url: /net/groupdocs.conversion.contracts/wimdocumentinfo/
---
## WimDocumentInfo class

Contains Wim document metadata

```csharp
public class WimDocumentInfo : DocumentInfo, ICompressionDocumentHierarchyInfo
```
...
| Name | Description |
| --- | --- |
| [ContentTree](../../groupdocs.conversion.contracts/wimdocumentinfo/contenttree) { get; } | Gets the hierarchical structure of the compressed content. |
