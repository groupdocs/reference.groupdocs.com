...
```csharp
public class LhaDocumentInfo : DocumentInfo, ICompressionDocumentHierarchyInfo
```
...
| Name | Description |
| --- | --- |
| [ContentTree](../../groupdocs.conversion.contracts/lhadocumentinfo/contenttree) { get; } | Gets the hierarchical structure of the compressed content. |
