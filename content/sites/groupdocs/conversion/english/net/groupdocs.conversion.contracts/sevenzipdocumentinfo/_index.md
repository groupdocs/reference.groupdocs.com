...
```csharp
public class SevenZipDocumentInfo : DocumentInfo, ICompressionDocumentHierarchyInfo
```
...
| Name | Description |
| --- | --- |
| [ContentTree](../../groupdocs.conversion.contracts/sevenzipdocumentinfo/contenttree) { get; } | Gets the hierarchical structure of the compressed content. |
