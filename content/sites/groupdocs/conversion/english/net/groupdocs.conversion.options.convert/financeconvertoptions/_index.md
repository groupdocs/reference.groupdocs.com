...
| Name | Description |
| --- | --- |
| [FinanceConvertOptions](financeconvertoptions)() | Initializes new instance of [`FinanceConvertOptions`](../financeconvertoptions) class. |
...
| [PageNumber](../../groupdocs.conversion.options.convert/financeconvertoptions/pagenumber) { get; set; } | Implements [`PageNumber`](../ipagedconvertoptions/pagenumber) |
| [PagesCount](../../groupdocs.conversion.options.convert/financeconvertoptions/pagescount) { get; set; } | Implements [`PagesCount`](../ipagedconvertoptions/pagescount) |
