...
type: docs
weight: 16
url: /nodejs-java/com.groupdocs.conversion.exceptions/invalidconvertoptionsexception/
---
**Inheritance:**
...
```
public final class InvalidConvertOptionsException extends GroupDocsConversionException
```
