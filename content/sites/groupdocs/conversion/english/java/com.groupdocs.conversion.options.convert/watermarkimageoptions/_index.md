...
type: docs
weight: 43
url: /nodejs-java/com.groupdocs.conversion.options.convert/watermarkimageoptions/
---
**Inheritance:**
...
```
public class WatermarkImageOptions extends WatermarkOptions
```
...
| --- | --- |
| [WatermarkImageOptions(byte[] image)](#WatermarkImageOptions-byte---) |  |
## Methods
