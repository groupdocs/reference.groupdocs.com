...
```
public final class PsdOptions extends ValueObject implements Serializable
```
...
| Parameter | Type | Description |
| --- | --- | --- |
| value | [PsdColorModes](../../com.groupdocs.conversion.options.convert/psdcolormodes) |  |

### getCompression() {#getCompression--}
```
public final PsdCompressionMethods getCompression()
```
...
| Parameter | Type | Description |
| --- | --- | --- |
| value | [PsdCompressionMethods](../../com.groupdocs.conversion.options.convert/psdcompressionmethods) |  |
