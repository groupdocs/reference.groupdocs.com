...
```
public class FontConvertOptions extends ConvertOptions<FontFileType>
```
...
| --- | --- |
| [FontConvertOptions()](#FontConvertOptions--) | Initializes new instance of  class. |
### FontConvertOptions() {#FontConvertOptions--}
```
