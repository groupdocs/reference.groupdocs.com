...
| --- | --- |
| [MarkdownDocumentInfo(Document txt, FileType format, long size)](#MarkdownDocumentInfo-com.aspose.words.Document-com.groupdocs.conversion.filetypes.FileType-long-) |  |
### MarkdownDocumentInfo(Document txt, FileType format, long size) {#MarkdownDocumentInfo-com.aspose.words.Document-com.groupdocs.conversion.filetypes.FileType-long-}
```
public MarkdownDocumentInfo(Document txt, FileType format, long size)
```
