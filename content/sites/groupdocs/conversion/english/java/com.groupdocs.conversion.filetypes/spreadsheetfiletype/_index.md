...
| [Ods](#Ods) | Files with ODS extension stand for OpenDocument Spreadsheet Document format that are editable by user.
 |
| [Ots](#Ots) | A file with .ots extension is an OpenDocument Spreadsheet Template file that is created with the Calc application software included in Apache OpenOffice.
 |
...
| [Tsv](#Tsv) | A Tab-Separated Values (TSV) file format represents data separated with tabs in plain text format.
 |
| [Xlam](#Xlam) | XLAM is an Macro-Enabled Add-In file that is used to add new functions to spreadsheets.
 |
| [Csv](#Csv) | Files with CSV (Comma Separated Values) extension represent plain text files that contain records of data with comma separated values.
 |
| [Fods](#Fods) | A file with .fods extension is a type of OpenDocument Spreadsheet document format that stores data in rows and columns.
 |
| [Dif](#Dif) | DIF stands for Data Interchange Format that is used to import/export spreadsheets data between different applications.
 |
| [Sxc](#Sxc) | The file format SXC(Sun XML Calc) belongs to an office suite called OpenOffice.org.
 |
