...
type: docs
url: /python-net/groupdocs.conversion.fluent/iconversionloadoptionsorsourcedocumentloaded/with_options/
is_root: false
weight: 1100
---
...
| Parameter | Type | Description |
| :- | :- | :- |
| load_options_provider | `Func[LoadContext, LoadOptions]` | Load options provider. The load options context. |
