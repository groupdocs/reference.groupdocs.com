...
type: docs
url: /python-net/groupdocs.conversion.fluent/iconversionsettingsorconversionfrom/with_events/
is_root: false
weight: 1070
---
...
It sits at the same entry stage as [`IConversionSettings.with_settings`](/conversion/python-net/groupdocs.conversion.fluent/iconversionsettings/with_settings/). Multiple calls accumulate: the same internal bag is passed to each `configure` action, so handlers set in earlier calls survive unless overwritten by a later one.
