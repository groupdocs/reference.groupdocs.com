...
description: 
type: docs
url: /conversion/python-net/groupdocs.conversion.contracts/fonttransformation/create_by_name/
is_root: false
weight: 1020
---
...
Creates a font transformation by name only, matching any size and style.

The replacement font will preserve the original font's size and style.
