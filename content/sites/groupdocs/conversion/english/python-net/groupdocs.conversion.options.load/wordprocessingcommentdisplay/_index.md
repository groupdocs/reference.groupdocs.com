---
title: WordProcessingCommentDisplay class
second_title: GroupDocs.Conversion for Python via .NET API References
description: "The rendering mode for document comments."
type: docs
url: /python-net/groupdocs.conversion.options.load/wordprocessingcommentdisplay/
is_root: false
weight: 570
---
...
The rendering mode for document comments.

The WordProcessingCommentDisplay type exposes the following members:
...
| [equals](/conversion/python-net/groupdocs.conversion.contracts/enumeration/equals/) | Determines whether two object instances are equal. (inherited from [`Enumeration`](/conversion/python-net/groupdocs.conversion.contracts/enumeration/)) |
...
| [to_string](/conversion/python-net/groupdocs.conversion.contracts/enumeration/to_string/) | Returns a string that represents the current object. (inherited from [`Enumeration`](/conversion/python-net/groupdocs.conversion.contracts/enumeration/)) |
