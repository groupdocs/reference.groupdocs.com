---
title: PresentationNotesPosition class
second_title: GroupDocs.Conversion for Python via .NET API References
description: "Represents the way notes are printed with the slide."
type: docs
url: /python-net/groupdocs.conversion.options.load/presentationnotesposition/
is_root: false
weight: 410
---
...
The PresentationNotesPosition type exposes the following members:
