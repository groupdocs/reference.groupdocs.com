...
description: "The option to display or hide the \"from\" email address."
type: docs
...
The option to display or hide the "from" email address. Default: True.
...
def display_from_email_address(self, value):
    ...
```
