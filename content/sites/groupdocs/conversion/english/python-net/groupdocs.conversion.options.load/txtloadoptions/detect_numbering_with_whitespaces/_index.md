...
description: "The property specifies how numbered list items are recognized when a plain text document is converted."
type: docs
...
The property specifies how numbered list items are recognized when a plain text document is converted. The default value is True.
