...
description: 
type: docs
url: /conversion/python-net/groupdocs.conversion.options.load/spreadsheetloadoptions/ignore_formula_calculation_errors/
is_root: false
weight: 2150
---
...
```python
@property
def ignore_formula_calculation_errors(self):
    ...
@ignore_formula_calculation_errors.setter
def ignore_formula_calculation_errors(self, value):
    ...
```
