...
description: 
type: docs
url: /conversion/python-net/groupdocs.conversion.options.load/spreadsheetloadoptions/whitelisted_resources/
is_root: false
weight: 2330
---
...
The whitelisted resources for loading, implementing `IResourceLoadingOptions.whitelisted_resources`.
