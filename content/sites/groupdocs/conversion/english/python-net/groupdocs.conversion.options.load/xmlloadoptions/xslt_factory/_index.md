---
title: xslt_factory property
second_title: GroupDocs.Conversion for Python via .NET API References
description: 
type: docs
url: /conversion/python-net/groupdocs.conversion.options.load/xmlloadoptions/xslt_factory/
is_root: false
weight: 2040
---
...
```python
@property
def xslt_factory(self):
    ...
@xslt_factory.setter
def xslt_factory(self, value):
    ...
```
