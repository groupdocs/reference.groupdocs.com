...
description: पृष्ठ ववरण भष फ़इल प्रकर में रूपंतरण के लए वकल्प
type: docs
weight: 1700
url: /hi/net/groupdocs.conversion.options.convert/pagedescriptionlanguageconvertoptions/
---
## PageDescriptionLanguageConvertOptions class

पृष्ठ विवरण भाषा फ़ाइल प्रकार में रूपांतरण के लिए विकल्प।
...
| नाम | विवरण |
| --- | --- |
| [PageDescriptionLanguageConvertOptions](pagedescriptionlanguageconvertoptions)() | का नया उदाहरण शुरू करता है[`PageDescriptionLanguageFileType`](../../groupdocs.conversion.filetypes/pagedescriptionlanguagefiletype) वर्ग. |
