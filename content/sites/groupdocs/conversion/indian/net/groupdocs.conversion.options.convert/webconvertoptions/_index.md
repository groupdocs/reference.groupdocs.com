...
description: वेब फ़इल प्रकर में रूपंतरण के लए वकल्प.
type: docs
weight: 1980
url: /hi/net/groupdocs.conversion.options.convert/webconvertoptions/
---
## WebConvertOptions class

वेब फ़ाइल प्रकार में रूपांतरण के लिए विकल्प.
...
| नाम | विवरण |
| --- | --- |
| [WebConvertOptions](webconvertoptions)() | का नया उदाहरण शुरू करता है[`WebConvertOptions`](../webconvertoptions) वर्ग. |

## गुण

| नाम | विवरण |
| --- | --- |
| [FixedLayout](../../groupdocs.conversion.options.convert/webconvertoptions/fixedlayout) { get; set; } | अगर`सत्य` निश्चित लेआउट का उपयोग किया जाएगा उदाहरण के लिए पूरी तरह से तैनात एचटीएमएल तत्व डिफ़ॉल्ट: true |
| [FixedLayoutShowBorders](../../groupdocs.conversion.options.convert/webconvertoptions/fixedlayoutshowborders) { get; set; } | निश्चित लेआउट में कनवर्ट करते समय पेज बॉर्डर दिखाएं। डिफ़ॉल्ट True. है |
...
| [UsePdf](../../groupdocs.conversion.options.convert/webconvertoptions/usepdf) { get; set; } | अगर`सत्य` , इनपुट पहले पीडीएफ में और उसके बाद वांछित प्रारूप में परिवर्तित हो जाता है |
| [Watermark](../../groupdocs.conversion.options.convert/commonconvertoptions-1/watermark) { get; set; } | वॉटरमार्क विशिष्ट विकल्प |
| [Zoom](../../groupdocs.conversion.options.convert/webconvertoptions/zoom) { get; set; } | ज़ूम स्तर को प्रतिशत में निर्दिष्ट करता है। डिफ़ॉल्ट 100. है |
