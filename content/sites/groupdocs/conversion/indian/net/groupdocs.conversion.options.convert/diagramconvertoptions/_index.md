...
description: आरेख फ़इल प्रकर में रूपंतरण के लए वकल्प
type: docs
weight: 1490
url: /hi/net/groupdocs.conversion.options.convert/diagramconvertoptions/
---
## DiagramConvertOptions class

आरेख फ़ाइल प्रकार में रूपांतरण के लिए विकल्प।
...
| नाम | विवरण |
| --- | --- |
| [DiagramConvertOptions](diagramconvertoptions)() | का नया उदाहरण शुरू करता है[`DiagramConvertOptions`](../diagramconvertoptions) वर्ग. |

## गुण

| नाम | विवरण |
| --- | --- |
| [AutoFitPageToDrawingContent](../../groupdocs.conversion.options.convert/diagramconvertoptions/autofitpagetodrawingcontent) { get; set; } | परिभाषित करता है कि ड्राइंग सामग्री को फिट करने के लिए पृष्ठ को बड़ा करने की आवश्यकता है या नहीं |
