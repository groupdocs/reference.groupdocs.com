...
description: कैड प्रकर में रूपंतरण के लए वकल्प
type: docs
weight: 1430
url: /hi/net/groupdocs.conversion.options.convert/cadconvertoptions/
---
## CadConvertOptions class

कैड प्रकार में रूपांतरण के लिए विकल्प।
...
| नाम | विवरण |
| --- | --- |
| [CadConvertOptions](cadconvertoptions)() | का नया उदाहरण शुरू करता है[`CadConvertOptions`](../cadconvertoptions) वर्ग. |
...
| [PageNumber](../../groupdocs.conversion.options.convert/cadconvertoptions/pagenumber) { get; set; } | रूपांतरण शुरू करने के लिए पृष्ठ संख्या. |
| [PagesCount](../../groupdocs.conversion.options.convert/cadconvertoptions/pagescount) { get; set; } | से शुरू करने के लिए पृष्ठों की संख्या`पृष्ठ संख्या` . |
