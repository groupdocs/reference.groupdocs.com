...
description: ऑडय प्रकर में रूपंतरण के लए वकल्प.
type: docs
weight: 1420
url: /hi/net/groupdocs.conversion.options.convert/audioconvertoptions/
---
## AudioConvertOptions class

ऑडियो प्रकार में रूपांतरण के लिए विकल्प.
...
| नाम | विवरण |
| --- | --- |
| [AudioConvertOptions](audioconvertoptions)() | का नया उदाहरण शुरू करता है[`AudioConvertOptions`](../audioconvertoptions) वर्ग. |
