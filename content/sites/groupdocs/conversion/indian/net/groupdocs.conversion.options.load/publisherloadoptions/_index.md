...
description: प्रकशक दस्तवेज़ लड करने के वकल्प.
type: docs
weight: 2250
url: /hi/net/groupdocs.conversion.options.load/publisherloadoptions/
---
## PublisherLoadOptions class

प्रकाशक दस्तावेज़ लोड करने के विकल्प.
...
| नाम | विवरण |
| --- | --- |
| [PublisherLoadOptions](publisherloadoptions)() | का नया उदाहरण शुरू करता है[`PublisherLoadOptions`](../publisherloadoptions) वर्ग. |

## गुण

| नाम | विवरण |
| --- | --- |
| [Format](../../groupdocs.conversion.options.load/publisherloadoptions/format) { get; set; } | इनपुट दस्तावेज़ फ़ाइल प्रकार. |
