...
description: ईबुक दस्तवेज़ लड करने के वकल्प
type: docs
weight: 2090
url: /hi/net/groupdocs.conversion.options.load/ebookloadoptions/
---
## EBookLoadOptions class

ईबुक दस्तावेज़ लोड करने के विकल्प।
...
| नाम | विवरण |
| --- | --- |
| [EBookLoadOptions](ebookloadoptions)() | का नया उदाहरण शुरू करता है[`EBookLoadOptions`](../ebookloadoptions) वर्ग. |

## गुण

| नाम | विवरण |
| --- | --- |
| [Format](../../groupdocs.conversion.options.load/ebookloadoptions/format) { get; set; } | इनपुट दस्तावेज़ फ़ाइल प्रकार. |
