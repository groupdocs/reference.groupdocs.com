...
description: Tsv दस्तवेज़ लड करने के लए वकल्प.
type: docs
weight: 2280
url: /hi/net/groupdocs.conversion.options.load/tsvloadoptions/
---
...
| नाम | विवरण |
| --- | --- |
| [TsvLoadOptions](tsvloadoptions)() | का नया उदाहरण शुरू करता है[`TsvLoadOptions`](../tsvloadoptions) वर्ग. |
