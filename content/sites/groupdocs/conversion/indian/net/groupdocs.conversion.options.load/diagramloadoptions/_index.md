...
description: आरेख दस्तवेज़ लड करने के लए वकल्प.
type: docs
weight: 2080
url: /hi/net/groupdocs.conversion.options.load/diagramloadoptions/
---
## DiagramLoadOptions class

आरेख दस्तावेज़ लोड करने के लिए विकल्प.
...
| नाम | विवरण |
| --- | --- |
| [DiagramLoadOptions](diagramloadoptions)() | का नया उदाहरण शुरू करता है[`DiagramLoadOptions`](../diagramloadoptions) वर्ग. |

## गुण

| नाम | विवरण |
| --- | --- |
| [DefaultFont](../../groupdocs.conversion.options.load/diagramloadoptions/defaultfont) { get; set; } | आरेख दस्तावेज़ के लिए डिफ़ॉल्ट फ़ॉन्ट। यदि कोई फ़ॉन्ट अनुपलब्ध है तो निम्न फ़ॉन्ट का उपयोग किया जाएगा. |
| [Format](../../groupdocs.conversion.options.load/diagramloadoptions/format) { get; set; } | इनपुट दस्तावेज़ फ़ाइल प्रकार. |
