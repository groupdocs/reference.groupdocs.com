...
description: Параметры загрузки документов базы данных.
type: docs
weight: 2070
url: /ru/net/groupdocs.conversion.options.load/databaseloadoptions/
---
## DatabaseLoadOptions class

Параметры загрузки документов базы данных.
...
| Имя | Описание |
| --- | --- |
| [DatabaseLoadOptions](databaseloadoptions)() | Инициализирует новый экземпляр[`DataLoadOptions`](../dataloadoptions) класс. |

## Характеристики

| Имя | Описание |
| --- | --- |
| [Format](../../groupdocs.conversion.options.load/databaseloadoptions/format) { get; set; } | Тип файла входного документа. |
