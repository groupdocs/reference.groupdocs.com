...
Параметры загрузки электронных таблиц.
...
| Имя | Описание |
| --- | --- |
| [SpreadsheetLoadOptions](spreadsheetloadoptions)() | Инициализирует новый экземпляр[`SpreadsheetLoadOptions`](../spreadsheetloadoptions) класс. |
