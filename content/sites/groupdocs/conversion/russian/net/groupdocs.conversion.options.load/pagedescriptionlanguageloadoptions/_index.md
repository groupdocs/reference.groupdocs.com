...
description: Параметры загрузки документов на языке описания страниц.
type: docs
weight: 2210
url: /ru/net/groupdocs.conversion.options.load/pagedescriptionlanguageloadoptions/
---
## PageDescriptionLanguageLoadOptions class

Параметры загрузки документов на языке описания страниц.
...
| Имя | Описание |
| --- | --- |
| [PageDescriptionLanguageLoadOptions](pagedescriptionlanguageloadoptions)() | Инициализирует новый экземпляр[`PageDescriptionLanguageLoadOptions`](../pagedescriptionlanguageloadoptions) класс. |

## Характеристики

| Имя | Описание |
| --- | --- |
| [Format](../../groupdocs.conversion.options.load/pagedescriptionlanguageloadoptions/format) { get; set; } | Тип файла входного документа. |
