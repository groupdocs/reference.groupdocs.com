...
description: Опции для загрузки вебдокументов.
type: docs
weight: 2340
...
Опции для загрузки веб-документов.
...
| Имя | Описание |
| --- | --- |
| [WebLoadOptions](webloadoptions)() | Инициализирует новый экземпляр[`WebLoadOptions`](../webloadoptions) класс. |
