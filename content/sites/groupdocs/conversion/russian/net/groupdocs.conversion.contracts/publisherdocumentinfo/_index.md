...
description: Содержит метаданные документа издателя
type: docs
weight: 450
url: /ru/net/groupdocs.conversion.contracts/publisherdocumentinfo/
---
## PublisherDocumentInfo class

Содержит метаданные документа издателя
