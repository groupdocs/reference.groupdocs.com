...
description: Содержит метаданные документа диаграммы
type: docs
weight: 150
url: /ru/net/groupdocs.conversion.contracts/diagramdocumentinfo/
---
## DiagramDocumentInfo class

Содержит метаданные документа диаграммы
