...
description: Параметры преобразования в тип файла языка описания страниц.
type: docs
weight: 1700
...
Параметры преобразования в тип файла языка описания страниц.
...
| Имя | Описание |
| --- | --- |
| [PageDescriptionLanguageConvertOptions](pagedescriptionlanguageconvertoptions)() | Инициализирует новый экземпляр[`PageDescriptionLanguageFileType`](../../groupdocs.conversion.filetypes/pagedescriptionlanguagefiletype) класс. |
