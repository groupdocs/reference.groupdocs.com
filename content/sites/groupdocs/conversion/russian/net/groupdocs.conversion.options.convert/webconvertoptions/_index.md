...
description: Параметры для преобразования в тип вебфайла.
type: docs
weight: 1980
...
Параметры для преобразования в тип веб-файла.
...
| Имя | Описание |
| --- | --- |
| [WebConvertOptions](webconvertoptions)() | Инициализирует новый экземпляр[`WebConvertOptions`](../webconvertoptions) класс. |
