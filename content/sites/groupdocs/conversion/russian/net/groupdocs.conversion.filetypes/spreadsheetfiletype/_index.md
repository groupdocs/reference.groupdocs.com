...
| static readonly [Fods](../../groupdocs.conversion.filetypes/spreadsheetfiletype/fods) | Плоская XML-таблица OpenDocument |
...
| static readonly [Ots](../../groupdocs.conversion.filetypes/spreadsheetfiletype/ots) | Шаблон электронной таблицы OpenDocument |
| static readonly [Sxc](../../groupdocs.conversion.filetypes/spreadsheetfiletype/sxc) | Формат на основе XML, используемый OpenOffice и StarOffice |
...
| static readonly [Xlam](../../groupdocs.conversion.filetypes/spreadsheetfiletype/xlam) | Формат документа Xlam |
