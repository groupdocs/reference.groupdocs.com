...
description: Décrit les modes de retournement dimage.
type: docs
weight: 1640
url: /fr/net/groupdocs.conversion.options.convert/imageflipmodes/
---
## ImageFlipModes class

Décrit les modes de retournement d'image.
...
| Nom | La description |
| --- | --- |
| [ImageFlipModes](imageflipmodes)() | Constructeur de sérialisation |
...
| Nom | La description |
| --- | --- |
| static readonly [FlipX](../../groupdocs.conversion.options.convert/imageflipmodes/flipx) | Retournement horizontal. |
| static readonly [FlipXY](../../groupdocs.conversion.options.convert/imageflipmodes/flipxy) | Retourner horizontalement et verticalement. |
| static readonly [FlipY](../../groupdocs.conversion.options.convert/imageflipmodes/flipy) | Retourner verticalement. |
| static readonly [None](../../groupdocs.conversion.options.convert/imageflipmodes/none) | Pas de retournement. |
