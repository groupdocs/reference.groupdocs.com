...
description: Options de conversion vers le type de fichier de gestion de projet.
type: docs
weight: 1840
url: /fr/net/groupdocs.conversion.options.convert/projectmanagementconvertoptions/
---
## ProjectManagementConvertOptions class

Options de conversion vers le type de fichier de gestion de projet.
...
| Nom | La description |
| --- | --- |
| [ProjectManagementConvertOptions](projectmanagementconvertoptions)() | Initialise la nouvelle instance de[`ProjectManagementConvertOptions`](../projectmanagementconvertoptions) classe. |
