...
description: Options de chargement des documents EBook.
type: docs
weight: 2090
url: /fr/net/groupdocs.conversion.options.load/ebookloadoptions/
---
## EBookLoadOptions class

Options de chargement des documents EBook.
...
| Nom | La description |
| --- | --- |
| [EBookLoadOptions](ebookloadoptions)() | Initialise la nouvelle instance de[`EBookLoadOptions`](../ebookloadoptions) classe. |

## Propriétés

| Nom | La description |
| --- | --- |
| [Format](../../groupdocs.conversion.options.load/ebookloadoptions/format) { get; set; } | Type de fichier du document d'entrée. |
