...
description: 글꼴 문서 로드 옵션.
type: docs
weight: 2140
url: /ko/net/groupdocs.conversion.options.load/fontloadoptions/
---
...
| 이름 | 설명 |
| --- | --- |
| [FontLoadOptions](fontloadoptions)() | 의 새 인스턴스를 초기화합니다.[`FontLoadOptions`](../fontloadoptions) 클래스. |

## 속성

| 이름 | 설명 |
| --- | --- |
| [Format](../../groupdocs.conversion.options.load/fontloadoptions/format) { get; set; } | 입력 문서 파일 유형. |
