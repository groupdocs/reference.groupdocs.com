...
description: Publisher 문서 로드 옵션.
type: docs
weight: 2250
url: /ko/net/groupdocs.conversion.options.load/publisherloadoptions/
---
...
| 이름 | 설명 |
| --- | --- |
| [PublisherLoadOptions](publisherloadoptions)() | 의 새 인스턴스를 초기화합니다.[`PublisherLoadOptions`](../publisherloadoptions) 클래스. |

## 속성

| 이름 | 설명 |
| --- | --- |
| [Format](../../groupdocs.conversion.options.load/publisherloadoptions/format) { get; set; } | 입력 문서 파일 유형. |
