...
description: 재무 문서 로드 옵션.
type: docs
weight: 2130
url: /ko/net/groupdocs.conversion.options.load/financeloadoptions/
---
...
| 이름 | 설명 |
| --- | --- |
| [FinanceLoadOptions](financeloadoptions)() | 의 새 인스턴스를 초기화합니다.[`FinanceLoadOptions`](../financeloadoptions) 클래스. |

## 속성

| 이름 | 설명 |
| --- | --- |
| [Format](../../groupdocs.conversion.options.load/financeloadoptions/format) { get; set; } | 입력 문서 파일 유형. |
