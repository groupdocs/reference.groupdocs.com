...
description: 3D 문서 로드 옵션.
type: docs
weight: 2270
url: /ko/net/groupdocs.conversion.options.load/threedloadoptions/
---
...
| 이름 | 설명 |
| --- | --- |
| [ThreeDLoadOptions](threedloadoptions)() | 의 새 인스턴스를 초기화합니다.[`ThreeDLoadOptions`](../threedloadoptions) 클래스. |

## 속성

| 이름 | 설명 |
| --- | --- |
| [Format](../../groupdocs.conversion.options.load/threedloadoptions/format) { get; set; } | 입력 문서 파일 유형. |
