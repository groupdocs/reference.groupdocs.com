...
description: 이미지 문서 로드 옵션.
type: docs
weight: 2150
url: /ko/net/groupdocs.conversion.options.load/imageloadoptions/
---
...
| 이름 | 설명 |
| --- | --- |
| [DefaultFont](../../groupdocs.conversion.options.load/imageloadoptions/defaultfont) { get; set; } | Psd, Emf, Wmf 문서 유형의 기본 글꼴. 글꼴이 누락된 경우 다음 글꼴이 사용됩니다. |
| [Format](../../groupdocs.conversion.options.load/imageloadoptions/format) { get; set; } | 입력 문서 파일 유형. |
...
| [SetOcrConnector](../../groupdocs.conversion.options.load/imageloadoptions/setocrconnector)(IOcrConnector) | 이미지 OCR 설정 connector |
