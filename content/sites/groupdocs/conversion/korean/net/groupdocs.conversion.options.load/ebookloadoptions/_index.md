...
description: 전자책 문서 로드 옵션.
type: docs
weight: 2090
url: /ko/net/groupdocs.conversion.options.load/ebookloadoptions/
---
...
| 이름 | 설명 |
| --- | --- |
| [EBookLoadOptions](ebookloadoptions)() | 의 새 인스턴스를 초기화합니다.[`EBookLoadOptions`](../ebookloadoptions) 클래스. |

## 속성

| 이름 | 설명 |
| --- | --- |
| [Format](../../groupdocs.conversion.options.load/ebookloadoptions/format) { get; set; } | 입력 문서 파일 유형. |
