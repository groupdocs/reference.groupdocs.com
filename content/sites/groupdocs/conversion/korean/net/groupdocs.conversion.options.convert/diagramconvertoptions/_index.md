...
description: 다이어그램 파일 형식으로 변환하기 위한 옵션.
type: docs
weight: 1490
url: /ko/net/groupdocs.conversion.options.convert/diagramconvertoptions/
---
## DiagramConvertOptions class

다이어그램 파일 형식으로 변환하기 위한 옵션.
...
| 이름 | 설명 |
| --- | --- |
| [DiagramConvertOptions](diagramconvertoptions)() | 의 새 인스턴스를 초기화합니다.[`DiagramConvertOptions`](../diagramconvertoptions) 클래스. |

## 속성

| 이름 | 설명 |
| --- | --- |
| [AutoFitPageToDrawingContent](../../groupdocs.conversion.options.convert/diagramconvertoptions/autofitpagetodrawingcontent) { get; set; } | 도면 내용에 맞게 페이지를 확대해야 하는지 여부를 정의합니다. |
