...
description: 이메일 파일 형식으로 변환하기 위한 옵션입니다.
type: docs
weight: 1510
url: /ko/net/groupdocs.conversion.options.convert/emailconvertoptions/
---
## EmailConvertOptions class

이메일 파일 형식으로 변환하기 위한 옵션입니다.
...
| 이름 | 설명 |
| --- | --- |
| [EmailConvertOptions](emailconvertoptions)() | 의 새 인스턴스를 초기화합니다.[`EmailConvertOptions`](../emailconvertoptions) 클래스. |
