...
description: Opties voor conversie naar Cadtype.
type: docs
weight: 1430
...
| Naam | Beschrijving |
| --- | --- |
| [CadConvertOptions](cadconvertoptions)() | Initialiseert nieuw exemplaar van[`CadConvertOptions`](../cadconvertoptions) klasse. |
...
| [PageNumber](../../groupdocs.conversion.options.convert/cadconvertoptions/pagenumber) { get; set; } | Het paginanummer vanaf waar de conversie moet worden gestart. |
| [PagesCount](../../groupdocs.conversion.options.convert/cadconvertoptions/pagescount) { get; set; } | Aantal pagina's om vanaf te converteren`Paginanummer` . |
