...
description: Opties voor het laden van gegevensdocumenten.
type: docs
weight: 2060
url: /nl/net/groupdocs.conversion.options.load/dataloadoptions/
---
## DataLoadOptions class

Opties voor het laden van gegevensdocumenten.
