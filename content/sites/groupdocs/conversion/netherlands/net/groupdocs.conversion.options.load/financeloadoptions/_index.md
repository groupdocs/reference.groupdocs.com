...
description: Opties voor het laden van financiële documenten.
type: docs
weight: 2130
url: /nl/net/groupdocs.conversion.options.load/financeloadoptions/
---
## FinanceLoadOptions class

Opties voor het laden van financiële documenten.
...
| Naam | Beschrijving |
| --- | --- |
| [FinanceLoadOptions](financeloadoptions)() | Initialiseert nieuw exemplaar van[`FinanceLoadOptions`](../financeloadoptions) klasse. |

## Eigenschappen

| Naam | Beschrijving |
| --- | --- |
| [Format](../../groupdocs.conversion.options.load/financeloadoptions/format) { get; set; } | Type documentbestand invoeren. |
