...
description: Opties voor het laden van Csvdocumenten.
type: docs
weight: 2050
url: /nl/net/groupdocs.conversion.options.load/csvloadoptions/
---
...
| Naam | Beschrijving |
| --- | --- |
| [CsvLoadOptions](csvloadoptions)() | Initialiseert nieuw exemplaar van[`CsvLoadOptions`](../csvloadoptions) klasse. |
...
| [ConvertDateTimeData](../../groupdocs.conversion.options.load/csvloadoptions/convertdatetimedata) { get; set; } | Geeft aan of de string in het bestand is geconverteerd naar datum. Standaard is True. |
| [ConvertNumericData](../../groupdocs.conversion.options.load/csvloadoptions/convertnumericdata) { get; set; } | Geeft aan of de tekenreeks in het bestand wordt geconverteerd naar numeriek. Standaard is True. |
...
| [Encoding](../../groupdocs.conversion.options.load/csvloadoptions/encoding) { get; set; } | Codering. Standaard is Encoding.Default. |
...
| [HasFormula](../../groupdocs.conversion.options.load/csvloadoptions/hasformula) { get; set; } | Geeft aan of tekst een formule is als deze begint met "=". |
| [HideComments](../../groupdocs.conversion.options.load/spreadsheetloadoptions/hidecomments) { get; set; } | Opmerkingen verbergen. |
| [IsMultiEncoded](../../groupdocs.conversion.options.load/csvloadoptions/ismultiencoded) { get; set; } | True betekent dat het bestand meerdere coderingen bevat. |
...
| [Separator](../../groupdocs.conversion.options.load/csvloadoptions/separator) { get; set; } | Scheidingsteken van een csv-bestand. |
