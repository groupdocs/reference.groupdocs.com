...
description: 转换为音频类型的选项
type: docs
weight: 1290
url: /zh/net/groupdocs.conversion.options.convert/audioconvertoptions/
---
...
| 姓名 | 描述 |
| --- | --- |
| [AudioConvertOptions](audioconvertoptions)() | 初始化的新实例[`AudioConvertOptions`](../audioconvertoptions)类. |
