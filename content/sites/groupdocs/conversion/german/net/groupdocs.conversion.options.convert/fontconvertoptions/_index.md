...
description: Optionen für die Konvertierung in Schriftart.
type: docs
weight: 1540
url: /de/net/groupdocs.conversion.options.convert/fontconvertoptions/
---
## FontConvertOptions class

Optionen für die Konvertierung in Schriftart.
...
| Name | Beschreibung |
| --- | --- |
| [FontConvertOptions](fontconvertoptions)() | Initialisiert eine neue Instanz von[`AudioConvertOptions`](../audioconvertoptions) Klasse. |
