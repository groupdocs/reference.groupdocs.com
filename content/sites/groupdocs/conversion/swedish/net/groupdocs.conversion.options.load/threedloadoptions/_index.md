...
Alternativ för att ladda 3D-dokument.
...
| namn | Beskrivning |
| --- | --- |
| [ThreeDLoadOptions](threedloadoptions)() | Initierar ny instans av[`ThreeDLoadOptions`](../threedloadoptions) class. |

## Egenskaper

| namn | Beskrivning |
| --- | --- |
| [Format](../../groupdocs.conversion.options.load/threedloadoptions/format) { get; set; } | Inmatningsdokumentfiltyp. |
