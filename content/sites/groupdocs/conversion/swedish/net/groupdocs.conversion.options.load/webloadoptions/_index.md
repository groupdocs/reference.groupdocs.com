...
description: Alternativ för att ladda webbdokument.
type: docs
weight: 2340
...
Alternativ för att ladda webbdokument.
...
| namn | Beskrivning |
| --- | --- |
| [WebLoadOptions](webloadoptions)() | Initierar ny instans av[`WebLoadOptions`](../webloadoptions) class. |
