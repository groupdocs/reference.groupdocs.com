...
description: Alternativ för att ladda Tsvdokument.
type: docs
weight: 2030
...
Alternativ för att ladda Tsv-dokument.
...
| namn | Beskrivning |
| --- | --- |
| [TsvLoadOptions](tsvloadoptions)() | Initierar ny instans av[`TsvLoadOptions`](../tsvloadoptions) class. |
