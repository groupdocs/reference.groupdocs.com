...
description: Alternativ för att ladda eboksdokument.
type: docs
weight: 2090
url: /sv/net/groupdocs.conversion.options.load/ebookloadoptions/
---
## EBookLoadOptions class

Alternativ för att ladda e-boksdokument.
...
| namn | Beskrivning |
| --- | --- |
| [EBookLoadOptions](ebookloadoptions)() | Initierar ny instans av[`EBookLoadOptions`](../ebookloadoptions) class. |

## Egenskaper

| namn | Beskrivning |
| --- | --- |
| [Format](../../groupdocs.conversion.options.load/ebookloadoptions/format) { get; set; } | Inmatningsdokumentfiltyp. |
