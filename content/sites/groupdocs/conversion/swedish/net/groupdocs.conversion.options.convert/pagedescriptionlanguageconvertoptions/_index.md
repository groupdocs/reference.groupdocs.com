...
description: Alternativ för konvertering till sidbeskrivningar språk filtyp.
type: docs
weight: 1700
url: /sv/net/groupdocs.conversion.options.convert/pagedescriptionlanguageconvertoptions/
---
## PageDescriptionLanguageConvertOptions class

Alternativ för konvertering till sidbeskrivningar språk filtyp.
...
| namn | Beskrivning |
| --- | --- |
| [PageDescriptionLanguageConvertOptions](pagedescriptionlanguageconvertoptions)() | Initierar ny instans av[`PageDescriptionLanguageFileType`](../../groupdocs.conversion.filetypes/pagedescriptionlanguagefiletype) class. |
