...
description: Alternativ för konvertering till webbfiltyp.
type: docs
weight: 1980
...
Alternativ för konvertering till webbfiltyp.
...
| namn | Beskrivning |
| --- | --- |
| [WebConvertOptions](webconvertoptions)() | Initierar ny instans av[`WebConvertOptions`](../webconvertoptions) class. |
