...
Opciones de conversión a tipo de archivo de hoja de cálculo.
...
| Nombre | Descripción |
| --- | --- |
| [SpreadsheetConvertOptions](spreadsheetconvertoptions)() | Inicializa una nueva instancia de[`SpreadsheetConvertOptions`](../spreadsheetconvertoptions) clase. |
...
| [Password](../../groupdocs.conversion.options.convert/spreadsheetconvertoptions/password) { get; set; } | Configure esta propiedad si desea proteger el documento convertido con una contraseña. |
