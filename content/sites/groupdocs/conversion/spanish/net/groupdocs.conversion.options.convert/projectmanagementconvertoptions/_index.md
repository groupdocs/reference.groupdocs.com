...
description: Opciones de conversión a tipo de archivo de gestión de proyectos.
type: docs
weight: 1840
url: /es/net/groupdocs.conversion.options.convert/projectmanagementconvertoptions/
---
## ProjectManagementConvertOptions class

Opciones de conversión a tipo de archivo de gestión de proyectos.
...
| Nombre | Descripción |
| --- | --- |
| [ProjectManagementConvertOptions](projectmanagementconvertoptions)() | Inicializa una nueva instancia de[`ProjectManagementConvertOptions`](../projectmanagementconvertoptions) clase. |
