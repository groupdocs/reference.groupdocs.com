...
| Nombre | Descripción |
| --- | --- |
| [CompressionLoadOptions](compressionloadoptions)() | Inicializa una nueva instancia de[`CompressionLoadOptions`](../compressionloadoptions) clase. |

## Propiedades

| Nombre | Descripción |
| --- | --- |
| [ConvertOwned](../../groupdocs.conversion.options.load/compressionloadoptions/convertowned) { get; } | Opción para controlar si los documentos propios en el contenedor de documentos deben convertirse |
| [ConvertOwner](../../groupdocs.conversion.options.load/compressionloadoptions/convertowner) { get; } | Opción para controlar si el contenedor de documentos debe convertirse en sí mismo Si esta propiedad es verdadera, el contenedor de documentos será el primer documento convertido |
| [Depth](../../groupdocs.conversion.options.load/compressionloadoptions/depth) { get; set; } | Opción para controlar cuántos niveles de profundidad realizar la conversión |
| [Format](../../groupdocs.conversion.options.load/loadoptions/format) { get; } | Tipo de archivo de documento de entrada. |
| [Password](../../groupdocs.conversion.options.load/compressionloadoptions/password) { get; set; } | Establecer contraseña para cargar documento protegido. |
