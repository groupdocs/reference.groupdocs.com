...
| Nombre | Descripción |
| --- | --- |
| [NsfLoadOptions](nsfloadoptions)() | Inicializa una nueva instancia de[`NsfLoadOptions`](../nsfloadoptions) clase. |

## Propiedades

| Nombre | Descripción |
| --- | --- |
| [ConvertOwned](../../groupdocs.conversion.options.load/nsfloadoptions/convertowned) { get; } | Opción para controlar si los documentos propios en el contenedor de documentos deben convertirse |
| [ConvertOwner](../../groupdocs.conversion.options.load/nsfloadoptions/convertowner) { get; } | Opción para controlar si el contenedor de documentos debe convertirse en sí mismo Si esta propiedad es verdadera, el contenedor de documentos será el primer documento convertido |
| [Depth](../../groupdocs.conversion.options.load/nsfloadoptions/depth) { get; set; } | Opción para controlar cuántos niveles de profundidad realizar la conversión |
