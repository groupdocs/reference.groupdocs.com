...
description: Ad alanı üyelerin çıktı belgesini başlatmasını ve serbest bırakmasını yazı tipi değişikliklerini yönetmesini vb. sağlar.
type: docs
weight: 30
url: /tr/net/groupdocs.conversion.contracts/
---
...
| [MarkupDocumentInfo](./markupdocumentinfo) | İşaretleme belgesi meta verilerini içerir |
| [NoteDocumentInfo](./notedocumentinfo) | Not belgesi meta verilerini içerir |
| [PasswordProtectedDocumentInfo](./passwordprotecteddocumentinfo) | Sağlanan belge parola korumalıdır |
...
| [SpreadsheetDocumentInfo](./spreadsheetdocumentinfo) | Elektronik Tablo belgesi meta verilerini içerir |
| [SvgDocumentInfo](./svgdocumentinfo) | Svg belgesi meta verilerini içerir |
| [TableOfContentsItem](./tableofcontentsitem) | İçerir İçindekiler öğesi metadata |
| [TarDocumentInfo](./tardocumentinfo) | Tar belgesi meta verilerini içerir |
| [TargetConversion](./targetconversion) | Olası hedef dönüştürmeyi temsil eder ve birincil mi yoksa ikincil mi bir bayraktır |
| [TexDocumentInfo](./texdocumentinfo) | Tex belgesi meta verilerini içerir |
| [ThreeDDocumentInfo](./threeddocumentinfo) | 3B belge meta verilerini içerir |
| [TsvDocumentInfo](./tsvdocumentinfo) | Tsv belgesi meta verilerini içerir |
| [TxtDocumentInfo](./txtdocumentinfo) | Metin belgesi meta verilerini içerir |
...
| [XzDocumentInfo](./xzdocumentinfo) | Xz belgesi meta verilerini içerir |
| [ZDocumentInfo](./zdocumentinfo) | Z belgesi meta verilerini içerir |
| [ZipDocumentInfo](./zipdocumentinfo) | Metadata sıkıştırma belgesini içerir |
## Arayüzler

| Arayüz | Tanım |
| --- | --- |
| [IDocumentInfo](./idocumentinfo) | Bir belge için meta veri içerir. |
| [IDocumentsContainerLoadOptions](./idocumentscontainerloadoptions) | Belgeler için yükleme seçenekleri container |
