...
description: Tsv belgelerini yüklemek için seçenekler.
type: docs
weight: 2280
url: /tr/net/groupdocs.conversion.options.load/tsvloadoptions/
---
## TsvLoadOptions class

Tsv belgelerini yüklemek için seçenekler.
...
| İsim | Tanım |
| --- | --- |
| [TsvLoadOptions](tsvloadoptions)() | Yeni örneğini başlatır[`TsvLoadOptions`](../tsvloadoptions) sınıf. |
