...
description: Web belgelerini yüklemek için seçenekler.
type: docs
weight: 2340
...
Web belgelerini yüklemek için seçenekler.
...
| İsim | Tanım |
| --- | --- |
| [WebLoadOptions](webloadoptions)() | Yeni örneğini başlatır[`WebLoadOptions`](../webloadoptions) sınıf. |
