...
Video belgelerini yüklemek için seçenekler.
...
| İsim | Tanım |
| --- | --- |
| [VideoLoadOptions](videoloadoptions)() | Yeni örneğini başlatır[`VideoLoadOptions`](../videoloadoptions) sınıf. |

## Özellikleri

| İsim | Tanım |
| --- | --- |
| [Format](../../groupdocs.conversion.options.load/videoloadoptions/format) { get; set; } | Girdi belgesi dosya türü. |
...
| [SetVideoConnector](../../groupdocs.conversion.options.load/videoloadoptions/setvideoconnector)(IVideoConnector) | Video belge bağlayıcısını ayarla |
