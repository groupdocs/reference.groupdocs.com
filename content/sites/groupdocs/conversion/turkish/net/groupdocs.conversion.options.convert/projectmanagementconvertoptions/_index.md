...
description: Proje yönetimi dosya türüne dönüştürme seçenekleri.
type: docs
weight: 1660
url: /tr/net/groupdocs.conversion.options.convert/projectmanagementconvertoptions/
---
## ProjectManagementConvertOptions class

Proje yönetimi dosya türüne dönüştürme seçenekleri.
...
| İsim | Tanım |
| --- | --- |
| [ProjectManagementConvertOptions](projectmanagementconvertoptions)() | Yeni örneğini başlatır[`ProjectManagementConvertOptions`](../projectmanagementconvertoptions) sınıf. |
