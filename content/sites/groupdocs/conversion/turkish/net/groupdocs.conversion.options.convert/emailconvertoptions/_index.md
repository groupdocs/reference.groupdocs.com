...
E-posta dosya türüne dönüştürme seçenekleri.
...
| İsim | Tanım |
| --- | --- |
| [EmailConvertOptions](emailconvertoptions)() | Yeni örneğini başlatır[`EmailConvertOptions`](../emailconvertoptions) sınıf. |
