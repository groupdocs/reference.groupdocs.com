...
description: 財務ドキュメントをロードするためのオプション.
type: docs
weight: 2130
url: /ja/net/groupdocs.conversion.options.load/financeloadoptions/
---
## FinanceLoadOptions class

財務ドキュメントをロードするためのオプション.
...
| 名前 | 説明 |
| --- | --- |
| [FinanceLoadOptions](financeloadoptions)() | の新しいインスタンスを初期化します[`FinanceLoadOptions`](../financeloadoptions)class. |

## プロパティ

| 名前 | 説明 |
| --- | --- |
| [Format](../../groupdocs.conversion.options.load/financeloadoptions/format) { get; set; } | 入力ドキュメントのファイル形式. |
