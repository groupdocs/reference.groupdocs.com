...
description: ダイアグラム ファイル タイプへの変換オプション
type: docs
weight: 1490
...
| 名前 | 説明 |
| --- | --- |
| [DiagramConvertOptions](diagramconvertoptions)() | の新しいインスタンスを初期化します[`DiagramConvertOptions`](../diagramconvertoptions)class. |

## プロパティ

| 名前 | 説明 |
| --- | --- |
| [AutoFitPageToDrawingContent](../../groupdocs.conversion.options.convert/diagramconvertoptions/autofitpagetodrawingcontent) { get; set; } | 描画コンテンツに合わせてページを拡大する必要があるかどうかを定義します |
