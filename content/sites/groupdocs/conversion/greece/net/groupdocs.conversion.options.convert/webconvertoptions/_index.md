...
description: Επιλογές για μετατροπή σε τύπο αρχείου Ιστού.
type: docs
weight: 1980
...
Επιλογές για μετατροπή σε τύπο αρχείου Ιστού.
...
| Ονομα | Περιγραφή |
| --- | --- |
| [WebConvertOptions](webconvertoptions)() | Αρχικοποιεί νέα παρουσία του[`WebConvertOptions`](../webconvertoptions) τάξη. |
