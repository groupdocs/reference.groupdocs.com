...
description: Επιλογές για μετατροπή σε τύπο αρχείου δεδομένων.
type: docs
weight: 1480
url: /el/net/groupdocs.conversion.options.convert/dataconvertoptions/
---
## DataConvertOptions class

Επιλογές για μετατροπή σε τύπο αρχείου δεδομένων.
