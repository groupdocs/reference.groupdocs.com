...
description: Επιλογές για μετατροπή σε τύπο αρχείου υπολογιστικού φύλλου.
type: docs
weight: 1900
...
Επιλογές για μετατροπή σε τύπο αρχείου υπολογιστικού φύλλου.
...
| Ονομα | Περιγραφή |
| --- | --- |
| [SpreadsheetConvertOptions](spreadsheetconvertoptions)() | Αρχικοποιεί νέα παρουσία του[`SpreadsheetConvertOptions`](../spreadsheetconvertoptions) τάξη. |
...
| [Password](../../groupdocs.conversion.options.convert/spreadsheetconvertoptions/password) { get; set; } | Ορίστε αυτήν την ιδιότητα εάν θέλετε να προστατεύσετε το έγγραφο που έχει μετατραπεί με κωδικό πρόσβασης. |
