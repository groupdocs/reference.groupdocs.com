...
description: Επιλογές για μετατροπή σε τύπο αρχείου διαχείρισης έργου.
type: docs
weight: 1840
url: /el/net/groupdocs.conversion.options.convert/projectmanagementconvertoptions/
---
## ProjectManagementConvertOptions class

Επιλογές για μετατροπή σε τύπο αρχείου διαχείρισης έργου.
...
| Ονομα | Περιγραφή |
| --- | --- |
| [ProjectManagementConvertOptions](projectmanagementconvertoptions)() | Αρχικοποιεί νέα παρουσία του[`ProjectManagementConvertOptions`](../projectmanagementconvertoptions) τάξη. |
