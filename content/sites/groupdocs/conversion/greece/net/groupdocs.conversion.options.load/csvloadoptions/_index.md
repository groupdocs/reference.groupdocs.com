...
description: Επιλογές για τη φόρτωση εγγράφων Csv.
type: docs
weight: 2050
url: /el/net/groupdocs.conversion.options.load/csvloadoptions/
---
## CsvLoadOptions class

Επιλογές για τη φόρτωση εγγράφων Csv.
...
| Ονομα | Περιγραφή |
| --- | --- |
| [CsvLoadOptions](csvloadoptions)() | Αρχικοποιεί νέα παρουσία του[`CsvLoadOptions`](../csvloadoptions) τάξη. |
...
| [ConvertDateTimeData](../../groupdocs.conversion.options.load/csvloadoptions/convertdatetimedata) { get; set; } | Υποδεικνύει εάν η συμβολοσειρά στο αρχείο έχει μετατραπεί σε ημερομηνία. Η προεπιλογή είναι True. |
| [ConvertNumericData](../../groupdocs.conversion.options.load/csvloadoptions/convertnumericdata) { get; set; } | Υποδεικνύει εάν η συμβολοσειρά στο αρχείο έχει μετατραπεί σε αριθμητική. Η προεπιλογή είναι True. |
...
| [Encoding](../../groupdocs.conversion.options.load/csvloadoptions/encoding) { get; set; } | Κωδικοποίηση. Η προεπιλογή είναι Encoding.Default. |
...
| [HasFormula](../../groupdocs.conversion.options.load/csvloadoptions/hasformula) { get; set; } | Υποδεικνύει εάν το κείμενο είναι τύπος εάν ξεκινά με "=". |
| [HideComments](../../groupdocs.conversion.options.load/spreadsheetloadoptions/hidecomments) { get; set; } | Απόκρυψη σχολίων. |
| [IsMultiEncoded](../../groupdocs.conversion.options.load/csvloadoptions/ismultiencoded) { get; set; } | True σημαίνει ότι το αρχείο περιέχει πολλές κωδικοποιήσεις. |
...
| [Separator](../../groupdocs.conversion.options.load/csvloadoptions/separator) { get; set; } | Οριοθέτης ενός αρχείου Csv. |
