...
description: Επιλογές για τη φόρτωση εγγράφων EBook.
type: docs
weight: 2090
url: /el/net/groupdocs.conversion.options.load/ebookloadoptions/
---
## EBookLoadOptions class

Επιλογές για τη φόρτωση εγγράφων EBook.
...
| Ονομα | Περιγραφή |
| --- | --- |
| [EBookLoadOptions](ebookloadoptions)() | Αρχικοποιεί νέα παρουσία του[`EBookLoadOptions`](../ebookloadoptions) τάξη. |

## Ιδιότητες

| Ονομα | Περιγραφή |
| --- | --- |
| [Format](../../groupdocs.conversion.options.load/ebookloadoptions/format) { get; set; } | Τύπος αρχείου εγγράφου εισαγωγής. |
