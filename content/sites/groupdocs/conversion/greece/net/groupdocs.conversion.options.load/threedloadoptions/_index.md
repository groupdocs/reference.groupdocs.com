...
description: Επιλογές για τη φόρτωση εγγράφων 3D.
type: docs
weight: 2270
url: /el/net/groupdocs.conversion.options.load/threedloadoptions/
---
## ThreeDLoadOptions class

Επιλογές για τη φόρτωση εγγράφων 3D.
...
| Ονομα | Περιγραφή |
| --- | --- |
| [ThreeDLoadOptions](threedloadoptions)() | Αρχικοποιεί νέα παρουσία του[`ThreeDLoadOptions`](../threedloadoptions) τάξη. |

## Ιδιότητες

| Ονομα | Περιγραφή |
| --- | --- |
| [Format](../../groupdocs.conversion.options.load/threedloadoptions/format) { get; set; } | Τύπος αρχείου εγγράφου εισαγωγής. |
