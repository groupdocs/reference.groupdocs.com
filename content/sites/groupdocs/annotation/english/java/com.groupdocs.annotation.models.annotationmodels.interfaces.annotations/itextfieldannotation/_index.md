...
```
public interface ITextFieldAnnotation extends IBackgroundColor, IBox, IText, ITextHAlignment, IFontColor, IFontFamily, IFontSize, IOpacity, IPenColor, IPenStyle, IPenWidth
```
