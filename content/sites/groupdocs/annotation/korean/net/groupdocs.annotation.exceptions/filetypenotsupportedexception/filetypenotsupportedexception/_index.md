...
description: 의 새 인스턴스를 초기화합니다.FileTypeNotSupportedExceptiongroupdocs.annotation.exceptions/filetypenotsupportedexception 수업.
type: docs
weight: 10
url: /ko/net/groupdocs.annotation.exceptions/filetypenotsupportedexception/filetypenotsupportedexception/
---
## FileTypeNotSupportedException(string) {#constructor}

의 새 인스턴스를 초기화합니다.[`FileTypeNotSupportedException`](../../filetypenotsupportedexception) 수업.
...
* 네임스페이스 [GroupDocs.Annotation.Exceptions](../../filetypenotsupportedexception)
