...
description: 하이라이트 주석 속성을 나타냅니다
type: docs
weight: 240
url: /ko/net/groupdocs.annotation.models.annotationmodels/highlightannotation/
---
...
| 이름 | 설명 |
| --- | --- |
| [HighlightAnnotation](highlightannotation)() | 의 새 인스턴스를 초기화합니다.[`HighlightAnnotation`](../highlightannotation) 클래스. |

## 속성

| 이름 | 설명 |
| --- | --- |
| [BackgroundColor](../../groupdocs.annotation.models.annotationmodels/highlightannotation/backgroundcolor) { get; set; } | 주석 배경 color 를 가져오거나 설정합니다. |
| [CreatedOn](../../groupdocs.annotation.models.annotationmodels/annotationbase/createdon) { get; set; } | 주석 생성 날짜 를 가져오거나 설정합니다. |
| [FontColor](../../groupdocs.annotation.models.annotationmodels/highlightannotation/fontcolor) { get; set; } | 주석 텍스트 글꼴 color 를 가져오거나 설정합니다. |
...
| [Opacity](../../groupdocs.annotation.models.annotationmodels/highlightannotation/opacity) { get; set; } | 주석 opacity 를 가져오거나 설정합니다. |
...
| [Points](../../groupdocs.annotation.models.annotationmodels/highlightannotation/points) { get; set; } | text 로 사각형을 설명하는 점 모음을 가져오거나 설정합니다. |
...
| 이름 | 설명 |
| --- | --- |
| override [Clone](../../groupdocs.annotation.models.annotationmodels/highlightannotation/clone)() | 동일한 values 를 가진 새 인스턴스를 반환합니다. |
...
| [Equals](../../groupdocs.annotation.models.annotationmodels/highlightannotation/equals#equals_1)(HighlightAnnotation) | IEquatable Equals method 를 사용하여 하이라이트 주석을 비교합니다. |
| override [Equals](../../groupdocs.annotation.models.annotationmodels/highlightannotation/equals#equals_2)(object) | 표준 개체 Equals method 를 사용하여 하이라이트 주석을 비교합니다. |
| override [GetHashCode](../../groupdocs.annotation.models.annotationmodels/highlightannotation/gethashcode)() | Highlight Annotation 의 해시 코드를 반환합니다. |
...
* 다양한 유형의 문서에 하이라이트 주석을 추가하는 방법에 대해 자세히 알아보기: [C#에서 하이라이트 주석을 추가하는 방법](https://docs.groupdocs.com/display/annotationnet/Add+highlight+annotation)
