...
description: 취소선 주석 properties 를 나타냅니다.
type: docs
weight: 700
url: /ko/net/groupdocs.annotation.models.annotationmodels/strikeoutannotation/
---
...
| 이름 | 설명 |
| --- | --- |
| [StrikeoutAnnotation](strikeoutannotation)() | 의 새 인스턴스를 초기화합니다.[`StrikeoutAnnotation`](../strikeoutannotation) 클래스. |

## 속성

| 이름 | 설명 |
| --- | --- |
| [BackgroundColor](../../groupdocs.annotation.models.annotationmodels/strikeoutannotation/backgroundcolor) { get; set; } | 주석 텍스트 배경 color 를 가져오거나 설정합니다. |
| [CreatedOn](../../groupdocs.annotation.models.annotationmodels/annotationbase/createdon) { get; set; } | 주석 생성 날짜 를 가져오거나 설정합니다. |
| [FontColor](../../groupdocs.annotation.models.annotationmodels/strikeoutannotation/fontcolor) { get; set; } | 주석 텍스트 글꼴 color 를 가져오거나 설정합니다. |
...
| [Opacity](../../groupdocs.annotation.models.annotationmodels/strikeoutannotation/opacity) { get; set; } | 주석 opacity 를 가져오거나 설정합니다. |
...
| [Points](../../groupdocs.annotation.models.annotationmodels/strikeoutannotation/points) { get; set; } | text 로 사각형을 설명하는 점 모음을 가져오거나 설정합니다. |
...
| 이름 | 설명 |
| --- | --- |
| override [Clone](../../groupdocs.annotation.models.annotationmodels/strikeoutannotation/clone)() | 동일한 values 를 가진 새 인스턴스를 반환합니다. |
...
| override [Equals](../../groupdocs.annotation.models.annotationmodels/strikeoutannotation/equals#equals_2)(object) | 표준 개체 Equals method 를 사용하여 취소선 주석을 비교합니다. |
| [Equals](../../groupdocs.annotation.models.annotationmodels/strikeoutannotation/equals#equals_1)(StrikeoutAnnotation) | IEquatable Equals method 를 사용하여 취소선 주석을 비교합니다. |
| override [GetHashCode](../../groupdocs.annotation.models.annotationmodels/strikeoutannotation/gethashcode)() | 취소선 Annotation 의 해시 코드를 반환합니다. |
...
* 다양한 유형의 문서에 취소선 주석 추가에 대한 추가 정보: [C#에서 취소선 주석을 추가하는 방법](https://docs.groupdocs.com/display/annotationnet/Add+strikeout+annotation)
