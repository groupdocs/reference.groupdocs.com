...
description: 포인트 주석 properties 를 나타냅니다.
type: docs
weight: 640
url: /ko/net/groupdocs.annotation.models.annotationmodels/pointannotation/
---
## PointAnnotation class

포인트 주석 properties 를 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [PointAnnotation](pointannotation)() | 의 새 인스턴스를 초기화합니다.[`PointAnnotation`](../pointannotation) 클래스. |

## 속성

| 이름 | 설명 |
| --- | --- |
| [Box](../../groupdocs.annotation.models.annotationmodels/pointannotation/box) { get; set; } | 주석 position 를 가져오거나 설정합니다. |
...
| 이름 | 설명 |
| --- | --- |
| override [Clone](../../groupdocs.annotation.models.annotationmodels/pointannotation/clone)() | 동일한 values 를 가진 새 인스턴스를 반환합니다. |
...
| override [Equals](../../groupdocs.annotation.models.annotationmodels/pointannotation/equals#equals_2)(object) | 표준 개체 Equals method 를 사용하여 포인트 주석을 비교합니다. |
| [Equals](../../groupdocs.annotation.models.annotationmodels/pointannotation/equals#equals_1)(PointAnnotation) | IEquatable Equals method 를 사용하여 포인트 주석을 비교합니다. |
| override [GetHashCode](../../groupdocs.annotation.models.annotationmodels/pointannotation/gethashcode)() | Point Annotation 의 해시 코드를 반환합니다. |
...
* 다양한 유형의 문서에 점 주석을 추가하는 방법에 대해 자세히 알아보기: [C#에서 점 주석을 추가하는 방법](https://docs.groupdocs.com/display/annotationnet/Add+point+annotation)
