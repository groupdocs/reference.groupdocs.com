...
description: 리소스 수정 주석 properties 를 나타냅니다.
type: docs
weight: 670
url: /ko/net/groupdocs.annotation.models.annotationmodels/resourcesredactionannotation/
---
## ResourcesRedactionAnnotation class

리소스 수정 주석 properties 를 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [ResourcesRedactionAnnotation](resourcesredactionannotation)() | 의 새 인스턴스를 초기화합니다.[`ResourcesRedactionAnnotation`](../resourcesredactionannotation) 클래스. |

## 속성

| 이름 | 설명 |
| --- | --- |
| [Box](../../groupdocs.annotation.models.annotationmodels/resourcesredactionannotation/box) { get; set; } | 주석 position 를 가져오거나 설정합니다. |
...
| 이름 | 설명 |
| --- | --- |
| override [Clone](../../groupdocs.annotation.models.annotationmodels/resourcesredactionannotation/clone)() | 동일한 values 를 가진 새 인스턴스를 반환합니다. |
...
| override [Equals](../../groupdocs.annotation.models.annotationmodels/resourcesredactionannotation/equals#equals_2)(object) | 표준 개체 Equals method 를 사용하여 리소스 편집 주석을 비교합니다. |
| [Equals](../../groupdocs.annotation.models.annotationmodels/resourcesredactionannotation/equals#equals_1)(ResourcesRedactionAnnotation) | IEquatable Equals method 를 사용하여 리소스 수정 주석을 비교합니다. |
| override [GetHashCode](../../groupdocs.annotation.models.annotationmodels/resourcesredactionannotation/gethashcode)() | 리소스 교정 Annotation 의 해시 코드를 반환합니다. |
...
* 다양한 유형의 문서에 리소스 수정 주석을 추가하는 방법에 대해 자세히 알아보기: [C#에서 리소스 수정 주석을 추가하는 방법](https://docs.groupdocs.com/display/annotationnet/Add+resource+redaction+annotation)
