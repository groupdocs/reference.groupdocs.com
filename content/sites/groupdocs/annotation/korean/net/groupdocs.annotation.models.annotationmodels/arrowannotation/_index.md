...
description: 는 화살표 주석 properties 를 나타냅니다.
type: docs
weight: 210
url: /ko/net/groupdocs.annotation.models.annotationmodels/arrowannotation/
---
## ArrowAnnotation class

는 화살표 주석 properties 를 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [ArrowAnnotation](arrowannotation)() | 의 새 인스턴스를 초기화합니다.[`ArrowAnnotation`](../arrowannotation) 클래스. |

## 속성

| 이름 | 설명 |
| --- | --- |
| [Box](../../groupdocs.annotation.models.annotationmodels/arrowannotation/box) { get; set; } | 주석 position 를 가져오거나 설정합니다. |
...
| [Opacity](../../groupdocs.annotation.models.annotationmodels/arrowannotation/opacity) { get; set; } | 주석 opacity 를 가져오거나 설정합니다. |
...
| [PenColor](../../groupdocs.annotation.models.annotationmodels/arrowannotation/pencolor) { get; set; } | 주석 펜 color 를 가져오거나 설정합니다. |
| [PenStyle](../../groupdocs.annotation.models.annotationmodels/arrowannotation/penstyle) { get; set; } | 주석 펜 style 를 가져오거나 설정합니다. |
| [PenWidth](../../groupdocs.annotation.models.annotationmodels/arrowannotation/penwidth) { get; set; } | 주석 펜 width 를 가져오거나 설정합니다. |
...
| 이름 | 설명 |
| --- | --- |
| override [Clone](../../groupdocs.annotation.models.annotationmodels/arrowannotation/clone)() | 동일한 values 를 가진 새 인스턴스를 반환합니다. |
...
| [Equals](../../groupdocs.annotation.models.annotationmodels/arrowannotation/equals#equals_1)(ArrowAnnotation) | IEquatable Equals method 를 사용하여 영역 주석을 비교합니다. |
| override [Equals](../../groupdocs.annotation.models.annotationmodels/arrowannotation/equals#equals_2)(object) | 표준 개체 Equals method 를 사용하여 화살표 주석을 비교합니다. |
| override [GetHashCode](../../groupdocs.annotation.models.annotationmodels/arrowannotation/gethashcode)() | 화살표 Annotation 의 해시 코드를 반환합니다. |
...
* 다양한 유형의 문서에 화살표 주석 추가에 대한 추가 정보: [C#에서 화살표 주석을 추가하는 방법](https://docs.groupdocs.com/display/annotationnet/Add+arrow+annotation)
