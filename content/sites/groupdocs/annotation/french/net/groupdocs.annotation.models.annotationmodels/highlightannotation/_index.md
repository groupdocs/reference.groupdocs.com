...
description: Représente les propriétés dannotation de surbrillance
type: docs
weight: 240
url: /fr/net/groupdocs.annotation.models.annotationmodels/highlightannotation/
---
## HighlightAnnotation class

Représente les propriétés d'annotation de surbrillance
...
| Nom | La description |
| --- | --- |
| [HighlightAnnotation](highlightannotation)() | Initialise la nouvelle instance de[`HighlightAnnotation`](../highlightannotation) classe. |

## Propriétés

| Nom | La description |
| --- | --- |
| [BackgroundColor](../../groupdocs.annotation.models.annotationmodels/highlightannotation/backgroundcolor) { get; set; } | Obtient ou définit la couleur d'arrière-plan de l'annotation |
...
| [FontColor](../../groupdocs.annotation.models.annotationmodels/highlightannotation/fontcolor) { get; set; } | Obtient ou définit la couleur de police du texte d'annotation |
...
| [Opacity](../../groupdocs.annotation.models.annotationmodels/highlightannotation/opacity) { get; set; } | Obtient ou définit l'opacité des annotations |
...
| [Points](../../groupdocs.annotation.models.annotationmodels/highlightannotation/points) { get; set; } | Obtient ou définit une collection de points qui décrivent des rectangles avec text |
...
| Nom | La description |
| --- | --- |
| override [Clone](../../groupdocs.annotation.models.annotationmodels/highlightannotation/clone)() | Renvoie une nouvelle instance avec les mêmes valeurs |
...
| [Equals](../../groupdocs.annotation.models.annotationmodels/highlightannotation/equals#equals_1)(HighlightAnnotation) | Compare les annotations en surbrillance à l'aide de la méthode IEquatable Equals |
| override [Equals](../../groupdocs.annotation.models.annotationmodels/highlightannotation/equals#equals_2)(object) | Compare les annotations de surbrillance à l'aide de l'objet standard Égale à la méthode |
| override [GetHashCode](../../groupdocs.annotation.models.annotationmodels/highlightannotation/gethashcode)() | Renvoie le code de hachage de l'annotation de surbrillance |
...
* En savoir plus sur l'ajout d'annotations de surbrillance à des documents de différents types : [Comment ajouter des annotations de surbrillance en C #](https://docs.groupdocs.com/display/annotationnet/Add+highlight+annotation)
