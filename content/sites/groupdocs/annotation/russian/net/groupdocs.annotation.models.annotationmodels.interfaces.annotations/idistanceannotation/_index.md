...
description: Определяет свойства аннотации расстояния
type: docs
weight: 280
url: /ru/net/groupdocs.annotation.models.annotationmodels.interfaces.annotations/idistanceannotation/
---
## IDistanceAnnotation interface

Определяет свойства аннотации расстояния
