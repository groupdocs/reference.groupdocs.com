...
description: Определяет свойства аннотации эллипса
type: docs
weight: 290
url: /ru/net/groupdocs.annotation.models.annotationmodels.interfaces.annotations/iellipseannotation/
---
## IEllipseAnnotation interface

Определяет свойства аннотации эллипса
