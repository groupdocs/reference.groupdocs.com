...
description: Определяет свойства аннотации стрелки
type: docs
weight: 270
url: /ru/net/groupdocs.annotation.models.annotationmodels.interfaces.annotations/iarrowannotation/
---
## IArrowAnnotation interface

Определяет свойства аннотации стрелки
