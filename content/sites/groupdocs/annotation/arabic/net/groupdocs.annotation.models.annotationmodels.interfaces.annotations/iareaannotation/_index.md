...
description: يحدد خصائص التعليقات التوضيحية للمنطقة
type: docs
weight: 260
url: /ar/net/groupdocs.annotation.models.annotationmodels.interfaces.annotations/iareaannotation/
---
## IAreaAnnotation interface

يحدد خصائص التعليقات التوضيحية للمنطقة
