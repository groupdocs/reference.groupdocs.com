...
description: يحدد خصائص التعليق التوضيحي لحقل النص
type: docs
weight: 390
url: /ar/net/groupdocs.annotation.models.annotationmodels.interfaces.annotations/itextfieldannotation/
---
## ITextFieldAnnotation interface

يحدد خصائص التعليق التوضيحي لحقل النص
