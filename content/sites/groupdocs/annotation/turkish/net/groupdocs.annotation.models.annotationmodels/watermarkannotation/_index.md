...
description: Filigran açıklama özelliklerini temsil eder
type: docs
weight: 740
url: /tr/net/groupdocs.annotation.models.annotationmodels/watermarkannotation/
---
## WatermarkAnnotation class

Filigran açıklama özelliklerini temsil eder
...
| İsim | Tanım |
| --- | --- |
| [WatermarkAnnotation](watermarkannotation)() | Yeni örneğini başlatır[`WatermarkAnnotation`](../watermarkannotation) sınıf. |
...
| [FontSize](../../groupdocs.annotation.models.annotationmodels/watermarkannotation/fontsize) { get; set; } | Filigran metin yazı tipi boyutunu alır veya ayarlar |
| [HorizontalAlignment](../../groupdocs.annotation.models.annotationmodels/watermarkannotation/horizontalalignment) { get; set; } | Document üzerinde filigran yatay hizalamasını alır veya ayarlar |
...
| [Opacity](../../groupdocs.annotation.models.annotationmodels/watermarkannotation/opacity) { get; set; } | Filigran opaklığını alır veya ayarlar |
...
| [Text](../../groupdocs.annotation.models.annotationmodels/watermarkannotation/text) { get; set; } | Metni filigran alır veya ayarlar |
...
| [VerticalAlignment](../../groupdocs.annotation.models.annotationmodels/watermarkannotation/verticalalignment) { get; set; } | Document üzerinde filigran dikey hizalamasını alır veya ayarlar |

## yöntemler

| İsim | Tanım |
| --- | --- |
| override [Clone](../../groupdocs.annotation.models.annotationmodels/watermarkannotation/clone)() | Aynı değerlere sahip yeni Örnek döndürür |
...
| override [Equals](../../groupdocs.annotation.models.annotationmodels/watermarkannotation/equals#equals_2)(object) | Standart nesne Equals yöntemini kullanarak Filigran Ek Açıklamalarını karşılaştırır |
| [Equals](../../groupdocs.annotation.models.annotationmodels/watermarkannotation/equals#equals_1)(WatermarkAnnotation) | Filigran Ek Açıklamalarını IEquatable Equals yöntemini kullanarak karşılaştırır |
| override [GetHashCode](../../groupdocs.annotation.models.annotationmodels/watermarkannotation/gethashcode)() | Filigran Açıklamanın HashCode'unu döndürür |
