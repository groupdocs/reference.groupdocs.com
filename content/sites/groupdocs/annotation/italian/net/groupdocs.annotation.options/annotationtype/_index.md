...
Enumerazione che descrive i tipi di annotazione supportati da GroupDocs.Annotation per .NET
...
| Area | `2` | Il tipo di annotazione dell'area che evidenzia l'area rettangolare all'interno della pagina del documento |
| Arrow | `4` | Il tipo di annotazione che disegna una freccia sulla pagina del documento |
...
| TextReplacement | `1000` | Il tipo di annotazione che sostituisce il testo originale con un altro frammento di testo fornito |
| TextStrikeout | `2000` | Il tipo di annotazione che contrassegna il frammento di testo con uno stile barrato |
...
* [Come aggiungere annotazioni freccia in C#](https://docs.groupdocs.com/display/annotationnet/Add+arrow+annotation)
...
* [Come aggiungere annotazioni evidenziate in C#](https://docs.groupdocs.com/display/annotationnet/Add+highlight+annotation)
* [Come aggiungere annotazioni di redazione del testo in C#](https://docs.groupdocs.com/display/annotationnet/Add+text+redaction+annotation)
