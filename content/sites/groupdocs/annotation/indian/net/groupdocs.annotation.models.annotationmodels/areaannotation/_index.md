...
description: क्षेत्र एनटेशन गुणं क प्रतनधत्व करत है
type: docs
weight: 200
url: /hi/net/groupdocs.annotation.models.annotationmodels/areaannotation/
---
## AreaAnnotation class

क्षेत्र एनोटेशन गुणों का प्रतिनिधित्व करता है
...
| नाम | विवरण |
| --- | --- |
| [AreaAnnotation](areaannotation)() | का नया उदाहरण शुरू करता है[`AreaAnnotation`](../areaannotation) वर्ग. |

## गुण

| नाम | विवरण |
| --- | --- |
| [BackgroundColor](../../groupdocs.annotation.models.annotationmodels/areaannotation/backgroundcolor) { get; set; } | एनोटेशन बैकग्राउंड कलर प्राप्त या सेट करता है |
| [Box](../../groupdocs.annotation.models.annotationmodels/areaannotation/box) { get; set; } | एनोटेशन स्थिति प्राप्त या सेट करता है |
...
| [Opacity](../../groupdocs.annotation.models.annotationmodels/areaannotation/opacity) { get; set; } | एनोटेशन अपारदर्शिता प्राप्त या सेट करता है |
...
| [PenColor](../../groupdocs.annotation.models.annotationmodels/areaannotation/pencolor) { get; set; } | एनोटेशन पेन कलर प्राप्त या सेट करता है |
| [PenStyle](../../groupdocs.annotation.models.annotationmodels/areaannotation/penstyle) { get; set; } | एनोटेशन पेन स्टाइल प्राप्त या सेट करता है |
| [PenWidth](../../groupdocs.annotation.models.annotationmodels/areaannotation/penwidth) { get; set; } | एनोटेशन पेन की चौड़ाई प्राप्त या सेट करता है |
...
| नाम | विवरण |
| --- | --- |
| override [Clone](../../groupdocs.annotation.models.annotationmodels/areaannotation/clone)() | समान मानों के साथ नया उदाहरण लौटाता है |
...
| [Equals](../../groupdocs.annotation.models.annotationmodels/areaannotation/equals#equals_1)(AreaAnnotation) | IEquatable Equals विधि का उपयोग करके क्षेत्र एनोटेशन की तुलना करता है |
| override [Equals](../../groupdocs.annotation.models.annotationmodels/areaannotation/equals#equals_2)(object) | मानक ऑब्जेक्ट बराबर विधि का उपयोग करके क्षेत्र एनोटेशन की तुलना करता है |
| override [GetHashCode](../../groupdocs.annotation.models.annotationmodels/areaannotation/gethashcode)() | एरिया एनोटेशन का हैशकोड लौटाता है |
...
* विभिन्न प्रकार के दस्तावेज़ों में क्षेत्र एनोटेशन जोड़ने के बारे में अधिक: [कैसे सी # में क्षेत्र एनोटेशन जोड़ने के लिए](https://docs.groupdocs.com/display/annotationnet/Add+area+annotation)
