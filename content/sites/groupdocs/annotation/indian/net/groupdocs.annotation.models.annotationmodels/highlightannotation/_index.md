...
description: हइलइट एनटेशन गुणं क प्रतनधत्व करत है
type: docs
weight: 240
url: /hi/net/groupdocs.annotation.models.annotationmodels/highlightannotation/
---
## HighlightAnnotation class

हाइलाइट एनोटेशन गुणों का प्रतिनिधित्व करता है
...
| नाम | विवरण |
| --- | --- |
| [HighlightAnnotation](highlightannotation)() | का नया उदाहरण शुरू करता है[`HighlightAnnotation`](../highlightannotation) वर्ग. |

## गुण

| नाम | विवरण |
| --- | --- |
| [BackgroundColor](../../groupdocs.annotation.models.annotationmodels/highlightannotation/backgroundcolor) { get; set; } | एनोटेशन बैकग्राउंड कलर प्राप्त या सेट करता है |
...
| [FontColor](../../groupdocs.annotation.models.annotationmodels/highlightannotation/fontcolor) { get; set; } | एनोटेशन टेक्स्ट फ़ॉन्ट रंग प्राप्त या सेट करता है |
...
| [Opacity](../../groupdocs.annotation.models.annotationmodels/highlightannotation/opacity) { get; set; } | एनोटेशन अपारदर्शिता प्राप्त या सेट करता है |
...
| [Points](../../groupdocs.annotation.models.annotationmodels/highlightannotation/points) { get; set; } | टेक्स्ट के साथ आयतों का वर्णन करने वाले बिंदुओं का संग्रह प्राप्त या सेट करता है |
...
| नाम | विवरण |
| --- | --- |
| override [Clone](../../groupdocs.annotation.models.annotationmodels/highlightannotation/clone)() | समान मानों के साथ नया उदाहरण लौटाता है |
...
| [Equals](../../groupdocs.annotation.models.annotationmodels/highlightannotation/equals#equals_1)(HighlightAnnotation) | IEquatable Equals विधि का उपयोग करके हाइलाइट एनोटेशन की तुलना करता है |
| override [Equals](../../groupdocs.annotation.models.annotationmodels/highlightannotation/equals#equals_2)(object) | मानक ऑब्जेक्ट बराबर विधि का उपयोग करके हाइलाइट एनोटेशन की तुलना करता है |
| override [GetHashCode](../../groupdocs.annotation.models.annotationmodels/highlightannotation/gethashcode)() | हाइलाइट एनोटेशन का हैशकोड लौटाता है |
...
* विभिन्न प्रकार के दस्तावेज़ों में हाइलाइट एनोटेशन जोड़ने के बारे में अधिक: [सी # में हाइलाइट एनोटेशन कैसे जोड़ें](https://docs.groupdocs.com/display/annotationnet/Add+highlight+annotation)
