...
description: संसधनं के संपदन एनटेशन गुणं क प्रतनधत्व करत है
type: docs
weight: 670
url: /hi/net/groupdocs.annotation.models.annotationmodels/resourcesredactionannotation/
---
## ResourcesRedactionAnnotation class

संसाधनों के संपादन एनोटेशन गुणों का प्रतिनिधित्व करता है
...
| नाम | विवरण |
| --- | --- |
| [ResourcesRedactionAnnotation](resourcesredactionannotation)() | का नया उदाहरण शुरू करता है[`ResourcesRedactionAnnotation`](../resourcesredactionannotation) वर्ग. |

## गुण

| नाम | विवरण |
| --- | --- |
| [Box](../../groupdocs.annotation.models.annotationmodels/resourcesredactionannotation/box) { get; set; } | एनोटेशन स्थिति प्राप्त या सेट करता है |
...
| नाम | विवरण |
| --- | --- |
| override [Clone](../../groupdocs.annotation.models.annotationmodels/resourcesredactionannotation/clone)() | समान मानों के साथ नया उदाहरण लौटाता है |
...
| override [Equals](../../groupdocs.annotation.models.annotationmodels/resourcesredactionannotation/equals#equals_2)(object) | मानक वस्तु बराबर विधि का उपयोग करके संसाधन सुधार एनोटेशन की तुलना करता है |
| [Equals](../../groupdocs.annotation.models.annotationmodels/resourcesredactionannotation/equals#equals_1)(ResourcesRedactionAnnotation) | IEquatable Equals method का उपयोग करके संसाधन सुधार एनोटेशन की तुलना करता है |
| override [GetHashCode](../../groupdocs.annotation.models.annotationmodels/resourcesredactionannotation/gethashcode)() | रिसोर्स रिडक्शन एनोटेशन का हैशकोड लौटाता है |
...
* विभिन्न प्रकार के दस्तावेज़ों में संसाधन सुधार एनोटेशन जोड़ने के बारे में अधिक जानकारी: [सी # में संसाधन रिडक्शन एनोटेशन कैसे जोड़ें](https://docs.groupdocs.com/display/annotationnet/Add+resource+redaction+annotation)
