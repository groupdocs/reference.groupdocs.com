...
description: प्रतस्थपन एनटेशन गुणं क प्रतनधत्व करत है
type: docs
weight: 660
url: /hi/net/groupdocs.annotation.models.annotationmodels/replacementannotation/
---
## ReplacementAnnotation class

प्रतिस्थापन एनोटेशन गुणों का प्रतिनिधित्व करता है
...
| नाम | विवरण |
| --- | --- |
| [ReplacementAnnotation](replacementannotation)() | का नया उदाहरण शुरू करता है[`ReplacementAnnotation`](../replacementannotation) वर्ग. |
...
| [FontColor](../../groupdocs.annotation.models.annotationmodels/replacementannotation/fontcolor) { get; set; } | एनोटेशन टेक्स्ट फ़ॉन्ट रंग प्राप्त या सेट करता है |
| [FontSize](../../groupdocs.annotation.models.annotationmodels/replacementannotation/fontsize) { get; set; } | एनोटेशन टेक्स्ट फ़ॉन्ट आकार प्राप्त या सेट करता है |
...
| [Opacity](../../groupdocs.annotation.models.annotationmodels/replacementannotation/opacity) { get; set; } | एनोटेशन अपारदर्शिता प्राप्त या सेट करता है |
...
| [Points](../../groupdocs.annotation.models.annotationmodels/replacementannotation/points) { get; set; } | टेक्स्ट के साथ आयतों का वर्णन करने वाले बिंदुओं का संग्रह प्राप्त या सेट करता है |
...
| [TextToReplace](../../groupdocs.annotation.models.annotationmodels/replacementannotation/texttoreplace) { get; set; } | टेक्स्ट को प्रतिस्थापित करने के लिए प्राप्त या सेट करता है |
...
| नाम | विवरण |
| --- | --- |
| override [Clone](../../groupdocs.annotation.models.annotationmodels/replacementannotation/clone)() | समान मानों के साथ नया उदाहरण लौटाता है |
...
| override [Equals](../../groupdocs.annotation.models.annotationmodels/replacementannotation/equals#equals_2)(object) | मानक ऑब्जेक्ट बराबर विधि का उपयोग करके प्रतिस्थापन एनोटेशन की तुलना करता है |
| [Equals](../../groupdocs.annotation.models.annotationmodels/replacementannotation/equals#equals_1)(ReplacementAnnotation) | IEquatable Equals विधि का उपयोग करके प्रतिस्थापन एनोटेशन की तुलना करता है |
| override [GetHashCode](../../groupdocs.annotation.models.annotationmodels/replacementannotation/gethashcode)() | रिप्लेसमेंट एनोटेशन का हैशकोड लौटाता है |
...
* विभिन्न प्रकार के दस्तावेज़ों में प्रतिस्थापन एनोटेशन जोड़ने के बारे में अधिक जानकारी: [सी # में प्रतिस्थापन एनोटेशन कैसे जोड़ें](https://docs.groupdocs.com/display/annotationnet/Add+replacement+annotation)
