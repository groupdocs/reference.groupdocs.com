...
| 姓名 | 描述 |
| --- | --- |
| [DistanceAnnotation](distanceannotation)() | 初始化的新实例[`DistanceAnnotation`](../distanceannotation)类. |
...
| [Opacity](../../groupdocs.annotation.models.annotationmodels/distanceannotation/opacity) { get; set; } | 获取或设置注解不透明度 |
...
| [PenWidth](../../groupdocs.annotation.models.annotationmodels/distanceannotation/penwidth) { get; set; } | 获取或设置注释笔宽度 |
...
| override [Equals](../../groupdocs.annotation.models.annotationmodels/distanceannotation/equals#equals_2)(object) | 使用标准对象等于方法比较距离注释 |
...
* 更多关于为各种类型的文档添加距离注释： [如何在 C# 中添加距离注释](https://docs.groupdocs.com/display/annotationnet/Add+distance+annotation)
