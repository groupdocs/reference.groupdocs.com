...
description: 初始化一个新的实例ConvertFileExceptiongroupdocs.annotation.exceptions/convertfileexception班级
type: docs
weight: 10
url: /zh/net/groupdocs.annotation.exceptions/convertfileexception/convertfileexception/
---
## ConvertFileException(string) {#constructor}

初始化一个新的实例[`ConvertFileException`](../../convertfileexception)班级。
...
* 命名空间 [GroupDocs.Annotation.Exceptions](../../convertfileexception)
