...
A utility class providing constants. Specifies how to read XML data and a relational schema into a com.groupdocs.assembly.system.data.DataSet.
## Fields
...
| [IGNORE_SCHEMA](#IGNORE-SCHEMA) | Ignores any inline schema and reads data into the existing com.groupdocs.assembly.system.data.DataSet schema. |
| [INFER_SCHEMA](#INFER-SCHEMA) | Ignores any inline schema, infers schema from the data and loads the data. |
| [DIFF_GRAM](#DIFF-GRAM) | Reads a DiffGram, applying changes from the DiffGram to the com.groupdocs.assembly.system.data.DataSet and preserving com.groupdocs.assembly.system.data.DataRow\#getRowState() values. |
...
Reads any inline schema and loads the data. If the com.groupdocs.assembly.system.data.DataSet already contains schema, new tables may be added to the schema, but an exception is thrown if any tables in the inline schema already exist in the com.groupdocs.assembly.system.data.DataSet.
...
Ignores any inline schema and reads data into the existing com.groupdocs.assembly.system.data.DataSet schema. If any data does not match the existing schema, it is discarded (including data from differing namespaces defined for the com.groupdocs.assembly.system.data.DataSet). If the data is a DiffGram, IgnoreSchema has the same functionality as DiffGram.
...
Reads a DiffGram, applying changes from the DiffGram to the com.groupdocs.assembly.system.data.DataSet and preserving com.groupdocs.assembly.system.data.DataRow\#getRowState() values.
...
Reads XML fragments, such as those generated by executing FOR XML queries, against an instance of SQL Server. When com.groupdocs.assembly.system.data.XmlReadMode is set to Fragment, the default namespace is read as the inline schema.
