...
| [AssembleDocument](../../groupdocs.assembly/documentassembler/assembledocument#assembledocument_2)(string, string, params DataSourceInfo[]) | Carica un documento modello dal percorso di origine specificato, popola il documento modello con i dati da le origini singole o multiple specificate e archivia il documento risultante nel percorso di destinazione utilizzando default [`LoadSaveOptions`](../loadsaveoptions) . |
