...
description: الحصول على أو تعيين تنسيقات دقيقة لتحليل قيم JSON للتاريخ والوقت أثناء تحميل JSON. الافتراضي هوباطل .
type: docs
weight: 30
...
الحصول على أو تعيين تنسيقات دقيقة لتحليل قيم JSON للتاريخ والوقت أثناء تحميل JSON. الافتراضي هو**باطل** .
...
* متى`ExactDateTimeParseFormats` يكون**باطل**، يتم استخدام تنسيق ISO-8601 وجميع تنسيقات التاريخ والوقت المدعومة للثقافات الحالية والإنجليزية في الولايات المتحدة الأمريكية والإنجليزية في نيوزيلندا بالإضافة إلى ذلك في الترتيب المذكور .
