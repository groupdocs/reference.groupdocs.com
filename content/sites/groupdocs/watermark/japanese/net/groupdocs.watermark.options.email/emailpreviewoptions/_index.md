...
description: 電子メール ドキュメントのプレビュー生成の要件とストリーム デリゲートを設定するオプションを提供します
type: docs
weight: 1710
url: /ja/net/groupdocs.watermark.options.email/emailpreviewoptions/
---
## EmailPreviewOptions class

電子メール ドキュメントのプレビュー生成の要件とストリーム デリゲートを設定するオプションを提供します。
...
| 名前 | 説明 |
| --- | --- |
| [EmailPreviewOptions](emailpreviewoptions#constructor)(CreatePageStream) | の新しいインスタンスを初期化します[`EmailPreviewOptions`](../emailpreviewoptions)出力ストリームを閉じるクラス. |
| [EmailPreviewOptions](emailpreviewoptions#constructor_1)(CreatePageStream, ReleasePageStream) | の新しいインスタンスを初期化します[`EmailPreviewOptions`](../emailpreviewoptions)出力ストリームをさらに使用するために クライアントに返すクラス. |
...
| [Resolution](../../groupdocs.watermark.options.email/emailpreviewoptions/resolution) { get; set; } | 生成された画像の解像度を 1 インチあたりのドット数で取得または設定します。 |
...
| 名前 | 説明 |
| --- | --- |
| const [DefaultResolution](../../groupdocs.watermark.options.email/emailpreviewoptions/defaultresolution) | デフォルトの解像度 (ドット/インチ)。 |
