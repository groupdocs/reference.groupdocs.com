...
description: プレゼンテーション ドキュメント マスター配布資料スライドに透かしを追加するときのオプションを表します
type: docs
weight: 2010
url: /ja/net/groupdocs.watermark.options.presentation/presentationwatermarkmasterhandoutslideoptions/
---
## PresentationWatermarkMasterHandoutSlideOptions class

プレゼンテーション ドキュメント マスター配布資料スライドに透かしを追加するときのオプションを表します。
...
| 名前 | 説明 |
| --- | --- |
| [PresentationWatermarkMasterHandoutSlideOptions](presentationwatermarkmasterhandoutslideoptions)() | の新しいインスタンスを初期化します[`PresentationWatermarkMasterHandoutSlideOptions`](../presentationwatermarkmasterhandoutslideoptions)class. |
