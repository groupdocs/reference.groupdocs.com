...
description: プレゼンテーション ドキュメントのノート スライドに透かしを追加するときのオプションを表します
type: docs
weight: 2040
url: /ja/net/groupdocs.watermark.options.presentation/presentationwatermarknoteslideoptions/
---
## PresentationWatermarkNoteSlideOptions class

プレゼンテーション ドキュメントのノート スライドに透かしを追加するときのオプションを表します。
...
| 名前 | 説明 |
| --- | --- |
| [PresentationWatermarkNoteSlideOptions](presentationwatermarknoteslideoptions)() | の新しいインスタンスを初期化します[`PresentationWatermarkNoteSlideOptions`](../presentationwatermarknoteslideoptions)class. |
...
| [SlideIndex](../../groupdocs.watermark.options.presentation/presentationwatermarknoteslideoptions/slideindex) { get; set; } | スライドのインデックスを取得または設定して、透かしをそのスライドのメモに追加します. |
