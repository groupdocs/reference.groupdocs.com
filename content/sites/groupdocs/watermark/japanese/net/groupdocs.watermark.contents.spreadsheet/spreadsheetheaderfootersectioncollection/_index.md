...
description: ヘッダー/フッター セクションのコレクションを表します
type: docs
weight: 1140
url: /ja/net/groupdocs.watermark.contents.spreadsheet/spreadsheetheaderfootersectioncollection/
---
...
| [Item](../../groupdocs.watermark.contents.spreadsheet/spreadsheetheaderfootersectioncollection/item) { get; } | 指定されたタイプのヘッダー/フッター セクションを取得します。 |
...
このコレクションには、[`SpreadsheetHeaderFooterSection`](../spreadsheetheaderfootersection) type.
