...
description: Visio ドキュメント内の図形のコレクションを表します
type: docs
weight: 240
url: /ja/net/groupdocs.watermark.contents.diagram/diagramshapecollection/
---
## DiagramShapeCollection class

Visio ドキュメント内の図形のコレクションを表します。
...
このコレクションには、[`DiagramShape`](../diagramshape) type.
