...
description: 電子メール メッセージ内のアドレスのコレクションを表します
type: docs
weight: 280
url: /ja/net/groupdocs.watermark.contents.email/emailaddresscollection/
---
## EmailAddressCollection class

電子メール メッセージ内のアドレスのコレクションを表します。
...
このコレクションには、[`EmailAddress`](../emailaddress) type.
