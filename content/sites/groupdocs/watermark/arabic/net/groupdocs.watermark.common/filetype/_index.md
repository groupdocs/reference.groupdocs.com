...
| static readonly [POTX](../../groupdocs.watermark.common/filetype/potx) | تمثل الملفات ذات الامتداد .POTX العروض التقديمية لقوالب Microsoft PowerPoint التي تم إنشاؤها باستخدام Microsoft PowerPoint 2007 والإصدارات الأحدث. تعرف على المزيد حول هذا الملف format [هنا](https://wiki.fileformat.com/presentation/potx/) . |
