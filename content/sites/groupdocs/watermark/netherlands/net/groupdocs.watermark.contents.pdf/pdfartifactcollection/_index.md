...
description: Vertegenwoordigt een verzameling artefacten in een pdfinhoud.
type: docs
weight: 560
url: /nl/net/groupdocs.watermark.contents.pdf/pdfartifactcollection/
---
## PdfArtifactCollection class

Vertegenwoordigt een verzameling artefacten in een pdf-inhoud.
...
Deze collectie bevat de items van[`PdfArtifact`](../pdfartifact) type.
