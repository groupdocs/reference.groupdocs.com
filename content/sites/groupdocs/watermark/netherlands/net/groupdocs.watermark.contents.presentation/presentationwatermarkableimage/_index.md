...
description: Vertegenwoordigt een afbeelding in een PowerPointdocument.
type: docs
weight: 1020
url: /nl/net/groupdocs.watermark.contents.presentation/presentationwatermarkableimage/
---
## PresentationWatermarkableImage class

Vertegenwoordigt een afbeelding in een PowerPoint-document.
...
| Naam | Beschrijving |
| --- | --- |
| [PresentationWatermarkableImage](presentationwatermarkableimage)(byte[]) | Initialiseert een nieuw exemplaar van het[`PresentationWatermarkableImage`](../presentationwatermarkableimage) klasse met behulp van gespecificeerde afbeeldingsgegevens. |
