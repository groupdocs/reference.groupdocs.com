...
description: Vertegenwoordigt een afbeelding in een Worddocument.
type: docs
weight: 1460
url: /nl/net/groupdocs.watermark.contents.wordprocessing/wordprocessingwatermarkableimage/
---
## WordProcessingWatermarkableImage class

Vertegenwoordigt een afbeelding in een Word-document.
...
| Naam | Beschrijving |
| --- | --- |
| [WordProcessingWatermarkableImage](wordprocessingwatermarkableimage)(byte[]) | Initialiseert een nieuw exemplaar van het[`WordProcessingWatermarkableImage`](../wordprocessingwatermarkableimage) klasse met behulp van opgegeven afbeeldingsgegevens. |
