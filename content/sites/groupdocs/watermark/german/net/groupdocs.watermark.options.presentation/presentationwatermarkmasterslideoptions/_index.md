...
description: Repräsentiert Optionen beim Hinzufügen von Wasserzeichen zu einer Masterfolie eines Präsentationsdokuments.
type: docs
weight: 2030
url: /de/net/groupdocs.watermark.options.presentation/presentationwatermarkmasterslideoptions/
---
## PresentationWatermarkMasterSlideOptions class

Repräsentiert Optionen beim Hinzufügen von Wasserzeichen zu einer Masterfolie eines Präsentationsdokuments.
...
| Name | Beschreibung |
| --- | --- |
| [PresentationWatermarkMasterSlideOptions](presentationwatermarkmasterslideoptions)() | Initialisiert eine neue Instanz von[`PresentationWatermarkMasterSlideOptions`](../presentationwatermarkmasterslideoptions) Klasse. |
...
| [MasterSlideIndex](../../groupdocs.watermark.options.presentation/presentationwatermarkmasterslideoptions/masterslideindex) { get; set; } | Ruft den Index der Masterfolie ab oder legt ihn fest, zu der das Wasserzeichen hinzugefügt werden soll. |
