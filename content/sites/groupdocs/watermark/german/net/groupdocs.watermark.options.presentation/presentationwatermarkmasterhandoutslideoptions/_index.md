...
description: Repräsentiert Optionen beim Hinzufügen von Wasserzeichen zu einer MasterHandoutFolie eines Präsentationsdokuments.
type: docs
weight: 2010
url: /de/net/groupdocs.watermark.options.presentation/presentationwatermarkmasterhandoutslideoptions/
---
## PresentationWatermarkMasterHandoutSlideOptions class

Repräsentiert Optionen beim Hinzufügen von Wasserzeichen zu einer Master-Handout-Folie eines Präsentationsdokuments.
...
| Name | Beschreibung |
| --- | --- |
| [PresentationWatermarkMasterHandoutSlideOptions](presentationwatermarkmasterhandoutslideoptions)() | Initialisiert eine neue Instanz von[`PresentationWatermarkMasterHandoutSlideOptions`](../presentationwatermarkmasterhandoutslideoptions) Klasse. |
