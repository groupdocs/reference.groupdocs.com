...
description: Repräsentiert Optionen beim Hinzufügen von Wasserzeichen zu einer Notizfolie eines Präsentationsdokuments.
type: docs
weight: 2040
url: /de/net/groupdocs.watermark.options.presentation/presentationwatermarknoteslideoptions/
---
## PresentationWatermarkNoteSlideOptions class

Repräsentiert Optionen beim Hinzufügen von Wasserzeichen zu einer Notizfolie eines Präsentationsdokuments.
...
| Name | Beschreibung |
| --- | --- |
| [PresentationWatermarkNoteSlideOptions](presentationwatermarknoteslideoptions)() | Initialisiert eine neue Instanz von[`PresentationWatermarkNoteSlideOptions`](../presentationwatermarknoteslideoptions) Klasse. |
...
| [SlideIndex](../../groupdocs.watermark.options.presentation/presentationwatermarknoteslideoptions/slideindex) { get; set; } | Ruft den Index einer Folie ab oder legt ihn fest, um das Wasserzeichen hinzuzufügen, um die Folie davon zu notieren. |
