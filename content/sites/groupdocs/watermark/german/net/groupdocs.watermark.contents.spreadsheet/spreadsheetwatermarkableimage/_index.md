...
description: Stellt ein Bild in einem ExcelDokument dar.
type: docs
weight: 1250
url: /de/net/groupdocs.watermark.contents.spreadsheet/spreadsheetwatermarkableimage/
---
## SpreadsheetWatermarkableImage class

Stellt ein Bild in einem Excel-Dokument dar.
...
| Name | Beschreibung |
| --- | --- |
| [SpreadsheetWatermarkableImage](spreadsheetwatermarkableimage)(byte[]) | Initialisiert eine neue Instanz von[`SpreadsheetWatermarkableImage`](../spreadsheetwatermarkableimage) class unter Verwendung angegebener Bilddaten. |
