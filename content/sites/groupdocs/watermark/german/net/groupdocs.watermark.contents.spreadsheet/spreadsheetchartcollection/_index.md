...
description: Stellt eine Sammlung von Diagrammen in einem ExcelDokument dar.
type: docs
weight: 1090
url: /de/net/groupdocs.watermark.contents.spreadsheet/spreadsheetchartcollection/
---
## SpreadsheetChartCollection class

Stellt eine Sammlung von Diagrammen in einem Excel-Dokument dar.
...
Diese Sammlung enthält die Artikel von[`SpreadsheetChart`](../spreadsheetchart) Typ.
