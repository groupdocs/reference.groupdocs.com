...
description: Stellt eine Sammlung von Anmerkungen in einem PDFDokument dar.
type: docs
weight: 530
url: /de/net/groupdocs.watermark.contents.pdf/pdfannotationcollection/
---
## PdfAnnotationCollection class

Stellt eine Sammlung von Anmerkungen in einem PDF-Dokument dar.
...
Diese Sammlung enthält die Artikel von[`PdfAnnotation`](../pdfannotation) Typ.
