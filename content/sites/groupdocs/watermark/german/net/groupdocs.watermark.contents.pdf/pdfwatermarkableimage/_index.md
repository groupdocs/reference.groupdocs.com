...
description: Stellt ein Bild in einem PDFDokument dar.
type: docs
weight: 730
url: /de/net/groupdocs.watermark.contents.pdf/pdfwatermarkableimage/
---
## PdfWatermarkableImage class

Stellt ein Bild in einem PDF-Dokument dar.
...
| Name | Beschreibung |
| --- | --- |
| [PdfWatermarkableImage](pdfwatermarkableimage)(byte[]) | Initialisiert eine neue Instanz von[`PdfWatermarkableImage`](../pdfwatermarkableimage) Klasse mit angegebenen Bilddaten. |
