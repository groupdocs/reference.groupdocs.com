...
description: Stellt ein Bild in einem VisioDokument dar.
type: docs
weight: 260
url: /de/net/groupdocs.watermark.contents.diagram/diagramwatermarkableimage/
---
## DiagramWatermarkableImage class

Stellt ein Bild in einem Visio-Dokument dar.
...
| Name | Beschreibung |
| --- | --- |
| [DiagramWatermarkableImage](diagramwatermarkableimage)(byte[]) | Initialisiert eine neue Instanz von[`DiagramWatermarkableImage`](../diagramwatermarkableimage) Klasse mit angegebenen Bilddaten. |
