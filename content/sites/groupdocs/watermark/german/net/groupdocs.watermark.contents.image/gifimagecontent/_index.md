...
description: Stellt ein GIFBild dar in dem ein Wasserzeichen platziert werden kann.
type: docs
weight: 360
url: /de/net/groupdocs.watermark.contents.image/gifimagecontent/
---
## GifImageContent class

Stellt ein GIF-Bild dar, in dem ein Wasserzeichen platziert werden kann.
