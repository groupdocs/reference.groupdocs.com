...
description: Représente une image dans un document PowerPoint.
type: docs
weight: 1020
url: /fr/net/groupdocs.watermark.contents.presentation/presentationwatermarkableimage/
---
## PresentationWatermarkableImage class

Représente une image dans un document PowerPoint.
...
| Nom | La description |
| --- | --- |
| [PresentationWatermarkableImage](presentationwatermarkableimage)(byte[]) | Initialise une nouvelle instance du[`PresentationWatermarkableImage`](../presentationwatermarkableimage) classe utilisant les données d'image spécifiées. |
