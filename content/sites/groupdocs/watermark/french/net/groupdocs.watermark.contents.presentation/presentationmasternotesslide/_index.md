...
description: Représente une diapositive principale pour toutes les diapositives de notes dun document PowerPoint.
type: docs
weight: 910
url: /fr/net/groupdocs.watermark.contents.presentation/presentationmasternotesslide/
---
## PresentationMasterNotesSlide class

Représente une diapositive principale pour toutes les diapositives de notes d'un document PowerPoint.
