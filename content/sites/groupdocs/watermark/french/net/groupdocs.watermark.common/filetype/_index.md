...
| static readonly [XLSX](../../groupdocs.watermark.common/filetype/xlsx) | XLSX est un format bien connu pour les documents Microsoft Excel qui a été introduit par Microsoft avec la release de Microsoft Office 2007. En savoir plus sur ce format de fichier [ici](https://wiki.fileformat.com/specification/spreadsheet/xlsx/) . |
