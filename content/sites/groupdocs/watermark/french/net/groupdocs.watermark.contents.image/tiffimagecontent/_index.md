...
description: Représente une image tiff où un filigrane peut être placé.
type: docs
weight: 410
url: /fr/net/groupdocs.watermark.contents.image/tiffimagecontent/
---
## TiffImageContent class

Représente une image tiff où un filigrane peut être placé.
