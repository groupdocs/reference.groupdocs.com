...
description: Représente une image dans un document Visio.
type: docs
weight: 260
url: /fr/net/groupdocs.watermark.contents.diagram/diagramwatermarkableimage/
---
## DiagramWatermarkableImage class

Représente une image dans un document Visio.
...
| Nom | La description |
| --- | --- |
| [DiagramWatermarkableImage](diagramwatermarkableimage)(byte[]) | Initialise une nouvelle instance du[`DiagramWatermarkableImage`](../diagramwatermarkableimage) classe utilisant les données d'image spécifiées. |
