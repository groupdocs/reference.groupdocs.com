...
description: Représente une image dans un document Excel.
type: docs
weight: 1250
url: /fr/net/groupdocs.watermark.contents.spreadsheet/spreadsheetwatermarkableimage/
---
## SpreadsheetWatermarkableImage class

Représente une image dans un document Excel.
...
| Nom | La description |
| --- | --- |
| [SpreadsheetWatermarkableImage](spreadsheetwatermarkableimage)(byte[]) | Initialise une nouvelle instance du[`SpreadsheetWatermarkableImage`](../spreadsheetwatermarkableimage) class utilisant les données d'image spécifiées. |
