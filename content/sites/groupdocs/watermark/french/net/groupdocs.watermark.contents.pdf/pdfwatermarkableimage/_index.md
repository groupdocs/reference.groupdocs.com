...
description: Représente une image dans un document Pdf.
type: docs
weight: 730
url: /fr/net/groupdocs.watermark.contents.pdf/pdfwatermarkableimage/
---
## PdfWatermarkableImage class

Représente une image dans un document Pdf.
...
| Nom | La description |
| --- | --- |
| [PdfWatermarkableImage](pdfwatermarkableimage)(byte[]) | Initialise une nouvelle instance du[`PdfWatermarkableImage`](../pdfwatermarkableimage) classe utilisant les données d'image spécifiées. |
