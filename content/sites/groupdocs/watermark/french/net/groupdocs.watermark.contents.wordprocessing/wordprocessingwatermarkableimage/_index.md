...
description: Représente une image dans un document Word.
type: docs
weight: 1460
url: /fr/net/groupdocs.watermark.contents.wordprocessing/wordprocessingwatermarkableimage/
---
## WordProcessingWatermarkableImage class

Représente une image dans un document Word.
...
| Nom | La description |
| --- | --- |
| [WordProcessingWatermarkableImage](wordprocessingwatermarkableimage)(byte[]) | Initialise une nouvelle instance du[`WordProcessingWatermarkableImage`](../wordprocessingwatermarkableimage) classe utilisant les données d'image spécifiées. |
