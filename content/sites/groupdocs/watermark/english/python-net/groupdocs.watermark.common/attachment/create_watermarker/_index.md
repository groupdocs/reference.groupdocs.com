...
**Returns:** An instance of a subclass of `Content` representing the loaded content.
...
```python
    ...
    watermark = gww.TextWatermark("Sample", gww.Font("Arial", 19.0))
...
**Returns:** The instance of appropriate descendant of `Content` class.
