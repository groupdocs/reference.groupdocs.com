...
| :- | :- |
| [attachments](/watermark/python-net/groupdocs.watermark.contents.email/emailcontent/attachments/) | The collection of all attachments of the email message. |
| [bcc](/watermark/python-net/groupdocs.watermark.contents.email/emailcontent/bcc/) | The collection of BCC (blind carbon copy) recipients of the email message. |
| [body](/watermark/python-net/groupdocs.watermark.contents.email/emailcontent/body/) | The plain text representation of the message body. |
| [body_type](/watermark/python-net/groupdocs.watermark.contents.email/emailcontent/body_type/) | The type of the email message body. |
| [cc](/watermark/python-net/groupdocs.watermark.contents.email/emailcontent/cc/) | The collection of CC (carbon copy) recipients of the email message. |
| [embedded_objects](/watermark/python-net/groupdocs.watermark.contents.email/emailcontent/embedded_objects/) | The collection of all embedded objects of the email message. |
| [from_](/watermark/python-net/groupdocs.watermark.contents.email/emailcontent/from_/) | The from address of the email message. |
