---
title: MarginType class
second_title: GroupDocs.Watermark for Python via .NET API References
description: "MarginType enum — GroupDocs.Watermark for Python via .NET API reference."
type: docs
...
| Field | Description |
| :- | :- |
| [ABSOLUTE](/watermark/python-net/groupdocs.watermark.watermarks/margintype/absolute/) | Margin value measured in content units. |
