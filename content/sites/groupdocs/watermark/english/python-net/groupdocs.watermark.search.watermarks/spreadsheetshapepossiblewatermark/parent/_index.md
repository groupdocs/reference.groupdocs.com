...
description: 
type: docs
url: /python-net/groupdocs.watermark.search.watermarks/spreadsheetshapepossiblewatermark/parent/
is_root: false
weight: 70
---
...
Gets the parent of this [`SpreadsheetShapePossibleWatermark`](/watermark/python-net/groupdocs.watermark.search.watermarks/spreadsheetshapepossiblewatermark).
### Definition:
```python
@property
def parent(self):
