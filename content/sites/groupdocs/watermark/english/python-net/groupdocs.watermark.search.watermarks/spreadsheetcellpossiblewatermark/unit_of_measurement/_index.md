...
Gets the unit of measurement of this [`SpreadsheetCellPossibleWatermark`](/watermark/python-net/groupdocs.watermark.search.watermarks/spreadsheetcellpossiblewatermark).
### Definition:
```python
@property
