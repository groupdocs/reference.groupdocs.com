...
description: 
type: docs
url: /python-net/groupdocs.watermark.search.watermarks/spreadsheetcellpossiblewatermark/parent/
is_root: false
weight: 70
---
...
Gets the parent of this [`SpreadsheetCellPossibleWatermark`](/watermark/python-net/groupdocs.watermark.search.watermarks/spreadsheetcellpossiblewatermark).
### Definition:
```python
@property
def parent(self):
