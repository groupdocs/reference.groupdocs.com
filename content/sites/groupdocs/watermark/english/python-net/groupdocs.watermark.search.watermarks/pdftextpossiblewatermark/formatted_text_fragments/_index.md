...
Gets the collection of formatted text fragments of this [`PdfTextPossibleWatermark`](/watermark/python-net/groupdocs.watermark.search.watermarks/pdftextpossiblewatermark).
### Definition:
```python
@property
