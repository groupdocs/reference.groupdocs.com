...
description: 
type: docs
url: /python-net/groupdocs.watermark.search.watermarks/pdfxobjectpossiblewatermark/parent/
is_root: false
weight: 70
---
...
Gets the parent of this [`PdfXObjectPossibleWatermark`](/watermark/python-net/groupdocs.watermark.search.watermarks/pdfxobjectpossiblewatermark).
### Definition:
```python
@property
def parent(self):
