---
title: ImageFrame class
second_title: GroupDocs.Watermark for Python via .NET API References
description: 
type: docs
url: /python-net/groupdocs.watermark.contents.image/imageframe/
is_root: false
weight: 30
---
...
The ImageFrame type exposes the following members:
...
| :- | :- |
| [height](/watermark/python-net/groupdocs.watermark.contents.image/imageframe/height/) | The height of this ImageFrame in pixels. |
| [width](/watermark/python-net/groupdocs.watermark.contents.image/imageframe/width/) | The width of this ImageFrame in pixels. |
