...
Types under `groupdocs.watermark.options.email`.
...
| [`EmailPreviewOptions`](/watermark/python-net/groupdocs.watermark.options.email/emailpreviewoptions/) | Provides options to set requirements and stream delegates for preview generation of an email document. |
