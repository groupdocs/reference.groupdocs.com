---
title: WordProcessingSection class
second_title: GroupDocs.Watermark for Python via .NET API References
description: "Represents a Word document section."
type: docs
url: /python-net/groupdocs.watermark.contents.word_processing/wordprocessingsection/
is_root: false
weight: 100
---
...
| :- | :- |
| [headers_footers](/watermark/python-net/groupdocs.watermark.contents.word_processing/wordprocessingsection/headers_footers/) | The collection of all headers and footers of this [`WordProcessingSection`](/watermark/python-net/groupdocs.watermark.contents.word_processing/wordprocessingsection/). |
| [page_setup](/watermark/python-net/groupdocs.watermark.contents.word_processing/wordprocessingsection/page_setup/) | The printing page setup for this [`WordProcessingSection`](/watermark/python-net/groupdocs.watermark.contents.word_processing/wordprocessingsection/). |
| [shapes](/watermark/python-net/groupdocs.watermark.contents.word_processing/wordprocessingsection/shapes/) | The collection of all shapes contained in this WordProcessingSection. |
