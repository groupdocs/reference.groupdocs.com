...
| :- | :- |
| [background_color_range](/watermark/python-net/groupdocs.watermark.search.search_criteria/textformattingsearchcriteria/background_color_range/) | The range of colors used to filter watermarks by text background color. |
...
| [font_italic](/watermark/python-net/groupdocs.watermark.search.search_criteria/textformattingsearchcriteria/font_italic/) | The font italic flag indicating whether the watermark text uses an italic font. |
...
| [font_strikeout](/watermark/python-net/groupdocs.watermark.search.search_criteria/textformattingsearchcriteria/font_strikeout/) | The font strikeout flag for watermark text formatting. The default value is None, which means that the filter is not applied. |
| [font_underline](/watermark/python-net/groupdocs.watermark.search.search_criteria/textformattingsearchcriteria/font_underline/) | The font underline flag for the watermark text formatting. The default value is None, which means that the filter is not applied. |
