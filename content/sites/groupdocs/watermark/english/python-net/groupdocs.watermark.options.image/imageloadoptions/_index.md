...
description: 
type: docs
url: /python-net/groupdocs.watermark.options.image/imageloadoptions/
is_root: false
weight: 40
---
...
| :- | :- |
| [__init__](/watermark/python-net/groupdocs.watermark.options.image/imageloadoptions/__init__/) | Initializes a new instance of the [`ImageLoadOptions`](/watermark/python-net/groupdocs.watermark.options.image/imageloadoptions/) class. |
...
| Field | Description |
| :- | :- |
| [DEFAULT](/watermark/python-net/groupdocs.watermark.options.image/imageloadoptions/default/) | Gets the default value for the class. |
