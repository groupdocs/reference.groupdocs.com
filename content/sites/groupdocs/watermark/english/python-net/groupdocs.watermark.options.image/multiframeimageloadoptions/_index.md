...
The MultiframeImageLoadOptions type exposes the following members:

### Constructors
| Constructor | Description |
| :- | :- |
| [__init__](/watermark/python-net/groupdocs.watermark.options.image/multiframeimageloadoptions/__init__/) | Initializes a new instance of the [`MultiframeImageLoadOptions`](/watermark/python-net/groupdocs.watermark.options.image/multiframeimageloadoptions/) class. |
...
| Field | Description |
| :- | :- |
| [DEFAULT](/watermark/python-net/groupdocs.watermark.options.image/multiframeimageloadoptions/default/) | Gets the default value for the class. |
