...
The GifImageLoadOptions type exposes the following members:
...
| Field | Description |
| :- | :- |
| [DEFAULT](/watermark/python-net/groupdocs.watermark.options.image/gifimageloadoptions/default/) | Gets the default value for class. |
