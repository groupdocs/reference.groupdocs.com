...
description: "Initializes a new instance of the PdfPreviewOptions class, causing the output stream to be closed."
type: docs
...
Initializes a new instance of the PdfPreviewOptions class, causing the output stream to be closed.
