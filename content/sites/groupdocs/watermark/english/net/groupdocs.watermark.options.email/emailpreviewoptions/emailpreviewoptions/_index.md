...
description: Initializes a new instance of the EmailPreviewOptionsgroupdocs.watermark.options.email/emailpreviewoptions class causing the output stream to be closed.
type: docs
weight: 10
url: /net/groupdocs.watermark.options.email/emailpreviewoptions/emailpreviewoptions/
---
## EmailPreviewOptions(CreatePageStream) {#constructor}

Initializes a new instance of the [`EmailPreviewOptions`](../../emailpreviewoptions) class causing the output stream to be closed.
...
Initializes a new instance of [`EmailPreviewOptions`](../../emailpreviewoptions) class causing the output stream to be returned to the client for further use.
