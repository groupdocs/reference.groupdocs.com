...
type: docs
weight: 42
url: /java/com.groupdocs.watermark.options/presentationwatermarkmasternotesslideoptions/
---
**Inheritance:**
...
```
public final class PresentationWatermarkMasterNotesSlideOptions extends PresentationWatermarkBaseSlideOptions
```
