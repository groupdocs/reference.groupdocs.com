...
description: PowerPoint 문서의 도형 그리기 모음을 나타냅니다.
type: docs
weight: 960
url: /ko/net/groupdocs.watermark.contents.presentation/presentationshapecollection/
---
## PresentationShapeCollection class

PowerPoint 문서의 도형 그리기 모음을 나타냅니다.
...
이 컬렉션에는 다음 항목이 포함되어 있습니다.[`PresentationShape`](../presentationshape) 유형.
