...
description: PowerPoint 콘텐츠 레이아웃 슬라이드를 나타냅니다.
type: docs
weight: 880
url: /ko/net/groupdocs.watermark.contents.presentation/presentationlayoutslide/
---
## PresentationLayoutSlide class

PowerPoint 콘텐츠 레이아웃 슬라이드를 나타냅니다.
...
| [MasterSlide](../../groupdocs.watermark.contents.presentation/presentationlayoutslide/masterslide) { get; } | 이에 대한 마스터 슬라이드를 가져옵니다.[`PresentationLayoutSlide`](../presentationlayoutslide) . |
