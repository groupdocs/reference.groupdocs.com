...
description: PowerPoint 문서 내의 이미지를 나타냅니다.
type: docs
weight: 1020
url: /ko/net/groupdocs.watermark.contents.presentation/presentationwatermarkableimage/
---
## PresentationWatermarkableImage class

PowerPoint 문서 내의 이미지를 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [PresentationWatermarkableImage](presentationwatermarkableimage)(byte[]) | 의 새 인스턴스를 초기화합니다.[`PresentationWatermarkableImage`](../presentationwatermarkableimage) 지정된 이미지 데이터를 사용하는 클래스. |
