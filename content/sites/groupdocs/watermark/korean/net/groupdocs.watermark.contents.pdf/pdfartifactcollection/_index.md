...
description: pdf 콘텐츠의 아티팩트 모음을 나타냅니다.
type: docs
weight: 560
url: /ko/net/groupdocs.watermark.contents.pdf/pdfartifactcollection/
---
## PdfArtifactCollection class

pdf 콘텐츠의 아티팩트 모음을 나타냅니다.
...
이 컬렉션에는 다음 항목이 포함되어 있습니다.[`PdfArtifact`](../pdfartifact) 유형.
