...
description: PDF 문서의 첨부 파일 모음을 나타냅니다.
type: docs
weight: 600
url: /ko/net/groupdocs.watermark.contents.pdf/pdfattachmentcollection/
---
## PdfAttachmentCollection class

PDF 문서의 첨부 파일 모음을 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [Add](../../groupdocs.watermark.contents.pdf/pdfattachmentcollection/add)(byte[], string, string) | 에 첨부 파일을 추가합니다.[`PdfContent`](../pdfcontent) . |
...
이 컬렉션에는 다음 항목이 포함되어 있습니다.[`PdfAttachment`](../pdfattachment) 유형.
