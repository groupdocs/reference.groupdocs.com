...
description: PDF 문서의 주석 모음을 나타냅니다.
type: docs
weight: 530
url: /ko/net/groupdocs.watermark.contents.pdf/pdfannotationcollection/
---
## PdfAnnotationCollection class

PDF 문서의 주석 모음을 나타냅니다.
...
이 컬렉션에는 다음 항목이 포함되어 있습니다.[`PdfAnnotation`](../pdfannotation) 유형.
