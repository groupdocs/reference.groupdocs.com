...
description: Visio 문서의 하이퍼링크 모음을 나타냅니다.
type: docs
weight: 200
url: /ko/net/groupdocs.watermark.contents.diagram/diagramhyperlinkcollection/
---
## DiagramHyperlinkCollection class

Visio 문서의 하이퍼링크 모음을 나타냅니다.
...
이 컬렉션에는 다음 항목이 포함되어 있습니다.[`DiagramHyperlink`](../diagramhyperlink) 유형.
