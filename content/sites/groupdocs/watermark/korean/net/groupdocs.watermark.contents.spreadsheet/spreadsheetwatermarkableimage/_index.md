...
description: Excel 문서 내부의 이미지를 나타냅니다.
type: docs
weight: 1250
url: /ko/net/groupdocs.watermark.contents.spreadsheet/spreadsheetwatermarkableimage/
---
## SpreadsheetWatermarkableImage class

Excel 문서 내부의 이미지를 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [SpreadsheetWatermarkableImage](spreadsheetwatermarkableimage)(byte[]) | 의 새 인스턴스를 초기화합니다.[`SpreadsheetWatermarkableImage`](../spreadsheetwatermarkableimage) class 지정된 이미지 데이터 사용. |
