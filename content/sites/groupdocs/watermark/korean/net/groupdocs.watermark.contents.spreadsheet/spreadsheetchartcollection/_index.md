...
description: Excel 문서의 차트 모음을 나타냅니다.
type: docs
weight: 1090
url: /ko/net/groupdocs.watermark.contents.spreadsheet/spreadsheetchartcollection/
---
## SpreadsheetChartCollection class

Excel 문서의 차트 모음을 나타냅니다.
...
이 컬렉션에는 다음 항목이 포함되어 있습니다.[`SpreadsheetChart`](../spreadsheetchart) 유형.
