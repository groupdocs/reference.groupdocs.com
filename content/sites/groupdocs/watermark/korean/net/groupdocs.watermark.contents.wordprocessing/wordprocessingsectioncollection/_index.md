...
description: Word 문서의 섹션 모음을 나타냅니다.
type: docs
weight: 1380
url: /ko/net/groupdocs.watermark.contents.wordprocessing/wordprocessingsectioncollection/
---
## WordProcessingSectionCollection class

Word 문서의 섹션 모음을 나타냅니다.
...
이 컬렉션에는 다음 항목이 포함되어 있습니다.[`WordProcessingSection`](../wordprocessingsection) 유형.
