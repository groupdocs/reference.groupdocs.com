...
description: Word 문서의 도형 모음을 나타냅니다.
type: docs
weight: 1400
url: /ko/net/groupdocs.watermark.contents.wordprocessing/wordprocessingshapecollection/
---
## WordProcessingShapeCollection class

Word 문서의 도형 모음을 나타냅니다.
...
이 컬렉션에는 다음 항목이 포함되어 있습니다.[`WordProcessingShape`](../wordprocessingshape) 유형.
