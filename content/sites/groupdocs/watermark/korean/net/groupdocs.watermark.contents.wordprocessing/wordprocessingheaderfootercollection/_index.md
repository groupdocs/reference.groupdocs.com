...
description: Word 문서의 머리글 및 바닥글 모음을 나타냅니다.
type: docs
weight: 1310
url: /ko/net/groupdocs.watermark.contents.wordprocessing/wordprocessingheaderfootercollection/
---
...
| [Item](../../groupdocs.watermark.contents.wordprocessing/wordprocessingheaderfootercollection/item) { get; } | 지정된 유형의 머리글 또는 바닥글을 가져옵니다. |
...
| [LinkToPrevious](../../groupdocs.watermark.contents.wordprocessing/wordprocessingheaderfootercollection/linktoprevious)(bool) | 모든 머리글과 바닥글을 이전 섹션의 해당 머리글과 바닥글에 연결하거나 연결 해제합니다. |

### 비고

이 컬렉션에는 다음 항목이 포함되어 있습니다.[`WordProcessingHeaderFooter`](../wordprocessingheaderfooter) 유형.
