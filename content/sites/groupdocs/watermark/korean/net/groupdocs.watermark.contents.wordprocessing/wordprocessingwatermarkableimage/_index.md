...
description: Word 문서 내부의 이미지를 나타냅니다.
type: docs
weight: 1460
url: /ko/net/groupdocs.watermark.contents.wordprocessing/wordprocessingwatermarkableimage/
---
## WordProcessingWatermarkableImage class

Word 문서 내부의 이미지를 나타냅니다.
...
| 이름 | 설명 |
| --- | --- |
| [WordProcessingWatermarkableImage](wordprocessingwatermarkableimage)(byte[]) | 의 새 인스턴스를 초기화합니다.[`WordProcessingWatermarkableImage`](../wordprocessingwatermarkableimage) 지정된 이미지 데이터를 사용하는 클래스. |
