...
description: 의 새 인스턴스를 초기화합니다.PdfPreviewOptionsgroupdocs.watermark.options.pdf/pdfpreviewoptions 출력 스트림을 닫는 클래스.
type: docs
weight: 10
url: /ko/net/groupdocs.watermark.options.pdf/pdfpreviewoptions/pdfpreviewoptions/
---
## PdfPreviewOptions(CreatePageStream) {#constructor}

의 새 인스턴스를 초기화합니다.[`PdfPreviewOptions`](../../pdfpreviewoptions) 출력 스트림을 닫는 클래스.
...
의 새 인스턴스를 초기화합니다.[`PdfPreviewOptions`](../../pdfpreviewoptions) 추가 사용을 위해 출력 스트림이 클라이언트에 반환되도록 하는 클래스입니다.
