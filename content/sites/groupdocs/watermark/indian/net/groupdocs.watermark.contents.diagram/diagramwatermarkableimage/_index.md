...
description: एक वसओ दस्तवेज़ के अंदर एक छव क प्रतनधत्व करत है
type: docs
weight: 260
url: /hi/net/groupdocs.watermark.contents.diagram/diagramwatermarkableimage/
---
## DiagramWatermarkableImage class

एक विसिओ दस्तावेज़ के अंदर एक छवि का प्रतिनिधित्व करता है।
...
| नाम | विवरण |
| --- | --- |
| [DiagramWatermarkableImage](diagramwatermarkableimage)(byte[]) | का एक नया उदाहरण प्रारंभ करता है[`DiagramWatermarkableImage`](../diagramwatermarkableimage) वर्ग निर्दिष्ट छवि डेटा का उपयोग कर। |
