...
description: प्रस्तुतकरण दस्तवेज़ नट स्लइड में वटरमर्क जड़ते समय वकल्पं क प्रतनधत्व करत है
type: docs
weight: 2040
url: /hi/net/groupdocs.watermark.options.presentation/presentationwatermarknoteslideoptions/
---
## PresentationWatermarkNoteSlideOptions class

प्रस्तुतीकरण दस्तावेज़ नोट स्लाइड में वॉटरमार्क जोड़ते समय विकल्पों का प्रतिनिधित्व करता है।
...
| नाम | विवरण |
| --- | --- |
| [PresentationWatermarkNoteSlideOptions](presentationwatermarknoteslideoptions)() | का एक नया उदाहरण प्रारंभ करता है[`PresentationWatermarkNoteSlideOptions`](../presentationwatermarknoteslideoptions) वर्ग. |
...
| [SlideIndex](../../groupdocs.watermark.options.presentation/presentationwatermarknoteslideoptions/slideindex) { get; set; } | स्लाइड को नोट करने के लिए वॉटरमार्क जोड़ने के लिए स्लाइड का इंडेक्स प्राप्त या सेट करता है। |
