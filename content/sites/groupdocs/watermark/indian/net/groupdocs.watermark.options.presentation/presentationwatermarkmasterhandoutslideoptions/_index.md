...
description: प्रस्तुतकरण दस्तवेज़ मस्टर हैंडआउट स्लइड में वटरमर्क जड़ते समय वकल्पं क प्रतनधत्व करत है
type: docs
weight: 2010
url: /hi/net/groupdocs.watermark.options.presentation/presentationwatermarkmasterhandoutslideoptions/
---
## PresentationWatermarkMasterHandoutSlideOptions class

प्रस्तुतीकरण दस्तावेज़ मास्टर हैंडआउट स्लाइड में वॉटरमार्क जोड़ते समय विकल्पों का प्रतिनिधित्व करता है।
...
| नाम | विवरण |
| --- | --- |
| [PresentationWatermarkMasterHandoutSlideOptions](presentationwatermarkmasterhandoutslideoptions)() | का एक नया उदाहरण प्रारंभ करता है[`PresentationWatermarkMasterHandoutSlideOptions`](../presentationwatermarkmasterhandoutslideoptions) वर्ग. |
