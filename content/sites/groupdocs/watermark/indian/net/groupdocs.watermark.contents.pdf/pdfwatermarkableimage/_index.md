...
description: एक पडएफ दस्तवेज़ के अंदर एक छव क प्रतनधत्व करत है
type: docs
weight: 730
url: /hi/net/groupdocs.watermark.contents.pdf/pdfwatermarkableimage/
---
## PdfWatermarkableImage class

एक पीडीएफ दस्तावेज़ के अंदर एक छवि का प्रतिनिधित्व करता है।
...
| नाम | विवरण |
| --- | --- |
| [PdfWatermarkableImage](pdfwatermarkableimage)(byte[]) | का एक नया उदाहरण प्रारंभ करता है[`PdfWatermarkableImage`](../pdfwatermarkableimage) वर्ग निर्दिष्ट छवि डेटा का उपयोग कर। |
