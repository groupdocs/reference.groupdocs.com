...
description: एक पडएफ समग्र में कलकृतयं के संग्रह क प्रतनधत्व करत है
type: docs
weight: 560
url: /hi/net/groupdocs.watermark.contents.pdf/pdfartifactcollection/
---
## PdfArtifactCollection class

एक पीडीएफ सामग्री में कलाकृतियों के संग्रह का प्रतिनिधित्व करता है।
...
इस संग्रह में के आइटम हैं[`PdfArtifact`](../pdfartifact) टाइप.
