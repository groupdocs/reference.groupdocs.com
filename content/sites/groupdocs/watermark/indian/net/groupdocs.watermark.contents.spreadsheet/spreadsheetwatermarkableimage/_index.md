...
description: एक एक्सेल दस्तवेज़ के अंदर एक छव क प्रतनधत्व करत है
type: docs
weight: 1250
url: /hi/net/groupdocs.watermark.contents.spreadsheet/spreadsheetwatermarkableimage/
---
## SpreadsheetWatermarkableImage class

एक एक्सेल दस्तावेज़ के अंदर एक छवि का प्रतिनिधित्व करता है।
...
| नाम | विवरण |
| --- | --- |
| [SpreadsheetWatermarkableImage](spreadsheetwatermarkableimage)(byte[]) | का एक नया उदाहरण प्रारंभ करता है[`SpreadsheetWatermarkableImage`](../spreadsheetwatermarkableimage) निर्दिष्ट छवि डेटा का उपयोग करते हुए class |
