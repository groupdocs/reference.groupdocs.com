...
description: एक PowerPoint दस्तवेज़ के अंदर एक छव क प्रतनधत्व करत है
type: docs
weight: 1020
url: /hi/net/groupdocs.watermark.contents.presentation/presentationwatermarkableimage/
---
## PresentationWatermarkableImage class

एक PowerPoint दस्तावेज़ के अंदर एक छवि का प्रतिनिधित्व करता है।
...
| नाम | विवरण |
| --- | --- |
| [PresentationWatermarkableImage](presentationwatermarkableimage)(byte[]) | का एक नया उदाहरण प्रारंभ करता है[`PresentationWatermarkableImage`](../presentationwatermarkableimage) निर्दिष्ट छवि डेटा का उपयोग करते हुए वर्ग. |
