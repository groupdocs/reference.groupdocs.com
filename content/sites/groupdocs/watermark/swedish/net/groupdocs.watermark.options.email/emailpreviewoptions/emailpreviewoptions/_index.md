...
description: Initierar en ny instans avEmailPreviewOptionsgroupdocs.watermark.options.email/emailpreviewoptions klass som gör att utgångsströmmen stängs.
type: docs
weight: 10
url: /sv/net/groupdocs.watermark.options.email/emailpreviewoptions/emailpreviewoptions/
---
## EmailPreviewOptions(CreatePageStream) {#constructor}

Initierar en ny instans av[`EmailPreviewOptions`](../../emailpreviewoptions) klass som gör att utgångsströmmen stängs.
...
Initierar en ny instans av[`EmailPreviewOptions`](../../emailpreviewoptions) klass som gör att utgångsströmmen returneras till klienten för vidare användning.
