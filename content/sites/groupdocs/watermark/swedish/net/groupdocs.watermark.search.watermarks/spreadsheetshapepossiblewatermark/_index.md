...
description: Representerar möjlig formvattenstämpel i ett Exceldokument.
type: docs
weight: 3000
url: /sv/net/groupdocs.watermark.search.watermarks/spreadsheetshapepossiblewatermark/
---
## SpreadsheetShapePossibleWatermark class

Representerar möjlig formvattenstämpel i ett Excel-dokument.
...
| override [Parent](../../groupdocs.watermark.search.watermarks/spreadsheetshapepossiblewatermark/parent) { get; } | Hämtar föräldern till detta[`SpreadsheetShapePossibleWatermark`](../spreadsheetshapepossiblewatermark) . |
