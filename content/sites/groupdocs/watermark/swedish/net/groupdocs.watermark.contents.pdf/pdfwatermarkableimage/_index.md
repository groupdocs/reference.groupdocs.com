...
description: Representerar en bild i ett pdfdokument.
type: docs
weight: 730
url: /sv/net/groupdocs.watermark.contents.pdf/pdfwatermarkableimage/
---
## PdfWatermarkableImage class

Representerar en bild i ett pdf-dokument.
...
| namn | Beskrivning |
| --- | --- |
| [PdfWatermarkableImage](pdfwatermarkableimage)(byte[]) | Initierar en ny instans av[`PdfWatermarkableImage`](../pdfwatermarkableimage) klass med angivna bilddata. |
