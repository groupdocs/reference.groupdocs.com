...
description: Representerar en bild inuti ett PowerPointdokument.
type: docs
weight: 1020
url: /sv/net/groupdocs.watermark.contents.presentation/presentationwatermarkableimage/
---
## PresentationWatermarkableImage class

Representerar en bild inuti ett PowerPoint-dokument.
...
| namn | Beskrivning |
| --- | --- |
| [PresentationWatermarkableImage](presentationwatermarkableimage)(byte[]) | Initierar en ny instans av[`PresentationWatermarkableImage`](../presentationwatermarkableimage) klass med angivna bilddata. |
