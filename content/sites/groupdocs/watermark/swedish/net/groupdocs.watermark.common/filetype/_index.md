...
| static readonly [VSTX](../../groupdocs.watermark.common/filetype/vstx) | Filer med VSTX-tillägg är ritmallsfiler skapade med Microsoft Visio 2013 och senare. Läs mer om detta filformat [här](https://wiki.fileformat.com/image/vstx/) . |
