...
description: Αντιπροσωπεύει μια συλλογή από πιθανά υδατογραφήματα που βρίσκονται σε ένα περιεχόμενο.
type: docs
weight: 2550
url: /el/net/groupdocs.watermark.search/possiblewatermarkcollection/
---
## PossibleWatermarkCollection class

Αντιπροσωπεύει μια συλλογή από πιθανά υδατογραφήματα που βρίσκονται σε ένα περιεχόμενο.
...
Αυτή η συλλογή περιέχει τα στοιχεία του[`PossibleWatermark`](../possiblewatermark) τύπος.
