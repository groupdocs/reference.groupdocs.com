...
description: Αντιπροσωπεύει μια συλλογή υπερσυνδέσμων σε ένα έγγραφο του Visio.
type: docs
weight: 200
url: /el/net/groupdocs.watermark.contents.diagram/diagramhyperlinkcollection/
---
## DiagramHyperlinkCollection class

Αντιπροσωπεύει μια συλλογή υπερσυνδέσμων σε ένα έγγραφο του Visio.
...
Αυτή η συλλογή περιέχει τα στοιχεία του[`DiagramHyperlink`](../diagramhyperlink) τύπος.
