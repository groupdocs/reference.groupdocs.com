...
description: Αντιπροσωπεύει μια συλλογή σχολιασμών σε ένα έγγραφο pdf.
type: docs
weight: 530
url: /el/net/groupdocs.watermark.contents.pdf/pdfannotationcollection/
---
## PdfAnnotationCollection class

Αντιπροσωπεύει μια συλλογή σχολιασμών σε ένα έγγραφο pdf.
...
Αυτή η συλλογή περιέχει τα στοιχεία του[`PdfAnnotation`](../pdfannotation) τύπος.
