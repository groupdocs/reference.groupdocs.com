...
description: Αντιπροσωπεύει μια συλλογή από ενσωματωμένα αντικείμενα σε ένα μήνυμα email.
type: docs
weight: 350
url: /el/net/groupdocs.watermark.contents.email/emailembeddedobjectcollection/
---
## EmailEmbeddedObjectCollection class

Αντιπροσωπεύει μια συλλογή από ενσωματωμένα αντικείμενα σε ένα μήνυμα email.
...
| Ονομα | Περιγραφή |
| --- | --- |
| [Add](../../groupdocs.watermark.contents.email/emailembeddedobjectcollection/add)(byte[], string) | Προσθέτει έναν ενσωματωμένο πόρο στο[`EmailContent`](../emailcontent) . |
...
Αυτή η συλλογή περιέχει τα στοιχεία του[`EmailEmbeddedObject`](../emailembeddedobject) τύπος.
