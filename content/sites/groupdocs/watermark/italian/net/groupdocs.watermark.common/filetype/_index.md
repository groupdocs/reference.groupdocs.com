...
| static readonly [FlatOpcTemplate](../../groupdocs.watermark.common/filetype/flatopctemplate) | Modello Office Open XML WordprocessingML (privo di macro) memorizzato in un file XML piatto anziché in un pacchetto ZIP (.xml). Ulteriori informazioni su questo formato di file[Qui](https://en.wikipedia.org/wiki/Office_Open_XML) . |
...
| static readonly [VDW](../../groupdocs.watermark.common/filetype/vdw) | VDW è il formato di file di Visio Graphics Service che specifica i flussi e gli archivi necessari per il rendering di un disegno Web. Ulteriori informazioni su questo formato di file [Qui](https://wiki.fileformat.com/web/vdw/) . |
...
Questa classe fornisce metodi per ottenere l'elenco di tutti i tipi di file supportati da**GroupDocs.Filigrana**.**Saperne di più**
