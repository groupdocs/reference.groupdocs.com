...
description: Rappresenta le opzioni quando si aggiunge la filigrana a una diapositiva della dispensa principale del documento di presentazione.
type: docs
weight: 2010
url: /it/net/groupdocs.watermark.options.presentation/presentationwatermarkmasterhandoutslideoptions/
---
## PresentationWatermarkMasterHandoutSlideOptions class

Rappresenta le opzioni quando si aggiunge la filigrana a una diapositiva della dispensa principale del documento di presentazione.
...
| Nome | Descrizione |
| --- | --- |
| [PresentationWatermarkMasterHandoutSlideOptions](presentationwatermarkmasterhandoutslideoptions)() | Inizializza una nuova istanza di[`PresentationWatermarkMasterHandoutSlideOptions`](../presentationwatermarkmasterhandoutslideoptions) classe. |
