...
description: Rappresenta unimmagine allinterno di un documento Word.
type: docs
weight: 1460
url: /it/net/groupdocs.watermark.contents.wordprocessing/wordprocessingwatermarkableimage/
---
## WordProcessingWatermarkableImage class

Rappresenta un'immagine all'interno di un documento Word.
...
| Nome | Descrizione |
| --- | --- |
| [WordProcessingWatermarkableImage](wordprocessingwatermarkableimage)(byte[]) | Inizializza una nuova istanza di[`WordProcessingWatermarkableImage`](../wordprocessingwatermarkableimage) classe utilizzando i dati dell'immagine specificati. |
