...
description: Rappresenta una filigrana di forma possibile in un documento Visio.
type: docs
weight: 2770
url: /it/net/groupdocs.watermark.search.watermarks/diagramshapepossiblewatermark/
---
## DiagramShapePossibleWatermark class

Rappresenta una filigrana di forma possibile in un documento Visio.
...
| override [Parent](../../groupdocs.watermark.search.watermarks/diagramshapepossiblewatermark/parent) { get; } | Ottiene il genitore di this[`DiagramShapePossibleWatermark`](../diagramshapepossiblewatermark) . |
