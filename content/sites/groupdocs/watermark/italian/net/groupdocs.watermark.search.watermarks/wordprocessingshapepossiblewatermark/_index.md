...
description: Rappresenta una filigrana di forma possibile in un documento Word.
type: docs
weight: 3010
url: /it/net/groupdocs.watermark.search.watermarks/wordprocessingshapepossiblewatermark/
---
## WordProcessingShapePossibleWatermark class

Rappresenta una filigrana di forma possibile in un documento Word.
...
| override [Parent](../../groupdocs.watermark.search.watermarks/wordprocessingshapepossiblewatermark/parent) { get; } | Ottiene il genitore di this[`WordProcessingShapePossibleWatermark`](../wordprocessingshapepossiblewatermark) . |
