...
description: Rappresenta la possibile filigrana XObject in un contenuto pdf.
type: docs
weight: 2890
url: /it/net/groupdocs.watermark.search.watermarks/pdfxobjectpossiblewatermark/
---
## PdfXObjectPossibleWatermark class

Rappresenta la possibile filigrana XObject in un contenuto pdf.
...
| override [Parent](../../groupdocs.watermark.search.watermarks/pdfxobjectpossiblewatermark/parent) { get; } | Ottiene il genitore di this[`PdfXObjectPossibleWatermark`](../pdfxobjectpossiblewatermark) . |
