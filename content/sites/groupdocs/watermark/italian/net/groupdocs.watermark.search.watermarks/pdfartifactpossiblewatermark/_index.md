...
description: Rappresenta una possibile filigrana artefatto in un contenuto pdf.
type: docs
weight: 2850
url: /it/net/groupdocs.watermark.search.watermarks/pdfartifactpossiblewatermark/
---
## PdfArtifactPossibleWatermark class

Rappresenta una possibile filigrana artefatto in un contenuto pdf.
...
| override [Parent](../../groupdocs.watermark.search.watermarks/pdfartifactpossiblewatermark/parent) { get; } | Ottiene il genitore di this[`PdfArtifactPossibleWatermark`](../pdfartifactpossiblewatermark) . |
