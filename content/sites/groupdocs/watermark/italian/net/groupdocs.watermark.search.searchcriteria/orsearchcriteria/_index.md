...
description: Rappresenta i criteri di ricerca compositi OR.
type: docs
weight: 2650
url: /it/net/groupdocs.watermark.search.searchcriteria/orsearchcriteria/
---
## OrSearchCriteria class

Rappresenta i criteri di ricerca compositi OR.
...
| Nome | Descrizione |
| --- | --- |
| [Left](../../groupdocs.watermark.search.searchcriteria/orsearchcriteria/left) { get; } | Ottiene i criteri di ricerca a sinistra. |
| [Right](../../groupdocs.watermark.search.searchcriteria/orsearchcriteria/right) { get; } | Ottiene i criteri di ricerca corretti. |
