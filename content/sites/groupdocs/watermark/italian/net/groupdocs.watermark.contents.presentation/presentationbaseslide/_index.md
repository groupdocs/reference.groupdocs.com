...
description: Fornisce la classe base astratta per diapositive di tutti i tipi in un documento PowerPoint.
type: docs
weight: 800
url: /it/net/groupdocs.watermark.contents.presentation/presentationbaseslide/
---
## PresentationBaseSlide class

Fornisce la classe base astratta per diapositive di tutti i tipi in un documento PowerPoint.
