...
description: Rappresenta una diapositiva master per tutte le diapositive delle note in un documento PowerPoint.
type: docs
weight: 910
url: /it/net/groupdocs.watermark.contents.presentation/presentationmasternotesslide/
---
## PresentationMasterNotesSlide class

Rappresenta una diapositiva master per tutte le diapositive delle note in un documento PowerPoint.
