...
description: Rappresenta unimmagine allinterno di un documento Excel.
type: docs
weight: 1250
url: /it/net/groupdocs.watermark.contents.spreadsheet/spreadsheetwatermarkableimage/
---
## SpreadsheetWatermarkableImage class

Rappresenta un'immagine all'interno di un documento Excel.
...
| Nome | Descrizione |
| --- | --- |
| [SpreadsheetWatermarkableImage](spreadsheetwatermarkableimage)(byte[]) | Inizializza una nuova istanza di[`SpreadsheetWatermarkableImage`](../spreadsheetwatermarkableimage) class utilizzando i dati dell'immagine specificati. |
