...
description: Rappresenta una raccolta di possibili filigrane trovate in un contenuto.
type: docs
weight: 2550
url: /it/net/groupdocs.watermark.search/possiblewatermarkcollection/
---
## PossibleWatermarkCollection class

Rappresenta una raccolta di possibili filigrane trovate in un contenuto.
...
Questa raccolta contiene gli elementi di[`PossibleWatermark`](../possiblewatermark) tipo.
