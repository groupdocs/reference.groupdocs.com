...
description: Представляет мастерслайд для всех слайдов заметок в документе PowerPoint.
type: docs
weight: 910
url: /ru/net/groupdocs.watermark.contents.presentation/presentationmasternotesslide/
---
## PresentationMasterNotesSlide class

Представляет мастер-слайд для всех слайдов заметок в документе PowerPoint.
