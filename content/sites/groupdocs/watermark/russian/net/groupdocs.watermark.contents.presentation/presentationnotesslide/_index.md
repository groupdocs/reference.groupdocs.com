...
description: Представляет слайд с примечаниями к документу PowerPoint.
type: docs
weight: 940
url: /ru/net/groupdocs.watermark.contents.presentation/presentationnotesslide/
---
## PresentationNotesSlide class

Представляет слайд с примечаниями к документу PowerPoint.
