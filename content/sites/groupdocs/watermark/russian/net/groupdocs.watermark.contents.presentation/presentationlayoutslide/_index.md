...
description: Представляет слайд макета содержимого PowerPoint.
type: docs
weight: 880
url: /ru/net/groupdocs.watermark.contents.presentation/presentationlayoutslide/
---
## PresentationLayoutSlide class

Представляет слайд макета содержимого PowerPoint.
...
| [MasterSlide](../../groupdocs.watermark.contents.presentation/presentationlayoutslide/masterslide) { get; } | Получает мастер-слайд для этого[`PresentationLayoutSlide`](../presentationlayoutslide) . |
