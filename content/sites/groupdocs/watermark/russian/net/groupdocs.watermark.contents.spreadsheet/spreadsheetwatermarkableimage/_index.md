...
description: Представляет изображение внутри документа Excel.
type: docs
weight: 1250
url: /ru/net/groupdocs.watermark.contents.spreadsheet/spreadsheetwatermarkableimage/
---
## SpreadsheetWatermarkableImage class

Представляет изображение внутри документа Excel.
...
| Имя | Описание |
| --- | --- |
| [SpreadsheetWatermarkableImage](spreadsheetwatermarkableimage)(byte[]) | Инициализирует новый экземпляр[`SpreadsheetWatermarkableImage`](../spreadsheetwatermarkableimage) class с использованием указанных данных изображения. |
