...
description: Представляет изображение в формате gif на которое можно поместить водяной знак.
type: docs
weight: 360
url: /ru/net/groupdocs.watermark.contents.image/gifimagecontent/
---
## GifImageContent class

Представляет изображение в формате gif, на которое можно поместить водяной знак.
