...
description: Представляет изображение внутри документа Visio.
type: docs
weight: 260
url: /ru/net/groupdocs.watermark.contents.diagram/diagramwatermarkableimage/
---
## DiagramWatermarkableImage class

Представляет изображение внутри документа Visio.
...
| Имя | Описание |
| --- | --- |
| [DiagramWatermarkableImage](diagramwatermarkableimage)(byte[]) | Инициализирует новый экземпляр[`DiagramWatermarkableImage`](../diagramwatermarkableimage) класс, использующий указанные данные изображения. |
