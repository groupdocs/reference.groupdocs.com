...
description: 表示 Visio 文档中可能的超链接水印
type: docs
weight: 2760
url: /zh/net/groupdocs.watermark.search.watermarks/diagramhyperlinkpossiblewatermark/
---
## DiagramHyperlinkPossibleWatermark class

表示 Visio 文档中可能的超链接水印。
...
| override [Text](../../groupdocs.watermark.search.watermarks/diagramhyperlinkpossiblewatermark/text) { get; set; } | 获取或设置 this 的 url[`DiagramHyperlinkPossibleWatermark`](../diagramhyperlinkpossiblewatermark). |
