...
description: 表示 PowerPoint 文档中可能的形状水印
type: docs
weight: 2930
url: /zh/net/groupdocs.watermark.search.watermarks/presentationshapepossiblewatermark/
---
## PresentationShapePossibleWatermark class

表示 PowerPoint 文档中可能的形状水印。
...
| override [Parent](../../groupdocs.watermark.search.watermarks/presentationshapepossiblewatermark/parent) { get; } | 获取这个的父级[`PresentationShapePossibleWatermark`](../presentationshapepossiblewatermark). |
