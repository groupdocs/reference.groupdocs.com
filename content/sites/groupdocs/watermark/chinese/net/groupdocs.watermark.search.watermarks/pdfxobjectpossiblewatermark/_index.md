...
description: 表示 pdf 内容中可能存在的 XObject 水印
type: docs
weight: 2890
url: /zh/net/groupdocs.watermark.search.watermarks/pdfxobjectpossiblewatermark/
---
## PdfXObjectPossibleWatermark class

表示 pdf 内容中可能存在的 XObject 水印。
...
| override [Parent](../../groupdocs.watermark.search.watermarks/pdfxobjectpossiblewatermark/parent) { get; } | 获取这个的父级[`PdfXObjectPossibleWatermark`](../pdfxobjectpossiblewatermark). |
