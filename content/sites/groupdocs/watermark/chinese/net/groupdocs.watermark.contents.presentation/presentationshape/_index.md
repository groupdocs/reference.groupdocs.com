...
| [FormattedTextFragments](../../groupdocs.watermark.contents.presentation/presentationshape/formattedtextfragments) { get; } | 获取此格式化文本片段的集合[`PresentationShape`](../presentationshape). |
...
| [RotateAngle](../../groupdocs.watermark.contents.presentation/presentationshape/rotateangle) { get; set; } | 获取或设置 this 的旋转角度[`PresentationShape`](../presentationshape)度数. |
| [ShapeType](../../groupdocs.watermark.contents.presentation/presentationshape/shapetype) { get; } | 获取形状几何预设类型。 |
| [Text](../../groupdocs.watermark.contents.presentation/presentationshape/text) { get; set; } | 获取或设置 this 的文本[`PresentationShape`](../presentationshape). |
