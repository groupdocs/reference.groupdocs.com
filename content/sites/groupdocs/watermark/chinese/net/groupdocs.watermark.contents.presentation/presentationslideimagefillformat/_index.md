...
description: 表示 PowerPoint 文档中幻灯片的图像填充格式设置
type: docs
weight: 1010
url: /zh/net/groupdocs.watermark.contents.presentation/presentationslideimagefillformat/
---
## PresentationSlideImageFillFormat class

表示 PowerPoint 文档中幻灯片的图像填充格式设置。
