...
description: 表示 PowerPoint 文档幻灯片
type: docs
weight: 990
url: /zh/net/groupdocs.watermark.contents.presentation/presentationslide/
---
...
| [LayoutSlide](../../groupdocs.watermark.contents.presentation/presentationslide/layoutslide) { get; } | 获取此布局幻灯片[`PresentationSlide`](../presentationslide). |
| [MasterSlide](../../groupdocs.watermark.contents.presentation/presentationslide/masterslide) { get; } | 获取此母版幻灯片[`PresentationSlide`](../presentationslide). |
| [NotesSlide](../../groupdocs.watermark.contents.presentation/presentationslide/notesslide) { get; } | 获取此的注释幻灯片[`PresentationSlide`](../presentationslide). |
