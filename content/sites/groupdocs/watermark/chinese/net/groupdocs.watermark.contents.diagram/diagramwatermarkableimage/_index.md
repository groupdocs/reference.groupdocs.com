...
description: 表示 Visio 文档中的图像
type: docs
weight: 260
url: /zh/net/groupdocs.watermark.contents.diagram/diagramwatermarkableimage/
---
...
| 姓名 | 描述 |
| --- | --- |
| [DiagramWatermarkableImage](diagramwatermarkableimage)(byte[]) | 初始化一个新的实例[`DiagramWatermarkableImage`](../diagramwatermarkableimage)使用指定图像数据的类. |
