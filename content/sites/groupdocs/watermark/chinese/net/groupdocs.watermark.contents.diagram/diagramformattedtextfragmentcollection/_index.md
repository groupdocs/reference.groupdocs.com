...
description: 表示 Visio 文档中格式化文本片段的集合
type: docs
weight: 160
url: /zh/net/groupdocs.watermark.contents.diagram/diagramformattedtextfragmentcollection/
---
## DiagramFormattedTextFragmentCollection class

表示 Visio 文档中格式化文本片段的集合。
...
此集合包含以下项目[`DiagramFormattedTextFragment`](../diagramformattedtextfragment)类型.
