...
description: 获取或设置添加水印时使用的 pdf 页边距
type: docs
weight: 20
...
此属性仅在以下情况下有效[`ConsiderParentMargins`](../../../groupdocs.watermark/watermark/considerparentmargins)设置为真。 如果[`ConsiderParentMargins`](../../../groupdocs.watermark/watermark/considerparentmargins)为假，当pdf CropBox 用作 水印区域时。
