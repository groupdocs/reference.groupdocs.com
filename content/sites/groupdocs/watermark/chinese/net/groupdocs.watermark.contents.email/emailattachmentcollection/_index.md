...
| 姓名 | 描述 |
| --- | --- |
| [Add](../../groupdocs.watermark.contents.email/emailattachmentcollection/add)(byte[], string) | 将附件添加到[`EmailContent`](../emailcontent). |
...
此集合包含以下项目[`EmailAttachment`](../emailattachment)类型.
