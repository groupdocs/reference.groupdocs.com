...
description: 表示电子邮件中嵌入对象的集合
type: docs
weight: 350
url: /zh/net/groupdocs.watermark.contents.email/emailembeddedobjectcollection/
---
...
| 姓名 | 描述 |
| --- | --- |
| [Add](../../groupdocs.watermark.contents.email/emailembeddedobjectcollection/add)(byte[], string) | 将嵌入资源添加到[`EmailContent`](../emailcontent). |
...
此集合包含以下项目[`EmailEmbeddedObject`](../emailembeddedobject)类型.
