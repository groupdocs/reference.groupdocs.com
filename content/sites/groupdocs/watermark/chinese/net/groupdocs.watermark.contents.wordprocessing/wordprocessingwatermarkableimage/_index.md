...
description: 表示 Word 文档中的图像
type: docs
weight: 1460
url: /zh/net/groupdocs.watermark.contents.wordprocessing/wordprocessingwatermarkableimage/
---
...
| 姓名 | 描述 |
| --- | --- |
| [WordProcessingWatermarkableImage](wordprocessingwatermarkableimage)(byte[]) | 初始化一个新的实例[`WordProcessingWatermarkableImage`](../wordprocessingwatermarkableimage)使用指定图像数据的类. |
