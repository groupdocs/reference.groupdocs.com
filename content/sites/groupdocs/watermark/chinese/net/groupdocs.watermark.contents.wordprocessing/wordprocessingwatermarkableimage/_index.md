...
| 姓名 | 描述 |
| --- | --- |
| [WordProcessingWatermarkableImage](wordprocessingwatermarkableimage)(byte[]) | 初始化[`WordProcessingWatermarkableImage`](../wordprocessingwatermarkableimage)使用指定图像数据的类。 |
