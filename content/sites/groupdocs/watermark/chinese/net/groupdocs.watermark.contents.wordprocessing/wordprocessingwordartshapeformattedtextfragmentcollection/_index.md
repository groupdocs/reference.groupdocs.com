...
description: 表示 Word 文档艺术字形状中格式化文本片段的集合
type: docs
weight: 1480
...
此集合包含以下项目[`WordProcessingWordArtShapeFormattedTextFragment`](../wordprocessingwordartshapeformattedtextfragment)类型.
