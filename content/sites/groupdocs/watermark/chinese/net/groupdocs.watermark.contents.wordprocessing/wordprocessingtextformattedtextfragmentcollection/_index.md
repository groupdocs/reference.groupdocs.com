...
description: 表示 Word 文档正文中格式化文本片段的集合
type: docs
weight: 1440
url: /zh/net/groupdocs.watermark.contents.wordprocessing/wordprocessingtextformattedtextfragmentcollection/
---
## WordProcessingTextFormattedTextFragmentCollection class

表示 Word 文档正文中格式化文本片段的集合。
