...
description: 表示 Word 文档形状中格式化文本片段的集合
type: docs
weight: 1410
...
此集合包含以下项目[`WordProcessingTextFormattedTextFragment`](../wordprocessingtextformattedtextfragment)类型.
