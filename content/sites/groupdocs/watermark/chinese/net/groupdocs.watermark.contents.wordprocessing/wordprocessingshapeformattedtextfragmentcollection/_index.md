...
description: 表示 Word 文档形状中的格式化文本片段的集合
type: docs
weight: 1410
url: /zh/net/groupdocs.watermark.contents.wordprocessing/wordprocessingshapeformattedtextfragmentcollection/
---
## WordProcessingShapeFormattedTextFragmentCollection class

表示 Word 文档形状中的格式化文本片段的集合。
...
此集合包含的项目[`WordProcessingTextFormattedTextFragment`](../wordprocessingtextformattedtextfragment)类型.
