...
description: 表示 Excel 文档文本形状中格式化文本片段的集合
type: docs
weight: 1220
url: /zh/net/groupdocs.watermark.contents.spreadsheet/spreadsheetshapeformattedtextfragmentcollection/
---
## SpreadsheetShapeFormattedTextFragmentCollection class

表示 Excel 文档文本形状中格式化文本片段的集合。
...
此集合包含以下项目[`SpreadsheetShapeFormattedTextFragment`](../spreadsheetshapeformattedtextfragment)类型.
