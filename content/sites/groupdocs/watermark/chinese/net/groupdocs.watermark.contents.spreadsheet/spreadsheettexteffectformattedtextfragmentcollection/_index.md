...
description: 表示 Excel 文档艺术字形状中的格式化文本片段的集合
type: docs
weight: 1240
url: /zh/net/groupdocs.watermark.contents.spreadsheet/spreadsheettexteffectformattedtextfragmentcollection/
---
## SpreadsheetTextEffectFormattedTextFragmentCollection class

表示 Excel 文档艺术字形状中的格式化文本片段的集合。
...
此集合包含的项目[`SpreadsheetTextEffectFormattedTextFragment`](../spreadsheettexteffectformattedtextfragment)类型.
