...
description: 表示 Excel 文档艺术字形状中格式化文本片段的集合
type: docs
weight: 1240
...
此集合包含以下项目[`SpreadsheetTextEffectFormattedTextFragment`](../spreadsheettexteffectformattedtextfragment)类型.
