...
description: 表示 Excel 文档单元格中格式化文本片段的集合
type: docs
weight: 1070
url: /zh/net/groupdocs.watermark.contents.spreadsheet/spreadsheetcellformattedtextfragmentcollection/
---
## SpreadsheetCellFormattedTextFragmentCollection class

表示 Excel 文档单元格中格式化文本片段的集合。
