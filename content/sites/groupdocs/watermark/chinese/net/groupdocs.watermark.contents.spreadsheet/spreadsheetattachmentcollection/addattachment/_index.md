...
description: 添加附件到SpreadsheetWorksheetgroupdocs.watermark.contents.spreadsheet/spreadsheetworksheet.
type: docs
weight: 10
...
添加附件到[`SpreadsheetWorksheet`](../../spreadsheetworksheet).
...
| sourceFullName | String | 附加文件的全名（扩展名用于 确定合适的应用程序打开文件）。 |
