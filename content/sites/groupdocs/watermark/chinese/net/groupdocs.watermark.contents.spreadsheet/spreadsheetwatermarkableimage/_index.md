...
description: 表示 Excel 文档中的图像
type: docs
weight: 1250
url: /zh/net/groupdocs.watermark.contents.spreadsheet/spreadsheetwatermarkableimage/
---
...
| 姓名 | 描述 |
| --- | --- |
| [SpreadsheetWatermarkableImage](spreadsheetwatermarkableimage)(byte[]) | 初始化一个新的实例[`SpreadsheetWatermarkableImage`](../spreadsheetwatermarkableimage) class 使用指定的图像数据. |
