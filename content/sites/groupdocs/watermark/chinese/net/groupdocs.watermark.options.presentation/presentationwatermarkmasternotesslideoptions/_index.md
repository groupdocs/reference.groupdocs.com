...
description: 表示将水印添加到演示文稿文档主注释幻灯片时的选项
type: docs
weight: 2020
...
| 姓名 | 描述 |
| --- | --- |
| [PresentationWatermarkMasterNotesSlideOptions](presentationwatermarkmasternotesslideoptions)() | 初始化[`PresentationWatermarkMasterNotesSlideOptions`](../presentationwatermarkmasternotesslideoptions)类. |
