...
description: 表示将水印添加到演示文档主讲义幻灯片时的选项
type: docs
weight: 2010
url: /zh/net/groupdocs.watermark.options.presentation/presentationwatermarkmasterhandoutslideoptions/
---
## PresentationWatermarkMasterHandoutSlideOptions class

表示将水印添加到演示文档主讲义幻灯片时的选项。
...
| 姓名 | 描述 |
| --- | --- |
| [PresentationWatermarkMasterHandoutSlideOptions](presentationwatermarkmasterhandoutslideoptions)() | 初始化一个新的实例[`PresentationWatermarkMasterHandoutSlideOptions`](../presentationwatermarkmasterhandoutslideoptions)类. |
