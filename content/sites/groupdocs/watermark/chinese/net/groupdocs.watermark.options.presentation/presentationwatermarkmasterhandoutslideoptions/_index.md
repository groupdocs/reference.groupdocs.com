...
description: 表示向演示文稿文档主讲义幻灯片添加水印时的选项
type: docs
weight: 2010
...
| 姓名 | 描述 |
| --- | --- |
| [PresentationWatermarkMasterHandoutSlideOptions](presentationwatermarkmasterhandoutslideoptions)() | 初始化[`PresentationWatermarkMasterHandoutSlideOptions`](../presentationwatermarkmasterhandoutslideoptions)类. |
