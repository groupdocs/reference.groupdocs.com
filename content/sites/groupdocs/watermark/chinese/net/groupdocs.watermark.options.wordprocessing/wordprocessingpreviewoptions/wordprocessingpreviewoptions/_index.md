...
description: 初始化WordProcessingPreviewOptionsgroupdocs.watermark.options.wordprocessing/wordprocessingpreviewoptions导致输出流关闭的类
type: docs
weight: 10
...
初始化[`WordProcessingPreviewOptions`](../../wordprocessingpreviewoptions)导致输出流关闭的类。
...
初始化一个新的实例[`WordProcessingPreviewOptions`](../../wordprocessingpreviewoptions)类导致输出流返回 给客户端以供进一步使用。
