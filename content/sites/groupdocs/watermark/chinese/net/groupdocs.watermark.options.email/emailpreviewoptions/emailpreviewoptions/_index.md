...
description: 初始化一个新的实例EmailPreviewOptionsgroupdocs.watermark.options.email/emailpreviewoptions导致输出流关闭的类
type: docs
weight: 10
...
初始化一个新的实例[`EmailPreviewOptions`](../../emailpreviewoptions)导致输出流关闭的类。
...
初始化一个新实例[`EmailPreviewOptions`](../../emailpreviewoptions)导致输出流被返回 到客户端以供进一步使用的类。
