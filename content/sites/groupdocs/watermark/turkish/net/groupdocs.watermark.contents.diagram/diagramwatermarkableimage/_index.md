...
description: Visio belgesi içindeki bir görüntüyü temsil eder.
type: docs
weight: 260
url: /tr/net/groupdocs.watermark.contents.diagram/diagramwatermarkableimage/
---
## DiagramWatermarkableImage class

Visio belgesi içindeki bir görüntüyü temsil eder.
...
| İsim | Tanım |
| --- | --- |
| [DiagramWatermarkableImage](diagramwatermarkableimage)(byte[]) | Yeni bir örneğini başlatır.[`DiagramWatermarkableImage`](../diagramwatermarkableimage) belirtilen görüntü verilerini kullanan sınıf. |
