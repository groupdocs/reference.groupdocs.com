...
description: Visio belgesindeki biçimlendirilmiş metin parçalarından oluşan bir koleksiyonu temsil eder.
type: docs
weight: 160
url: /tr/net/groupdocs.watermark.contents.diagram/diagramformattedtextfragmentcollection/
---
## DiagramFormattedTextFragmentCollection class

Visio belgesindeki biçimlendirilmiş metin parçalarından oluşan bir koleksiyonu temsil eder.
...
Bu koleksiyon şunları içerir:[`DiagramFormattedTextFragment`](../diagramformattedtextfragment) yazın.
