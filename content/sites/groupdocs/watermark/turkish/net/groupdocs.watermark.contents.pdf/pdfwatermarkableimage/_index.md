...
description: Pdf belgesi içindeki bir görüntüyü temsil eder.
type: docs
weight: 730
url: /tr/net/groupdocs.watermark.contents.pdf/pdfwatermarkableimage/
---
## PdfWatermarkableImage class

Pdf belgesi içindeki bir görüntüyü temsil eder.
...
| İsim | Tanım |
| --- | --- |
| [PdfWatermarkableImage](pdfwatermarkableimage)(byte[]) | Yeni bir örneğini başlatır.[`PdfWatermarkableImage`](../pdfwatermarkableimage) belirtilen görüntü verilerini kullanan sınıf. |
