...
description: WordArt shape. Word belgesindeki biçimlendirilmiş metin parçalarından oluşan bir koleksiyonu temsil eder.
type: docs
weight: 1480
url: /tr/net/groupdocs.watermark.contents.wordprocessing/wordprocessingwordartshapeformattedtextfragmentcollection/
---
## WordProcessingWordArtShapeFormattedTextFragmentCollection class

WordArt shape. Word belgesindeki biçimlendirilmiş metin parçalarından oluşan bir koleksiyonu temsil eder.
...
Bu koleksiyon şunları içerir:[`WordProcessingWordArtShapeFormattedTextFragment`](../wordprocessingwordartshapeformattedtextfragment) yazın.
