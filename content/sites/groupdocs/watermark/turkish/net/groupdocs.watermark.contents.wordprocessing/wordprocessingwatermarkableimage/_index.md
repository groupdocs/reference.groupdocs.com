...
description: Word belgesi içindeki bir görüntüyü temsil eder.
type: docs
weight: 1460
url: /tr/net/groupdocs.watermark.contents.wordprocessing/wordprocessingwatermarkableimage/
---
## WordProcessingWatermarkableImage class

Word belgesi içindeki bir görüntüyü temsil eder.
...
| İsim | Tanım |
| --- | --- |
| [WordProcessingWatermarkableImage](wordprocessingwatermarkableimage)(byte[]) | Yeni bir örneğini başlatır.[`WordProcessingWatermarkableImage`](../wordprocessingwatermarkableimage) belirtilen görüntü verilerini kullanan sınıf. |
