...
description: Word belgesi şeklinde biçimlendirilmiş metin parçalarından oluşan bir koleksiyonu temsil eder.
type: docs
weight: 1410
url: /tr/net/groupdocs.watermark.contents.wordprocessing/wordprocessingshapeformattedtextfragmentcollection/
---
## WordProcessingShapeFormattedTextFragmentCollection class

Word belgesi şeklinde biçimlendirilmiş metin parçalarından oluşan bir koleksiyonu temsil eder.
