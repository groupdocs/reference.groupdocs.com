...
description: Bir Excel belgesi içindeki bir görüntüyü temsil eder.
type: docs
weight: 1250
url: /tr/net/groupdocs.watermark.contents.spreadsheet/spreadsheetwatermarkableimage/
---
## SpreadsheetWatermarkableImage class

Bir Excel belgesi içindeki bir görüntüyü temsil eder.
...
| İsim | Tanım |
| --- | --- |
| [SpreadsheetWatermarkableImage](spreadsheetwatermarkableimage)(byte[]) | Yeni bir örneğini başlatır.[`SpreadsheetWatermarkableImage`](../spreadsheetwatermarkableimage) class belirtilen görüntü verilerini kullanıyor. |
