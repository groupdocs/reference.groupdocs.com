...
description: Bir Excel belge hücresindeki biçimlendirilmiş metin parçalarından oluşan bir koleksiyonu temsil eder.
type: docs
weight: 1070
url: /tr/net/groupdocs.watermark.contents.spreadsheet/spreadsheetcellformattedtextfragmentcollection/
---
## SpreadsheetCellFormattedTextFragmentCollection class

Bir Excel belge hücresindeki biçimlendirilmiş metin parçalarından oluşan bir koleksiyonu temsil eder.
...
Bu koleksiyon şunları içerir:[`SpreadsheetCellFormattedTextFragment`](../spreadsheetcellformattedtextfragment) yazın.
