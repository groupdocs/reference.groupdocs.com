...
description: Bir Excel belgesi metin şeklindeki biçimlendirilmiş metin parçalarından oluşan bir koleksiyonu temsil eder.
type: docs
weight: 1220
url: /tr/net/groupdocs.watermark.contents.spreadsheet/spreadsheetshapeformattedtextfragmentcollection/
---
## SpreadsheetShapeFormattedTextFragmentCollection class

Bir Excel belgesi metin şeklindeki biçimlendirilmiş metin parçalarından oluşan bir koleksiyonu temsil eder.
...
Bu koleksiyon şunları içerir:[`SpreadsheetShapeFormattedTextFragment`](../spreadsheetshapeformattedtextfragment) yazın.
