...
description: Bir PowerPoint belgesindeki biçimlendirilmiş metin parçalarından oluşan bir koleksiyonu temsil eder.
type: docs
weight: 850
url: /tr/net/groupdocs.watermark.contents.presentation/presentationformattedtextfragmentcollection/
---
## PresentationFormattedTextFragmentCollection class

Bir PowerPoint belgesindeki biçimlendirilmiş metin parçalarından oluşan bir koleksiyonu temsil eder.
...
Bu koleksiyon şunları içerir:[`PresentationFormattedTextFragment`](../presentationformattedtextfragment) yazın.
