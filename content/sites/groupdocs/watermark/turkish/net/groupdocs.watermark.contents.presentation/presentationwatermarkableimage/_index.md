...
description: PowerPoint belgesi içindeki bir görüntüyü temsil eder.
type: docs
weight: 1020
url: /tr/net/groupdocs.watermark.contents.presentation/presentationwatermarkableimage/
---
## PresentationWatermarkableImage class

PowerPoint belgesi içindeki bir görüntüyü temsil eder.
...
| İsim | Tanım |
| --- | --- |
| [PresentationWatermarkableImage](presentationwatermarkableimage)(byte[]) | Yeni bir örneğini başlatır.[`PresentationWatermarkableImage`](../presentationwatermarkableimage) sınıfı, belirtilen görüntü verilerini kullanıyor. |
