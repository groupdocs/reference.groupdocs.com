...
description: Eposta ekleri için bir temel sınıf sağlar.
type: docs
weight: 300
url: /tr/net/groupdocs.watermark.contents.email/emailattachmentbase/
---
## EmailAttachmentBase class

E-posta ekleri için bir temel sınıf sağlar.
