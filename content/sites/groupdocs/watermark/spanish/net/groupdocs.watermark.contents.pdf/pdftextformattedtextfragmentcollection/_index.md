...
description: Representa una colección de fragmentos de texto formateados en un texto principal de contenido pdf.
type: docs
weight: 720
url: /es/net/groupdocs.watermark.contents.pdf/pdftextformattedtextfragmentcollection/
---
## PdfTextFormattedTextFragmentCollection class

Representa una colección de fragmentos de texto formateados en un texto principal de contenido pdf.
