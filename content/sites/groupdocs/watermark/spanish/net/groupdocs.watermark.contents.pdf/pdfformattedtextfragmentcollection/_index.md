...
description: Representa una colección de fragmentos de texto con formato en un documento pdf.
type: docs
weight: 640
url: /es/net/groupdocs.watermark.contents.pdf/pdfformattedtextfragmentcollection/
---
## PdfFormattedTextFragmentCollection class

Representa una colección de fragmentos de texto con formato en un documento pdf.
