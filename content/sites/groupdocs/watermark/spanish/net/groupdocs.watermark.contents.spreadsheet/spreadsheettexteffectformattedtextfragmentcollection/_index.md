...
description: Representa una colección de fragmentos de texto con formato en una forma de WordArt de un documento de Excel.
type: docs
weight: 1240
url: /es/net/groupdocs.watermark.contents.spreadsheet/spreadsheettexteffectformattedtextfragmentcollection/
---
## SpreadsheetTextEffectFormattedTextFragmentCollection class

Representa una colección de fragmentos de texto con formato en una forma de WordArt de un documento de Excel.
...
Esta colección contiene los elementos de[`SpreadsheetTextEffectFormattedTextFragment`](../spreadsheettexteffectformattedtextfragment) tipo.
