...
description: Representa una colección de gráficos en un documento de Excel.
type: docs
weight: 1090
url: /es/net/groupdocs.watermark.contents.spreadsheet/spreadsheetchartcollection/
---
## SpreadsheetChartCollection class

Representa una colección de gráficos en un documento de Excel.
...
Esta colección contiene los elementos de[`SpreadsheetChart`](../spreadsheetchart) tipo.
