...
description: Representa una colección de fragmentos de texto con formato en una celda de documento de Excel.
type: docs
weight: 1070
url: /es/net/groupdocs.watermark.contents.spreadsheet/spreadsheetcellformattedtextfragmentcollection/
---
## SpreadsheetCellFormattedTextFragmentCollection class

Representa una colección de fragmentos de texto con formato en una celda de documento de Excel.
...
Esta colección contiene los elementos de[`SpreadsheetCellFormattedTextFragment`](../spreadsheetcellformattedtextfragment) tipo.
