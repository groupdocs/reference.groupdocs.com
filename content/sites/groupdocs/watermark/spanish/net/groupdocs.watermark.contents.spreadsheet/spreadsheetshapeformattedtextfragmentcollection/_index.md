...
description: Representa una colección de fragmentos de texto con formato en una forma de texto de documento de Excel.
type: docs
weight: 1220
url: /es/net/groupdocs.watermark.contents.spreadsheet/spreadsheetshapeformattedtextfragmentcollection/
---
## SpreadsheetShapeFormattedTextFragmentCollection class

Representa una colección de fragmentos de texto con formato en una forma de texto de documento de Excel.
...
Esta colección contiene los elementos de[`SpreadsheetShapeFormattedTextFragment`](../spreadsheetshapeformattedtextfragment) tipo.
