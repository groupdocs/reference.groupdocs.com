...
description: Representa una imagen dentro de un documento de Excel.
type: docs
weight: 1250
url: /es/net/groupdocs.watermark.contents.spreadsheet/spreadsheetwatermarkableimage/
---
## SpreadsheetWatermarkableImage class

Representa una imagen dentro de un documento de Excel.
...
| Nombre | Descripción |
| --- | --- |
| [SpreadsheetWatermarkableImage](spreadsheetwatermarkableimage)(byte[]) | Inicializa una nueva instancia del[`SpreadsheetWatermarkableImage`](../spreadsheetwatermarkableimage) class utilizando datos de imagen especificados. |
