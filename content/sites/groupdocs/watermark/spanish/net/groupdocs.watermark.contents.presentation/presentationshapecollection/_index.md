...
description: Representa una colección de formas de dibujo en un documento de PowerPoint.
type: docs
weight: 960
url: /es/net/groupdocs.watermark.contents.presentation/presentationshapecollection/
---
...
Esta colección contiene los elementos de[`PresentationShape`](../presentationshape) tipo.
