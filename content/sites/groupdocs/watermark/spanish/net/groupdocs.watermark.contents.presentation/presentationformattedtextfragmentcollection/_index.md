...
description: Representa una colección de fragmentos de texto con formato en un documento de PowerPoint.
type: docs
weight: 850
url: /es/net/groupdocs.watermark.contents.presentation/presentationformattedtextfragmentcollection/
---
## PresentationFormattedTextFragmentCollection class

Representa una colección de fragmentos de texto con formato en un documento de PowerPoint.
...
Esta colección contiene los elementos de[`PresentationFormattedTextFragment`](../presentationformattedtextfragment) tipo.
