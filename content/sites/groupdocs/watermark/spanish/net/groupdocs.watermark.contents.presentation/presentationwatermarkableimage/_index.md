...
description: Representa una imagen dentro de un documento de PowerPoint.
type: docs
weight: 1020
url: /es/net/groupdocs.watermark.contents.presentation/presentationwatermarkableimage/
---
## PresentationWatermarkableImage class

Representa una imagen dentro de un documento de PowerPoint.
...
| Nombre | Descripción |
| --- | --- |
| [PresentationWatermarkableImage](presentationwatermarkableimage)(byte[]) | Inicializa una nueva instancia del[`PresentationWatermarkableImage`](../presentationwatermarkableimage) Clase utilizando datos de imagen especificados. |
