...
description: Representa las opciones al agregar una marca de agua a una diapositiva del documento maestro del documento de presentación.
type: docs
weight: 2010
url: /es/net/groupdocs.watermark.options.presentation/presentationwatermarkmasterhandoutslideoptions/
---
## PresentationWatermarkMasterHandoutSlideOptions class

Representa las opciones al agregar una marca de agua a una diapositiva del documento maestro del documento de presentación.
...
| Nombre | Descripción |
| --- | --- |
| [PresentationWatermarkMasterHandoutSlideOptions](presentationwatermarkmasterhandoutslideoptions)() | Inicializa una nueva instancia del[`PresentationWatermarkMasterHandoutSlideOptions`](../presentationwatermarkmasterhandoutslideoptions) clase. |
