...
description: Representa las opciones al agregar una marca de agua a una diapositiva maestra de un documento de presentación.
type: docs
weight: 2030
url: /es/net/groupdocs.watermark.options.presentation/presentationwatermarkmasterslideoptions/
---
## PresentationWatermarkMasterSlideOptions class

Representa las opciones al agregar una marca de agua a una diapositiva maestra de un documento de presentación.
...
| Nombre | Descripción |
| --- | --- |
| [PresentationWatermarkMasterSlideOptions](presentationwatermarkmasterslideoptions)() | Inicializa una nueva instancia del[`PresentationWatermarkMasterSlideOptions`](../presentationwatermarkmasterslideoptions) clase. |
