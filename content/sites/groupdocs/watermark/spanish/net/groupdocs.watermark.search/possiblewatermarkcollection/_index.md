...
description: Representa una colección de posibles marcas de agua encontradas en un contenido.
type: docs
weight: 2550
url: /es/net/groupdocs.watermark.search/possiblewatermarkcollection/
---
## PossibleWatermarkCollection class

Representa una colección de posibles marcas de agua encontradas en un contenido.
...
Esta colección contiene los elementos de[`PossibleWatermark`](../possiblewatermark) tipo.
