...
description: Representa una imagen de varios fotogramas en la que se puede colocar una marca de agua.
type: docs
weight: 400
url: /es/net/groupdocs.watermark.contents.image/multiframeimagecontent/
---
## MultiframeImageContent class

Representa una imagen de varios fotogramas en la que se puede colocar una marca de agua.
