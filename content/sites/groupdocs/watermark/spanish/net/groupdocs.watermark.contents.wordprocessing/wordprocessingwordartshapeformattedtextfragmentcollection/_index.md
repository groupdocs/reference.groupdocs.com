...
description: Representa una colección de fragmentos de texto con formato en una forma de WordArt de un documento de Word.
type: docs
weight: 1480
url: /es/net/groupdocs.watermark.contents.wordprocessing/wordprocessingwordartshapeformattedtextfragmentcollection/
---
## WordProcessingWordArtShapeFormattedTextFragmentCollection class

Representa una colección de fragmentos de texto con formato en una forma de WordArt de un documento de Word.
...
Esta colección contiene los elementos de[`WordProcessingWordArtShapeFormattedTextFragment`](../wordprocessingwordartshapeformattedtextfragment) tipo.
