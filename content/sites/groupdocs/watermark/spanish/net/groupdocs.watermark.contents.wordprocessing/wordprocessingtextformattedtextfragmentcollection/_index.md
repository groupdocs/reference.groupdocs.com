...
description: Representa una colección de fragmentos de texto con formato en el texto principal de un documento de Word.
type: docs
weight: 1440
url: /es/net/groupdocs.watermark.contents.wordprocessing/wordprocessingtextformattedtextfragmentcollection/
---
## WordProcessingTextFormattedTextFragmentCollection class

Representa una colección de fragmentos de texto con formato en el texto principal de un documento de Word.
