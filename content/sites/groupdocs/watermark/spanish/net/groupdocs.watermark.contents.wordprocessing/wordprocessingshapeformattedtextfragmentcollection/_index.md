...
description: Representa una colección de fragmentos de texto con formato en una forma de documento de Word.
type: docs
weight: 1410
url: /es/net/groupdocs.watermark.contents.wordprocessing/wordprocessingshapeformattedtextfragmentcollection/
---
## WordProcessingShapeFormattedTextFragmentCollection class

Representa una colección de fragmentos de texto con formato en una forma de documento de Word.
...
Esta colección contiene los elementos de[`WordProcessingTextFormattedTextFragment`](../wordprocessingtextformattedtextfragment) tipo.
