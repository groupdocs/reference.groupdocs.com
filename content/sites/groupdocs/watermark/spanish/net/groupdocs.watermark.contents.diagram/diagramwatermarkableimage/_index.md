...
description: Representa una imagen dentro de un documento de Visio.
type: docs
weight: 260
url: /es/net/groupdocs.watermark.contents.diagram/diagramwatermarkableimage/
---
## DiagramWatermarkableImage class

Representa una imagen dentro de un documento de Visio.
...
| Nombre | Descripción |
| --- | --- |
| [DiagramWatermarkableImage](diagramwatermarkableimage)(byte[]) | Inicializa una nueva instancia del[`DiagramWatermarkableImage`](../diagramwatermarkableimage) clase usando datos de imagen especificados. |
