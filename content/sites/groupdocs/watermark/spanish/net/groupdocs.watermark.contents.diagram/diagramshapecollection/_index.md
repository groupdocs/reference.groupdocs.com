...
description: Representa una colección de formas de dibujo en un documento de Visio.
type: docs
weight: 240
url: /es/net/groupdocs.watermark.contents.diagram/diagramshapecollection/
---
## DiagramShapeCollection class

Representa una colección de formas de dibujo en un documento de Visio.
...
Esta colección contiene los elementos de[`DiagramShape`](../diagramshape) tipo.
