...
description: Representa una colección de hipervínculos en un documento de Visio.
type: docs
weight: 200
url: /es/net/groupdocs.watermark.contents.diagram/diagramhyperlinkcollection/
---
## DiagramHyperlinkCollection class

Representa una colección de hipervínculos en un documento de Visio.
...
Esta colección contiene los elementos de[`DiagramHyperlink`](../diagramhyperlink) tipo.
